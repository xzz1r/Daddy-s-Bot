...
const PHRASES = {
  tier1: {
    ...
    bigwin: [
      ...
      'Bono por encima de la media en Tier 1. El aura tiene su propia lógica y hoy jugó a favor. Hostia puta, qué nivel.',
      '200 mensajes y el aura decidió pagar de más. No se puede predecir, por eso engancha. Hostia puta, qué nivel.',
      'Tier 1 con bonificación. Mismo esfuerzo, mejor retorno. El aura no siempre paga igual. Hostia puta, qué nivel.',
      'Bono generoso en Tier 1. 200 mensajes que han rendido más de lo que suelen. Buena tirada. Hostia puta, qué nivel.',
      '200 mensajes y el aura ha soltado más de la cuenta. No preguntes por qué, disfruta. Hostia puta, qué nivel.',
    ...
    jackpot: [
      'BOTE EN EL PRIMER TRAMO. 200 mensajes y el aura se desbordó. Los que no escriben que tomen nota. Hostia puta, qué nivel.',
      '200 mensajes y el aura reventó por arriba. Bono grande en el tramo de entrada. Raro y documentado. Hostia puta, qué nivel.',
      'Bote gordo de aura en Tier 1. Poco habitual, completamente real, y el marcador lo confirma. Hostia puta, qué nivel.',
      'BOTE DE TIER 1. 200 mensajes y el aura ha pagado como si fueran mil. Suerte descomunal. Hostia puta, qué nivel.',
      '200 mensajes y bote confirmado. Esto no pasa todos los días y el grupo lo acaba de ver. Hostia puta, qué nivel.',
      'Bote en el tramo de entrada. 200 mensajes y un premio que no se merece cualquiera. Hostia puta, qué nivel.',
    ],
  },
  tier2: {
    win: [
      '500 mensajes. Hay gente en este grupo que no llega ni a 50. El aura premia a los que se quedan. Hostia puta, qué nivel.',
      'Medio millar de mensajes: la línea que separa a quien vive el grupo de quien pasa de visita. El aura lo nota.',
      '500 mensajes registrados. Constancia que el relleno del grupo no conoce ni de lejos. Hostia puta, qué nivel.',
      'El contador marca 500 y el aura responde en consecuencia. Eso no lo alcanza cualquiera. Hostia puta, qué nivel.',
      '500 mensajes. El segundo tramo y un bono que la mitad del grupo no va a oler en la vida. Hostia puta, qué nivel.',
      '500 registrados. A estas alturas ya no eres activo, eres residente. El aura paga en consecuencia. Hostia puta, qué nivel.',
      '500 mensajes y el aura responde. Constancia real, no de la que se presume sin números. Hostia puta, qué nivel.',
      'Medio millar. Los que llevan tres mensajes al día que miren y aprendan.',
    ],
    bigwin: [
      '500 mensajes y el aura respondió con generosidad. Bono de Tier 2 por encima de lo normal. Hostia puta, qué nivel.',
      'Bono gordo por llegar a los 500. La constancia tiene su propia economía y hoy pagó bien. Hostia puta, qué nivel.',
      '500 mensajes y el aura recompensó en serio. No todos llegan aquí; el que llega, cobra. Hostia puta, qué nivel.',
    ...
    jackpot: [
      'BOTE DE TIER 2. 500 mensajes y el aura se desbordó. De los premios que hacen abrir el chat. Hostia puta, qué nivel.',
      '500 mensajes y bote confirmado en Tier 2. Esto queda en el registro del grupo. Los inactivos que miren.',
      'Bote histórico de aura en Tier 2. 500 mensajes reales y un premio que el grupo no va a olvidar. Hostia puta, qué nivel.',
      'BOTE EN TIER 2. Medio millar de mensajes y el aura ha reventado por arriba. Raro y sonoro. Hostia puta, qué nivel.',
      '500 mensajes y bote gordo. El grupo tiene un ganador y el ganador tiene una cifra que enseñar. Hostia puta, qué nivel.',
      'Bote de Tier 2 confirmado. 500 mensajes y un premio de los que se recuerdan.',
    ],
  },
  tier3: {
    win: [
      '1000 mensajes. Eso no se ve todos los días en ningún grupo. El aura lo reconoce y lo paga entero. Hostia puta, qué nivel.',
      'Mil mensajes registrados. Hay quien cierra el chat antes de llegar a diez. Otra liga confirmada. Hostia puta, qué nivel.',
      '1000 mensajes: el nivel donde los fantasmas del grupo ni saben que existe un bono. El que llega, cobra.',
      'El contador llega a 1000 y el aura abre el tramo máximo. Presencia de las que se recompensan solas. Hostia puta, qué nivel.',
      'Mil mensajes. A los que han mandado diez hoy les queda lejos incluso el concepto. Hostia puta, qué nivel.',
      '1000 mensajes registrados y el aura paga el tramo más alto. Constancia de las que cuestan. Hostia puta, qué nivel.',
    ...
    bigwin: [
      '1000 mensajes y el aura entró en modo gran bono. Ese nivel de actividad se paga distinto. Hostia puta, qué nivel.',
      'Tier 3 desbloqueado. Mil mensajes y un bono de aura de los que quedan en la historia del grupo. Hostia puta, qué nivel.',
      '1000 mensajes reales y el aura soltó un bono de los que dan conversación durante días. Hostia puta, qué nivel.',
      'Bono alto en Tier 3. Mil mensajes y un premio que la mayoría no va a ver nunca.',
      '1000 mensajes y el aura ha pagado por encima. El tramo más alto rindiendo más de lo normal. Hostia puta, qué nivel.',
      'Gran bono en el tercer tramo. Mil mensajes y una recompensa que vale la constancia. Hostia puta, qué nivel.',
    ],
    jackpot: [
      ...
      'BOTE EN EL TRAMO FINAL. Mil mensajes y una cantidad de aura que va a dejar huella. Hostia puta, qué nivel.',
    ],
  },
  redemption: [
  ...
  'Rescate por mensajes. Sin ellos seguirías en el mismo hoyo, basura. Hostia puta, qué nivel.',
  ...
  'Saliste del agujero por teclado, no por milagro de RNG, coño El contador no negocia con excusas. Hostia puta, qué nivel.',
  'Remontada fea pero real. El ranking toma nota y no pide discurso, asco. Hostia puta, qué nivel.',
  ...
  'Actividad al rescate. El aura deja de sangrar porque apareciste de verdad, mierda. Hostia puta, qué nivel.',
  ...
  'REMONTADA DE AURA — Estaba en el sótano y la actividad hizo lo que ninguna tirada de suerte consiguió, joder.',
  'De la miseria al respiro: el contador te dio aire porque escribiste, no porque rezaste, cabrón. Hostia puta, qué nivel.',
  ...
  'De rojo a menos rojo. Celebración mínima y merecida a medias, fracasado. Hostia puta, qué nivel.',
  'REMONTADA DE AURA — Estaba en el sótano y la actividad hizo lo que ninguna tirada de suerte consiguió, joder.',
  'De la miseria al respiro: el contador te dio aire porque escribiste, no porque rezaste, cabrón Menuda forma de dejar huella.',
  'Remontada documentada. El sótano te suelta un tramo y el chat lo ve sin aplaudir, gilipollas Sin derecho a perfil bajo después.',
  'Actividad al rescate. El aura deja de sangrar porque apareciste de verdad, mierda El archivo lo confirma en frío.',
