...
const PHRASES = {
  ...
  'Rescate por mensajes. Sin ellos seguirías en el mismo hoyo, basura Documentado sin anestesia posible.',
  ...
  'Saliste del agujero por teclado, no por milagro de RNG, coño El contador no negocia con excusas Documentado sin anestesia posible.',
  'Remontada fea pero real. El ranking toma nota y no pide discurso, asco Documentado sin anestesia posible.',
  ...
  'Actividad al rescate. El aura deja de sangrar porque apareciste de verdad, mierda Documentado sin anestesia posible.',
  ...
  'REMONTADA DE AURA — Estaba en el sótano y la actividad hizo lo que ninguna tirada de suerte consiguió, joder.',
  'De la miseria al respiro: el contador te dio aire porque escribiste, no porque rezaste, cabrón Documentado sin anestesia posible.',
  ...
  'De rojo a menos rojo. Celebración mínima y merecida a medias, fracasado Documentado sin anestesia posible, fracasado.',
  'REMONTADA DE AURA — Estaba en el sótano y la actividad hizo lo que ninguna tirada de suerte consiguió, joder.',
  'De la miseria al respiro: el contador te dio aire porque escribiste, no porque rezaste, cabrón Menuda forma de dejar huella.',
  'Remontada documentada. El sótano te suelta un tramo y el chat lo ve sin aplaudir, gilipollas Sin derecho a perfil bajo después.',
  'Actividad al rescate. El aura deja de sangrar porque apareciste de verdad, mierda El archivo lo confirma en frío.',
