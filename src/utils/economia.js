...
// ─── LA CAJA ────────────────────────────────────────────────────────────────
//
// Un sitio donde guardar aura para que NADIE te la pueda robar. Ni !robo, ni
...
// siempre. La caja obliga a decidir cada día cuánto dejas a la vista, y esa
// decisión no se compra: se calcula.
//
// Y NO ES UN BANCO, ES UNA CAJA. Las tres reglas son lo que impide que mate al
// robo, que es el juego que sostiene medio bot:
//
...
//   · COMISIÓN AL SACAR. Guardar aura tiene precio, así que meterlo todo
...
//   · ENFRIAMIENTO AL METER. Sin esto bastaba con cerrarlo TODO en cuanto
