...
const MISERIA = [
  ...
  'Aura en dieta extrema. El cobro te mira y se ríe, cabrón, y el chat lo tiene claro, joder.',
  'Miseria de ranking. No cubres ni el peaje mínimo, gilipollas, y el chat lo tiene claro, mierda.',
  'Sin aura suficiente. El sistema no fía, mierda, y el chat lo tiene claro, coño.',
  'Pobreza de aura certificada. Vuelve cuando tengas algo, coño, y el chat lo tiene claro, cabrón.',
  'El cobro necesita saldo. Tú tienes vergüenza, asco, y el chat lo tiene claro, gilipollas.',
  'Aura insuficiente para la operación. Pobre de solemnidad, patético, y el chat lo tiene claro, patético.',
  'Miseria total. El contador no abre la puerta, basura, y el chat lo tiene claro, asco.',
  'No te llega. El mínimo te queda grande, ridículo, y el chat lo tiene claro, basura.',
  'Aura en números rojos de dignidad, fracasado, y el chat lo tiene claro, ridículo.',
  'Sin saldo de aura no hay movimiento, joder, y el chat lo tiene claro, fracasado.',
  'Miseria documentada en el contador, cabrón, y el chat lo tiene claro, joder.',
  'El sistema exige mínimo. Tú no llegas, gilipollas, y el chat lo tiene claro, mierda.',
  'Pobre de aura y rico en cara, mierda, y el chat lo tiene claro, coño.',
  'No cubres el peaje. El cobro se cancela, coño, y el chat lo tiene claro, cabrón.',
  'Aura insuficiente. Caso cerrado, asco, y el chat lo tiene claro, gilipollas.',
  'Miseria de los que miran el escaparate, patético, y el chat lo tiene claro, patético.',
  'Sin aura no hay cobro posible, basura, y el chat lo tiene claro, asco.',
  'El mínimo te vomita, ridículo, y el chat lo tiene claro, basura.',
  'Pobreza de ranking sin maquillaje, fracasado, y el chat lo tiene claro, ridículo.',
  'No te alcanza. El bot no hace caridad, joder, y el chat lo tiene claro, fracasado.',
  'Aura en miseria. Operación denegada, cabrón, y el chat lo tiene claro, joder.',
  'Sin fondos de aura, gilipollas, y el chat lo tiene claro, mierda.',
  'El cobro requiere más de lo que tienes, mierda, y el chat lo tiene claro, coño.',
  'Miseria pura en el contador, coño, y el chat lo tiene claro, cabrón.',
  'No llegas al mínimo vital de aura, asco, y el chat lo tiene claro, gilipollas.',
  'Pobre documentado. Siguiente, patético, y el chat lo tiene claro, patético.',
  'Aura insuficiente para cualquier movimiento serio, basura, y el chat lo tiene claro, asco.',
  'El sistema te rechaza por pobreza, ridículo, y el chat lo tiene claro, basura.',
  'Miseria de aura. Firma el parte, fracasado, y el chat lo tiene claro, ridículo.',
  'No te llega ni para empezar, joder, y el chat lo tiene claro, fracasado.',
  'Cobro imposible: saldo de pena, cabrón, y el chat lo tiene claro, joder.',
  'Aura en la miseria más baja, gilipollas, y el chat lo tiene claro, mierda.',
  'Sin el mínimo no hay historia, mierda, y el chat lo tiene claro, coño.',
  'Pobreza de aura a la vista, coño, y el chat lo tiene claro, cabrón.',
  'El contador dice no. Tú también deberías, asco, y el chat lo tiene claro, gilipollas.',
  'Miseria certificada, patético, y el chat lo tiene claro, patético.',
  'No cubres. El cobro espera a otro, basura, y el chat lo tiene claro, asco.',
  'Aura de pobres y pretensiones de rico, ridículo, y el chat lo tiene claro, basura.',
  'Insuficiente. Miseria, fracasado, y el chat lo tiene claro, ridículo.',
  'No te alcanza el aura para el peaje, joder, y el chat lo tiene claro, fracasado.',
  'Cobro bloqueado por pobreza, cabrón, y el chat lo tiene claro, joder.',
  'Miseria en el marcador, gilipollas, y el chat lo tiene claro, mierda.',
  'Sin saldo útil de aura, mierda, y el chat lo tiene claro, coño.',
  'El mínimo te queda a años luz, coño, y el chat lo tiene claro, cabrón.',
  'Pobre de aura documentado, asco, y el chat lo tiene claro, gilipollas.',
  'Operación cancelada: miseria, patético, y el chat lo tiene claro, patético.',
  'No llegas. El sistema parpadea en rojo, basura, y el chat lo tiene claro, asco.',
  'Aura insuficiente crónica, ridículo, y el chat lo tiene claro, basura.',
  'Miseria total. Vuelve con algo, fracasado, y el chat lo tiene claro, ridículo.',
  'Pobre de aura y rico en cara, mierda, fracasado, y el chat lo tiene claro, fracasado.'
];
