...
const ROB_WIN = [
  ...
  '%A le vacía el bolsillo a %V y sale decepcionado. Ni robándote se saca nada decente, muerto de hambre.',
  ...
  '%A trabaja rápido y %V no se entera hasta que mira el saldo. Oficio contra papelón.',
  ...
  '%A se lleva %C y ya tiene tema para un mes. %V también, pero contándolo desde el suelo.',
  ...
  'El golpe salió redondo y la reputación de %V salió peor. Las dos cosas en el mismo minuto.',
  ...
  '%C de botín. Poco para el trabajo que da %V, y aun así %V lo va a echar de menos.',
  ...
  '%A se lo lleva limpio y %V lo cuenta como que aguantó. Fracasado hasta narrando.',
