...
const ROB_MAESTRO = [
  ...
  'Robo de manual. %A se llevó el doble de lo que iba a buscar porque %V se dejó y encima dio de más sin darse cuenta.',
  ...
  'Casi el doble para %A. La cuenta de %V queda tan vacía que ni el eco quiere quedarse ahí dentro.',
...
const ROB_PARCIAL = [
  ...
  '%A se llevó solo un trozo de %V y aun así basta para dejar constancia de lo poco que aguantas.',
...
const ROB_DESASTRE = [
  ...
  'Desastre total: %A quiso robar y terminó pagando. %V tiene más aura y sigue sin saber por qué.',
  ...
  'Robo catastrófico. %A acaba con menos que antes de empezar y %V con más sin mover un dedo.',
  ...
  'El robo de %A se dio la vuelta entero. Ahora %V tiene más y tú haces más el ridículo.',
