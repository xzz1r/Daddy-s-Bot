...
// Pools de desenlace de !robo. La lógica vive en commands/robo.js.
...
const ROB_WIN = [
  ...
  '%A le vació el aura a %V delante del grupo. %V se quedó contando los bolsillos. Estaban vacíos, inútil.',
  ...
  '%A entró, cogió y salió. %V se quedó mirando el hueco. Qué asco de rival.',
  ...
  '%A se llevó lo de %V entero. %V se siente atracado. Lo está. El marcador no miente, pringado.',
  ...
  '%A terminó el robo. %V perdió. Con este pringado no hace falta repetir.',
  ...
  '%A le vació el aura a %V y se fue silbando. Hasta robarte es un recado, muerto de hambre.',
  ...
  '%A tiró y se llevó lo de %V. %V ya está temblando. Tarde, pringado.',
  ...
  'Robo limpio, humillación entera. %A se lleva el aura de %V y todo el respeto.',
  ...
  'Robo limpio, ridículo completo. %A se lleva lo de %V, %V se queda con la fama de fácil.',
  ...
  '%A se llevó el aura de %V entera, y %V es el único que sale mal en la foto.',
  ...
  '%A terminó el atraco porque %V no daba para defensa. %V no daba para más.',
  ...
  'Robo limpio y %V está peor que antes. %A ni ha calentado, y ya está.',
  ...
  '%A terminó porque le dio la gana. %V no compensaba el esfuerzo y aun así se quedó a cero.',
...
const ROB_MAESTRO = [
  ...
  '%A se llevó casi el doble y a %V le duele como si le hubieran quitado la vida. Y se la han quitado.',
  ...
  '%A no dejó nada a %V. El destino no se aburre: se ensaña, y hoy le tocó a este.',
...
const ROB_DESASTRE = [
  ...
  '%V cobró. %A perdió, que es distinto y mucho más patético. El aura cambió de sentido.',
...
module.exports = { ROBO_FALLO_REMATE, ROB_WIN, ROB_FAIL, ROB_MAESTRO, ROB_PARCIAL, ROB_DESASTRE };
