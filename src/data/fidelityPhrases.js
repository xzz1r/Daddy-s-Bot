...
const FIEL_MID = [
  ...
  'Tu lealtad es como la cobertura en un pueblo de mierda: va y viene, y justo cuando mas la necesitas se corta, cabron.',
  'Ni fiel ni traidor, el puto limbo de los tibios. Estas ahi flotando sin comprometerte con nada ni con nadie, gilipollas.',
  ...
  'Hostia, tu fidelidad depende del dia de la semana. Los lunes leal, los viernes ya estas mirando opciones como un puto catalogo de Ikea.',
  'Coño, eres fiel por inercia, no por conviccion. El dia que la inercia se pare vas a salir volando hacia la primera mierda que pase.',
  ...
  'Eres fiel a ratos, como las putas farolas solares. Cuando hace sol todo bien, pero en cuanto oscurece te apagas, cabron.',
  ...
  'Tu compromiso es como una ereccion despues de diez cervezas: la intencion esta, pero el resultado es bastante discutible, cabron.',
  'Hostia, [nombre], eres mas impredecible que una cagada despues de kebab. Nadie sabe si hoy toca fiel o toca que la cagues.',
  ...
  'Coño, eres el tipico que dice yo nunca haria eso con la misma boca que usa para hacerlo tres meses despues. Clasico.',
  '[nombre] no traiciona, simplemente se olvida de que tenia compromisos. Que es peor, porque ni mala intencion tiene, el muy imbecil.',
  ...
  'Eres fiel hasta que alguien te pone una cerveza fria y una sonrisa. Entonces tus principios se derriten como mantequilla en sarten.',
  '[nombre] tiene la fidelidad de un taximetro: funciona mientras pagues, y en cuanto dejas de poner no avanza ni un metro, el cabron.',
  ...
  'Tu palabra tiene la firmeza de un moco colgando: aguanta un rato ahi, pero todo el mundo sabe que va a caer en algun momento.',
  ...
  'Joder, tu compromiso es como hacer dieta un lunes: dura hasta que ves una pizza, y la pizza siempre aparece, cabron.',
  ...
  'Tu fidelidad es como una polla dibujada en un pupitre: parece que esta ahi para siempre, pero con un poco de esfuerzo se borra.',
  'Ni eres de fiar ni eres una amenaza. Eres el puto NPC de las relaciones: estas ahi, ocupas espacio, pero no haces nada relevante.',
  ...
  'Coño, eres fiel por descarte, no por eleccion. Si tuvieras mas opciones ya habriamos visto tu verdadera cara, cabron.',
  ...
  'Hostia, tu compromiso es como una suscripcion de gimnasio: pagas el primer mes motivado y el segundo ya ni apareces, cabron.',
  '[nombre] cambia de lealtad como de ropa interior: cada dos dias, y a veces ni eso. Que asco de consistencia, joder.',
  ...
  'Joder, ni frio ni caliente. Eres el agua del grifo templada de cojones: no satisface a nadie y todo el mundo preferiria otra cosa.',
  'Tu lealtad tiene la vida util de un Bic naranja: funciona un rato y luego deja de pintar cuando mas lo necesitas.',
  ...
  'Hostia puta, eres fiel como un GPS sin datos: la direccion general la tienes, pero los detalles te los inventas sobre la marcha.',
  ...
  'Eres el tipico que ayuda a mudarse pero se larga antes de montar los muebles. Presente en lo facil, ausente en lo jodido.',
  ...
  'Hostia, eres como una cita del dentista: todo el mundo sabe que deberias ir, pero nadie confia en que aparezcas, cabron.',
  ...
  'Eres fiel por pereza, que es la forma mas puta de ser fiel. El dia que te de por mover el culo, la cagamos todos.',
  ...
  '[nombre] es fiel mientras la relacion sea un buffet libre. En cuanto toca pagar la cuenta, busca la puerta de atras, el muy rata.',
  ...
  'Joder, [nombre] no engaña por principios, no engaña por falta de habilidad social. El dia que aprenda a ligar la cagamos.',
  ...
  'Hostia, tu fidelidad va como el trafico en hora punta: avanza, se para, avanza, se para. No llegas a ningun sitio, cabron.',
  ...
  'Hostia, eres fiel por geografia: si vivieras en otra ciudad con otra gente, tu lealtad ya habria cambiado de codigo postal.',
  ...
  'Coño, tu fidelidad es como un contrato de practicas: temporal, mal pagado y todo el mundo sabe que no va a durar, cabron.',
  ...
  'Hostia, [nombre], tu fidelidad depende de la temperatura del momento. Frio te quedas, caliente te largas. Termometro con patas.',
  ...
  'Tu palabra es como un chicle sin azucar: pierde el sabor a los cinco minutos y la gente la escupe sin pensarselo dos veces.',
  '[nombre] tiene la lealtad de un mando a distancia: funciona cuando quiere, desaparece cuando mas falta hace y nadie lo busca.',
  'Hostia puta, tu fidelidad es como los abdominales en enero: mucha motivacion al principio, cero resultados y abandono total.',
  'Eres el tio que compra seguro de viaje pero no viaja. Preparado para la traicion que luego no cometes. Cobarde hasta en eso.',
  '[nombre] no es leal, es indeciso. Y un indeciso con acceso a Tinder es una bomba de relojeria con mecha mojada.',
  'Coño, tu compromiso es como una pegatina vieja: medio pegada, medio despegada, y con un aspecto lamentable, cabron.',
  ...
  'Hostia, ni traicionas ni proteges. Eres como un puto cono de trafico: estas ahi en medio, no haces nada y todo el mundo te esquiva.',
];
...
const FIEL_LOW = [
  ...
  'Tu lealtad es como la virginidad de un actor porno: se perdio hace tanto que ya nadie recuerda que existio, cabron.',
  ...
  '[nombre] cambia de lealtad mas rapido que un chaval de quince años cambia de paja. Cada dia una nueva, sin compromiso ninguno.',
  'Joder, si la traicion fuese un deporte olimpico, tu serias el puto Usain Bolt. Record mundial en joder a la gente.',
  'Tu fidelidad murio antes de nacer, como un aborto moral que ni la ciencia puede explicar. Naciste sin esa pieza, cabron.',
  'Hostia, [nombre] es tan desleal que si le prestas un boli lo devuelve sin tinta y mordido. Y encima te dice que ya estaba asi.',
  ...
  '[nombre] traiciona con la frecuencia de quien se lava los dientes: dos veces al dia y a veces tres si hay oportunidad.',
  'Joder, tu lealtad es como el papel de vater de un bar: aspera, escasa y nadie en su sano juicio querria depender de ella.',
  ...
  '[nombre] tiene el compromiso de un tio meandose en un portal: duro lo justo, dejo todo hecho una mierda y se largo sin mirar atras.',
  'Hostia puta, eres tan traidor que Brutus te miraria y diria joder, este tio se pasa, y yo apuñale a Cesar.',
  ...
  '[nombre] es mas falso que un billete de tres euros pintado con rotulador. Y aun asi hay gilipollas que se lo tragan.',
  'Joder, eres el tipo de cabron que le pega una patada a un perro y luego pregunta por que no le quieren los animales.',
  ...
  'Hostia, si la deslealtad fuese una ETS, tu serias la puta pandemia del siglo. Contagias traicion con solo abrir la boca.',
  'Coño, tu compromiso dura lo que tarda en enfriarse un cafe. Y te lo bebes asi, tibio, como haces con todo en tu mierda de vida.',
  ...
  '[nombre] promete con la misma solemnidad con la que un crio jura que no ha sido el: mirandote a los ojos mientras miente de puta madre.',
  ...
  'Tu lealtad es como un culo despues de Taco Bell: explosiva, impredecible y deja un desastre que nadie quiere limpiar.',
  ...
  'Tu fidelidad tiene la profundidad de un charco de meado de perro: se ve el fondo, apesta y nadie quiere pisar ahi.',
  '[nombre] es el cabron que te roba la novia y luego te pide consejo para la relacion. Descarado de cojones, como siempre.',
  ...
  'Hostia puta, eres tan traidor que hasta los politicos te señalan y dicen hostia, al lado de ese tio yo soy un puto santo.',
  'Coño, tu lealtad es como una braga rota: no sujeta nada, no cubre nada y todo el mundo ve lo que no deberia verse.',
  'Eres la definicion andante de hijo de puta con DNI. Si buscas traicion en el diccionario, sale tu cara y tu codigo postal.',
  ...
  'Joder, te han dado mas oportunidades que a un preso en tercer grado y las has cagado todas con la precision de un reloj suizo.',
  'Tu fidelidad cabe en un dedal y aun sobra espacio para meter toda tu verguenza, que tambien es microscopica, cabron.',
  ...
  '[nombre] es tan falso que si se tragara un termometro no le subiria la temperatura. Frio de cojones por dentro y por fuera.',
  'Hostia, tu historial de traiciones necesita un disco duro externo. El movil ya no tiene espacio para tanta mierda.',
  'Coño, eres el tipico que te invita a cenar para despues pedirte que pagues tu. Generosidad cero, deslealtad infinita.',
  'Tu lealtad es como el pelo de un calvo: todo el mundo sabe que no esta, pero tu sigues peinandote como si existiera.',
  '[nombre] tiene mas vidas que un gato, pero todas las usa para joder a alguien distinto. Nueve traiciones garantizadas.',
  'Joder, tu fidelidad es como la pasta de dientes de un avion: tamaño miniatura, dura un viaje y nadie la quiere de verdad.',
  ...
  'Hostia puta, tu compromiso es como una ereccion de las cuatro de la mañana: aparece sin motivo, dura poco y no le sirve a nadie.',
  'Coño, eres tan desleal que si fueras pais te habrian invadido por tus propios aliados. Nadie quiere estar en tu bando, cabron.',
  ...
  'Joder, la ultima vez que fuiste fiel a algo fue a tu mano derecha, y eso porque la izquierda no tenia suficiente tecnica.',
  'Tu fidelidad es como buscar señal en un bunker nuclear: puedes intentarlo, pero todo el mundo sabe que es imposible.',
  'Hostia, [nombre] es la persona que todos ponen de ejemplo cuando quieren explicar por que la humanidad esta jodida. Y con razon.',
  ...
  'Coño, si tu lealtad fuese un billete de metro, ya habria caducado en la maquina antes de que llegaras a la puta estacion.',
  ...
  'Joder, eres tan traidor que si Jesus te hubiera conocido, Judas le habria parecido un puto angel en comparacion.',
  ...
  'Hostia, tu fidelidad tiene la misma credibilidad que un politico diciendo que no va a subir impuestos. Nadie te cree, cabron.',
  ...
  'Joder, si montaran un museo de la deslealtad, tu serias la pieza central y la explicacion del cartel diria simplemente: mierda.',
  ...
  'Coño, tu compromiso es como una bolsa de basura: sirve para cargar mierda un rato y despues se tira sin mirar dentro.',
  'Eres tan desleal que si tu perra te mordiera, le darias la razon. Hasta los animales saben que no te mereces su confianza.',
  '[nombre] tiene la moral de una alcantarilla: todo baja, nada sube y el olor te avisa de que te mantengas lejos.',
  'Joder, tu fidelidad es como la conexion Bluetooth de un coche viejo: se intenta, no conecta y al final vas con el cable, cabron.',
  'Eres la prueba viviente de que la evolucion tambien produce errores. Darwin te habria puesto como ejemplo de lo que no deberia sobrevivir.',
  '[nombre] es tan poco fiable que si fuera preservativo, ya tendria diecisiete hijos y una demanda colectiva.',
  'Hostia, tu lealtad tiene menos capas que un chicle masticado: fino, pegajoso y asqueroso de mirar.',
  'Coño, eres mas falso que las tetas de una presentadora de Telecinco. Y al menos las de ella tienen garantia, cabron.',
  ...
  'Hostia puta, [nombre], tu lealtad es tan inexistente que hasta la Atlantida tiene mas pruebas de existir. Y esa lleva perdida milenios, cabron.',
];
...
const INFIEL_HIGH = [
  ...
  'Tu polla tiene mas kilometros que un Seat Ibiza de repartidor. Y como ese Ibiza, ya no la quiere nadie, cabron.',
  'Hostia puta, cambias de pareja como de canal de television: con el pulgar, sin levantarte del sofa y sin prestarle atencion a ninguno.',
  ...
  'Eres tan infiel que tu polla deberia tener su propio DNI y cotizar a la Seguridad Social por horas extras.',
  ...
  'Hostia, tienes mas cuernos puestos que la Sierra de Gredos. Y en la Sierra al menos las cabras no se enteran, cabron.',
  ...
  'Coño, eres un puto multicines de la infidelidad: varias salas, horarios diferentes y siempre hay funcion para todos los publicos.',
  'Tu pareja te espera en casa mientras tu haces horas extra de mierda. Y las horas extra no son en la oficina, cabron.',
  '[nombre] tiene el movil mas protegido que Fort Knox. Tres contraseñas, huella dactilar y un sistema de borrado automatico, el muy cabron.',
  'Joder, si pagaran por infidelidades, tu ya te habrias jubilado. Con pension completa y piso en la playa.',
  'Hostia puta, tu lealtad en pareja es como un unicornio: bonita idea, pero no existe y nadie la ha visto nunca, mierda.',
  'Eres el tipo que va al funeral de una relacion con el traje puesto para la siguiente boda. Reciclaje emocional de cabron.',
  '[nombre] tiene mas lios que un ovillo de lana en una casa con gatos. Enredado de cojones y sin posibilidad de arreglo.',
  'Coño, tu pene tiene mas aventuras que Indiana Jones. Y como Indiana, siempre acaba en sitios donde no deberia estar.',
  ...
  'Tu compromiso de pareja es como un menu del dia: barato, rapido y lo cambias cada veinticuatro horas, cabron.',
  ...
  'Tu fidelidad tiene la vida util de un cubito de hielo en el infierno: antes de existir ya se ha derretido, gilipollas.',
  '[nombre] no tiene exs, tiene un puto archivo historico. Y todas las carpetas tienen la misma etiqueta: traicion.',
  ...
  'Eres la clase de basura que le dice te quiero a tres personas distintas el mismo dia y se queda tan pancho.',
  '[nombre] miente sobre su pareja como los pescadores sobre el tamaño del pez: con entusiasmo, sin verguenza y exagerando todo.',
  'Coño, tu relacion es como una puerta giratoria: siempre hay alguien entrando mientras otro sale. Circulacion continua de mierda.',
  'Tu pareja confia en ti como un pollo confia en el que le da de comer: sin saber que le estan engordando para el matadero.',
  '[nombre] es mas resbaladizo que una pista de hielo con aceite. Nadie puede sujetarle porque siempre esta deslizandose hacia otra cama.',
  'Joder, si tus cuernos fueran antenas, tu pareja captaria señal hasta en el puto Amazonas.',
  'Hostia, tienes la fidelidad de un perro callejero pero sin la excusa de no tener dueño. Tu tienes y aun asi meas en otros jardines.',
  ...
  'Coño, eres tan infiel que ya deberias venir con una etiqueta de advertencia sanitaria pegada en la frente, cabron.',
  'Tu polla tiene su propio codigo QR para los check-ins en cada cama nueva. Digitalizacion de la infidelidad, el muy cerdo.',
  '[nombre] tiene mas secretos que la CIA y menos escrupulos que la mafia. Combinacion perfecta para ser el peor hijo de puta del grupo.',
  'Joder, engañas con la misma regularidad con la que comes. Tres veces al dia, algun picoteo y de vez en cuando un atracon nocturno.',
  'Hostia puta, tu relacion es como un queso gruyere: mas agujeros que sustancia y cada vez huele peor.',
  ...
  '[nombre] es tan infiel que podria dar clases magistrales en la universidad. Catedra de Deslealtad Aplicada, con practicas incluidas.',
  'Coño, tu bragueta tiene mas aperturas que la Bolsa de Nueva York. Y como en la Bolsa, siempre hay alguien que pierde.',
  'Tu fidelidad se mide en minutos, no en años. Y ni en minutos quedas bien, cabron.',
  ...
  '[nombre] se ha follado a medio grupo de amigos y la otra mitad le tiene en la lista de espera. Cola de carniceria del cabron.',
  'Coño, tu compromiso es como una cancion del verano: suena tres meses, la odias y al año siguiente ni la recuerdas, basura.',
  'Eres el tipo de cabron que llora viendo peliculas romanticas y luego sale a hacer exactamente lo contrario, mierda.',
  ...
  'Hostia puta, engañar es tu cardio. Lo haces todos los dias, mantienes el ritmo y ni sudas la camiseta, cabron.',
  'Tu relacion es como una funda de movil del bazar: la pones sabiendo que no va a durar y la cambias en cuanto se raya un poco.',
  '[nombre] es tan infiel que su pareja deberia recibir prestacion por desempleo emocional. Abandonada en el puesto de trabajo.',
  'Coño, tienes mas dobles vidas que un espia de la Guerra Fria. La diferencia es que el espia al menos servia a un bando.',
  'Tu lealtad de pareja es como un WiFi de bar: la contraseña la tiene todo el mundo y la conexion es una mierda.',
  '[nombre] no tiene corazon, tiene un hostal: entra gente, sale gente y nadie se queda mas de una noche. Sin servicio de desayuno.',
  ...
  'Coño, tu historial es mas largo que la lista de la compra de una familia numerosa. Y todo es basura, cabron.',
  ...
  '[nombre] podria abrir una franquicia con sus infidelidades. Varias sedes, mismo servicio de mierda y cero control de calidad.',
  ...
  'Tu pareja necesita mas una aseguradora que un anillo. Porque lo tuyo es un siniestro total, cabron.',
  '[nombre] se acuesta con la misma facilidad con la que un borracho se cae. Sin control, sin direccion y siempre acabando en el suelo.',
  'Coño, tu fidelidad es como un avion de papel: vuela un segundo, se cae y nadie la recoge porque no vale nada.',
  'Eres la Wikipedia de la infidelidad: informacion para todos, accesible a cualquier hora y que cualquiera puede editar.',
  '[nombre] es el tipo de cabron que le pone los cuernos a su pareja y luego le regala flores. Con la tarjeta de credito de ella.',
  'Joder, si tu cama fuera una pista de aterrizaje, tendria mas trafico que el aeropuerto de Barajas en Semana Santa.',
  'Hostia puta, tienes la exclusividad de una fuente publica: cualquiera puede beber, a cualquier hora y sin pedir permiso.',
  'Tu relacion de pareja es como una cinta de correr: mucho movimiento, ningun avance y al final acabas exactamente donde empezaste.',
  '[nombre] miente con la fluidez de un presentador de telediario. La diferencia es que el presentador al menos tiene guion, el cabron no.',
  'Coño, tu historial sentimental deberia venir con un disclaimer legal: peligro biologico, no tocar sin proteccion y a ser posible no tocar.',
  'Eres el tipo de basura que tiene mas cuentas de citas que cuentas bancarias. Y todas con mas actividad que las del banco.',
  '[nombre] ha puesto mas cuernos que un ganadero de toros bravos. Y al menos el ganadero cobra por ello, cabron.',
  'Joder, tu compromiso es como un condon pinchado: parece que cumple pero no protege de una puta mierda.',
  'Hostia, engañas a tu pareja con la misma cara con la que le dices buenos dias. Psicopata emocional de manual.',
  'Tu infidelidad tiene mas temporadas que Los Simpson. Y como Los Simpson, los ultimos capitulos son basura pero no se acaba nunca.',
  '[nombre] es el cabron que va al cine con la novia y liga con la de la fila de atras. Multitarea de mierda.',
  'Coño, tu polla deberia tener su propia aplicacion de gestion de citas. Un puto CRM de infidelidades.',
  'Eres tan infiel que si existiera una vacuna contra la deslealtad, necesitarias quince dosis y aun asi seguirias contagiando.',
  '[nombre] tiene la relacion como un coche de alquiler: la usa, la maltrata y la devuelve sin limpiar ni pagar los daños.',
  'Joder, tu pareja deberia cobrar un sueldo por aguantarte. Con plus de peligrosidad y horas nocturnas, cabron.',
  'Hostia puta, si te pusieran un rastreador en la polla, el mapa tendria mas rutas que un GPS de repartidor de Amazon.',
...
const INFIEL_MID = [
  'Joder, [nombre], ni eres infiel del todo ni eres fiel del todo. Eres el puto limbo con patas y una ereccion selectiva.',
  ...
  'Hostia, ni te acuestas con nadie ni dejas de mirar a todo el mundo. Eres el miron profesional de las relaciones, cabron.',
  ...
  'Tu compromiso de pareja es como una dieta intermitente: unos dias lo cumples y otros te pones hasta el culo de mierda.',
  '[nombre] tiene la fidelidad de una antena TDT: a veces pilla señal, a veces no, y siempre se ve pixelada de cojones.',
  'Joder, ni engañas ni tranquilizas. Eres el ruido blanco de las relaciones: siempre ahi, molestando sin que nadie sepa por que.',
  'Hostia puta, tu lealtad de pareja es como el agua de la ducha en un hotel barato: nunca sabes si va a salir fria o caliente.',
  'Eres como un examen con las respuestas a lapiz: todo borrable, todo provisional y nada que inspire confianza, cabron.',
  '[nombre] no engaña pero tampoco cierra la puerta del todo. Deja una rendija por si hay corriente de aire de otra cama.',
  'Coño, tu fidelidad depende del baremo del dia. Los lunes leal, los viernes un peligro y los sabados no se sabe, gilipollas.',
  'Tu compromiso es como una suscripcion de prueba: gratuita, temporal y todo el mundo sabe que no la vas a renovar.',
  '[nombre] tiene la mirada mas desviada que un bizco en una montaña rusa. Mirando a todos lados menos donde deberia.',
  'Joder, eres el Schrodinger de la infidelidad: hasta que tu pareja abra la caja, eres fiel e infiel al mismo tiempo, cabron.',
  'Hostia, tu zona gris es mas amplia que el culo de tu tia en Navidad. Y como ese culo, nadie quiere sentarse al lado.',
  'Tu fidelidad es como una conexion Bluetooth de los cojones: a veces se engancha, a veces no y siempre tarda mas de lo que deberia.',
  ...
  'Eres el tipico que dice que no ha pasado nada pero tiene el movil con mas capas de seguridad que el pentagono, cabron.',
  '[nombre] tiene la lealtad de pareja de un interruptor de la luz: on, off, on, off. Nadie sabe en que posicion va a estar.',
  ...
  'Eres el tio que se come el menu del dia con ojos de bufet libre. Pides lo que hay pero te quedas mirando lo que no has pedido.',
  '[nombre] tiene conversaciones que no enseñaria ni bajo tortura china. No son prueba de nada, pero tampoco de inocencia.',
  'Joder, tu fidelidad depende de la hora del dia como la oferta de una pizzeria. A partir de las once todo vale, cabron.',
  ...
  '[nombre] tiene la fidelidad de una veleta en un dia sin viento: de momento quieta, pero todo el mundo sabe que va a girar.',
  'Joder, ni tu madre apostaria dinero por tu fidelidad. Y tu madre te quiere. Eso dice todo lo que hay que decir, cabron.',
  'Hostia puta, tu lealtad de pareja es como el gazpacho: parece que esta frio y estable hasta que alguien lo agita, gilipollas.',
  ...
  '[nombre] flirtea con la misma naturalidad con la que respira. Dice que no significa nada, pero a nadie le sale asi de natural sin practica.',
  'Coño, eres como un mapa de carreteras sin actualizar: la direccion general la tienes, pero los detalles estan todos mal, cabron.',
  ...
  'Joder, eres el puto termometro del grupo: cambias segun el ambiente. Si hay calor te subes, si hay frio te bajas. Cero criterio.',
  ...
  'Eres el que dice que no ha hecho nada pero se pone rojo como un pimiento del piquillo cada vez que le preguntan, cabron.',
  ...
  'Hostia puta, tu compromiso es como una barbacoa en un piso: la intencion esta, el resultado es humo, y los vecinos se quejan.',
  'Tu fidelidad tiene la solidez de una silla de Ikea sin dos tornillos: se sienta alguien y crujen todas las piezas, cabron.',
  ...
  'Joder, tu lealtad de pareja es como una cena de empresa: sonrisas falsas, conversacion vacia y todo el mundo deseando irse a otra parte.',
  'Hostia, eres el tio que no ha robado nunca pero deja la puerta del coche abierta por si ve algo interesante dentro.',
  ...
  'Eres el tipo que borra el historial de navegacion por higiene digital. Claro que si, campeon. Higiene digital, dice el cabron.',
  ...
  'Hostia puta, tu relacion es como un partido de tenis: vas y vienes, cambian los lados y nadie sabe quien lleva ventaja, cabron.',
  'Tu fidelidad es como un mueble de carton: se ve bonito en la foto pero en cuanto le pones peso real se desmorona todo.',
  '[nombre] no engaña fisicamente pero su cabeza ya esta en otra postal. Infidelidad mental cronica, la version cobarde.',
  'Coño, eres como una puerta sin cerrojo: no la has abierto, pero cualquiera podria entrar si empuja un poco. Invitacion abierta.',
  'Tu compromiso es como la lluvia en agosto: cuando cae todos se sorprenden porque nadie se lo esperaba, cabron.',
  ...
  'Tu relacion tiene mas grietas que la fachada de un piso de los años sesenta. Y como esas fachadas, nadie quiere pagar el arreglo.',
  '[nombre] es fiel por temporadas como quien ve series: engancha un tiempo, se aburre y lo deja sin terminar. Patron de mierda.',
  'Coño, tu compromiso es como un calcetin con agujero: tecnicamente puesto, pero falla justo donde mas se nota, cabron.',
  'Eres el que dice que su relacion va genial mientras mantiene tres conversaciones sospechosas abiertas. Genial dice, el cabron.',
  ...
  '[nombre] tiene el historial de busqueda mas sospechoso que un politico antes de elecciones. Todo limpio, demasiado limpio, cabron.',
  ...
  'Eres el tio que no ha suspendido pero tiene un tres con siete raspando. Aprobado de mierda y con la mitad copiada.',
  '[nombre] no engaña pero huele a infiel como un bar huele a fritura: no ves el aceite, pero sabes que esta ahi por los poros.',
  ...
  'Tu relacion es como una piscina municipal: mucha gente ha pasado por ahi, el mantenimiento es minimo y siempre hay tiritas flotando.',
  ...
  'Coño, tu lealtad sentimental es como una farola fundida: el poste esta, pero no ilumina una mierda, cabron.',
  ...
  'Coño, tu relacion es como una mesa de tres patas: se sostiene si no la tocas, pero al minimo movimiento se cae todo al suelo.',
  'Eres el que dice que no pasa nada mientras su pareja encuentra un pelo que no es suyo. Siempre del gato. Claro, el gato, cabron.',
  '[nombre] es fiel por defecto y sospechoso por eleccion. Esa combinacion de mierda es la que mantiene a su pareja en vilo.',
  'Joder, tu compromiso sentimental es como un coche con check engine encendido: funciona, pero todos saben que algo va mal.',
  'Hostia, ni eres el peor ni eres el mejor. Eres la puta media aritmetica de la infidelidad: ni frio ni caliente. Tibio de cojones.',
...
const INFIEL_LOW = [
  'Joder, [nombre], sacas tan poco en infidelidad que hasta las monjas te tendrian envidia. Fiel de cojones, el cabron.',
  ...
  '[nombre] es tan leal que su pareja deberia hacerse un seguro, no por si la engaña, sino por si le atropella un bus de lo segura que esta.',
  'Tu puntuacion de infiel es mas baja que la autoestima de un calvo en una tienda de peines. Y lo digo como halago, cabron.',
  ...
  'Hostia puta, tu nivel de infidelidad es cero como el numero de personas que han sobrevivido a jugar a la ruleta rusa con todas las balas. Imposible.',
  'Coño, eres tan fiel que si tu pareja te dejara en una habitacion con veinte modelos, saldrias preguntando donde esta el wifi para llamarla.',
  'Tu lealtad es como un herpes genital del bueno: no se va nunca, siempre esta ahi y tu pareja se ha acostumbrado a vivir con ella.',
  '[nombre] tiene la infidelidad de un monje tibetano con los cojones de hormigon: simplemente no existe y punto, el muy santo.',
  'Joder, sacas menos en infidelidad que yo saco en el gimnasio. Y eso es decir que no sacas una puta mierda, cabron leal.',
  'Eres tan fiel que si la fidelidad fuese un deporte, te habrian hecho controles antidoping porque nadie se cree que sea natural.',
  'Hostia, [nombre] es mas fiable que la muerte. Que es la unica certeza en esta vida, y ahora resulta que este cabron tambien lo es.',
  'Tu nivel de infidelidad es tan bajo que las estadisticas te excluyen por considerarte un error de medicion, gilipollas leal.',
  ...
  '[nombre] no engaña ni en los sueños. Ese cabron sueña que le ponen los cuernos y se despierta indignado. Fiel hasta dormido.',
  'Joder, tu puntuacion de infiel esta por debajo del nivel del mar. Como Holanda, pero sin tulipanes, solo lealtad.',
  'Tu fidelidad es como una cucaracha: sobrevive a todo, nadie puede con ella y estara ahi cuando todo lo demas se haya ido a la mierda.',
  'Hostia puta, [nombre] tiene menos infidelidad que pelos tiene un huevo. Y el huevo al menos tiene cascara, este cabron no tiene nada.',
  'Eres tan leal que si te clonaran habria que cerrar Tinder. No habria mercado para la infidelidad, joder.',
  '[nombre] es el unico cabron al que le puedes dejar el movil desbloqueado encima de la mesa sin que te suba la ansiedad.',
  'Coño, tu compromiso de pareja es mas solido que una mierda de tres dias de estreñimiento. Inamovible y a prueba de todo.',
  ...
  'Tu puntuacion de infiel es tan baja que hasta el cura te daria la comunion sin confesarte. Limpio como una patena, cabron.',
  ...
  'Eres tan fiel que tu pareja podria mandarte a una despedida de soltera en Benidorm y volveras solo con quemaduras de sol.',
  'Hostia puta, tu infidelidad es como el monstruo del lago Ness: todo el mundo habla de ella pero nadie la ha visto nunca, cabron.',
  'Tu lealtad es tan bestia que deberian estudiarla en la facultad de medicina como anomalia genetica. Tesis doctoral: por que cojones no falla.',
  ...
  'Coño, eres mas fiel que un tatuaje en la cara: siempre ahi, imposible de esconder y todo el mundo lo ve, cabron.',
  'Joder, tu nivel de infidelidad es tan bajo que si fuera temperatura estariamos hablando del cero absoluto. Menos doscientos setenta y tres grados de traicion.',
  '[nombre] no engaña ni cuando le dan la oportunidad en bandeja de plata con servilleta y cubiertos incluidos. Ni asi, hostia.',
  ...
  '[nombre] es fiel como un puto Kalashnikov: funciona en el barro, en el frio, en el desierto y despues de cuarenta años sin limpiarlo.',
  'Coño, tu puntuacion de infiel es tan ridicula que parece un chiste. Pero no es un chiste, es que eres asi de cabron bueno.',
  ...
  '[nombre] tiene la fidelidad de un misil teledirigido: una vez apunta, no se desvia ni aunque le metan interferencias, el cabron.',
  ...
  '[nombre] es tan fiel que si le pusieran delante a toda la seleccion brasileña en bikini, pediria que le pasaran el mando de la tele.',
  'Coño, tu nivel de traicion es tan inexistente que ni con microscopio electronico lo encontrarias. Invisible, cabron.',
  ...
  '[nombre] es mas leal que la puta gravedad. Siempre ahi, sin que nadie se lo pida, sujetando el tinglado sin cobrar horas extra.',
  'Coño, tu nivel de infidelidad es como buscar señal en un bunker: puedes intentarlo, pero no vas a encontrar una mierda.',
  'Joder, [nombre] es tan fiel que sus amigos le usan como ejemplo cuando sus novias les preguntan por que no son como el. Gracias, cabron.',
  ...
  '[nombre] tiene la infidelidad de un Nokia 3310: simplemente no existe. Ese cabron esta diseñado para aguantar sin romperse.',
  ...
  'Coño, eres tan leal que podrian dejarte las llaves del Ferrari, la tarjeta de credito y la novia y no tocarias ninguna. Bueno, el Ferrari quiza.',
  '[nombre] es la prueba de que la evolucion a veces acierta. Entre millones de monos con movil, sale uno que no manda fotos de la polla a desconocidas.',
  'Joder, tu puntuacion de infiel es un insulto para los infieles. Les haces sentir peor de lo que ya se sienten, cabron.',
  ...
  'Eres el tipo de persona que hace que la gente crea que el amor eterno existe. Y eso, viniendo de un cabron como tu, tiene mucho merito.',
  ...
  '[nombre] no es infiel ni por asomo, ni por error, ni por accidente, ni borracho, ni dormido. Ese nivel de control asusta, cabron.',
  ...
  'Hostia puta, eres tan leal que hasta tu perro te mira y piensa joder, este tio me da verguenza de lo fiel que es.',
  '[nombre] es fiel como la hipoteca: siempre ahi, treinta años de compromiso y sin posibilidad de escape. Pero a diferencia de la hipoteca, este mola.',
  'Coño, tu compromiso de pareja es tan solido que se podria usar como material de construccion. Hormigon emocional armado, cabron.',
  'Joder, [nombre] es la clase de fiel que no existe en las peliculas porque el guionista diria que es demasiado inverosimil.',
  'Tu nivel de infidelidad es como un numero imaginario: existe en teoria pero en la practica no tiene presencia en el mundo real.',
  ...
  'Hostia, [nombre] tiene la lealtad de un puto roble: raices profundas, tronco gordo y ni el viento mas cabron lo tumba.',
  'Tu puntuacion de infiel es tan baja que necesitaria notacion cientifica para expresarla. Cero coma cero cero cero una mierda.',
  '[nombre] es el unico cabron del grupo al que puedes presentarle tu novia sin que te suba la bilirrubina. Paz total y merecida.',
  'Coño, tu fidelidad es como encontrar aparcamiento en el centro un sabado: nadie se lo cree hasta que lo ve, y cuando lo ve se queda con la boca abierta.',
  ...
  'Tu lealtad es tan absurdamente grande que a veces da miedo. Como encontrarte un tiburon haciendo yoga: no deberia existir pero ahi esta.',
  ...
  'Eres como una puta roca en medio de una tormenta de mierda: no te mueves, no te quejas y cuando pasa la tormenta sigues ahi, cabron.',
  ...
  'Coño, tu compromiso es tan serio que deberia tener su propio codigo penal. Infringirlo seria delito con pena maxima.',
  'Joder, eres tan leal que si un dia te pillaran siendo infiel, saldrian en las noticias. Titular: cae el ultimo fiel del pais.',
  '[nombre] es el tipo de cabron que te coge el telefono a las cuatro de la mañana, te recoge a ochenta kilometros y encima te invita al desayuno.',
  ...
  'Eres mas fiel que el olor a fritanga en un piso pequeño: imposible de quitar, omnipresente y todo el mundo lo nota, cabron.',
  '[nombre] es tan de fiar que si la confianza fuese dinero, seria el puto Amancio Ortega del grupo. Forrado de lealtad.',
  'Coño, tu puntuacion de infiel es la prueba de que Dios existe. Alguien tuvo que diseñar a este cabron con los valores a tope.',
  ...
  'Tu fidelidad es como la cucaracha: sobrevive al apocalipsis nuclear y sigue ahi cuando ya no queda nada. Indestructible de los cojones.',
  ...
  'Tu nivel de infidelidad es como el segundo piso de un bungalow: no existe. Simplemente no esta, cabron.',
  'Hostia, [nombre], tu lealtad ya no es una virtud, es un puto diagnostico. Pero de los que el medico ve y dice joder, ojala fuera contagioso, cabron.',
];
