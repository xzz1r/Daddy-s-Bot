...
const FIEL_HIGH = [
  ...
  'Eres mas fiel que un perro callejero al primer gilipoyas que le da un trozo de pan. Pero lo digo con carino.',
...
const FIEL_MID = [
  ...
  'Ni fiel ni traidor, el puto limbo de los tibios. Estas ahí flotando sin comprometerte con nada ni con nadie, gilipoyas.',
  ...
  'Coño, [nombre], tienes la lealtad de un perro que menea la cola a todo el que pasa. Fiel a todos es fiel a ninguno, gilipoyas.',
...
const FIEL_LOW = [
  ...
  'Lo de [nombre] es mas falso que un billete de tres euros pintado con rotulador. Y aun así hay gilipoyas que se lo tragan.',
...
const INFIEL_HIGH = [
  ...
  'Tu fidelidad es como el bigote de un adolescente: se nota que intentas, pero nadie se lo toma en serio, gilipoyas.',
  ...
  'Tu fidelidad tiene la vida útil de un cubito de hielo en el infierno: antes de existir ya se ha derretido, gilipoyas.',
...
const INFIEL_MID = [
  ...
  'Coño, coqueteas con la linea pero no la cruzas. Eso no te hace fiel, te hace un cobarde con ganas de joder, gilipoyas.',
  ...
  'Coño, tu fidelidad depende del baremo del día. Los lunes leal, los viernes un peligro y los sabados no se sabe, gilipoyas.',
  ...
  'Hostia puta, tu lealtad de pareja es como el gazpacho: parece que esta frío y estable hasta que alguien lo agita, gilipoyas.',
  ...
  '[nombre] tiene mas likes sospechosos que seguidores normales. Esas interacciones de madrugada no son casualidad, gilipoyas.',
  ...
  'Joder, ni eres el malo de la pelicula ni eres el bueno. Eres el puto extra que sale de fondo y nadie recuerda, gilipoyas.',
  ...
  '[nombre] no ha engañado pero tiene la mirada de quien lo esta considerando seriamente. Esos ojos no mienten, gilipoyas.',
  ...
  '[nombre] esta a un WhatsApp de ser infiel y a un like de ser sospechoso. Esa distancia tan corta ya dice bastante, gilipoyas.',
];
...
const INFIEL_LOW = [
  ...
  'Tu nivel de infidelidad es tan bajo que las estadisticas te excluyen por considerarte un error de medición, gilipoyas leal.',
