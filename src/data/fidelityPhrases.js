...
const FIEL_HIGH = [
  ...
  'Coño, eres el tipo de persona que hace que los demas parezcan unos miserables traidores por comparacion. Gracias por eso.',
  ...
  'Hostia, [nombre], tienes mas fibra moral que cable tiene Movistar tendido. Y funciona mejor, ademas.',
...
const FIEL_MID = [
  ...
  'Tu compromiso es como una ereccion despues de diez cervezas: la intencion esta, pero el resultado es bastante discutible.',
  ...
  'Coño, eres fiel por descarte, no por eleccion. Si tuvieras mas opciones ya habriamos visto tu verdadera cara.',
  ...
  'Hostia, tu compromiso es como una suscripcion de gimnasio: pagas el primer mes motivado y el segundo ya ni apareces.',
...
const FIEL_LOW = [
  ...
  'Tu fidelidad cabe en un dedal y aun sobra espacio para meter toda tu verguenza, que tambien es microscopica.',
  ...
  'Coño, eres tan desleal que si fueras pais te habrian invadido por tus propios aliados. Nadie quiere estar en tu bando.',
...
const INFIEL_HIGH = [
  ...
  'Tu compromiso de pareja es como un menu del dia: barato, rapido y lo cambias cada veinticuatro horas.',
  ...
  'Hostia puta, engañar es tu cardio. Lo haces todos los dias, mantienes el ritmo y ni sudas la camiseta.',
  ...
  'Joder, tu pareja deberia cobrar un sueldo por aguantarte. Con plus de peligrosidad y horas nocturnas.',
...
const INFIEL_MID = [
  ...
  'Eres el tipico que dice que no ha pasado nada pero tiene el movil con mas capas de seguridad que el pentagono.',
  ...
  'Joder, tu fidelidad depende de la hora del dia como la oferta de una pizzeria. A partir de las once todo vale.',
  ...
  'Coño, eres como un mapa de carreteras sin actualizar: la direccion general la tienes, pero los detalles estan todos mal.',
  ...
  'Hostia puta, tu relacion es como un partido de tenis: vas y vienes, cambian los lados y nadie sabe quien lleva ventaja.',
...
const INFIEL_LOW = [
  ...
  'Tu puntuacion de infiel es mas baja que la autoestima de un calvo en una tienda de peines. Y lo digo como halago.',
  ...
  'Coño, eres mas fiel que un tatuaje en la cara: siempre ahi, imposible de esconder y todo el mundo lo ve.',
  ...
  'Coño, tu nivel de traicion es tan inexistente que ni con microscopio electronico lo encontrarias. Invisible.',
  ...
  'Coño, tu compromiso de pareja es tan solido que se podria usar como material de construccion. Hormigon emocional armado.',
