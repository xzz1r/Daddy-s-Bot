...
const APUESTA_GANA = [
  ...
  'Dobla lo que puso. Ahora viene la parte donde lo tira todo, gilipoyas.',
  ...
  'Dobla. Recordadlo cuando vuelva a la mesa a devolverlo enterito, gilipoyas.',
...
const APUESTA_PIERDE = [
  ...
  'Pierde, y encima con esa cara de gilipoyas al que no le cuadra nada.',
  'El aura se lo queda y no da ni una puta explicación. %S.',
  '%A tira la pasta al water y tira de la cadena sin ayuda de nadie, el muy imbécil.',
  ...
  'Sigue mirando la pantalla sin creérselo, el pobre gilipoyas.',
  ...
  'Lo peor es que sabía que iba a pasar. Y pulsó igual, el gilipoyas.',
  ...
  'Fuera del bote y fuera de la conversación. %S y a callar, gilipoyas.',
  ...
  'El aura se queda con lo suyo. Justo lo que este gilipoyas puso.',
  ...
  'Pierde y ahora explica su teoría. Insufrible el gilipoyas.',
  ...
  'La mesa se lo lleva. Se lo lleva todo, mejor dicho, gilipoyas.',
  ...
  '%A pierde y el grupo aprende gratis lo que este gilipoyas ha pagado.',
  ...
  'Se lo traga la mesa. %S y a esperar el cooldown, gilipoyas.',
