...
const BOTE_REVIENTA = [
  ...
  '%C. Asi de gordo estaba, y asi de rapido ha dejado de existir.',
  ...
  '%A revienta la caja: %C. El unico que se atrevio, el unico que cobra.',
  'Ahi va el bote. %C para %A y una leccion gratis para el resto: mirar no paga.',
  'Reventado. %A se lleva %C y vosotros os llevais la sensacion de haber contribuido.',
  '%C de golpe. Que levante la mano el que aporto mas a ese bote sin cobrar nada. Eso.',
  'Y de pronto el bote esta a cero y %A tiene %C. Las matematicas mas dolorosas del grupo.',
];
...
const BOTE_FALLA = [
  ...
  'El bote sigue ahi, intacto, riendose de %A en su cara.',
  '%A lo intento. Es lo unico bueno que se puede decir, y ni eso es verdad.',
  ...
  'El bote se queda. %A tambien, pero con menos aura y mas verguenza.',
  'Vaya. %A tenia un plan y el plan era perder dinero delante de todos.',
...
const BOTE_VACIO = [
  ...
  'Cero. Para que haya bote alguien tiene que fallar robando, y aqui nadie roba.',
  'El bote esta vacio porque llevais una semana sin hacer nada digno de castigo.',
  'Nada dentro. Ni una moneda, ni una migaja, ni una razon para seguir mirando.',
  ...
  'Vacio. Lo unico que se acumula en este grupo son las ganas de no hacer nada.',
  'Ni un duro. El bote lleva tanto tiempo seco que ya cria polvo.',
  'El bote esta a cero y eso dice mas de vosotros que cualquier ranking.',
  ...
  'Ni rastro de aura aqui dentro. Solo eco.',
...
const COMPRA_ESCUDO = [
  ...
  'Comprado. %N detras del cristal, ladrando como los que solo ladran ahi.',
  '%N suelta %C para que nadie le meta la mano. Que original.',
  'Escudo activo. %N pasa de ser un objetivo a ser un objetivo aplazado.',
  '%N ha decidido que su aura vale mas que su dignidad. %C al cambio.',
  ...
  '%N compra proteccion. Lo unico que protege de verdad es no tener nada, pero bueno.',
...
const COMPRA_GANZUA = [
  ...
  'Ganzua en el bolsillo. Ahora %N solo necesita valor, que es lo que no venden aqui.',
  ...
  '%N paga %C por un porcentaje. Literalmente compra suerte, y ni asi.',
  'Herramienta comprada. Le falta la mano.',
  '%N va a por alguien y quiere asegurarlo. Ese alguien deberia mirar por encima del hombro.',
  'Ganzua. %N ya no puede echarle la culpa al azar cuando la cague.',
  '%C fuera. %N ya tiene excusa menos para el proximo fracaso.',
...
const COMPRA_CEBO = [
  ...
  '%N va a ir por ahi enseñando billetes falsos. Que piquen los avariciosos.',
  'Comprado. %N ahora parece un objetivo jugoso, que es mas de lo que ha parecido nunca.',
  ...
  '%N aparentando fortuna. Es lo mas cerca que va a estar de tenerla.',
...
const GANZUA_USADA = [
  ...
  '%A ha quemado su unica ayuda. A partir de aqui, a pelo.',
  'Gastada. Espero que %A la haya usado en alguien con dinero y no en un muerto de hambre.',
  '%A se queda sin herramienta. Ahora veremos cuanto habia de tecnica y cuanto de juguete.',
  ...
  '%A ya no tiene ganzua. Tampoco tenia plan, pero eso es de siempre.',
  ...
  'Quemada. La proxima vez que %A falle, ya no habra a quien culpar.',
  '%A se queda sin filo. Justo cuando mas lo iba a necesitar.',
  'Ganzua gastada, ventaja evaporada, %A igual de perdido.',
  'Y ahi va el unico truco que tenia.',
];
...
const INVENTARIO_VACIO = [
  ...
  'Tu inventario es un espejo: no hay nada y aun asi molesta mirarlo.',
...
const COMPRA_OK = [
  ...
  '%C fuera. %N se lleva el material y todas las excusas se quedan aqui.',
  ...
  'Trato cerrado. %N con el bolsillo mas ligero y el ego mas pesado.',
  ...
  '%N compra. Es lo unico que ha hecho bien en toda la semana.',
...
const COMPRA_POBRE = [
  ...
  'Sin saldo. Vuelve cuando tengas algo mas que ganas.',
  '%N no puede permitirselo y aun asi lo ha intentado. Eso es peor que no tener dinero.',
...
const ESCUDO_SALVA = [
  ...
  '%A eligio mal el dia. %V llevaba escudo y ahora lleva razon.',
  'Nada que hacer. %V se cubrio antes y %A llego tarde a todo, como de costumbre.',
  '%A contra el escudo de %V: cero puntos, mucha verguenza.',
  '%V compro proteccion y %A acaba de justificar el gasto.',
  'Rechazado. A %A le ha salido mas caro el intento que a %V el escudo.',
  '%A se ha llevado un golpe en los nudillos. %V ni se ha enterado.',
  'El escudo cumple. %A aprende que informarse antes sale mas barato.',
  '%V blindado, %A humillado. Reparto justo.',
  '%A ha atacado a la unica persona del grupo que iba preparada. Talento puro.',
  'Escudo aguanta. %A puede volver en doce horas o buscarse un objetivo mas facil.',
...
const CEBO_PICA = [
  ...
  '%A ha picado. %V iba disfrazado de rico y no tiene ni para el autobus.',
  ...
  '%A ha robado humo. %V aparentaba el doble y valia la mitad.',
  ...
  'Picado. %A ha caido en la trampa mas vieja: la codicia.',
  ...
  'Todo ese calculo para robarle a alguien que no tenia nada. Bravo, %A.',
  '%A muerde el anzuelo de %V y se lleva un puñado de nada.',
  'El cebo de %V ha pescado justo al que tenia que pescar.',
...
const CONTRA_GANA = [
  ...
  '%V no se lo penso. %A ahora tiene %C menos y una leccion encima.',
  ...
  'Devuelto con intereses. %A deberia haber elegido a otro.',
  ...
  '%C de vuelta. %A tenia el aura calentita y ha durado noventa segundos.',
...
const CONTRA_PIERDE = [
  ...
  'Menuda ruina: %V quiso vengarse y le ha regalado %C mas a %A.',
  '%V ha doblado la apuesta y ha doblado el ridiculo. %C mas para %A.',
  'El contraataque de %V ha salido como todo lo suyo. %A cobra %C otra vez.',
  '%V insistio. %V perdio. %A no da credito a su suerte.',
  '%C mas. %V acaba de convertir un mal dia en un dia historico.',
  ...
  '%V ha ido a recuperar lo suyo y ha dejado %C mas. Aritmetica del desesperado.',
  ...
  'Y asi es como %V paso de victima a patrocinador.',
];
...
const CONTRA_TARDE = [
  ...
  'Tarde. Mientras mirabas la pared, tu aura ya tenia dueño nuevo.',
  ...
  'Se acabo el tiempo. Tu aura ya es historia y tu venganza tambien.',
  ...
  'Fuera de tiempo. La proxima vez responde en caliente o no respondas.',
...
const DIANA_GOLPE = [
  ...
  '%A le baja los humos al mas buscado y se lleva %C. Nada sabe mejor.',
  ...
  '%A ha hecho lo que el resto solo comentaba: %C al mas buscado.',
  'Golpe a la diana. %C menos para el que presumia de intocable.',
  '%A se lleva %C del bolsillo mejor vigilado del grupo. Aplauso.',
  'El mas buscado acaba de descubrir por que se llama asi. %C para %A.',
  '%C. La corona pesa y hoy le ha caido encima.',
  '%A ha cazado al numero uno. El grupo entero lo va a recordar mas que el.',
  'Diana derribada por %A. %C cambian de manos y el ranking tiembla.',
  'Ir primero tiene premio y tambien tiene precio: %C, pagados hoy.',
