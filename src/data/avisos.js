...
const MAL_ESCRITO = [
  ...
  'Eres tonto del culo. Era escribir un comando bien. Uno. Bien.',
  ...
  'Qué corto eres, hijo de puta. Qué corto. Una sola palabra.',
  'Eres idiota, y encima de los que escriben rápido. La peor mezcla.',
  'No sabes teclear una palabra entera, cretino. Ese es tu nivel y ahí se queda.',
  ...
  'Tu cerebro es una puta piedra y se nota en una sola palabra.',
  ...
  'Tienes la cabeza hueca, cabrón. Te ha ganado una palabra.',
  'Te falta cerebro. No cuidado, no prisa: CEREBRO. Y eso no se pone.',
  'Qué puta mierda de cabeza tienes. Una palabra, gilipollas.',
  'Ahí dentro no hay nada. Lo acabas de demostrar con una palabra.',
  'Tu cabeza no da ni para escribir una palabra entera. Asúmelo de una puta vez.',
  'Una puta palabra y ahí está tu techo. No da para más esa cabeza.',
  'Ese es tu máximo: una palabra bien escrita. Y ni eso. Asúmelo.',
  'Tu techo es escribir una palabra entera. Qué puta pena das.',
  'No das para más. Punto. No es prisa: es que eres corto de cojones.',
  'Hasta aquí razonas: una palabra. Y mañana vas a estar igual.',
  'Ni una palabra te sale entera, hostia. Ese es tu tope y no hay más que rascar.',
  ...
  'Escribir bien una palabra es lo más bajo que se le pide a alguien, y has fallado.',
  'Ni lees, ni escribes, ni aciertas. ¿Qué cojones sabes hacer, exactamente?',
  'No sabes escribir una palabra sin romperla. Ese es el nivel, hostia.',
  ...
  'Se te ha visto el nivel en una palabra, y es un nivel de mierda.',
  ...
  'El grupo acaba de medirte con una palabra. Y has dado bajísimo.',
