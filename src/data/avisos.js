...
const MAL_ESCRITO = [
  ...
  'Qué cojones te pasa en la sesera. Es un puto comando.',
  ...
  'Menuda puta caja vacía tienes por sesera.',
  'Cerebro de mierda. No hay otra forma de decirlo ni hace falta.',
  'No tienes ni media hostia de neuronas, y hoy lo has enseñado gratis.',
  'Tienes la mollera hueca, cabrón. Te ha ganado un comando.',
  'Te falta cerebro. No cuidado, no prisa: CEREBRO. Y eso no se pone.',
  'Qué puta mierda de sesera tienes, gilipollas.',
  'Ahí dentro no hay nada, y lo acabas de firmar delante de todos.',
  'Tu coco no da ni para escribir un comando entero. Asúmelo de una puta vez.',
  ...
  'No sabes escribir un comando sin romperlo. Ese es el nivel, hostia.',
