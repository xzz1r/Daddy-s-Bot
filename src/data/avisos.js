...
const MAL_ESCRITO = [
  ...
  'Mira que eres imbécil. Un comando. UNO, carajo.',
  'Bruto es lo que eres. Era escribir un comando bien. Uno. Bien.',
  'Qué carajo te pasa en la cabeza. Es un puto comando.',
  'Eres idiota y encima lento. Vaya puta combinación.',
  ...
  'Vaya puta caja vacía tienes por cabeza.',
  ...
  'Qué puta mierda de cerebro tienes, imbécil.',
  ...
  'No das para más. Punto. No es prisa: es que eres corto, a secas.',
  'Hasta aquí razonas, y mañana vas a estar exactamente igual.',
  ...
  'Teclear algo corto sin cagarla es lo más bajo que se pide, y has fallado.',
  'Ni lees, ni escribes, ni aciertas. ¿Qué carajo sabes hacer, exactamente?',
  'No sabes escribir un comando sin romperlo. Ese es tu nivel, carajo.',
  'Un comando de nada y encuentras la forma de cagarla. Cerebro roto.',
  ...
  'Delante de todos, imbécil. Y nadie se ha sorprendido, que es lo grave.',
