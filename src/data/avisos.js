...
const MAL_ESCRITO = [
  'Eres imbécil. Así, sin más. Cinco letras y no has podido.',
  'Mira que eres imbécil. Una palabra. UNA, hostia.',
  'Eres tonto del culo. Era copiar. CO-PI-AR.',
  'Qué cojones te pasa en la cabeza. Es una puta palabra.',
  'Eres gilipollas y encima lento. Menuda puta combinación.',
  'Eres estúpido de nacimiento y esto lo confirma cada puta vez.',
  'Puto inútil. Ni copiando. Ese es tu techo y ahí te vas a morir.',
  'Qué corto eres, hijo de puta. Qué corto. Cinco letras.',
  'Eres idiota, y encima de los que escriben rápido. La peor mezcla.',
  'No sabes ni copiar, cretino. Ese es tu nivel real y ahí se queda.',
  'Eres imbécil perdido. Y lo peor es que te crees que no.',
  'Eres cortito. Muy cortito. Y acaba de verlo el grupo entero.',
  'Hijo de puta, era copiar. Copiar. Y no te ha dado el cerebro.',
  'Eres un puto inútil mental. Ahí queda dicho y ahí se queda.',
  'No tienes cabeza. No es una forma de hablar: no la tienes.',
  'Tu cerebro es una puta piedra y se nota en cinco letras.',
  'Menuda puta caja vacía tienes por cabeza.',
  'Cerebro de mierda. No hay otra forma de decirlo ni hace falta.',
  'No tienes ni media hostia de cabeza, y hoy lo has enseñado gratis.',
  'Tienes la cabeza hueca, cabrón. Cinco letras te han ganado.',
  'Te falta cerebro. No cuidado, no prisa: CEREBRO. Y eso no se pone.',
  'Qué puta mierda de cabeza tienes. Cinco letras, gilipollas.',
  'Ahí dentro no hay nada. Lo acabas de demostrar con una palabra.',
  'Tu cabeza no da ni para copiar. Asúmelo de una puta vez.',
  'Cinco putas letras y ahí está tu techo. No da para más esa cabeza.',
  'Ese es tu máximo. Una palabra copiada, y ni eso. Asúmelo.',
  'Tu techo es una palabra de cinco letras. Qué puta pena das.',
  'No das para más. Punto. No es prisa: es que eres corto de cojones.',
  'Hasta aquí razonas. Cinco letras. Y mañana vas a estar igual.',
  'Ni con el modelo delante, hostia. Ese es tu tope y no hay más que rascar.',
  ...
  'Cinco letras. CINCO. Y tu puto cerebro no ha dado.',
  'Copiar es lo más bajo que se le puede pedir a alguien y has fallado.',
  'Ni lees, ni copias, ni aciertas. ¿Qué cojones sabes hacer, exactamente?',
  'No sabes seguir dos pasos. Leer y repetir. Dos, hostia. Dos.',
  'Te lo dan hecho y encuentras la forma de joderlo. Eso es un cerebro roto.',
  ...
  'Ni copiar. Se te pide lo mínimo del mundo y ni eso, comemierda.',
  ...
  'Tienes el mismo problema que hace un mes y el que viene igual. Eres tú.',
  'Hay errores de dedo y luego está lo tuyo, que es de cabeza y es permanente.',
  'Eso no se entrena, no se estudia y no se cura. Es lo que eres.',
  'Una puta palabra mal escrita y ya sabe el grupo hasta dónde das. Nada.',
  'Se te ha visto el nivel en cinco letras, y es un nivel de mierda.',
  ...
  'El grupo acaba de medirte con cinco letras. Y has dado bajísimo.',
