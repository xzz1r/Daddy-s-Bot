...
const AL_BOT = [
  ...
  '¿Ni mencionar sabes, gilipoyas? Esa mierda iba para otra persona, no para mí.',
  ...
  'No soy tu objetivo, gilipoyas. Aprende a mencionar o suelta el móvil.',
...
const MAL_ESCRITO = [
  ...
  'Mira que eres imbécil. Uno. UNO, hostia. Y te ha salido torcido.',
  'Tonto del culo es lo que eres. Era escribir un comando bien. Uno.',
  'Qué cojones te pasa en la cabeza. Lo has destrozado al teclearlo.',
  'Ni te sale bien, gilipoyas. Y encima lento. Menuda puta combinación.',
  ...
  'Qué corto eres, hijo de puta. Ni teclearlo bien, y delante de todos.',
  ...
  'Eres imbécil perdido. Lo has puesto mal y aún te crees que no.',
  ...
  'Eres un puto inútil mental. Mira cómo lo has dejado.',
  ...
  'Menuda puta caja vacía tienes por cabeza. Mira lo que has puesto.',
  'Cerebro de mierda. Lo que has puesto ahí no se parece a nada.',
  'No tienes ni media neurona, y lo que acabas de poner lo demuestra.',
  'Tienes la cabeza hueca, cabrón. Te ha ganado un comando.',
  'No te ha salido mal por prisa. Te falta CEREBRO, y eso no se pone.',
  'Qué puta mierda de cerebro tienes, gilipoyas. Ni teclearlo bien.',
  ...
  'Una puta palabra mal puesta y ahí está tu techo. No da para más.',
  'Ese es tu máximo: un comando bien escrito. Y ni eso. Asúmelo.',
  'Tu techo es teclear algo corto sin romperlo. Qué puta pena das.',
  'Te ha salido mal y no es prisa: no das para más, corto de cojones.',
  ...
  'Una palabra. UNA. Y te ha salido otra cosa, puto cerebro de adorno.',
  ...
  'Teclearlo bien lo hace un crío de ocho años. Tú no. Piensa en eso.',
  ...
  'No te ha salido mal por despiste. Eres corto, y viene de fábrica.',
  ...
  'Lo tecleas igual de mal que hace un mes, y el que viene igual. Retraso.',
  ...
  'Lo has puesto mal delante de todos, gilipoyas. Y nadie se ha sorprendido.',
