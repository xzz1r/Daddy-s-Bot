...
const AURA = {
  blessed: [
    ...
    'Hoy no hubo debate. El número cerró el puto caso, ridículo. coño Menudo numerito, coño, joder.',
    ...
    'Sacaste respeto por la vía rápida: el marcador, gilipollas. basura Menudo numerito, basura, joder.',
    ...
    'Ganaste tan claro que hasta el más listo se calló, asco. joder Y el grupo tomó nota, joder, joder.',
    'Te tocó el premio gordo del silencio ajeno,. mierda Sin anestesia posible, mierda, joder.',
    ...
    'Nadie tenía plan B para cuando tú ganas. Se notó,. asco Sin anestesia posible, asco, joder.',
    ...
    'Ganaste de verdad. El resto es envidia con WiFi, cabrón. joder Y el grupo tomó nota, joder, joder.',
    'Les rompiste el pronóstico y el pronóstico eras tú perdiendo, asco. mierda Sin anestesia posible, mierda.',
    'Hoy el aura habló más alto que los haters,. coño Menudo numerito, coño, joder.',
    ...
    'Sacaste peso real en un chat de pluma, gilipollas. fracasado Se te ve a la legua, fracasado, joder.',
    ...
    'Nadie te lo va a recordar mañana. Disfrútalo hoy,. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Les diste en el orgullo con un solo número, mierda. mierda Sin anestesia posible, mierda, joder.',
    'Hoy el aura te puso donde el chat no te quería ver, cabrón. coño Menudo numerito, coño, joder.',
    ...
    'Te tocó el turno de hacer tragar a esta gente, basura. asco Sin anestesia posible, asco, joder.',
    ...
    'Les cambiaste el humor del grupo con una tirada, coño. joder Y el grupo tomó nota, joder, joder.',
    ...
    'Sacaste un golpe que no se limpia con un emoji, patético. asco Sin anestesia posible, asco, joder.',
    'Hoy estuviste arriba y se notó en cada silencio, basura. basura Menudo numerito, basura, joder.',
  ...
  gain: [
    ...
    'Hoy no perdiste. En este chat eso ya es noticia, basura. basura Menudo numerito, basura, joder.',
    ...
    'Migaja de aura. En tu historial brilla como un faro, basura. basura Menudo numerito, basura, joder.',
    ...
    'Suma ligera. No inventes una saga alrededor, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Te dieron aire. No lo gastes gritando, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'Ganaste de penalti. Tómalo y cállate, basura. basura Menudo numerito, basura, joder.',
    ...
    'Un empujón mínimo en un historial de caídas,. joder Y el grupo tomó nota, joder, joder.',
    ...
    'Poco, limpio, olvidable. Ideal para ti, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Hoy el aura no te escupió. Eso ya es progreso, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Sumaste migajas. En tu mesa parecen banquete, asco. patético Y el grupo tomó nota, patético, joder.',
    'Ganancia discreta. El grupo no necesita narrador, patético. asco Sin anestesia posible, asco, joder.',
    'Te subieron un punto. No firmes autobiografía, basura. basura Menudo numerito, basura, joder.',
    'Hoy no fuiste el fail. Disfruta el anonimato, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Suma pequeña y ego en observación, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Te dieron algo. No pidas propina de respeto,. joder Y el grupo tomó nota, joder, joder.',
    ...
    'Sumaste. Punto. El resto es relleno, asco. patético Y el grupo tomó nota, patético, joder.',
    ...
    'Te subieron la moral un milímetro. No abuses,. joder Y el grupo tomó nota, joder, joder.',
    'Suma ligera en un océano de pérdidas, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Hoy no bajaste el promedio del grupo. Casi un favor, gilipollas. coño Menudo numerito, coño, joder.',
    'Migaja de victoria. Guárdala donde no se te pierda, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Ganaste de callado. Sigue así, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'Hoy el aura te dio el mínimo vital, basura. basura Menudo numerito, basura, joder.',
    ...
    'Empujón discreto. No lo conviertas en identidad,. joder Y el grupo tomó nota, joder, joder.',
    'Te subieron sin pedir opinión al grupo. Mejor, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Poco pero positivo. En tu gráfica es un milagro, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy no fuiste noticia mala. Eso ya basta, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Gain tibio. Cierra el turno y no insistas, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'Hoy el marcador te dejó vivir. Aprovecha, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Ganaste menos de un titular y más de una derrota, fracasado. fracasado Se te ve a la legua, fracasado.',
    'Puntos de consolación con disfraz de victoria,. joder Y el grupo tomó nota, joder, joder.',
    'Te tocó subir. El karma ya está revisando el recibo, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Suma sin fanfarria. Lo único decente del día, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Ganaste poquito. El grupo ni abrió el hilo, asco. patético Y el grupo tomó nota, patético, joder.',
    'Subida de las que no cambian tu reputación, patético. asco Sin anestesia posible, asco, joder.',
    'Te dieron un respiro. No lo conviertas en discurso, basura. basura Menudo numerito, basura, joder.',
    ...
    'Sumaste. El chat bostezó. Equilibrio restaurado,. joder Y el grupo tomó nota, joder, joder.',
    'Te subieron un poco la autoestima prestada, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Poco aura nuevo. No firmes contratos con el destino, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy estuviste en verde. No te hagas el empresario, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Suma ligera y sin testigos emocionados, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Ganaste lo justo para no ser el pobre del turno, asco. patético Y el grupo tomó nota, patético, joder.',
    'Empujón mínimo. Silencio máximo. Ideal, patético. asco Sin anestesia posible, asco, joder.',
    'Te tocaron puntos. No son una disculpa del universo, basura. basura Menudo numerito, basura, joder.',
    'Hoy subiste sin romper el chat. Milagro administrativo, ridículo. ridículo Pura vergüenza ajena, ridículo.',
    'Gain tibio. Tómalo y vuelve a la fila, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Sumaste algo olvidable. Como casi todo lo tuyo,. joder Y el grupo tomó nota, joder, joder.',
    'Te dieron un empujón. No pidas que te carguen, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Poca subida, cero espectáculo. Así da menos asco, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy el aura no te escupió a la cara. Progreso, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Subida discreta en un currículum de caídas, patético. asco Sin anestesia posible, asco, joder.',
    'Te tocó gain. El grupo ya está en el siguiente fail, basura. basura Menudo numerito, basura, joder.',
  ...
  loss: [
    ...
    'Pérdida rutinaria. Como el clima, como tú, patético. asco Sin anestesia posible, asco, joder.',
    'El aura te dio un toque. El chat ni levantó la vista, basura. basura Menudo numerito, basura, joder.',
    'Hoy no ganaste. Noticia del año, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    ...
    'Te quitaron presencia. Te sobraba poco, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy el marcador fue honesto contigo. Duele, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Pérdida discreta. Tu especialidad, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'Te restaron. El universo en modo automático, basura. basura Menudo numerito, basura, joder.',
    'Caída ligera en una carrera de descensos, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Hoy perdiste sin merecer ni el roast completo, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'El aura te recortó. El chat bostezó en estéreo,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste puntos. Subiste en ridículo, cabrón. mierda Sin anestesia posible, mierda, joder.',
    ...
    'Hoy el número te delató otra vez, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Se te fue aura. Se te fue también la esperanza de disimulo, asco. patético Y el grupo tomó nota, patético.',
    'Bajada previsible. El chat tenía el libreto, patético. asco Sin anestesia posible, asco, joder.',
    'Perdiste con cara de siempre. El grupo también, basura. basura Menudo numerito, basura, joder.',
    'Te restaron sin odio. Peor: con indiferencia, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caíste un escalón más hacia el sótano, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Hoy el aura no te pegó fuerte. Te pegó con desgana,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste. El historial aplaudió en silencio, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida menor, daño a la reputación mayor, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Hoy no hubo sorpresa: hubo pérdida, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada rutinaria en tu temporada de fallos, patético. asco Sin anestesia posible, asco, joder.',
    'Perdiste aura y el chat ganó tranquilidad, basura. basura Menudo numerito, basura, joder.',
    ...
    'Hoy el aura te bajó el sueldo de dignidad,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste puntos como quien pierde calcetines, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida tibia. El odio ni se activó, gilipollas. coño Menudo numerito, coño, joder.',
    'Te delató el número otra vez. Qué original, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Se te escurrió aura. El grupo ni puso el cubo, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Hoy perdiste en modo paisaje, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada de las que suman al promedio de fail, patético. asco Sin anestesia posible, asco, joder.',
    'El aura te recortó sin anestesia y sin público, basura. basura Menudo numerito, basura, joder.',
    'Te restaron. Fin del comunicado, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caíste. El chat ya estaba en otra cosa, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Hoy no ganaste respeto. Perdiste el poco que te prestaban,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste y ni el karma se inmutó, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida discreta, historial escandaloso, gilipollas. coño Menudo numerito, coño, joder.',
    'Te quitaron aura. Te dejaron el nick, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'El número fue sincero. Tú no, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Hoy el descenso fue administrativo, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada sin gritos. El silencio te delata igual, patético. asco Sin anestesia posible, asco, joder.',
    'Perdiste puntos. Ganaste en predecible, basura. basura Menudo numerito, basura, joder.',
    'Te restaron presencia en el mapa del grupo, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caída ligera, trayectoria pesada, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Hoy el aura te trató como al paisaje: te restó y siguió,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste. El libreto del chat no necesitó reescritura, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida de las que ya no sorprenden ni a tu madre, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Hoy perdiste sin merecer trending, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada silenciosa. El fail también puede ser introvertido, patético. asco Sin anestesia posible, asco.',
    'El aura te bajó el volumen. El chat agradeció, basura. basura Menudo numerito, basura, joder.',
    'Te restaron. No hay nota al pie, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caíste otro tramo del mismo tobogán, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Hoy el número te dejó donde siempre: un poco más abajo,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste puntos y el ego no se enteró a tiempo, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida menor en un festival de derrotas, gilipollas. coño Menudo numerito, coño, joder.',
    'Te quitaron aura como quien quita polvo, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'El marcador sigue siendo tu único crítico honesto, coño. gilipollas Se te ve a la legua, gilipollas.',
    'Hoy no hubo drama. Hubo pérdida, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada previsible con sello de calidad industrial, patético. asco Sin anestesia posible, asco, joder.',
    'Perdiste. El grupo no pidió explicaciones, basura. basura Menudo numerito, basura, joder.',
    ...
    'Hoy el aura te hizo el favor de no avisar al chat,. joder Y el grupo tomó nota, joder, joder.',
    'Bajaste y el hilo ni se arrugó, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pérdida tibia. Tu temperatura favorita, gilipollas. coño Menudo numerito, coño, joder.',
    'Te delató otra vez el puto número, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Se te escurrió aura. El suelo ya conocía el camino, coño. gilipollas Se te ve a la legua, gilipollas.',
    'Hoy perdiste en silencio de biblioteca, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajada de trámite. Firma aquí, patético. asco Sin anestesia posible, asco, joder.',
    'El aura te recortó el presupuesto de respeto, basura. basura Menudo numerito, basura, joder.',
    'Te restaron. Caso cerrado sin forense, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
  ...
  spiral: [
    ...
    'Racha de mierda con firma autógrafa tuya, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Spiral: el arte de empeorar con constancia, asco. patético Y el grupo tomó nota, patético, joder.',
    'Bajas otra vez. El sótano aplaude en eco, patético. asco Sin anestesia posible, asco, joder.',
    ...
    'El rojo te queda de uniforme. Hoy también,. joder Y el grupo tomó nota, joder, joder.',
    'Caes y caes. El chat ya trajo palomitas mentales, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Racha tan larga que parece proyecto personal, gilipollas. coño Menudo numerito, coño, joder.',
    'Sigues en negativo como pez en el agua, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Cada pérdida suma al monumento del fail, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'El spiral te abraza y tú le das las gracias, asco. patético Y el grupo tomó nota, patético, joder.',
    'Otra bajada. El suelo pide refuerzos, patético. asco Sin anestesia posible, asco, joder.',
    'Tu historial de pérdidas ya no cabe en un mensaje, basura. basura Menudo numerito, basura, joder.',
    ...
    'El chat enumeró tus caídas y se quedó sin dedos,. joder Y el grupo tomó nota, joder, joder.',
    'Otra más. El sótano renueva el contrato, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pierdes en bucle y el bucle ya es tu casa, gilipollas. coño Menudo numerito, coño, joder.',
    'Spiral mode activado hace tanto que olvidaste el verde, mierda. cabrón Pura vergüenza ajena, cabrón.',
    'Sigues bajando el promedio moral del hilo, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'El rojo te queda mejor que cualquier victoria tuya, basura. basura Menudo numerito, basura, joder.',
    ...
    'El grupo ya no pregunta si perdiste: pregunta cuánto,. joder Y el grupo tomó nota, joder, joder.',
    'Spiral: perder con la fe de quien no conoce otro oficio, cabrón. mierda Sin anestesia posible, mierda.',
    'Tu racha negativa es el clima del chat, gilipollas. coño Menudo numerito, coño, joder.',
    'Bajas otra vez. El archivo suspira, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Sigues excavando el sótano personal, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Otra pérdida. El eco responde antes que el grupo, asco. patético Y el grupo tomó nota, patético, joder.',
    'Racha tan seria que parece maldición barata, patético. asco Sin anestesia posible, asco, joder.',
    'El aura te empuja abajo y tú no pones freno, basura. basura Menudo numerito, basura, joder.',
    ...
    'Sigues en rojo. El chat cambió de color de tema,. joder Y el grupo tomó nota, joder, joder.',
    'Otra bajada para el museo de tus derrotas, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Pierdes y el historial te da la razón otra vez, gilipollas. coño Menudo numerito, coño, joder.',
    'La racha te posee. Tú solo firmas el parte, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Sigues cayendo sin público entregado. Hasta el odio se aburre, coño. gilipollas Se te ve a la legua, gilipollas.',
    'Spiral sin plot twist. Solo gravedad, asco. patético Y el grupo tomó nota, patético, joder.',
    'Otra pérdida. El sótano te pone apodo, patético. asco Sin anestesia posible, asco, joder.',
    'Tu descenso ya es contenido evergreen del grupo, basura. basura Menudo numerito, basura, joder.',
    ...
    'Sigues en el pozo y pides otra pala,. joder Y el grupo tomó nota, joder, joder.',
    'El aura te confirma el sótano cada puta tirada, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Otra más. El chat ni abre la notificación, gilipollas. coño Menudo numerito, coño, joder.',
    'Spiral: arte contemporáneo de empeorar, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Sigues bajando. El fondo envía recuerdos, patético. asco Sin anestesia posible, asco, joder.',
    'Otra caída. Firma al pie, basura. basura Menudo numerito, basura, joder.',
    'Tu historial negativo es un género literario, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Spiral mode sin salida de emergencia, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Bajas otra vez. El grupo usa tu racha de reloj,. joder Y el grupo tomó nota, joder, joder.',
    'El rojo te abraza. Tú le devuelves el abrazo, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Otra pérdida en la serie infinita, gilipollas. coño Menudo numerito, coño, joder.',
    'Sigues en descenso libre con sonrisa de costumbre, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'La racha te escribió la biografía, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Caes. El sótano enciende la luz de bienvenida, asco. patético Y el grupo tomó nota, patético, joder.',
    'Spiral con sello personal. Inconfundible, patético. asco Sin anestesia posible, asco, joder.',
    'Otra bajada. El archivo ya tiene carpeta con tu nombre, basura. basura Menudo numerito, basura, joder.',
    'Pierdes y el eco dice te lo dije, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Sigues profundizando. El chat cerró el telescopio, fracasado. fracasado Se te ve a la legua, fracasado.',
    'Racha de mierda con continuidad argumental,. joder Y el grupo tomó nota, joder, joder.',
    'El aura te empuja y tú no tienes suelo, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Otra más al contador del fail eterno, gilipollas. coño Menudo numerito, coño, joder.',
    'Spiral: perder como forma de vida, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Bajas. Nadie pone red. Nadie miraba, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    ...
    'Otra caída libre documentada, basura. basura Menudo numerito, basura, joder.',
    ...
    'Pierdes otra vez. El libreto no cambió una coma,. joder Y el grupo tomó nota, joder, joder.',
    'La racha te tiene de protagonista involuntario, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Bajas con la fe del que no conoce el freno, gilipollas. coño Menudo numerito, coño, joder.',
    'Otra pérdida. El chat bostezó en 4K, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Sigues cayendo. El fondo manda postales, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Spiral sin final feliz ni final, asco. patético Y el grupo tomó nota, patético, joder.',
    'Tu descenso es el único arco estable de tu historia, patético. asco Sin anestesia posible, asco, joder.',
    'El aura firma el parte y tú pones la huella, basura. basura Menudo numerito, basura, joder.',
  ...
  cursed: [
    ...
    'Hoy fuiste el aviso sanitario del comando, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Pérdida de las que apagan la conversación, patético. asco Sin anestesia posible, asco, joder.',
    'Te bajaron el telón a la fuerza. Sin bis, basura. basura Menudo numerito, basura, joder.',
    'Hoy el número te dejó en evidencia sin anestesia, ridículo. ridículo Pura vergüenza ajena, ridículo.',
    'Caída libre con público incómodo, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Perdiste tanto que hasta el odio se sintió saturado,. joder Y el grupo tomó nota, joder, joder.',
    'El chat vio el desastre y fingió mirar el móvil, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Bajada histórica en tu temporada de mierda, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy el aura firmó tu sentencia en voz alta, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Hoy fuiste el tutorial de cómo no tirar, basura. basura Menudo numerito, basura, joder.',
    'El número te dejó sin ángulo de defensa, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Pérdida pública, dignidad privada en llamas, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Te hundieron y el eco todavía se ríe bajo,. joder Y el grupo tomó nota, joder, joder.',
    'Bajada de las que cambian el tono del hilo entero, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Hoy el aura te usó de piñata numérica, gilipollas. coño Menudo numerito, coño, joder.',
    'Perdiste en modo ejemplo para el resto, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    ...
    'Te bajaron el aura como quien tira un saco, patético. asco Sin anestesia posible, asco, joder.',
    'Pérdida brutal sin derecho a bis ni a contexto, basura. basura Menudo numerito, basura, joder.',
    'Hoy el marcador te delató en 4K, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caíste fuerte. El grupo cerró el telón por piedad, fracasado. fracasado Se te ve a la legua, fracasado.',
    'El aura te pegó donde más duele: en público,. joder Y el grupo tomó nota, joder, joder.',
    ...
    'Hoy fuiste el fail del día sin competencia, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Te reventaron el contador y la cara se te quedó de yeso, coño. gilipollas Se te ve a la legua, gilipollas.',
    'Pérdida con olor a definitivo, asco. patético Y el grupo tomó nota, patético, joder.',
    'Caída libre documentada para la posteridad del chat, patético. asco Sin anestesia posible, asco, joder.',
    'El número te dejó sin discurso posible, basura. basura Menudo numerito, basura, joder.',
    ...
    'Perdiste en grande y el cringe fue colectivo,. joder Y el grupo tomó nota, joder, joder.',
    'Te usaron de ejemplo y el ejemplo dolió, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Caída tan fea que nadie pidió repetición, gilipollas. coño Menudo numerito, coño, joder.',
    'Hoy el marcador fue un acta notarial de tu desastre, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Pérdida pública sin abogado de oficio, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'El aura te bajó de un golpe limpio y sucio a la vez, asco. patético Y el grupo tomó nota, patético, joder.',
    'Te hundieron el turno. El chat respiró después, patético. asco Sin anestesia posible, asco, joder.',
    'Bajada histórica personal. Felicidades al revés, basura. basura Menudo numerito, basura, joder.',
    'Hoy no hubo debate: hubo sentencia, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Caíste y el eco pidió clemencia, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    'Perdiste tanta aura que el silencio se volvió personaje,. joder Y el grupo tomó nota, joder, joder.',
    'El grupo te vio caer y guardó el momento en la memoria del fail, cabrón. mierda Sin anestesia posible, mierda.',
    'Te destrozaron el número. Nadie soltó el gag barato, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Caída sin red ni narrador emocional, patético. asco Sin anestesia posible, asco, joder.',
    ...
    'Pérdida brutal. Firma y archiva, fracasado. fracasado Se te ve a la legua, fracasado, joder.',
    ...
    'Perdiste en modo tutorial negativo, gilipollas. coño Menudo numerito, coño, joder.',
    'El aura te exhibió y nadie pidió autógrafo, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Caíste tan hondo que el screenshot dolía, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'Hoy el marcador habló más claro que tus excusas, asco. patético Y el grupo tomó nota, patético, joder.',
    'Pérdida pública con sello de calidad industrial, patético. asco Sin anestesia posible, asco, joder.',
    'Te hundieron el aura y la conversación se fue a otro lado, basura. basura Menudo numerito, basura, joder.',
    'Bajada limpia, daño sucio, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'El chat te vio el desastre y practicó la indiferencia educada, fracasado. fracasado Se te ve a la legua, fracasado.',
    'Hoy el aura te hizo el favor de ser honesta,. joder Y el grupo tomó nota, joder, joder.',
    'Perdiste fuerte. El sótano te recibió con alfombra, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Caída de las que se recuerdan en la próxima pelea, gilipollas. coño Menudo numerito, coño, joder.',
    'Te delató el número en alta definición, mierda. cabrón Pura vergüenza ajena, cabrón, joder.',
    'Pérdida sin anestesia ni testigos solidarios, coño. gilipollas Se te ve a la legua, gilipollas, joder.',
    'El aura te bajó el telón a calzón quitado, asco. patético Y el grupo tomó nota, patético, joder.',
    'Hoy fuiste el fail que no necesita narración, patético. asco Sin anestesia posible, asco, joder.',
    'Bajaste y el silencio pesó como una losa, basura. basura Menudo numerito, basura, joder.',
    'Caída libre con cringe de regalo, ridículo. ridículo Pura vergüenza ajena, ridículo, joder.',
    'Perdiste tanto que hasta el roast se quedó corto, fracasado. fracasado Se te ve a la legua, fracasado.',
    'El marcador firmó el parte. Tú solo pusiste la cara,. joder Y el grupo tomó nota, joder, joder.',
    'Te usaron de ejemplo y el ejemplo quedó grabado, cabrón. mierda Sin anestesia posible, mierda, joder.',
    'Hoy el aura no te pegó suave: te puso de cartel, gilipollas. coño Menudo numerito, coño, joder.',
    ...
    'Caíste. El eco todavía está bajando, asco. patético Y el grupo tomó nota, patético, joder.',
