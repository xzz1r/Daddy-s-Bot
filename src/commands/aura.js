...
const AURA = {
  blessed: [
    'Ganaste tan limpio que el chat se quedó sin chiste. Aquí eso casi no pasa: anótalo antes de que el ego te lo gaste en teatro, basura.',
    'Alza gorda. El contador firmó a tu favor y el grupo lo vio entero. No lo conviertas en soberbia barata, patético.',
    'Hoy el aura te eligió sin anestesia positiva. Número arriba, boca cerrada un rato: el silencio también cotiza, ridículo.',
    'Subida de las que duelen al que iba detrás. El ranking no pide permiso para reordenarte; solo lo hace, cabrón.',
    'Botín limpio. El archivo te puso en verde y el resto a tragar saliva. Que no se te suba a la cabeza el wifi, pringado.',
    'Ganancia real, no de pose. El hilo lo registró sin aplauso falso. Sostén el número o el próximo corte te lo cobra, cutre.',
    'Hoy no fue migaja: fue plato. El contador te sonrió y el chat tomó nota. No gastes el crédito en monólogo, basura.',
    'Alza que se siente en el total. Aquí el respeto se farmea con números, no con discursos de sobremesa, patético.',
    'El aura te empujó fuerte. El grupo no te debe la vida; te debe el rastro que acabas de firmar. Cuídalo, ridículo.',
    'Victoria de contador. Sin narrativa heroica: solo el dígito subiendo y el ego en observación, cabrón con suerte.',
    'Hoy el corte salió a tu favor y grande. El archivo no miente. El que discute el número discute con el aire, pringado.',
    'Subida limpia. En este chat eso pesa más que diez mensajes de pose. No lo cambies por teatro barato, cutre.',
    'Aura en verde fuerte. El ranking te acomodó arriba un tramo. Que el orgullo no te baje antes que el próximo tiro, basura.',
    'Ganaste espacio real en el total. No es caridad del bot: es el azar y tu racha. Adminístrala o la pierdes, patético.',
    'Alza de las que callan bocas. El chat vio el número y cambió el tono. No abras la boca de más, basura con suerte.',
    ...
    'Subida que se lee sin narrador. El dígito solo basta. El resto es ruido que no suma aura El archivo no discute el dígito, pringado.',
    'Botín visible. El grupo no aplaude: archiva. Y el archivo te dejó en positivo gordo esta vez El chat ya tomó nota sin pedirte permiso, cutre.',
    'Ganancia de las que reordenan el top. No te creas intocable: el próximo !aura no firma lealtad Aquí el número pesa más que la labia, basura.',
    'Hoy saliste arriba de verdad. El ego querrá discursito; el contador prefiere que calles y sostengas, patético.',
    'Alza sin adorno. Número, punto. En este chat eso vale más que media hora de labia, pringado con racha.',
    'El aura te eligió en grande. No es amor: es tirada. Trátala como capital, no como identidad El total habla solo, cabrón.',
    'Subida gorda registrada. El que iba a reírse se tragó el chiste. No le des material nuevo tan pronto, pringado.',
    'Victoria numérica. El ranking te movió y el hilo lo sintió. Baja el teatro; sube la constancia El grupo lo vio de un vistazo, cutre.',
    'Hoy el total te quedó mejor puesto. Eso se farmea y se pierde. Hoy farmeaste. Mañana no está firmado, basura.',
    'Alza limpia de las que duelen al rival de ranking. Sin sangre: solo dígitos. Suficiente para este chat, patético.',
    'Ganaste aire. El contador te abrió margen. No lo gastes explicando por qué merecías más, fracasado con suerte.',
    ...
    'Aura en modo generoso contigo. Raro. Anótalo. Aquí la generosidad dura lo que dura una tirada Sin narrativa que lo tape, pringado.',
    'Hoy el corte fue hostil… para el que esperaba verte caer. Tú sumaste. Ellos aprendieron el número El total habla solo, cutre.',
    'Botín de verdad. No migaja. El archivo cerró el párrafo a tu favor. Firma y sigue, sin discurso Documentado en el contador, basura.',
    'Alza que se nota en el total de un vistazo. El grupo no necesita subtítulos. El dígito basta El grupo lo vio de un vistazo, patético.',
    'Ganaste. Punto. En este chat eso ya es noticia. No la conviertas en novela de autoayuda barata El archivo no discute el dígito, ridículo.',
    'Subida fuerte. El ranking te reubicó. El ego quiere fiesta; el contador quiere la próxima tirada limpia, cabrón.',
    'Hoy el aura te hizo el trabajo sucio a favor. Cobró el azar en tu cuenta. No digas que era destino Aquí el número pesa más que la labia, pringado.',
    'Victoria de mesa. Sin narrativa. Solo el total subiendo y el chat mirando de reojo, basura afortunada.',
    'Alza registrada sin filtro. El bot no te felicita: te muestra el número. Eso es todo el cariño que hay, basura.',
    'Ganancia gorda. El que lleva la cuenta mental ya te recalculó. No le des motivos para celebrar tu caída, patético.',
    'Hoy saliste verde de verdad. Sostén el número con menos boca y más rastro. Aquí eso cotiza Documentado en el contador, ridículo.',
    ...
    'El contador te sonrió en grande. Raro en este grupo. No lo malgastes en monólogo de sobremesa El archivo no discute el dígito, pringado.',
    'Alza de ranking. No de ego. Confundir las dos es el camino más corto a la próxima espiral, patético.',
    'Ganaste margen. El total lo dice sin adjetivos. Los adjetivos sobran cuando el dígito trabaja Aquí el número pesa más que la labia, basura.',
    'Hoy el aura te empujó al alza fuerte. El chat archivó el resultado. Tú decide si lo cuidas o lo tiras, patético.',
    'Botín visible en el total. Sin poesía. Solo matemática del comando a tu favor esta vez Sin narrativa que lo tape, ridículo.',
    'Subida que cierra bocas un rato. Aprovecha el silencio: dura menos que tu racha, pringado El total habla solo.',
    'Ganaste. El ranking lo firmó. El resto es decoración. No decores de más el momento, basura Documentado en el contador.',
    'Alza gorda sin anestesia positiva. Duele al de abajo. A ti te toca no volverte insoportable tan rápido, cutre.',
    'Hoy el número te eligió. Mañana puede no. Administra el capital como adulto, no como influencer de aura, basura.',
    'Victoria contable. El hilo lo vio. El ego querrá discurso; dale descanso al grupo, ridículo con suerte.',
    'Subida real. No de pose. El archivo no premia relatos: premia el dígito que acabas de farmear Aquí el número pesa más que la labia, ridículo.',
    ...
    'Ganaste espacio. No lo conviertas en trono. Los tronos aquí duran lo que dura un !aura en contra Sin narrativa que lo tape, pringado.',
    'Alza limpia de las que no necesitan hilo de celebración. El número basta y sobra, cabrón El total habla solo.',
    'Hoy el corte te dejó mejor parado. Anota la fecha: las buenas tiradas se recuerdan cuando vuelves a caer, basura.',
    'Botín de contador. El grupo no te ovaciona; te recalcula. Sé digno del recálculo, basura El grupo lo vio de un vistazo.',
    'Subida fuerte registrada. Sin migas de consuelo para el que esperaba tu fail. Solo tu total subiendo, ridículo.',
    ...
    'Alza que se lee en el total de un vistazo. Sin narrador. Sin bis. Solo el dígito a tu favor Aquí el número pesa más que la labia, pringado.',
    'Hoy el aura te hizo rico un tramo. Rico de número, no de carácter. No confundas las cuentas El ranking lo registra entero, cutre.',
    'Victoria de tirada. El azar te guiñó. El ego querrá atribuírselo. No le hagas caso, patético Sin narrativa que lo tape.',
    'Subida gorda. El archivo cerró verde. El próximo mensaje tuyo no debería arruinar el clima, ridículo.',
    'Ganaste margen real. El ranking te movió. Callar un poco también es estrategia de aura Documentado en el contador, ridículo.',
    ...
    'Hoy saliste a favor y se notó. El chat no lo dice con palabras: lo dice dejando de reírse de ti un rato, pringado.',
    ...
    'Subida que duele al ranking ajeno. Sin sangre. Solo matemáticas. Suficiente para este grupo Aquí el número pesa más que la labia, basura.',
    'Ganaste. Punto final del párrafo. No agregues epílogo de soberbia o el próximo corte te lo cobra con intereses, patético.',
    'Alza registrada. El total te quedó más presentable. No lo celebras a gritos: aquí eso se ve cutre Sin narrativa que lo tape.',
    'Hoy el aura te empujó. El grupo recalculó. Tú decide si el nuevo número te dura o se evapora, basura.',
    'Victoria numérica sin poesía. El bot no escribe odas: escribe totales. El tuyo subió. Ya Documentado en el contador, pringado.',
    'Subida fuerte. El que llevaba la cuenta mental apretó los dientes. No le des el placer de verte caer ya, cutre.',
    'Ganaste aire en el total. Respíralo sin discurso. El discurso gasta aura social aunque el número quede, basura.',
    ...
    'Hoy el contador te hizo el trabajo. Tú no fueras y lo arruines con pose de intocable, ridículo Aquí el número pesa más que la labia.',
    ...
    'Subida limpia. El archivo te puso en verde. El resto del hilo a tragar. No pidas aplauso encima Sin narrativa que lo tape, pringado.',
    'Ganaste. En este grupo eso ya es titular. No lo conviertas en editorial de soberbia, cabrón El total habla solo.',
    'Alza real. Sin migaja. El dígito habla y el chat calla un segundo. Aprovecha ese segundo Documentado en el contador, basura.',
    'Hoy el aura te eligió en grande. No digas destino. Di tirada. Y cuida el capital, basura con suerte.',
    'Hoy el total te hizo un guiño gordo. Guiño de número, no de destino. Cuídalo sin discurso, cabrón Aquí el número manda.',
    'Alza real registrada. El chat no trae globos. Trae memoria. No le des material en contra tan pronto, basura.',
    'Ganaste margen fuerte. El margen no es trono. Los tronos aquí duran un !aura, patético El chat tomó nota.',
    'Subida limpia. El archivo te dejó en verde intenso. Intenso se sostiene callando, ridículo Aquí el número manda.',
    'Hoy el contador te empujó arriba de verdad. Arriba se cae más fuerte. Adminístralo, pringado El archivo no discute el dígito.',
    'Botín gordo. El ranking te recalculó. El ego quiere fiesta. La fiesta atrae cursed, cutre El chat tomó nota.',
    ...
    'Hoy saliste verde fuerte. Verde se defiende con menos boca y más rastro, patético El chat tomó nota.',
    'Subida gorda firmada. Firma y sigue. Quedarte monologando es de pringado con racha, ridículo Aquí el número manda.',
    'Ganaste espacio real. Espacio no es corona. La corona aquí es de cartón, cutre El archivo no discute el dígito.',
    'Alza limpia. El buitre se quedó sin carroña un rato. No le regales la próxima, cabrón El chat tomó nota.',
    'Hoy el aura te eligió en grande. Elección de tirada. No de merecimiento cósmico, basura Aquí el número manda.',
    'Botín visible. Ranking movido. Ego en cuarentena. Así se sostiene, patético El archivo no discute el dígito.',
    'Subida fuerte. El grupo te recalculó sin aplauso. El aplauso aquí es trampa, ridículo El chat tomó nota.',
    'Ganaste. Punto. El punto final evita el epílogo de soberbia, pringado Aquí el número manda. El contador no ofrece apelación.',
    'Alza gorda. El total lo grita. Tú no grites. El grito gasta respeto, cutre El archivo no discute el dígito.',
    'Hoy el contador te hizo rico un tramo. Rico de número. Pobre de carácter si lo alardeas, cabrón El chat tomó nota.',
    'Victoria de mesa. Mesa fría. Número caliente. No calientes el ego, basura Aquí el número manda. El contador no ofrece apelación.',
    'Subida registrada sin filtro. Sin filtro también se celebra en silencio, patético El archivo no discute el dígito.'
  ],
  gain: [
    'Hoy no perdiste. En este chat eso ya es noticia. El ranking lo registró sin pedirte aplauso El archivo no discute el dígito, basura.',
    ...
    'Subida chica pero verde. El archivo prefiere eso a tu discurso de “casi gano grande” Aquí el número pesa más que la labia, ridículo.',
    'Ganancia modesta. El total se movió a tu favor. No lo conviertas en leyenda personal, patético El ranking lo registra entero.',
    'Hoy el corte te dejó un poco mejor. Un poco cuenta. Aquí los poco se acumulan o se evaporan Sin narrativa que lo tape, pringado.',
    'Aura arriba un tramo. Sin fiesta. Sin bis. Solo el dígito haciendo su trabajo en silencio El total habla solo, cutre.',
    'Subiste. No es portada; es pie de página positivo. Aun así pesa más que diez mensajes vacíos Documentado en el contador, basura.',
    'Alza de las discretas. El chat casi no lo comenta. Mejor: menos teatro, más total, basura El grupo lo vio de un vistazo.',
    'Hoy el contador te hizo un favor chico. Anótalo. Los favores chicos también se cobran El archivo no discute el dígito, ridículo.',
    ...
    'Verde flojo pero verde. El que esperaba tu caída se quedó con el chiste a medias, ridículo Aquí el número pesa más que la labia.',
    'Subida menor. El ego querrá inflarla. No le hagas caso: el número es el que es, pringado El ranking lo registra entero.',
    'Hoy no sangraste aura. Ya es logro local. No lo celebres como mundial, cutre Sin narrativa que lo tape.',
    'Alza contenida registrada. Mejor administración que otra tirada de soberbia barata El total habla solo, patético.',
    'El aura te dio un empujón chico. Úsalo de colchón, no de trampolín de ego, cabrón Documentado en el contador.',
    'Subiste un poco. El archivo lo firmó. El resto es ruido que no suma, basura El grupo lo vio de un vistazo.',
    'Ganancia discreta. El total respira mejor. Tú también deberías: menos boca, más rastro El archivo no discute el dígito, pringado.',
    'Hoy el corte fue amable en lo mínimo. Lo mínimo aquí se agradece porque lo normal es el fail El chat ya tomó nota sin pedirte permiso, cutre.',
    'Alza chica. No pide hilo de celebración. Pide que no la tires en la próxima, patético Aquí el número pesa más que la labia.',
    'Verde. Punto. En este chat eso ya cierra el párrafo mejor que tu labia, ridículo El ranking lo registra entero.',
    'Subida de mantenimiento. El ranking no te coronó; te dejó de hundir un rato. Aprovecha Sin narrativa que lo tape, ridículo.',
    'Hoy sumaste. Poco. Suficiente para no ser el chiste del momento. No pidas más crédito, basura El total habla solo.',
    'Alza modesta firmada. El contador no hace odas. Solo mueve el total y sigue Documentado en el contador, pringado.',
    'Ganaste aire chico. Respíralo sin discurso de superación. Aquí eso suena a estafa, pringado El grupo lo vio de un vistazo.',
    'Subida contenida. El grupo lo vio y no aplaudió. Perfecto: el aplauso aquí suele ser trampa El archivo no discute el dígito, basura.',
    'Hoy el aura te dejó en positivo menor. Adminístralo como adulto, no como influencer de tiradas El chat ya tomó nota sin pedirte permiso, patético.',
    'Alza sin adorno. Número un poco más alto. Boca en observación. Así se sostiene, cabrón Aquí el número pesa más que la labia.',
    'Sumaste. El archivo no se emocionó. Tú tampoco deberías. La emoción gasta foco, cutre El ranking lo registra entero.',
    'Verde flojo. Mejor que rojo. El ranking te dio una tregua. No la malgastes en teatro, basura Sin narrativa que lo tape.',
    'Hoy no caíste. En este grupo eso es casi una victoria moral. Casi. No la influes, patético El total habla solo.',
    'Alza chica registrada. El que lleva la cuenta mental te recalculó sin drama. Imita eso Documentado en el contador, basura.',
    'Subiste un tramo menor. El total lo refleja. El ego no debería reflejar más que el total El grupo lo vio de un vistazo, patético.',
    'Ganancia de las que no hacen titular. Perfecto. Los titulares aquí suelen terminar mal, ridículo El archivo no discute el dígito.',
    'Hoy el contador te sonrió chiquito. Sonrisa chiquita. No pidas foto del momento, pringado El chat ya tomó nota sin pedirte permiso.',
    'Alza discreta. El hilo no se detuvo a celebrarte. Mejor: sigue el hilo y cuida el número Aquí el número pesa más que la labia, pringado.',
    'Sumaste poco. El poco es capital. El capital se pierde explicando por qué merecías más, basura El ranking lo registra entero.',
    'Verde. Sin fiesta. Sin epílogo. Solo el dígito un poco menos miserable que antes, cabrón Sin narrativa que lo tape.',
    'Hoy el aura te hizo el favor mínimo. El mínimo aquí es lujo. No lo trate como derecho El total habla solo, patético.',
    'Alza contenida. Mejor eso que otra espiral de pérdida. En este chat eso pesa, patético Documentado en el contador.',
    ...
    'Ganaste un colchón chico. No saltes encima. Los saltos aquí terminan en cursed, ridículo El archivo no discute el dígito.',
    'Hoy no fue grande; fue suficiente. Suficiente para no abrir el parte de fallos, basura El chat ya tomó nota sin pedirte permiso.',
    'Alza de mantenimiento del ego. El número subió un poco. El ego debería quedarse quieto Aquí el número pesa más que la labia, basura.',
    'Sumaste. El archivo cerró el renglón en verde flojo. Ya. Siguiente tirada sin discurso, cabrón El ranking lo registra entero.',
    'Subida chica. El chat casi bosteza. Mejor bostezar que reírse de tu caída, pringado Sin narrativa que lo tape.',
    'Hoy el total te quedó un peldaño mejor. Un peldaño. No construyas escalera imaginaria, cutre El total habla solo.',
    'Alza sin narrativa. El bot no escribe crónicas de subidas chicas. Solo el número, basura Documentado en el contador.',
    'Ganancia modesta. El que esperaba drama se aburrió. Aburrir al buitre también es victoria El grupo lo vio de un vistazo, cutre.',
    'Verde menor. Registrado. Sin bis. Sin hilo de gratitud al universo, patético El archivo no discute el dígito.',
    'Hoy el aura te empujó despacio. Despacio llega más lejos que tu soberbia, ridículo El chat ya tomó nota sin pedirte permiso.',
    ...
    'Sumaste poco y bien. Lo bien es no haber sangrado. Anota esa diferencia, basura El ranking lo registra entero.',
    'Subida discreta. El grupo no cambió de tema por ti. Perfecto. No fuerces el tema, pringado Sin narrativa que lo tape.',
    'Hoy el corte te dejó respirar. Respira. No discurses. El discurso atrae el próximo fail, cutre El total habla solo.',
    'Alza chica firmada en el total. El ego firma de más. Táchalo, patético Documentado en el contador. El contador no ofrece apelación.',
    'Ganaste margen mínimo. El mínimo sostiene. El máximo discurso hunde, ridículo El grupo lo vio de un vistazo.',
    'Verde. Punto. Siguiente. En este chat la economía de palabras también cotiza, cabrón El archivo no discute el dígito.',
    'Hoy no perdiste aura. Titular local. No lo mandes a portada nacional, basura El chat ya tomó nota sin pedirte permiso.',
    'Alza de las silenciosas. Las silenciosas duran más que las gritadas, pringado Aquí el número pesa más que la labia.',
    'Subiste un poco. El archivo lo sabe. Tú también. No hace falta hilo, cutre El ranking lo registra entero.',
    'Ganancia contenida. Mejor administración que otra noche de espiral, patético Sin narrativa que lo tape.',
    'Hoy el contador fue neutro-positivo contigo. Acepta la neutralidad como regalo, ridículo El total habla solo.',
    'Alza menor. El top no se movió; tu sótano sí un centímetro. Centímetro vale, cabrón Documentado en el contador.',
    'Sumaste. Sin poesía. Sin destino. Solo tirada. Cuídala, basura El grupo lo vio de un vistazo. El contador no ofrece apelación.',
    'Subida chica. El buitre del chat se quedó sin carroña un rato. Ya es algo, pringado El archivo no discute el dígito.',
    'Hoy el aura te dejó en paz relativa. La paz relativa aquí es lujo importado, cutre El chat ya tomó nota sin pedirte permiso.',
    'Alza firmada. El número un poco menos triste. No pidas medalla por eso, patético Aquí el número pesa más que la labia.',
    'Ganaste un respiro. No lo conviertas en mitin. Los mitines gastan lo que el respiro dio, ridículo El ranking lo registra entero.',
    'Verde flojo. El ranking te recalculó sin odio. Imita al ranking: menos odio, más número, cabrón Sin narrativa que lo tape.',
    'Hoy sumaste sin hacer ruido. El silencio te favorece más que tu labia, basura El total habla solo. El contador no ofrece apelación.',
    'Alza discreta. Guardala. Las discretas pagan mejor a largo plazo que el teatro, pringado Documentado en el contador.',
    'Subida menor. El archivo no abrió champán. Tú tampoco deberías. No hay champán, cutre El grupo lo vio de un vistazo.',
    'Ganancia de colchón. Si te tiras de cabeza igual te partes. No te tires, patético El archivo no discute el dígito.',
    'Hoy el total te hizo un guiño. Un guiño. No un contrato de intocable, ridículo El chat ya tomó nota sin pedirte permiso.',
    'Alza chica. Cierra el párrafo. Abre el siguiente sin soberbia, cabrón Aquí el número pesa más que la labia.',
    'Sumaste poco. El poco bien administrado vence al mucho mal gastado, basura El ranking lo registra entero.',
    'Verde. Registrado. Sin epílogo. El epílogo es de los que van a caer, pringado Sin narrativa que lo tape.',
    'Hoy no fue cursed. Ya puedes exhalar. Exhala sin discurso de supervivencia, cutre El total habla solo.',
    'Alza contenida. El chat lo archivó y siguió. Tú también sigue, sin monólogo, patético Documentado en el contador.',
    'Subiste. El número lo dice. Cualquier adjetivo de más sobra, ridículo El grupo lo vio de un vistazo.',
    'Hoy sumaste un poco más. Un poco más es capital. No lo conviertas en mitología, cabrón Aquí el número manda.',
    'Alza chica extra. El colchón crece milímetro a milímetro. Los milímetros cuentan, basura El archivo no discute el dígito.',
    'Subida contenida. Mejor eso que el discurso de casi. El casi no cotiza, patético El chat tomó nota. El contador no ofrece apelación.',
    'Verde menor otra vez. Acumular menores vence al teatro de un grande fallido, ridículo Aquí el número manda.',
    'Hoy el total te hizo un favor chico. Favor chico. Cóbralo en silencio, pringado El archivo no discute el dígito.',
    'Ganancia discreta. El archivo sonríe flojo. Tú no sonrías de más, cutre El chat tomó nota. El contador no ofrece apelación.',
    'Alza de mantenimiento. Mantener también es ganar en este chat, cabrón Aquí el número manda. El contador no ofrece apelación.',
    'Sumaste. El ranking no abrió champán. Perfecto. No hay champán, basura El archivo no discute el dígito.',
    'Hoy no sangraste. Titular local renovado. No lo mandes a nacionales, patético El chat tomó nota. El contador no ofrece apelación.',
    'Subida chica firmada. Firma corta. Epílogo prohibido, ridículo Aquí el número manda. El contador no ofrece apelación.',
    'Verde flojo. Flojo y suficiente. Suficiente es una palabra adulta, pringado El archivo no discute el dígito.',
    'Alza contenida. El buitre bostezó. Mejor bostezo que pico, cutre El chat tomó nota. El contador no ofrece apelación.',
    'Hoy el aura te dejó respirar otra vez. Respira. No discurses, cabrón Aquí el número manda. El contador no ofrece apelación.',
    'Ganancia mínima con máximo de sentido. El sentido es no haber caído, basura El archivo no discute el dígito.',
    'Subiste un peldaño. Peldaño. No escalera al cielo, patético El chat tomó nota. El contador no ofrece apelación.',
    'Alza discreta. Guardala como adulto. Los adultos no hacen hilo, ridículo Aquí el número manda. El contador no ofrece apelación.',
    'Hoy el contador fue neutro-positivo. Acepta la neutralidad, pringado El archivo no discute el dígito.',
    'Sumaste poco. El poco bien llevado vence al mucho mal gastado, cutre El chat tomó nota. El contador no ofrece apelación.',
    'Verde. Punto. Siguiente sin soberbia, cabrón Aquí el número manda. El contador no ofrece apelación.',
    'Alza chica. El silencio te favorece más que tu labia, basura El archivo no discute el dígito. El contador no ofrece apelación.'
  ],
  loss: [
