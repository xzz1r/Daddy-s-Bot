...
const AURA = {
  blessed: [
    ...
    'Joder, nadie te felicitó y eso es lo mejor que te ha pasado. La envidia muda es el premio gordo.',
    'Tu tirada hizo que dos personas borrasen lo que estaban escribiendo. Ese es el mejor cumplido del puto chat.',
    ...
    'Hoy te tocó estar arriba y el puto grupo lo asumió sin gracia ninguna. Les jodió, y se notó.',
    'El grupo tuvo que tragarse lo que estaba preparando. Les cambiaste el puto guion en un turno.',
    'Joder, alguien tenía el roast en el cuadro de texto y le dio a borrar. Conserva esa captura mental.',
    'Joder, el bocazas se mordió la lengua. Se le ha visto el diente. Hoy no era su día, era el tuyo.',
    'Tres personas abrieron el puto ranking y lo cerraron. No querían ver tu nombre ahí arriba.',
    'Joder, alguien escribió "¿está bien el bot?" y no lo mandó. Lo estaba. El fallo eras tú ganando.',
    'El que siempre comenta se fue a beber agua. Cuando vuelva, tu número seguirá ahí, joder.',
    'Habían preparado el "ya ves" y se les ha atragantado. Traga, puto grupo. Traga entero.',
    'Joder, el sticker de risa se quedó en "elegir". Nadie lo mandó. Ese aborto es tu medalla.',
    'Joder, alguien dijo "suerte" hace diez minutos. Que se trague la palabra con sal.',
    'Joder, el que te tenía de chiste fijo ha tenido que buscar otro. Hoy has dejado un hueco laboral.',
    ...
    'El aura te ha puesto el foco. El escenario era una mesa de bar. Aun así, te han mirado.',
    ...
    'Alguien ha guardado captura "por si acaso". Por si acaso mañana vuelves a ser el de siempre.',
    'Has ganado sucio de tan limpio: sin debate, sin asterisco, sin "sí, pero". Eso aquí es un crimen.',
    'El que iba a mandar el "otra vez tú" se ha encontrado con que esta vez no. Se le ha visto el corte.',
    'Te han hecho el respeto de los funerales invertido: no estás muerto. Estás arriba. Peor para el ambiente.',
    'Has apagado el modo burla como se apaga una tele a las tres. El LED rojo se ha quedado mirándote.',
    ...
    'Te han concedido el trono de plástico. Es plástico. Es un rato. Aun así, estás sentado tú.',
    'El puto chat te ha tragado como se traga un hueso de aceituna: de lado, y con un gesto feo.',
    'Has obligado a que el "era de esperar" se use al revés. No lo esperaban. Por eso duele.',
    'Alguien ha puesto "joder" y se ha quedado ahí. Sin segunda línea. Ese joder es todo el discurso.',
    'Has hecho que el puto grupo te mire de reojo, que es la única forma honesta de respeto aquí.',
    'El que tenía la broma de siempre se ha encontrado con que la de siempre ya no encaja, cabrón.',
    'Te han hecho sitio como se hace sitio en un ascensor lleno: de mala gana, y oliendo a derrota ajena.',
    'Has cerrado el ciclo del chiste. Hoy el punchline eras tú, y no del lado que ellos querían.',
    'El aura te ha puesto el micrófono. El karaoke se ha callado. Canta bajo, que esto no dura.',
    'Has ganado y el puto ranking ha hecho un ruido que nadie quería oír. Ese ruido es tuyo.',
    'Te han tragado el puto resultado como se traga un hueso en un bar: entre dientes, sin reclamar al camarero.',
    'El puto grupo te ha dado el respeto de los que están haciendo cola detrás. Les has adelantado. Les jode.',
    'Has dejado un "me cago en" a medias. La frase no tenía final que no te reconociera.',
    'Alguien ha ido a ver tu historial por si esto venía de antes. No venía. Por eso pesa más.',
    'Te han puesto en el plano y no sabían dónde mirar. El plano eras tú. Qué incomodidad más rica.',
    'Has hecho que el "este no" se convierta en "este sí" durante un minuto. Un minuto de infierno ajeno.',
    'El puto chat te ha pagado en silencio. Aquí el silencio es moneda alta. No la gastes en un discurso.',
    'Has ganado de una forma que obliga a recalcular el chiste del puto grupo. El chiste ya no eres tú. Raro, ¿eh?',
    'Te han mirado como se mira un radar en verde: no debería pitar, y está pitando, y eres tú.',
  ...
  gain: [
    ...
    'Coño, el café de máquina. Caliente dos sorbos y luego sabe a cenicero. Tu tamaño exacto.',
    ...
    'Carga del tres por ciento. Enciende, enseña la hora y se muere. No lo conviertas en tendencia.',
    ...
    'Mecha de mechero vacío. Chispa, olor a gas, y nada. Hoy por lo menos chispeó.',
    'Powerbank prestada al tres. Te deja mandar un mensaje y te la reclaman.',
    ...
    'Subida de esas que caben en un post-it. Pégalo en la nevera si te hace ilusión, fracasado.',
    'Te han dado el recambio de pilas AAA. Funciona el mando. Nadie te va a pedir el canal.',
    'Miga de croissant en la barba. Te la comes tú solo y crees que desayunaste, gilipollas.',
    ...
    'Brisa, no viento. Se te mueve el flequillo y ya estás escribiendo el discurso, ridículo.',
    ...
    'El aura te ha dejado el asiento del cine que nadie quería. Ves la peli igual, pringado.',
    ...
    'Envío estándar, no premium. Llega. Tarde. Sin tracking. Como tú por la vida, don nadie.',
    'El aura te ha puesto un "ok" en el puto chat. Ni un sticker. Ni un jaja. Ok.',
    'Pan del día anterior a mitad de precio. Come, que es comida, y cierra el hocico.',
    ...
    'El aura te ha dejado el último palito de la bolsa. Lo querías. Da vergüenza que lo quisieras.',
    'Te ha salido el modo ahorro de batería. Dura más. Brilla menos. Tu retrato.',
    'Gotas en el parabrisas, no tormenta. Limpia y sigue, que no es noticia, pringado.',
    ...
    'Te dieron la muestra del perfume. Hueles un segundo y el bote se queda en el escaparate.',
    'Cambio de marcha en un semáforo en rojo. Has hecho ruido. No has avanzado una mierda... espera, sí: un poco. El poco de siempre.',
    'El aura te ha puesto en la lista de espera del respeto. Hoy has avanzado un puesto. Hay 400.',
    ...
    'El aura te ha hecho un pase en corto. Controla y no chutes, que te ríes el puto grupo.',
    ...
    'Te ha salido el modo invitado. Entras. No guardas historial. Mañana ni te acuerdas el wifi.',
    'Sumaste lo que suma un recuento de votos nulos: aparece en el acta y a nadie le cambia el alcalde.',
    'Te dieron el asiento plegable del pasillo. Viajas. El paisaje es el culo de los otros.',
    'El aura te ha hecho la cama de hotel de tres estrellas: limpia, sosa, y el minibar cerrado. Cutre y suficiente.',
    'Subiste un peldaño de esos de parking: no ves la calle, pero ya no estás en el -3.',
    'Te tocó el chupito de hierbas que regalan a las once. Ni rico ni tuyo. Lo bebes igual.',
    'El aura te ha dejado un "visto" en verde. Ni escribe. Ni va a escribir. Cobra y calla, pringado.',
    'Te han dado la bolsa de plástico de pago. Has salido de la tienda. No has comprado nada que importe.',
    'Subida de esas que se miden en cucharillas de café. El desayuno sigue siendo aire, joder.',
    'Te dio para el café solo, no para el con leche. Pide eso y no mires la vitrina.',
    'El aura te ha puesto de extra en la escena. Sales un segundo. El protagonista es otro.',
    'Te llevaron de copiloto. No tocas el volante, no eliges el radio, y aun así has avanzado, inútil.',
    'Sumaste el trozo de chorizo que cae de la tapa. Lo picas del plato ajeno y callas, pringado.',
  ],
  loss: [
    // ── Ejemplos del usuario (intocables) ──
    ...
    'Te quitaron aura y el puto grupo siguió hablando de comida. Tu pérdida vale menos que un menú.',
    'El marcador rojo se repite otra vez. A estas alturas podría ser tu puto fondo de pantalla.',
    'Joder, hoy fallaste en algo fácil. Pero como todo lo fácil se te complica, nadie se sorprendió.',
    'Bajaste otro escalón sin que nadie te empujara. El mérito es tuyo entero, cabrón.',
    'El puto grupo vio tu pérdida y la archivó con las demás. Tienes una carpeta propia de descensos.',
    'Joder, perdiste aura como quien pierde un botón: ni te diste cuenta hasta que miraste.',
    'Te restaron y ni te molestas en preguntar por qué. Ya sabes por qué: porque eres tú, gilipollas.',
    'Te quitaron aura y el puto chat cambió a fútbol. Tu número duró menos que un fuera de juego.',
    'Sticker viejo de "jaja". Ni lo han reenviado. Tu puta pérdida tiene esa misma energía.',
    'Joder, un estado que caduca en 24 horas. El tuyo ha caducado en diez segundos y nadie lo ha visto.',
    'Joder, la notificación silenciada. El teléfono ni se ha molestado en vibrar por ti.',
    'Joder, la silla de plástico que nadie retira después de la fiesta. Ahí sigues, mojada y de más.',
    'Joder, la planta de oficina que ya no se riega. Baja un poco cada semana y el jefe pasa de largo.',
    'Joder, el correo de spam en la carpeta. Ni el filtro te tiene respeto: te deja pasar y te ignora.',
    'Anuncio skippable a los cinco segundos. El puto grupo le ha dado a skip. Tú eres el anuncio.',
    'Nota adhesiva que se cae de la nevera. El imán no te quería tanto, fracasado.',
    'Joder, tu nombre en visto a las tres de la mañana. Ni "ok". Ni "jaja". Visto, y a dormir.',
    'Cajón de cables que nadie desenreda. Tu puta pérdida va ahí, con los cargadores huérfanos.',
    ...
    'Mando sin pilas. Has apretado botones. La tele no te debe una mierda.',
    'Tostada quemada por un lado. Se come igual. El desayuno no se para por ti.',
    'Café que se ha quedado frío en la reunión. Lo tiras. Nadie pregunta si lo querías, pringado.',
    'Bus que acaba de cerrar la puerta. Lo ves irse. El siguiente tarda, y es tu culpa por llegar así.',
    'Parquímetro en rojo. Una multa pequeña, la de siempre, la que ya no te sorprende, inútil.',
    'Calcetín suelto en la lavadora. Desaparece uno y el otro se queda viudo. Como tu puto saldo.',
    ...
    'Te han cobrado el recargo de maleta. Viajas igual. Pagas de más. Nadie te espera en llegadas.',
    'Pérdida de llave de trastero. El piso sigue. El trastero, ya ni está.',
    ...
    'Sello de "impagado" en una factura de tres euros. Ni el banco se emociona.',
    ...
    'Pérdida de esas que se cuentan en cucharillas. El café sigue siendo una mierda, ahora con menos azúcar.',
    ...
    'Te cobraron el plástico de la bolsa. Has salido de la tienda más pobre y con menos dignidad.',
    'El puto grupo te usó de ruido blanco. Bajaste el volumen un punto. El podcast seguía.',
    'Te restaron lo que se lleva el perro del parque: un poco, sin odio, porque estaba ahí.',
    'Bajada de andén. El tren no te esperaba. Nunca te espera, fracasado.',
    ...
    'Te quitaron el extra de la pizza. La masa sigue. El queso era lo único que te gustaba.',
    'Bajada de esas que caben en el vueltos que no te dieron. El kiosko ya está atendiendo a otro.',
    'El puto chat te usó de ejemplo en voz baja. Ni en alto. En voz baja. Eso duele distinto.',
    'Te restaron lo que se lleva una polilla: un puto agujero pequeño en algo que ya era viejo.',
    'Pérdida de silla reservada con un abrigo. El abrigo era de otro. Tú te quedas de pie.',
    'El aura te ha puesto el semáforo en ámbar y lo has cruzado mal. Multa pequeña, cara de siempre.',
    'Bajaste el brillo de la pantalla. El puto grupo ni pestañeó. Su noche seguía igual de larga.',
    'Te cobraron el recargo de madrugada. El taxi te deja igual de lejos, ahora más pobre.',
    'El puto grupo te tiene en "familia" para no ver las notificaciones. Hoy se ha notado el filtro.',
    ...
    'Te restaron el cubierto de plástico. Come con las manos, que para lo que hay… cutre y tuyo.',
    'El aura te ha puesto de extra y te ha recortado el segundo. Sales menos. El corte es tuyo.',
    'Te han dado el número 87 de la cola y ha salido el 86 dos veces. Así es tu suerte, pringado.',
    'Bajada de esas que no merecen sticker. Ni el de caca. Demasiado trabajo para lo que eres, gilipollas.',
  ...
  spiral: [
    ...
    'El puto grupo ya no apuesta por tu recuperación. Apuesta por cuánto tardas en tocar un nuevo mínimo.',
    'Llevas tanto abajo que el fondo te ha adoptado. Residencia permanente, gilipollas.',
    'Tu racha negativa ya es tan larga que el puto grupo la usa de referencia temporal: "desde que empezó a perder".',
    ...
    'Tienes DNI del puto sótano. El -1 te reconoce al pasar el torniquete.',
    ...
    'Abono mensual al puto pozo. Viajas ilimitado. El destino es siempre el mismo.',
    'Joder, el inquilino del rojo. El casero eres tú. El desahucio no llega nunca.',
    'Récord Guinness de perder. No te lo van a dar. El puto grupo te lo tiene contabilizado igual.',
    'Recaída de alguien que nunca salió. No hay recaída. Hay continuidad, pringado.',
    'Fosa con tu cara en el cartel. "Se busca el puto fondo". El fondo ya te tiene.',
    'Joder, la cuchara de preso. Sigues comiendo. El rancho es perder. El rancho no cambia.',
    'Joder, el ascensor que solo tiene botón menos uno. Lo pulsas con el codo, por costumbre.',
    'Coño, la marea que nunca sube. La playa se te ha quedado lejos y sigues nadando hacia dentro.',
    'Pozo séptico con tu puto nombre en la tapa. Huele. Nadie lo abre. Tú vives ahí.',
    'Cuenta atrás invertida: cada puta tirada suma un día más de sótano.',
    'Coño, la suscripción al rojo. Se renueva sola. El botón de cancelar te lo has comido.',
    'Coño, la planta que ya no se riega. Sigue ahí, marrón, y nadie la tira porque "es la tuya".',
    'Coño, la alarma que ya ni suena. El golpe eres tú. El cuerpo lo tiene metido.',
    'Mancha en la pared que nadie limpia. El puto grupo ya la usa de referencia: "junto a esa".',
    'Tobogán del parque. Los críos se cansan. Tú no. Baja otra vez, fracasado.',
    ...
    'Escalera de incendio oxidada. Solo baja. El primer piso se te ha olvidado.',
    ...
    'Sótano de trasteros. El tuyo es el que gotea. El seguro no cubre mala suerte crónica.',
    'Pozo artesiano al revés: cuanto más tiras, más seco. Y tiras igual.',
    ...
    'Foso de orquesta sin orquesta. Solo el hueco. Tú te has instalado con silla plegable.',
    'Aljibe. El agua está quieta. Tú también. El mosquito es lo único que se mueve, y no eres el mosquito: eres el agua.',
    'Hoyo de la cerradura visto desde dentro. Llevas tanto ahí que el pasillo es un mito.',
    'Sótano de discoteca a las siete de la mañana. La música paró. Tú no.',
    'Pozo de petrolera seca. Sigues perforando. El accionista ya vendió.',
    'Cubo de obra bajando por la polea. Nadie tira hacia arriba. El albañil se fue a otro piso.',
    'Cripta familiar. El nicho del medio tiene tu puto nombre a lápiz. Aún no es oficial. Casi.',
    'Tubería bajante. Todo lo que sueltas acaba en el mismo sitio. El sitio eres tú.',
    'Hoyo de la paloma en el parque. El resto vuela. Tú has hecho nido en el puto agujero.',
    'Sótano de archivo. Tus derrotas están en cajas. Han pedido más cajas, cabrón.',
    'Pozo de nieve en agosto. No debería existir. Tú sí. El milagro es al revés.',
    'Escalera mecánica en bajada, rota, y tú andando igual. El cartel dice "no usar". Lo usas.',
    'Fosa séptica con luz led. Te has acondicionado el infierno. Qué asco de hogar.',
    'Sótano de gimnasio: solo hay pesas negativas. Cada rep te deja más abajo.',
    'Pozo de los deseos al revés: tiras una moneda y el puto pozo te cobra otra.',
    'Cueva de aficionado. Sin casco. Sin linterna. Con costumbre. Lo más peligroso.',
    'Hoyo negro de salón. El sofá te traga un palmo más cada tarde. El mando ya no llega.',
    'Sótano de parking sin numerar. Has perdido el coche. El coche eras tú.',
    'Aljibe de pueblo. El cubo sube vacío. El pueblo ya bebe de otra fuente.',
    'Pozo de minero. El canario se murió en 2024. Tú seguiste, pringado.',
    'Rampa de skate hacia un bordillo. Te caes. Subes. Te caes. El vídeo ya no se graba.',
    'Sótano de ensayo. La banda se fue. El bajo sigue sonando. Eres el bajo.',
    'Hoyo de plantación. Lo que crece, crece hacia abajo. Jardinería tuya, joder.',
    'Cripta de wifi: una raya, a veces cero. Te has quedado a vivir con la raya.',
    'Pozo de noria sin caballos. La rueda no gira. Tú empujas igual. Hacia ningún sitio.',
    'Sótano de hotel sin estrellas. El desayuno es perder. El check-out no existe.',
    'Foso de leones sin leones. El público se fue. Tú sigues en la arena, fracasado.',
    'Tubería de desagüe con tu foto en la tapa de registro. Los de saneamiento te saludan.',
    'Hoyo de bunker. El palo no saca la bola. La bola eres tú. El green se ve de postal.',
    'Sótano de bunker antiaéreo. La guerra paró. Tú no has oído la sirena de fin.',
    'Pozo de hielo. Cada puta tirada es un pico. El bloque ya es una estalactita con tu cara.',
    'Cueva de setas. Crece todo lo que no debería. Tú eres el sustrato, gilipollas.',
    'Rampa de minusválidos usada al revés. Bajando. El que te diseñó no pensó en esto. Tú sí lo haces.',
    'Sótano de biblioteca: solo hay tomos de "otra vez". Has pedido el siguiente volumen.',
    'Aljibe con ladilla de óxido. El agua sabe a ti. Nadie bebe. Sigue llenándose.',
    ...
    'Hoyo de la cerradura visto por el ojo de gato. Llevas tanto al otro lado que el pasillo es leyenda.',
    'Rampa de camiones hacia la cantera. Cada viaje, menos. La cantera te espera con el bostezo.',
    'Sótano de disco duro: solo hay papelera. Vaciarla sería subir. No vacías.',
    'Pozo de nieve sucia al borde de la carretera. Los coches te salpican. Sigues ahí en marzo.',
    'Cueva de turista sin selfie. Ni tú quieres la foto. El puto grupo tampoco. Aun así bajas.',
    'Aljibe de azotea agrietado. Todo se va. El edificio sigue. El que gotea eres tú, cabrón.',
    'Hoyo de plantón que nunca brotó. El jardinero era tú. El solar, también.',
    'Sótano de metro fantasma. El andén está. El tren no. Tú esperas. Es tu parada.',
    'Pozo de los deseos con reja. Los deseos se quedaron arriba. Tú, abajo, haciendo inventario.',
    'Fosa de piscina vacía en octubre. El trampolín sigue. Tú saltas. El agua no vuelve.',
    'Tubería bajante de un bloque de veinte. Eres el último piso del desagüe. Felicidades, inútil.',
    'Sótano de ensayo de batería a las tres. El vecino ya no pega en el techo. Se rindió. Tú no.',
    'Hoyo de bunker lleno de agua. El palo no sirve. El palo eres tú. El agua, tu puto saldo.',
    'Pozo de pueblo con el brocal roto. Los críos tiran piedras. Tú las cuentas. Es tu hobby.',
    'Cripta de notificaciones: todas en rojo, ninguna abierta. Has hecho de tu vida un badge.',
    'Rampa de skate oxidada. De noche. Sin luces. Con rodilla rota. Mañana vuelves, pringado.',
    'Sótano de archivo muerto. Han puesto tu carpeta en "indefinido". El indefinido eres tú bajando.',
  ],
  cursed: [
    // ── Ejemplos del usuario (intocables) ──
    ...
    // ── Reescritas y nuevas ──
    'Joder, hoy batiste un récord que nadie quería ver roto. Enhorabuena por lo único que se te da bien.',
    'Joder, hoy te hundiste delante de todos. Con público, con testigos y con capturas que van a durar.',
    'Joder, perdiste tanto que la cifra ya no da risa. Da esa incomodidad de cuando alguien la caga de verdad.',
    'Perdiste con la elegancia de un saco de mierda cayendo por las escaleras. Ruidoso y feo.',
    'Sacaste un número que el puto grupo va a usar como unidad de medida del desastre. "Perdiste casi tanto como él".',
    ...
    'Alguien ha reenviado esto a otro puto grupo y ha puesto "mira". Ya eres contenido de exportación.',
    'El que siempre se suma al montón ha elegido no. Cuando ni el carroñero pica, has llegado al puto fondo.',
    'Has hecho que el puto grupo se mire los zapatos. Los zapatos no tenían la culpa. Tú sí.',
    'Un "joder" que se ha muerto a mitad. No había segunda palabra que no te dejara peor.',
    'El puto ranking se ha abierto solo para enseñar el agujero. Luego lo han cerrado con dos dedos, asqueados.',
    'Alguien ha comprobado si el bot se había roto. No se había roto. Eres tú, gilipollas.',
    'Has dejado el ambiente de cuando alguien se tira un pedo en el ascensor y hay diez pisos por delante.',
    'El que dijo "esta vez gana" se está comiendo la frase con tenedor. Que mastique despacio.',
    'Te has tropezado en el escenario. Con foco, con público y sin orquesta que tape el golpe.',
    ...
    'Alguien ha guardado el audio que iba a mandar. Hoy no tocaba reírse. Tocaba sobrevivir al cringe.',
    ...
    'Has dejado a los carroñeros sin apetito. El cadáver era demasiado. Qué logro más raro.',
    'Alguien ha puesto "F" y lo ha borrado. Ni el respeto póstumo te querían dar.',
    'El puto grupo se ha dividido entre cringe y pena. Ninguno ha elegido la risa. Eso duele distinto.',
    'Has hecho que cierren la app y abran otra cosa. TikTok te debe una comisión, pringado.',
    'El que te defiende siempre ha mirado el techo. El techo no te iba a salvar. Él tampoco.',
    'Has caído como un saco por las escaleras del metro: todo el andén oyéndolo, nadie ayudando.',
    'La captura tiene hora. La hora se va a quedar. Tú también, en esa foto.',
    'Has dejado el puto chat con esa cara de cuando el camarero oye lo que no debía. Incómodo y sin cuenta que pedir.',
    'Alguien ha escrito "madre mía" y se ha quedado ahí. El resto del teclado se le ha rendido.',
    'Te has dado de bruces con el suelo delante de todo el puto grupo. El suelo estaba duro. El grupo, más.',
    'Has hecho que el "jaja" colectivo se atragante. La risa se les ha vuelto tos.',
    'El ambiente se ha puesto de velatorio de pueblo: sillas, calor, y nadie sabiendo qué decirte.',
    'Has salido en el parte como accidente con testigos. Los testigos van a hablar cuando no estés.',
    'Alguien ha tapado la pantalla con la mano, instinto de película mala. La película eras tú.',
    ...
    'Has dejado al cronista sin adjetivo. Ha tenido que escribir "esto". "Esto" eras tú, cabrón.',
    'Alguien ha ido a ver si podías borrar el mensaje. No se puede. Qué suerte la nuestra.',
    'Has hecho el equivalente a vomitar en la mesa y seguir comiendo. El resto ha retirado el plato.',
    'El puto grupo te ha concedido el silencio de los accidentes. No se aplaude. Se aparta.',
    'Has puesto tu puto nombre al lado de "no mirar". El aviso llega tarde. Ya han mirado.',
    'Te has llevado el ambiente por delante. El hilo de antes se ha muerto de vergüenza ajena.',
    'Alguien ha puesto el modo avión diez segundos. Un receso de ti. Luego ha vuelto, peor.',
    'Has hecho que el "menos mal que no soy yo" se diga en voz alta. Raro. Aquí eso no se dice. Hoy sí.',
    'El carroñero ha cerrado la boca. Cuando el buitre pasa, el cadáver está demasiado.',
    'Has dejado una captura con más vida útil que tu dignidad. La dignidad se caduca. La foto, no.',
    'El chat te ha mirado como se mira una uña rota en público: asco, pena, y ganas de no ser tú.',
    'Has hecho un agujero en el puto ranking del tamaño de un silencio. El silencio te queda grande, y aun así te lo has puesto.',
    'Alguien ha escrito "se ha pasado" hablando del bot. El bot no se ha pasado. Te has pasado tú, hacia abajo.',
    'Has puesto cara de funeral al martes. El martes ya era una mierda. Has aportado, inútil.',
    'El que te tenía de meme se ha encontrado con que el meme se ha vuelto documental. Ya no pega de risa.',
    'Has caído con público y sin red. La red era el puto grupo. Te han mirado caer.',
    'Te has comido la peor tirada de la semana en directo. El directo no se edita, gilipollas.',
    'El puto grupo ha hecho un "uf" colectivo. Un uf. Barato. Honesto. Letal.',
    'Has dejado el hilo anterior herido. Nadie quería retomar con tu puto número todavía en pantalla.',
    'Alguien ha tapado el nombre con el dedo para enseñar solo la cifra. La cifra bastaba. El nombre sobraba de vergüenza.',
    'Has hecho que hasta el que disfruta viendo palos diga "bah, esto ya no". Enhorabuena, has saturado al sádico.',
    'El ambiente se ha puesto de ascensor parado entre dos pisos. Nadie pulsa. Tú eres el aviso de alarma.',
    'Has salido en el parte como "incidente". Los incidentes se recuerdan. Los mensajes, no. Jódete.',
    'Te han dado el respeto invertido: no te bardean porque da cosa. Da cosa. Atesora eso.',
    'Has convertido tu puto nombre en una unidad de palo. "Casi un tú". Vas a oírlo. Merecido.',
    'El puto chat ha respirado cuando ha salido otro mensaje que no eras tú. Ese suspiro te define.',
    'Has hecho un cráter y el puto grupo ha asomado la cabeza. Luego se ha apartado. El cráter sigue.',
  ],
};
