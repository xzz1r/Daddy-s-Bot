...
const APUESTA_POBRE = [
  ...
  '¿Con qué apuestas? ¿Con la cara? La cara no cotiza en este ranking. Y el grupo lo ve, patético.',
  'Te acercas a la mesa sin aura suficiente: la mesa no hace caridad. Y el grupo lo ve, ridículo.',
  'Sin fichas no hay juego. Trajiste solo el discurso. El discurso no cubre la apuesta. Y el grupo lo ve, basura.',
  'Quieres arriesgar lo que no tienes: el bot no financia ilusiones. Y el grupo lo ve, desperdicio.',
  'Saldo insuficiente para apostar. Vuelve cuando el aura no dé vergüenza ajena. Y el grupo lo ve, asco.',
  'En la mesa de apuestas con los bolsillos transparentes: se ve el vacío. Y el grupo lo ve, cutre.',
  ...
  'Apuesta bloqueada. Pobre de aura y rico en cara de querer jugar. Y el grupo lo ve, joder.',
  'Sin saldo para la apuesta: el juego empieza cuando hay algo que perder de verdad. Y el grupo lo ve, mierda.',
  '¿Apostar en seco? Aquí no se fía. Aquí se cuenta el aura antes de hablar. Y el grupo lo ve, coño.',
  'Trajiste sed de apuesta y cero de combustible. La mesa no arranca en vacío. Y el grupo lo ve, cabrón.',
  'Insuficiente. No cubres el mínimo: el ridículo sí lo cubres entero. Y el grupo lo ve, gilipollas.',
  'Quieres sentarte a apostar sin fichas: la silla está reservada a quien puede perder. Y el grupo lo ve, patético.',
  'Sin aura no hay apuesta. Hay un mensaje de este estilo y poco más. Y el grupo lo ve, ridículo.',
  'La apuesta imposible: el contador en rojo, la intención en verde, gana el contador. Y el grupo lo ve, basura.',
  'Apuesta denegada por pobreza de aura. Quedas notificado en público. Y el grupo lo ve, desperdicio.',
  'Te presentaste a apostar con la cuenta en modo mendigo: la mesa dijo que no. Y el grupo lo ve, asco.',
  'No tienes con qué. La apuesta no es un deseo: es un saldo. Y el grupo lo ve, cutre.',
  'Pobre para la mesa: el bot no alarga crédito de aura. Y el grupo lo ve, pringado.',
  'Saldo insuficiente. La próxima vez mira el contador antes de abrir la boca de apostar. Y el grupo lo ve, fracasado.',
  'Quieres jugarte el aura que no tienes: el chiste se escribe solo. Y el grupo lo ve, joder.',
  'Apuesta imposible: estás en la cola de los que quieren sin poder. Y el grupo lo ve, mierda.',
  'Sin fichas en la mesa de aura: solo el eco de la intención. Y el grupo lo ve, coño.',
  '¿Apostar sin nada? Vuelve con aura o no vuelvas a pedir mesa. Y el grupo lo ve, cabrón.',
  'El mínimo de la apuesta está por encima de tu máximo actual. Y el grupo lo ve, gilipollas.',
  ...
  'Sin aura suficiente no hay apuesta. Hay solo este roast de pobre. Y el grupo lo ve, basura.',
  'La mesa pide fichas: tú pediste juego. Gana la mesa. Y el grupo lo ve, desperdicio.',
  'Apuesta bloqueada por saldo. Quedas en evidencia delante del chat. Y el grupo lo ve, asco.',
  'Rico en discurso de apostador: pobre en el único número que abre la mesa. Y el grupo lo ve, cutre.',
  'No hay crédito. Hay contador. El contador dice que no. Y el grupo lo ve, pringado.',
  'Te sentaste a apostar sin mirar el bolsillo: el bolsillo estaba vacío de antes. Y el grupo lo ve, fracasado.',
  'Insuficiente para apostar. Suficiente para el mensaje de burla. Y el grupo lo ve, joder.',
  'Quieres arriesgar aire: el aire no cotiza, el ridículo sí. Y el grupo lo ve, mierda.',
  'Apuesta denegada. Tú y el saldo en desacuerdo: gana el saldo. Y el grupo lo ve, coño.',
  'Sin con qué: la mesa de apuestas no es un deseo de año nuevo. Y el grupo lo ve, cabrón.',
  'El mínimo te supera. El ridículo te alcanza igual. Y el grupo lo ve, gilipollas.',
  'Pobre de aura en la puerta de la apuesta: la puerta no se abre. Y el grupo lo ve, patético.',
  ...
  'Apuesta imposible hoy. Mañana también si el aura no cambia. Y el grupo lo ve, desperdicio.',
  'Trajiste la intención y olvidaste el saldo: la mesa no olvida el requisito. Y el grupo lo ve, asco.',
  'Rechazado por pobreza de contador. El chat toma nota del intento. Y el grupo lo ve, cutre.'
];
