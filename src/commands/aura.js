...
const APUESTA_POBRE = [
  'Joder, vienes a apostar con el culo al aire y sin un puto duro. Vuelve cuando tengas algo que no sea miseria de mendigo.',
  'Con esa mierda de saldo no llegas ni a la barra del bar de putas, cojones. Lárgate.',
  '¿Apostar tú? Ni de coña, pringado. Antes junta cuatro duros y deja de hacer el ridículo.',
  'Vienes más pelado que una rata de alcantarilla con diarrea. Aquí no se juega con pena ni con tu miseria.',
  'Esa calderilla no vale ni para limpiarme el culo después de cagar, no te digo ya para apostar, gilipollas.',
  'La mesa tiene un mínimo y tú tienes menos que un puto mendigo. Larga de aquí.',
  'Con lo que tienes no apuestas, mendigas como un pordiosero. Y aquí no se reparte caridad, cabrón.',
  'Joder, qué vergüenza ajena da tu saldo de mierda. Vuelve cuando no seas un puto pordiosero sin dignidad.',
  'Eso no es aura, es la mierda que queda en el fondo del bolsillo después de pagar la puta.',
  'Ni para propina de puta barata llega eso, coño. Vete a pedir a otro lado, pringado.',
  'Aquí se apuesta con cojones y con pasta, no con las migajas que te quedan de limosna.',
  'Con esa hostia de saldo lo único que arriesgas es hacer el ridículo más grande del grupo, gilipollas.',
  'Estás más seco que la Mancha en agosto y más pobre que un gitano sin carromato. Junta pasta y vuelve.',
  'No hay mínimo que sobreviva a tu miseria de mierda. Larga de la mesa, pordiosero.',
  'Vienes a la mesa con menos aura que un muerto de hambre. Aquí se juega con hombres, no con mendigos.',
  'Tu saldo es una puta ofensa a la mesa. Vuelve cuando tengas algo que no sea vergüenza ajena.',
  'Con esa miseria no te dejan ni entrar al puticlub, no te digo ya a apostar, cabrón.',
  'Joder, estás más pelado que un pollo de granja. Aquí no se juega con tu pobreza de mierda.',
  'Eso que tienes no es saldo, es una limosna que te dio alguien por pena. Fuera de la mesa.',
  'La mesa te vomita con ese saldo de pordiosero. Junta cuatro duros o lárgate a mendigar a otro lado.',
];
