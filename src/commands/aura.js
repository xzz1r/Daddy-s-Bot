...
const AURA = {
  ...
  loss: [
    ...
    'Fallaste en algo fácil, gilipoyas, y a nadie le ha sorprendido.',
    ...
    'Ya sabes por qué: porque eres tú, gilipoyas.',
    ...
    'Pierdes poco y seguido, que es la forma más tonta de quedarse sin nada, gilipoyas.',
    ...
    'Te han quitado poco, gilipoyas, porque tampoco había mucho que quitar.',
    ...
    'Pérdida pequeña y aburrida, como tu manera de jugar, gilipoyas.',
    ...
    'Tirada de las que no duelen, y por eso repites. Ahí está el truco, gilipoyas.',
    ...
    'Otra vez lo que ya se sabía. Sorpresa cero, gilipoyas.',
  ],
  spiral: [
    // ── Reescritas y nuevas ──
    'Joder, a esto ya no se le llama mala suerte, se le llama ser tú.',
    'Sigues cavando, y el fondo lo pasaste hace rato, gilipoyas.',
    ...
    'Pozo con eco. Gritas "ya está" y te devuelve "todavía no", gilipoyas.',
    ...
    'Ya no pierdes aura, la donas. Y encima con constancia, gilipoyas.',
    ...
    'Tu problema no es la suerte. Tu problema es que no sabes parar, gilipoyas.',
    ...
    'Tu aura no baja: se desploma con horario fijo, gilipoyas.',
  ...
  cursed: [
    ...
    'Hoy batiste un fondo que nadie sabía que existía, gilipoyas.',
    ...
    'Alguien ha comprobado si el bot se había roto. No se había roto. Eres tú, gilipoyas.',
    ...
    'Quien iba a vacilarte se ha quedado sin ganas. Ni odio te mereces hoy. Solo pena.',
    ...
    'Respeto invertido: nadie se mete contigo porque da cosa. Da cosa. Atesora eso.',
