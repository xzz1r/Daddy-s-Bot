...
let DUEL_WIN = [
  ...
  '%W ejecuta a %L sin pestañear: trámite para uno, trauma para el otro. El grupo lo vio entero, asco.',
  '%W mandó de principio a fin: %L solo engordó el marcador ajeno. El grupo lo vio entero, cutre.',
  '%L tiró los dados como un rasca: %W le explicó la estadística a hostia limpia. El grupo lo vio entero, pringado.',
  ...
  '%W le quita el aura y la dignidad a %L en el mismo movimiento. El grupo lo vio entero, coño.',
  '%W no se esforzó: %L nunca necesitó ayuda para hundirse, hoy tuvo asistencia. El grupo lo vio entero, gilipollas.',
  '%W gana y pasa página: %L añade la derrota a la lista nocturna. El grupo lo vio entero, patético.',
  ...
  '%W cerró el duelo: %L abrió el manual de excusas por la página más sobada. El grupo lo vio entero, desperdicio.',
  '%L midió fuerzas con %W y descubrió otra vez que no tiene ni una. El grupo lo vio entero, asco.',
  '%W lo mandó al rincón de pensar: %L lleva ahí toda la vida sin un pensamiento útil. El grupo lo vio entero, cutre.',
  '%W cobró el stake y el respeto: %L pagó ambos sin descuento. El grupo lo vio entero, pringado.',
  ...
  '%L apostó el aura y la cara: se quedó sin las dos frente a %W. El grupo lo vio entero, mierda.',
  ...
  '%W no sudó el stake: %L sudó la explicación que nadie pidió. El grupo lo vio entero, ridículo.',
  '%L retó por orgullo: el orgullo no paga el aura que %W se lleva. El grupo lo vio entero, basura.',
  '%W cerró el intercambio antes de que %L encontrara su segunda idea. El grupo lo vio entero, desperdicio.',
  '%L en el duelo es carne de ranking: %W es quien escribe el ranking. El grupo lo vio entero, asco.',
  '%W ganó limpio: %L perdió completo, pack sin reembolso. El grupo lo vio entero, cutre.',
  '%L creyó en la racha: %W creyó en la realidad. Gana la realidad. El grupo lo vio entero, pringado.',
  '%W le dejó a %L el recibo del duelo en forma de este mensaje. El grupo lo vio entero, fracasado.',
  '%L midió mal desde el saludo: %W midió bien desde el stake. El grupo lo vio entero, joder.',
  '%W no improvisó la victoria: la tenía en el bolsillo antes del sí de %L. El grupo lo vio entero, mierda.',
  '%L salió a cazar aura y volvió cazado: %W contó el botín. El grupo lo vio entero, coño.',
  '%W el duelo fue corto: el efecto en el orgullo de %L, no. El grupo lo vio entero, cabrón.',
  '%L vs %W terminó 0-1 sin prórroga y sin debate útil. El grupo lo vio entero, gilipollas.',
  '%W cobró el stake con la calma de quien no contemplaba el empate. El grupo lo vio entero, patético.',
  '%L aportó el fail: %W aportó la ejecución. Distribución natural. El grupo lo vio entero, ridículo.',
  '%W ganó y el chat archivó: %L todavía busca la frase del almost. El grupo lo vio entero, basura.',
  '%L el duelo le quedó grande: %W le quedó justo. El grupo lo vio entero, desperdicio.',
  '%W no pidió suerte: ejecutó. %L no tuvo suficiente nada. El grupo lo vio entero, asco.',
  '%L firmó el reto con la mano y la derrota con las dos. El grupo lo vio entero, cutre.',
  '%W vació el stake de %L sin pedir segunda ronda. El grupo lo vio entero, pringado.',
  '%L en modo héroe de tutorial: %W en modo jefe final del primer pasillo. El grupo lo vio entero, fracasado.',
  '%W el frame del duelo aplastó a %L antes del segundo mensaje. El grupo lo vio entero, joder.',
  '%L apostó convicción: la convicción no cotiza contra %W. El grupo lo vio entero, mierda.',
  '%W cerró el duelo y abrió el hueco en el aura de %L. El grupo lo vio entero, coño.',
  '%L vs %W: crónica breve de una derrota larga para el ego. El grupo lo vio entero, cabrón.',
  '%W ganó sin narrador: el resultado se narra solo. El grupo lo vio entero, gilipollas.',
  '%L el único hábito constante es perder: hoy lo practicó con %W. El grupo lo vio entero, patético.',
  '%W cobró, %L pagó, el grupo presenció: duelo completo. El grupo lo vio entero, ridículo.',
  '%L retó a %W y el universo le contestó con este mensaje. El grupo lo vio entero, basura.',
  '%W no dejó almost: dejó derrota limpia en el marcador de %L. El grupo lo vio entero, desperdicio.',
  '%L midió el stake con el ego: el ego no cubrió el peaje de %W. El grupo lo vio entero, asco.',
  '%W ejecutó el duelo como quien marca una casilla pendiente. El grupo lo vio entero, cutre.',
  '%L salió del duelo con menos aura y la misma cara de siempre. El grupo lo vio entero, pringado.',
  '%W el stake cambió de dueño: el respeto también. El grupo lo vio entero, fracasado.',
  '%L vs %W terminó antes de que %L encontrara el plan B. El grupo lo vio entero, joder.',
  '%W ganó el intercambio y el relato: %L se quedó sin ambos. El grupo lo vio entero, mierda.',
  '%L la derrota le llama por su nombre desde antes del duelo. El grupo lo vio entero, coño.',
  '%W no sudó: %L sudó la lista de excusas. El grupo lo vio entero, cabrón.',
  '%L aportó el reto: %W aportó el final. Fin. El grupo lo vio entero, gilipollas.'
];
