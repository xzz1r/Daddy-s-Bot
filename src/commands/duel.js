...
let DUEL_WIN = [
  ...
  '%W barre a %L delante del grupo, el único sitio donde a %L lo mencionan, aunque sea para esto. Aprovéchalo, perdedor, da asco.',
  ...
  '%L retó a %W con la boca llena y el currículum vacío de un puto don nadie. El choque fue breve, público y le dejó bien claro lo poca cosa que es, da grima.',
  '%W ejecuta a %L sin pestañear. Para %W fue un trámite; para %L, otro trauma más que sumar a la montaña de mierda que es su vida de fracasado sin un puto duro, qué nivel de pena.',
  '%W mandó de principio a fin. %L solo apareció para engordar el marcador del otro, el único puto papel que sabe hacer este pelele en cualquier grupo, basura.',
  '%L tiró los dados como quien compra un rasca esperando jubilarse. %W le explicó la estadística a hostia limpia y gratis, qué cutre.',
  'El frame de %W aplastó a %L antes del primer asalto. Y eso que a %L lo revienta a diario cualquier chorrada más pequeña, como una simple charla. Pobre mierda blanda, da pena ajena.',
  '%W ganó tan fácil que casi pide la revancha por aburrimiento. %L declinó: bastante tiene el pobre pringado con recoger su orgullo hecho mierda del suelo, qué vacío.',
  '%L creyó que tenía una oportunidad. Esa fe ciega de perdedor es entrañable en un cachorro y patética en un puto adulto con su historial de fracasos, indignante.',
  '%W se lleva el botín. %L se lleva la enésima prueba de que nació para perder, un talento de mierda que es lo único que este inútil tiene bien afinado, qué vergüenza ajena.',
  'Duelo resuelto a favor de quien nunca dudó. %W, leyenda; %L, el puto chiste que el grupo usa para reírse y de paso avisar de cómo no acabar en la vida, da vergüenza.',
  '%W ni recordará este duelo mañana. %L lo va a rumiar una semana entera, que es lo que tarda su cerebro de mierda, lento como un módem viejo, en digerir la paliza, qué flojo.',
  '%W gana sin drama. %L necesita drama y excusas hasta para dormir, y aun así esta noche no pega ojo dándole vueltas a la puta basura de persona que es, menudo desastre.',
  '%L entró a por una victoria que le alegrara el día gris. Sale con el manual ilustrado de por qué su vida entera es una mierda gris, cortesía de %W, qué pena.',
  ...
  'A %W no le hizo falta ni esforzarse. A %L nunca le hizo falta ayuda para hundirse en su propia mierda, pero hoy, por una vez, tuvo asistencia técnica gratis, da asco.',
  ...
  '%W cerró el duelo y %L abrió su manual de excusas por la página más sobada: "no estaba concentrado". El clásico de todo perdedor que no asume que es una puta mierda, qué miseria.',
  '%L midió sus fuerzas con %W y descubrió, otra vez, que no tiene ni una. Lección que este inútil no aprende porque en esa cabeza hueca de mierda no cabe ni eso, da grima.',
  '%W lo mandó al rincón de pensar. %L lleva ahí sentado toda su puta vida y aún no ha parido un solo pensamiento útil, pero el sitio de perdedor ya lo tiene calentito, qué nivel de pena.',
  '%W desarmó a %L en el primer intercambio y le dejó el orgullo en el suelo del chat. El grupo lo vio entero, basura.',
  '%W ni se despeinó: %L tenía la derrota ensayada antes de aceptar el duelo. El grupo lo vio entero, qué cutre.',
  '%W lo tenía leído: %L es el manual viviente de cómo perder con confianza. El grupo lo vio entero, da pena ajena.',
  '%W barre a %L delante del grupo: el único sitio donde a %L lo mencionan. El grupo lo vio entero, qué vacío.',
  '%W gana sin sudar: %L se derrumba solo, como siempre que intenta sostener algo. El grupo lo vio entero, indignante.',
  ...
  '%W ejecuta a %L sin pestañear: trámite para uno, trauma para el otro. El grupo lo vio entero, asco con el ranking como único testigo del veredicto, qué flojo.',
  ...
  '%L tiró los dados como un rasca: %W le explicó la estadística a hostia limpia. El grupo lo vio entero',
  ...
  '%W no se esforzó: %L nunca necesitó ayuda para hundirse, hoy tuvo asistencia. El grupo lo vio entero, da asco.',
  ...
  '%W cerró el duelo: %L abrió el manual de excusas por la página más sobada. El grupo lo vio entero',
  '%L midió fuerzas con %W y descubrió otra vez que no tiene ni una. El grupo lo vio entero, asco delante de todo el hilo sin posibilidad de borrado, da grima.',
  '%W lo mandó al rincón de pensar: %L lleva ahí toda la vida sin un pensamiento útil. El grupo lo vio entero, cutre, fracasado.',
  '%W cobró el stake y el respeto: %L pagó ambos sin descuento. El grupo lo vio entero, pringado y el contador lo dejó por escrito sin debate, basura.',
  '%L entró al duelo de héroe y salió de estadística: %W firmó el parte. El grupo lo vio entero, fracasado.',
  '%W no dejó espacio al drama de %L: primero el golpe, luego el silencio. El grupo lo vio entero, da pena ajena.',
  '%L apostó el aura y la cara: se quedó sin las dos frente a %W. El grupo lo vio entero, mierda con el parte del comando cerrado en firme, qué vacío.',
  '%W gana el duelo como quien cobra una deuda vieja: sin sorpresa, con intereses. El grupo lo vio entero, indignante.',
  '%L vs %W: el marcador se escribió solo en la columna del que sabe ganar. El grupo lo vio entero, qué vergüenza ajena.',
  '%W ejecutó el duelo en modo trámite: %L en modo traumatismo leve. El grupo lo vio entero, da vergüenza.',
  '%L trajo confianza de más y talento de menos: %W cobró la diferencia. El grupo lo vio entero, patético.',
  '%W no sudó el stake: %L sudó la explicación que nadie pidió. El grupo lo vio entero, ridículo delante de quien miraba el ranking en ese momento, menudo desastre.',
  '%L retó por orgullo: el orgullo no paga el aura que %W se lleva. El grupo lo vio entero, basura con el sistema firmando debajo sin pedir aclaración, qué pena.',
  '%W cerró el intercambio antes de que %L encontrara su segunda idea. El grupo lo vio entero',
  ...
  '%L creyó en la racha: %W creyó en la realidad. Gana la realidad. El grupo lo vio entero, pringado en el momento más visible del chat, da asco.',
  ...
  '%L el único hábito constante es perder: hoy lo practicó con %W. El grupo lo vio entero, patético con el sistema firmando debajo sin pedir aclaración, da asco.',
  ...
  '%W no dejó almost: dejó derrota limpia en el marcador de %L. El grupo lo vio entero, desperdicio y el contador lo dejó por escrito sin debate',
...
async function cmdDuel(sock, msg, args, groupMeta) {
  ...
  if (['rechazar', 'rechazo', 'no', 'cancelar', 'cancel', 'decline', 'paso'].includes(sub)) {
    ...
    if (isTarget) {
      return sock.sendMessage(jid, {
        text: `@${d.target.split('@')[0]} le saca el cuerpo al duelo de @${d.challenger.split('@')[0]}. Cobarde confirmado, qué flojo.`,
        mentions: [d.target, d.challenger],
      }, { quoted: msg });
    }
    return sock.sendMessage(jid, {
      text: `@${d.challenger.split('@')[0]} cancela su propio reto. Se arrepintió a tiempo, menudo desastre.`,
      mentions: [d.challenger],
    }, { quoted: msg });
  }
  ...
  if (existing) {
    return sock.sendMessage(jid, {
      text: `Ya hay un duelo pendiente: @${existing.challenger.split('@')[0]} vs @${existing.target.split('@')[0]}. Espera a que se resuelva, qué pena.`,
