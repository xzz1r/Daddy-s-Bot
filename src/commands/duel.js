...
let DUEL_WIN = [
  ...
  '%W mandó de principio a fin: %L solo engordó el marcador ajeno. El grupo lo vio entero, cutre y el contador lo dejó por escrito sin debate.',
  ...
  '%W cobró el stake y el respeto: %L pagó ambos sin descuento. El grupo lo vio entero, pringado y el contador lo dejó por escrito sin debate.',
  ...
  '%W ganó limpio: %L perdió completo, pack sin reembolso. El grupo lo vio entero, cutre y el contador lo dejó por escrito sin debate.',
  '%L creyó en la racha: %W creyó en la realidad. Gana la realidad. El grupo lo vio entero, pringado en el momento más visible del chat.',
  ...
  '%L el duelo le quedó grande: %W le quedó justo. El grupo lo vio entero, desperdicio con el ranking como único testigo del veredicto.',
  ...
  '%L firmó el reto con la mano y la derrota con las dos. El grupo lo vio entero, cutre en el momento más visible del chat.',
  '%W vació el stake de %L sin pedir segunda ronda. El grupo lo vio entero, pringado sin que nadie pudiera fingir que no lo vio.',
  ...
  '%W ejecutó el duelo como quien marca una casilla pendiente. El grupo lo vio entero, cutre sin que nadie pudiera fingir que no lo vio.',
  '%L salió del duelo con menos aura y la misma cara de siempre. El grupo lo vio entero, pringado con el parte del comando cerrado en firme.',
