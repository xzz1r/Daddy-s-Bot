...
const VERDICTS = {
  ...
  low: [
    ...
    'Juntarlos es como meter un gato en la lavadora: mala idea desde el minuto uno, gilipollas.',
  ...
  zero: [
    ...
    'Meter a estos dos en la misma habitación es como poner diésel en un Ferrari y esperar que gane la carrera, gilipollas.',
