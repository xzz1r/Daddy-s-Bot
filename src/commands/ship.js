...
const VERDICTS = {
  perfect: [
    ...
    'Pleno. Si no acaban juntos es porque el universo tiene sentido del humor y quiere verlos sufrir por separado, los gilipoyas.',
    ...
    'Hostia, cien por cien. El grupo entero lo veía venir menos ellos dos, que son gilipoyas.',
    ...
    'Cien. Este número no lo da el bot por casualidad, lo da porque no hay alternativa para ninguno de estos gilipoyas.',
    ...
    'Match total. Nadie discute esto. Ni ellos, y eso que discuten absolutamente todo como los gilipoyas que son.',
    ...
    'Compatibilidad absoluta. Lo raro no es que encajen, lo raro es que hayan tardado tanto con el grupo entero mirando como gilipoyas.',
    ...
    'Cien por cien y con el grupo de testigo. A partir de ahora ya no se puede fingir que no pasa nada, gilipoyas.',
  ...
  high: [
    ...
    'Esta compatibilidad debería venir con una etiqueta: contenido no apto para los dos gilipoyas que la protagonizan.',
    ...
    'Con esta cifra ya podríais estar eligiendo el menú de la boda, y en vez de eso seguís dándole vueltas como dos gilipoyas.',
    ...
    'El bot lo tiene clarísimo: os gustáis un huevo y os comportáis como dos gilipoyas jugando al despiste.',
  ...
  low: [
    'Estos dos tienen menos química que un preservativo caducado olvidado en una guantera. Qué asco de pareja.',
    'Compatibilidad tan baja que hasta el algoritmo de la app mandó un mensaje pidiendo perdón, joder.',
    'Si esto fuera una boda, hasta el fotógrafo se iría antes del brindis. Ridículo.',
    'Se llevan tan mal que sus signos del zodiaco han pedido el divorcio, cabrones.',
    'Menos compatibles que un vegano invitado de honor a una barbacoa. Una mierda de cruce.',
    'Esto no es química, es un accidente de laboratorio esperando a que alguien llame a los bomberos. Cutre y tóxico.',
    'El grupo entero suspiró aliviado al ver este resultado, coño.',
    'Juntarlos es como meter un gato en la lavadora: mala idea desde el minuto uno, gilipoyas.',
    'Su primera cita terminaría en urgencias, y no por amor precisamente. Qué asco de plan.',
    'Tienen tanta conexión como una avispa encerrada en un coche con las ventanillas subidas. Miseria de pareja.',
    'Esto es lo más parecido a mezclar lejía con amoníaco: alguien va a acabar mal, y merecido.',
    'Su compatibilidad es un error 404: contenido no encontrado, ni se molesten en buscar, pringados.',
    'Se caen tan mal que ni sus fantasmas se cruzarían en el mismo pasillo del más allá. Basura de cruce.',
    'Menos pegue que un pez intentando aparcar una moto. Ridículo de puerta a puerta.',
    'Si fueran imanes, se repelerían desde la otra punta del supermercado, joder.',
    'Esta pareja tiene la compatibilidad de una resaca con el despertador sonando a todo volumen. Qué asco.',
    ...
    'Esto es como poner a un pingüino a hacer surf en pleno desierto: no cuadra ni de casualidad, cabrones.',
    'Se odian con una elegancia que ni el mejor guion de Hollywood podría mejorar. Una mierda bien filmada.',
    'Compatibilidad de mierda, la misma que tiene una dieta estricta con un bufet libre.',
    'Estos dos son agua y aceite, pero el aceite está ardiendo. Cutre y peligroso.',
    'El universo entero conspiró para que jamás coincidieran, y por una vez hizo bien su trabajo, joder.',
    'Tienen la conexión de un módem viejo intentando cargar una videollamada. Miseria de sintonía.',
    'Su chat tendría un solo tick gris eternamente, sin doble tick jamás. Qué vergüenza de visto.',
    'Esto necesitaría un puto tratado de paz internacional para no acabar a hostias.',
    ...
    'Esto es tan improbable como que un gilipoyas gane la lotería dos veces seguidas, pero al revés.',
    ...
    'Compatibles como un gilipoyas con carnet de conducir recién sacado en hora punta.',
  ...
  zero: [
    ...
    'Compatibilidad de cero como el aceite y el agua bendita: ni con exorcismo se mezclan estos dos, cabrones.',
    ...
    'Match del cero por ciento: como pedirle a un pez que suba una escalera mientras se está quemando vivo. Qué asco.',
    ...
    'Cero compatibilidad, cero futuro, cero de todo. Ni una vela de cumpleaños sobrevive a este agujero negro, joder.',
    'Esto es como firmar la paz entre un gato y un perro y que al día siguiente pidan el divorcio. Ridículo.',
    'Coño, si esto fuera una ecuación, ni las matemáticas más rotas del mundo la resolverían.',
    'Vaya par de gilipoyas. Ni el Big Bang tuvo tan poca química como estos dos.',
    'Esto no es amor imposible, es una broma de mal gusto que le está gastando el destino a la humanidad. Una mierda cósmica.',
    'Meter a estos dos en la misma habitación es como poner diésel en un Ferrari y esperar que gane la carrera, gilipoyas.',
    'Cero por ciento, y ni el fósil más viejo del planeta tiene tan poca vida como esta pareja. Basura de cruce.',
    ...
    'Esto es tan improbable como que un gilipoyas se calle a la primera. O sea, imposible.',
