...
const VERDICTS = {
  ...
  low: [
    'Bajo de verdad. Estos dos juntos son un fail anunciado y el número lo grita sin filtro delante de todo el chat, joder.',
    'Ship bajo: la química es un agujero y no un puente. El bot no regala décimas delante de todo el chat, mierda.',
    'Compatibilidad de mierda. Mejor separados que ensuciando el ranking juntos delante de todo el chat, coño.',
    'Bajo. El ship no levanta ni con tutorial ni con rezo delante de todo el chat, cabrón.',
    'Estos dos suman menos que por separado. Matemáticas del ranking delante de todo el chat, gilipollas.',
    'Ship en el sótano. El número no admite recurso ni segunda lectura delante de todo el chat, patético.',
    'Bajo de los que duelen. La compatibilidad se fue a la mierda y no vuelve delante de todo el chat, asco.',
    'El bot midió y el resultado es un no seco. Ship fallido delante de todo el chat, basura.',
    'Bajo. Mejor ni intentarlo: el ranking ya firmó el fail delante de todo el chat, ridículo.',
    'Compatibilidad justa para el trámite y nada más. El resto es ruido delante de todo el chat, fracasado.',
    'Ship bajo documentado. Autor el número, testigo el puto grupo delante de todo el chat, joder.',
    'Estos dos juntos bajan el promedio del chat solo con el comando delante de todo el chat, mierda.',
    'Bajo. La química no existe y el bot no inventa delante de todo el chat, coño.',
    'Ship en números rojos. El ranking no ofrece consuelo delante de todo el chat, cabrón.',
    'Bajo de verdad: ni el almost salva este par delante de todo el chat, gilipollas.',
    'La compatibilidad es un gag y el grupo no pide replay delante de todo el chat, patético.',
    'Ship bajo. Separados estorban menos delante de todo el chat, asco.',
    'El número habla: bajo. Vosotros calláis delante de todo el chat, basura.',
    'Bajo. El ship es un experimento fallido del ranking delante de todo el chat, ridículo.',
    'Compatibilidad de sótano. El bot no suaviza el veredicto delante de todo el chat, fracasado.',
    'Ship bajo hasta para el modo oscuro del comando delante de todo el chat, joder.',
    'Estos dos no suman. Restan. El ranking lo firma delante de todo el chat, mierda.',
    'Bajo. Mejor archivo y olvido que insistir delante de todo el chat, coño.',
    'Ship fallido en limpio. Sin asterisco de caridad delante de todo el chat, cabrón.',
    'Bajo de los que el chat archiva sin debate delante de todo el chat, gilipollas.',
    'La química es cero con maquillaje de low. Se nota delante de todo el chat, patético.',
    'Ship en el tramo que nadie quiere. El número manda delante de todo el chat, asco.',
    'Bajo. El bot midió dos veces y las dos dio fail delante de todo el chat, basura.',
    'Compatibilidad de puta pena. El ranking no miente delante de todo el chat, ridículo.',
    'Ship bajo: el almost de pareja nunca llega delante de todo el chat, fracasado.',
    'Estos dos juntos son el gag del comando delante de todo el chat, joder.',
    'Bajo. Separados al menos no ensucian el mismo frame delante de todo el chat, mierda.',
    'Ship en rojo. El veredicto es seco y público delante de todo el chat, coño.',
    'Bajo de manual. El número no necesita narrador delante de todo el chat, cabrón.',
    'La compatibilidad se cayó sola antes del primer mensaje delante de todo el chat, gilipollas.',
    'Ship bajo documentado delante del grupo delante de todo el chat, patético.',
    'Bajo. Mejor no forzar lo que el ranking ya mató delante de todo el chat, asco.',
    'Compatibilidad de sótano sin ascensor delante de todo el chat, basura.',
    'Ship fallido. El bot cierra el parte sin consuelo delante de todo el chat, ridículo.',
    'Bajo hasta el cartel de salida del comando delante de todo el chat, fracasado.',
    'Estos dos no levantan el ship ni con milagro delante de todo el chat, joder.',
    'Bajo. El ranking firma y el chat archiva delante de todo el chat, mierda.',
    'Ship en el empty seat de la compatibilidad delante de todo el chat, coño.',
    'Bajo de verdad. Ni el low light favorece a este par delante de todo el chat, cabrón.',
    'La química es un rumor y el número lo desmiente delante de todo el chat, gilipollas.',
    'Ship bajo. El almost de pareja es eterno y vacío delante de todo el chat, patético.',
    'Bajo. Separados es el único consejo útil del bot delante de todo el chat, asco.',
    'Compatibilidad de mierda documentada en el ranking delante de todo el chat, basura.',
    'Ship fallido sin derecho a bis ni a apelación delante de todo el chat, ridículo.',
    'Bajo. El bot no regala décimas de caridad a este par delante de todo el chat, fracasado.',
    'Estos dos suman un fail con nombre propio delante de todo el chat, joder.',
    'Bajo de los que duelen en público delante de todo el chat, mierda.',
    'Ship en números que no se maquillan delante de todo el chat, coño.',
    'Bajo. La pareja es un experimento que el ranking abortó delante de todo el chat, cabrón.',
    'Compatibilidad de sótano. Sin filtro que salve delante de todo el chat, gilipollas.',
    'Ship bajo hasta para el modo avión del deseo delante de todo el chat, patético.',
    'Bajo. El número habla y vosotros no tenéis réplica delante de todo el chat, asco.',
    'Ship fallido. Archivo cerrado delante de todo el chat, basura.',
    'Bajo de puta madre en el sentido del desastre de pareja delante de todo el chat, ridículo.',
    'Compatibilidad justa para el gag y nada más delante de todo el chat, fracasado.'
  ],
  zero: [
    'Cero. La distancia química es un agujero, no un puente. El ranking lo grita delante de todo el chat, joder.',
    'Ship cero. Ni el almost existe. El bot cierra sin anestesia delante de todo el chat, mierda.',
    'Cero de compatibilidad. Separados es poco: mejor ni en el mismo chat delante de todo el chat, coño.',
    'Ship en el abismo. El número es un no rotundo delante de todo el chat, cabrón.',
    'Cero. Estos dos juntos son un error de casting del comando delante de todo el chat, gilipollas.',
    'Compatibilidad cero. El ranking no ofrece segunda oportunidad delante de todo el chat, patético.',
    'Ship cero documentado. Autor el número, testigo el grupo delante de todo el chat, asco.',
    'Cero. Mejor archivo permanente que insistir en el fail delante de todo el chat, basura.',
    'Ship en el empty total. Ni chispa ni almost delante de todo el chat, ridículo.',
    'Cero de verdad. El bot midió y el resultado es un agujero delante de todo el chat, fracasado.',
    'Estos dos no suman ni en broma. Restan en serio delante de todo el chat, joder.',
    'Ship cero. La química se fue y no dejó nota delante de todo el chat, mierda.',
    'Cero. El ranking firma el no sin narrador delante de todo el chat, coño.',
    'Compatibilidad de abismo. Sin puente posible delante de todo el chat, cabrón.',
    'Ship cero hasta para el modo oscuro del comando delante de todo el chat, gilipollas.',
    'Cero. Separados estorban menos al promedio del chat delante de todo el chat, patético.',
    'Ship en el sótano sin escalera. El número manda delante de todo el chat, asco.',
    'Cero documentado delante del puto grupo delante de todo el chat, basura.',
    'Ship fallido en grado cero. Sin asterisco delante de todo el chat, ridículo.',
    'Cero. El bot no regala ni una décima de caridad delante de todo el chat, fracasado.',
    'Estos dos son el gag más corto del comando delante de todo el chat, joder.',
    'Ship cero. El almost de pareja ni siquiera empezó delante de todo el chat, mierda.',
    'Cero. Mejor ni el trámite del comando delante de todo el chat, coño.',
    'Compatibilidad cero. El ranking cierra el parte delante de todo el chat, cabrón.',
    'Ship en el empty seat eterno delante de todo el chat, gilipollas.',
    'Cero de los que duelen porque ni ilusión quedó delante de todo el chat, patético.',
    'Ship cero. Archivo y olvido delante de todo el chat, asco.',
    'Cero. La distancia no se mide: se certifica delante de todo el chat, basura.',
    'Ship fallido total. Sin recurso ni bis delante de todo el chat, ridículo.',
    'Cero. El número es un muro y vosotros el eco delante de todo el chat, fracasado.',
    'Estos dos juntos bajan el promedio solo con el ship delante de todo el chat, joder.',
    'Ship cero. Ni el low light favorece este par delante de todo el chat, mierda.',
    'Cero de compatibilidad. El bot no inventa química delante de todo el chat, coño.',
    'Ship en el abismo documentado delante de todo el chat, cabrón.',
    'Cero. Separados es el único veredicto útil delante de todo el chat, gilipollas.',
    'Compatibilidad cero. Sin filtro que salve el frame delante de todo el chat, patético.',
    'Ship cero hasta el cartel de salida delante de todo el chat, asco.',
    'Cero delante de todo el chat, basura.',
    'Ship fallido en limpio. Cero es cero delante de todo el chat, ridículo.',
    'Cero de puta madre en el sentido del vacío de pareja delante de todo el chat, fracasado.',
    'Estos dos no levantan ni con milagro del ranking delante de todo el chat, joder.',
    'Ship cero. El chat archiva sin debate delante de todo el chat, mierda.',
    'Cero. La química es un rumor desmentido por el número delante de todo el chat, coño.',
    'Compatibilidad de abismo sin puente ni cuerda delante de todo el chat, cabrón.',
    'Ship cero. Mejor ni en la misma foto del grupo delante de todo el chat, gilipollas.',
    'Cero documentado. Autor el bot, testigo todos delante de todo el chat, patético.',
    'Ship en el empty total del deseo delante de todo el chat, asco.',
    'Cero. El almost ni se presentó al trámite delante de todo el chat, basura.',
    'Ship fallido. Cero sin maquillaje delante de todo el chat, ridículo.',
    'Cero. El número habla y no hay réplica posible delante de todo el chat, fracasado.',
    'Estos dos suman un agujero con nombre delante de todo el chat, joder.',
    'Ship cero. El ranking firma el no en público delante de todo el chat, mierda.',
    'Cero de verdad. Ni el modo avión oculta el fail delante de todo el chat, coño.',
    'Compatibilidad cero. Archivo cerrado delante de todo el chat, cabrón.',
    'Ship en el sótano sin luz ni escalera delante de todo el chat, gilipollas.',
    'Cero. Separados es piedad, juntos es el gag delante de todo el chat, patético.',
    'Ship cero hasta para el que no cree en el comando delante de todo el chat, asco.',
    'Cero. El bot midió dos veces y las dos dio vacío delante de todo el chat, basura.',
    'Ship fallido total. Sin consuelo ni narrador delante de todo el chat, ridículo.',
    'Cero de compatibilidad. El veredicto es un muro delante de todo el chat, fracasado.'
  ],
};
