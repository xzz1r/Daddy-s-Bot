...
const VERDICTS = {
  perfect: [
    ...
    'Match perfecto: dos taras que se cancelan. La ciencia no lo explica, esta mierda sí, cabrón El chat ya tomó nota, mierda.',
    'Compatibilidad total. Van a discutir todos los días y ninguno se va, gilipollas El chat ya tomó nota, coño.',
    'Ship redondo. El grupo va a sufrirlo en silencio durante años, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Perfectos el uno para el otro. Nadie más los aguantaría, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Cien por cien. Química de la que se nota y da un poco de asco ajeno, asco El chat ya tomó nota, patético.',
    'Match de manual. Menos mal que se tienen: el resto del mundo no aplica, patético El chat ya tomó nota, asco.',
    'Compatibilidad perfecta. Dos que se entienden sin escuchar, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Ship cerrado. El marcador no negocia y el chat tampoco, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cien. Que se besen ya y acabemos con el cringe colectivo, fracasado El chat ya tomó nota, fracasado.',
    'Perfectos. Uno pone el caos y el otro la paciencia tóxica, joder. El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Match que duele de ver desde fuera. Funciona demasiado bien, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Compatibilidad de la mala: la que dura, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Ship al máximo. El grupo ya está preparando el popcorn amargo, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Cien de compatibilidad. Insufrible y real, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Perfectos entre sí. Un desastre para el resto del hilo, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Match sin fisuras. Hasta el ranking aplaude a regañadientes, patético El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Compatibilidad total documentada. Caso cerrado, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Ship de los que se odian bien. Eso también es amor aquí, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cien. No hay tercero que entre en esa órbita, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Perfectos. El chat lo sabía antes que ellos, joder. El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Match químico sin anestesia. Duele mirarlo, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Compatibilidad de laboratorio roto, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Ship perfecto. El resto sobra, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Cien por cien de drama sostenible, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Perfectos el uno para el otro. Qué puta tragedia ajena, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Match cerrado con candado, patético El chat ya tomó nota, asco, y el ranking no discute, asco, y el grupo ya lo olió, asco.',
    'Compatibilidad máxima. Sin derecho a réplica, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Ship de los que el grupo no discute, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cien. Archivo y a sufrir, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Perfectos. La física del fail compartido, joder. El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Match que se siente en el hilo, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Compatibilidad sin escape, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Ship total. Menudo numerito, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Cien de cien y el chat lo traga, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Perfectos. No hay plan B que merezca la pena, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Match de los que se eligen mal a propósito, patético El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Compatibilidad perfecta de taras, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Ship al límite. El ranking firmó, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cien. Fin del debate, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
],
  high: [
    ...
    'Fuerte. No es perfecto, pero el aire cambia cuando salen juntos, cabrón El chat ya tomó nota, joder.',
    'Alto de verdad. El chat ya está shippeando sin pedir permiso, gilipollas El chat ya tomó nota, mierda.',
    'Buena química. El ranking lo marca y el resto inventa excusas, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Ship alto. Hay historia aunque lo nieguen, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Tensión real. No es fanfic: el número habla, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Alto. El grupo ve lo que ellos fingen no ver, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Fuerte compatibilidad. Casi molesta de lo obvio, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Ship de los que el hilo adelanta el final, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Alto. Material de drama sostenible, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Hay drift de puta madre. El marcador no miente, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Química alta. El chat ya tiene el ship name, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Fuerte. Casi perfecto y por eso da más rabia, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Ship alto documentado. Sin anestesia, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Tensión que se corta. El ranking aplaude, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Alto. Ellos en negación, el grupo en modo crónica, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Buena pareja de fail compartido, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship que se siente en cada respuesta cruzada, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Fuerte. No necesita narrador, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Alto de los que el almost duele, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Hay material. Y de sobra, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Química de las que no se improvisan, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Ship alto. El chat ya cobró entrada, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Fuerte compatibilidad con olor a drama, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Alto. El número cierra el caso, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Tensión real en un grupo de cínicos, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship que el ranking no discute, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Buena química, peor para el resto del hilo, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Alto. Casi perfectos y se nota, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Fuerte. Sin derecho a fingir lo contrario, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Hay drift. El grupo ya eligió bando, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Ship alto con potencial de incendio, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Química que molesta de lo clara, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Fuerte. El marcador no pide opiniones, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Alto de verdad. Archivado, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Tensión de la que se traduce en memes, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship que se ve venir a la legua, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Buena pareja según el bot y según el chisme, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Alto. Casi el techo, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura, y el grupo ya lo olió, basura.',
    'Fuerte compatibilidad sin anestesia, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
  ...
  mid: [
    ...
    'Mitad de camino. Ni spark de verdad ni rechazo limpio: zona tibia, joder. El chat ya tomó nota, joder.',
    'Ship mediocre. Como pizza sin queso: llega, pero para qué, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Medio. Hay algo, pero no suficiente para el hype del grupo, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Compatibilidad tibia. El ranking bostezó, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Ni fu ni fa. El ship más olvidable del catálogo, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Medio puro. Ni drama ni magia, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship de los que el chat no recuerda mañana, patético El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Mitad. Química de ascensor: existe y se acaba, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Mediocre. El número no miente y no emociona, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Zona gris. Ni ship ni enemigos, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Medio. Como serie cancelada en el capítulo tres, joder. El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Compatibilidad de trámite. Siguiente, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Ship tibio. El grupo ya cambió de tema, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Mitad de tarta. Nadie pide segunda porción, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Medio sin narrativa. Gracias por no inventarla, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ni spark ni tragedia. Solo mediocridad, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship administrativo. Firmado y olvidado, patético El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Mediocre de manual, basura El chat ya tomó nota, basura, y el ranking no discute, basura, y el grupo ya lo olió, basura.',
    'Zona media. El ranking no se emociona, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Mitad. Casi un no con maquillaje, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Medio. El hype se murió solo, joder. El chat ya tomó nota, joder, y el ranking no discute, joder, y el grupo ya lo olió, joder.',
    'Compatibilidad de sala de espera, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Ship sin gancho. El chat bostezó, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Tibio. Ni vale el thread, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Medio puro sin plot, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas, y el grupo ya lo olió, gilipollas.',
    'Ni química ni guerra. Solo relleno, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship de los que no generan meme, patético El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Mitad de camino al olvido, basura El chat ya tomó nota, basura, y el ranking no discute, basura, y el grupo ya lo olió, basura.',
    'Mediocre. El número lo dice sin drama, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Zona gris documentada, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Medio. Como café descafeinado del ship, joder. El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Compatibilidad sin especias, cabrón El chat ya tomó nota, mierda, y el ranking no discute, mierda, y el grupo ya lo olió, mierda.',
    'Ship tibio de los que sobran, gilipollas El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Mitad. El grupo no pide bis, mierda El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Medio sin derecho a hype, coño El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ni fu ni fa con sello oficial, asco El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship olvidable a propósito, patético El chat ya tomó nota, asco, y el ranking no discute, asco, y el grupo ya lo olió, asco.',
    'Tibio. Archivado sin ceremonia, basura El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Mediocre y previsible, ridículo El chat ya tomó nota, ridículo, y el ranking no discute, ridículo, y el grupo ya lo olió, ridículo.',
    'Zona media: el casi que no importa, fracasado El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
],
  low: [
    ...
    'Poca química. El ranking lo marca en rojo suave, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Ship bajo. Mejor ni forzar el crossover, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Compatibilidad de las que duelen de lo flojas, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Bajo. El grupo ya está en modo no, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Casi nada. Forzar esto es crueldad gratuita, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship de los que el número pide clemencia, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Bajo perfil de desastre compartido, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Poca chispa. Mucho potencial de cringe, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Compatibilidad en el sótano, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Bajo. Mejor amigos de mentira que esto, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Ship flojo. El chat no compra la premisa, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Poca química documentada, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda, y el grupo ya lo olió, mierda.',
    'Bajo de los que se ven venir, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Fail de pareja en versión preview, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Compatibilidad mínima. Casi un no, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship bajo sin derecho a defensa, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Poco material. Mucho riesgo de ridículo, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Bajo. El ranking no discute, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Química en huelga, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo, y el grupo ya lo olió, ridículo.',
    'Ship de los que mejor ni empezar, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Bajo perfil tóxico sin beneficio, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Poca compatibilidad real, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda, y el grupo ya lo olió, mierda.',
    'Fail anunciado con números, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Bajo. Archivado por piedad, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Casi cero con maquillaje, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship flojo de solemnidad, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Compatibilidad de trámite negativo, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Bajo. El grupo ya dijo que no, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Poca chispa, mucho papelón, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Ship en zona de peligro tibio, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Bajo de verdad. Sin anestesia, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder, y el grupo ya lo olió, joder.',
    'Química ausente con testigos, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Fail de pareja en diferido, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Bajo. No fuerces el crossover, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Poco ship, mucho cringe potencial, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Compatibilidad de sótano documentada, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship bajo sin plot twist, basura El chat ya tomó nota, asco, y el ranking no discute, asco, y el grupo ya lo olió, asco.',
    'Bajo. Caso casi cerrado, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura, y el grupo ya lo olió, basura.',
    'La química pidió la baja, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
  ...
  zero: [
    ...
    'Nada. Cero spark, cero futuro, cero debate, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Ship imposible. El ranking firmó el no, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Cero de cero. Ni en fanfic salva, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Nula compatibilidad. El chat ni lo intenta, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Cero. Mejor enemigos que esto, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship cancelado antes de empezar, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Nada de nada. El número es un muro, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Cero químico. Archivado con asco, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Imposible. Fin del experimento, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cero. Ni el RNG los junta con sentido, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Nula. El grupo respira aliviado, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Ship cero. Sin derecho a almost, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Nada. Química en modo avión eterno, mierda El chat ya tomó nota, coño, y el ranking no discute, coño.',
    'Cero total. Caso cerrado, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón, y el grupo ya lo olió, cabrón.',
    'Imposible de vender hasta de broma, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship nulo. El ranking no negocia, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Cero. Mejor cada uno por su lado, basura El chat ya tomó nota, asco, y el ranking no discute, asco, y el grupo ya lo olió, asco.',
    'Nula compatibilidad documentada, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Cero spark. Cero paciencia del chat, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Nada. El agujero donde debería haber química, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Ship imposible con sello oficial, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder.',
    'Cero. Ni forzado funciona, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Nula. Fin, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Cero de compatibilidad. Sin anestesia, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Imposible. El chat ya pasó página, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Ship cero sin narrador amigo, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Nada que salvar. Nada que inventar, basura El chat ya tomó nota, asco, y el ranking no discute, asco.',
    'Cero. El no más limpio del catálogo, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Nula química. Archivado, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo.',
    'Cero total. Ni meme salva esto, joder. El chat ya tomó nota, fracasado, y el ranking no discute, fracasado.',
    'Ship cancelado por el universo, cabrón El chat ya tomó nota, joder, y el ranking no discute, joder, y el grupo ya lo olió, joder.',
    'Nada. El ranking fue misericordioso al decir cero, gilipollas El chat ya tomó nota, mierda, y el ranking no discute, mierda.',
    'Cero. Punto final, mierda El chat ya tomó nota, coño, y el ranking no discute, coño, y el grupo ya lo olió, coño.',
    'Imposible de shippear sin autoengaño, coño El chat ya tomó nota, cabrón, y el ranking no discute, cabrón.',
    'Nula. El grupo lo sabía, asco El chat ya tomó nota, gilipollas, y el ranking no discute, gilipollas.',
    'Cero químico sin maquillaje, patético El chat ya tomó nota, patético, y el ranking no discute, patético.',
    'Ship nulo. Sin bis, basura El chat ya tomó nota, asco, y el ranking no discute, asco, y el grupo ya lo olió, asco.',
    'Nada de nada. Caso cerrado con llave, ridículo El chat ya tomó nota, basura, y el ranking no discute, basura.',
    'Cero. Y menos mal, fracasado El chat ya tomó nota, ridículo, y el ranking no discute, ridículo, y el grupo ya lo olió, ridículo.',
