...
const VERDICTS = {
  ...
  high: [
    'Alto. Hay drift, hay tensión, hay material de ship que el grupo ya olió El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta. No es pleno, pero el arco se ve sin forzar El ranking lo deja bastante claro, joder.',
    'Alto de los que ilusionan con razón: la química está y se nota El ranking lo deja bastante claro, joder.',
    'Ship sólido. Falta un empujón para el pleno, sobra base El ranking lo deja bastante claro, joder.',
    'Compatibilidad de las que el chat comenta en serio El ranking lo deja bastante claro, joder.',
    'Alto. No es cuento: el cálculo respalda el runoreo del grupo El ranking lo deja bastante claro, joder.',
    'Ship con sustancia. La tensión no es invento del comando El ranking lo deja bastante claro, joder.',
    ...
    'Ship que se sostiene solo. El número solo confirma El ranking lo deja bastante claro, joder.',
    'Alto. Hay arco, hay roce, hay motivo para mirar dos veces El ranking lo deja bastante claro, joder.',
    'Compatibilidad de las que duelen si no se consuman El ranking lo deja bastante claro, joder.',
    'Alto. El grupo lo veía: el bot pone el porcentaje El ranking lo deja bastante claro, joder.',
    'Ship con base real. No es cope, es cálculo El ranking lo deja bastante claro, joder.',
    'Alto de los limpios: química sin necesidad de guion forzado El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta y legible en el día a día del chat El ranking lo deja bastante claro, joder.',
    'Alto. El pleno es tentación, no fantasía El ranking lo deja bastante claro, joder.',
    'Ship con tensión de la buena: la que no se apaga sola El ranking lo deja bastante claro, joder.',
    'Alto. Material de pareja con número que no miente El ranking lo deja bastante claro, joder.',
    'Compatibilidad de quienes ya se buscan en el hilo sin decirlo El ranking lo deja bastante claro, joder.',
    'Alto. Falta poco para el cien y el poco se siente El ranking lo deja bastante claro, joder.',
    'Ship sólido documentado. El chat puede dejar de fingir sorpresa El ranking lo deja bastante claro, joder.',
    'Alto de verdad. La química tiene expediente El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta: el roce produce chispa, no solo roce El ranking lo deja bastante claro, joder.',
    'Alto. El arco está escrito a medias y pide final El ranking lo deja bastante claro, joder.',
    'Ship con sustancia suficiente para el rumor serio El ranking lo deja bastante claro, joder.',
    'Alto. No es el pleno y aun así pesa El ranking lo deja bastante claro, joder.',
    'Compatibilidad de las que el grupo banca en silencio El ranking lo deja bastante claro, joder.',
    'Alto. El número respalda lo que ya se comentaba El ranking lo deja bastante claro, joder.',
    'Ship con base: el resto es decisión de ellos, no del bot El ranking lo deja bastante claro, joder.',
    'Alto de los claros. La tensión no es un malentendido El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta y de cope El ranking lo deja bastante claro, joder.',
    'Alto. Hay match de verdad, no de relleno El ranking lo deja bastante claro, joder.',
    'Ship que se sostiene en el cálculo y en el chat El ranking lo deja bastante claro, joder.',
    'Alto. El pleno está a un mal día de distancia o a un buen sí El ranking lo deja bastante claro, joder.',
    'Compatibilidad de quienes ya ocupan espacio mental ajeno El ranking lo deja bastante claro, joder.',
    'Alto. Material de pareja con porcentaje que no pide fe El ranking lo deja bastante claro, joder.',
    'Ship sólido: el grupo puede dejar el cinismo un segundo El ranking lo deja bastante claro, joder.',
    'Alto de verdad. La química no es un rumor vacío El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta legible sin forzar el relato El ranking lo deja bastante claro, joder.',
    'Alto. Falta el cierre, sobra la base El ranking lo deja bastante claro, joder.',
    'Ship con arco real. El número es el subtítulo El ranking lo deja bastante claro, joder.',
    'Alto. El chat lo olió antes que el comando El ranking lo deja bastante claro, joder.',
    'Compatibilidad de las que duelen por lo cerca que están del pleno El ranking lo deja bastante claro, joder.',
    'Alto. No es cuento chino: es porcentaje con sustancia El ranking lo deja bastante claro, joder.',
    'Ship con tensión que no se apaga al cambiar de hilo El ranking lo deja bastante claro, joder.',
    'Alto de los limpios: match sin necesidad de milagro El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta y el grupo lo sabe El ranking lo deja bastante claro, joder.',
    'Alto. El bot confirma, no inventa El ranking lo deja bastante claro, joder.',
    'Ship sólido documentado sin drama falso El ranking lo deja bastante claro, joder.',
    'Alto. Hay drift de pareja, no solo de amistad de chat El ranking lo deja bastante claro, joder.',
    ...
    'Ship con base y con roce. El número pesa El ranking lo deja bastante claro, joder.',
    'Alto de verdad. La química tiene testigos en el hilo El ranking lo deja bastante claro, joder.',
    'Compatibilidad alta: piezas que encajan con historia El ranking lo deja bastante claro, joder.',
    'Alto. Material suficiente para que el rumor sea legítimo El ranking lo deja bastante claro, joder.',
    'Ship que se sostiene solo ante el cálculo El ranking lo deja bastante claro, joder.',
    'Alto. El grupo puede dejar de hacerse el sorprendido El ranking lo deja bastante claro, joder.',
  ...
  low: [
    'Bajo de verdad. Estos dos juntos son un fail anunciado y el número lo grita sin filtro delante del puto grupo, joder.',
    ...
    'Bajo. El ship no levanta ni con tutorial ni con rezo del puto grupo delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    ...
    'El bot midió y el resultado es un no seco. Ship fallido en limpio delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Bajo. Mejor ni intentarlo: el ranking ya firmó el fail en público delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Compatibilidad justa para el trámite y nada más. El resto es ruido delante del puto grupo, fracasado.',
    'Ship bajo documentado. Autor el número, testigo el puto grupo entero delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Estos dos juntos bajan el promedio del chat solo con el comando delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Bajo. La química no existe y el bot no inventa lo que no hay delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Ship en números rojos. El ranking no ofrece consuelo ni anestesia delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Bajo de verdad: ni el almost salva a este par del sótano delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'La compatibilidad es un gag y el grupo no pide replay del fail delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship bajo. Separados estorban menos al promedio del ranking delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'El número habla: bajo. Vosotros calláis porque no hay réplica delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Bajo. El ship es un experimento fallido del ranking del grupo delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Compatibilidad de sótano. El bot no suaviza el veredicto público delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Ship bajo hasta para el modo oscuro del comando de pareja delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Estos dos no suman. Restan. El ranking lo firma sin debate delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Bajo. Mejor archivo y olvido que insistir en este fail delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Ship fallido en limpio. Sin asterisco de caridad del bot delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Bajo de los que el chat archiva sin pedir amplificación delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'La química es cero con maquillaje de low. Se nota a la legua delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship en el tramo que nadie quiere. El número manda y punto delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Bajo. El bot midió dos veces y las dos dio fail de pareja delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Compatibilidad de puta pena. El ranking no miente nunca delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Ship bajo: el almost de pareja nunca llega a puerto delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos juntos son el gag del comando y del chat delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Bajo. Separados al menos no ensucian el mismo frame delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Ship en rojo. El veredicto es seco y público en el ranking delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Bajo de manual. El número no necesita narrador emocional delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'La compatibilidad se cayó sola antes del primer mensaje delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Ship bajo documentado delante de todo el puto grupo delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Bajo. Mejor no forzar lo que el ranking ya mató delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Compatibilidad de sótano sin ascensor ni luz de emergencia delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido. El bot cierra el parte sin consuelo posible delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Bajo hasta el cartel de salida del comando de pareja delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos no levantan el ship ni con milagro del ranking delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Bajo. El ranking firma y el chat archiva sin debate delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Ship en el empty seat de la compatibilidad del grupo delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Bajo de verdad. Ni el low light favorece a este par delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'La química es un rumor y el número lo desmiente en seco delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Ship bajo. El almost de pareja es eterno y vacío delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Bajo. Separados es el único consejo útil del bot delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Compatibilidad de mierda documentada en el ranking delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido sin derecho a bis ni a apelación posible delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Bajo. El bot no regala décimas de caridad a este par delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos suman un fail con nombre propio en el chat delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Bajo de los que duelen en público delante del grupo delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Ship en números que no se maquillan con filtros delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Bajo. La pareja es un experimento que el ranking abortó delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Compatibilidad de sótano. Sin filtro que salve el frame delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Ship bajo hasta para el modo avión del deseo ajeno delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Bajo. El número habla y vosotros no tenéis réplica útil delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Ship fallido. Archivo cerrado sin segunda oportunidad delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Bajo de puta madre en el sentido del desastre de pareja delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Compatibilidad justa para el gag del comando y nada más delante del puto grupo, fracasado y el chat ya lo archivó sin debate.'
  ],
  zero: [
    'Cero. La distancia química es un agujero, no un puente. El ranking lo grita delante del puto grupo, joder.',
    'Ship cero. Ni el almost existe. El bot cierra sin anestesia ni consuelo delante del puto grupo, mierda.',
    'Cero de compatibilidad. Separados es poco: mejor ni en el mismo chat delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Ship en el abismo. El número es un no rotundo sin maquillaje delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Cero. Estos dos juntos son un error de casting del comando delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Compatibilidad cero. El ranking no ofrece segunda oportunidad útil delante del puto grupo, patético.',
    'Ship cero documentado. Autor el número, testigo el grupo entero delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero. Mejor archivo permanente que insistir en este fail delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship en el empty total. Ni chispa ni almost de pareja delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero de verdad. El bot midió y el resultado es un agujero delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos no suman ni en broma. Restan en serio en el ranking delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Ship cero. La química se fue y no dejó ni una puta nota delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Cero. El ranking firma el no sin narrador emocional delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Compatibilidad de abismo. Sin puente posible en este comando delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Ship cero hasta para el modo oscuro del ranking del grupo delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Cero. Separados estorban menos al promedio del chat delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship en el sótano sin escalera. El número manda y punto delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero documentado delante del puto grupo sin filtro delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido en grado cero. Sin asterisco de caridad delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero. El bot no regala ni una décima de caridad visual delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos son el gag más corto del comando de pareja delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Ship cero. El almost de pareja ni siquiera empezó delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Cero. Mejor ni el trámite del comando en este caso delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Compatibilidad cero. El ranking cierra el parte en seco delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Ship en el empty seat eterno del deseo del ranking delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Cero de los que duelen porque ni ilusión quedó en pie delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship cero. Archivo y olvido sin segunda lectura útil delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero. La distancia no se mide: se certifica en el bot delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido total. Sin recurso ni bis posible aquí delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero. El número es un muro y vosotros el eco del fail delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos juntos bajan el promedio solo con el ship delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Ship cero. Ni el low light favorece a este par de mierda delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Cero de compatibilidad. El bot no inventa química ajena delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Ship en el abismo documentado sin consuelo del ranking delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Cero. Separados es el único veredicto útil del comando delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Compatibilidad cero. Sin filtro que salve el frame junto delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship cero hasta el cartel de salida del puto ranking delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero. El ranking no suaviza este no de pareja nunca delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido en limpio. Cero es cero y punto final delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero de puta madre en el sentido del vacío de pareja delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos no levantan ni con milagro del ranking del grupo delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Ship cero. El chat archiva sin debate ni amplificación delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Cero. La química es un rumor desmentido por el número delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Compatibilidad de abismo sin puente ni cuerda de escape delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Ship cero. Mejor ni en la misma foto del puto grupo delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Cero documentado. Autor el bot, testigo todos en el chat delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship en el empty total del deseo del ranking del grupo delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero. El almost ni se presentó al trámite del comando delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido. Cero sin maquillaje ni narrador emocional delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero. El número habla y no hay réplica posible aquí delante del puto grupo, fracasado y el chat ya lo archivó sin debate.',
    'Estos dos suman un agujero con nombre en el ranking delante del puto grupo, joder y el chat ya lo archivó sin debate.',
    'Ship cero. El ranking firma el no en público y listo delante del puto grupo, mierda y el chat ya lo archivó sin debate.',
    'Cero de verdad. Ni el modo avión oculta este fail delante del puto grupo, coño y el chat ya lo archivó sin debate.',
    'Compatibilidad cero. Archivo cerrado sin recurso útil delante del puto grupo, cabrón y el chat ya lo archivó sin debate.',
    'Ship en el sótano sin luz ni escalera de emergencia delante del puto grupo, gilipollas y el chat ya lo archivó sin debate.',
    'Cero. Separados es piedad, juntos es el gag del chat delante del puto grupo, patético y el chat ya lo archivó sin debate.',
    'Ship cero hasta para el que no cree en el comando delante del puto grupo, asco y el chat ya lo archivó sin debate.',
    'Cero. El bot midió dos veces y las dos dio vacío total delante del puto grupo, basura y el chat ya lo archivó sin debate.',
    'Ship fallido total. Sin consuelo ni narrador que salve delante del puto grupo, ridículo y el chat ya lo archivó sin debate.',
    'Cero de compatibilidad. El veredicto es un muro seco delante del puto grupo, fracasado y el chat ya lo archivó sin debate.'
  ],
};
