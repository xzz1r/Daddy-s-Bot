...
const VERDICTS = {
  ...
  low: [
    ...
    'Ship bajo documentado. Autor el número, testigo el puto grupo entero delante del puto grupo, joder.',
    ...
    'Ship bajo hasta para el modo oscuro del comando de pareja delante del puto grupo, joder.',
    ...
    'Estos dos juntos son el gag del comando y del chat delante del puto grupo, joder.',
    ...
    'Estos dos no levantan el ship ni con milagro del ranking delante del puto grupo, joder.',
    ...
    'Estos dos suman un fail con nombre propio en el chat delante del puto grupo, joder.',
  ...
  zero: [
    ...
    'Estos dos no suman ni en broma. Restan en serio en el ranking delante del puto grupo, joder.',
    ...
    'Estos dos son el gag más corto del comando de pareja delante del puto grupo, joder.',
    ...
    'Estos dos juntos bajan el promedio solo con el ship delante del puto grupo, joder.',
    ...
    'Cero. El ranking no suaviza este no de pareja nunca delante del puto grupo, basura.',
    ...
    'Estos dos no levantan ni con milagro del ranking del grupo delante del puto grupo, joder.',
    ...
    'Estos dos suman un agujero con nombre en el ranking delante del puto grupo, joder.',
