...
const VERDICTS = {
  ...
  low: [
    'Bajo de verdad. Estos dos juntos son un fail anunciado y el número lo grita sin filtro, mierda El ranking no suaviza este veredicto, joder.',
    'Ship bajo: la química es un agujero y no un puente. El bot no regala décimas, cabrón El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de mierda. Mejor separados que ensuciando el ranking juntos, coño El ranking no suaviza este veredicto, joder.',
    'Bajo. El ship no levanta ni con tutorial ni con rezo del puto grupo, gilipollas El ranking no suaviza este veredicto, joder.',
    'Estos dos suman menos que por separado. Matemáticas crueles del ranking, patético El ranking no suaviza este veredicto, joder.',
    'Ship en el sótano. El número no admite recurso ni segunda lectura útil, asco El ranking no suaviza este veredicto, joder.',
    'Bajo de los que duelen. La compatibilidad se fue a la mierda y no vuelve, basura El ranking no suaviza este veredicto, joder.',
    'El bot midió y el resultado es un no seco. Ship fallido en limpio, ridículo El ranking no suaviza este veredicto, joder.',
    'Bajo. Mejor ni intentarlo: el ranking ya firmó el fail en público, fracasado El ranking no suaviza este veredicto, joder.',
    'Compatibilidad justa para el trámite y nada más. El resto es ruido, joder El ranking no suaviza este veredicto, joder.',
    'Ship bajo documentado. Autor el número, testigo el puto grupo entero, mierda El ranking no suaviza este veredicto, joder.',
    'Estos dos juntos bajan el promedio del chat solo con el comando, cabrón El ranking no suaviza este veredicto, joder.',
    'Bajo. La química no existe y el bot no inventa lo que no hay, coño El ranking no suaviza este veredicto, joder.',
    'Ship en números rojos. El ranking no ofrece consuelo ni anestesia, gilipollas El ranking no suaviza este veredicto, joder.',
    'Bajo de verdad: ni el almost salva a este par del sótano, patético El ranking no suaviza este veredicto, joder.',
    'La compatibilidad es un gag y el grupo no pide replay del fail, asco El ranking no suaviza este veredicto, joder.',
    'Ship bajo. Separados estorban menos al promedio del ranking, basura El ranking no suaviza este veredicto, joder.',
    'El número habla: bajo. Vosotros calláis porque no hay réplica, ridículo El ranking no suaviza este veredicto, joder.',
    'Bajo. El ship es un experimento fallido del ranking del grupo, fracasado El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de sótano. El bot no suaviza el veredicto público, joder El ranking no suaviza este veredicto, joder.',
    'Ship bajo hasta para el modo oscuro del comando de pareja, mierda El ranking no suaviza este veredicto, joder.',
    'Estos dos no suman. Restan. El ranking lo firma sin debate, cabrón El ranking no suaviza este veredicto, joder.',
    'Bajo. Mejor archivo y olvido que insistir en este fail, coño El ranking no suaviza este veredicto, joder.',
    'Ship fallido en limpio. Sin asterisco de caridad del bot, gilipollas El ranking no suaviza este veredicto, joder.',
    'Bajo de los que el chat archiva sin pedir amplificación, patético El ranking no suaviza este veredicto, joder.',
    'La química es cero con maquillaje de low. Se nota a la legua, asco El ranking no suaviza este veredicto, joder.',
    'Ship en el tramo que nadie quiere. El número manda y punto, basura El ranking no suaviza este veredicto, joder.',
    'Bajo. El bot midió dos veces y las dos dio fail de pareja, ridículo El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de puta pena. El ranking no miente nunca, fracasado El ranking no suaviza este veredicto, joder.',
    'Ship bajo: el almost de pareja nunca llega a puerto, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos juntos son el gag del comando y del chat, mierda El ranking no suaviza este veredicto, joder.',
    'Bajo. Separados al menos no ensucian el mismo frame, cabrón El ranking no suaviza este veredicto, joder.',
    'Ship en rojo. El veredicto es seco y público en el ranking, coño El ranking no suaviza este veredicto, joder.',
    'Bajo de manual. El número no necesita narrador emocional, gilipollas El ranking no suaviza este veredicto, joder.',
    'La compatibilidad se cayó sola antes del primer mensaje, patético El ranking no suaviza este veredicto, joder.',
    'Ship bajo documentado delante de todo el puto grupo, asco El ranking no suaviza este veredicto, joder.',
    'Bajo. Mejor no forzar lo que el ranking ya mató, basura El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de sótano sin ascensor ni luz de emergencia, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido. El bot cierra el parte sin consuelo posible, fracasado El ranking no suaviza este veredicto, joder.',
    'Bajo hasta el cartel de salida del comando de pareja, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos no levantan el ship ni con milagro del ranking, mierda El ranking no suaviza este veredicto, joder.',
    'Bajo. El ranking firma y el chat archiva sin debate, cabrón El ranking no suaviza este veredicto, joder.',
    'Ship en el empty seat de la compatibilidad del grupo, coño El ranking no suaviza este veredicto, joder.',
    'Bajo de verdad. Ni el low light favorece a este par, gilipollas El ranking no suaviza este veredicto, joder.',
    'La química es un rumor y el número lo desmiente en seco, patético El ranking no suaviza este veredicto, joder.',
    'Ship bajo. El almost de pareja es eterno y vacío, asco El ranking no suaviza este veredicto, joder El ranking no suaviza este veredicto, joder.',
    'Bajo. Separados es el único consejo útil del bot, basura El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de mierda documentada en el ranking, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido sin derecho a bis ni a apelación posible, fracasado El ranking no suaviza este veredicto, joder.',
    'Bajo. El bot no regala décimas de caridad a este par, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos suman un fail con nombre propio en el chat, mierda El ranking no suaviza este veredicto, joder.',
    'Bajo de los que duelen en público delante del grupo, cabrón El ranking no suaviza este veredicto, joder.',
    'Ship en números que no se maquillan con filtros, coño El ranking no suaviza este veredicto, joder El ranking no suaviza este veredicto, joder.',
    'Bajo. La pareja es un experimento que el ranking abortó, gilipollas El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de sótano. Sin filtro que salve el frame, patético El ranking no suaviza este veredicto, joder.',
    'Ship bajo hasta para el modo avión del deseo ajeno, asco El ranking no suaviza este veredicto, joder.',
    'Bajo. El número habla y vosotros no tenéis réplica útil, basura El ranking no suaviza este veredicto, joder.',
    'Ship fallido. Archivo cerrado sin segunda oportunidad, ridículo El ranking no suaviza este veredicto, joder.',
    'Bajo de puta madre en el sentido del desastre de pareja, fracasado El ranking no suaviza este veredicto, joder.',
    'Compatibilidad justa para el gag del comando y nada más, joder El ranking no suaviza este veredicto, joder.'
  ],
  zero: [
    'Cero. La distancia química es un agujero, no un puente. El ranking lo grita, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. Ni el almost existe. El bot cierra sin anestesia ni consuelo, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero de compatibilidad. Separados es poco: mejor ni en el mismo chat, coño El ranking no suaviza este veredicto, joder.',
    'Ship en el abismo. El número es un no rotundo sin maquillaje, gilipollas El ranking no suaviza este veredicto, joder.',
    'Cero. Estos dos juntos son un error de casting del comando, patético El ranking no suaviza este veredicto, joder.',
    'Compatibilidad cero. El ranking no ofrece segunda oportunidad útil, asco El ranking no suaviza este veredicto, joder.',
    'Ship cero documentado. Autor el número, testigo el grupo entero, basura El ranking no suaviza este veredicto, joder.',
    'Cero. Mejor archivo permanente que insistir en este fail, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship en el empty total. Ni chispa ni almost de pareja, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero de verdad. El bot midió y el resultado es un agujero, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos no suman ni en broma. Restan en serio en el ranking, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. La química se fue y no dejó ni una puta nota, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero. El ranking firma el no sin narrador emocional, coño El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de abismo. Sin puente posible en este comando, gilipollas El ranking no suaviza este veredicto, joder.',
    'Ship cero hasta para el modo oscuro del ranking del grupo, patético El ranking no suaviza este veredicto, joder.',
    'Cero. Separados estorban menos al promedio del chat, asco El ranking no suaviza este veredicto, joder.',
    'Ship en el sótano sin escalera. El número manda y punto, basura El ranking no suaviza este veredicto, joder.',
    'Cero documentado delante del puto grupo sin filtro, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido en grado cero. Sin asterisco de caridad, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero. El bot no regala ni una décima de caridad visual, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos son el gag más corto del comando de pareja, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. El almost de pareja ni siquiera empezó, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero. Mejor ni el trámite del comando en este caso, coño El ranking no suaviza este veredicto, joder.',
    'Compatibilidad cero. El ranking cierra el parte en seco, gilipollas El ranking no suaviza este veredicto, joder.',
    'Ship en el empty seat eterno del deseo del ranking, patético El ranking no suaviza este veredicto, joder.',
    'Cero de los que duelen porque ni ilusión quedó en pie, asco El ranking no suaviza este veredicto, joder.',
    'Ship cero. Archivo y olvido sin segunda lectura útil, basura El ranking no suaviza este veredicto, joder.',
    'Cero. La distancia no se mide: se certifica en el bot, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido total. Sin recurso ni bis posible aquí, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero. El número es un muro y vosotros el eco del fail, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos juntos bajan el promedio solo con el ship, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. Ni el low light favorece a este par de mierda, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero de compatibilidad. El bot no inventa química ajena, coño El ranking no suaviza este veredicto, joder.',
    'Ship en el abismo documentado sin consuelo del ranking, gilipollas El ranking no suaviza este veredicto, joder.',
    'Cero. Separados es el único veredicto útil del comando, patético El ranking no suaviza este veredicto, joder.',
    'Compatibilidad cero. Sin filtro que salve el frame junto, asco El ranking no suaviza este veredicto, joder.',
    'Ship cero hasta el cartel de salida del puto ranking, basura El ranking no suaviza este veredicto, joder.',
    'Cero. El ranking no suaviza este no de pareja nunca, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido en limpio. Cero es cero y punto final, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero de puta madre en el sentido del vacío de pareja, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos no levantan ni con milagro del ranking del grupo, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. El chat archiva sin debate ni amplificación, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero. La química es un rumor desmentido por el número, coño El ranking no suaviza este veredicto, joder.',
    'Compatibilidad de abismo sin puente ni cuerda de escape, gilipollas El ranking no suaviza este veredicto, joder.',
    'Ship cero. Mejor ni en la misma foto del puto grupo, patético El ranking no suaviza este veredicto, joder.',
    'Cero documentado. Autor el bot, testigo todos en el chat, asco El ranking no suaviza este veredicto, joder.',
    'Ship en el empty total del deseo del ranking del grupo, basura El ranking no suaviza este veredicto, joder.',
    'Cero. El almost ni se presentó al trámite del comando, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido. Cero sin maquillaje ni narrador emocional, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero. El número habla y no hay réplica posible aquí, joder El ranking no suaviza este veredicto, joder.',
    'Estos dos suman un agujero con nombre en el ranking, mierda El ranking no suaviza este veredicto, joder.',
    'Ship cero. El ranking firma el no en público y listo, cabrón El ranking no suaviza este veredicto, joder.',
    'Cero de verdad. Ni el modo avión oculta este fail, coño El ranking no suaviza este veredicto, joder.',
    'Compatibilidad cero. Archivo cerrado sin recurso útil, gilipollas El ranking no suaviza este veredicto, joder.',
    'Ship en el sótano sin luz ni escalera de emergencia, patético El ranking no suaviza este veredicto, joder.',
    'Cero. Separados es piedad, juntos es el gag del chat, asco El ranking no suaviza este veredicto, joder.',
    'Ship cero hasta para el que no cree en el comando, basura El ranking no suaviza este veredicto, joder.',
    'Cero. El bot midió dos veces y las dos dio vacío total, ridículo El ranking no suaviza este veredicto, joder.',
    'Ship fallido total. Sin consuelo ni narrador que salve, fracasado El ranking no suaviza este veredicto, joder.',
    'Cero de compatibilidad. El veredicto es un muro seco, joder El ranking no suaviza este veredicto, joder.'
  ],
};
