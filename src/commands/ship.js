...
const VERDICTS = {
  ...
  high: [
    ...
    'Compatibilidad alta. No es pleno, pero el arco se ve sin forzar. Sin anestesia, mierda.',
    'Alto de los que ilusionan con razón: la química está y se nota. Sin anestesia, coño.',
    'Ship sólido. Falta un empujón para el pleno, sobra base. Sin anestesia, cabrón.',
    'Compatibilidad de las que el chat comenta en serio. Sin anestesia, gilipollas.',
    'Alto. No es cuento: el cálculo respalda el runoreo del grupo. Sin anestesia, patético.',
    'Ship con sustancia. La tensión no es invento del comando. Sin anestesia, ridículo.',
    'Alto de verdad. El pleno está cerca si el universo no es cabrón. Sin anestesia, basura.',
    'Compatibilidad alta: piezas que encajan con roce interesante. Sin anestesia, desperdicio.',
    'Ship que se sostiene solo. El número solo confirma. Sin anestesia, asco.',
    'Alto. Hay arco, hay roce, hay motivo para mirar dos veces. Sin anestesia, cutre.',
    'Compatibilidad de las que duelen si no se consuman. Sin anestesia, pringado.',
    'Alto. El grupo lo veía: el bot pone el porcentaje. Sin anestesia, fracasado.',
    'Ship con base real. No es cope, es cálculo. Sin anestesia, joder.',
    'Alto de los limpios: química sin necesidad de guion forzado. Sin anestesia, mierda.',
    'Compatibilidad alta y legible en el día a día del chat. Sin anestesia, coño.',
    'Alto. El pleno es tentación, no fantasía. Sin anestesia, cabrón.',
    'Ship con tensión de la buena: la que no se apaga sola. Sin anestesia, gilipollas.',
    'Alto. Material de pareja con número que no miente. Sin anestesia, patético.',
    'Compatibilidad de quienes ya se buscan en el hilo sin decirlo. Sin anestesia, ridículo.',
    'Alto. Falta poco para el cien y el poco se siente. Sin anestesia, basura.',
    'Ship sólido documentado. El chat puede dejar de fingir sorpresa. El grupo lo veía venir, desperdicio.',
    'Alto de verdad. La química tiene expediente. Sin anestesia, asco.',
    'Compatibilidad alta: el roce produce chispa, no solo roce. Sin anestesia, cutre.',
    'Alto. El arco está escrito a medias y pide final. Sin anestesia, pringado.',
    'Ship con sustancia suficiente para el rumor serio. Sin anestesia, fracasado.',
    'Alto. No es el pleno y aun así pesa. Sin anestesia, joder.',
    'Compatibilidad de las que el grupo banca en silencio. Sin anestesia, mierda.',
    'Alto. El número respalda lo que ya se comentaba. Sin anestesia, coño.',
    'Ship con base: el resto es decisión de ellos, no del bot. Sin anestesia, cabrón.',
    'Alto de los claros. La tensión no es un malentendido. Sin anestesia, gilipollas.',
    'Compatibilidad alta y sin anestesia de cope. Sin anestesia, patético.',
    'Alto. Hay match de verdad, no de relleno. Sin anestesia, ridículo.',
    'Ship que se sostiene en el cálculo y en el chat. Sin anestesia, basura.',
    'Alto. El pleno está a un mal día de distancia o a un buen sí. Sin anestesia, desperdicio.',
    'Compatibilidad de quienes ya ocupan espacio mental ajeno. Sin anestesia, asco.',
    'Alto. Material de pareja con porcentaje que no pide fe. Sin anestesia, cutre.',
    'Ship sólido: el grupo puede dejar el cinismo un segundo. Sin anestesia, pringado.',
    'Alto de verdad. La química no es un rumor vacío. Sin anestesia, fracasado.',
    'Compatibilidad alta legible sin forzar el relato. Sin anestesia, joder.',
    'Alto. Falta el cierre, sobra la base. Sin anestesia, mierda.',
    'Ship con arco real. El número es el subtítulo. Sin anestesia, coño.',
    'Alto. El chat lo olió antes que el comando. Sin anestesia, cabrón.',
    'Compatibilidad de las que duelen por lo cerca que están del pleno. El grupo lo veía venir, gilipollas.',
    'Alto. No es cuento chino: es porcentaje con sustancia. Sin anestesia, patético.',
    'Ship con tensión que no se apaga al cambiar de hilo. Sin anestesia, ridículo.',
    'Alto de los limpios: match sin necesidad de milagro. Sin anestesia, basura.',
    'Compatibilidad alta y el grupo lo sabe. Sin anestesia, desperdicio.',
    'Alto. El bot confirma, no inventa. Sin anestesia, asco.',
    'Ship sólido documentado sin drama falso. Sin anestesia, cutre.',
    'Alto. Hay drift de pareja, no solo de amistad de chat. Sin anestesia, pringado.',
    'Compatibilidad de quienes ya se eligen en las bromas del grupo. Sin anestesia, fracasado.',
    'Alto. El pleno es el siguiente tramo natural, no un salto imposible. Sin anestesia, joder.',
    'Ship con base y con roce. El número pesa. Sin anestesia, mierda.',
    'Alto de verdad. La química tiene testigos en el hilo. Sin anestesia, coño.',
    'Compatibilidad alta: piezas que encajan con historia. Sin anestesia, cabrón.',
    'Alto. Material suficiente para que el rumor sea legítimo. Sin anestesia, gilipollas.',
    'Ship que se sostiene solo ante el cálculo. Sin anestesia, patético.',
    'Alto. El grupo puede dejar de hacerse el sorprendido. Sin anestesia, ridículo.',
  ...
  low: [
    'Bajo. Hay menos química aquí que en un vaso de agua del grifo. Sin anestesia, joder.',
    'Compatibilidad floja. Se aguantan en el mismo chat y poco más. Sin anestesia, mierda.',
    'Bajo de verdad. El ship cojea y no es de gracia. Sin anestesia, coño.',
    'Poca cosa. Ni chispa ni drama interesante: solo el número bajo. Sin anestesia, cabrón.',
    ...
    'Ship flojo. La química pidió la baja médica. Sin anestesia, ridículo.',
    'Bajo de los que duelen de lo previsible: no hay match y se nota. Sin anestesia, basura.',
    'Compatibilidad tibia hacia abajo. El termómetro bosteza. Sin anestesia, desperdicio.',
    'Bajo. Ni el alcohol cósmico arregla este cálculo. Sin anestesia, asco.',
    'Poca química. El comando no necesita adorno para el no casi total. Sin anestesia, cutre.',
    'Ship en zona de peligro de aburrimiento: bajo y sin arco. Sin anestesia, pringado.',
    'Bajo. Se toleran: eso no es un match, es civismo mínimo. Sin anestesia, fracasado.',
    'Compatibilidad de quien comparte grupo y nada más. Sin anestesia, joder.',
    'Bajo de solemnidad: el romance no vive aquí. Sin anestesia, mierda.',
    'Ship flojo documentado. El chat no discute el número. Sin anestesia, coño.',
    'Bajo. La chispa se mojó antes de acercarse. Sin anestesia, cabrón.',
    'Compatibilidad escasa: el puente es un tablón roto. Sin anestesia, gilipollas.',
    'Bajo. Mejor amigos de la distancia que pareja de este número. Sin anestesia, patético.',
    'Ship en el tramo que no ilusiona ni al más cope. Sin anestesia, ridículo.',
    'Bajo de verdad. El bot no regala décimas de caridad. Sin anestesia, basura.',
    'Compatibilidad justa para el trámite del comando y nada más. Sin anestesia, desperdicio.',
    'Bajo. Dos trayectorias paralelas que no se tocan. Sin anestesia, asco.',
    'Ship flojo: el drama sería más interesante por separado. Sin anestesia, cutre.',
    'Bajo. La química está de vacaciones indefinidas. Sin anestesia, pringado.',
    'Compatibilidad tibia-fría. El jersey no calienta. Sin anestesia, fracasado.',
    'Bajo. El match existe solo porque el comando lo forzó a existir. Sin anestesia, joder.',
    'Ship en números que piden otro intento con otras personas. Sin anestesia, mierda.',
    'Bajo. Ni tensión ni paz interesante: solo el bajo. Sin anestesia, coño.',
    'Compatibilidad de pasillo de grupo: se cruzan y ya. Sin anestesia, cabrón.',
    'Bajo de los claros. El grupo no necesitaba el porcentaje. Sin anestesia, gilipollas.',
    'Ship flojo sin derecho a narración épica. Sin anestesia, patético.',
    'Bajo. La idea de pareja aquí es un malentendido del azar. Sin anestesia, ridículo.',
    'Compatibilidad escasa y se nota en el silencio del chat al ver el número. El grupo lo veía venir, basura.',
    'Bajo. Mejor no forzar lo que el cálculo ya enterró. Sin anestesia, desperdicio.',
    'Ship en zona de no-recomendable según este bot. Sin anestesia, asco.',
    'Bajo. Química de archivo muerto. Sin anestesia, cutre.',
    'Compatibilidad de quienes comparten wifi del grupo y nada del resto. El grupo lo veía venir, pringado.',
    'Bajo. El romance pidió traslado. Sin anestesia, fracasado.',
    'Ship flojo: el número es el mensaje, el resto es cortesía. Sin anestesia, joder.',
    'Bajo de vergüenza ajena si alguien lo celebrara. Sin anestesia, mierda.',
    'Compatibilidad justa para no ser cero: el consuelo más triste. Sin anestesia, coño.',
    'Bajo. Dos piezas que no son del mismo puzzle. Sin anestesia, cabrón.',
    'Ship en el tramo del bostezo colectivo. Sin anestesia, gilipollas.',
    'Bajo. La chispa no solo no prende: no existe el yesquero. Sin anestesia, patético.',
    'Compatibilidad tibia hacia el sótano. Sin anestesia, ridículo.',
    'Bajo. El comando cumple el trámite; el corazón no. Sin anestesia, basura.',
    'Ship flojo sin arco, sin tensión, con número honesto. Sin anestesia, desperdicio.',
    'Bajo de los que cierran el debate en una línea. Sin anestesia, asco.',
    'Compatibilidad de vecinos de hilo, no de pareja. Sin anestesia, cutre.',
    'Bajo. El azar se arrepiente de haberlos puesto en la misma frase. Sin anestesia, pringado.',
    'Ship en números que piden cambio de objetivo. Sin anestesia, fracasado.',
    'Bajo. Química ausente con disculpas del universo. Sin anestesia, joder.',
    'Compatibilidad escasa: el tablón del puente ya era de cartón. Sin anestesia, mierda.',
    'Bajo. Mejor el no claro que el sí forzado. Sin anestesia, coño.',
    'Ship flojo documentado sin anestesia. Sin anestesia, cabrón.',
    'Bajo. El match es un malentendido estadístico. Sin anestesia, gilipollas.',
    'Compatibilidad de quienes se soportan en silencio y poco más. Sin anestesia, patético.',
    'Bajo de verdad. Siguiente pareja, por favor. Sin anestesia, ridículo.',
    'Ship en el tramo donde el bot casi pone cero por redondeo. Sin anestesia, basura.'
  ],
  zero: [
    'Cero. Estos dos juntos son un accidente de calendario, no un ship. Sin anestesia, joder.',
    ...
    'Cero. Ni por descarte, ni por pena, ni por alcohol cósmico. Sin anestesia, desperdicio.',
    'Ship cancelado antes de existir. El ranking de no-química tiene cabeza de cartel. El grupo lo veía venir, asco.',
    'Cero por cien. La química entre ellos es un rumor falso del chat. Sin anestesia, cutre.',
    'Nula total. Juntarlos es insultar a la idea de match. Sin anestesia, pringado.',
    'Cero. El grupo lo sabía: el comando solo pone el sello. Sin anestesia, fracasado.',
    ...
    'Cero por cien. El azar se niega a firmar esta combinación. Sin anestesia, cabrón.',
    'Nula. Ni el cope más optimista vende este match. Sin anestesia, gilipollas.',
    'Cero. Estos dos juntos son ruido, no pareja. Sin anestesia, patético.',
    'Compatibilidad cero: el bot no suaviza el veredicto. Sin anestesia, ridículo.',
    'Cero. La distancia química es un agujero, no un puente. Sin anestesia, basura.',
    'Ship imposible documentado. Archivo cerrado. Sin anestesia, desperdicio.',
    'Cero por cien. Ni por aburrimiento del universo. Sin anestesia, asco.',
    'Nula. El match más forzado del historial del comando. Sin anestesia, cutre.',
    'Cero. Se miran y el aire entre ellos pide asilo en otro hilo. Sin anestesia, pringado.',
    'Compatibilidad bajo cero. El termómetro no miente. Sin anestesia, fracasado.',
    'Cero. El ship naufragó antes de botarse. Sin anestesia, joder.',
    'Nula total. Dos piezas de puzzles distintos en cajas distintas. Sin anestesia, mierda.',
    'Cero por cien. El grupo no necesita debate: necesita el número. Sin anestesia, coño.',
    'Ship cancelado. Cero. Siguiente pareja. Sin anestesia, cabrón.',
    'Cero. La química es un meme malo y ni siquiera da risa. Sin anestesia, gilipollas.',
    'Compatibilidad inexistente con sello del bot. Sin anestesia, patético.',
    'Cero. Juntarlos es un error de casting del destino. Sin anestesia, ridículo.',
    'Nula. No hay arco, no hay tensión útil, solo el no. Sin anestesia, basura.',
    'Cero por cien. El cálculo fue cortesía; el resultado era obvio. El grupo lo veía venir, desperdicio.',
    'Ship en el sótano del ranking de matches. Sin anestesia, asco.',
    'Cero. Estos dos no suman: restan al concepto de ship. Sin anestesia, cutre.',
    'Compatibilidad nula: el chat respira aliviado con el número. Sin anestesia, pringado.',
    'Cero. Ni el fanfic más desesperado los fuerza bien. Sin anestesia, fracasado.',
    'Nula. El no más limpio que ha escupido este comando. Sin anestesia, joder.',
    'Cero por cien. Química ausente, drama inútil, veredicto claro. Sin anestesia, mierda.',
    'Ship imposible. El bot no ofrece recursos de apelación. Sin anestesia, coño.',
    'Cero. La pareja que no existe ni en el modo broma. Sin anestesia, cabrón.',
    'Compatibilidad bajo tierra con lápida incluida. Sin anestesia, gilipollas.',
    'Cero. Dos nicks, cero motivo para la misma frase romántica. Sin anestesia, patético.',
    'Nula total. El universo pasó de esta combinación. Sin anestesia, ridículo.',
    'Cero por cien. No hay chispa: hay un extintor permanente. Sin anestesia, basura.',
    'Ship cancelado por falta de materia prima. Sin anestesia, desperdicio.',
    'Cero. El match más vacío del archivo. Sin anestesia, asco.',
    'Compatibilidad cero: sin anestesia y sin debate. Sin anestesia, cutre.',
    'Cero. Estos dos juntos son un typo del destino. Sin anestesia, pringado.',
    'Nula. El ranking de no-ships tiene nuevo referente. Sin anestesia, fracasado.',
    'Cero por cien. El bot casi se disculpa por tener que decirlo. Sin anestesia, joder.',
    'Ship en números que dan vergüenza ajena al concepto de pareja. Sin anestesia, mierda.',
    'Cero. Química nula, interés nulo, veredicto nulo de esperanza. Sin anestesia, coño.',
    'Compatibilidad inexistente: archivo y a otra cosa. Sin anestesia, cabrón.',
    'Cero. Ni por pena del grupo. Sin anestesia, gilipollas.',
    'Nula. El no más rotundo del día. Sin anestesia, patético.',
    'Cero por cien. Siguiente. Sin anestesia, ridículo.',
    'Ship imposible. Cero. Punto final. Sin anestesia, basura.'
  ],
};
