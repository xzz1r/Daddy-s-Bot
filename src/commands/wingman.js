...
const RIZZ = {
  ...
  mid: [
    ...
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, patético. Variante 93 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, ridículo. Variante 94 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, cabrón. Variante 95 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, basura. Variante 96 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, patético. Variante 97 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, ridículo. Variante 98 del tramo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, cabrón. Variante 99 del tramo.'
  ],
  low: [
    ...
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, patético. Tramo low 89.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, ridículo. Tramo low 90.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, cabrón. Tramo low 91.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, basura. Tramo low 92.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, patético. Tramo low 93.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, ridículo. Tramo low 94.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, cabrón. Tramo low 95.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, basura. Tramo low 96.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, patético. Tramo low 97.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, ridículo. Tramo low 98.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, cabrón. Tramo low 99.'
  ],
};
