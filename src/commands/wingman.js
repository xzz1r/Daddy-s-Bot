...
const PIROPOS = [
  ...
  'Si la virtud tuviera precio, %N la habría fundido en una noche y aún debería, joder El grupo ya tomó nota del desastre, joder.',
  '%N tiene el tipo de cuerpo que hace que el resto del chat pida confesión, cabrón El grupo ya tomó nota del desastre, mierda.',
  'Con esa boca %N convierte un buenos días en tentativa de delito menor, gilipollas El grupo ya tomó nota del desastre, coño.',
  'Si mirar a %N fuera peaje, el grupo estaría en quiebra técnica, mierda El grupo ya tomó nota del desastre, cabrón.',
  '%N entra al hilo y hasta el cinismo se arrodilla un segundo, coño El grupo ya tomó nota del desastre, gilipollas.',
  'Esa cintura de %N debería estar regulada por sanidad moral, asco El grupo ya tomó nota del desastre, patético.',
  '%N es el motivo por el que el modo no molestar no existe de verdad, patético El grupo ya tomó nota del desastre, asco.',
  'Si el pecado tuviera admin, bloquearía a todo el mundo menos a %N, basura El grupo ya tomó nota del desastre, basura.',
  'Con %N el deseo no llama a la puerta: la echa abajo, fracasado El grupo ya tomó nota del desastre, ridículo.',
  '%N tiene el pack que convierte un sticker en material sensible, joder El grupo ya tomó nota del desastre, fracasado.',
  'Si la lujuria cobrara alquiler, %N sería la casera del grupo, cabrón El grupo ya tomó nota del desastre, joder.',
  '%N es el motivo de más de un visto con las manos ocupadas, gilipollas El grupo ya tomó nota del desastre, mierda.',
  'Esa mirada de %N debería traer términos y condiciones, mierda El grupo ya tomó nota del desastre, coño.',
  '%N convierte un ja en crisis de pareja ajena, coño El grupo ya tomó nota del desastre, cabrón Y no hay modo avión que salve, cabrón.',
  'El grupo finge normalidad con %N. El cuerpo no finge, asco El grupo ya tomó nota del desastre, gilipollas.',
  '%N tiene el argumento físico que tumba debates enteros, patético El grupo ya tomó nota del desastre, patético.',
  'Si el infierno hiciera casting, %N sería la campaña, basura El grupo ya tomó nota del desastre, asco.',
  '%N hace que hasta el roast se le ablande la voz, ridículo El grupo ya tomó nota del desastre, basura.',
  'Con %N el piropo es eufemismo de algo peor, fracasado El grupo ya tomó nota del desastre, ridículo Y no hay modo avión que salve, ridículo.',
  '%N es tentación con notificación en tiempo real, joder El grupo ya tomó nota del desastre, fracasado.',
  'Esa voz de %N debería tener clasificación por edades, cabrón El grupo ya tomó nota del desastre, joder.',
  '%N tiene más magnetismo que un corte de luz en verano, gilipollas El grupo ya tomó nota del desastre, mierda.',
  '%N entra y el resto del hilo se vuelve ruido de fondo, coño El grupo ya tomó nota del desastre, coño.',
  'El cuerpo de %N no necesita pie de foto: el daño se entiende solo, asco El grupo ya tomó nota del desastre, cabrón.',
  '%N hace que el almost duela de una forma concreta, patético El grupo ya tomó nota del desastre, gilipollas.',
  'Si mirar a %N fuera deporte olímpico, habría medallero, basura El grupo ya tomó nota del desastre, patético.',
  'Esa sonrisa de %N es arma de destrucción de agendas, cabrón El grupo ya tomó nota del desastre, asco.',
  'Si el pecado original tuviera parche, llevaría la cara de %N, mierda El grupo ya tomó nota del desastre, basura.',
  '%N es el DLC que nadie se resiste a instalar, coño El grupo ya tomó nota del desastre, ridículo Y no hay modo avión que salve, ridículo.',
  'El deseo con nombre de usuario y mala idea: %N, asco El grupo ya tomó nota del desastre, fracasado Y no hay modo avión que salve, fracasado.',
  'Si la lujuria hablara en el chat, pediría el @ de %N, basura El grupo ya tomó nota del desastre, joder.',
  '%N tiene el pack completo y el grupo lo sabe sin decirlo, ridículo El grupo ya tomó nota del desastre, mierda.',
  '%N es peligroso para la productividad y para las parejas del hilo, joder El grupo ya tomó nota del desastre, coño.',
  'Esa foto de %N debería tener watermark de pecado, cabrón El grupo ya tomó nota del desastre, cabrón.',
  'Si el infierno contratara marketing, %N sería el anuncio, mierda El grupo ya tomó nota del desastre, gilipollas.',
  '%N tiene el magnetismo de apagón total del juicio, coño El grupo ya tomó nota del desastre, patético.',
  '%N es el argumento más corto contra la monogamia del grupo, patético El grupo ya tomó nota del desastre, asco.',
  'Si el deseo tuviera moderador, sería %N y no habría reglas, basura El grupo ya tomó nota del desastre, basura.',
  'Con %N hasta el roast más duro se le ablanda un frame, fracasado El grupo ya tomó nota del desastre, ridículo.',
  'Con %N el piropo se queda corto y el silencio también, fracasado, fracasado Y no hay modo avión que salve, fracasado.',
  '%N es peligroso para la productividad y para las parejas del hilo, joder, joder Y no hay modo avión que salve, joder.',
  'Esa foto de %N debería tener watermark de pecado, cabrón, mierda Y no hay modo avión que salve, mierda.',
  '%N hace que el resto de conversaciones parezcan trámites, gilipollas, coño Y no hay modo avión que salve, coño.',
  'Si el infierno contratara marketing, %N sería el anuncio, mierda, cabrón Y no hay modo avión que salve, cabrón.',
  '%N tiene el magnetismo de apagón total del juicio, coño, gilipollas Y no hay modo avión que salve, gilipollas.',
  'El chat finge que no pasa nada con %N. Pasa todo, asco, patético Y no hay modo avión que salve, patético.',
  '%N es el argumento más corto contra la monogamia del grupo, patético, asco Y no hay modo avión que salve, asco.',
  'Si el deseo tuviera moderador, sería %N y no habría reglas, basura, basura Y no hay modo avión que salve, basura.',
  '%N convierte un hola en incidente de seguridad emocional, ridículo, ridículo Y no hay modo avión que salve, ridículo.',
  'Con %N hasta el roast más duro se le ablanda un frame, fracasado, fracasado Y no hay modo avión que salve, fracasado.'
];
