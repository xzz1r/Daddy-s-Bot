...
const RIZZ = {
  ...
  mid: [
    ...
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, patético.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, ridículo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, cabrón.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, basura.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, patético.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, ridículo.',
    '%N en rizz medio: suficiente para no ser el chiste fijo, insuficiente para leyenda. Calibrado, cabrón.'
  ],
  low: [
    ...
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, patético.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, ridículo.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, cabrón.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, basura.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, patético.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, ridículo.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, cabrón.',
    '%N en rizz bajo: el comando no suaviza el golpe. Material flojo de ligue, basura.',
