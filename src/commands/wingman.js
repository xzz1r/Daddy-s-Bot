...
const PIROPOS = [
  ...
  '%N tiene el pack que el chat no merece pero disfruta, joder El grupo ya tomó nota, joder joder. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N tiene el cuerpo de argumento definitivo, patético El grupo ya tomó nota, asco, joder asco. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N es tentación con wifi, joder El grupo ya tomó nota, joder joder. Se te ve el desastre sin subtítulos, joder.',
  'Esa voz de %N debería estar regulada, cabrón El grupo ya tomó nota, mierda, joder mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene más magnetismo que un imán en zona prohibida, gilipollas El grupo ya tomó nota, coño, joder.',
  'Si el deseo fuera ranking, %N sería owner, mierda El grupo ya tomó nota, cabrón, joder cabrón. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N hace que el almost duela de otra manera, patético El grupo ya tomó nota, asco, joder asco. Se te ve el desastre sin subtítulos, joder.',
  'Si mirar a %N fuera deporte, habría olimpiadas, basura El grupo ya tomó nota, basura, joder basura. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N tiene el tipo de presencia que no pide: exige, joder El grupo ya tomó nota, joder joder. Se te ve el desastre sin subtítulos, joder.',
  ...
  'El deseo con nombre de usuario: %N, asco El grupo ya tomó nota, patético, joder patético. Se te ve el desastre sin subtítulos, joder.',
  '%N hace que hasta los haters miren dos veces, patético El grupo ya tomó nota, asco, joder asco. Se te ve el desastre sin subtítulos, joder.',
  'Si la lujuria hablara, pediría el número de %N, basura El grupo ya tomó nota, basura, joder basura. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el pack completo y el chat lo sabe, ridículo El grupo ya tomó nota, ridículo, joder ridículo.',
  'Con %N el piropo es casi un eufemismo, fracasado El grupo ya tomó nota, fracasado, joder fracasado. Se te ve el desastre sin subtítulos, joder.',
  '%N es peligroso para la productividad del grupo, joder El grupo ya tomó nota, joder joder. Se te ve el desastre sin subtítulos, joder.',
  ...
  'Si el infierno contratara, %N sería la campaña, mierda El grupo ya tomó nota, cabrón, joder cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el magnetismo de apagón total, coño El grupo ya tomó nota, gilipollas, joder gilipollas. Se te ve el desastre sin subtítulos, joder.',
  'El chat finge que no pasa nada con %N. Pasa, asco El grupo ya tomó nota, patético, joder patético. Se te ve el desastre sin subtítulos, joder.',
  '%N es el argumento contra la monogamia del hilo, patético El grupo ya tomó nota, asco, joder asco. Se te ve el desastre sin subtítulos, joder.',
  'Si el deseo tuviera admin, sería %N, basura El grupo ya tomó nota, basura, joder basura. Se te ve el desastre sin subtítulos, joder.',
  ...
  'Si la virtud tuviera precio, %N la habría fundido en una noche y aún debería, joder joder. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el tipo de cuerpo que hace que el resto del chat pida confesión, cabrón mierda. Se te ve el desastre sin subtítulos, joder.',
  'Con esa boca %N convierte un buenos días en tentativa de delito menor, gilipollas coño. Se te ve el desastre sin subtítulos, joder.',
  'Si mirar a %N fuera peaje, el grupo estaría en quiebra técnica, mierda cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N entra al hilo y hasta el cinismo se arrodilla un segundo, coño gilipollas. Se te ve el desastre sin subtítulos, joder.',
  'Esa cintura de %N debería estar regulada por sanidad moral, asco patético. Se te ve el desastre sin subtítulos, joder.',
  '%N es el motivo por el que el modo no molestar no existe de verdad, patético asco. Se te ve el desastre sin subtítulos, joder.',
  'Si el pecado tuviera admin, bloquearía a todo el mundo menos a %N, basura basura. Se te ve el desastre sin subtítulos, joder.',
  'Con %N el deseo no llama a la puerta: la echa abajo, fracasado ridículo. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el pack que convierte un sticker en material sensible, joder fracasado. Se te ve el desastre sin subtítulos, joder.',
  'Si la lujuria cobrara alquiler, %N sería la casera del grupo, cabrón joder. Se te ve el desastre sin subtítulos, joder.',
  '%N es el motivo de más de un visto con las manos ocupadas, gilipollas mierda. Se te ve el desastre sin subtítulos, joder.',
  'Esa mirada de %N debería traer términos y condiciones, mierda coño. Se te ve el desastre sin subtítulos, joder.',
  '%N convierte un ja en crisis de pareja ajena, coño cabrón Y cabrón. Se te ve el desastre sin subtítulos, joder.',
  'El grupo finge normalidad con %N. El cuerpo no finge, asco gilipollas. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el argumento físico que tumba debates enteros, patético patético. Se te ve el desastre sin subtítulos, joder.',
  'Si el infierno hiciera casting, %N sería la campaña, basura asco. Se te ve el desastre sin subtítulos, joder.',
  '%N hace que hasta el roast se le ablande la voz, ridículo basura. Se te ve el desastre sin subtítulos, joder.',
  'Con %N el piropo es eufemismo de algo peor, fracasado ridículo Y ridículo. Se te ve el desastre sin subtítulos, joder.',
  '%N es tentación con notificación en tiempo real, joder fracasado. Se te ve el desastre sin subtítulos, joder.',
  'Esa voz de %N debería tener clasificación por edades, cabrón joder. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene más magnetismo que un corte de luz en verano, gilipollas mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N entra y el resto del hilo se vuelve ruido de fondo, coño coño. Se te ve el desastre sin subtítulos, joder.',
  'El cuerpo de %N no necesita pie de foto: el daño se entiende solo, asco cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N hace que el almost duela de una forma concreta, patético gilipollas. Se te ve el desastre sin subtítulos, joder.',
  'Si mirar a %N fuera deporte olímpico, habría medallero, basura patético. Se te ve el desastre sin subtítulos, joder.',
  'Esa sonrisa de %N es arma de destrucción de agendas, cabrón asco. Se te ve el desastre sin subtítulos, joder.',
  'Si el pecado original tuviera parche, llevaría la cara de %N, mierda basura. Se te ve el desastre sin subtítulos, joder.',
  '%N es el DLC que nadie se resiste a instalar, coño ridículo Y ridículo. Se te ve el desastre sin subtítulos, joder.',
  'El deseo con nombre de usuario y mala idea: %N, asco fracasado Y fracasado. Se te ve el desastre sin subtítulos, joder.',
  'Si la lujuria hablara en el chat, pediría el @ de %N, basura joder. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el pack completo y el grupo lo sabe sin decirlo, ridículo mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N es peligroso para la productividad y para las parejas del hilo, joder coño. Se te ve el desastre sin subtítulos, joder.',
  'Esa foto de %N debería tener watermark de pecado, cabrón cabrón. Se te ve el desastre sin subtítulos, joder.',
  'Si el infierno contratara marketing, %N sería el anuncio, mierda gilipollas. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el magnetismo de apagón total del juicio, coño patético. Se te ve el desastre sin subtítulos, joder.',
  '%N es el argumento más corto contra la monogamia del grupo, patético asco. Se te ve el desastre sin subtítulos, joder.',
  'Si el deseo tuviera moderador, sería %N y no habría reglas, basura basura. Se te ve el desastre sin subtítulos, joder.',
  'Con %N hasta el roast más duro se le ablanda un frame, fracasado ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Con %N el piropo se queda corto y el silencio también, fracasado, fracasado Y fracasado. Se te ve el desastre sin subtítulos, joder Nota 139.',
  '%N es peligroso para la productividad y para las parejas del hilo, joder Y joder. Se te ve el desastre sin subtítulos, joder Nota 140.',
  'Esa foto de %N debería tener watermark de pecado, cabrón, mierda Y mierda. Se te ve el desastre sin subtítulos, joder Nota 141.',
  '%N hace que el resto de conversaciones parezcan trámites, gilipollas, coño Y coño. Se te ve el desastre sin subtítulos, joder.',
  'Si el infierno contratara marketing, %N sería el anuncio, mierda, cabrón Y cabrón. Se te ve el desastre sin subtítulos, joder Nota 143.',
  '%N tiene el magnetismo de apagón total del juicio, coño, gilipollas Y gilipollas. Se te ve el desastre sin subtítulos, joder Nota 144.',
  'El chat finge que no pasa nada con %N. Pasa todo, asco, patético Y patético. Se te ve el desastre sin subtítulos, joder.',
  '%N es el argumento más corto contra la monogamia del grupo, patético, asco Y asco. Se te ve el desastre sin subtítulos, joder Nota 146.',
  'Si el deseo tuviera moderador, sería %N y no habría reglas, basura, basura Y basura. Se te ve el desastre sin subtítulos, joder Nota 147.',
  '%N convierte un hola en incidente de seguridad emocional, ridículo, ridículo Y ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Con %N hasta el roast más duro se le ablanda un frame, fracasado, fracasado Y fracasado. Se te ve el desastre sin subtítulos, joder Nota 149.'
];
...
const WINGMAN_CIERRES = [
  ...
  'Y con eso el bot cierra el expediente de %N, joder Sin anestesia y sin bis, joder. Se te ve el desastre sin subtítulos, joder.',
  'Fin del informe. %N queda expuesto, cabrón Sin anestesia y sin bis, mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N. El chat ya tiene el veredicto. Siguiente, gilipollas Sin anestesia y sin bis, coño. Se te ve el desastre sin subtítulos, joder.',
  'Documentado. %N no puede alegar ignorancia, mierda Sin anestesia y sin bis, cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N. Cierre sin anestesia. El eco sigue, coño Sin anestesia y sin bis, gilipollas. Se te ve el desastre sin subtítulos, joder.',
  'Archivo cerrado sobre %N. Sin apelación, asco Sin anestesia y sin bis, patético. Se te ve el desastre sin subtítulos, joder.',
  '%N. El wingman terminó. El cringe permanece, patético Sin anestesia y sin bis, asco. Se te ve el desastre sin subtítulos, joder.',
  'Fin. %N ya no puede fingir que no pasó, basura Sin anestesia y sin bis, basura. Se te ve el desastre sin subtítulos, joder.',
  '%N. Expediente sellado. El grupo es testigo, ridículo Sin anestesia y sin bis, ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Cierre de transmisión. %N queda en el acta, fracasado Sin anestesia y sin bis, fracasado. Se te ve el desastre sin subtítulos, joder.',
  'Y así queda el parte de %N, joder Sin anestesia y sin bis, joder. Se te ve el desastre sin subtítulos, joder.',
  '%N. Sin más. El ranking hizo su trabajo, cabrón Sin anestesia y sin bis, mierda. Se te ve el desastre sin subtítulos, joder.',
  'Informe listo. %N puede leerlo y callar, gilipollas Sin anestesia y sin bis, coño. Se te ve el desastre sin subtítulos, joder.',
  'Fin del show de %N por hoy, mierda Sin anestesia y sin bis, cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N. Cerrado. El chat no pide bis, coño Sin anestesia y sin bis, gilipollas. Se te ve el desastre sin subtítulos, joder.',
  'El bot firma. %N asume, asco Sin anestesia y sin bis, patético. Se te ve el desastre sin subtítulos, joder.',
  '%N. Acta levantada. Sin firmas ajenas necesarias, patético Sin anestesia y sin bis, asco. Se te ve el desastre sin subtítulos, joder.',
  'Terminado. El eco de %N todavía suena, basura Sin anestesia y sin bis, basura. Se te ve el desastre sin subtítulos, joder.',
  '%N. Cierre limpio. Daño permanente, ridículo Sin anestesia y sin bis, ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Expediente de %N: completo, fracasado Sin anestesia y sin bis, fracasado. Se te ve el desastre sin subtítulos, joder.',
  ...
  'Cierre del acta de %N. El bot cumplió, asco Sin anestesia y sin bis, patético. Se te ve el desastre sin subtítulos, joder.',
  'Parte final. %N puede guardar silencio productivo, patético Sin anestesia y sin bis, asco. Se te ve el desastre sin subtítulos, joder Nota 96.',
  'Expediente %N: cerrado sin apelación barata, basura Sin anestesia y sin bis, basura. Se te ve el desastre sin subtítulos, joder Nota 97.',
  'Y se acabó lo de %N por esta ronda, ridículo Sin anestesia y sin bis, ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Cierre. El wingman no devuelve dignidad a %N, fracasado Sin anestesia y sin bis, fracasado. Se te ve el desastre sin subtítulos, joder Nota 99.'
];
