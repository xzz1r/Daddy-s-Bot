...
const ROB_MAESTRO = [
  '%A le vació el aura a %V con la precisión de un puto cirujano. El ranking lo deja claro, joder.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking. El ranking lo deja claro, mierda.',
  '%A vs %V: clínica. El botín viajó entero y el chat lo vio. El ranking lo deja claro, coño.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V. El ranking lo deja claro, cabrón.',
  '%A ejecutó el atraco perfecto. %V firmó el empty account. El ranking lo deja claro, gilipollas.',
  'Robo de manual negro: %A cobra, %V llora, el ranking firma. El ranking lo deja claro, patético.',
  '%A entró como sombra y salió con el aura completa de %V. El ranking lo deja claro, asco.',
  'Maestro documentado. Autor %A, víctima total %V. El ranking lo deja claro, basura.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo. El ranking lo deja claro, ridículo.',
  '%A se llevó todo. %V se quedó con el hueco y este mensaje. El ranking lo deja claro, fracasado.',
  '%A vació a %V en público sin dejar almost ni consuelo. El ranking lo deja claro, joder.',
  'Maestro de puta madre: el contador de %V a cero en un golpe. El ranking lo deja claro, mierda.',
  '%A cobró el aura de %V como quien cobra una deuda vieja. El ranking lo deja claro, coño.',
  'Robo maestro. %V ni activó defensa porque no hubo tiempo. El ranking lo deja claro, cabrón.',
  '%A vs %V: el ladrón ganó el único round que importaba. El ranking lo deja claro, gilipollas.',
  '%A dejó a %V mirando el contador en cero sin anestesia. El ranking lo deja claro, patético.',
  'Maestro limpio en el ranking y sucio para el ego de %V. El ranking lo deja claro, asco.',
  '%A ejecutó, cobró y cerró el parte a favor sin temblar. El ranking lo deja claro, basura.',
  'Robo total. %A con todo, %V con nada, el chat de testigo. El ranking lo deja claro, ridículo.',
  '%A vació el aura de %V y el ranking no ofreció recurso. El ranking lo deja claro, fracasado.',
  '%A le limpió el contador a %V en un solo movimiento limpio. El ranking lo deja claro, joder.',
  'Maestro: empty total. %V mira el cero y el grupo mira a %A. El ranking lo deja claro, mierda.',
  '%A vs %V clínica total. El botín no dejó residuo en %V. El ranking lo deja claro, coño.',
  '%A cobró el 100 % del aura de %V sin pedir la palabra. El ranking lo deja claro, cabrón.',
  'Robo maestro limpio. El ranking actualiza a favor de %A. El ranking lo deja claro, gilipollas.',
  '%A entró, vació y salió. %V se enteró por el contador. El ranking lo deja claro, patético.',
  'Maestro documentado sin filtro delante del puto grupo. El ranking lo deja claro, asco.',
  '%A no dejó almost: dejó el empty account de %V. El ranking lo deja claro, basura.',
  '%A vs %V: 1-0 con botín completo y cero debate útil. El ranking lo deja claro, ridículo.',
  '%A se llevó el aura de %V entera. El hueco es el mensaje. El ranking lo deja claro, fracasado.',
  '%A vació a %V con la calma de quien ya había contado el botín. El ranking lo deja claro, joder.',
  'Maestro de manual: cero en %V, todo en %A, firma el ranking. El ranking lo deja claro, mierda.',
  '%A vs %V terminó con transfer total y cara de fail en %V. El ranking lo deja claro, coño.',
  '%A cobró todo lo que %V tenía contado de aura. El ranking lo deja claro, cabrón.',
  'Robo total limpio. %A ejecuta, %V firma el vacío. El ranking lo deja claro, gilipollas.',
  '%A entró como profesional y salió con el aura completa de %V. El ranking lo deja claro, patético.',
  'Maestro en el ranking. El chat no pide replay porque se vio. El ranking lo deja claro, asco.',
  '%A no improvisó: vació a %V según plan y el plan salió. El ranking lo deja claro, basura.',
  '%A vs %V: crónica de un empty account firmado en público. El ranking lo deja claro, ridículo.',
  '%A se llevó el 100 %. %V se quedó con este mensaje de recibo. El ranking lo deja claro, fracasado.',
  '%A le dejó el contador a cero a %V delante de todos. El ranking lo deja claro, joder.',
  'Maestro limpio. Ni polvo de aura quedó en la cuenta de %V. El ranking lo deja claro, mierda.',
  '%A vs %V clínica. Botín entero, defensa inexistente. El ranking lo deja claro, coño.',
  '%A cobró el aura de %V sin dejar almost de consuelo. El ranking lo deja claro, cabrón.',
  'Robo maestro. El ranking de %V a cero en un golpe. El ranking lo deja claro, gilipollas.',
  '%A entró, tomó todo y cerró. %V abrió el hueco. El ranking lo deja claro, patético.',
  'Maestro documentado. Autor %A, empty %V, archivo el grupo. El ranking lo deja claro, asco.',
  '%A vació a %V como quien limpia una deuda pendiente. El ranking lo deja claro, basura.',
  '%A vs %V: el ladrón no falló ni un frame del atraco. El ranking lo deja claro, ridículo.',
  '%A se llevó todo el aura de %V y el ranking lo selló. El ranking lo deja claro, fracasado.',
  '%A ejecutó el empty total de %V sin sudar el golpe. El ranking lo deja claro, joder.',
  'Maestro de puta madre en el sentido del botín completo. El ranking lo deja claro, mierda.',
  '%A vs %V terminó con cero en %V y sonrisa en %A. El ranking lo deja claro, coño.',
  '%A cobró el aura entera. %V pagó el curso completo. El ranking lo deja claro, cabrón.',
  'Robo total. %A con el botín, %V con el vacío. El ranking lo deja claro, gilipollas.',
  '%A entró en silencio y salió con el contador de %V a cero. El ranking lo deja claro, patético.',
  'Maestro en público. El grupo vio el transfer total. El ranking lo deja claro, asco.',
  '%A no dejó residuo: empty account de %V firmado. El ranking lo deja claro, basura.',
  '%A vs %V: 1-0 sin VAR ni prórroga ni consuelo. El ranking lo deja claro, ridículo.',
  '%A se llevó el aura de %V al completo. Recibo: este mensaje. El ranking lo deja claro, fracasado.',
  '%A vació el ranking de %V en un movimiento de cirujano. El ranking lo deja claro, joder.',
  'Maestro limpio. El botín viajó entero hacia %A. El ranking lo deja claro, mierda.',
  '%A vs %V clínica total sin almost de defensa posible. El ranking lo deja claro, coño.',
  '%A cobró el 100 % y el ranking no ofreció recurso a %V. El ranking lo deja claro, cabrón.',
  'Robo maestro. %V mira el cero y no hay segunda lectura. El ranking lo deja claro, gilipollas.',
  '%A entró, vació y el parte se cerró solo a su favor. El ranking lo deja claro, patético.',
  'Maestro documentado sin anestesia para %V. El ranking lo deja claro, asco.',
  '%A no falló el empty: lo firmó en el contador de %V. El ranking lo deja claro, basura.',
  '%A vs %V: crónica de un atraco total con público. El ranking lo deja claro, ridículo.',
  '%A se llevó todo. %V se quedó sin aura y sin discurso. El ranking lo deja claro, fracasado.',
  '%A le limpió el aura a %V como quien cobra al contado. El ranking lo deja claro, joder.',
  'Maestro de manual negro: cero %V, todo %A, firma ranking. El ranking lo deja claro, mierda.',
  '%A vs %V terminó con transfer total visible en el chat. El ranking lo deja claro, coño.',
  '%A cobró el aura completa de %V sin pedir turno de palabra. El ranking lo deja claro, cabrón.',
  'Robo total limpio. El ranking actualiza y %V calla. El ranking lo deja claro, gilipollas.',
  '%A entró de profesional y salió con el empty de %V. El ranking lo deja claro, patético.',
  'Maestro en el ranking. El chat archiva el golpe total. El ranking lo deja claro, asco.',
  '%A vació a %V según plan. El plan no falló un frame. El ranking lo deja claro, basura.',
  '%A vs %V: el empty account firmado sin debate útil. El ranking lo deja claro, ridículo.',
  '%A se llevó el 100 % del aura. %V el 100 % del fail. El ranking lo deja claro, fracasado.',
  '%A ejecutó el empty de %V delante del puto grupo. El ranking lo deja claro, joder.',
  'Maestro limpio en números y sucio para el ego de %V. El ranking lo deja claro, mierda.',
  '%A vs %V clínica. Botín entero, defensa en cero. El ranking lo deja claro, coño.',
  '%A cobró todo lo contado en el aura de %V. El ranking lo deja claro, cabrón.',
  'Robo maestro. El contador de %V a cero sin prórroga. El ranking lo deja claro, gilipollas.',
  '%A entró, tomó el total y cerró el parte, patético para %V. El ranking lo deja claro, patético.',
  'Maestro documentado. Empty %V, botín %A, testigo el chat. El ranking lo deja claro, asco.',
  '%A vació a %V sin dejar almost de consuelo en el ranking. El ranking lo deja claro, basura.',
  '%A vs %V: 1-0 total. El ladrón no dudó ni un segundo. El ranking lo deja claro, ridículo.',
  '%A se llevó el aura entera de %V y el ranking lo selló. El ranking lo deja claro, fracasado.',
  '%A le dejó a %V el contador en cero y este mensaje de recibo. El ranking lo deja claro, joder.',
  'Maestro de puta madre: empty total firmado en público. El ranking lo deja claro, mierda.',
  '%A vs %V terminó con cero en %V y el botín en %A. El ranking lo deja claro, coño.',
  '%A cobró el aura de %V al completo sin temblar. El ranking lo deja claro, cabrón.',
  'Robo total. %A ejecuta, %V firma el vacío, el chat mira. El ranking lo deja claro, gilipollas.',
  '%A entró en silencio y salió con todo el aura de %V. El ranking lo deja claro, patético.',
  'Maestro en público sin filtro ni narrador emocional. El ranking lo deja claro, asco.',
  '%A no dejó residuo de aura en la cuenta de %V. El ranking lo deja claro, basura.',
  '%A vs %V: empty account. Archivo cerrado. El ranking lo deja claro, ridículo.',
  '%A se llevó el 100 %. Recibo colgado en este hilo. El ranking lo deja claro, fracasado.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió. El ranking lo deja claro, joder.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas. El ranking lo deja claro, mierda.',
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual. El ranking lo deja claro, coño.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias. El ranking lo deja claro, cabrón.',
  '%A no se llevó todo, pero se llevó lo suficiente para que se note. El ranking lo deja claro, gilipollas.',
  'Robo a medias: %A sonríe y %V cuenta lo que falta en el contador. El ranking lo deja claro, patético.',
  '%A entró, picó y salió con botín incompleto pero real para %V. El ranking lo deja claro, asco.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo. El ranking lo deja claro, basura.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa. El ranking lo deja claro, ridículo.',
  '%A se llevó una parte. %V se llevó el almost de haber defendido. El ranking lo deja claro, fracasado.',
  '%A mordió el aura de %V sin vaciarla. El dolor es el mismo en el ranking. El ranking lo deja claro, joder.',
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias. El ranking lo deja claro, mierda.',
  '%A no fue maestro ni fail: fue el medio que duele igual. El ranking lo deja claro, coño.',
  'Robo parcial. El ranking de %V baja y el de %A sube a medias. El ranking lo deja claro, cabrón.',
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail. El ranking lo deja claro, gilipollas.',
  '%A se llevó lo justo para que %V lo note el resto del día. El ranking lo deja claro, patético.',
  'Parcial limpio en el contador y sucio en la cara de %V. El ranking lo deja claro, asco.',
  '%A picó, cobró y salió. %V se quedó con el almost de defensa. El ranking lo deja claro, basura.',
  'Robo a medias documentado delante del grupo sin filtro. El ranking lo deja claro, ridículo.',
  '%A no vació a %V: lo dejó cojeando de aura en el ranking. El ranking lo deja claro, fracasado.',
  '%A le quitó un trozo del aura a %V y el ranking lo registró igual. El ranking lo deja claro, joder.',
  'Parcial: no es el golpe perfecto, pero %V sangra aura de verdad. El ranking lo deja claro, mierda.',
  '%A vs %V a medias. El botín no es total y la vergüenza sí. El ranking lo deja claro, coño.',
  '%A cobró tajada incompleta. %V pagó completa en cara. El ranking lo deja claro, cabrón.',
  'Robo parcial limpio. %A con algo, %V con menos y con el gag. El ranking lo deja claro, gilipollas.',
  '%A no se fue de vacío. %V tampoco se fue intacto. El ranking lo deja claro, patético.',
  'Parcial en el contador. El chat vio el transfer a medias. El ranking lo deja claro, asco.',
  '%A vs %V: el medio duele como el todo cuando se firma en público. El ranking lo deja claro, basura.',
  '%A se llevó una porción. El ranking de %V lo nota igual. El ranking lo deja claro, ridículo.',
  'Robo a medias. Autor %A, hueco en %V, archivo el grupo. El ranking lo deja claro, fracasado.',
  '%A picó el aura de %V sin rematar. Suficiente para el ranking. El ranking lo deja claro, joder.',
  'Parcial de puta madre: no vacío, pero el dolor es real para %V. El ranking lo deja claro, mierda.',
  '%A vs %V terminó en transfer incompleto y cara completa de fail. El ranking lo deja claro, coño.',
  '%A cobró lo que pudo. %V perdió lo que no quería. El ranking lo deja claro, cabrón.',
  'Robo parcial. El almost de %V es haber perdido solo una parte. El ranking lo deja claro, gilipollas.',
  '%A entró a medias y salió con botín real. %V con el hueco. El ranking lo deja claro, patético.',
  'Parcial documentado sin anestesia en el ranking del grupo. El ranking lo deja claro, asco.',
  '%A no fue cirujano: fue carnicero a medias y %V sangra igual. El ranking lo deja claro, basura.',
  '%A vs %V: tajada incompleta, vergüenza completa. El ranking lo deja claro, ridículo.',
  '%A se llevó lo suficiente. El ranking de %V firma el parcial. El ranking lo deja claro, fracasado.',
  '%A le arrancó un trozo del aura a %V delante de todos. El ranking lo deja claro, joder.',
  'Parcial limpio en números y sucio en el ego de %V. El ranking lo deja claro, mierda.',
  '%A vs %V a medio gas. El botín existe y el fail de %V también. El ranking lo deja claro, coño.',
  '%A cobró incompleto. El dolor de %V es completo. El ranking lo deja claro, cabrón.',
  'Robo parcial. %A con tajada, %V con lección, el chat con gag. El ranking lo deja claro, gilipollas.',
  '%A no vació el tanque: lo dejó en reserva baja de aura. El ranking lo deja claro, patético.',
  'Parcial en el ranking. %V lo nota cada vez que mira el contador. El ranking lo deja claro, asco.',
  '%A vs %V: crónica de un medio atraco con efecto total en la cara. El ranking lo deja claro, basura.',
  '%A se llevó una parte y dejó el almost de defensa en %V. El ranking lo deja claro, ridículo.',
  'Robo a medias firmado. Autor %A, archivo el puto grupo. El ranking lo deja claro, fracasado.',
  '%A picó sin rematar. El ranking de %V bajó igual. El ranking lo deja claro, joder.',
  'Parcial de manual negro: tajada real, vacío no, dolor sí. El ranking lo deja claro, mierda.',
  '%A vs %V terminó a medias en botín y completo en vergüenza. El ranking lo deja claro, coño.',
  '%A cobró lo justo. %V pagó de más en cara del ranking. El ranking lo deja claro, cabrón.',
  'Robo parcial limpio. El contador habla y %V calla. El ranking lo deja claro, gilipollas.',
  '%A entró, tomó y salió. %V se quedó con menos y con el gag. El ranking lo deja claro, patético.',
  'Parcial documentado. El grupo no necesita narrador. El ranking lo deja claro, asco.',
  '%A no fue maestro: fue eficaz a medias y suficiente. El ranking lo deja claro, basura.',
  '%A vs %V: el medio atraco que duele como el grande. El ranking lo deja claro, ridículo.',
  '%A se llevó una porción del aura de %V sin pedir permiso. El ranking lo deja claro, fracasado.',
  '%A le sacó aura a %V sin vaciar la cuenta. El ranking igual. El ranking lo deja claro, joder.',
  'Parcial: %A gana algo, %V pierde algo, el chat gana el gag. El ranking lo deja claro, mierda.',
  '%A vs %V a medias. Transfer incompleto, veredicto completo. El ranking lo deja claro, coño.',
  '%A cobró tajada. %V firmó el hueco a medias en el ranking. El ranking lo deja claro, cabrón.',
  'Robo parcial. No es el empty total y aun así duele. El ranking lo deja claro, gilipollas.',
  '%A no se fue de vacío. El almost de %V es haber perdido poco. El ranking lo deja claro, patético.',
  'Parcial en público. El ranking actualiza y %V se entera. El ranking lo deja claro, asco.',
  '%A vs %V: crónica del medio golpe con efecto de hostia. El ranking lo deja claro, basura.',
  '%A se llevó lo bastante para que el contador de %V se note. El ranking lo deja claro, ridículo.',
  'Robo a medias. Firmado por el bot delante del grupo. El ranking lo deja claro, fracasado.',
  '%A picó el aura de %V y el ranking registró el parcial. El ranking lo deja claro, joder.',
  'Parcial de puta madre en el sentido del dolor a medias. El ranking lo deja claro, mierda.',
  '%A vs %V terminó con botín incompleto y cara de fail completa. El ranking lo deja claro, coño.',
  '%A cobró. %V perdió. El medio también cuenta en el ranking. El ranking lo deja claro, cabrón.',
  'Robo parcial limpio. %A con tajada, %V con el gag. El ranking lo deja claro, gilipollas.',
  '%A entró a medias y el efecto fue total en el ego de %V. El ranking lo deja claro, patético.',
  'Parcial documentado sin filtro ni consuelo para %V. El ranking lo deja claro, asco.',
  '%A no vació: dejó a %V cojeando de aura en el contador. El ranking lo deja claro, basura.',
  '%A vs %V: el atraco incompleto que el ranking sí completa. El ranking lo deja claro, ridículo.',
  '%A se llevó una parte del aura de %V y el chat lo archivó. El ranking lo deja claro, fracasado.',
  '%A le quitó aura a %V sin el empty total. Suficiente. El ranking lo deja claro, joder.',
  'Parcial limpio en el número y sucio para %V. El ranking lo deja claro, mierda.',
  '%A vs %V a medio gas con efecto de hostia en el ranking. El ranking lo deja claro, coño.',
  '%A cobró incompleto y %V pagó completo en vergüenza. El ranking lo deja claro, cabrón.',
  'Robo parcial. El contador de %V baja y el gag sube. El ranking lo deja claro, gilipollas.',
  '%A no fue cirujano ni fail: fue el medio que duele. El ranking lo deja claro, patético.',
  'Parcial en el ranking. %V lo mira y se le cae la cara. El ranking lo deja claro, asco.',
  '%A vs %V: tajada real, vacío no, dolor sí documentado. El ranking lo deja claro, basura.',
  '%A se llevó lo justo. El almost de defensa de %V quedó en almost. El ranking lo deja claro, ridículo.',
  'Robo a medias firmado sin anestesia en el puto grupo. El ranking lo deja claro, fracasado.',
  '%A picó sin rematar y el ranking de %V sangró igual. El ranking lo deja claro, joder.',
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana. El ranking lo deja claro, mierda.',
  '%A vs %V terminó a medias en botín y entero en fail de %V. El ranking lo deja claro, coño.',
  '%A cobró lo que pudo sacar. %V notó cada unidad. El ranking lo deja claro, cabrón.',
  'Robo parcial limpio. El bot firma y %V calla. El ranking lo deja claro, gilipollas.',
  '%A entró, tomó tajada y salió. %V con el hueco a medias. El ranking lo deja claro, patético.',
  'Parcial documentado delante de todos sin narrador. El ranking lo deja claro, asco.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja. El ranking lo deja claro, basura.',
  '%A vs %V: el medio atraco con firma completa en el ranking. El ranking lo deja claro, ridículo.',
  '%A se llevó una porción y dejó a %V con la lección a medias. El ranking lo deja claro, fracasado.'
];
