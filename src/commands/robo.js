...
const ROB_WIN = [
  ...
  '%A le vació los bolsillos a %V y se fue silbando. Ni te enteraste, pringado.',
  'Saqueo total: %A se llevó casi el doble de %V. Te han dejado el esqueleto, inútil.',
  ...
  '%A arrasó a %V y la banca aplaude. Nadie va a defenderte, don nadie.',
  ...
  '%A robó a %V y ni siquiera cambió de expresión. Robarte no emociona a nadie.',
  ...
  'Botín doble para %A y ni una moneda para %V. Esa balanza describe tu existencia entera.',
  ...
  '%A dejó a %V a medio pelar. Ni para robarte sale bien redondo, muerto de hambre.',
  '%A se llevó lo de %V sin despeinarse. Los inútiles no ofrecen resistencia, ofrecen facilidades.',
  '%V financió el doble botín de %A y encima quiere revancha. La revancha también la vas a perder.',
  ...
  '%A dobló su dinero gracias a %V. Ser tu víctima es la inversión más rentable del grupo.',
  ...
  '%A limpió la caja de %V. Si algo se te da bien es dejar las cosas al alcance de cualquiera.',
  ...
  '%A robó a %V y ni cambió de expresión. Robarte no emociona a nadie, muerto de hambre.',
  ...
  '%A dobló su aura gracias a %V. Ser tu víctima es la inversión más rentable del grupo.',
  ...
  '%V dejó pasar a %A sin resistencia. Igual que dejas pasar todo lo demás en tu vida.',
  ...
  '%V acaba de aportar a la cuenta de %A. Tu única contribución útil en meses, muerto de hambre.',
  ...
  '%V financió a %A sin querer y sin poder evitarlo. Esa es tu función exacta en este grupo.',
  ...
  '%V perdió lo suyo ante %A y ya está buscando a quién echarle la culpa. Empieza por ti.',
...
const ROB_FAIL = [
  ...
  '%A falló el robo y %V se lo tomó como un cumplido. Ni ofenderte sabes, muerto de hambre.',
...
const ROB_MAESTRO = [
  ...
  '%A cogió media parte de %V y la otra mitad la dejó de propina. Ni tu ruina interesa entera.',
  ...
  '%V financió el doble botín de %A y encima quiere revancha. La revancha también la vas a perder.',
  'Golpe maestro de %A. %V queda reducido a lo que siempre fue: nada con nombre de usuario.',
  '%A dobló su aura gracias a %V. Ser tu víctima es el mejor negocio de este grupo.',
  ...
  '%A dobló lo apostado a costa de %V. Ser tu víctima empieza a ser una estrategia rentable.',
  ...
  '%A dobló lo apostado gracias a %V. Ser tu víctima empieza a ser rentable, muerto de hambre.',
...
const ROB_PARCIAL = [
  ...
  'El atraco quedó a medias, %A se lleva algo y %V se lleva miradas de lástima. Peor negocio el tuyo.',
  '%A limpió a %V con un solo movimiento. Contra un cero a la izquierda no hace falta plan.',
  '%V acaba de aportar el doble a la cuenta de %A. Tu única contribución útil en meses.',
  ...
  '%V financió a %A sin querer y sin poder evitarlo. Esa es tu función en este grupo.',
  ...
  '%A vació la apuesta de %V mientras %V se creía listo. Ese es el chiste completo.',
  '%V pierde lo apostado ante %A y el chat sigue como si nada. Porque eres nada.',
  ...
  '%A se llevó un trozo de %V y se fue aburrido. Ni robarte entretiene, muerto de hambre.',
  ...
  '%A cogió un pedazo de %V y lo dejó a medias por aburrimiento. Ni robarte entretiene.',
  ...
  '%A cogió un pedazo de %V y lo dejó a medias por aburrimiento. Ni robarte entretiene, cabrón.',
  ...
  'Golpe a medias de %A y aun así %V sale perdiendo. Ese es tu punto de partida, pringado.',
];
...
const ROB_DESASTRE = [
  ...
  '%A perdió su aura y %V ni tuvo que defenderse. Así de irrelevante eres.',
  ...
  '%A quiso ser ladrón y terminó de mecenas de %V. Elige mejor tus ambiciones, pringado.',
  ...
  '%A firmó su propia ruina y %V puso el sello. Puta mierda de día para ti.',
  ...
  'El aura de %A ahora es de %V. La incompetencia sigue siendo tuya, esa no se transfiere.',
  '%A jugó, %V cobró. Así de simple es tu vida, fracasado.',
  ...
  '%A perdió el aura y %V ni tuvo que mirar. Esa es tu relevancia exacta.',
  ...
  '%A perdió su aura y %V ni tuvo que defenderse. Así de irrelevante eres, cabrón.',
  ...
  '%A firmó su propia ruina y %V puso el sello. Puta mierda de día para ti, cabrón.',
  ...
  '%A salió a cazar y volvió siendo la cena de %V. Ni el papel de presa te sale digno.',
  ...
  '%A jugó, %V cobró. Así de simple es tu vida entera, fracasado de manual.',
  ...
  '%A perdió el aura y %V ni tuvo que mirar. Esa es tu relevancia exacta en este grupo.',
  ...
  '%A ha logrado que perder tenga premio. Para %V, claro. Para ti solo tiene factura.',
  ...
  '%A apostó su aura contra %V y la perdió toda. Ni de farol te sale bien, cabrón.',
  '%A fue a por lo ajeno y dejó lo propio. %V lo recogió como quien recoge la calderilla.',
  '%A perdió por ambición y %V ganó por quietud. La lección está clara y no la vas a aprender.',
  ...
  '%A apostó su aura contra %V y la perdió toda. Ni de farol te sale bien nada, muerto de hambre.',
  ...
  '%A apostó su aura contra %V y la perdió entera. Ni de farol te sale bien nada, muerto de hambre.',
  '%A perdió por ambición y %V ganó por quietud. La lección está clara y no la vas a aprender nunca.',
