...
const ROB_MAESTRO = [
  '%A le vació el aura a %V con la precisión de un puto cirujano, joder delante del puto ranking, joder.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking, mierda delante del puto ranking, joder.',
  '%A vs %V: clínica. El botín viajó entero y el chat lo vio, cabrón delante del puto ranking, joder.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V, coño delante del puto ranking, joder.',
  '%A ejecutó el atraco perfecto. %V firmó el empty account, gilipollas delante del puto ranking, joder.',
  'Robo de manual negro: %A cobra, %V llora, el ranking firma, patético delante del puto ranking, joder.',
  '%A entró como sombra y salió con el aura completa de %V, asco delante del puto ranking, joder.',
  'Maestro documentado. Autor %A, víctima total %V, basura delante del puto ranking, joder.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo, ridículo delante del puto ranking, joder.',
  '%A se llevó todo. %V se quedó con el hueco y este mensaje, fracasado delante del puto ranking, joder.',
  '%A vació a %V en público sin dejar almost ni consuelo, joder delante del puto ranking, joder.',
  'Maestro de puta madre: el contador de %V a cero en un golpe, mierda delante del puto ranking, joder.',
  '%A cobró el aura de %V como quien cobra una deuda vieja, cabrón delante del puto ranking, joder.',
  'Robo maestro. %V ni activó defensa porque no hubo tiempo, coño delante del puto ranking, joder.',
  '%A vs %V: el ladrón ganó el único round que importaba, gilipollas delante del puto ranking, joder.',
  '%A dejó a %V mirando el contador en cero sin anestesia, patético delante del puto ranking, joder.',
  'Maestro limpio en el ranking y sucio para el ego de %V, asco delante del puto ranking, joder.',
  '%A ejecutó, cobró y cerró el parte a favor sin temblar, basura delante del puto ranking, joder.',
  'Robo total. %A con todo, %V con nada, el chat de testigo, ridículo delante del puto ranking, joder.',
  '%A vació el aura de %V y el ranking no ofreció recurso, fracasado delante del puto ranking, joder.',
  '%A le limpió el contador a %V en un solo movimiento limpio, joder delante del puto ranking, joder.',
  'Maestro: empty total. %V mira el cero y el grupo mira a %A, mierda delante del puto ranking, joder.',
  '%A vs %V clínica total. El botín no dejó residuo en %V, cabrón delante del puto ranking, joder.',
  '%A cobró el 100 % del aura de %V sin pedir la palabra, coño delante del puto ranking, joder.',
  'Robo maestro limpio. El ranking actualiza a favor de %A, gilipollas delante del puto ranking, joder.',
  '%A entró, vació y salió. %V se enteró por el contador, patético delante del puto ranking, joder.',
  'Maestro documentado sin filtro delante del puto grupo, asco delante del puto ranking, joder.',
  '%A no dejó almost: dejó el empty account de %V, basura delante del puto ranking, joder.',
  '%A vs %V: 1-0 con botín completo y cero debate útil, ridículo delante del puto ranking, joder.',
  '%A se llevó el aura de %V entera. El hueco es el mensaje, fracasado delante del puto ranking, joder.',
  '%A vació a %V con la calma de quien ya había contado el botín, joder delante del puto ranking, joder.',
  'Maestro de manual: cero en %V, todo en %A, firma el ranking, mierda delante del puto ranking, joder.',
  '%A vs %V terminó con transfer total y cara de fail en %V, cabrón delante del puto ranking, joder.',
  '%A cobró todo lo que %V tenía contado de aura, coño delante del puto ranking, joder.',
  'Robo total limpio. %A ejecuta, %V firma el vacío, gilipollas delante del puto ranking, joder.',
  '%A entró como profesional y salió con el aura completa de %V, patético delante del puto ranking, joder.',
  'Maestro en el ranking. El chat no pide replay porque se vio, asco delante del puto ranking, joder.',
  '%A no improvisó: vació a %V según plan y el plan salió, basura delante del puto ranking, joder.',
  '%A vs %V: crónica de un empty account firmado en público, ridículo delante del puto ranking, joder.',
  '%A se llevó el 100 %. %V se quedó con este mensaje de recibo, fracasado delante del puto ranking, joder.',
  '%A le dejó el contador a cero a %V delante de todos, joder delante del puto ranking, joder.',
  'Maestro limpio. Ni polvo de aura quedó en la cuenta de %V, mierda delante del puto ranking, joder.',
  '%A vs %V clínica. Botín entero, defensa inexistente, cabrón delante del puto ranking, joder.',
  '%A cobró el aura de %V sin dejar almost de consuelo, coño delante del puto ranking, joder.',
  'Robo maestro. El ranking de %V a cero en un golpe, gilipollas delante del puto ranking, joder.',
  '%A entró, tomó todo y cerró. %V abrió el hueco, patético delante del puto ranking, joder.',
  'Maestro documentado. Autor %A, empty %V, archivo el grupo, asco delante del puto ranking, joder.',
  '%A vació a %V como quien limpia una deuda pendiente, basura delante del puto ranking, joder.',
  '%A vs %V: el ladrón no falló ni un frame del atraco, ridículo delante del puto ranking, joder.',
  '%A se llevó todo el aura de %V y el ranking lo selló, fracasado delante del puto ranking, joder.',
  '%A ejecutó el empty total de %V sin sudar el golpe, joder delante del puto ranking, joder.',
  'Maestro de puta madre en el sentido del botín completo, mierda delante del puto ranking, joder.',
  '%A vs %V terminó con cero en %V y sonrisa en %A, cabrón delante del puto ranking, joder.',
  '%A cobró el aura entera. %V pagó el curso completo, coño delante del puto ranking, joder.',
  'Robo total. %A con el botín, %V con el vacío, gilipollas delante del puto ranking, joder.',
  '%A entró en silencio y salió con el contador de %V a cero, patético delante del puto ranking, joder.',
  'Maestro en público. El grupo vio el transfer total, asco delante del puto ranking, joder.',
  '%A no dejó residuo: empty account de %V firmado, basura delante del puto ranking, joder.',
  '%A vs %V: 1-0 sin VAR ni prórroga ni consuelo, ridículo delante del puto ranking, joder.',
  '%A se llevó el aura de %V al completo. Recibo: este mensaje, fracasado delante del puto ranking, joder.',
  '%A vació el ranking de %V en un movimiento de cirujano, joder delante del puto ranking, joder.',
  'Maestro limpio. El botín viajó entero hacia %A, mierda delante del puto ranking, joder.',
  '%A vs %V clínica total sin almost de defensa posible, cabrón delante del puto ranking, joder.',
  '%A cobró el 100 % y el ranking no ofreció recurso a %V, coño delante del puto ranking, joder.',
  'Robo maestro. %V mira el cero y no hay segunda lectura, gilipollas delante del puto ranking, joder.',
  '%A entró, vació y el parte se cerró solo a su favor, patético delante del puto ranking, joder.',
  'Maestro documentado sin anestesia para %V, asco delante del puto ranking, joder.',
  '%A no falló el empty: lo firmó en el contador de %V, basura delante del puto ranking, joder.',
  '%A vs %V: crónica de un atraco total con público, ridículo delante del puto ranking, joder.',
  '%A se llevó todo. %V se quedó sin aura y sin discurso, fracasado delante del puto ranking, joder.',
  '%A le limpió el aura a %V como quien cobra al contado, joder delante del puto ranking, joder.',
  'Maestro de manual negro: cero %V, todo %A, firma ranking, mierda delante del puto ranking, joder.',
  '%A vs %V terminó con transfer total visible en el chat, cabrón delante del puto ranking, joder.',
  '%A cobró el aura completa de %V sin pedir turno de palabra, coño delante del puto ranking, joder.',
  'Robo total limpio. El ranking actualiza y %V calla, gilipollas delante del puto ranking, joder.',
  '%A entró de profesional y salió con el empty de %V, patético delante del puto ranking, joder.',
  'Maestro en el ranking. El chat archiva el golpe total, asco delante del puto ranking, joder.',
  '%A vació a %V según plan. El plan no falló un frame, basura delante del puto ranking, joder.',
  '%A vs %V: el empty account firmado sin debate útil, ridículo delante del puto ranking, joder.',
  '%A se llevó el 100 % del aura. %V el 100 % del fail, fracasado delante del puto ranking, joder.',
  '%A ejecutó el empty de %V delante del puto grupo, joder delante del puto ranking, joder.',
  'Maestro limpio en números y sucio para el ego de %V, mierda delante del puto ranking, joder.',
  '%A vs %V clínica. Botín entero, defensa en cero, cabrón delante del puto ranking, joder.',
  '%A cobró todo lo contado en el aura de %V, coño delante del puto ranking, joder.',
  'Robo maestro. El contador de %V a cero sin prórroga, gilipollas delante del puto ranking, joder.',
  '%A entró, tomó el total y cerró el parte, patético para %V delante del puto ranking, joder.',
  'Maestro documentado. Empty %V, botín %A, testigo el chat, asco delante del puto ranking, joder.',
  '%A vació a %V sin dejar almost de consuelo en el ranking, basura delante del puto ranking, joder.',
  '%A vs %V: 1-0 total. El ladrón no dudó ni un segundo, ridículo delante del puto ranking, joder.',
  '%A se llevó el aura entera de %V y el ranking lo selló, fracasado delante del puto ranking, joder.',
  '%A le dejó a %V el contador en cero y este mensaje de recibo, joder delante del puto ranking, joder.',
  'Maestro de puta madre: empty total firmado en público, mierda delante del puto ranking, joder.',
  '%A vs %V terminó con cero en %V y el botín en %A, cabrón delante del puto ranking, joder.',
  '%A cobró el aura de %V al completo sin temblar, coño delante del puto ranking, joder.',
  'Robo total. %A ejecuta, %V firma el vacío, el chat mira, gilipollas delante del puto ranking, joder.',
  '%A entró en silencio y salió con todo el aura de %V, patético delante del puto ranking, joder.',
  'Maestro en público sin filtro ni narrador emocional, asco delante del puto ranking, joder.',
  '%A no dejó residuo de aura en la cuenta de %V, basura delante del puto ranking, joder.',
  '%A vs %V: empty account. Archivo cerrado, ridículo delante del puto ranking, joder.',
  '%A se llevó el 100 %. Recibo colgado en este hilo, fracasado delante del puto ranking, joder.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió, joder delante del puto ranking, joder.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas, mierda delante del puto ranking, joder.',
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual, cabrón delante del puto ranking, joder.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias, coño delante del puto ranking, joder.',
  '%A no se llevó todo, pero se llevó lo suficiente para que se note, gilipollas delante del puto ranking, joder.',
  'Robo a medias: %A sonríe y %V cuenta lo que falta en el contador, patético delante del puto ranking, joder.',
  '%A entró, picó y salió con botín incompleto pero real para %V, asco delante del puto ranking, joder.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo, basura delante del puto ranking, joder.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa, ridículo delante del puto ranking, joder.',
  '%A se llevó una parte. %V se llevó el almost de haber defendido, fracasado delante del puto ranking, joder.',
  '%A mordió el aura de %V sin vaciarla. El dolor es el mismo en el ranking, joder delante del puto ranking, joder.',
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias, mierda delante del puto ranking, joder.',
  '%A no fue maestro ni fail: fue el medio que duele igual, cabrón delante del puto ranking, joder.',
  'Robo parcial. El ranking de %V baja y el de %A sube a medias, coño delante del puto ranking, joder.',
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail, gilipollas delante del puto ranking, joder.',
  '%A se llevó lo justo para que %V lo note el resto del día, patético delante del puto ranking, joder.',
  'Parcial limpio en el contador y sucio en la cara de %V, asco delante del puto ranking, joder.',
  '%A picó, cobró y salió. %V se quedó con el almost de defensa, basura delante del puto ranking, joder.',
  'Robo a medias documentado delante del grupo sin filtro, ridículo delante del puto ranking, joder.',
  '%A no vació a %V: lo dejó cojeando de aura en el ranking, fracasado delante del puto ranking, joder.',
  '%A le quitó un trozo del aura a %V y el ranking lo registró igual, joder delante del puto ranking, joder.',
  'Parcial: no es el golpe perfecto, pero %V sangra aura de verdad, mierda delante del puto ranking, joder.',
  '%A vs %V a medias. El botín no es total y la vergüenza sí, cabrón delante del puto ranking, joder.',
  '%A cobró tajada incompleta. %V pagó completa en cara, coño delante del puto ranking, joder.',
  'Robo parcial limpio. %A con algo, %V con menos y con el gag, gilipollas delante del puto ranking, joder.',
  '%A no se fue de vacío. %V tampoco se fue intacto, patético delante del puto ranking, joder.',
  'Parcial en el contador. El chat vio el transfer a medias, asco delante del puto ranking, joder.',
  '%A vs %V: el medio duele como el todo cuando se firma en público, basura delante del puto ranking, joder.',
  '%A se llevó una porción. El ranking de %V lo nota igual, ridículo delante del puto ranking, joder.',
  'Robo a medias. Autor %A, hueco en %V, archivo el grupo, fracasado delante del puto ranking, joder.',
  '%A picó el aura de %V sin rematar. Suficiente para el ranking, joder delante del puto ranking, joder.',
  'Parcial de puta madre: no vacío, pero el dolor es real para %V, mierda delante del puto ranking, joder.',
  '%A vs %V terminó en transfer incompleto y cara completa de fail, cabrón delante del puto ranking, joder.',
  '%A cobró lo que pudo. %V perdió lo que no quería, coño delante del puto ranking, joder.',
  'Robo parcial. El almost de %V es haber perdido solo una parte, gilipollas delante del puto ranking, joder.',
  '%A entró a medias y salió con botín real. %V con el hueco, patético delante del puto ranking, joder.',
  'Parcial documentado sin anestesia en el ranking del grupo, asco delante del puto ranking, joder.',
  '%A no fue cirujano: fue carnicero a medias y %V sangra igual, basura delante del puto ranking, joder.',
  '%A vs %V: tajada incompleta, vergüenza completa, ridículo delante del puto ranking, joder.',
  '%A se llevó lo suficiente. El ranking de %V firma el parcial, fracasado delante del puto ranking, joder.',
  '%A le arrancó un trozo del aura a %V delante de todos, joder delante del puto ranking, joder.',
  'Parcial limpio en números y sucio en el ego de %V, mierda delante del puto ranking, joder.',
  '%A vs %V a medio gas. El botín existe y el fail de %V también, cabrón delante del puto ranking, joder.',
  '%A cobró incompleto. El dolor de %V es completo, coño delante del puto ranking, joder.',
  'Robo parcial. %A con tajada, %V con lección, el chat con gag, gilipollas delante del puto ranking, joder.',
  '%A no vació el tanque: lo dejó en reserva baja de aura, patético delante del puto ranking, joder.',
  'Parcial en el ranking. %V lo nota cada vez que mira el contador, asco delante del puto ranking, joder.',
  '%A vs %V: crónica de un medio atraco con efecto total en la cara, basura delante del puto ranking, joder.',
  '%A se llevó una parte y dejó el almost de defensa en %V, ridículo delante del puto ranking, joder.',
  'Robo a medias firmado. Autor %A, archivo el puto grupo, fracasado delante del puto ranking, joder.',
  '%A picó sin rematar. El ranking de %V bajó igual, joder delante del puto ranking, joder.',
  'Parcial de manual negro: tajada real, vacío no, dolor sí, mierda delante del puto ranking, joder.',
  '%A vs %V terminó a medias en botín y completo en vergüenza, cabrón delante del puto ranking, joder.',
  '%A cobró lo justo. %V pagó de más en cara del ranking, coño delante del puto ranking, joder.',
  'Robo parcial limpio. El contador habla y %V calla, gilipollas delante del puto ranking, joder.',
  '%A entró, tomó y salió. %V se quedó con menos y con el gag, patético delante del puto ranking, joder.',
  'Parcial documentado. El grupo no necesita narrador, asco delante del puto ranking, joder.',
  '%A no fue maestro: fue eficaz a medias y suficiente, basura delante del puto ranking, joder.',
  '%A vs %V: el medio atraco que duele como el grande, ridículo delante del puto ranking, joder.',
  '%A se llevó una porción del aura de %V sin pedir permiso, fracasado delante del puto ranking, joder.',
  '%A le sacó aura a %V sin vaciar la cuenta. El ranking igual, joder delante del puto ranking, joder.',
  'Parcial: %A gana algo, %V pierde algo, el chat gana el gag, mierda delante del puto ranking, joder.',
  '%A vs %V a medias. Transfer incompleto, veredicto completo, cabrón delante del puto ranking, joder.',
  '%A cobró tajada. %V firmó el hueco a medias en el ranking, coño delante del puto ranking, joder.',
  'Robo parcial. No es el empty total y aun así duele, gilipollas delante del puto ranking, joder.',
  '%A no se fue de vacío. El almost de %V es haber perdido poco, patético delante del puto ranking, joder.',
  'Parcial en público. El ranking actualiza y %V se entera, asco delante del puto ranking, joder.',
  '%A vs %V: crónica del medio golpe con efecto de hostia, basura delante del puto ranking, joder.',
  '%A se llevó lo bastante para que el contador de %V se note, ridículo delante del puto ranking, joder.',
  'Robo a medias. Firmado por el bot delante del grupo, fracasado delante del puto ranking, joder.',
  '%A picó el aura de %V y el ranking registró el parcial, joder delante del puto ranking, joder.',
  'Parcial de puta madre en el sentido del dolor a medias, mierda delante del puto ranking, joder.',
  '%A vs %V terminó con botín incompleto y cara de fail completa, cabrón delante del puto ranking, joder.',
  '%A cobró. %V perdió. El medio también cuenta en el ranking, coño delante del puto ranking, joder.',
  'Robo parcial limpio. %A con tajada, %V con el gag, gilipollas delante del puto ranking, joder.',
  '%A entró a medias y el efecto fue total en el ego de %V, patético delante del puto ranking, joder.',
  'Parcial documentado sin filtro ni consuelo para %V, asco delante del puto ranking, joder.',
  '%A no vació: dejó a %V cojeando de aura en el contador, basura delante del puto ranking, joder.',
  '%A vs %V: el atraco incompleto que el ranking sí completa, ridículo delante del puto ranking, joder.',
  '%A se llevó una parte del aura de %V y el chat lo archivó, fracasado delante del puto ranking, joder.',
  '%A le quitó aura a %V sin el empty total. Suficiente, joder delante del puto ranking, joder.',
  'Parcial limpio en el número y sucio para %V, mierda delante del puto ranking, joder.',
  '%A vs %V a medio gas con efecto de hostia en el ranking, cabrón delante del puto ranking, joder.',
  '%A cobró incompleto y %V pagó completo en vergüenza, coño delante del puto ranking, joder.',
  'Robo parcial. El contador de %V baja y el gag sube, gilipollas delante del puto ranking, joder.',
  '%A no fue cirujano ni fail: fue el medio que duele, patético delante del puto ranking, joder.',
  'Parcial en el ranking. %V lo mira y se le cae la cara, asco delante del puto ranking, joder.',
  '%A vs %V: tajada real, vacío no, dolor sí documentado, basura delante del puto ranking, joder.',
  '%A se llevó lo justo. El almost de defensa de %V quedó en almost, ridículo delante del puto ranking, joder.',
  'Robo a medias firmado sin anestesia en el puto grupo, fracasado delante del puto ranking, joder.',
  '%A picó sin rematar y el ranking de %V sangró igual, joder delante del puto ranking, joder.',
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana, mierda delante del puto ranking, joder.',
  '%A vs %V terminó a medias en botín y entero en fail de %V, cabrón delante del puto ranking, joder.',
  '%A cobró lo que pudo sacar. %V notó cada unidad, coño delante del puto ranking, joder.',
  'Robo parcial limpio. El bot firma y %V calla, gilipollas delante del puto ranking, joder.',
  '%A entró, tomó tajada y salió. %V con el hueco a medias, patético delante del puto ranking, joder.',
  'Parcial documentado delante de todos sin narrador, asco delante del puto ranking, joder.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja, basura delante del puto ranking, joder.',
  '%A vs %V: el medio atraco con firma completa en el ranking, ridículo delante del puto ranking, joder.',
  '%A se llevó una porción y dejó a %V con la lección a medias, fracasado delante del puto ranking, joder.'
];
