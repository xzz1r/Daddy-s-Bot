...
const ROB_WIN = [
  ...
  'Atraco exitoso al natural: %A sonríe con el botín y %V cuenta lo que ya no tiene, asco y el ranking lo deja claro.',
  ...
  '%A no solo intentó el golpe: cobró. %V no solo se defendió: perdió, gilipollas y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con %A contando botín y %V restando aura en silencio, fracasado y el ranking lo deja claro.',
  '%A no dejó el atraco en almost eterno: lo cerró con botín de %V en su cuenta, cutre y el ranking lo deja claro.',
  ...
  '%A vs %V: el ladrón no solo intentó, cobró y se fue con el botín, joder y el ranking lo deja claro.',
  ...
  '%A el contador no miente en este caso: %V menos, %A más,, joder. sin segunda oportunidad hoy y el ranking lo deja claro.',
  ...
  '%A se llevó el botín de %V sin pedir disculpas al contador ni permiso al grupo, joder y el ranking lo deja claro.',
  '%A el plan contra %V funcionó de principio a fin del intento de atraco, mierda y el ranking lo deja claro.',
  ...
  'Robo exitoso: %A con aura nueva en la cuenta y %V con el hueco documentado, gilipollas y el ranking lo deja claro.',
  ...
  '%A el botín de %V ya tiene dueño nuevo; el ranking lo nombra sin pedir confirmación, ridículo y el ranking lo deja claro.',
  '%A vs %V: gana quien atacó con el contador a favor y cerró el parte, fracasado y el ranking lo deja claro.',
  '%A robó a %V en plena luz del chat: sin sombra útil que tape el cargo del ranking, cutre y no hay modo de suavizarlo.',
  'Robo limpio de %A a costa de %V: medible, visible y archivado en el historial, joder y el ranking lo deja claro.',
  ...
  'Robo exitoso de %A: el aura de %V cambió de manos sin letra pequeña ni recurso, mierda y el ranking lo deja claro.',
  ...
  '%A entró a por el aura de %V y cumplió el objetivo del comando en el ranking, basura y el ranking lo deja claro.',
  ...
  '%A robó el aura de %V con público y sin remordimiento de contador, cutre y el ranking lo deja claro.',
  ...
  '%A vs %V: 1-0 sin VAR, sin prórroga y con botín a nombre de %A, cabrón y el ranking lo deja claro.',
  ...
  'Robo limpio de %A: el aura de %V viajó sin billete de retorno ni reembolso, ridículo y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con el transfer visible y el debate inútil en el hilo, mierda y el ranking lo deja claro.',
  ...
  '%A el plan contra %V funcionó: el aura cambió de dueño en el contador, basura y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con el contador actualizado y el debate cerrado por los números, ridículo y el ranking lo deja claro.',
  '%A se llevó el aura de %V cuando más se notaba soltarla en el ranking, fracasado y el ranking lo deja claro.',
  ...
  '%A robó a %V sin pedir turno de palabra en el grupo ni devolver el botín, patético y el ranking lo deja claro.',
  '%A el golpe a %V aterrizó en el aura: el resto del mensaje es ruido de fondo, asco y el ranking lo deja claro.',
  '%A vs %V: crónica de un atraco con final de botín a favor de %A, basura. y el contador insiste sin apelación posible hoy.',
  '%A se llevó el aura de %V en el momento que el ranking no perdona ni suaviza, ridículo y el ranking lo deja claro.',
  'Robo exitoso: %A cierra, %V abre el hueco y el grupo archiva el resultado, fracasado y el ranking lo deja claro.',
  ...
  '%A el plan salió; %V no se salvó; el contador quedó de testigo del cargo, mierda y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con el aura de %V en tránsito hacia la cuenta de %A, patético y el ranking lo deja claro.',
  ...
  '%A se llevó lo marcado de %V sin letra pequeña ni segunda oportunidad del sistema, cabrón y el ranking lo deja claro.',
  ...
  '%A entró a por el aura de %V y cerró el parte a su favor en el sistema, gilipollas y el ranking lo deja claro.',
  '%A ejecutó el atraco sin almost: %V sin defensa suficiente para retener, patético y el ranking lo deja claro.',
  ...
  '%A cobró el aura de %V en el momento exacto del comando y del hilo a favor del resultado, cutre y el ranking lo deja claro.',
  ...
  '%A el golpe a %V fue limpio; el efecto en el contador, sucio para %V a favor del resultado, cutre y el ranking lo deja claro.',
  ...
  '%A robó a %V sin almost y sin devolución posible del botín, ridículo y el ranking lo deja claro.',
  'Robo limpio: %A cierra el parte, %V abre el hueco y el grupo lo ve en el ranking, fracasado. delante del ranking y de la cara.',
  '%A vs %V: 1-0 en el único marcador que el comando reconoce de verdad, cutre y el ranking lo deja claro.',
  ...
  '%A robó el aura de %V con precisión de cobro ya calculado de antemano, asco y el ranking lo deja claro.',
  ...
  '%A se llevó lo marcado del aura de %V: casilla cobrada en el sistema, patético y el ranking lo deja claro.',
  '%A el plan contra %V funcionó de punta a punta del intento de atraco, asco y el ranking lo deja claro.',
  ...
  '%A cobró el aura de %V y cerró el parte sin pedir aplauso al grupo, joder y el ranking lo deja claro.',
  '%A el botín de %V ya no vuelve: el ranking no ofrece reembolso de aura, mierda y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con el resultado que %A había marcado en la lista de la compra, patético y el ranking lo deja claro.',
  '%A robó el aura de %V y dejó el hueco como firma visible en el perfil del ranking, asco. delante de quien aún leía el hilo.',
  '%A vs %V: 1-0 en aura, archivo cerrado, siguiente ronda cuando toque, ridículo y el ranking lo deja claro.'
];
...
const ROB_FAIL = [
  ...
  '%A tenía hambre de aura ajena; %V tenía la nevera cerrada y la llave en otro continente, fracasado y el ranking lo deja claro.',
  '%A vs %V terminó 0-1 sin que %V sudara ni una gota de aura ni de paciencia, joder. con el fail todavía caliente.',
  'Robo abortado por falta de talento documentada en acta: autor %A, espectador aburrido %V, mierda y el ranking lo deja claro.',
  ...
  'El atraco de %A fue un farol a mesa llena; %V no vio las cartas porque no había juego encima, coño y el ranking lo deja claro.',
  ...
  '%A tropezó con la realidad en el primer escalón del plan; la realidad se llama %V intacto, basura y el ranking lo deja claro.',
  ...
  '%V sigue: el contador de aura no parpadeó ni un frame; %A sí, de nervios y de vergüenza, cabrón y el ranking lo deja claro.',
  ...
  '%A en el intento, el intento en el suelo y el botín donde siempre estuvo: en %V, patético y el ranking lo deja claro.',
  ...
  '%A creyó que esta vez sí tocaba; el universo y %V contestaron que no al unísono y sin dudar, cutre y el ranking lo deja claro.',
  '%V ni se enteró del show montado; %A se enteró demasiado, demasiado tarde y demasiado claro, joder y el ranking lo deja claro.',
  '%A tropezó con el peaje del fallo antes de oler de cerca el botín que guardaba %V, mierda y el ranking lo deja claro.',
  ...
  '%A sin el aura de %V y sin la cara de haberlo intentado de una forma decente, mierda y el ranking lo deja claro.',
  ...
  '%V 1, %A 0: acta cerrada sin prórroga, sin VAR y sin bis de consuelo, gilipollas y el ranking lo deja claro.',
  '%A vs %V: el fallo se escribió solo en el ranking, sin ayuda de guionista ni de narrador, ridículo y el ranking lo deja claro.',
  ...
  '%A vs %V terminó antes de que %A encontrara siquiera el bolsillo correcto del objetivo, ridículo y el ranking lo deja claro.',
...
const ROB_DESASTRE = [
  ...
  'Desastre de %A: intentó quitar y terminó poniendo aura en la cuenta de %V, basura y el ranking lo deja claro.',
  ...
  '%A intentó robar a %V y terminó de patrocinador oficial de su aura en el ranking, gilipollas y el ranking lo deja claro.',
  ...
  '%A salió a cazar aura ajena y volvió dejando la propia en el plato de %V, joder y el ranking lo deja claro.',
  ...
  '%A salió a vaciar a %V y terminó vaciándose él; el chat tomó nota del peaje, cabrón y el ranking lo deja claro.',
  ...
  '%A vs %V en modo desastre: gana quien debía perder según el guion original de %A, basura y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con transfer automático por incompetencia documentada, mierda y el ranking lo deja claro.',
  ...
  '%A vs %V: el ladrón pagó la entrada, la consumición y la propina del ranking ajeno, asco y el ranking lo deja claro.',
  ...
  'Desastre de %A: el botín viajó hacia %V con remitente el fallo del intento, cabrón y el ranking lo deja claro.',
  ...
  '%A vs %V: crónica breve de un transfer largo y doloroso para %A, patético y el ranking lo deja claro.',
  ...
  'Desastre documentado: el aura de %A emigró con destino fijo a la cuenta de %V, mierda y el ranking lo deja claro.',
  ...
  '%A vs %V terminó con transfer y sin una sola línea de gloria para %A, coño y el ranking lo deja claro.',
  '%A perdió el duelo del atraco y el del contador; %V sin ponerse los guantes, gilipollas y el ranking lo deja claro.',
  ...
  '%A sin gloria y con el saldo en menos; %V sin haber pedido nada del regalo, cabrón y el ranking lo deja claro.',
  'Desastre total: %A financió a %V con el intento mismo de robarle el aura, gilipollas. y el resto es ruido de fondo.',
  '%A vs %V terminó con %A de patrocinador y %V de marca beneficiada a favor del resultado, asco y el ranking lo deja claro.',
  ...
  '%A intentó el golpe de oro y firmó el cargo de plomo a favor de %V, gilipollas y el ranking lo deja claro.',
