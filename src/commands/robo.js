...
const ROB_MAESTRO = [
  ...
  '%A le vació el aura a %V con la precisión de un puto cirujano delante del puto ranking, joder Qué asco de intento.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking delante del puto ranking, mierda Qué asco de intento.',
  '%A vs %V: clínica. El botín viajó entero y el chat aplaudió el golpe delante del puto ranking, coño.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V delante del puto ranking, cabrón Qué asco de intento.',
  '%A ejecutó el atraco perfecto. %V firmó el empty account delante del puto ranking, gilipollas Qué asco de intento.',
  'Robo de manual negro: %A cobra, %V llora, el ranking firma delante del puto ranking, patético Qué asco de intento.',
  '%A entró como sombra y salió con el aura completa de %V delante del puto ranking, asco Qué asco de intento.',
  'Maestro documentado. Autor %A, víctima total %V, basura el defendido delante del puto ranking, basura.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo, ridículo para %V delante del puto ranking, ridículo.',
  '%A se llevó todo. %V se quedó con el hueco y este mensaje delante del puto ranking, fracasado Qué asco de intento.'
];
...
const ROB_PARCIAL = [
  ...
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual delante del puto ranking, coño Qué asco de intento.',
  ...
  'Robo a medias: %A sonríe y %V cuenta lo que falta delante del puto ranking, patético Qué asco de intento.',
  '%A entró, picó y salió con botín incompleto pero real, asco para %V delante del puto ranking, asco Qué asco de intento.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo delante del puto ranking, basura Qué asco de intento.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa delante del puto ranking, ridículo Qué asco de intento.',
