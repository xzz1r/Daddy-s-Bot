...
const ROB_WIN = [
  '%A le roba el aura a %V en plena cara del grupo. Limpio, visible y con la cara de %V de "otra vez no", joder.',
  '%A entró a por el aura de %V y salió con ella en el contador. El chat no necesita narrador ni subtítulos, mierda.',
  'Robo limpio de %A a %V: el aura cambió de dueño y el ranking lo registró sin pedir permiso a nadie, coño.',
  '%A vs %V: gana el que atacó. %V se defendió como se defiende un argentino de la inflación: mal y tarde, cabrón.',
  '%A vació lo que pudo del aura de %V. Suficiente para que se note en el contador y en la cara del pobre, gilipollas.',
  'El atraco de %A a %V salió redondo: botín en mano, víctima mirando el hueco como quien mira la cuenta del banco, patético.',
  '%A no pidió permiso a nadie. Se llevó el aura de %V y dejó el recibo colgado en este mensaje, y el grupo no necesita dibujo para entenderlo, asco.',
  'Robo a favor de %A: %V pierde aura y la cara a la vez. Doble cargo, una sola operación, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A ejecutó el golpe a %V con la calma de un chileno cobrando la cuenta. Frío, exacto y sin propina, ridículo.',
  '%A vs %V terminó con el contador de %A en más y el de %V en menos. Aritmética cruel, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A le quitó el aura a %V delante de todos. No hubo modo avión ni silencio que ocultara el cargo, cutre.',
  ...
  'Robo limpio: %A cobra, %V paga y el grupo presencia el transfer sin filtro ni consuelo, y el grupo no necesita dibujo para entenderlo, coño.',
  ...
  '%A se llevó el aura de %V con la precisión de un peruano cobrando deuda vieja. Sin prisa, sin fallar, patético.',
  'Atraco exitoso: %A sonríe con el botín y %V cuenta lo que ya no tiene. Matemática del robo, y el grupo no necesita dibujo para entenderlo, asco.',
  ...
  'Robo a cara descubierta: %A no se escondió y %V no se salvó del cargo. Luz de chat completa, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V terminó con el botín en el bolsillo correcto del sistema: el de %A, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A dejó a %V mirando el hueco del contador donde antes había aura contada unidad por unidad, mierda.',
  '%A ejecutó el atraco a %V sin pedir aplauso. El contador aplaude por él en números fríos, y el grupo no necesita dibujo para entenderlo, coño.',
  'El aura de %V cambió de manos en público. Las manos son las de %A y el ranking lo firma sin dudar, cabrón.',
  '%A no solo intentó el golpe: cobró. %V no solo se defendió: perdió. Crónica corta, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V: crónica de un robo que sí se ejecutó y se puede leer en el ranking sin lupa, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A se llevó lo suyo de la cuenta de %V. Definición operativa de atraco exitoso sin poesía, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A cazó el aura de %V cuando %V menos lo tenía en la agenda del día. Timing de carnicero, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el botín de %V ya no es de %V. El ranking no discute el cargo ni ofrece recurso de apelación, fracasado.',
  '%A vs %V terminó 1-0 con el 1 en la columna del que atacó bien y cobró sin temblar, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A le dejó a %V el recibo del robo en forma de mensaje de este comando. Sin sobre ni sello, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Atraco redondo: %A cobra, %V aprende la lección y el chat archiva el resultado sin debate, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A no falló el timing ni la puntería del golpe. %V falló la defensa del ranking completo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V: el aura viajó en la dirección que %A había marcado en la lista de la compra, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A se llevó el botín de %V sin pedir la palabra en el grupo ni devolver una sola unidad, y el grupo no necesita dibujo para entenderlo, patético.',
  'Robo exitoso de %A a costa de %V: visible, medible y archivado en el historial del comando, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A ejecutó el golpe con la lista de la compra cerrada. Aura de %V: marcada y cobrada, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A el contador de %V bajó. El de %A subió. Aritmética del atraco sin poesía ni consuelo, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V terminó con %A contando botín y %V restando aura en silencio de ranking, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A no dejó el atraco en almost eterno. Lo cerró con botín de %V en su cuenta del sistema, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A se llevó el aura de %V en el momento exacto en que el chat miraba el hilo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V: gana quien no se quedó mirando el aura propia mientras se la llevaban, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A cobró de %V lo que %V no pensaba soltar. El ranking insiste en el cargo sin piedad, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A el golpe a %V fue corto, claro y suficiente para mover el contador de una vez, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A entró, tomó el aura de %V y dejó el hueco de recuerdo en el perfil del ranking, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V terminó con el botín en movimiento y destino claro: la cuenta de %A, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A no pidió suerte de principiante: ejecutó. %V no tuvo defensa suficiente ni de cerca, y el grupo no necesita dibujo para entenderlo, basura.',
  'Atraco a favor de %A: %V en el parte como quien pierde aura en público y se nota, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A se llevó lo marcado de la cuenta de %V sin letra pequeña ni segunda oportunidad, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A el plan contra %V salió como en la pizarra. Aura de %V en su columna del ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V: el ladrón no solo intentó, cobró y se fue con el botín bajo el brazo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A robó el aura de %V con la calma de un trámite ya resuelto en el sistema del bot, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Robo exitoso: %A con el botín, %V con la lección y el grupo con el dato del ranking, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A no dejó espacio al drama largo de %V. Primero el golpe, luego este mensaje de recibo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V terminó 1-0 en el único marcador que importa aquí: el del aura del comando, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A cazó a %V en el ranking y el contador firmó el resultado sin pedir segunda opinión, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el aura de %V viajó sin billete de vuelta ni posibilidad de reembolso en el sistema, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A ejecutó el atraco a %V como quien cobra una deuda pendiente con intereses de demora, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V: crónica de un golpe que sí aterrizó en el contador y se puede leer, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A se llevó el botín de %V y el chat no pidió repetición. Se vio claro a la primera, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A el contador no miente en este caso: %V menos, %A más, punto final del parte, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A entró a por el aura de %V y no salió de vacío ni de almost eterno esta vez, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó con el ranking actualizado a favor del atacante sin debate útil, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A cobró el aura de %V en el timing que %V no esperaba ni había agendado en el día, y el grupo no necesita dibujo para entenderlo, cabrón.',
  'Atraco redondo: %A no falló, %V no se salvó y el grupo no dudó del resultado ni un segundo, gilipollas.',
  '%A se llevó lo suyo del bolsillo de %V. Definición corta y operativa del atraco exitoso, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el golpe fue suficiente. El aura de %V lo nota y el ranking también lo muestra sin filtro, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V: gana %A. El resto es ruido de la defensa que no llegó a tiempo ni de cerca, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A robó a %V sin pedir la palabra en el hilo y sin devolver una sola unidad de aura, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Robo exitoso de %A: el botín de %V cambió de manos en público y queda firmado en el ranking, fracasado.',
  '%A ejecutó, cobró y dejó a %V con el hueco del contador y este mensaje de recibo, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V terminó con el transfer en la dirección correcta para %A y visible para todos, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A no improvisó el final del atraco. El aura de %V ya estaba contada a su favor desde antes, mierda.',
  '%A el atraco a %V salió limpio de fallos y lleno de botín ajeno en el contador del comando, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A se llevó el aura de %V mientras el chat tomaba nota del movimiento en el ranking, y el grupo no necesita dibujo para entenderlo, cabrón.',
  'Robo limpio: %A cobra en silencio de víctima y %V en ruido de queja que no cambia el número, gilipollas.',
  '%A vs %V: el marcador final del aura no admite debate ni recurso de apelación posible, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A entró a por %V y salió con el contador a favor y el parte cerrado en el sistema, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A el golpe a %V conectó donde tenía que conectar: el aura contada del ranking del grupo, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V terminó con %A en más y %V en el parte de bajas de aura del día, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A robó el aura de %V con la precisión de quien no necesita segunda oportunidad en el comando, fracasado.',
  '%A se llevó el botín de %V sin pedir disculpas al contador ni permiso al grupo entero, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el plan contra %V funcionó de principio a fin del intento de atraco sin un solo fallo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: crónica corta de un robo largo para el contador de %V y dulce para %A, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A cobró de %V lo marcado en la lista. El ranking confirma el cargo sin dudar ni un tick, y el grupo no necesita dibujo para entenderlo, cabrón.',
  'Robo exitoso: %A con aura nueva en la cuenta y %V con el hueco documentado en el perfil, gilipollas.',
  '%A ejecutó el atraco a %V en el momento en que más dolía soltar el aura contada, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V terminó 1-0 sin prórroga. El 1 es de %A y el 0 de la defensa insuficiente, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A se llevó el aura de %V y dejó el recibo colgado en este hilo del chat para siempre, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A el botín de %V ya tiene dueño nuevo. El ranking lo nombra sin pedir confirmación a nadie, ridículo.',
  '%A vs %V: gana quien atacó con el contador a favor y cerró el parte sin temblar, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A robó a %V en plena luz del chat. Sin sombra útil que tape el cargo del ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  'Robo limpio de %A a costa de %V: medible, visible y archivado en el historial del comando, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A entró, cobró el aura de %V y salió con el trabajo del atraco hecho de una vez, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A el golpe fue corto en segundos y largo en efecto sobre el contador de %V, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V terminó con el transfer firmado a favor de %A en el sistema del bot, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A no dejó el atraco a medias. Cerró con el aura de %V en su cuenta del ranking, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A se llevó lo que %V no pensaba soltar. El ranking insiste en el cargo sin piedad ni descuento, patético.',
  'Atraco redondo: %A ejecuta, %V paga y el grupo presencia el cambio de dueño en vivo, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A cobró el aura de %V con la calma de un trámite ya cerrado en el sistema, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el contador de %V bajó en público. No hay modo avión que oculte el número del cargo, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V terminó con %A contando botín y %V contando pérdidas en silencio de ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A robó a %V sin pedir la palabra y sin devolver ni una unidad del botín cobrado, y el grupo no necesita dibujo para entenderlo, joder.',
  'Robo exitoso de %A: el aura de %V cambió de manos sin letra pequeña ni recurso posible, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A ejecutó el golpe a %V como quien marca una casilla pendiente del ranking y pasa página, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V: crónica de un atraco que no se quedó en intento ni en almost eterno, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A se llevó el botín de %V delante de quienes miraban el ranking en ese preciso momento, gilipollas.',
  '%A el plan salió. El aura de %V no se salvó del cargo en el contador del comando, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V terminó 1-0 en aura. El resto del mensaje es comentario de relleno, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A entró a por el aura de %V y cumplió el objetivo del comando en el ranking sin fallar, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A cobró de %V en el timing que no perdona ni avisa dos veces seguidas al objetivo, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Robo limpio: %A con el botín, %V con el hueco y el chat con el dato del transfer, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V: gana %A por ejecución limpia y pierde %V por defensa insuficiente de ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A se llevó el aura de %V y el recibo quedó colgado en este hilo para quien quiera leerlo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el golpe a %V aterrizó. El ranking no pide segunda opinión ni VAR ni narrador, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó con el transfer en dirección %A y visible para todo el grupo del chat, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A robó a %V en el momento exacto. Ni un segundo antes ni uno después del timing perfecto, y el grupo no necesita dibujo para entenderlo, cabrón.',
  'Atraco a favor de %A: %V en el parte de pérdidas y el aura en otra cuenta del sistema, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A ejecutó, cobró y dejó a %V con la cara del contador en menos y este mensaje de recibo, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V: el botín se movió y el debate útil no hace falta en el hilo del grupo, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A se llevó lo marcado del aura de %V sin pedir confirmación al sistema ni al chat, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A el atraco a %V fue limpio de fallos y sucio de botín ajeno en el contador, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V terminó con %A en verde y %V en el hueco del ranking del comando, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A robó el aura de %V con público y sin remordimiento de contador ni de conciencia, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A entró a por %V y salió con el objetivo del comando cumplido en números del sistema, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A el golpe fue suficiente para que %V lo note el resto de la sesión del chat entero, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V: 1-0 sin VAR, sin prórroga y con botín a nombre de %A en el ranking, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A cobró el aura de %V y el chat archivó el resultado sin pedir amplificación ni bis, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A se llevó el botín de %V en el timing del que no avisa ni pide permiso al objetivo, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V terminó con el ranking a favor del que atacó bien y cobró sin temblar, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A ejecutó el atraco a %V como un cobro pendiente saldado en el sistema del bot, y el grupo no necesita dibujo para entenderlo, basura.',
  'Robo limpio de %A: el aura de %V viajó sin billete de retorno ni reembolso posible, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V: crónica corta y botín largo para la cuenta de %A en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A se llevó el aura de %V mientras %V todavía contaba la unidad anterior del contador, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A el contador no miente en este parte: %A más, %V menos, punto final del acta, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V terminó con el transfer visible y el debate inútil sobrando en el hilo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A robó a %V sin sombra que oculte el cargo. Luz de chat completa sobre el movimiento, y el grupo no necesita dibujo para entenderlo, coño.',
  'Atraco redondo a favor de %A: cobra el aura de %V en un solo movimiento limpio del comando, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A ejecutó el golpe a %V y el ranking firmó debajo sin pedir aclaración a nadie, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V: gana quien no se quedó con las manos vacías al final del round del atraco, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A se llevó el botín de %V y dejó el mensaje como único recibo del cargo en el hilo, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A el plan contra %V funcionó. El aura cambió de dueño en el contador del ranking, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V terminó 1-0 en el marcador del aura y el archivo quedó cerrado sin recurso, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A cobró de %V lo que el ranking ahora muestra a su favor sin filtro ni modo privado, y el grupo no necesita dibujo para entenderlo, fracasado.',
  'Robo exitoso de %A a costa de %V: sin asterisco que lo relativice ni consuelo posible, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A entró a por el aura de %V y no aceptó un no del contador como respuesta del sistema, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el golpe a %V fue corto en el reloj y largo en el efecto del ranking del grupo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó con %A en el lado correcto del transfer de aura del comando, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A robó el aura de %V en plena sesión de chat. Sin pausa ni aviso previo al objetivo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V: el ladrón cerró el parte antes de que la víctima terminara de quejarse en el hilo, patético.',
  '%A ejecutó el atraco a %V con lista cerrada. Botín marcado y botín cobrado en el contador, y el grupo no necesita dibujo para entenderlo, asco.',
  'Robo limpio: %A con aura de %V, %V con el hueco y el grupo con la foto del ranking, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V terminó con el contador actualizado y el debate cerrado por los números fríos, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A se llevó el aura de %V cuando más se notaba soltarla en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A el botín de %V cambió de manos. Las manos de %A no tiemblan en el contador del comando, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V: 1-0 a favor de quien no falló el golpe del atraco en esta tirada, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A cobró el aura de %V y dejó el hueco como recuerdo visible en el perfil del ranking, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A ejecutó, %V pagó y el chat presenció. Robo completo sin asteriscos ni consuelo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V terminó con el transfer en firme a nombre de %A en el sistema del bot, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A robó a %V sin pedir turno de palabra en el grupo ni devolver el botín cobrado, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el golpe a %V aterrizó en el aura. El resto del mensaje es ruido de fondo del hilo, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V: crónica de un atraco con final de botín a favor de %A en el ranking, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A se llevó el aura de %V en el momento que el ranking no perdona ni suaviza el cargo, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Robo exitoso: %A cierra, %V abre el hueco y el grupo archiva el resultado sin debate, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V terminó 1-0 sin necesidad de amplificación ni narrador extra en el chat, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A cobró de %V el aura que ahora figura en su columna del ranking del grupo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el plan salió. %V no se salvó. El contador quedó de testigo del cargo en el sistema, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: gana %A por ejecución limpia del atraco y pierde %V por no retener el aura, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A se llevó el botín de %V delante de quien quisiera mirar el hilo en ese momento, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A ejecutó el atraco a %V como quien marca una casilla y pasa a la siguiente del ranking, gilipollas.',
  '%A vs %V terminó con el aura de %V en tránsito hacia la cuenta de %A en el sistema, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A robó el aura de %V con la precisión de un cobro ya calculado de antemano en la cabeza, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V: el marcador del aura no admite empate en este resultado del comando, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el golpe fue suficiente. %V lo nota y el ranking lo muestra sin filtro ni consuelo, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A cobró el aura de %V y el chat no pidió repetición. Se vio de sobra a la primera, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Atraco redondo a favor de %A: %V en el hueco documentado del contador del comando, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A se llevó lo marcado de %V sin letra pequeña ni segunda oportunidad del sistema, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V: el ladrón ganó el round que importaba al contador de aura del ranking, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A ejecutó el atraco a %V en el timing del que no avisa dos veces seguidas al objetivo, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el aura de %V viajó. Destino: cuenta de %A. Billete sin retorno posible en el sistema, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V terminó 1-0 en aura. Archivo cerrado y siguiente ronda cuando toque, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A robó a %V en luz de chat completa. Sin sombra útil para la víctima del cargo del ranking, ridículo.',
  '%A se llevó el botín de %V con la calma de quien ya había contado el premio de antemano, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V: crónica corta de un transfer largo para el contador de %V en el ranking, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A cobró de %V lo que ahora pesa en su favor en el ranking del grupo del chat, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A el golpe a %V conectó. No hace falta cámara lenta ni narrador emocional del comando, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V terminó con el botín en el bolsillo de %A y el hueco en el de %V, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A entró a por el aura de %V y cerró el parte a su favor en el sistema del bot, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A ejecutó el atraco sin almost. %V sin defensa suficiente para retener el aura, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V: 1-0 sin prórroga y con aura en movimiento hacia %A en el ranking, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A se llevó el aura de %V y dejó el hueco como firma visible en el perfil del ranking, y el grupo no necesita dibujo para entenderlo, basura.',
  'Robo limpio: %A con el resultado, %V con la pérdida y el grupo con el dato del transfer, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V terminó con el ranking firmando a favor de %A sin pedir aclaración a nadie, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A cobró el aura de %V en el momento exacto del comando y del hilo del grupo, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A el plan contra %V no se quedó en la pizarra. Se cobró en el contador del ranking, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V: gana quien atacó y cobró, pierde quien defendió mal el aura del ranking, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A ejecutó el atraco a %V como un cobro de deuda que %V no reconocía ni quería pagar, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V terminó con el transfer visible en el ranking y sin recurso de apelación, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A robó el aura de %V y el chat archivó el resultado sin debate útil posible en el hilo, y el grupo no necesita dibujo para entenderlo, patético.',
  'Atraco a favor de %A: %V en pérdidas y el aura en otra columna del sistema del bot, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A se llevó lo suyo del aura de %V. Operativa de atraco exitoso sin maquillaje ni consuelo, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V: el ladrón cerró antes de que la queja de %V terminara de escribirse en el chat, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A cobró de %V en público. El ranking no ofrece modo privado para el cargo del comando, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A el golpe a %V fue limpio. El efecto en el contador, sucio para %V y dulce para %A, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V terminó 1-0 con el botín en movimiento hacia la cuenta de %A en el ranking, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A entró a por %V y cumplió. El aura cambió de dueño en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Robo exitoso de %A a costa de %V: sin relativizar y con números a la vista de todos, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A ejecutó, cobró y dejó a %V con el mensaje de recibo y el hueco del contador, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A se llevó el aura de %V en el timing que el ranking registra sin piedad ni descuento, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A robó a %V sin almost y sin devolución posible del botín cobrado en el ranking, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Robo limpio: %A cierra el parte, %V abre el hueco y el grupo lo ve en el ranking, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V: 1-0 en el único marcador que el comando reconoce de verdad en el chat, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A cobró el aura de %V y dejó el recibo colgado en este hilo del chat para el archivo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el plan salió redondo. El aura de %V no tuvo billete de vuelta al contador del ranking, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó con el ranking actualizado y el debate sobrando en el hilo del grupo, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A ejecutó el atraco a %V como quien salda una línea pendiente del sistema del bot, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V: gana %A, pierde %V y el aura no se discute en el chat del grupo, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A robó el aura de %V con precisión de cobro ya calculado de antemano en la lista, y el grupo no necesita dibujo para entenderlo, asco.',
  'Atraco redondo: %A con el resultado en el contador y %V con la pérdida a la vista, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V terminó con el transfer en firme y sin VAR que lo cambie en el ranking, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el golpe a %V aterrizó donde más dolía: el contador del ranking del comando, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V: 1-0 sin prórroga y con botín a nombre de %A en el sistema del bot, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A cobró de %V lo que el ranking ahora muestra sin filtro ni modo privado posible, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A ejecutó el atraco a %V y el chat no pidió segunda toma del golpe ni del recibo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V terminó con %A contando y %V restando en silencio de ranking del grupo, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A se llevó lo marcado del aura de %V. Casilla cobrada en el sistema del comando, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el plan contra %V funcionó de punta a punta del intento de atraco sin un fallo, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V: el ladrón ganó el round del contador y cerró el parte del ranking, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A robó a %V en plena luz. Sin sombra para esconder el cargo del ranking del grupo, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Robo limpio de %A a costa de %V: archivado en el ranking sin recurso de apelación, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V terminó 1-0 con el aura en tránsito hacia quien atacó bien en el comando, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A cobró el aura de %V y cerró el parte sin pedir aplauso al grupo del chat, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el botín de %V ya no vuelve. El ranking no ofrece reembolso de aura en el sistema, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: crónica corta de un cobro largo para el contador de %V en el ranking, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A se llevó el aura de %V con la calma de un trámite terminado en el sistema del bot, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A ejecutó el golpe a %V. El contador firmó y el chat presenció el cargo en vivo, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V terminó con el resultado que %A había marcado en la lista de la compra, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A robó el aura de %V y dejó el hueco como firma visible en el perfil del ranking, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V: 1-0 en aura, archivo cerrado, siguiente ronda cuando toque en el comando, y el grupo no necesita dibujo para entenderlo, ridículo.'
];

const ROB_FAIL = [
  '%A intentó robarle el aura a %V con la sutileza de un argentino explicando economía: mucho volumen, cero resultado, joder.',
  '%A salió a cazar el aura de %V y volvió con las manos más vacías que nevera de estudiante venezolano un domingo, mierda.',
  'El plan de %A contra %V era tan sólido como un presupuesto griego: se desmontó solo antes de tocar el botín, cabrón.',
  '%A puso la mano donde no debía y %V se la devolvió vacía. Parecía colombiano vendiendo humo en WhatsApp, patético.',
  '%A vs %V terminó 0-1. %A atacó con la precisión de un mexicano dando direcciones: "allá derechito" y se perdió, gilipollas.',
  '%A calculó mal el golpe y %V ni se movió. El chat se rió como cuando un español dice que llega en 5 minutos, asco.',
  '%A falló el atraco a %V como falla un peruano el dúo dinámico: llega tarde, mal y sin el segundo, ridículo.',
  '%V sigue con su aura; %A sigue con la cara de dominicano que juraba que esta vez sí pagaba el viernes, fracasado.',
  'El plan de %A se cayó solo. Ni %V tuvo que defenderse. Nivel: ecuatoriano prometiendo que el envío sale mañana, cutre.',
  '%A entró a por el aura de %V y salió con el ego más vacío que discurso de político cubano en el exilio, joder.',
  'Robo fallido: %A firma el parte, %V bosteza. Parece chileno quejándose del clima mientras le roban el teléfono, mierda.',
  '%A tenía el guion del atraco memorizado. %V tenía la realidad. Como uruguayo debatiendo con la VAR, coño.',
  'El golpe de %A no conectó ni de casualidad. %V intacto, %A explicando como boliviano en aduana con tres pasaportes, cabrón.',
  '%A miró el aura de %V como nicaragüense mira el tipo de cambio: con esperanza y sin poder tocarlo, asco.',
  '%V intacto y aburrido. %A sudando la explicación como salvadoreño en control migratorio, y el grupo no necesita dibujo para entenderlo, fracasado.',
  'El aura de %V no se movió. La de respeto de %A sí, hacia el sótano. Bienvenido al ranking de los almost, joder.',
  'Fallo de manual: %A con la mano tendida al vacío. %V con el aura donde siempre. Robo nivel "te pago mañana", coño.',
  '%V no necesitaba escudo. %A se blindó solo a base de incompetencia pura, como selección que no pasa de grupos, gilipollas.',
  'Atraco fallido: %A sin botín, %V quieto, el grupo con contenido fresco. Gracias por el show gratis, basura.',
  '%A tenía hambre de aura ajena. %V tenía la puerta cerrada. Como restaurante peruano un feriado: cerrado y sin aviso, ridículo.',
  '%A vs %V terminó 0-1 sin que %V sudara. %A sudó la camiseta del almost otra vez, y el grupo no necesita dibujo para entenderlo, cutre.',
  'Robo abortado por falta de talento. Autor %A. Espectador aburrido %V. Créditos al final: nadie, joder.',
  '%A extendió la mano al aura de %V. %V contó hasta tres y no pasó nada. Ni magia, ni milagro, ni botín, mierda.',
  'El aura de %V sigue en su sitio. El prestigio de %A salió a fumar y no contesta el teléfono, y el grupo no necesita dibujo para entenderlo, coño.',
  ...
  '%A salió a cazar aura y cazó una lección: %V no se deja y él no da el nivel mínimo del comando, asco.',
  'El atraco se desinfló solo. %A sopló de más al principio. %V ni gastó saliva en defenderse, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A con cara de ladrón de película de sobremesa. %V con cara de no haber visto nada porque no hubo nada, ridículo.',
  '%A apuntó al aura de %V y le dio al aire del chat. El aire no paga botín ni da propina, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%V sigue rico en aura. %A sigue rico en excusas de por qué esta vez casi. El almost es su residencia fiscal, joder.',
  'El golpe no llegó. El ridículo sí. Autor %A. Objetivo intacto %V. Público: todos los que no parpadearon, mierda.',
  '%V no defendió porque no hizo falta. %A se defendió solo de su propio plan defectuoso, y el grupo no necesita dibujo para entenderlo, patético.',
  'Robo en modo borrador eterno. %A no pasó a limpio. %V sigue en el original sin un tachón, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A puso la trampa al revés y cayó él. %V miró desde la grada sin pagar entrada, y el grupo no necesita dibujo para entenderlo, basura.',
  'Atraco 0. %A 0. %V 1 por el simple hecho de no hacer nada y con eso bastar, y el grupo no necesita dibujo para entenderlo, cutre.',
  'El plan de %A tenía más agujeros que un colador de feria. %V pasó de largo sin mirar, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A sin botín, %V sin drama, el grupo con el veredicto escrito antes del punto final, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A creyó que %V era objetivo fácil de tutorial. %V resultó pared de hormigón. Gana la pared, gilipollas.',
  '%A extendió la mano al aura de %V y solo tocó el vacío de un intento mal medido, y el grupo no necesita dibujo para entenderlo, asco.',
  '%V ni activó defensa. El ataque de %A no merecía el gasto de energía ni de mensaje, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V: el marcador se escribió solo en la columna del fallo. Sin prórroga, y el grupo no necesita dibujo para entenderlo, cutre.',
  'El atraco de %A fue un farol a mesa llena. %V no vio las cartas porque no había juego, y el grupo no necesita dibujo para entenderlo, joder.',
  '%V sigue exactamente igual. %A explica y el grupo ya cambió de tema hace tres mensajes, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A tropezó con la meta antes de llegar. La meta era el aura de %V y sigue clavada ahí, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A tenía hambre de aura contada. %V tenía cerradura y la llave en otro continente, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A no conectó ni por accidente del universo. %V no sudó ni por educación básica, y el grupo no necesita dibujo para entenderlo, basura.',
  'Robo en modo ensayo general eterno. %A no estrena. %V no compró entrada ni pirata, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%V intacto por mérito de estar quieto y por demérito largo y documentado de %A, y el grupo no necesita dibujo para entenderlo, cutre.',
  'El aura de %V no se movió del contador. La cara de %A sí, varios tonos hacia el rojo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó antes del primer paso real. El plan no sobrevivió al contacto con la realidad, gilipollas.',
  '%V no necesitaba suerte ni escudo de tienda. %A trajo su propia derrota bajo el brazo, y el grupo no necesita dibujo para entenderlo, asco.',
  'Fallo de %A: el botín sigue en %V, el meme queda en el chat y el prestigio baja sin freno, y el grupo no necesita dibujo para entenderlo, basura.',
  'El golpe de %A fue un soplo de aire acondicionado. %V ni se molestó en apartar el flequillo, fracasado.',
  '%V sigue en su sitio contando aura. %A sigue buscando la frase mágica que lo arregle, y el grupo no necesita dibujo para entenderlo, joder.',
  ...
  '%A sin el aura de %V y sin la suya de respeto. Doble pérdida en un solo intento torpe, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%V no se defendió porque el ataque de %A no llegó a la fase donde hace falta gastar defensa, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A tropezó con la realidad en el primer escalón del plan. La realidad se llama %V intacto, patético.',
  '%A extendió la mano al aura. %V contó las unidades al final y no faltaba ni media, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V en modo fail previsible de manual. Guion visto mil veces y ejecución todavía peor, fracasado.',
  '%V sigue: el contador de aura no parpadeó ni un frame. %A sí, de nervios y de vergüenza, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A no llegó. %V no se fue. Empate técnico a favor de quien no necesitaba ni jugar, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A salió a por %V y volvió con una anécdota de fallo que nadie en el grupo había pedido, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%V intacto de la primera a la última línea. %A redactando otra vez la crónica del casi, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs el aura de %V: el aura ni se enteró de que había una amenaza nominal en el chat, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A en el intento, el intento en el suelo y el botín donde siempre estuvo: en %V, y el grupo no necesita dibujo para entenderlo, cabrón.',
  ...
  'El plan de %A no sobrevivió al primer contacto visual con %V en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A tenía hambre del aura de %V y se quedó solo con el hambre y el chat entero de testigo, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V terminó con el marcador en blanco total en la columna de quien atacó, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%V no sudó ni de lejos del intento. %A sudó la explicación larga que nadie había pedido, y el grupo no necesita dibujo para entenderlo, basura.',
  '%V sigue con el contador igual de firme. %A con el ego claramente en números rojos del día, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: crónica breve de un fallo que a %A se le hizo eterno en la cabeza, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A vs %V en modo solo frente al espejo del chat. Gana quien no atacó como atacó %A, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  ...
  '%A tropezó con el peaje del fallo antes de oler de cerca el botín que guardaba %V, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A sin el aura de %V. Historia corta de botín y largometraje de ridículo con créditos finales, joder.',
  '%A el plan se le cayó de las manos antes de poder usarlo una sola vez contra %V, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs el aura de %V: 0-1 en el marcador y el 1 no sudó ni pidió cambio de ritmo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V: el guion del comando decía robo y la función acabó siendo sketch de fallos, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%V intacto en el ranking. %A en la cola permanente de los almost del historial del comando, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A sin el aura de %V y sin la cara de haberlo intentado de una forma decente, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V terminó en walkover a favor de quien no necesitó atacar bien ni una sola vez, y el grupo no necesita dibujo para entenderlo, joder.',
  ...
  '%A vs el aura de %V: ni hubo combate real ni hubo duda razonable del resultado final, y el grupo no necesita dibujo para entenderlo, ridículo.',
  'Atraco fallido en limpio. %A firma el parte, %V bosteza y el grupo archiva sin debate, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A no conectó el golpe. El universo no ayudó. %V no necesitaba ayuda para ganar este round, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A puso la trampa, olvidó el sitio exacto y cayó lejos de %V y del botín que soñaba, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vs %V en una sola línea de acta notarial del bot: falló. Punto y cierre, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A extendió la mano al aura. El aura de %V no hizo el trayecto inverso ni de broma ni de error, fracasado.',
  '%V 1, %A 0. Acta cerrada sin prórroga, sin VAR y sin bis de consuelo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: el fallo se escribió solo en el ranking, sin ayuda de guionista ni de narrador, y el grupo no necesita dibujo para entenderlo, patético.',
  ...
  '%A vs %V terminó antes de que %A encontrara siquiera el bolsillo correcto del objetivo, y el grupo no necesita dibujo para entenderlo, patético.',
  ...
  '%A salió a por el botín de %V y volvió con este mensaje como único souvenir del viaje, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el plan se evaporó al primer contacto real con %V en la lista del grupo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V: no hubo robo en el sentido útil de la palabra. Hubo intento y hubo un no rotundo, gilipollas.',
  '%A vs %V terminó 0-1. El 1 es %V por el simple hecho de no moverse mal ni una vez, y el grupo no necesita dibujo para entenderlo, fracasado.',
...
const ROB_DESASTRE = [
  '%A salió a robar y acabó financiando a %V. El karma le pasó factura con intereses de usurero, joder.',
  '%A intentó el atraco y terminó pagando aura de su propio bolsillo a favor de %V. Patrocinador involuntario, mierda.',
  'Desastre total: %A no solo falló, encima le dejó el aura a %V en bandeja de plata. Servicio completo, coño.',
  '%A vs %V terminó con %A más pobre y %V agradeciendo el regalo. Como propina de malo, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A vino a cazar y salió cazado. %V cuenta el botín que al principio no era suyo. Invertido total, gilipollas.',
  'El atraco de %A fue un donativo disfrazado de robo. %V no dijo que no al ingreso. Lógico, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A perdió el robo y el aura en el mismo ticket. %V ganó el día sin sudar el ataque. Eficiente, asco.',
  'Desastre de %A: intentó quitar y terminó poniendo aura en la cuenta de %V. Matemáticas al revés, basura.',
  '%A firmó un cheque al portador a nombre de %V con la tinta de su propio fallo. Cortesía extrema, ridículo.',
  '%A el plan salió tan mal que %V cobró peaje por el simple hecho de haber sido el objetivo, fracasado.',
  '%A vs %V: marcador final a favor de quien debía perder el aura según el guion de %A. Guion roto, cutre.',
  '%A no solo falló el golpe: abrió la cartera y %V dijo gracias en silencio de ranking. Peaje cobrado, joder.',
  'Desastre documentado: %A más ligero, %V más pesado de aura y el chat más contento con el show, mierda.',
  '%A salió a por el botín y volvió sin el suyo. %V sonríe con lo de los dos en el contador. Combo, coño.',
  ...
  '%A puso la mano para quitar y la retiró dejando de más. %V no se queja del error de contabilidad, asco.',
  ...
  '%A perdió el duelo del atraco y el del saldo. %V ni tenía que haber peleado de verdad. Walkover, fracasado.',
  'Desastre de manual: autor %A, beneficiario %V y el grupo testigo de la limosna forzada, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A salió a cazar aura ajena y volvió dejando la propia en el plato de %V. Servicio a domicilio, joder.',
  '%A el fallo no bastaba como castigo: hacía falta el peaje. %V lo cobró entero sin pedir el puesto, mierda.',
  '%A vs %V: el ladrón pagó la cena y la propina del ranking ajeno. Generosidad involuntaria, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A intentó el golpe de la semana y firmó la donación del mes a nombre de %V. Calendario invertido, cabrón.',
  '%A sin el botín de %V y sin el suyo. %V con ambos sonidos de caja en el contador. Feliz, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A el plan era quitar. El resultado fue dar. %V aplaude en silencio de ranking. Lógico, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V terminó con el ranking más justo de lo que %A quería ver en pantalla. Justicia poética, ridículo.',
  '%A falló tan fuerte que el eco le cobró aura a favor de %V en el sistema del bot, y el grupo no necesita dibujo para entenderlo, fracasado.',
  'Desastre: %A más pobre por intentar ser más rico a costa de %V y salir escaldado del intento, cutre.',
  '%A vs %V: crónica de un donativo anunciado como robo en el comando. Publicidad engañosa, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A salió a vaciar a %V y terminó vaciándose él. El chat tomó nota del peaje con gusto, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A el karma contó el intento y pasó factura con el aura de %A hacia %V. Contabilidad divina, gilipollas.',
  'Desastre de %A: no hay premio de consolación, hay peaje cobrado en el ranking a favor de %V, patético.',
  '%A intentó el atraco y %V terminó cobrando el servicio de haber sido el objetivo del comando, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A vs %V en modo desastre: gana quien debía perder según el guion original de %A. Guion en llamas, basura.',
  '%A puso la trampa y pagó la fianza. %V recogió ambas cosas en el contador. Servicio completo, ridículo.',
  '%A sin gloria en el parte y con el saldo peor. %V con el día hecho en el ranking sin atacar, fracasado.',
  'Desastre total: el aura de %A emigró hacia %V sin pedir asilo ni contrato de robo exitoso, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A el golpe salió por la culata y la culata cobraba en unidades de aura a favor de %V, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V terminó con transfer automático por incompetencia documentada de %A, y el grupo no necesita dibujo para entenderlo, mierda.',
  ...
  '%A intentó quitar y el sistema sumó en la columna de %V. Matemáticas del desastre puro, y el grupo no necesita dibujo para entenderlo, patético.',
  ...
  'Desastre: %A en modo patrocinador involuntario de %V en el contador del grupo, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A vs %V terminó con el contador de %A en menos y el de %V en más sin debate posible, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A salió a por todo y volvió con menos de lo que tenía. %V agradece el ingreso inesperado, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Desastre de %A: el botín viajó hacia %V con remitente el fallo del intento de %A, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A intentó el golpe y terminó de cajero automático a favor de %V en el ranking del grupo, gilipollas.',
  '%A vs %V en una línea de acta: %A pagó. Punto y cierre del desastre del comando, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el atraco fue un transfer con pasos extra innecesarios y resultado invertido a favor de %V, asco.',
  '%A sin el aura de %V y sin la suya completa. %V con el combo ganado sin atacar de verdad, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A puso el robo en el horno y se coció él. %V se comió el plato del ranking sin pedir menú, fracasado.',
  '%A el karma no negocia el peaje del fail. %V cobra en silencio de contador y sonríe, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V terminó con el peaje más caro del día para la cuenta de %A en el ranking, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A salió a vaciar bolsillos ajenos y terminó vaciando el suyo. %V testigo y cajero del peaje, mierda.',
  '%A el fallo con recargo: el recargo en aura a nombre de %V en el sistema del bot, y el grupo no necesita dibujo para entenderlo, coño.',
  'Desastre: %A más ligero, %V más contento y el chat más entretenido con el peaje cobrado, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A intentó el atraco de oro y firmó la donación de bronce oxidado a %V. Cambio de metal, gilipollas.',
  '%A vs %V: crónica breve de un transfer largo y doloroso para %A en el ranking, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el bumerán del robo le volvió con intereses de demora cobrados en aura a favor de %V, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A sin gloria en el parte y con el saldo empeorado. %V sin haber atacado de verdad en el comando, basura.',
  'Desastre de manual con factura visible: autor %A, beneficiario %V en el contador, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V terminó con el ranking corrigiendo a %A a la baja y a %V al alza sin debate, y el grupo no necesita dibujo para entenderlo, cutre.',
  'Desastre: %A en rojo, %V en verde y el intento en el museo de fails del chat del grupo, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A puso la mano para sacar y el sistema registró un ingreso a favor de %V. Contabilidad del karma, cabrón.',
  '%A vs %V en modo donación involuntaria con público de pie en el hilo del grupo, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A firmó la factura del intento: beneficiario claro %V en el contador del ranking, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V terminó con el ranking haciendo justicia poética a costa de %A en el comando, y el grupo no necesita dibujo para entenderlo, fracasado.',
  '%A salió a cazar y volvió como trofeo de %V en el chat y en el número del ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  'Desastre documentado: el aura de %A emigró con destino fijo a la cuenta de %V sin billete de vuelta, mierda.',
  '%A vs %V: una línea de acta del bot — %A pagó el peaje del intento fallido, y el grupo no necesita dibujo para entenderlo, cabrón.',
  ...
  '%A puso el robo en marcha y la marcha era atrás. %V recibió igual el ingreso del peaje, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A vs %V en una frase: el intento costó aura a quien lo empezó en el comando, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el fail con intereses de demora: los intereses se llaman %V en el contador del ranking, fracasado.',
  '%A sin el plan original y con el cargo original. %V con el aura del peaje cobrado, y el grupo no necesita dibujo para entenderlo, cutre.',
  'Desastre: %A más pobre por la ambición mal ejecutada contra %V en el ranking, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A intentó el golpe y el golpe le hizo de cajero a favor de %V en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A vs %V terminó con transfer y sin una sola línea de gloria para %A en el parte, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A el bumerán volvió cobrando y no aceptó devolución del peaje en aura a favor de %V, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A perdió el duelo del atraco y el del contador. %V sin ponerse los guantes del comando, gilipollas.',
  '%A vs %V: ranking a la baja para %A, al alza para %V, sin debate útil en el hilo, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A el peaje del fail se cobró solo. %V fue el cajero que no pidió el puesto del ranking, y el grupo no necesita dibujo para entenderlo, fracasado.',
  'Desastre documentado a favor de %V con autor intelectual %A en negrita del parte, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A intentó el atraco y terminó de mecenas involuntario de %V en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V en modo desastre limpio: sin duda del resultado ni del peaje cobrado, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A el aura viajó al revés. El chat viajó a la risa del peaje cobrado a favor de %V, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A sin gloria y con el saldo en menos. %V sin haber pedido nada del regalo del peaje, y el grupo no necesita dibujo para entenderlo, cabrón.',
  'Desastre total: %A financió a %V con el intento mismo de robarle el aura del ranking, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V terminó con %A de patrocinador y %V de marca beneficiada del peaje, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A perdió lo que quería ganar y lo que ya tenía. %V solo miró el ingreso del peaje, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A el universo no negocia el peaje del fail. %V cobra en silencio de contador del ranking, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A vs %V: crónica de un donativo con coreografía fallida de atraco del comando, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A salió a vaciar a %V y terminó en la cola del cajero al revés del ranking, y el grupo no necesita dibujo para entenderlo, mierda.',
  '%A el fallo con recargo automático: recargo a nombre de %V en el sistema del bot, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A intentó el golpe de oro y firmó el cargo de plomo a favor de %V en el ranking, y el grupo no necesita dibujo para entenderlo, gilipollas.',
  '%A vs %V terminó con el contador de %A en dirección incorrecta del todo en el ranking, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A el bumerán del robo le cobró el viaje de ida y vuelta en aura a favor de %V, y el grupo no necesita dibujo para entenderlo, asco.',
  '%A sin botín propio ni ajeno. %V con el combo ganado sin atacar de verdad en el comando, y el grupo no necesita dibujo para entenderlo, basura.',
  'Desastre total documentado: %A deudor, %V acreedor y el grupo testigo del peaje, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A vs %V: el ladrón pagó la cena de los dos y la propina del ranking ajeno, y el grupo no necesita dibujo para entenderlo, cutre.',
  '%A salió a por el aura de %V y regaló la ruta de la suya hacia el otro contador, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A el karma cobró al contado. %V no rechazó el ingreso en el ranking del grupo, y el grupo no necesita dibujo para entenderlo, mierda.',
  'Desastre: %A en rojo por ambición y %V en verde por existir como objetivo del comando, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A firmó la factura del intento con beneficiario %V en el contador del ranking, y el grupo no necesita dibujo para entenderlo, ridículo.',
  '%A intentó quitar y el universo usó la función sumar en la cuenta de %V del ranking, y el grupo no necesita dibujo para entenderlo, coño.',
  '%A vs %V: una línea de acta — %A pagó el peaje del intento fallido del comando, y el grupo no necesita dibujo para entenderlo, cabrón.',
  '%A sin aura nueva y sin la vieja completa. %V con el día resuelto en el ranking, y el grupo no necesita dibujo para entenderlo, patético.',
  '%A puso el robo en marcha atrás sin querer. %V recibió el ingreso igual del peaje, y el grupo no necesita dibujo para entenderlo, basura.',
  '%A el fail con intereses: los intereses se llaman %V en el contador del ranking del grupo, fracasado.',
  'Desastre: %A más pobre por querer ser más rico a costa de %V y salir escaldado, y el grupo no necesita dibujo para entenderlo, joder.',
  '%A vs %V: ranking a la baja para %A y al alza para %V, sin debate posible en el hilo, y el grupo no necesita dibujo para entenderlo, basura.'
];
