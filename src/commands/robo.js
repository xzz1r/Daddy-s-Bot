...
const ROB_MAESTRO = [
  '%A le vació el aura a %V con la precisión de un puto cirujano del ranking, joder.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el contador del chat, mierda.',
  ...
  'Robo de manual negro: %A cobra, %V llora, el ranking firma sin debate, patético.',
  ...
  '%A se llevó todo. %V se quedó con el hueco y este mensaje de recibo, fracasado.',
  '%A vació a %V en público sin dejar almost ni consuelo en el ranking, joder.',
  ...
  '%A vs %V: el ladrón ganó el único round que importaba en el comando, gilipollas.',
  '%A dejó a %V mirando el contador en cero sin anestesia del ranking, patético.',
  ...
  '%A vació el aura de %V y el ranking no ofreció recurso de apelación, fracasado.',
  '%A le limpió el contador a %V en un solo movimiento limpio del ranking, joder.',
  ...
  'Robo maestro limpio. El ranking actualiza a favor de %A sin debate, gilipollas.',
  '%A entró, vació y salió. %V se enteró por el contador del ranking, patético.',
  'Maestro documentado sin filtro delante del puto grupo del chat, asco.',
  ...
  '%A se llevó el aura de %V entera. El hueco es este mensaje de recibo, fracasado.',
  '%A vació a %V con la calma de quien ya había contado el botín, joder.',
  ...
  'Robo total limpio. %A ejecuta, %V firma el vacío delante del chat, gilipollas.',
  '%A entró como profesional y salió con el aura completa de %V, patético.',
  ...
  '%A le dejó el contador a cero a %V delante de todos en el hilo, joder.',
  ...
  'Robo maestro. El ranking de %V a cero en un golpe limpio, gilipollas.',
  '%A entró, tomó todo y cerró. %V abrió el hueco del contador, patético.',
  ...
  '%A se llevó todo el aura de %V y el ranking lo selló sin recurso, fracasado.',
  '%A ejecutó el empty total de %V sin sudar el golpe del ranking, joder.',
  ...
  'Robo total. %A con el botín, %V con el vacío, el chat de testigo, gilipollas.',
  '%A entró en silencio y salió con el contador de %V a cero, patético.',
  ...
  '%A se llevó el aura de %V al completo. Recibo: este mensaje del bot, fracasado.',
  '%A vació el ranking de %V en un movimiento de cirujano del comando, joder.',
  ...
  'Robo maestro. %V mira el cero y no hay segunda lectura útil, gilipollas.',
  '%A entró, vació y el parte se cerró solo a su favor en el ranking, patético.',
  'Maestro documentado sin anestesia para %V delante del grupo, asco.',
  ...
  '%A se llevó todo. %V se quedó sin aura y sin discurso útil, fracasado.',
  '%A le limpió el aura a %V como quien cobra al contado en el ranking, joder.',
  ...
  'Robo total limpio. El ranking actualiza y %V calla en el hilo, gilipollas.',
  '%A entró de profesional y salió con el empty de %V del contador, patético.',
  ...
  '%A se llevó el 100 % del aura. %V el 100 % del fail del comando, fracasado.',
  '%A ejecutó el empty de %V delante del puto grupo del ranking, joder.',
  ...
  'Robo maestro. El contador de %V a cero sin prórroga ni consuelo, gilipollas.',
  '%A entró, tomó el total y cerró el parte a favor en el ranking, patético.',
  ...
  '%A se llevó el aura entera de %V y el ranking lo selló sin recurso, fracasado.',
  '%A le dejó a %V el contador en cero y este mensaje de recibo del bot, joder.',
  ...
  'Robo total. %A ejecuta, %V firma el vacío, el chat mira el ranking, gilipollas.',
  '%A entró en silencio y salió con todo el aura de %V del contador, patético.',
  ...
  '%A se llevó el 100 %. Recibo colgado en este hilo del puto grupo, fracasado.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió igual delante del puto grupo, joder.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas del ranking, mierda.',
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual y el chat lo ve, cabrón.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias en público, coño.',
  '%A no se llevó todo, pero se llevó lo suficiente para que se note en el contador, gilipollas.',
  'Robo a medias: %A sonríe y %V cuenta lo que falta en el ranking del grupo, patético.',
  ...
  '%A se llevó una parte. %V se llevó el almost de haber defendido algo, fracasado.',
  '%A mordió el aura de %V sin vaciarla. El dolor es el mismo en el ranking, joder.',
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias delante de todos, mierda.',
  ...
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail, gilipollas.',
  '%A se llevó lo justo para que %V lo note el resto de la sesión del chat, patético.',
  ...
  '%A no vació a %V: lo dejó cojeando de aura en el ranking del comando, fracasado.',
  '%A le quitó un trozo del aura a %V y el ranking lo registró igual de claro, joder.',
  'Parcial: no es el golpe perfecto, pero %V sangra aura de verdad en el chat, mierda.',
  ...
  '%A no se fue de vacío. %V tampoco se fue intacto del atraco parcial, patético.',
  ...
  'Robo a medias. Autor %A, hueco en %V, archivo el grupo entero, fracasado.',
  '%A picó el aura de %V sin rematar. Suficiente para el ranking del comando, joder.',
  'Parcial de puta madre: no vacío, pero el dolor es real para %V en el chat, mierda.',
  ...
  'Robo parcial. El almost de %V es haber perdido solo una parte, gilipollas.',
  '%A entró a medias y salió con botín real. %V con el hueco a medias, patético.',
  'Parcial documentado sin anestesia en el ranking del puto grupo, asco.',
  ...
  '%A se llevó lo suficiente. El ranking de %V firma el parcial sin debate, fracasado.',
  '%A le arrancó un trozo del aura a %V delante de todos en el hilo, joder.',
  ...
  'Robo parcial. %A con tajada, %V con lección, el chat con gag, gilipollas.',
  '%A no vació el tanque: lo dejó en reserva baja de aura en el ranking, patético.',
  ...
  'Robo a medias firmado. Autor %A, archivo el puto grupo del chat, fracasado.',
  '%A picó sin rematar y el ranking de %V bajó igual de claro, joder.',
  ...
  'Robo parcial limpio. El contador habla y %V calla en el hilo, gilipollas.',
  '%A entró, tomó y salió. %V se quedó con menos y con el gag, patético.',
  ...
  '%A se llevó una porción del aura de %V sin pedir permiso al chat, fracasado.',
  '%A le sacó aura a %V sin vaciar la cuenta. El ranking igual de claro, joder.',
  ...
  'Robo parcial. No es el empty total y aun así duele en el contador, gilipollas.',
  '%A no se fue de vacío. El almost de %V es haber perdido poco, patético.',
  ...
  'Robo a medias. Firmado por el bot delante del puto grupo, fracasado.',
  '%A picó el aura de %V y el ranking registró el parcial sin debate, joder.',
  ...
  'Robo parcial limpio. %A con tajada, %V con el gag del chat, gilipollas.',
  '%A entró a medias y el efecto fue total en el ego de %V, patético.',
  ...
  '%A se llevó una parte del aura de %V y el chat lo archivó, fracasado.',
  '%A le quitó aura a %V sin el empty total. Suficiente para el ranking, joder.',
  ...
  'Robo parcial. El contador de %V baja y el gag del chat sube, gilipollas.',
  '%A no fue cirujano ni fail: fue el medio que duele en el ranking, patético.',
  ...
  'Robo a medias firmado sin anestesia en el puto grupo del ranking, fracasado.',
  '%A picó sin rematar y el ranking de %V sangró igual de claro, joder.',
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana el gag, mierda.',
  '%A vs %V terminó a medias en botín y entero en fail de %V, cabrón.',
  '%A cobró lo que pudo sacar. %V notó cada unidad del contador, coño.',
  'Robo parcial limpio. El bot firma y %V calla en el hilo del grupo, gilipollas.',
  '%A entró, tomó tajada y salió. %V con el hueco a medias del ranking, patético.',
  'Parcial documentado delante de todos sin narrador ni subtítulos, asco.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja del contador, basura.',
  '%A vs %V: el medio atraco con firma completa en el ranking del chat, ridículo.',
  '%A se llevó una porción y dejó a %V con la lección a medias, fracasado.'
];
