...
const ROB_WIN = [
  ...
  'Robo limpio de %A a %V: el aura cambió de dueño y el ranking lo registró sin debate posible, coño. en el segundo más incómodo del chat.',
  '%A vs %V: gana el que atacó. %V se defendió como se defiende de todo en la vida: mal, cabrón. sin consuelo de consola.',
  ...
  '%A no pidió permiso a nadie: se llevó el aura de %V y dejó el recibo en este mensaje, asco. sin que nadie pida replay.',
  'Robo a favor de %A: %V pierde aura y la cara a la vez delante de todo el grupo, basura. en el momento que más dolía soltarlo.',
  '%A ejecutó el golpe a %V con la calma de quien ya había contado el botín antes de empezar, ridículo.',
  '%A vs %V terminó con el contador de %A en más y el de %V en menos, sin discusión, fracasado. en el segundo más incómodo del chat.',
  '%A le quitó el aura a %V delante de todos; no hubo modo avión que ocultara el cargo, cutre. con el cargo en firme.',
  'El plan de %A funcionó de punta a punta; el aura de %V no. Resultado firmado en el ranking, joder. y el grupo ya pasó de página.',
  '%A salió a cazar y volvió con el trofeo: el trofeo se llama aura de %V y pesa en el contador, mierda.',
  'Robo limpio y legible: %A cobra, %V paga y el grupo presencia el transfer sin filtro, coño. con el dígito firmando solo.',
  ...
  '%A se llevó el aura de %V con la precisión de quien no falla el momento ni el objetivo, patético. y el chat archiva sin debate.',
  'Atraco exitoso al natural: %A sonríe con el botín y %V cuenta lo que ya no tiene, asco. sin filtro de autoayuda.',
  '%A entró, cobró el aura de %V y salió antes de que el drama de %V creciera de más, basura. sin prórroga ni VAR.',
  '%A el golpe a %V conectó donde tenía que conectar: el contador actualiza sin pedir confirmación, ridículo.',
  '%A le robó a %V en el timing perfecto: ni antes ni después, ahora, y se nota, fracasado. sin prórroga ni VAR.',
  'Robo a cara descubierta: %A no se escondió y %V no se salvó del cargo en el ranking, cutre. sin consuelo de consola.',
  '%A vs %V terminó con el botín en el bolsillo correcto del sistema: el de %A, joder. en el único idioma que entiende el contador.',
  '%A dejó a %V mirando el hueco del contador donde antes había aura contada, mierda. y el ranking cierra el caso.',
  '%A ejecutó el atraco a %V sin pedir aplauso; el contador aplaude por él en números, coño. y el chat archiva sin debate.',
  'El aura de %V cambió de manos en público: las manos son las de %A y el ranking lo firma a favor del resultado, cabrón.',
  '%A no solo intentó el golpe: cobró. %V no solo se defendió: perdió, gilipollas. sin derecho a matiz útil.',
  '%A vs %V: crónica breve de un robo que sí se ejecutó y se puede leer en el ranking, patético. sin barniz de relato heroico.',
  '%A se llevó lo suyo de la cuenta de %V: definición operativa de atraco exitoso, asco. sin prosa que lo maquille.',
  '%A cazó el aura de %V cuando %V menos lo tenía en la agenda del día, ridículo. delante del ranking y de la cara.',
  '%A el botín de %V ya no es de %V; el ranking no discute el cargo ni ofrece recurso, fracasado. sin consuelo de consola.',
  '%A vs %V terminó 1-0 con el 1 en la columna del que atacó bien y cobró, cutre. y el grupo ya pasó de página.',
  '%A le dejó a %V el recibo del robo en forma de mensaje de este comando, mierda. con el chat enterado del cargo.',
  'Atraco redondo: %A cobra, %V aprende la lección y el chat archiva el resultado, coño. sin anestesia de verdad esta vez.',
  '%A no falló el timing ni la puntería del golpe; %V falló la defensa del ranking, cabrón y no hay modo de suavizarlo.',
  '%A vs %V: el aura viajó en la dirección que %A había marcado en la lista a favor del resultado, gilipollas.',
  '%A se llevó el botín de %V sin pedir la palabra en el grupo ni devolver una unidad, patético. y el hilo no pide amplificación.',
  'Robo exitoso de %A a costa de %V: visible, medible y archivado en el ranking, asco. y el grupo ya pasó de página.',
  '%A ejecutó el golpe con la lista de la compra cerrada: aura de %V, marcada y cobrada, basura. delante de todo el que miraba.',
  '%A el contador de %V bajó; el de %A subió: aritmética del atraco sin poesía, ridículo. y el chat archiva sin debate.',
  '%A vs %V terminó con %A contando botín y %V restando aura en silencio, fracasado. con la cara del resultado a la vista.',
  '%A no dejó el atraco en almost eterno: lo cerró con botín de %V en su cuenta, cutre. con el botín o el fail a la vista.',
  '%A se llevó el aura de %V en el momento exacto en que el chat miraba el hilo, joder. con el fallo en 4K de chat.',
  '%A vs %V: gana quien no se quedó mirando el aura propia mientras se la llevaban, coño. sin que nadie pida replay.',
  '%A cobró de %V lo que %V no pensaba soltar; el ranking insiste en el cargo, cabrón. sin descuento por empatía.',
  '%A el golpe a %V fue corto, claro y suficiente para mover el contador a favor del resultado, gilipollas.',
  '%A entró, tomó el aura de %V y dejó el hueco de recuerdo en el perfil, patético. y el sistema cierra sin discusión.',
  '%A vs %V terminó con el botín en movimiento y destino claro: la cuenta de %A, asco. y el sistema cierra sin discusión.',
  '%A no pidió suerte de principiante: ejecutó. %V no tuvo defensa suficiente, basura. con el fail todavía caliente.',
  'Atraco a favor de %A: %V en el parte como quien pierde aura en público, ridículo. sin recurso ni nota al pie.',
  '%A se llevó lo marcado de la cuenta de %V sin letra pequeña ni segunda oportunidad, fracasado. sin descuento por empatía.',
  '%A el plan contra %V salió como en la pizarra: aura de %V en su columna del ranking, cutre. y el ranking lo deja por escrito.',
  '%A vs %V: el ladrón no solo intentó, cobró y se fue con el botín, joder. con el eco del almost todavía sonando.',
  '%A robó el aura de %V con la calma de un trámite ya resuelto en el sistema, mierda y no hay DLC que lo parchee.',
  'Robo exitoso: %A con el botín, %V con la lección y el grupo con el dato del ranking, coño. en el recuento que no perdona.',
  '%A no dejó espacio al drama largo de %V: primero el golpe, luego este mensaje a favor del resultado, cabrón.',
  '%A vs %V terminó 1-0 en el único marcador que importa aquí: el del aura, gilipollas. y el sistema no regala puntos.',
  '%A cazó a %V en el ranking y el contador firmó el resultado sin pedir segunda opinión, patético. con el eco todavía en el grupo.',
  '%A el aura de %V viajó sin billete de vuelta ni posibilidad de reembolso, asco. sin letra pequeña que lo salve.',
  '%A ejecutó el atraco a %V como quien cobra una deuda pendiente con intereses, basura. sin cuento que lo tape.',
  '%A vs %V: crónica de un golpe que sí aterrizó en el contador y se puede leer, fracasado. delante de quien no quería verlo.',
  '%A se llevó el botín de %V y el chat no pidió repetición: se vio claro a la primera, cutre y basta el dato del ranking.',
  '%A el contador no miente en este caso: %V menos, %A más,, joder. con el parte firmado debajo sin segunda oportunidad hoy.',
  '%A entró a por el aura de %V y no salió de vacío ni de almost, mierda. sin bis ni matiz de consuelo y el chat archiva sin debate.',
  '%A vs %V terminó con el ranking actualizado a favor del atacante sin debate útil, coño. sin consuelo de manual barato.',
  '%A cobró el aura de %V en el timing que %V no esperaba ni había agendado a favor del resultado, cabrón.',
  'Atraco redondo: %A no falló, %V no se salvó y el grupo no dudó del resultado, gilipollas. delante del ranking y de la cara.',
  '%A se llevó lo suyo del bolsillo de %V: definición corta y operativa del atraco, patético. con el chat enterado del cargo.',
  '%A el golpe fue suficiente: el aura de %V lo nota y el ranking también lo muestra, asco. sin descuento por empatía.',
  '%A vs %V: gana %A. El resto es ruido de la defensa que no llegó a tiempo, basura. en el recuento que no perdona.',
  '%A robó a %V sin pedir la palabra en el hilo y sin devolver una sola unidad de aura, ridículo. sin bis ni matiz de consuelo.',
  'Robo exitoso de %A: el botín de %V cambió de manos en público y queda firmado, fracasado. en el momento que más dolía soltarlo.',
  '%A ejecutó, cobró y dejó a %V con el hueco del contador y este mensaje de recibo, cutre. sin que nadie pida replay.',
  '%A vs %V terminó con el transfer en la dirección correcta para %A y visible para todos, joder. sin que nadie pida replay.',
  '%A no improvisó el final del atraco: el aura de %V ya estaba contada a su favor, mierda. con el cargo en firme.',
  '%A el atraco a %V salió limpio de fallos y lleno de botín ajeno en el contador a favor del resultado, coño.',
  '%A se llevó el aura de %V mientras el chat tomaba nota del movimiento en el ranking, cabrón. sin consuelo de manual barato.',
  'Robo limpio: %A cobra en silencio de víctima y %V en ruido de queja que no cambia el número, gilipollas.',
  '%A vs %V: el marcador final del aura no admite debate ni recurso de apelación, patético. con el saldo a la intemperie.',
  '%A entró a por %V y salió con el contador a favor y el parte cerrado, asco. y el ranking no pide permiso.',
  '%A vs %V terminó con %A en más y %V en el parte de bajas de aura del día, ridículo. sin letra pequeña que lo salve.',
  '%A robó el aura de %V con la precisión de quien no necesita segunda oportunidad, fracasado. con el cargo en firme.',
  '%A se llevó el botín de %V sin pedir disculpas al contador ni permiso al grupo, joder. sin suavizar el golpe del número.',
  '%A el plan contra %V funcionó de principio a fin del intento de atraco, mierda. con testigos obligados en el hilo.',
  '%A vs %V: crónica corta de un robo largo para el contador de %V, coño. en el único marcador que importa aquí.',
  '%A cobró de %V lo marcado en la lista; el ranking confirma el cargo sin dudar a favor del resultado, cabrón.',
  'Robo exitoso: %A con aura nueva en la cuenta y %V con el hueco documentado, gilipollas. sin apelación posible hoy.',
  '%A ejecutó el atraco a %V en el momento en que más dolía soltar el aura, patético y no hay DLC que lo parchee.',
  '%A vs %V terminó 1-0 sin prórroga: el 1 es de %A y el 0 de la defensa, asco. delante del público que no pidió entrada.',
  '%A se llevó el aura de %V y dejó el recibo colgado en este hilo del chat, basura. en el recuento que no perdona.',
  '%A el botín de %V ya tiene dueño nuevo; el ranking lo nombra sin pedir confirmación, ridículo. y el contador no discute.',
  '%A vs %V: gana quien atacó con el contador a favor y cerró el parte, fracasado. con la cara del resultado a la vista.',
  '%A robó a %V en plena luz del chat: sin sombra útil que tape el cargo del ranking, cutre y no hay modo de suavizarlo.',
  'Robo limpio de %A a costa de %V: medible, visible y archivado en el historial, joder. y el sistema marca el punto final.',
  '%A entró, cobró el aura de %V y salió con el trabajo del atraco hecho, mierda y no hace falta ampliar el parte.',
  '%A el golpe fue corto en segundos y largo en efecto sobre el contador de %V a favor del resultado, coño.',
  '%A vs %V terminó con el transfer firmado a favor de %A en el sistema, cabrón. y el sistema cierra sin discusión.',
  '%A no dejó el atraco a medias: cerró con el aura de %V en su cuenta del ranking, gilipollas. sin anestesia de verdad esta vez.',
  '%A se llevó lo que %V no pensaba soltar; el ranking insiste en el cargo sin piedad, patético. con el saldo a la intemperie.',
  'Atraco redondo: %A ejecuta, %V paga y el grupo presencia el cambio de dueño, asco. sin que nadie pida replay.',
  '%A cobró el aura de %V con la calma de un trámite ya cerrado en el sistema, ridículo. y el ranking lo deja por escrito.',
  '%A el contador de %V bajó en público; no hay modo avión que oculte el número, fracasado. y el hilo no pide amplificación.',
  '%A vs %V terminó con %A contando botín y %V contando pérdidas en silencio, cutre. con el peaje cobrado al natural.',
  '%A robó a %V sin pedir la palabra y sin devolver ni una unidad del botín, joder. con el cargo en firme.',
  'Robo exitoso de %A: el aura de %V cambió de manos sin letra pequeña ni recurso, mierda. con el botín o el fail a la vista.',
  '%A ejecutó el golpe a %V como quien marca una casilla pendiente del ranking a favor del resultado, coño.',
  '%A vs %V: crónica de un atraco que no se quedó en intento ni en almost, cabrón. con el eco todavía en el grupo.',
  '%A se llevó el botín de %V delante de quienes miraban el ranking en ese momento, gilipollas. con el eco todavía en el grupo.',
  '%A el plan salió; el aura de %V no se salvó del cargo en el contador, patético. y el ranking lo deja por escrito.',
  '%A vs %V terminó 1-0 en aura: el resto del mensaje es comentario, asco. y el chat archiva sin debate.',
  '%A entró a por el aura de %V y cumplió el objetivo del comando en el ranking, basura. con el botín o el fail a la vista.',
  '%A cobró de %V en el timing que no perdona ni avisa dos veces, ridículo. con el grupo de testigo silencioso.',
  'Robo limpio: %A con el botín, %V con el hueco y el chat con el dato del transfer, fracasado. sin recurso ni nota al pie.',
  '%A vs %V: gana %A por ejecución y pierde %V por defensa insuficiente, cutre. delante del ranking y de la cara.',
  '%A se llevó el aura de %V y el recibo quedó colgado en este hilo, joder. con el grupo de testigo silencioso.',
  '%A el golpe a %V aterrizó; el ranking no pide segunda opinión ni VAR a favor del resultado, mierda en la foto fija del ranking.',
  '%A vs %V terminó con el transfer en dirección %A y visible para todo el grupo, coño. con el grupo de testigo silencioso.',
  '%A robó a %V en el momento exacto: ni un segundo antes ni uno después, cabrón. con el fail todavía caliente.',
  'Atraco a favor de %A: %V en el parte de pérdidas y el aura en otra cuenta, gilipollas. sin maquillaje ni segunda toma.',
  '%A ejecutó, cobró y dejó a %V con la cara del contador en menos, patético. en el recuento que no perdona.',
  '%A vs %V: el botín se movió y el debate útil no hace falta en el chat, asco en alta resolución de group chat.',
  '%A se llevó lo marcado del aura de %V sin pedir confirmación al sistema, basura. y el ranking lo deja por escrito.',
  '%A el atraco a %V fue limpio de fallos y sucio de botín ajeno en el contador, ridículo. sin segunda oportunidad hoy.',
  '%A vs %V terminó con %A en verde y %V en el hueco del ranking, fracasado. con el saldo a la intemperie.',
  '%A robó el aura de %V con público y sin remordimiento de contador, cutre. con la cara del resultado a la vista.',
  '%A entró a por %V y salió con el objetivo cumplido en números del sistema a favor del resultado, mierda.',
  '%A el golpe fue suficiente para que %V lo note el resto de la sesión del chat, coño. en el recuento que no perdona.',
  '%A vs %V: 1-0 sin VAR, sin prórroga y con botín a nombre de %A, cabrón. y el sistema marca el punto final.',
  '%A cobró el aura de %V y el chat archivó el resultado sin pedir amplificación, gilipollas. sin barniz de relato heroico.',
  '%A se llevó el botín de %V en el timing del que no avisa ni pide permiso, patético. sin cuento que lo tape.',
  '%A vs %V terminó con el ranking a favor del que atacó bien y cobró, asco. con el número en la frente del mensaje.',
  '%A ejecutó el atraco a %V como un cobro pendiente saldado en el sistema, basura. con el grupo de testigo silencioso.',
  'Robo limpio de %A: el aura de %V viajó sin billete de retorno ni reembolso, ridículo. con el botín o el fail a la vista.',
  '%A vs %V: crónica corta y botín largo para la cuenta de %A, fracasado. con el saldo a la intemperie sin maquillaje ni segunda toma.',
  '%A se llevó el aura de %V mientras %V todavía contaba la unidad anterior, cutre. sin consuelo de manual barato.',
  '%A el contador no miente en este parte: %A más, %V menos, punto a favor del resultado, joder. y el sistema no regala puntos.',
  '%A vs %V terminó con el transfer visible y el debate inútil en el hilo, mierda. sin suavizar el golpe del número.',
  '%A robó a %V sin sombra que oculte el cargo: luz de chat completa, coño. con el dígito como única defensa.',
  'Atraco redondo a favor de %A: cobra el aura de %V en un solo movimiento limpio, cabrón. sin prórroga ni VAR.',
  '%A ejecutó el golpe a %V y el ranking firmó debajo sin pedir aclaración, gilipollas en la foto fija del ranking.',
  '%A vs %V: gana quien no se quedó con las manos vacías al final del round, patético. con el grupo de testigo silencioso.',
  '%A se llevó el botín de %V y dejó el mensaje como único recibo del cargo, asco. con el peaje cobrado al natural.',
  '%A el plan contra %V funcionó: el aura cambió de dueño en el contador, basura. con el veredicto seco del bot.',
  '%A vs %V terminó 1-0 en el marcador del aura y el archivo quedó cerrado, ridículo. con el peaje cobrado al natural.',
  '%A cobró de %V lo que el ranking ahora muestra a su favor sin filtro, fracasado. delante del hueco que quedó.',
  'Robo exitoso de %A a costa de %V: sin asterisco que lo relativice a favor del resultado, cutre. y el hilo sigue sin ti en el centro.',
  '%A entró a por el aura de %V y no aceptó un no del contador como respuesta, joder. y el ranking lo deja por escrito.',
  '%A el golpe a %V fue corto en el reloj y largo en el efecto del ranking, mierda. y el hilo sigue sin ti en el centro.',
  '%A vs %V terminó con %A en el lado correcto del transfer de aura, coño en la foto fija del ranking sin cuento que lo tape.',
  '%A robó el aura de %V en plena sesión de chat: sin pausa ni aviso previo, cabrón. sin consuelo de consola.',
  '%A vs %V: el ladrón cerró el parte antes de que la víctima terminara de quejarse, patético. con el dígito firmando solo.',
  '%A ejecutó el atraco a %V con lista cerrada: botín marcado y botín cobrado, asco. sin descuento por empatía.',
  'Robo limpio: %A con aura de %V, %V con el hueco y el grupo con la foto del ranking, basura. delante de todo el que miraba.',
  '%A vs %V terminó con el contador actualizado y el debate cerrado por los números, ridículo. con el parte firmado debajo.',
  '%A se llevó el aura de %V cuando más se notaba soltarla en el ranking, fracasado. con el resultado ya consumado.',
  '%A el botín de %V cambió de manos: las manos de %A no tiemblan en el contador a favor del resultado, cutre.',
  '%A vs %V: 1-0 a favor de quien no falló el golpe del atraco, joder. y el archivo queda cerrado sin suavizar el golpe del número.',
  '%A cobró el aura de %V y dejó el hueco como recuerdo visible en el perfil, mierda y no hay modo de suavizarlo.',
  '%A ejecutó, %V pagó y el chat presenció: robo completo sin asteriscos, cabrón. con el eco todavía en el grupo.',
  '%A vs %V terminó con el transfer en firme a nombre de %A en el sistema, gilipollas. con el dígito como única defensa.',
  '%A robó a %V sin pedir turno de palabra en el grupo ni devolver el botín, patético. con testigos obligados en el hilo.',
  '%A el golpe a %V aterrizó en el aura: el resto del mensaje es ruido de fondo, asco. con el veredicto seco del bot.',
  '%A vs %V: crónica de un atraco con final de botín a favor de %A, basura. y el contador insiste sin apelación posible hoy.',
  '%A se llevó el aura de %V en el momento que el ranking no perdona ni suaviza, ridículo. sin apelación posible hoy.',
  'Robo exitoso: %A cierra, %V abre el hueco y el grupo archiva el resultado, fracasado. delante de la evidencia del contador.',
  '%A vs %V terminó 1-0 sin necesidad de amplificación ni narrador extra a favor del resultado, cutre. con el eco todavía en el grupo.',
  '%A cobró de %V el aura que ahora figura en su columna del ranking, joder. y el contador insiste en el recuento que no perdona.',
  '%A el plan salió; %V no se salvó; el contador quedó de testigo del cargo, mierda. y el sistema marca el punto final.',
  '%A vs %V: gana %A por ejecución limpia del atraco y pierde %V por no retener, coño en alta resolución de group chat.',
  '%A se llevó el botín de %V delante de quien quisiera mirar el hilo, cabrón. delante de quien aún leía el hilo.',
  '%A ejecutó el atraco a %V como quien marca una casilla y pasa a la siguiente, gilipollas. en el momento que más dolía soltarlo.',
  '%A vs %V terminó con el aura de %V en tránsito hacia la cuenta de %A, patético. sin filtro de autoayuda.',
  '%A robó el aura de %V con la precisión de un cobro ya calculado de antemano, asco. delante del marcador en vivo.',
  '%A vs %V: el marcador del aura no admite empate en este resultado, ridículo. delante del ranking y de la cara.',
  '%A entró a por %V y salió con el objetivo del comando cumplido en el ranking, fracasado. delante del hueco que quedó.',
  '%A el golpe fue suficiente: %V lo nota y el ranking lo muestra sin filtro a favor del resultado, cutre.',
  '%A cobró el aura de %V y el chat no pidió repetición: se vio de sobra a la primera, mierda. sin que nadie pida replay.',
  'Atraco redondo a favor de %A: %V en el hueco documentado del contador, coño. sin cuento que lo tape sin segunda oportunidad hoy.',
  '%A se llevó lo marcado de %V sin letra pequeña ni segunda oportunidad del sistema, cabrón. con testigos obligados en el hilo.',
  '%A vs %V: el ladrón ganó el round que importaba al contador de aura, gilipollas. sin recurso ni nota al pie.',
  '%A ejecutó el atraco a %V en el timing del que no avisa dos veces seguidas, patético. sin prórroga ni VAR.',
  '%A el aura de %V viajó: destino cuenta de %A, billete sin retorno posible, asco. delante del hueco que quedó.',
  '%A vs %V terminó 1-0 en aura: archivo cerrado y siguiente, basura. con el fallo en 4K de chat con el chat enterado del cargo.',
  '%A robó a %V en luz de chat completa: sin sombra útil para la víctima del cargo, ridículo. en el segundo más incómodo del chat.',
  '%A se llevó el botín de %V con la calma de quien ya había contado el premio, cutre. en el recuento que no perdona.',
  '%A vs %V: crónica corta de un transfer largo para el contador de %V a favor del resultado, joder. delante de todo el que miraba.',
  '%A cobró de %V lo que ahora pesa en su favor en el ranking del grupo, mierda. con el chat enterado del cargo.',
  '%A el golpe a %V conectó; no hace falta cámara lenta ni narrador emocional, coño. y el contador insiste.',
  '%A vs %V terminó con el botín en el bolsillo de %A y el hueco en el de %V, cabrón y basta el dato del ranking.',
  '%A entró a por el aura de %V y cerró el parte a su favor en el sistema, gilipollas. con el resultado ya consumado.',
  '%A ejecutó el atraco sin almost: %V sin defensa suficiente para retener, patético. delante de la evidencia del contador.',
  '%A vs %V: 1-0 sin prórroga y con aura en movimiento hacia %A, asco. sin bis ni matiz de consuelo con el número hablando solo.',
  '%A se llevó el aura de %V y dejó el hueco como firma visible en el perfil, basura. y el sistema cierra sin discusión.',
  'Robo limpio: %A con el resultado, %V con la pérdida y el grupo con el dato, ridículo. y el resto es ruido de fondo.',
  '%A vs %V terminó con el ranking firmando a favor de %A sin pedir aclaración, fracasado. y el ranking no pide permiso.',
  '%A cobró el aura de %V en el momento exacto del comando y del hilo a favor del resultado, cutre. con el eco del almost todavía sonando.',
  '%A el plan contra %V no se quedó en la pizarra: se cobró en el contador, joder. y el veredicto no se negocia.',
  '%A vs %V: gana quien atacó y cobró, pierde quien defendió mal el aura, mierda. sin que nadie pida replay.',
  '%A ejecutó el atraco a %V como un cobro de deuda que %V no reconocía, cabrón. delante del ranking y de la cara.',
  '%A vs %V terminó con el transfer visible en el ranking y sin recurso, gilipollas. sin prosa que lo maquille.',
  '%A robó el aura de %V y el chat archivó el resultado sin debate útil posible, patético. y el ranking lo deja por escrito.',
  'Atraco a favor de %A: %V en pérdidas y el aura en otra columna del sistema, asco. en el momento que más dolía soltarlo.',
  '%A se llevó lo suyo del aura de %V: operativa de atraco exitoso sin maquillaje, basura. sin consuelo de manual barato.',
  '%A vs %V: el ladrón cerró antes de que la queja de %V terminara de escribirse, ridículo. sin consuelo de consola.',
  '%A cobró de %V en público: el ranking no ofrece modo privado para el cargo, fracasado. con el eco todavía en el grupo.',
  '%A el golpe a %V fue limpio; el efecto en el contador, sucio para %V a favor del resultado, cutre. con la cara del resultado a la vista.',
  '%A vs %V terminó 1-0 con el botín en movimiento hacia la cuenta de %A, joder. y el ranking cierra el caso.',
  '%A entró a por %V y cumplió: el aura cambió de dueño en el ranking, mierda. en el único marcador que importa aquí.',
  'Robo exitoso de %A a costa de %V: sin relativizar y con números a la vista, coño. en el recuento que no perdona.',
  '%A ejecutó, cobró y dejó a %V con el mensaje de recibo y el hueco del contador, cabrón. en el momento que más dolía soltarlo.',
  '%A se llevó el aura de %V en el timing que el ranking registra sin piedad, patético. y el veredicto no se negocia.',
  '%A robó a %V sin almost y sin devolución posible del botín, ridículo. con el veredicto seco del bot en alta resolución de group chat.',
  'Robo limpio: %A cierra el parte, %V abre el hueco y el grupo lo ve en el ranking, fracasado. delante del ranking y de la cara.',
  '%A vs %V: 1-0 en el único marcador que el comando reconoce de verdad, cutre. con el botín o el fail a la vista.',
  '%A cobró el aura de %V y dejó el recibo colgado en este hilo del chat, joder. sin letra pequeña que lo salve.',
  '%A el plan salió redondo: el aura de %V no tuvo billete de vuelta al contador a favor del resultado, mierda.',
  '%A vs %V terminó con el ranking actualizado y el debate sobrando en el hilo, coño. con el fail todavía caliente.',
  '%A ejecutó el atraco a %V como quien salda una línea pendiente del sistema, gilipollas. sin modo avión ni silencio cómplice.',
  '%A vs %V: gana %A, pierde %V y el aura no se discute en el chat, patético. sin descuento por empatía.',
  '%A robó el aura de %V con precisión de cobro ya calculado de antemano, asco. con testigos obligados en el hilo.',
  'Atraco redondo: %A con el resultado en el contador y %V con la pérdida a la vista, basura. delante del ranking y de la cara.',
  '%A vs %V terminó con el transfer en firme y sin VAR que lo cambie, ridículo. con el eco todavía en el grupo.',
  '%A el golpe a %V aterrizó donde más dolía: el contador del ranking, cutre. con el bot como notario del fallo.',
  '%A vs %V: 1-0 sin prórroga y con botín a nombre de %A en el sistema, joder. sin modo avión ni silencio cómplice.',
  '%A cobró de %V lo que el ranking ahora muestra sin filtro ni modo privado, mierda en alta resolución de group chat.',
  '%A ejecutó el atraco a %V y el chat no pidió segunda toma del golpe a favor del resultado, cabrón. delante de todo el que miraba.',
  '%A vs %V terminó con %A contando y %V restando en silencio de ranking, gilipollas. delante del ranking y de la cara.',
  '%A se llevó lo marcado del aura de %V: casilla cobrada en el sistema, patético. y el archivo no admite recurso.',
  '%A el plan contra %V funcionó de punta a punta del intento de atraco, asco. sin apelación posible hoy.',
  '%A vs %V: el ladrón ganó el round del contador y cerró el parte, basura. con el saldo a la intemperie.',
  '%A robó a %V en plena luz: sin sombra para esconder el cargo del ranking, ridículo. sin consuelo de manual barato.',
  'Robo limpio de %A a costa de %V: archivado en el ranking sin recurso, fracasado. sin barniz de relato heroico.',
  '%A vs %V terminó 1-0 con el aura en tránsito hacia quien atacó bien, cutre. en el único marcador que importa aquí.',
  '%A cobró el aura de %V y cerró el parte sin pedir aplauso al grupo, joder. y el archivo no admite recurso.',
  '%A el botín de %V ya no vuelve: el ranking no ofrece reembolso de aura, mierda. sin derecho a matiz útil.',
  '%A vs %V: crónica corta de un cobro largo para el contador de %V a favor del resultado, coño. y el sistema cierra sin discusión.',
  '%A se llevó el aura de %V con la calma de un trámite terminado en el sistema, cabrón. sin consuelo de manual barato.',
  '%A ejecutó el golpe a %V: el contador firmó y el chat presenció el cargo, gilipollas. sin cuento que lo tape.',
  '%A vs %V terminó con el resultado que %A había marcado en la lista de la compra, patético. sin derecho a matiz útil.',
  '%A robó el aura de %V y dejó el hueco como firma visible en el perfil del ranking, asco. delante de quien aún leía el hilo.',
  '%A vs %V: 1-0 en aura, archivo cerrado, siguiente ronda cuando toque, ridículo. con el botín o el fail a la vista.'
];
...
const ROB_FAIL = [
  ...
  '%A calculó mal el golpe y %V ni se agachó; el chat sí se inclinó de risa contenida, asco. y el sistema no regala puntos.',
  ...
  '%A tropezó con su propio plan tres pasos antes de oler siquiera el aura de %V, gilipollas y basta el dato del ranking.',
  ...
  'Robo en modo teatro de barrio: %A actuó, %V no aplaudió y el telón cayó igual de rápido, cutre. delante de todo el que miraba.',
  ...
  '%A calculó el ángulo dos veces y las dos veces calculó mal; %V ni se inmutó en el ranking, coño. con el número en la frente del mensaje.',
  ...
  '%A tenía hambre de aura ajena; %V tenía la nevera cerrada y la llave en otro continente, fracasado. con el eco del almost todavía sonando.',
  '%A vs %V terminó 0-1 sin que %V sudara ni una gota de aura ni de paciencia, joder. con el fail todavía caliente.',
  'Robo abortado por falta de talento documentada en acta: autor %A, espectador aburrido %V, mierda. y el sistema marca el punto final.',
  ...
  '%A salió a cazar aura ajena y cazó una lección: %V no se deja y él no da el nivel mínimo, ridículo y no hace falta ampliar el parte.',
  ...
  '%A apuntó al aura de %V y le dio al aire del chat; el aire no paga botín ni da propina, mierda. sin consuelo de manual barato.',
  '%V sigue rico en aura contada; %A sigue rico en excusas de por qué esta vez casi, coño. con el número hablando solo.',
  'El golpe no llegó al objetivo; el ridículo sí. Autor %A, objetivo intacto %V, público el grupo entero, cabrón.',
  '%V no defendió porque no hizo falta gastar energía: %A se defendió solo de su propio plan, basura. y el ranking cierra el caso.',
  ...
  'Atraco 0, %A 0, %V 1 por el simple hecho de no hacer nada y con eso bastar, mierda. sin anestesia de verdad esta vez.',
  'El plan de %A tenía más agujeros que aura disponible para robar; %V pasó de largo sin mirar, cabrón.',
  '%A sin botín, %V sin drama y el grupo con el veredicto escrito antes del punto final, gilipollas. sin anestesia de verdad esta vez.',
  '%A creyó que %V era objetivo fácil de tutorial; %V resultó pared de hormigón. Gana la pared, asco. con el bot como notario del fallo.',
  '%A extendió la mano al aura de %V y solo tocó el vacío de un intento mal medido, ridículo. con el eco todavía en el grupo.',
  '%V ni activó defensa ni sudó media gota: el ataque de %A no merecía el gasto de turnos, fracasado. delante de quien no quería verlo.',
  '%A vs %V: el marcador se escribió solo en la columna del fallo y no hubo prórroga, mierda. con el fail todavía caliente.',
  'El atraco de %A fue un farol a mesa llena; %V no vio las cartas porque no había juego encima, coño. sin filtro de autoayuda.',
  '%V sigue exactamente igual en el ranking; %A explica hace rato, gilipollas. en el recuento que no perdona.',
  '%A tropezó con la meta antes de llegar a ella: la meta era el aura de %V y sigue clavada ahí, patético.',
  '%A tenía hambre de aura contada; %V tenía cerradura y la llave lejos del alcance, basura. sin maquillaje ni segunda toma.',
  '%A no conectó ni por accidente afortunado del universo; %V no sudó ni por educación, fracasado. con el fallo en 4K de chat.',
  'Robo en modo ensayo general que nunca estrena: %A no sube al escenario; %V no compró entrada, cutre.',
  '%V intacto por mérito de estar quieto y por demérito largo y documentado de %A, mierda. sin bis ni matiz de consuelo.',
  ...
  '%V no necesitaba suerte ni escudo de tienda: %A trajo su propia derrota bajo el brazo, ridículo. con el número hablando solo.',
  'Fallo de %A: el botín sigue en %V, el meme queda en el chat y el prestigio baja sin freno, fracasado.',
  'El golpe de %A fue un soplo de aire acondicionado; %V ni se molestó en apartar el flequillo, joder. y el archivo queda cerrado.',
  ...
  '%A vs %V: crónica de un robo anunciado en el group chat y no ejecutado en ningún fotograma, joder. con el eco todavía en el grupo.',
  '%A sin el aura de %V y sin la suya de respeto: doble pérdida en un solo intento torpe, mierda. sin segunda oportunidad hoy.',
  '%V no se defendió porque el ataque de %A no llegó a la fase donde hace falta gastar defensa, gilipollas.',
  '%A tropezó con la realidad en el primer escalón del plan; la realidad se llama %V intacto, basura. sin derecho a matiz útil.',
  '%A extendió la mano al aura; %V contó las unidades al final y no faltaba ni media, cutre. con el grupo de testigo silencioso.',
  '%A vs %V en modo fail predecible de manual: guion visto mil veces y ejecución todavía peor, joder. sin consuelo de manual barato.',
  '%V sigue: el contador de aura no parpadeó ni un frame; %A sí, de nervios y de vergüenza, cabrón. delante de la evidencia del contador.',
  '%A no llegó; %V no se fue: empate técnico a favor de quien no necesitaba ni jugar, basura. sin bis ni matiz de consuelo.',
  '%A salió a por %V y volvió con una anécdota de fallo que nadie en el grupo había pedido, cutre. sin descuento por empatía.',
  '%V intacto de la primera a la última línea; %A redactando otra vez la crónica del casi, coño. sin modo avión ni silencio cómplice.',
  '%A vs el aura de %V: el aura ni se enteró de que había una amenaza nominal en el chat, cabrón y no hay modo de suavizarlo.',
  '%A en el intento, el intento en el suelo y el botín donde siempre estuvo: en %V, patético. con la firma legible del comando.',
  '%A no conectó ni por casualidad del universo; %V tampoco se movió por casualidad ni por pena, asco. en el único idioma que entiende el contador.',
  ...
  'El plan de %A no sobrevivió al primer contacto visual con %V en el ranking del grupo, coño. con el grupo de testigo silencioso.',
  '%A tenía hambre del aura de %V y se quedó solo con el hambre y el chat entero de testigo, gilipollas.',
  '%A vs %V terminó con el marcador en blanco total en la columna de quien atacó, asco. y el chat archiva sin debate.',
  '%V no sudó ni de lejos del intento; %A sudó la explicación larga que nadie había pedido, cutre. y el grupo ya pasó de página.',
  '%V sigue con el contador igual de firme; %A con el ego claramente en números rojos del día, gilipollas.',
  '%A vs %V: crónica breve de un fallo que a %A se le hizo eterno en la cabeza, ridículo. delante del marcador en vivo.',
  '%A vs %V en modo solo frente al espejo del chat: gana quien no atacó como atacó %A, basura. con el número hablando solo.',
  '%A creyó que esta vez sí tocaba; el universo y %V contestaron que no al unísono y sin dudar, cutre. con el veredicto seco del bot.',
  '%V ni se enteró del show montado; %A se enteró demasiado, demasiado tarde y demasiado claro, joder. y el contador no discute.',
  '%A tropezó con el peaje del fallo antes de oler de cerca el botín que guardaba %V, mierda. delante de la evidencia del contador.',
  '%A sin el aura de %V: historia corta de botín y largometraje de ridículo. con créditos finales, cabrón.',
  '%A el plan se le cayó de las manos antes de poder usarlo una sola vez contra %V, gilipollas y basta el dato del ranking.',
  '%A vs el aura de %V: 0-1 en el marcador y el 1 no sudó ni pidió cambio de ritmo, asco. con el número hablando solo.',
  '%A vs %V: el guion del comando decía robo y la función acabó siendo sketch de fallos, gilipollas. con el fallo en 4K de chat.',
  '%V intacto en el ranking; %A en la cola permanente de los almost del historial del comando, fracasado.',
  '%A sin el aura de %V y sin la cara de haberlo intentado de una forma decente, mierda. con testigos obligados en el hilo.',
  '%A vs %V terminó en walkover a favor de quien no necesitó atacar bien ni una sola vez, cabrón. con el fallo en 4K de chat.',
  ...
  '%A vs el aura de %V: ni hubo combate real ni hubo duda razonable del resultado final, joder y basta el dato del ranking.',
  'Atraco fallido en limpio: %A firma el parte, %V bosteza y el grupo archiva sin debate, cabrón. delante de quien no quería verlo.',
  '%A no conectó el golpe; el universo no ayudó; %V no necesitaba ayuda para ganar este round, gilipollas.',
  '%A puso la trampa, olvidó el sitio exacto y cayó lejos de %V y del botín que soñaba, asco. y el veredicto no se negocia.',
  '%A vs %V en una sola línea de acta notarial del bot: falló. Punto y cierre, ridículo. sin prosa que lo maquille.',
  '%A extendió la mano al aura; el aura de %V no hizo el trayecto inverso ni de broma ni de error, mierda.',
  '%V 1, %A 0: acta cerrada sin prórroga, sin VAR y sin bis de consuelo, gilipollas. con el botín o el fail a la vista.',
  '%A vs %V: el fallo se escribió solo en el ranking, sin ayuda de guionista ni de narrador, ridículo. sin segunda lectura que lo arregle.',
  ...
  '%A vs %V terminó antes de que %A encontrara siquiera el bolsillo correcto del objetivo, ridículo. y el contador no discute.',
  ...
  '%A vs el aura de %V: 0-1 sin prórroga, sin debate útil, cutre. con el saldo a la intemperie y basta el dato del ranking.',
  '%A salió a por el botín de %V y volvió con este mensaje como único souvenir del viaje, joder. con el número en la frente del mensaje.',
  '%A el plan se evaporó al primer contacto real con %V en la lista del grupo, gilipollas. y el ranking cierra el caso.',
  '%A vs %V: no hubo robo en el sentido útil de la palabra; hubo intento y hubo un no rotundo, basura. sin recurso ni nota al pie.',
  '%A vs %V terminó 0-1; el 1 es %V por el simple hecho de no moverse mal ni una vez, mierda. delante del listón que no saltaste.',
...
const ROB_MAESTRO = [
  ...
  '%A vs %V: crónica de un vaciado que el chat no discute. Y el grupo lo vio entero, asco. con el veredicto seco del bot.',
  ...
  '%A vs %V: clínica de atraco con resultado de vaciado. Y el grupo lo vio entero, cabrón. delante de la evidencia del contador.',
  ...
  '%A se llevó el pack de %V: el pack no volvió. Y el grupo lo vio entero, mierda. con el parte firmado debajo.',
...
const ROB_PARCIAL = [
  ...
  '%A vs %V: robo sí, ruina total no, dolor sí. Y el grupo lo vio entero, joder. con la cara del resultado a la vista.',
...
const ROB_DESASTRE = [
  '%A salió a robar y acabó financiando a %V: el karma le pasó factura con intereses de aura, joder. en el idioma seco del ranking.',
  '%A intentó el atraco y terminó pagando el aura de su propio bolsillo a favor de %V, mierda. en el momento que más dolía soltarlo.',
  'Desastre total del intento: %A no solo falló, encima le dejó el aura a %V en bandeja, coño. delante del marcador en vivo.',
  '%A vs %V terminó con %A más pobre en el ranking y %V agradeciendo el regalo involuntario, cabrón. y el archivo queda cerrado.',
  '%A vino a cazar y salió cazado: %V cuenta el botín que al principio no era suyo, gilipollas. y el hilo no pide amplificación.',
  'El atraco de %A fue un donativo disfrazado de robo; %V no dijo que no al ingreso a favor del resultado, patético.',
  '%A perdió el robo y el aura en el mismo ticket; %V ganó el día sin sudar el ataque, asco. en el segundo más incómodo del chat.',
  'Desastre de %A: intentó quitar y terminó poniendo aura en la cuenta de %V, basura. con la cara del resultado a la vista.',
  '%A firmó un cheque al portador a nombre de %V con la tinta de su propio fallo, ridículo. con el número hablando solo.',
  '%A el plan salió tan mal que %V cobró peaje por el simple hecho de haber sido el objetivo, fracasado.',
  '%A vs %V: marcador final a favor de quien debía perder el aura según el guion de %A, cutre. con el peaje cobrado al natural.',
  '%A no solo falló el golpe: abrió la cartera y %V dijo gracias en silencio de ranking, joder. delante del público que no pidió entrada.',
  'Desastre documentado: %A más ligero, %V más pesado de aura y el chat más contento, mierda. con el dígito firmando solo.',
  '%A salió a por el botín y volvió sin el suyo; %V sonríe con lo de los dos en el contador, coño. con el eco todavía en el grupo.',
  '%A intentó robar a %V y terminó de patrocinador oficial de su aura en el ranking, gilipollas. sin suavizar el golpe del número.',
  'Desastre en limpio: %A en números rojos, %V en verde y el intento en el museo de fails a favor del resultado, patético.',
  '%A puso la mano para quitar y la retiró dejando de más; %V no se queja del error, asco. sin segunda oportunidad hoy.',
  '%A vs %V terminó en donación involuntaria con público completo en el hilo, basura. con el fallo en 4K de chat.',
  '%A perdió el duelo del atraco y el del saldo; %V ni tenía que haber peleado de verdad, fracasado. en el único marcador que importa aquí.',
  'Desastre de manual: autor %A, beneficiario %V y el grupo testigo de la limosna, cutre. y el ranking cierra el caso.',
  '%A salió a cazar aura ajena y volvió dejando la propia en el plato de %V, joder. y el sistema marca el punto final.',
  '%A el fallo no bastaba como castigo: hacía falta el peaje. %V lo cobró entero, mierda. y el ranking no pide permiso.',
  '%A vs %V: el ladrón pagó la cena y la propina del ranking ajeno, coño. con el eco todavía en el grupo.',
  '%A intentó el golpe de la semana y firmó la donación del mes a nombre de %V, cabrón. sin descuento por empatía.',
  '%A sin el botín de %V y sin el suyo; %V con ambos sonidos de caja en el contador, asco. delante del listón que no saltaste.',
  '%A el plan era quitar: el resultado fue dar. %V aplaude en silencio de ranking a favor del resultado, basura.',
  '%A vs %V terminó con el ranking más justo de lo que %A quería ver en pantalla, ridículo. sin barniz de relato heroico.',
  '%A falló tan fuerte que el eco le cobró aura a favor de %V en el sistema, fracasado. con el grupo de testigo silencioso.',
  'Desastre: %A más pobre por intentar ser más rico a costa de %V y salir escaldado, cutre. con el saldo a la intemperie.',
  '%A vs %V: crónica de un donativo anunciado como robo en el comando, coño y no hay modo de suavizarlo.',
  '%A salió a vaciar a %V y terminó vaciándose él; el chat tomó nota del peaje, cabrón. con el botín o el fail a la vista.',
  '%A el karma contó el intento y pasó factura con el aura de %A hacia %V, gilipollas. en el segundo más incómodo del chat.',
  '%A intentó el atraco y %V terminó cobrando el servicio de haber sido el objetivo, asco. y el sistema no regala puntos.',
  '%A vs %V en modo desastre: gana quien debía perder según el guion original de %A, basura. con el botín o el fail a la vista.',
  '%A puso la trampa y pagó la fianza; %V recogió ambas cosas en el contador, ridículo. y el hilo no pide amplificación.',
  '%A sin gloria en el parte y con el saldo peor; %V con el día hecho en el ranking a favor del resultado, fracasado.',
  'Desastre total: el aura de %A emigró hacia %V sin pedir asilo ni contrato de robo exitoso, cutre. sin recurso ni nota al pie.',
  '%A vs %V terminó con transfer automático por incompetencia documentada, mierda. con el veredicto seco del bot.',
  '%A el fail no era suficiente castigo: hacía falta el peaje. Cobrado a favor de %V, cabrón. y el sistema no regala puntos.',
  'Desastre documentado de %A a favor de %V: el ranking no discute el cargo, gilipollas. delante del ranking y de la cara.',
  '%A intentó quitar y el sistema sumó en la columna de %V: matemáticas del desastre, patético y no hay modo de suavizarlo.',
  '%A vs %V: el ladrón pagó la entrada, la consumición y la propina del ranking ajeno, asco. sin filtro de autoayuda.',
  '%A perdió el robo, el aura y la cara; %V solo tenía que existir en el objetivo, ridículo. en el parte que nadie borra.',
  'Desastre: %A en modo patrocinador involuntario de %V en el contador del grupo, fracasado. sin prórroga ni VAR.',
  '%A vs %V terminó con el contador de %A en menos y el de %V en más sin debate, joder. con el cargo en firme.',
  '%A salió a por todo y volvió con menos de lo que tenía; %V agradece el ingreso a favor del resultado, mierda.',
  'Desastre de %A: el botín viajó hacia %V con remitente el fallo del intento, cabrón. con la firma legible del comando.',
  '%A intentó el golpe y terminó de cajero automático a favor de %V en el ranking, gilipollas. con el saldo a la intemperie.',
  '%A vs %V en una línea de acta: %A pagó. Punto y cierre del desastre, patético. en el idioma seco del ranking.',
  '%A sin el aura de %V y sin la suya completa; %V con el combo ganado sin atacar, basura. y el ranking no pide permiso.',
  '%A puso el robo en el horno y se coció él; %V se comió el plato del ranking, fracasado. sin modo avión ni silencio cómplice.',
  '%A el karma no negocia el peaje del fail: %V cobra en silencio de contador, cutre. y el grupo ya pasó de página.',
  '%A vs %V terminó con el peaje más caro del día para la cuenta de %A, joder. y el ranking no pide permiso.',
  '%A salió a vaciar bolsillos ajenos y terminó vaciando el suyo; %V testigo y cajero, mierda. y el ranking no pide permiso.',
  '%A el fallo con recargo: el recargo en aura a nombre de %V en el sistema, coño. con el dígito firmando solo.',
  'Desastre: %A más ligero, %V más contento y el chat más entretenido con el peaje a favor del resultado, cabrón.',
  '%A intentó el atraco de oro y firmó la donación de bronce oxidado a %V, gilipollas. delante de todo el que miraba.',
  '%A vs %V: crónica breve de un transfer largo y doloroso para %A, patético. y el archivo no admite recurso.',
  '%A sin gloria en el parte y con el saldo empeorado; %V sin haber atacado de verdad, basura. sin consuelo de consola.',
  'Desastre de manual con factura visible: autor %A, beneficiario %V, ridículo. con el eco todavía en el grupo.',
  '%A vs %V terminó con el ranking corrigiendo a %A a la baja y a %V al alza, cutre. con el saldo a la intemperie.',
  'Desastre: %A en rojo, %V en verde y el intento en el museo de fails del chat, coño y no hay DLC que lo parchee.',
  '%A puso la mano para sacar y el sistema registró un ingreso a favor de %V, cabrón. delante del público que no pidió entrada.',
  '%A vs %V en modo donación involuntaria con público de pie en el hilo, gilipollas. sin bis ni matiz de consuelo.',
  '%A firmó la factura del intento: beneficiario claro %V en el contador, ridículo. delante del ranking y de la cara.',
  '%A vs %V terminó con el ranking haciendo justicia poética a costa de %A a favor del resultado, fracasado.',
  '%A salió a cazar y volvió como trofeo de %V en el chat y en el número, cutre. con el dígito como única defensa.',
  'Desastre documentado: el aura de %A emigró con destino fijo a la cuenta de %V, mierda. con el botín o el fail a la vista.',
  '%A vs %V: una línea de acta del bot — %A pagó el peaje del intento, cabrón. sin modo avión ni silencio cómplice.',
  '%A sin aura nueva y sin aura vieja completa; %V con el día resuelto en el ranking, patético. sin consuelo de manual barato.',
  '%A puso el robo en marcha y la marcha era atrás; %V recibió igual el ingreso, basura. y el ranking cierra el caso.',
  '%A vs %V en una frase: el intento costó aura a quien lo empezó, ridículo. delante de quien aún leía el hilo.',
  '%A el fail con intereses de demora: los intereses se llaman %V en el contador, fracasado. con el grupo de testigo silencioso.',
  '%A sin el plan original y con el cargo original; %V con el aura del peaje, cutre. y el sistema no regala puntos.',
  'Desastre: %A más pobre por la ambición mal ejecutada contra %V, joder. con el chat enterado del cargo.',
  '%A intentó el golpe y el golpe le hizo de cajero a favor de %V a favor del resultado, mierda. sin consuelo de consola.',
  '%A vs %V terminó con transfer y sin una sola línea de gloria para %A, coño. con el parte firmado debajo.',
  '%A perdió el duelo del atraco y el del contador; %V sin ponerse los guantes, gilipollas. con el veredicto seco del bot.',
  '%A vs %V: ranking a la baja para %A, al alza para %V, sin debate útil, basura en la foto fija del ranking.',
  '%A el peaje del fail se cobró solo; %V fue el cajero que no pidió el puesto, fracasado. en el segundo más incómodo del chat.',
  'Desastre documentado a favor de %V con autor intelectual %A en negrita, cutre. en el único idioma que entiende el contador.',
  '%A intentó el atraco y terminó de mecenas involuntario de %V en el ranking, joder. sin que nadie pida replay.',
  '%A vs %V en modo desastre limpio: sin duda del resultado ni del peaje, mierda. y el ranking lo deja por escrito.',
  '%A sin gloria y con el saldo en menos; %V sin haber pedido nada del regalo, cabrón. y el archivo no admite recurso.',
  'Desastre total: %A financió a %V con el intento mismo de robarle el aura, gilipollas. y el resto es ruido de fondo.',
  '%A vs %V terminó con %A de patrocinador y %V de marca beneficiada a favor del resultado, asco. sin suavizar el golpe del número.',
  '%A perdió lo que quería ganar y lo que ya tenía; %V solo miró el ingreso, ridículo. y el ranking lo deja por escrito.',
  '%A el universo no negocia el peaje del fail; %V cobra en silencio de contador, cutre y basta el dato del ranking.',
  '%A vs %V: crónica de un donativo con coreografía fallida de atraco, joder. delante de todo el que miraba.',
  '%A salió a vaciar a %V y terminó en la cola del cajero al revés del ranking, mierda. con el cargo en firme.',
  '%A el fallo con recargo automático: recargo a nombre de %V en el sistema, coño. sin letra pequeña que lo salve.',
  '%A intentó el golpe de oro y firmó el cargo de plomo a favor de %V, gilipollas. sin filtro de autoayuda.',
  '%A vs %V terminó con el contador de %A en dirección incorrecta del todo, patético. con el número hablando solo.',
  '%A sin botín propio ni ajeno; %V con el combo ganado sin atacar de verdad, basura. y el sistema cierra sin discusión.',
  'Desastre total documentado: %A deudor, %V acreedor y el grupo testigo del peaje, ridículo. con el saldo a la intemperie.',
  '%A vs %V: el ladrón pagó la cena de los dos y la propina del ranking a favor del resultado, cutre. y el hilo sigue sin ti en el centro.',
  '%A salió a por el aura de %V y regaló la ruta de la suya hacia el otro contador, joder. delante de todo el que miraba.',
  '%A el karma cobró al contado; %V no rechazó el ingreso en el ranking, mierda. con el grupo de testigo silencioso.',
  'Desastre: %A en rojo por ambición y %V en verde por existir como objetivo, coño. en el único marcador que importa aquí.',
  '%A firmó la factura del intento con beneficiario %V en el contador, ridículo. y el ranking no pide permiso.',
  '%A intentó quitar y el universo usó la función sumar en la cuenta de %V, coño. delante del público que no pidió entrada.',
  '%A vs %V: una línea de acta — %A pagó el peaje del intento fallido, cabrón. y el grupo ya pasó de página.',
  '%A sin aura nueva y sin la vieja completa; %V con el día resuelto en el ranking, patético. y el archivo queda cerrado.',
  '%A puso el robo en marcha atrás sin querer; %V recibió el ingreso igual, basura. con el chat enterado del cargo.',
  '%A el fail con intereses: los intereses se llaman %V en el contador del grupo, fracasado. delante de todo el que miraba.',
  'Desastre: %A más pobre por querer ser más rico a costa de %V y salir escaldado a favor del resultado, joder.',
  '%A vs %V: ranking a la baja para %A y al alza para %V, sin debate posible, basura. sin cuento que lo tape.'
];
