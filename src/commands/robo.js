...
const ROB_MAESTRO = [
  '%A le vació el aura a %V con la precisión de un puto cirujano delante del puto ranking, joder.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking delante del puto ranking, mierda.',
  '%A vs %V: clínica. El botín viajó entero y el chat lo vio delante del puto ranking, coño.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V delante del puto ranking, cabrón.',
  '%A ejecutó el atraco perfecto. %V firmó el empty account delante del puto ranking, gilipollas.',
  'Robo de manual negro: %A cobra, %V llora, el ranking firma delante del puto ranking, patético.',
  '%A entró como sombra y salió con el aura completa de %V delante del puto ranking, asco.',
  'Maestro documentado. Autor %A, víctima total %V delante del puto ranking, basura.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo delante del puto ranking, ridículo.',
  '%A se llevó todo. %V se quedó con el hueco y este mensaje delante del puto ranking, fracasado.',
  '%A vació a %V en público sin dejar almost ni consuelo delante del puto ranking, joder.',
  'Maestro de puta madre: el contador de %V a cero en un golpe delante del puto ranking, mierda.',
  '%A cobró el aura de %V como quien cobra una deuda vieja delante del puto ranking, coño.',
  'Robo maestro. %V ni activó defensa porque no hubo tiempo delante del puto ranking, cabrón.',
  '%A vs %V: el ladrón ganó el único round que importaba delante del puto ranking, gilipollas.',
  '%A dejó a %V mirando el contador en cero sin anestesia delante del puto ranking, patético.',
  'Maestro limpio en el ranking y sucio para el ego de %V delante del puto ranking, asco.',
  '%A ejecutó, cobró y cerró el parte a favor sin temblar delante del puto ranking, basura.',
  'Robo total. %A con todo, %V con nada, el chat de testigo delante del puto ranking, ridículo.',
  '%A vació el aura de %V y el ranking no ofreció recurso delante del puto ranking, fracasado.',
  '%A le limpió el contador a %V en un solo movimiento limpio delante del puto ranking, joder.',
  'Maestro: empty total. %V mira el cero y el grupo mira a %A delante del puto ranking, mierda.',
  '%A vs %V clínica total. El botín no dejó residuo en %V delante del puto ranking, coño.',
  '%A cobró el 100 % del aura de %V sin pedir la palabra delante del puto ranking, cabrón.',
  'Robo maestro limpio. El ranking actualiza a favor de %A delante del puto ranking, gilipollas.',
  '%A entró, vació y salió. %V se enteró por el contador delante del puto ranking, patético.',
  'Maestro documentado sin filtro delante del puto grupo delante del puto ranking, asco.',
  '%A no dejó almost: dejó el empty account de %V delante del puto ranking, basura.',
  '%A vs %V: 1-0 con botín completo y cero debate útil delante del puto ranking, ridículo.',
  '%A se llevó el aura de %V entera. El hueco es el mensaje delante del puto ranking, fracasado.',
  '%A vació a %V con la calma de quien ya había contado el botín delante del puto ranking, joder.',
  'Maestro de manual: cero en %V, todo en %A, firma el ranking delante del puto ranking, mierda.',
  '%A vs %V terminó con transfer total y cara de fail en %V delante del puto ranking, coño.',
  '%A cobró todo lo que %V tenía contado de aura delante del puto ranking, cabrón.',
  'Robo total limpio. %A ejecuta, %V firma el vacío delante del puto ranking, gilipollas.',
  '%A entró como profesional y salió con el aura completa de %V delante del puto ranking, patético.',
  'Maestro en el ranking. El chat no pide replay porque se vio delante del puto ranking, asco.',
  '%A no improvisó: vació a %V según plan y el plan salió delante del puto ranking, basura.',
  '%A vs %V: crónica de un empty account firmado en público delante del puto ranking, ridículo.',
  '%A se llevó el 100 %. %V se quedó con este mensaje de recibo delante del puto ranking, fracasado.',
  '%A le dejó el contador a cero a %V delante de todos delante del puto ranking, joder.',
  'Maestro limpio. Ni polvo de aura quedó en la cuenta de %V delante del puto ranking, mierda.',
  '%A vs %V clínica. Botín entero, defensa inexistente delante del puto ranking, coño.',
  '%A cobró el aura de %V sin dejar almost de consuelo delante del puto ranking, cabrón.',
  'Robo maestro. El ranking de %V a cero en un golpe delante del puto ranking, gilipollas.',
  '%A entró, tomó todo y cerró. %V abrió el hueco delante del puto ranking, patético.',
  'Maestro documentado. Autor %A, empty %V, archivo el grupo delante del puto ranking, asco.',
  '%A vació a %V como quien limpia una deuda pendiente delante del puto ranking, basura.',
  '%A vs %V: el ladrón no falló ni un frame del atraco delante del puto ranking, ridículo.',
  '%A se llevó todo el aura de %V y el ranking lo selló delante del puto ranking, fracasado.',
  '%A ejecutó el empty total de %V sin sudar el golpe delante del puto ranking, joder.',
  'Maestro de puta madre en el sentido del botín completo delante del puto ranking, mierda.',
  '%A vs %V terminó con cero en %V y sonrisa en %A delante del puto ranking, coño.',
  '%A cobró el aura entera. %V pagó el curso completo delante del puto ranking, cabrón.',
  'Robo total. %A con el botín, %V con el vacío delante del puto ranking, gilipollas.',
  '%A entró en silencio y salió con el contador de %V a cero delante del puto ranking, patético.',
  'Maestro en público. El grupo vio el transfer total delante del puto ranking, asco.',
  '%A no dejó residuo: empty account de %V firmado delante del puto ranking, basura.',
  '%A vs %V: 1-0 sin VAR ni prórroga ni consuelo delante del puto ranking, ridículo.',
  '%A se llevó el aura de %V al completo. Recibo: este mensaje delante del puto ranking, fracasado.',
  '%A vació el ranking de %V en un movimiento de cirujano delante del puto ranking, joder.',
  'Maestro limpio. El botín viajó entero hacia %A delante del puto ranking, mierda.',
  '%A vs %V clínica total sin almost de defensa posible delante del puto ranking, coño.',
  '%A cobró el 100 % y el ranking no ofreció recurso a %V delante del puto ranking, cabrón.',
  'Robo maestro. %V mira el cero y no hay segunda lectura delante del puto ranking, gilipollas.',
  '%A entró, vació y el parte se cerró solo a su favor delante del puto ranking, patético.',
  'Maestro documentado sin anestesia para %V delante del puto ranking, asco.',
  '%A no falló el empty: lo firmó en el contador de %V delante del puto ranking, basura.',
  '%A vs %V: crónica de un atraco total con público delante del puto ranking, ridículo.',
  '%A se llevó todo. %V se quedó sin aura y sin discurso delante del puto ranking, fracasado.',
  '%A le limpió el aura a %V como quien cobra al contado delante del puto ranking, joder.',
  'Maestro de manual negro: cero %V, todo %A, firma ranking delante del puto ranking, mierda.',
  '%A vs %V terminó con transfer total visible en el chat delante del puto ranking, coño.',
  '%A cobró el aura completa de %V sin pedir turno de palabra delante del puto ranking, cabrón.',
  'Robo total limpio. El ranking actualiza y %V calla delante del puto ranking, gilipollas.',
  '%A entró de profesional y salió con el empty de %V delante del puto ranking, patético.',
  'Maestro en el ranking. El chat archiva el golpe total delante del puto ranking, asco.',
  '%A vació a %V según plan. El plan no falló un frame delante del puto ranking, basura.',
  '%A vs %V: el empty account firmado sin debate útil delante del puto ranking, ridículo.',
  '%A se llevó el 100 % del aura. %V el 100 % del fail delante del puto ranking, fracasado.',
  '%A ejecutó el empty de %V delante del puto grupo delante del puto ranking, joder.',
  'Maestro limpio en números y sucio para el ego de %V delante del puto ranking, mierda.',
  '%A vs %V clínica. Botín entero, defensa en cero delante del puto ranking, coño.',
  '%A cobró todo lo contado en el aura de %V delante del puto ranking, cabrón.',
  'Robo maestro. El contador de %V a cero sin prórroga delante del puto ranking, gilipollas.',
  '%A entró, tomó el total y cerró el parte, patético para %V delante del puto ranking, patético.',
  'Maestro documentado. Empty %V, botín %A, testigo el chat delante del puto ranking, asco.',
  '%A vació a %V sin dejar almost de consuelo en el ranking delante del puto ranking, basura.',
  '%A vs %V: 1-0 total. El ladrón no dudó ni un segundo delante del puto ranking, ridículo.',
  '%A se llevó el aura entera de %V y el ranking lo selló delante del puto ranking, fracasado.',
  '%A le dejó a %V el contador en cero y este mensaje de recibo delante del puto ranking, joder.',
  'Maestro de puta madre: empty total firmado en público delante del puto ranking, mierda.',
  '%A vs %V terminó con cero en %V y el botín en %A delante del puto ranking, coño.',
  '%A cobró el aura de %V al completo sin temblar delante del puto ranking, cabrón.',
  'Robo total. %A ejecuta, %V firma el vacío, el chat mira delante del puto ranking, gilipollas.',
  '%A entró en silencio y salió con todo el aura de %V delante del puto ranking, patético.',
  'Maestro en público sin filtro ni narrador emocional delante del puto ranking, asco.',
  '%A no dejó residuo de aura en la cuenta de %V delante del puto ranking, basura.',
  '%A vs %V: empty account. Archivo cerrado delante del puto ranking, ridículo.',
  '%A se llevó el 100 %. Recibo colgado en este hilo delante del puto ranking, fracasado.'
];
...
const ROB_PARCIAL = [
  ...
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual delante del puto ranking, coño.',
  ...
  '%A entró, picó y salió con botín incompleto pero real para %V delante del puto ranking, asco.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo delante del puto ranking, basura.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa delante del puto ranking, ridículo.',
  ...
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias delante del puto ranking, mierda.',
  '%A no fue maestro ni fail: fue el medio que duele igual delante del puto ranking, coño.',
  'Robo parcial. El ranking de %V baja y el de %A sube a medias delante del puto ranking, cabrón.',
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail delante del puto ranking, gilipollas.',
  '%A se llevó lo justo para que %V lo note el resto del día delante del puto ranking, patético.',
  'Parcial limpio en el contador y sucio en la cara de %V delante del puto ranking, asco.',
  '%A picó, cobró y salió. %V se quedó con el almost de defensa delante del puto ranking, basura.',
  'Robo a medias documentado delante del grupo sin filtro delante del puto ranking, ridículo.',
  '%A no vació a %V: lo dejó cojeando de aura en el ranking delante del puto ranking, fracasado.',
  '%A le quitó un trozo del aura a %V y el ranking lo registró igual delante del puto ranking, joder.',
  'Parcial: no es el golpe perfecto, pero %V sangra aura de verdad delante del puto ranking, mierda.',
  '%A vs %V a medias. El botín no es total y la vergüenza sí delante del puto ranking, coño.',
  '%A cobró tajada incompleta. %V pagó completa en cara delante del puto ranking, cabrón.',
  'Robo parcial limpio. %A con algo, %V con menos y con el gag delante del puto ranking, gilipollas.',
  '%A no se fue de vacío. %V tampoco se fue intacto delante del puto ranking, patético.',
  'Parcial en el contador. El chat vio el transfer a medias delante del puto ranking, asco.',
  '%A vs %V: el medio duele como el todo cuando se firma en público delante del puto ranking, basura.',
  '%A se llevó una porción. El ranking de %V lo nota igual delante del puto ranking, ridículo.',
  'Robo a medias. Autor %A, hueco en %V, archivo el grupo delante del puto ranking, fracasado.',
  '%A picó el aura de %V sin rematar. Suficiente para el ranking delante del puto ranking, joder.',
  'Parcial de puta madre: no vacío, pero el dolor es real para %V delante del puto ranking, mierda.',
  '%A vs %V terminó en transfer incompleto y cara completa de fail delante del puto ranking, coño.',
  '%A cobró lo que pudo. %V perdió lo que no quería delante del puto ranking, cabrón.',
  'Robo parcial. El almost de %V es haber perdido solo una parte delante del puto ranking, gilipollas.',
  '%A entró a medias y salió con botín real. %V con el hueco delante del puto ranking, patético.',
  'Parcial documentado sin anestesia en el ranking del grupo delante del puto ranking, asco.',
  '%A no fue cirujano: fue carnicero a medias y %V sangra igual delante del puto ranking, basura.',
  '%A vs %V: tajada incompleta, vergüenza completa delante del puto ranking, ridículo.',
  '%A se llevó lo suficiente. El ranking de %V firma el parcial delante del puto ranking, fracasado.',
  '%A le arrancó un trozo del aura a %V delante de todos delante del puto ranking, joder.',
  'Parcial limpio en números y sucio en el ego de %V delante del puto ranking, mierda.',
  '%A vs %V a medio gas. El botín existe y el fail de %V también delante del puto ranking, coño.',
  '%A cobró incompleto. El dolor de %V es completo delante del puto ranking, cabrón.',
  'Robo parcial. %A con tajada, %V con lección, el chat con gag delante del puto ranking, gilipollas.',
  '%A no vació el tanque: lo dejó en reserva baja de aura delante del puto ranking, patético.',
  'Parcial en el ranking. %V lo nota cada vez que mira el contador delante del puto ranking, asco.',
  '%A vs %V: crónica de un medio atraco con efecto total en la cara delante del puto ranking, basura.',
  '%A se llevó una parte y dejó el almost de defensa en %V delante del puto ranking, ridículo.',
  'Robo a medias firmado. Autor %A, archivo el puto grupo delante del puto ranking, fracasado.',
  '%A picó sin rematar. El ranking de %V bajó igual delante del puto ranking, joder.',
  'Parcial de manual negro: tajada real, vacío no, dolor sí delante del puto ranking, mierda.',
  '%A vs %V terminó a medias en botín y completo en vergüenza delante del puto ranking, coño.',
  '%A cobró lo justo. %V pagó de más en cara del ranking delante del puto ranking, cabrón.',
  'Robo parcial limpio. El contador habla y %V calla delante del puto ranking, gilipollas.',
  '%A entró, tomó y salió. %V se quedó con menos y con el gag delante del puto ranking, patético.',
  'Parcial documentado. El grupo no necesita narrador delante del puto ranking, asco.',
  '%A no fue maestro: fue eficaz a medias y suficiente delante del puto ranking, basura.',
  '%A vs %V: el medio atraco que duele como el grande delante del puto ranking, ridículo.',
  '%A se llevó una porción del aura de %V sin pedir permiso delante del puto ranking, fracasado.',
  '%A le sacó aura a %V sin vaciar la cuenta. El ranking igual delante del puto ranking, joder.',
  'Parcial: %A gana algo, %V pierde algo, el chat gana el gag delante del puto ranking, mierda.',
  '%A vs %V a medias. Transfer incompleto, veredicto completo delante del puto ranking, coño.',
  '%A cobró tajada. %V firmó el hueco a medias en el ranking delante del puto ranking, cabrón.',
  'Robo parcial. No es el empty total y aun así duele delante del puto ranking, gilipollas.',
  '%A no se fue de vacío. El almost de %V es haber perdido poco delante del puto ranking, patético.',
  'Parcial en público. El ranking actualiza y %V se entera delante del puto ranking, asco.',
  '%A vs %V: crónica del medio golpe con efecto de hostia delante del puto ranking, basura.',
  '%A se llevó lo bastante para que el contador de %V se note delante del puto ranking, ridículo.',
  'Robo a medias. Firmado por el bot delante del grupo delante del puto ranking, fracasado.',
  '%A picó el aura de %V y el ranking registró el parcial delante del puto ranking, joder.',
  'Parcial de puta madre en el sentido del dolor a medias delante del puto ranking, mierda.',
  '%A vs %V terminó con botín incompleto y cara de fail completa delante del puto ranking, coño.',
  '%A cobró. %V perdió. El medio también cuenta en el ranking delante del puto ranking, cabrón.',
  'Robo parcial limpio. %A con tajada, %V con el gag delante del puto ranking, gilipollas.',
  '%A entró a medias y el efecto fue total en el ego de %V delante del puto ranking, patético.',
  'Parcial documentado sin filtro ni consuelo para %V delante del puto ranking, asco.',
  '%A no vació: dejó a %V cojeando de aura en el contador delante del puto ranking, basura.',
  '%A vs %V: el atraco incompleto que el ranking sí completa delante del puto ranking, ridículo.',
  '%A se llevó una parte del aura de %V y el chat lo archivó delante del puto ranking, fracasado.',
  '%A le quitó aura a %V sin el empty total. Suficiente delante del puto ranking, joder.',
  'Parcial limpio en el número y sucio para %V delante del puto ranking, mierda.',
  '%A vs %V a medio gas con efecto de hostia en el ranking delante del puto ranking, coño.',
  '%A cobró incompleto y %V pagó completo en vergüenza delante del puto ranking, cabrón.',
  'Robo parcial. El contador de %V baja y el gag sube delante del puto ranking, gilipollas.',
  '%A no fue cirujano ni fail: fue el medio que duele delante del puto ranking, patético.',
  'Parcial en el ranking. %V lo mira y se le cae la cara delante del puto ranking, asco.',
  '%A vs %V: tajada real, vacío no, dolor sí documentado delante del puto ranking, basura.',
  '%A se llevó lo justo. El almost de defensa de %V quedó en almost delante del puto ranking, ridículo.',
  'Robo a medias firmado sin anestesia en el puto grupo delante del puto ranking, fracasado.',
  '%A picó sin rematar y el ranking de %V sangró igual delante del puto ranking, joder.',
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana delante del puto ranking, mierda.',
  '%A vs %V terminó a medias en botín y entero en fail de %V delante del puto ranking, coño.',
  '%A cobró lo que pudo sacar. %V notó cada unidad delante del puto ranking, cabrón.',
  'Robo parcial limpio. El bot firma y %V calla delante del puto ranking, gilipollas.',
  '%A entró, tomó tajada y salió. %V con el hueco a medias delante del puto ranking, patético.',
  'Parcial documentado delante de todos sin narrador delante del puto ranking, asco.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja delante del puto ranking, basura.',
  '%A vs %V: el medio atraco con firma completa en el ranking delante del puto ranking, ridículo.',
  '%A se llevó una porción y dejó a %V con la lección a medias delante del puto ranking, fracasado.'
];
