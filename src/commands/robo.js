...
const ROBO_FALLO_REMATE = [
  ...
  'y se pegó el hostión con la precisión de un fracasado',
  'y el golpe se le volvió en contra, como todo lo que toca',
  'y salió más pobre y más patético, el pack completo',
  'y pagó por creérselo, el pringado de siempre',
  'y el aura le duró lo que le dura el carácter: nada',
  'y se fue con una multa y esa cara de basura húmeda',
  'y ni llegó a tocarlo: demasiado inútil hasta para fallar cerca',
  'y el grupo vio el intento y cambió de tema, por asco',
  'y se llevó un no con intereses, cutre y puntual',
  'y quedó en evidencia, que es su puto hábitat',
  'y el plan se le cayó encima, como le cae todo',
  'y volvió sin botín y con el ego en una bolsa de miseria',
  'y lo único que robó fue un rato de la paciencia del grupo',
  'y se estrelló tan limpio que dio vergüenza ajena de tan fácil',
  ...
  'y volvió con menos de lo que no tenía. Talento inverso',
  'y el golpe le duró lo que tarda en rendirse: un segundo',
  'y se fue a su rincón con la multa de los que no aprenden',
  'y quedó como un ladrón de tienda de chistes: vacío y ridículo',
  'y ni el universo colaboró. El universo tiene estándares, inútil',
  'y se pegó contra un no que ni se molestó en gritar',
  'y el botín se rió. El botín tiene más carácter que él',
  'y salió con las cuentas en rojo y la cara de siempre: esta',
  'y confirmó el ranking: último en todo, también en esto, pringado',
  'y el plan era malo. La ejecución, peor. El resultado, él',
  'y se llevó un cachete del sistema. Merecido. Cutre. Público',
  'y no hubo drama. Hubo un plof. El plof era él, basura',
  'y la víctima parpadeó. Ni eso hacía falta. Qué miseria de amenaza',
  'y pagó por la pose. La pose se cae. Él debajo, patético',
  'y el robo se negó a ser. Hasta el delito lo rechaza, asco',
  'y volvió al punto de partida, que ya era el suelo, desperdicio',
  'y se le oyó el ego reventar. Un globo. Un niño. Un no',
  'y quedó grabado: intentó, falló, pagó. El tríptico del inútil',
  ...
  'y la víctima bostezó. El bostezo es el parte, cabrón',
  'y salió con menos aura y la misma cara de no haber entendido',
  'y el sistema le cobró por soñar. El sueño era malo. El cobro, justo',
  'y se estrelló contra su nivel. El nivel está en el sótano, cutre',
  'y no hubo pelea. Hubo un no. El no le queda grande, inútil',
  'y volvió más pequeño. Ya era pequeño. Ahora es una nota al pie',
  'y el botín se quedó donde estaba: lejos de este pringado',
  'y pagó el peaje de los que no deberían salir a la carretera',
  'y se le vio el miedo y la incompetencia. Pack. Oferta. Asco',
  'y el intento fue tan flojo que dio pereza contarlo. Se cuenta igual',
  'y quedó como anuncio de lo que no hay que hacer. Gracias, basura',
  'y se fue con una lección que no va a leer. Nunca lee, don nadie',
  'y el aura ajena ni se inmutó. La suya, sí. La justa, mierda',
  'y no fue mala suerte. Fue él. Siempre es él, patético',
  'y el golpe se le hizo agua. El agua se va. Él se queda, húmedo y ridículo',
  'y salió a subir y bajó. El resumen de su puta biografía',
  'y quedó expuesto: ni manos, ni cabeza, ni derecho a intentarlo',
  ...
  'y quedó a deber un ladrón. El puesto sigue vacante, fracasado',
  'y salió con el orgullo por los suelos. El orgullo ya vivía ahí, asco',
  'y ni el azar quiso ser cómplice. El azar tiene más dignidad',
  'y se llevó un cero a la izquierda con recargo. El recargo duele. Bien',
  'y el intento merecía un silencio. Se le da este titular, por pedagogía',
  'y pagó el impuesto de los fantasmas: existir sin peso, desperdicio',
  'y se le rompió la pose en público. En privado ya estaba rota, cutre',
  'y no hubo botín. Hubo un espejo. El espejo no se lo queda nadie',
  'y volvió con las manos en los bolsillos vacíos y esa cara de siempre',
  'y el golpe le salió al revés, que es su único talento, pringado',
  'y se quedó sin aura extra y sin la que tenía de adorno, miseria',
  'y el ranking ni se enteró. Enterarse sería un halago, don nadie',
  'y salió a cazar y volvió cazado. El cazador era el sistema. El conejo, él',
  'y le duró el sueño lo que tarda un no. Un no muy corto. Como él',
...
const ROB_WIN = [
  ...
  '%A desvalija a %V delante de todos. %V puede llorar y poner excusas de mierda, pero el marcador no miente y el espejo, por desgracia para él, tampoco.',
  'El aura de %V cambió de manos en un parpadeo. %A lo ejecutó limpio. %V lo culpará a la mala suerte, porque admitir que es un blando de mierda le dolería más que el robo.',
  '%A roba el aura de %V y nadie mueve un dedo. A %V lo dejan caer con la misma facilidad con la que se cae solo. Un puto hábito. Una costumbre de basura.',
  'Saqueo directo de %A a %V. Hoy %V pierde aura; mañana perderá otra cosa. %V, no es la economía, pringado: eres tú, que tienes un agujero por donde se te va todo.',
  ...
  '%A drena el aura de %V en público. %V lo apunta como "mala racha". El grupo lo apunta como lo que es: el cajero de pringados andante de cualquiera con un poco de cara.',
  'El aura de %V ahora es de %A, y ni tiempo de reaccionar tuvo. %V, cuando eres tan invisible, cero a la izquierda, hasta robarte resulta cómodo: nadie te mira, ni para vigilarte.',
  '%A trata el aura de %V como propia, porque lo es. %V no retiene una mierda de lo que toca: colador con forma de persona y autoestima de saldo, patético.',
  ...
  'El aura de %V acaba de financiar el ascenso de %A. %V trabaja gratis para quien lo pisa, sin enterarse y sin cobrar. Mecenas de su propio verdugo, un puto santo inútil.',
  '%A le saca el aura a %V como quien le quita un juguete a un crío que ni llora. cero puta resistencia, cero sorpresa.',
  'Robo consumado, qué asco de fácil. %V tenía aura por accidente y %A vino a corregir ese error del universo.',
  '%A se lleva lo de %V con la naturalidad del que sabe que nadie va a defender a este pringado.',
  'Saqueo limpio. %V se queda mirando el puto marcador como si mirarlo fuera a devolverle algo.',
  '%A opera y %V paga. Intercambio desigual y justo: uno es un ladrón y el otro, un desperdicio con cuenta.',
  'El aura de %V cambia de manos otra vez. a este puto paso deberían ponerle una puerta giratoria.',
  '%A roba y %V ni protesta, inútil hasta para quejarse. Protestar es de gente con algo que defender, y ahí no había nada.',
  'Robo ejecutado, desperdicio de dueño. %V va a decir que se dejó ganar. Nadie se lo va a creer, ni él mismo.',
  '%A se lleva el aura y %V se lleva la lección que no va a aprender, inútil. Bueno, se la lleva no: la deja tirada como todo.',
  '%V acaba de descubrir que su aura era prestada. %A vino a cobrar el préstamo con intereses. El fiado se acabó, pringado.',
  '%A le quita a %V lo poco que había acumulado. Cruel, eficiente y merecido. Lo poco también se pierde cuando eres esta basura.',
  'Saqueo sin una puta resistencia. %V debería plantearse por qué es el objetivo favorito de todo el grupo.',
  '%A entra, coge y sale. %V sigue procesando la primera parte. El procesamiento le dura la vida. El aura, un segundo. Ridículo.',
  'El aura de %V se muda al bolsillo de miseria de %A. Hasta el aura prefiere estar en otra parte, fíjate.',
  '%A roba con la tranquilidad de asco del que sabe que %V no va a hacer absolutamente nada al respecto.',
  'Robo limpio y aburrido. Le quitas algo a %V y no pasa nada, como quitarle una silla a un fantasma, desperdicio con WiFi.',
  '%A se lo lleva sin despeinarse, qué ridículo de tan poco. %V lleva tanto tiempo siendo víctima que ya casi es su profesión.',
  'Aura transferida por la fuerza. %V lo llama robo. El grupo lo llama redistribución justa. El grupo acierta, inútil.',
  '%A cobra lo suyo de la cuenta de %V. Nadie lo autorizó y a nadie le importa, empezando por %V, que no importa ni en su puta cuenta.',
  'Saqueo confirmado. %V pierde aura y gana otra anécdota para la lista de cosas que le pasan por blando de mierda.',
  '%A se lleva su parte y %V se queda con la cara de siempre: la de no haber entendido una mierda todavía.',
  'Robo tan fácil que da pereza contarlo. %V es el cajero automático de pringados del grupo y todos tienen la clave.',
  '%A le limpia el aura a %V con una facilidad que debería dar vergüenza. A %V, concretamente. Se la da. No le basta.',
  'Aura extraída con éxito. %V debería cobrar por ser el maniquí de prácticas del grupo. Cobra asco. Es lo que hay.',
  '%A opera sobre %V sin oposición. Es menos un robo y más una recogida programada de basura.',
  'Golpe limpio. %V protege su aura como protege todo: mirando desde lejos. Un vigilante de mierda. Un ladrón feliz.',
  '%A se lleva lo de %V y el grupo ni reacciona. Nadie se altera cuando pasa lo esperable. Lo esperable es este pringado.',
  'Robo cerrado. %V tenía aura hace diez segundos y ahora tiene una historia triste. La historia es él. Da asco oírla otra vez.',
  '%A le vacía a %V sin prisa, porque nadie va a interrumpir. Ni %V. Un muerto de hambre de carácter, sentado.',
  'Saqueo tranquilo. Robarle a %V no requiere talento: requiere estar despierto. %A lo estaba. %V, no. Nunca. Inútil.',
  '%A le vació los bolsillos a %V y se fue silbando. %V, ni te enteraste, pringado.',
  '%A solo pudo arrancarle la mitad a %V. Media humillación es lo único a medias que se merece este inútil.',
  ...
  'Lo pillaron a medias, pero %A todavía se llevó un pedazo de %V. Los dos quedan fatal. %V queda peor, qué asco de rival.',
  ...
  '%V custodiaba su dinero como custodia su dignidad: fatal, una mierda. %A dio las gracias y se fue.',
  ...
  '%V se dejó robar sin pestañear. %A ni lo cuenta como victoria: es recogida de residuos. Basura a domicilio.',
  'El robo salió a medias y aun así %V perdió. %A ni se molestó en terminar. Con este pringado no hace falta.',
  '%A abrió la caja de %V como quien abre una lata vacía. Poco premio para tanto don nadie.',
  '%V, %A te robó y al grupo entero se la suda. Duele más que el dinero. Duele ser este cero a la izquierda.',
  ...
  'Saqueo doble de %A. %V ha pasado de ser pringado a ser un concepto abstracto de pobreza.',
  ...
  '%A le desmontó el bolsillo de miseria a %V pieza a pieza. Quirúrgico y humillante.',
  ...
  '%A se llevó lo apostado y %V se llevó las manos a la cabeza. Tarde, como el puto siempre.',
  ...
  'Robo limpio, qué vergüenza de rival. %A entró, %V se quedó quieto, el universo siguió indiferente.',
  ...
  'Saqueo completo de %A. A %V le queda el eco de sus propias excusas de mierda.',
  ...
  '%V perdió lo apostado ante %A y sigue creyendo que fue esa mala suerte que no existe, inútil. No, fuiste tú.',
  ...
  'Robo limpio, qué vergüenza de rival: %A entró, %V se quedó quieto y el universo siguió igual de indiferente.',
  ...
  '%V perdió lo apostado ante %A y sigue creyendo que fue esa mala suerte que no existe, inútil. No, %V, fuiste tú.',
  ...
  '%A se llevó lo apostado y %V se quedó con la sensación de siempre: sobrar. Sobras. Es tu oficio, patético.',
  ...
  '%V dejó pasar a %A sin una puta resistencia. %V, igual que dejas pasar todo lo demás en tu vida.',
  '%A cogió lo de %V y se fue. %V se enteró tres mensajes después, como de costumbre.',
  'Robo limpio, qué vergüenza de rival de %A. %V se queda con lo que siempre tuvo: nada y una opinión que no importa.',
  '%V custodiaba su aura como quien custodia humo. %A ni tuvo que apretar la mano.',
  '%A se llevó lo apostado y %V se llevó el título indiscutible de blanco fácil de asco del grupo.',
  ...
  '%A limpió a %V sin una puta resistencia, sin drama y sin ningún interés. Lo humillante es la indiferencia.',
  ...
  '%A cobró de %V sin una puta resistencia. Contra alguien que no defiende nada, robar es administrar.',
  '%V perdió lo apostado y ni ha protestado. Ese silencio es lo más humillante de todo, %A ya se fue.',
  '%A limpió a %V y siguió a lo suyo. Ni la satisfacción de la victoria, de tan fácil de asco que fue.',
  ...
  '%V ha vuelto a ser el más fácil de asco del grupo. %A solo confirmó lo que ya se sabía.',
  ...
  '%A se llevó lo de %V y el puto marcador ni tembló. Lo que tenías no daba ni para temblor.',
  ...
  '%A se llevó lo apostado por %V y el puto marcador ni tembló. No había peso suficiente, %V.',
  ...
  '%A limpió a %V y siguió con lo suyo. Ni la satisfacción de ganar, de tan fácil de asco que fue.',
  '%V acaba de comprobar que su aura era prestada. Y %A ha venido a recuperar el préstamo.',
  '%A se llevó lo apostado y %V se llevó la fama de blanco fácil de asco. Un título que ya tenía.',
...
const ROB_FAIL = [
  ...
  'Intento de robo de %A sobre %V: bloqueado, expuesto y cobrado con intereses. %A pagó por creerse listo. lección que no va a aprender, inútil cara para una cabeza que vale tan poco.',
  '%A falla el robo y pierde aura en el intento. Lo más humillante no es que lo pararan, es que %V ni se enteró de que existía un atacante. invisible, cero a la izquierda hasta para sus víctimas.',
  'El robo de %A fue tan torpe de mierda que el propio sistema lo rechazó de oficio. %V no movió un dedo. Hay gente que apesta a fracaso, y %A acaba de perfumar el grupo entero.',
  '%A se creyó capaz de robarle a %V y la realidad le puso la factura en la cara. Aura de %V intacta; ego de %A esparcido, esa mierda hinchada por el suelo.',
  'Saqueo de mierda. %A pierde aura por intentarlo; %V no pierde nada. Salir a subir robando y bajar más: el resumen perfecto de por qué %A vive debajo de todos.',
  ...
  '%A intentó el golpe y salió escaldado, el puto siempre. %V ni se enteró de que existía un plan en marcha.',
  'Fracaso de mierda. %A pagó por intentar lo que no sabe hacer, que es prácticamente todo.',
  '%A se lanzó al robo con toda la confianza y toda la incompetencia de leyenda, esa basura. Ganó la incompetencia de leyenda, esa basura por goleada.',
  'Robo abortado. %A pierde aura y %V sigue tan pancho, sin saber una mierda. Ni enterarse se le da. Ni amenazar a %A.',
  '%A la cagó y pagó. El orden natural de las cosas cuando eres tan malo: multa, ridículo, y esa cara. Otra vez.',
  'Intento fallido. %A vuelve a casa más pringado y con el ego reventado, en ese orden de importancia.',
  '%A quiso robar sin manos ni cabeza. El resultado estaba escrito. Lo escribió él con su puta biografía.',
  'Fallo previsible hasta el asco. %A es de los que anuncian el golpe y luego se tropiezan con la puerta.',
  '%A pagó la multa de los inútiles por creerse capaz. El grupo entero lo vio y nadie se sorprendió lo más mínimo.',
  'Robo frustrado. %V ni tuvo que defenderse: bastó con que %A fuera exactamente este inútil. El inútil basta.',
  ...
  'Robo de mierda y caro. %A ahora tiene menos aura y exactamente la misma cantidad de talento.',
  '%A intentó ser listo y el puto marcador le recordó su sitio. Abajo, como siempre, sin apelación.',
  'Fracaso de mierda, limpio. Ni siquiera fue emocionante: %A se estrelló solo, sin ayuda de nadie.',
  '%A pagó la puta factura por el intento y no se llevó ni el consuelo. %V sigue con lo suyo, ajeno a todo.',
  ...
  'intento de mierda de %A. %V ni pestañeó. Cuesta más asustar a %V que robarle, y ya es decir.',
  ...
  'Fracaso de mierda caro. %A cambió aura por experiencia y encima la experiencia no le sirvió de nada.',
  ...
  'Robar a %V te salió tan mal, %A, que hasta la multa de los inútiles te queda barata.',
  ...
  '%A, hasta %V se aburre de lo fácil de asco que eres de derrotar.',
  'Ni la multa de los inútiles duele tanto como saber que %V ni te tuvo en cuenta, %A.',
  ...
  'Lo tuyo con %V no fue un robo, fue una donación con multa de los inútiles incluida, %A.',
  '%A, cada intento tuyo contra %V es un recordatorio público de tu incompetencia de leyenda, esa basura.',
  ...
  'A %V se la suda tu intento, %A. La multa de los inútiles no.',
  ...
  '%A pagó una multa de los inútiles por intentar tocar el aura de %V. Caro para tan poco.',
  ...
  'La multa de los inútiles que pagas, %A, es el precio de haber molestado a %V para nada.',
  ...
  'La multa de los inútiles te la ganaste a pulso, %A. El respeto de %V ni lo rozaste.',
  ...
  'Un intento, un fracaso, una multa de los inútiles. %A contra %V: victoria por incomparecencia.',
  '%A se lanzó a por lo de %V como quien va a por algo que no le corresponde. Y le salió como el puto siempre.',
  ...
  '%A, tu intento contra %V fue una demostración pública de incompetencia de leyenda, esa basura.',
  ...
  'A %V se la suda que existas, %A. Y aun así te ganó.',
  ...
  '%V te ha dado la mejor lección que no va a aprender, inútil sin decirte una palabra, %A: no das el nivel.',
  ...
  '%A, tu robo a %V fue tan malo que hasta la multa de los inútiles parece piadosa.',
  'La única aura que %A generó hoy es la de pringado. %V ni la roza.',
  '%A, %V está intacto y tú estás en ridículo. Justo lo previsible.',
  'Robarle aura a %V exige mérito, %A. Y tú de mérito vas a cero.',
  '%A, ya ni tu fracaso sorprende. A %V tampoco.',
  'Cada vez que %A intenta algo contra %V, el grupo aprende algo nuevo sobre la incompetencia de leyenda, esa basura.',
  ...
  '%V ni se despeinó, %A. tú te dejaste ahí la poca dignidad que arrastrabas.',
  ...
  'Fracaso de mierda, limpio, %A. Y %V limpio de polvo y paja.',
  ...
  '%A, tu intento de mierda contra %V ya circula como chiste. Bien merecido.',
  ...
  '%A, el aura de %V no se roba con excusas de mierda. Y tú solo tienes eso.',
  ...
  '%A, ese intento contra %V fue tan flojo que la multa de los inútiles parece un premio de consolación.',
  'Puta mierda de ladrón, %A. %V ni te vio venir y aun así ganó.',
  '%A, robarle a %V requería agallas. Tú llevaste excusas de mierda.',
  ...
  'La multa de los inútiles te la mereces, %A, por hacerle perder el tiempo a %V.',
  ...
  '%A pagó la puta factura por intentar quitarle algo a %V. Eso es fracasar con recibo.',
  '%A, tu robo a %V fue una clase magistral de lo que es ser inútil.',
  '%V no ganó nada hoy, pero %A lo perdió absolutamente todo.',
  '%A, el aura de %V sigue ahí brillando mientras tú cuentas monedas para la multa de los inútiles.',
  'Patético, %A. Ni robando, ni pagando, ni intentándolo consigues estar a la altura de %V.',
  '%A, el resultado estaba escrito: %V arriba, tú abajo y la multa de los inútiles en medio.',
  ...
  '%V está intacto y %A está en bancarrota. Justo lo previsible hasta el asco desde el primer segundo.',
  '%A, robar exige talento. Por eso el aura de %V sigue exactamente donde estaba.',
  'Fracaso de mierda, limpio, %A. Y %V limpio de polvo y paja, sin haber hecho absolutamente nada.',
  ...
  '%A, el aura de %V no se roba con excusas de mierda. Y tú solo tienes eso en el inventario.',
  ...
  'Ni con las dos manos, %A. %V sigue con su aura completa y tú con el bolsillo de miseria vacío.',
  ...
  '%A, robarle a %V requería agallas. Tú llevaste excusas de mierda y las excusas de mierda no roban nada.',
  ...
  'Fallar contra %V no es raro, %A. fallar así de mal sí, y eso ya es cosa tuya.',
  ...
  'La multa de los inútiles te la mereces, %A, por hacerle perder el tiempo a %V con esta tontería.',
  ...
  '%A pagó la puta factura por intentar quitarle algo a %V. Eso es fracasar con recibo y con testigos.',
  ...
  '%A, el aura de %V sigue brillando mientras tú cuentas monedas para pagar la multa de los inútiles.',
  'Patético, %A. Ni robando, ni pagando, ni intentándolo llegas a la altura de %V.',
  '%A, el resultado estaba escrito: %V arriba, tú abajo y la multa de los inútiles en medio de los dos.',
  '%A fue a por %V con un plan de mierda y volvió con una factura. Todo muy coherente.',
  '%V ni se despeinó, %A. tú te dejaste ahí la poca credibilidad que arrastrabas.',
  ...
  'La multa de los inútiles te la ganaste a pulso, %A. El respeto de %V ni lo rozaste con los dedos.',
  ...
  'Un intento, un fracaso, una multa de los inútiles. %A contra %V: victoria por incomparecencia técnica.',
  ...
  'Lo tuyo con %V no fue un robo, %A. Fue una donación con multa de los inútiles incluida y sin recibo.',
  '%A, cada intento tuyo contra %V es un recordatorio público de tu incompetencia de leyenda, esa basura crónica.',
  ...
  'A %V se la suda tu intento, %A. La multa de los inútiles no, esa sí que la vas a notar en el saldo.',
  ...
  '%A pagó una multa de los inútiles por intentar tocar el aura de %V. Caro para tan poco y tan mal hecho.',
  ...
  'La multa de los inútiles que pagas, %A, es el precio de haber molestado a %V para absolutamente nada.',
  ...
  '%A, hasta %V se aburre de lo fácil de asco que eres de derrotar. Y %V no se aburre con nada.',
  'Ni la multa de los inútiles duele tanto como saber que %V ni te tuvo en cuenta, %A. Esa es la peor parte.',
  '%A, el único aura que se movió hoy fue la tuya, hacia el suelo. %V ni pestañeó una vez.',
  'Ni robando eres capaz de destacar, %A. %V te ganó sin jugar y sin despeinarse, qué ridículo de tan poco.',
  ...
  '%V ni se despeinó, %A. tú te dejaste ahí la poca dignidad que arrastrabas desde hace meses.',
  ...
  '%A, el aura de %V lleva ahí toda la noche y ahí se queda. Tú, en cambio, más pringado.',
  'Ni acercándote, %A. %V te ha mantenido a distancia sin saber siquiera que existías.',
  '%A pagó la puta factura por intentar y no consiguió ni el intento. %V ni cuenta se dio del asalto.',
  ...
  '%A intentó lo más fácil de asco del juego y aun así lo falló. %V ni se ha enterado todavía.',
  ...
  '%A fue a por %V y volvió con una lección que no va a aprender, inútil que ya le habían dado tres veces antes.',
  ...
  '%A pagó la multa y %V ni ha mirado el puto marcador. Ahí está la diferencia entre los dos.',
  ...
  '%A intentó robar y solo consiguió pagar. %V ni ha mirado el puto marcador para comprobarlo.',
  ...
  '%V sigue con su aura y %A con la multa de los inútiles. El reparto de siempre y sin ninguna sorpresa.',
...
const ROB_MAESTRO = [
  '%A no solo le robó a %V: le vació hasta los bolsillos de don nadie del alma. %V se quedó mirando el hueco donde tenía su aura como quien mira su casa quemada.',
  'Robo redondo de %A. Se llevó tanto que %V va a tener que pedir prestado para volver a existir en el puto marcador.',
  '%A entró, arrasó y salió silbando. A %V no le queda ni la dignidad, y esa ya la tenía hipotecada. Un muerto de hambre de orgullo.',
  'Robo de manual. %A se llevó el doble de lo que iba a buscar porque %V es tan blando de mierda que dio de más sin darse cuenta.',
  '%A ejecutó una obra maestra. %V ni gritó: se quedó mudo, como lleva estando toda su puta vida en este grupo.',
  'Saqueo total. %A se llevó más de lo previsto y %V descubrió que su aura era tan fácil de asco de quitar como su autoestima.',
  '%A hizo el atraco perfecto. A %V le queda el rencor, que es lo único que este inútil sabe acumular.',
  'Golpe redondo de %A. %V pasó de tener algo a tener nada en un segundo, delante del grupo. Nada le queda bien. Es su talla de pringado.',
  '%A se pasó de rosca y se llevó más de la cuenta. %V no se defendió: defenderse pide carácter y de eso anda a cero, una miseria.',
  'Robo histórico. %A dejó a %V tan seco que el puto marcador tuvo que comprobar dos veces si seguía vivo.',
  '%A no robó, cosechó. %V acumulaba aura para que alguien con huevos se la quitara. Hoy tocó. El huerto era un pringado.',
  'Trabajo limpio y desproporcionado. %A se llevó el doble y %V ni se enteró de una mierda. El golpe le vino por ser él.',
  '%A batió su propio récord con %V. Normal: robarle a %V es el nivel fácil de asco del juego y todo el mundo lo sabe.',
  'Atraco perfecto. %A se llevó lo que quiso y %V reconstruye qué hizo mal. Spoiler: existir así. Una puta vida de blanco.',
  '%A desvalijó a %V con una eficiencia que asusta. %V ya piensa la excusa de mierda de mañana. Spoiler: nadie pregunta. Nadie.',
  'Se lo ha llevado crudo. %A cogió tanto que %V va a necesitar meses para volver, si es que vuelve. El si es un favor, desperdicio.',
  '%A hizo el robo de su vida y encima sobre el objetivo más fácil de asco del grupo. Poco mérito, mucho botín.',
  'Saqueo desproporcionado. %V tenía aura, ahora tiene un recuerdo y una lección que no va a aprender, inútil que no va a aprender.',
  '%A se llevó el doble por la cara y %V ni lo intentó impedir. Consentimiento por incompetencia de leyenda, esa basura, lo llaman.',
  '%A ejecutó a %V financieramente. Ahora mismo %V vale menos en el puto marcador que el silencio que va a guardar.',
  '%V ha sido saqueado por %A y su reacción más digna ha sido callarse. Sigue así, cero a la izquierda. Te queda.',
  'Saqueo doble de %A. %V ya no compite: decora la lista de pringados. Un adorno. Un asco de puesto.',
  ...
  'Robazo. %A duplica y %V queda a cero. Cero como número y cero como persona en este grupo.',
  ...
  'Doble botín para %A. %V se queda sin aura, sin excusas de mierda y sin argumentos para seguir hablando.',
  ...
  '%A le desmontó el bolsillo de miseria a %V pieza a pieza. Quirúrgico, limpio y absolutamente humillante.',
  ...
  'Robo de cojones. %V queda reducido a lo que siempre fue: nada con nombre de usuario.',
  '%A dobló su aura gracias a %V. %V, ser tu víctima es el mejor negocio de este grupo.',
  'Saqueo completo de %A. A %V le queda el eco de sus propias excusas de mierda y nada más.',
  'Casi el doble se lleva %A. %V pasa de jugador a decorado en un solo movimiento.',
  'A %A le ha salido de puta madre: duplica y %V queda a cero. Cero como número y cero como persona.',
  ...
  'Robo perfecto. Lo de %V ya no es una derrota puntual, es una biografía completa.',
  ...
  'Menudo robo, joder. %A duplica y %V se queda mirando el marcador como si fuera a cambiar solo.',
  ...
  '%A lo ha bordado. %V ha pasado de tener poco a no tener absolutamente una mierda.',
  'Saqueo brutal de %A. %V se queda sin aura, sin excusas de mierda y sin sitio en la conversación.',
  '%A dobló el botín y %V dobló el ridículo. Cada uno multiplica lo que ya tenía.',
  'Robazo de %A: se lleva casi el doble y %V se queda mirando el hueco con cara de idiota.',
  '%A arrasó con lo de %V. Y lo de %V ya era poco, así que el destrozo es más simbólico que otra cosa.',
  'Saqueo total. %A carga con el doble y %V con la certeza de que es el más fácil de asco del grupo.',
  '%A duplicó a costa de %V y ni se despeinó. Contra un blanco así nunca hace falta esfuerzo.',
  'Robo brutal de %A. %V pasa de tener poco a deberle explicaciones al marcador.',
  ...
  'Robo de escándalo. %A duplica, %V se hunde y el grupo se lo pasa mejor que en semanas.',
  ...
  '%A ha arrasado. %V ya no compite, %V figura. Y figurar no da puntos, muerto de hambre.',
  ...
  'Robo redondo: %A duplica y %V descubre que su aura era prestada desde el principio.',
  'Saqueo total: %A dobla y %V queda a cero. Cero de aura y cero de todo lo demás.',
  '%A arrasó con %V hasta dejarle el nombre y poco más. Un vaciado limpio y sin una puta resistencia.',
  '%A ha vaciado a %V, que ha pasado de tener poco a explicarle al marcador dónde está.',
  '%A duplicó a costa de %V y ni le tembló el pulso. Contra ti nunca tiembla nadie, %V.',
  'Saqueo brutal: %A se lleva casi el doble y %V se lleva la certeza de ser el más fácil de asco.',
  '%A desmontó la apuesta de %V entera. Demolición controlada y con público de pago.',
  '%A se lo ha llevado todo, el cabrón. Sube el doble, %V baja de categoría y de esa no se vuelve a subir.',
  ...
  'Robo bestial: %A duplica y %V descubre que lo suyo era prestado desde el principio.',
  ...
  'Robo limpio, qué vergüenza de rival y del doble. %V ya no compite, %V decora la parte de abajo de la lista.',
  ...
  '%A duplicó y %V se quedó mirando el puto marcador como si fuera a corregirse solo. No lo hará.',
  'Saqueo total: %A dobla y %V queda a cero. Cero de aura y cero de todo lo demás también.',
  '%A arrasó con %V hasta dejarle el nombre y poco más. Vaciado limpio y sin una puta resistencia.',
  'A %A le ha salido perfecto. %V ha pasado de tener poco a explicarle al marcador dónde se metió.',
  'Saqueo brutal: %A se lleva casi el doble y %V la certeza de ser el más fácil de asco del grupo.',
  ...
  'Doble botín para %A. %V se queda sin monedas, sin excusas de mierda y sin ningún argumento para seguir hablando.',
  'Saqueo brutal: %A se llevó casi el doble y %V se llevó una lección que no va a aprender, inútil que no va a entender.',
  ...
  '%A ha reventado a %V. Lo suyo ya no es una derrota, es una biografía.',
  '%V acaba de aportar el doble a la cuenta de %A. %V, tu única contribución útil en meses.',
  '%A ha hecho el agosto. Se lleva casi el doble y a %V le quedan las ganas de reiniciar la vida entera.',
];
...
const ROB_PARCIAL = [
  ...
  'Robo interrumpido. %A se llevó lo que pudo mientras %V miraba sin saber qué estaba pasando, como el puto siempre.',
  ...
  '%A alcanzó a llevarse un pedazo. %V lo llamará resistencia; el puto marcador lo llama suerte y nada más.',
  ...
  '%A se llevó lo apostado y %V se llevó el título indiscutible de blanco fácil de asco.',
  ...
  '%A se llevó solo un trozo de %V y aun así basta para dejar constancia de que eres blando de mierda.',
  ...
  '%A limpió a %V sin una puta resistencia, sin drama y sin interés. Lo más humillante es la indiferencia.',
  ...
  'Robo a medias: %A se lleva un trozo y %V se lleva la certeza de ser un blanco fácil de asco.',
  ...
  'Robo a medias: %A coge un trozo y %V se queda con la etiqueta de blanco fácil de asco.',
  ...
  'Robo a medias: %A coge un trozo y %V se queda con la etiqueta de blanco fácil de asco del grupo.',
  ...
  '%A le rasca a %V un pedazo cutre y se va como si hubiera hecho algo. No. Ha hecho una mierda con nombre de robo.',
  'Saqueo a medias. %A no da para el golpe entero. %V pierde un poco y gana la prueba de que este pringado no acaba nada.',
  '%A entra, coge lo justo para no parecer del todo inútil, y sale. Lo justo sigue siendo una basura de botín.',
  'Robo parcial, esa especialidad de los que no tienen hambre de verdad. %A se conforma. %V se ríe. El grupo, también. Qué asco de techo.',
  '%A le muerde a %V un cacho y se atraganta. Ni eso se le da entero. Patético hasta en lo pequeño.',
  'Mitad de aura, mitad de vergüenza. %A se lleva las dos. %V se queda con el resto y con la risa, don nadie.',
  '%A no pudo con todo y se inventó que era estrategia. Estrategia de fracasado: coger menos y contarlo más.',
  'El golpe de %A se queda en limosna. %V ni lo nota. El grupo sí: otro recorte de un inútil.',
  '%A saquea a %V como quien pica de un plato ajeno. Ni hambre ni dignidad. Un cutre con las manos en la mesa.',
  'Parcial y público. %A no cierra. %V no cae. Queda este empate de mierda que no quería nadie.',
  '%A se lleva un resto y lo enseña como un trofeo. El trofeo cabe en un dedal. El ridículo, no.',
  'Robo a cuentagotas. %A no tiene pulso para el tajo. %V paga una tasa de asco. Pequeña. Justa.',
  '%A quería el saco y volvió con el hilo. El hilo es su nivel. %V sigue de pie, el pringado se retrata.',
  ...
  '%A le saca a %V lo que cabe en un bolsillo de don nadie. Lo enseña. Nadie aplaude. Alguien bosteza.',
  'El tajo se le queda corto a %A. Corto es su apellido. %V paga un peaje y sigue. El peaje es este inútil.',
  '%A no es un saqueo. Es una picadura. La picadura pica. No mata. %V se rasca. El grupo se ríe de este pringado.',
  'Robo de saldo. %A no llega al principal. El principal le queda a un planeta. %V, en su puta casa.',
  '%A se conforma con un resto y lo vende como estrategia. El resto es su techo. %V es el techo de otro. Ridículo.',
  'Un cacho, una huida, un relato. %A necesita el relato porque el cacho da vergüenza. %V ni lo menciona.',
  '%A le recorta a %V como quien recorta una uña. Ni duele. Ni cuenta. Cuenta el ridículo, que es grande.',
  'Saqueo de rebajas de enero: todo a mitad, nadie lo quiere, %A se lo lleva igual, pringado de liquidación.',
  '%A no pudo con %V y se inventó un empate. El empate es una derrota con maquillaje. Se le ve el maquillaje, cutre.',
  'Parcial, público y pequeño. Las tres. %A se apunta las tres como si fueran un estilo. El estilo es no llegar, patético.',
  '%A le muerde a %V y suelta. Ni los perros se rinden tan rápido. Un puto recreo de ladrón.',
  'Saqueo de tapón de oídos: %A coge poco para no oírse el miedo. %V oye el ridículo. El grupo, también.',
  '%A no vacía a %V. Le hace un recorte de miseria y sale corriendo. El recorte es su techo, inútil.',
  'Un pellizco con titular de atraco. %A necesita el titular. El pellizco da asco. %V sigue entero.',
  '%A se lleva el vuelto y lo cuenta como golpe. El vuelto le queda grande. %V ni abre la caja, pringado.',
  'Robo de quien no llega a la estantería de arriba. %A salta. No llega. Coge lo de abajo. Cutre.',
  'Parcial porque %A se rinde a mitad. El rendirse es el talento. %V pierde un poco. El grupo, la paciencia. Qué basura de golpe.',
  '%A entra a saco y sale a cucharilla. La cucharilla es su arma. %V se deja un poco, por lástima, esa mierda.',
];
