...
const ROB_WIN = [
  ...
  'Robo consumado. %A entró, cogió el aura de %V y se fue silbando. %V puso la cara que pone cuando le explican un chiste: la de no haberlo pillado.',
  ...
  '%A le quita el aura a %V con la facilidad de quitarle un caramelo a un niño. La diferencia es que el niño al menos protesta; %V solo parpadea, confundido.',
