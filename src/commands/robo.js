...
const ROB_WIN = [
  ...
  '%A entró a por el aura de %V y salió con ella en el contador. El chat no necesita narrador ni subtítulos de mierda,.',
  ...
  'El aura de %V cambió de manos en público. Las manos son las de %A. Hostia puta, qué nivel.',
...
const ROB_MAESTRO = [
  ...
  '%A le dejó a %V el contador en cero y este mensaje de recibo del bot, joder. El ranking no ofrece descuento.',
  'Maestro de puta madre: empty total firmado en público del ranking, mierda. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A vs %V terminó con cero en %V y el botín en %A del contador, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el aura de %V al completo sin temblar en el hilo, coño. Qué asco de atraco. Hostia puta, qué nivel.',
  'Robo total. %A ejecuta, %V firma el vacío, el chat mira el ranking, gilipollas. Archivo cerrado. Qué asco de atraco.',
  '%A entró en silencio y salió con todo el aura de %V del contador, patético. El ranking no ofrece descuento.',
  'Maestro en público sin filtro ni narrador emocional del comando, asco. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A no dejó residuo de aura en la cuenta de %V del ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: empty account. Archivo cerrado sin segunda lectura, ridículo. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A se llevó el 100 %. Recibo colgado en este hilo del puto grupo, fracasado. Archivo cerrado. Qué asco de atraco.',
];
...
const ROB_PARCIAL = [
  ...
  'Robo a medias firmado sin anestesia en el puto grupo del ranking, fracasado. Archivo cerrado. Qué asco de atraco.',
  '%A picó sin rematar y el ranking de %V sangró igual de claro, joder. El ranking no ofrece descuento. Qué asco de atraco.',
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana el gag, mierda. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A vs %V terminó a medias en botín y entero en fail de %V, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró lo que pudo sacar. %V notó cada unidad del contador, coño. Qué asco de atraco. Hostia puta, qué nivel.',
  'Robo parcial limpio. El bot firma y %V calla en el hilo del grupo, gilipollas. Archivo cerrado. Qué asco de atraco.',
  '%A entró, tomó tajada y salió. %V con el hueco a medias del ranking, patético. El ranking no ofrece descuento.',
  'Parcial documentado delante de todos sin narrador ni subtítulos, asco. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja del contador, basura. Sin derecho a apelación.',
  '%A vs %V: el medio atraco con firma completa en el ranking del chat, ridículo. Qué asco de atraco. Hostia puta, qué nivel.',
  '%A se llevó una porción y dejó a %V con la lección a medias, fracasado. Archivo cerrado. Qué asco de atraco.',
];
