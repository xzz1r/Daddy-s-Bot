...
const ROB_MAESTRO = [
  ...
  'Robo redondo de %A. Se llevó tanto que %V va a tener que pedir prestado para volver a existir en el marcador.',
  ...
  'Se lo ha llevado crudo. %A cogió tanto que %V va a necesitar meses para volver, si es que vuelve.',
  ...
  'Robo limpio y del doble. %V ya no compite, %V decora la parte de abajo de la lista.',
