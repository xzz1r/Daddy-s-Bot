...
const ROB_MAESTRO = [
  ...
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el contador del chat, mierda. El chat ya tomó nota.',
  '%A vs %V: clínica. El botín viajó entero. y el grupo lo vio. sin filtro, cabrón. Sin derecho a apelación.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V en. el ranking, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  '%A entró como sombra y salió con el aura completa de %V del contador, asco. El chat ya tomó nota. Qué asco de atraco.',
  'Maestro documentado. Autor %A, víctima total %V, testigo el puto grupo, basura. Sin derecho a apelación.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo para %A en. el ranking, ridículo. Y se nota a la legua.',
  ...
  'Maestro de puta madre: el contador de %V a cero en un solo golpe, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A cobró el aura de %V como quien cobra una deuda vieja del ranking, cabrón. Sin derecho a apelación.',
  'Robo maestro. %V ni activó defensa porque no hubo tiempo de reaccionar, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro limpio en. el ranking y sucio para el ego de %V del chat, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A ejecutó, cobró y cerró el parte a favor sin temblar en el hilo, basura. Sin derecho a apelación. Qué asco de atraco.',
  'Robo total. %A con todo, %V con nada, el chat de testigo del empty, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro: empty total. %V mira el cero. y el grupo mira a %A, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V clínica total. El botín no dejó residuo en la cuenta de %V, cabrón. Sin derecho a apelación.',
  '%A cobró el 100 % del aura de %V sin pedir la palabra en. el chat, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro documentado. sin filtro del chat, asco. El chat ya tomó nota. Qué asco de atraco y el ranking lo firma, asco.',
  '%A no dejó almost: dejó el empty account de %V en. el ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: 1-0 con botín completo y cero debate útil en el hilo, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro de manual: cero en %V, todo en %A, firma. el ranking del grupo, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó con transfer total y cara de fail en %V, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró todo lo que %V tenía contado de aura en. el ranking, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro en. el ranking. El chat no pide replay porque se vio claro, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no improvisó: vació a %V según plan y el plan salió redondo, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: crónica de un empty account firmado en público, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro limpio. Ni polvo de aura quedó en la cuenta de %V del ranking, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V clínica. Botín entero, defensa inexistente en el comando, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el aura de %V sin dejar almost de consuelo en. el chat, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro documentado. Autor %A, empty %V, archivo el puto grupo, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vació a %V como quien limpia una deuda pendiente del ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: el ladrón no falló ni un frame del atraco total, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro de puta madre en el sentido del botín completo de %A, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó con cero en %V y sonrisa en %A del chat, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el aura entera. %V pagó el curso completo del comando, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro en público. El grupo vio el transfer total. sin filtro, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no dejó residuo: empty account de %V firmado en. el ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: 1-0 sin VAR ni prórroga ni consuelo posible, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro limpio. El botín viajó entero hacia %A en el contador, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V clínica total sin almost de defensa posible en. el chat, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el 100 % y. el ranking no ofreció recurso a %V, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro documentado sin anestesia para %V. delante del grupo, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no falló el empty: lo firmó en el contador de %V del ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: crónica de un atraco total con público en. el chat, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro de manual negro: cero %V, todo %A, firma. el ranking del grupo, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó con transfer total visible en. el chat del grupo, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el aura completa de %V sin pedir turno de palabra, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro en. el ranking. El chat archiva el golpe total sin debate, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vació a %V según plan. El plan no falló un frame del atraco, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: el empty account firmado sin debate útil en. el ranking, ridículo. Y se nota a la legua. Qué asco de atraco.',
  '%A se llevó el 100 % del aura. %V el 100 % del fail del comando, fracasado. Archivo cerrado. Qué asco de atraco.',
  '%A ejecutó el empty de %V. del ranking, joder. El ranking no ofrece descuento. Qué asco de atraco y el ranking lo firma, joder.',
  'Maestro limpio en números y sucio para el ego de %V del chat, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V clínica. Botín entero, defensa en cero del ranking, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró todo lo contado en el aura de %V del comando, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro documentado. Empty %V, botín %A, testigo. el chat entero, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vació a %V sin dejar almost de consuelo en. el ranking del grupo, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: 1-0 total. El ladrón no dudó ni un segundo del golpe, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro de puta madre: empty total firmado en público del ranking, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó con cero en %V y. el botín en %A del contador, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró el aura de %V al completo sin temblar en el hilo, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Maestro en público. sin filtro ni narrador emocional del comando, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no dejó residuo de aura en la cuenta de %V del ranking, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: empty account. Archivo cerrado sin segunda lectura, ridículo. Y se nota a la legua. Qué asco de atraco.',
  '%A se llevó el 100 %. Recibo colgado en este hilo del puto grupo, fracasado. Archivo cerrado. Qué asco de atraco.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió igual y el ranking lo firma, joder.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas del ranking, mierda. El chat ya tomó nota.',
  '%A vs %V: no vacío total, pero. el ranking de %V sangra igual. y el chat lo ve, cabrón. Sin derecho a apelación.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias en público, coño. Y se nota a la legua.',
  ...
  '%A entró, picó y salió con botín incompleto pero real. %V con el hueco a medias, asco. El chat ya tomó nota.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo entero, basura. Sin derecho a apelación.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa en. el chat, ridículo. Y se nota a la legua.',
  ...
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias delante de todos, mierda. El chat ya tomó nota.',
  '%A no fue maestro ni fail: fue el medio que duele igual en el contador, cabrón. Sin derecho a apelación.',
  'Robo parcial. El ranking de %V baja y el de %A sube a medias sin debate, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial limpio en el contador y sucio en la cara de %V. delante del grupo, asco. El chat ya tomó nota.',
  '%A picó, cobró y salió. %V se quedó con el almost de defensa en. el ranking, basura. Sin derecho a apelación.',
  'Robo a medias documentado. delante del grupo. sin filtro ni consuelo, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial: no es el golpe perfecto, pero %V sangra aura de verdad en. el chat, mierda. El chat ya tomó nota.',
  '%A vs %V a medias. El botín no es total y la vergüenza sí lo es, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró tajada incompleta. %V pagó completa en cara. delante del grupo, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial en el contador. El chat vio el transfer a medias sin necesidad de narrador, asco. El chat ya tomó nota.',
  '%A vs %V: el medio duele como el todo cuando se firma en público, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A se llevó una porción. El ranking de %V lo nota igual de claro, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial de puta madre: no vacío, pero el dolor es real para %V en. el chat, mierda. El chat ya tomó nota.',
  '%A vs %V terminó en transfer incompleto y cara completa de fail, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró lo que pudo. %V perdió lo que no quería soltar en. el ranking, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial documentado sin anestesia en. el ranking del puto grupo, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no fue cirujano: fue carnicero a medias y %V sangra igual, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: tajada incompleta, vergüenza completa. delante del chat, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial limpio en números y sucio en el ego de %V del ranking, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V a medio gas. El botín existe y el fail de %V también, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró incompleto. El dolor de %V es completo en el contador, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial en. el ranking. %V lo nota cada vez que mira el contador, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V: crónica del medio atraco con efecto total en la cara, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A se llevó una parte y dejó el almost de defensa en %V, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial de manual negro: tajada real, vacío no, dolor sí para %V, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó a medias en botín y completo en vergüenza, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró lo justo. %V pagó de más en cara del ranking del grupo, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial documentado. El grupo no necesita narrador ni subtítulos, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no fue maestro: fue eficaz a medias y suficiente para doler, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: el medio atraco que duele como el grande en. el ranking, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial: %A gana algo, %V pierde algo, el chat gana el gag del día, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V a medias. Transfer incompleto, veredicto completo, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró tajada. %V firmó el hueco a medias en. el ranking, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial en público. El ranking actualiza y %V se entera tarde, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V: crónica del medio golpe con efecto de hostia en. el chat, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A se llevó lo bastante para que el contador de %V se note, ridículo. Y se nota a la legua. Qué asco de atraco.',
  'Robo a medias. Firmado por. el bot fracasado. Archivo cerrado. Qué asco de atraco y el ranking lo firma, fracasado.',
  '%A picó el aura de %V y. el ranking registró el parcial sin debate, joder. El ranking no ofrece descuento.',
  'Parcial de puta madre en el sentido del dolor a medias de %V, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó con botín incompleto y cara de fail completa, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró. %V perdió. El medio también cuenta en. el ranking del grupo, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial documentado. sin filtro ni consuelo para %V en. el ranking, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no vació: dejó a %V cojeando de aura en el contador del comando, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A vs %V: el atraco incompleto que. el ranking sí completa, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial limpio en el número y sucio para %V. delante del grupo, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V a medio gas con efecto de hostia en. el ranking del chat, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró incompleto y %V pagó completo en vergüenza pública, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial en. el ranking. %V lo mira y se le cae la cara en el hilo, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V: tajada real, vacío no, dolor sí documentado en. el chat, basura. Sin derecho a apelación. Qué asco de atraco.',
  '%A se llevó lo justo. El almost de defensa de %V quedó en almost, ridículo. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial de manual: %A gana, %V pierde a medias, el chat gana el gag, mierda. El chat ya tomó nota. Qué asco de atraco.',
  '%A vs %V terminó a medias en botín y entero en fail de %V, cabrón. Sin derecho a apelación. Qué asco de atraco.',
  '%A cobró lo que pudo sacar. %V notó cada unidad del contador, coño. Y se nota a la legua. Qué asco de atraco.',
  ...
  'Parcial documentado delante de todos sin narrador ni subtítulos, asco. El chat ya tomó nota. Qué asco de atraco.',
  '%A no vació el tanque de %V: lo dejó en la reserva baja del contador, basura. Sin derecho a apelación.',
  '%A vs %V: el medio atraco con firma completa en. el ranking del chat, ridículo. Y se nota a la legua. Qué asco de atraco.',
...
const ROB_DESASTRE = [
  ...
  '%A sin. el botín de %V y sin el suyo. %V con ambos sonidos de caja en el contador. Feliz de asco, El chat ya tomó nota, patético.',
