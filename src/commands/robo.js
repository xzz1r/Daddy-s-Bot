...
const ROB_MAESTRO = [
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking y el ranking lo firma sin debate, mierda.',
  'Maestro de puta madre: el contador de %V a cero en un golpe y el ranking lo firma sin debate, mierda.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió delante del puto grupo, joder.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas y el ranking lo firma sin debate, mierda.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias y el chat ya tomó nota, cabrón.',
  '%A no se llevó todo, pero se llevó lo suficiente para que se note en el contador y en la cara, gilipollas.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa en alta definición del ranking, ridículo.',
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias y el ranking lo firma sin debate, mierda.',
  '%A no fue maestro ni fail: fue el medio que duele igual en el ranking sin anestesia ni consuelo, coño.',
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail en el contador y en la cara, gilipollas.',
  'Robo a medias documentado sin filtro en el ranking del grupo en alta definición del ranking, ridículo.'
];
