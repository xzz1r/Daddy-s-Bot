...
const ROB_MAESTRO = [
  '%A le vació el aura a %V con la precisión de un puto cirujano, joder Qué asco de atraco.',
  'Robo maestro: %A cobró todo y %V ni se enteró hasta el ranking, mierda Qué asco de atraco.',
  '%A vs %V: clínica. El botín viajó entero y el chat lo vio, coño Qué asco de atraco.',
  'Maestro limpio. %A no dejó ni el polvo del aura de %V, cabrón Qué asco de atraco.',
  '%A ejecutó el atraco perfecto. %V firmó el empty account, gilipollas Qué asco de atraco.',
  'Robo de manual negro: %A cobra, %V llora, el ranking firma, patético Qué asco de atraco.',
  '%A entró como sombra y salió con el aura completa de %V, asco Qué asco de atraco.',
  'Maestro documentado. Autor %A, víctima total %V en el ranking, basura Qué asco de atraco.',
  '%A vs %V terminó 1-0 sin prórroga. Botín completo para %A, ridículo Qué asco de atraco.',
  '%A se llevó todo. %V se quedó con el hueco y este mensaje, fracasado Qué asco de atraco.',
  '%A vació a %V en público sin dejar almost ni consuelo, joder Qué asco de atraco.',
  'Maestro de puta madre: el contador de %V a cero en un golpe, mierda Qué asco de atraco.',
  '%A cobró el aura de %V como quien cobra una deuda vieja, coño Qué asco de atraco.',
  'Robo maestro. %V ni activó defensa porque no hubo tiempo, cabrón Qué asco de atraco.',
  '%A vs %V: el ladrón ganó el único round que importaba, gilipollas Qué asco de atraco.',
  '%A dejó a %V mirando el contador en cero sin anestesia, patético Qué asco de atraco.',
  'Maestro limpio en el ranking y sucio para el ego de %V, asco Qué asco de atraco.',
  '%A ejecutó, cobró y cerró el parte a favor sin temblar, basura Qué asco de atraco.',
  'Robo total. %A con todo, %V con nada, el chat de testigo, ridículo Qué asco de atraco.',
  '%A vació el aura de %V y el ranking no ofreció recurso, fracasado Qué asco de atraco.',
  ...
  '%A no solo le robó a %V: le vació el aura con la precisión de quien no deja migas. El ranking lo registra delante del puto ranking, mierda.',
  'Robo de autor: %A a %V. El contador de %V no se recuperó en el mismo mensaje. El ranking lo registra delante del puto ranking, coño.',
  '%A vs %V terminó con el aura de %V en tránsito total hacia %A. El ranking lo registra y el grupo ya pasó de página delante del puto ranking, cabrón.',
  '%A vació lo que había que vaciar de %V: el ranking lo muestra sin filtro. El ranking lo registra con el dígito firmando solo delante del puto ranking, gilipollas.',
  'Atraco maestro de %A: %V mirando el hueco donde antes había margen. El ranking lo registra sin apelación posible hoy delante del puto ranking, patético.',
  '%A le robó a %V como quien cobra una deuda antigua con intereses. El ranking lo registra y el grupo ya pasó de página delante del puto ranking, asco.',
  '%A vs %V: clínica de atraco. El paciente %V sale con menos aura de la que entró. El ranking lo registra delante del puto ranking, basura.',
  '%A no dejó casi nada en la cuenta de %V: casi nada duele más que nada a veces. El ranking lo registra delante del puto ranking, ridículo.',
  'Robo de nivel: %A cobró de %V con la calma de un maestro que no suda el golpe. El ranking lo registra delante del puto ranking, fracasado.',
  '%A ejecutó el vaciado de %V en el timing que no perdona ni deja casi. El ranking lo registra sin consuelo de consola delante del puto ranking, joder.',
  '%A vs %V terminó con transfer pesado a favor de %A y silencio de %V. El ranking lo registra sin cuento que lo tape delante del puto ranking, mierda.',
  '%A se llevó el aura de %V como quien recoge lo suyo de un sitio ajeno. El ranking lo registra delante del listón que no saltaste delante del puto ranking, coño.',
  'Atraco de categoría: %A a costa de %V, el grupo sin duda del nivel. El ranking lo registra en alta resolución de group chat delante del puto ranking, cabrón.',
  '%A no improvisó el pleno: el aura de %V ya estaba en la lista de la compra. El ranking lo registra en el parte que nadie borra delante del puto ranking, gilipollas.',
  '%A vs %V: el ladrón maestro cobró, la víctima cuenta el hueco grande. El ranking lo registra en alta resolución de group chat delante del puto ranking, patético.',
  '%A vació a %V con precisión de quien no necesita segundo intento. El ranking lo registra sin bis ni matiz de consuelo delante del puto ranking, asco.',
  'Robo maestro: %A con el botín gordo, %V con el hueco del mismo tamaño. El ranking lo registra y no hace falta ampliar el parte delante del puto ranking, basura.',
  '%A vs %V terminó con el ranking actualizado a lo grande a favor de %A. El ranking lo registra sin derecho a matiz útil delante del puto ranking, ridículo.',
  '%A ejecutó el golpe a %V en modo autor: firma legible en el contador. El ranking lo registra sin barniz de relato heroico delante del puto ranking, fracasado.'
];

const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió, joder Qué asco de atraco.',
  'Robo parcial: %A se lleva algo y %V se queda con la cara de gilipollas, mierda Qué asco de atraco.',
  '%A vs %V: no vacío total, pero el ranking de %V sangra igual, coño Qué asco de atraco.',
  'Parcial limpio. %A cobra una tajada y %V aprende la lección a medias, cabrón Qué asco de atraco.',
  '%A no se llevó todo, pero se llevó lo suficiente para que se note, gilipollas Qué asco de atraco.',
  'Robo a medias: %A sonríe y %V cuenta lo que falta en el contador, patético Qué asco de atraco.',
  '%A entró, picó y salió con botín incompleto pero real para %V, asco Qué asco de atraco.',
  'Parcial documentado. Autor %A, víctima %V, testigo el puto grupo, basura Qué asco de atraco.',
  '%A vs %V terminó con transfer incompleto y vergüenza completa, ridículo Qué asco de atraco.',
  '%A se llevó una parte. %V se llevó el almost de haber defendido, fracasado Qué asco de atraco.',
  '%A mordió el aura de %V sin vaciarla. El dolor es el mismo, joder Qué asco de atraco.',
  'Parcial de manual: %A cobra tajada, %V firma el hueco a medias, mierda Qué asco de atraco.',
  '%A no fue maestro ni fail: fue el medio que duele igual, coño Qué asco de atraco.',
  'Robo parcial. El ranking de %V baja y el de %A sube a medias, cabrón Qué asco de atraco.',
  '%A vs %V: crónica de un atraco incompleto y una cara completa de fail, gilipollas Qué asco de atraco.',
  '%A se llevó lo justo para que %V lo note el resto del día, patético Qué asco de atraco.',
  'Parcial limpio en el contador y sucio en la cara de %V, asco Qué asco de atraco.',
  '%A picó, cobró y salió. %V se quedó con el almost de defensa, basura Qué asco de atraco.',
  'Robo a medias documentado delante del grupo sin filtro, ridículo Qué asco de atraco.',
  '%A no vació a %V: lo dejó cojeando de aura en el ranking, fracasado Qué asco de atraco.',
  ...
  'Robo a medias: %A cobra algo de %V, %V se salva de lo peor, el chat ve el término medio. El ranking lo registra delante del puto ranking, ridículo.',
  '%A se llevó un trozo del aura de %V: el resto se quedó por falta de empuje o de suerte. El ranking lo registra delante del puto ranking, fracasado.',
  'Atraco parcial de %A a %V: el contador se mueve, pero no del todo a favor de nadie. El ranking lo registra delante del puto ranking, joder.',
  '%A no vació a %V: lo dejó cojo de aura. Cojo duele igual. El ranking lo registra en el idioma seco del ranking delante del puto ranking, mierda.',
  '%A vs %V: botín a medias, drama a medias, resultado legible en el ranking. El ranking lo registra y el sistema marca el punto final delante del puto ranking, coño.',
  '%A cobró de %V menos de lo que soñó y más de lo que %V quería soltar. El ranking lo registra delante del hueco que quedó delante del puto ranking, cabrón.',
  'Robo incompleto: %A con algo en el bolsillo, %V con menos, ninguno del todo contento. El ranking lo registra delante del puto ranking, gilipollas.',
  '%A entró a por el pack completo de %V y salió con la mitad: la mitad ya duele. El ranking lo registra delante del puto ranking, patético.',
  '%A el golpe a %V conectó a medias: el contador baja, no se desploma. El ranking lo registra sin suavizar el golpe del número delante del puto ranking, asco.',
  '%A se llevó lo que pudo del aura de %V: lo que pudo no era todo. El ranking lo registra con el parte firmado debajo delante del puto ranking, basura.',
  'Atraco a medias: %A no falla del todo, %V no se salva del todo. El ranking lo registra con el número hablando solo delante del puto ranking, ridículo.',
  '%A cobró un pedazo de %V: el pedazo se nota en el ranking. El ranking lo registra con el fallo en 4K de chat delante del puto ranking, fracasado.',
  '%A vs %V: botín incompleto, cara de ambos de no estar satisfechos. El ranking lo registra con el cargo en firme delante del puto ranking, joder.',
  '%A no dejó a %V en cero: lo dejó en menos. Menos basta para este mensaje. El ranking lo registra sin segunda lectura que lo arregle delante del puto ranking, mierda.',
  'Robo parcial de %A: el aura de %V sangra, no se desangra. El ranking lo registra con el veredicto seco del bot delante del puto ranking, coño.',
  '%A entró a por todo y el todo no cupo: salió con una parte de %V. El ranking lo registra en el único marcador que importa aquí delante del puto ranking, cabrón.',
  '%A vs %V terminó con el contador en movimiento moderado a favor de %A. El ranking lo registra y el ranking cierra el caso delante del puto ranking, gilipollas.',
  '%A se llevó un trozo legible del aura de %V: legible duele. El ranking lo registra sin barniz de relato heroico delante del puto ranking, patético.',
  '%A el golpe fue suficiente para marcar y insuficiente para cerrar el libro de %V. El ranking lo registra delante del puto ranking, asco.',
  '%A vs %V: media ración de botín, media ración de drama. El ranking lo registra y el sistema cierra sin discusión delante del puto ranking, basura.',
  '%A cobró de %V lo que el timing y la defensa dejaron pasar. El ranking lo registra en el segundo más incómodo del chat delante del puto ranking, ridículo.',
  'Robo a medias: %A con botín parcial, %V con pérdida parcial, el grupo con el dato. El ranking lo registra delante del puto ranking, fracasado.'
];
