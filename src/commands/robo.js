...
const ROB_MAESTRO = [
  ...
  'Maestro documentado. sin filtro delante del puto grupo del chat, asco. El chat ya tomó nota. Qué asco de atraco.',
  ...
  '%A ejecutó el empty de %V. delante del puto grupo del ranking, joder. El ranking no ofrece descuento. Qué asco de atraco.',
...
const ROB_PARCIAL = [
  '%A le sacó un pedazo del aura a %V. No fue limpio ni completo, pero dolió igual. delante del puto grupo, joder.',
  ...
  'Robo a medias. Firmado por. el bot delante del puto grupo, fracasado. Archivo cerrado. Qué asco de atraco.',
