...
const ABISMO = [
  ...
  'Una lombriz partida por la mitad tiene dos veces tu capacidad de decisión. Literalmente el doble, y sin cerebro, gilipollas.',
  ...
  'Una gallina picotea al azar y acierta más veces que tú eligiendo. Y la gallina no da explicaciones después, gilipollas.',
  ...
  'Una mosca choca contra el cristal cien veces seguidas. Tú haces lo mismo pero encima defiendes que el cristal está mal, gilipollas.',
...
const BAJO = [
  ...
  'Con %IQ no eres tonto de manual, eres tonto de detalle: fallas en lo pequeño y siempre en el peor momento, gilipollas.',
  ...
  'Estás en el tramo del que lee un titular y ya tiene una teoría entera montada. Tramo peligroso, tramo tuyo, gilipollas.',
  ...
  'Con %IQ tomas decisiones rápidas. Malas, pero rápidas. Y encima las llamas instinto, gilipollas.',
  ...
  'Tienes el criterio del que compra por el envase y luego se queja del contenido. Cada vez, sin fallar, gilipollas.',
  ...
  'Con %IQ das el nivel del que se pierde en una receta de dos pasos. El segundo ya era demasiado, gilipollas.',
