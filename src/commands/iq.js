...
const ABISMO = [
  ...
  'Un mejillón cerrado procesa más información que tú en un día entero. El mejillón, además, sabe cuándo callarse, inútil.',
  'Con %IQ estás por debajo de una tostadora. La tostadora hace una cosa y la hace bien. Tú no has encontrado la tuya, pringado.',
  'Una lombriz partida por la mitad tiene dos veces tu capacidad de decisión. Literalmente el doble, y sin cerebro, gilipoyas.',
  'Tu cabeza funciona como un ventilador desenchufado: hace bulto, ocupa sitio y no mueve absolutamente nada. Don nadie con cráneo.',
  '%IQ. Un semáforo tiene tres estados y tú sigues atascado en uno solo, y encima es el ámbar.',
  'Una piedra del jardín lleva veinte años tomando exactamente las mismas decisiones que tú y le va bastante mejor, cabrón.',
  'Tienes el nivel de razonamiento de una puerta automática: reaccionas a lo que se te pone delante y ahí se acaba el proceso. Qué asco de cabeza.',
  'Un pez de colores olvida las cosas cada tres segundos. Tú olvidas menos, pero es que tampoco entra nada nuevo, inútil.',
  '%IQ de IQ. El pan de molde caduca con más criterio del que tú aplicas a cualquier decisión de tu vida, pringado.',
  'Tu cerebro tiene la capacidad de proceso de un chicle pegado debajo de una mesa: está ahí, molesta, y no hace nada más. Cutre y pegado.',
  'Una gallina picotea al azar y acierta más veces que tú eligiendo. Y la gallina no da explicaciones después, gilipoyas.',
  'Con %IQ compites en la misma liga que un cubo de fregona. El cubo, eso sí, sirve para algo concreto. Tú, no, fracasado.',
  'Tienes el procesamiento de una bombilla fundida: la forma está, el casquillo está, y dentro no pasa nada. Miseria de lámpara.',
  'Un caracol tarda una hora en cruzar un metro, pero llega. Tú llevas años sin llegar a ninguna conclusión, cabrón.',
  '%IQ. Eso no es una puntuación, es la temperatura a la que se sirve la sopa. Y la sopa tiene más cuerpo, pringado.',
  'Tu capacidad de análisis está entre la de un felpudo y la de un ladrillo, y el ladrillo va ganando por estructura. Qué asco de empate.',
  'Una mosca choca contra el cristal cien veces seguidas. Tú haces lo mismo pero encima defiendes que el cristal está mal, gilipoyas.',
  'Con %IQ el listón no está bajo: está enterrado, con lápida y con flores. Descanse en paz tu capacidad de razonar, inútil.',
  'Tienes el criterio de un despertador roto: das la hora dos veces al día y por pura casualidad, ridículo.',
  'Un microondas tiene más funciones que tu cabeza y encima avisa cuando termina de hacer algo. Tú ni eso, don nadie.',
  '%IQ de IQ. Un termómetro marca más y no presume de nada. Aprende del termómetro, pringado.',
  'Tu cerebro es un disco duro de un mega con el cable cortado. Ni guarda, ni lee, ni se entera de que está roto. Basura informática.',
...
const BAJO = [
  ...
  'Con %IQ no eres tonto de manual, eres tonto de detalle: fallas en lo pequeño y siempre en el peor momento, gilipoyas.',
  '%IQ de IQ. Justo lo necesario para llenar un formulario mal y quedarte convencido de que está bien, inútil.',
  'Tienes el nivel del típico que confunde una opinión con un dato y luego la defiende a gritos, cabrón.',
  '%IQ. Un poco por debajo del vecino que pone la lavadora a las tres de la mañana. Ese al menos sabe lo que hace. Tú, no, ridículo.',
  'Con %IQ entiendes los chistes tres segundos después que el resto y aun así te ríes por si acaso, pringado.',
  '%IQ de IQ. Eres el que pregunta lo que se acaba de explicar y encima pone cara de que la culpa es del que explicó. Qué asco.',
  'Estás en el tramo del que lee un titular y ya tiene una teoría entera montada. Tramo peligroso, tramo tuyo, gilipoyas.',
  '%IQ. Ni lo bastante corto para que te lo perdonen ni lo bastante listo para que te lo agradezcan, inútil.',
  'Con %IQ te manejas en lo básico y te pierdes en cuanto la conversación pasa de dos ideas seguidas, cabrón.',
  '%IQ de IQ. El nivel exacto del que dice "yo de eso sé bastante" justo antes de decir una barbaridad. Cutre y seguro.',
  'Tienes el intelecto del que se cree gracioso porque nadie le ha dicho nunca lo contrario a la cara, pringado.',
  '%IQ. Por debajo de la media, por encima del suelo, y sin ninguna intención de moverte de ahí, fracasado.',
  'Con %IQ tomas decisiones rápidas. Malas, pero rápidas. Y encima las llamas instinto, gilipoyas.',
  '%IQ de IQ. Justo el punto en el que uno se cree listo porque conoce a gente más tonta que él. Qué vergüenza de listón.',
  'Estás en la franja del que discute con el GPS. El GPS tiene razón y tú tienes una anécdota, inútil.',
  '%IQ. El nivel del que se sabe todos los atajos y ninguno de ellos llega antes que el camino normal, cabrón.',
  'Con %IQ funcionas bien mientras nadie te cambie nada. En cuanto cambia algo, se te ve el cartón, pringado.',
  '%IQ de IQ. Eres el que dice "eso ya lo sabía" cinco minutos después de que se lo expliquen despacio. Ridículo.',
  'Tienes el criterio del que compra por el envase y luego se queja del contenido. Cada vez, sin fallar, gilipoyas.',
  '%IQ. Un poco por debajo del que aparca en doble fila y encima te mira mal a ti. Qué asco de privilegio.',
  'Con %IQ te va justo para lo cotidiano y fatal para cualquier cosa que exija pensar dos pasos por delante, inútil.',
  '%IQ de IQ. El nivel de quien entiende la mitad de las cosas y actúa como si hubiera entendido el doble, cabrón.',
  ...
  'Con %IQ das el nivel del que se pierde en una receta de dos pasos. El segundo ya era demasiado, gilipoyas.',
  '%IQ de IQ. Justo lo que hace falta para discutir de oídas y callarte cuando llega un dato, inútil.',
  'Tienes el criterio del que elige el menú del día porque la carta le queda grande. Cada vez, cabrón.',
...
const MEDIO = [
  ...
  '%IQ. Tienes los cojones de ser exactamente igual que todo el mundo y encima no te da vergüenza, gilipoyas.',
  ...
  '%IQ. Tu cabeza funciona como un ascensor de dos plantas: sube, baja, y eso es todo lo que da de sí, gilipoyas.',
  ...
  '%IQ. Piensas como conduce un abuelo: despacio, sin sorpresas y cabreando a todos los que van detrás, gilipoyas.',
  ...
  '%IQ de IQ. Coño, eres tan del promedio que si te pusieras de perfil intelectualmente desaparecerías, gilipoyas.',
  'Mierda, %IQ. Tu cabeza es un piso piloto: parece que alguien vive ahí pero no hay ni un puto cepillo de dientes.',
];

const ALTO = [
  '%IQ. Mira el listo del grupo, coño. Tienes cerebro de sobra y lo usas para discutir con gilipoyas en un chat.',
  ...
  '%IQ de IQ. Listo pero en un chat de mierda. Es como tener un doctorado y usarlo para abrir botellas, gilipoyas.',
  ...
  'Hostia, %IQ. Cerebro de cirujano y manos de albañil borracho. Porque una cosa es saber y otra es hacer algo con ello, gilipoyas.',
  ...
  'Mierda, %IQ. Eres lo bastante listo para saber que deberías estar haciendo otra cosa y lo bastante gilipoyas para no hacerla.',
  ...
  'Con %IQ eres el tío que ve la solución mientras los demás siguen buscando el problema. Lástima que el problema seas tú, gilipoyas.',
...
const GENIO = [
  ...
  'Con %IQ tienes más coeficiente que cojones, porque un genio de verdad no estaría perdiendo el tiempo con estos gilipoyas.',
  ...
  'Con %IQ tu cerebro funciona como un reactor nuclear y lo usas para calentar un café con leche, gilipoyas.',
  ...
  'Mierda, %IQ. Cerebro privilegiado que ha decidido voluntariamente compartir espacio con gente que confunde "hay" con "ahí", gilipoyas.',
  ...
  'Con %IQ piensas tres veces más rápido que cualquiera aquí y aun así no se te ha ocurrido largarte, pedazo de gilipoyas.',
