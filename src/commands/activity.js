...
let AMENAZAS = [
  ...
  'Escribid o adiós. Sin drama, sin hilo de \\\'qué pasó con\\\\\\\', solo la salida delante de quien miraba el ranking en ese momento.',
  'Silencio = candidato a purga. El bot no hace excepciones por cara bonita con el sistema firmando debajo sin pedir aclaración.',
  'O hay mensajes o hay expulsión. La política es corta a propósito delante de todo el hilo sin posibilidad de borrado.',
  'Inactivos del ranking: el bot os está mirando. Escribid antes de que escriba él el kick con el ranking como único testigo del veredicto.',
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia y el contador lo dejó por escrito sin debate.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco en el momento más visible del chat.',
  'Escribid algo. El bot no acepta la excusa del \\\\\\\'estoy leyendo\\\\\\\' eterno sin que nadie pudiera fingir que no lo vio.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies y sin segunda oportunidad en este mensaje.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión mientras el grupo tomaba nota del resultado.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis con números que no admiten recurso de apelación.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse delante de quien miraba el ranking en ese momento.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo con el sistema firmando debajo sin pedir aclaración.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo delante de todo el hilo sin posibilidad de borrado.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre con el ranking como único testigo del veredicto.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida y el contador lo dejó por escrito sin debate.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles en el momento más visible del chat.',
  'El ranking de inactivos no es decoración: es la lista previa al kick sin que nadie pudiera fingir que no lo vio.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro con el parte del comando cerrado en firme.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia y sin segunda oportunidad en este mensaje.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual mientras el grupo tomaba nota del resultado.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos con números que no admiten recurso de apelación.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera y el historial del comando queda de testigo.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos delante de quien miraba el ranking en ese momento.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento con el sistema firmando debajo sin pedir aclaración.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar delante de todo el hilo sin posibilidad de borrado.',
  'Silencio prolongado documentado: el kick es la continuación natural con el ranking como único testigo del veredicto.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia y el contador lo dejó por escrito sin debate.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo en el momento más visible del chat.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate sin que nadie pudiera fingir que no lo vio.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre con el parte del comando cerrado en firme.',
  'Escribid antes de que el silencio se convierta en el parte de baja y sin segunda oportunidad en este mensaje.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención mientras el grupo tomaba nota del resultado.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior con números que no admiten recurso de apelación.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable y el historial del comando queda de testigo.',
  'Escribid. La purga no lee la mente: lee el historial vacío delante de quien miraba el ranking en ese momento.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite con el sistema firmando debajo sin pedir aclaración.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo delante de todo el hilo sin posibilidad de borrado.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral con el ranking como único testigo del veredicto.'
]
