...
let AMENAZAS = [
  ...
  'Escribid o adiós. Sin drama, sin hilo de \'qué pasó con\', solo la salida. El grupo lo ve entero y no hace falta replay, cutre.',
  'Silencio = candidato a purga. El bot no hace excepciones por cara bonita. El grupo lo ve entero y no hace falta replay, pringado.',
  'O hay mensajes o hay expulsión. La política es corta a propósito. El grupo lo ve entero y no hace falta replay, fracasado.',
  'Inactivos del ranking: el bot os está mirando. Escribid antes de que escriba él el kick. El grupo lo ve entero y no hace falta replay, joder.',
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia. El grupo lo ve entero y no hace falta replay, mierda.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco. El grupo lo ve entero y no hace falta replay, coño.',
  'Escribid algo. El bot no acepta la excusa del \'estoy leyendo\' eterno. El grupo lo ve entero y no hace falta replay, cabrón.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies. El grupo lo ve entero y no hace falta replay, patético.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión. El grupo lo ve entero y no hace falta replay, ridículo.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis. El grupo lo ve entero y no hace falta replay, basura.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse. El grupo lo ve entero y no hace falta replay, asco.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo. El grupo lo ve entero y no hace falta replay, cutre.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo. El grupo lo ve entero y no hace falta replay, pringado.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre. El grupo lo ve entero y no hace falta replay, fracasado.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida. El grupo lo ve entero y no hace falta replay, joder.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles. El grupo lo ve entero y no hace falta replay, mierda.',
  'El ranking de inactivos no es decoración: es la lista previa al kick. El grupo lo ve entero y no hace falta replay, coño.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro. El grupo lo ve entero y no hace falta replay, cabrón.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia. El grupo lo ve entero y no hace falta replay, gilipollas.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual. El grupo lo ve entero y no hace falta replay, patético.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos. El grupo lo ve entero y no hace falta replay, ridículo.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera. El grupo lo ve entero y no hace falta replay, basura.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos. El grupo lo ve entero y no hace falta replay, desperdicio.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento. El grupo lo ve entero y no hace falta replay, asco.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar. El grupo lo ve entero y no hace falta replay, cutre.',
  'Silencio prolongado documentado: el kick es la continuación natural. El grupo lo ve entero y no hace falta replay, pringado.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia. El grupo lo ve entero y no hace falta replay, fracasado.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo. El grupo lo ve entero y no hace falta replay, joder.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate. El grupo lo ve entero y no hace falta replay, mierda.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre. El grupo lo ve entero y no hace falta replay, coño.',
  'Escribid antes de que el silencio se convierta en el parte de baja. El grupo lo ve entero y no hace falta replay, cabrón.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención. El grupo lo ve entero y no hace falta replay, gilipollas.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior. El grupo lo ve entero y no hace falta replay, patético.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable. El grupo lo ve entero y no hace falta replay, ridículo.',
  'Escribid. La purga no lee la mente: lee el historial vacío. El grupo lo ve entero y no hace falta replay, basura.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite. El grupo lo ve entero y no hace falta replay, desperdicio.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo. El grupo lo ve entero y no hace falta replay, asco.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral. El grupo lo ve entero y no hace falta replay, cutre.'
]
