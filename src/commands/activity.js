...
let AMENAZAS = [
  ...
  'Escribid o adiós. Sin drama, sin hilo de \'qué pasó con\\\', solo la salida.',
  'Silencio = candidato a purga. El bot no hace excepciones por cara bonita.',
  'O hay mensajes o hay expulsión. La política es corta a propósito.',
  'Inactivos del ranking: el bot os está mirando. Escribid antes de que escriba él el kick.',
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco.',
  'Escribid algo. El bot no acepta la excusa del \\\'estoy leyendo\\\' eterno.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles.',
  'El ranking de inactivos no es decoración: es la lista previa al kick.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar.',
  'Silencio prolongado documentado: el kick es la continuación natural.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre.',
  'Escribid antes de que el silencio se convierta en el parte de baja.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable.',
  'Escribid. La purga no lee la mente: lee el historial vacío.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral.'
]
