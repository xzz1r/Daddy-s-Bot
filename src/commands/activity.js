...
let AVISO_PURGA = [
  ...
  'Historial mudo: la purga no es venganza, es higiene del grupo. Y el ranking no miente, joder.',
  ...
  'Purga: el historial vacío es la acusación y la sentencia a la vez. Y el ranking no miente, cabrón.',
  ...
  'Silencio documentado: la purga es el procedimiento, no el drama. Y el ranking no miente, asco.',
  'Historial vacío de mérito: el kick es la continuación lógica. Y el ranking no miente, cutre.',
  ...
  'Lista de purga con nombres del vacío. El bot no rellena biografías. Y el ranking no miente, mierda.',
  'El historial os dejó solos. El bot solo ejecuta lo que el vacío ya decidió. Y el ranking no miente, coño.',
  'Purga sin teatro: historial mudo, nick fuera cuando toque. Y el ranking no miente, cabrón.',
  'El bot buscó algo que salvar de vosotros. El resultado fue la lista de salida. El grupo lo nota cada día, gilipollas.',
  'Historial sin sustancia: la higiene del grupo tiene fecha. Y el ranking no miente, patético.',
  ...
  'Historial repasado: no hay obra. No hay defensa. Hay lista. Y el ranking no miente, asco.',
  ...
  'Historial vacío: la purga no pide permiso al sentimentalismo. Y el ranking no miente, mierda.',
  'Repaso terminado. Los que no dejaron rastro quedan en la mira. Escribid. Y el ranking no miente, coño.',
  'Purga en preparación seria: el vacío de mensajes es el expediente. Y el ranking no miente, cabrón.',
  ...
  'El silencio os puso en la lista. El bot solo está pasando lista. Y el ranking no miente, asco.',
  'Historial repasado sin hallazgo útil: la permanencia no se regala. Y el ranking no miente, cutre.'
]
...
let AMENAZAS = [
  ...
  'Silencio de más: el bot está contando. Cuando llegue a cero, fuera sin funeral. y el silencio del resto lo confirma, mierda.',
  'Escribid o desapareced del grupo. Nadie va a montar un hilo de despedida. y el silencio del resto lo confirma, coño.',
  'El bot no negocia el silencio eterno: o hay mensajes o hay expulsión. y el silencio del resto lo confirma, cabrón.',
  'Inactivos: el reloj corre. Cuando suene, fuera. El grupo no es un museo de nicks mudos. y el silencio del resto lo confirma, gilipollas.',
  'Escribid algo con sentido o el bot os limpia. La nostalgia no salva el puesto. y el silencio del resto lo confirma, patético.',
  'El silencio os delata. El bot solo ejecuta lo que el ranking de inactivos ya decidió. y el silencio del resto lo confirma, ridículo.',
  'O participáis o salís. El medio no existe en la política de este bot. y el silencio del resto lo confirma, basura.',
  'Inactividad prolongada: el bot prepara la lista. Escribid si queréis borrar vuestro nombre de ella. Desperdicio.',
  'El grupo no guarda sillón a quien no escribe. El bot es el encargado de cobrar el peaje. y el silencio del resto lo confirma, asco.',
  'Escribid o adiós. Sin drama, sin hilo de \'qué pasó con\\\', solo la salida., cutre y duele de lo previsible.',
  'Silencio = candidato a purga. El bot no hace excepciones por cara bonita., pringado sin derecho a bis.',
  'O hay mensajes o hay expulsión. La política es corta a propósito., fracasado con el chat de testigo.',
  'Inactivos del ranking: el bot os está mirando. Escribid antes de que escriba él el kick., joder punto final del parte.',
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia., mierda y no hay segunda lectura.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco., coño en alta definición.',
  'Escribid algo. El bot no acepta la excusa del \\\'estoy leyendo\\\' eterno., cabrón como manda el ranking.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies., patético sin descuento emocional.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión., ridículo.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis., basura delante de quien miraba.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse., asco con firma legible.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo., cutre y basta de cuento.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo., pringado al natural, sin filtro.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre., fracasado que es como duele de verdad.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida., joder y el resto es ruido.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles., mierda y duele de lo previsible.',
  'El ranking de inactivos no es decoración: es la lista previa al kick., coño sin derecho a bis.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro., cabrón con el chat de testigo.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia., gilipollas punto final del parte.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual., patético y no hay segunda lectura.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos., ridículo en alta definición.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera., basura como manda el ranking.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos., desperdicio sin descuento emocional.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento., asco y el contador no miente.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar., cutre delante de quien miraba.',
  'Silencio prolongado documentado: el kick es la continuación natural., pringado con firma legible.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia., fracasado y basta de cuento.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo., joder al natural, sin filtro.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate., mierda que es como duele de verdad.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre., coño y el resto es ruido.',
  'Escribid antes de que el silencio se convierta en el parte de baja., cabrón y duele de lo previsible.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención., gilipollas sin derecho a bis.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior., patético con el chat de testigo.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable., ridículo punto final del parte.',
  'Escribid. La purga no lee la mente: lee el historial vacío., basura y no hay segunda lectura.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite., desperdicio en alta definición.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo., asco como manda el ranking.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral., cutre sin descuento emocional.'
]
