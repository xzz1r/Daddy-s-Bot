...
let AMENAZAS = [
  ...
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia y el archivo no admite recurso sin cuento que lo tape.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco con el dígito firmando solo.',
  'Escribid algo. El bot no acepta la excusa del \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'estoy leyendo\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\' eterno con el fail todavía caliente.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies sin prosa que lo maquille sin recurso ni nota al pie.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión y el historial no olvida.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis con testigos obligados en el hilo.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse sin segunda lectura que lo arregle.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo con el parte firmado debajo.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo delante del marcador en vivo.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre con el veredicto seco del bot.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida con el número hablando solo y el chat archiva sin debate.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles en el idioma seco del ranking.',
  'El ranking de inactivos no es decoración: es la lista previa al kick en la foto fija del ranking con el peaje cobrado al natural.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro y el grupo ya pasó de página.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia y el hilo no pide amplificación.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual sin modo avión ni silencio cómplice.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos en la foto fija del ranking.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera sin cuento que lo tape sin que nadie pida replay.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos sin cuento que lo tape y el sistema cierra sin discusión.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento en el momento que más dolía soltarlo.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar sin suavizar el golpe del número.',
  'Silencio prolongado documentado: el kick es la continuación natural y el veredicto no se negocia sin letra pequeña que lo salve.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia en el recuento que no perdona.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo y el sistema no regala puntos.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate con el peaje cobrado al natural.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre y el sistema no regala puntos.',
  'Escribid antes de que el silencio se convierta en el parte de baja con el dígito firmando solo con el veredicto seco del bot.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención sin derecho a matiz útil con testigos obligados en el hilo.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior con la firma legible del comando.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable delante del marcador en vivo.',
  'Escribid. La purga no lee la mente: lee el historial vacío sin letra pequeña que lo salve sin que nadie pida replay.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite con el número en la frente del mensaje.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo y el sistema cierra sin discusión.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral en la foto fija del ranking sin segunda oportunidad hoy.'
]
