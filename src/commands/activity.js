...
let AMENAZAS = [
  ...
  'Escribid o adiós. Sin drama, sin hilo de \\\'qué pasó con\\\\\\\\\\\\\\\', solo la salida que es como duele de verdad aquí y el resto del hilo es ruido.',
  'Silencio = candidato a purga. El bot no hace excepciones por cara bonita sin modo avión que lo oculte.',
  'O hay mensajes o hay expulsión. La política es corta a propósito con el bot firmando el veredicto y el grupo ya cambió de tema.',
  'Inactivos del ranking: el bot os está mirando. Escribid antes de que escriba él el kick en el único idioma del ranking.',
  'El chat no es un archivo de nicks quietos. Escribid o el bot limpia sin apelación ni letra pequeña con el saldo escrito a la vista.',
  'Silencio de sobra: la lista de purga se alimenta sola. Aportad mensaje o aportad hueco y no hace falta ampliar el parte.',
  'Escribid algo. El bot no acepta la excusa del \\\\\\\\\\\\\\\'estoy leyendo\\\\\\\\\\\\\\\' eterno en el momento más incómodo del chat.',
  'Inactividad visible: el bot la traduce a expulsión cuando toca. Escribid si no queréis tocar. Gilipollas.',
  'O participáis en el hilo o salís del grupo. El bot no mantiene zombies sin que nadie pida repetición.',
  'El reloj de los inactivos corre en silencio. Cuando llegue a cero, el kick no pide opinión con el eco del fail todavía sonando.',
  'Escribid o el bot os saca. Nadie va a votar en contra del vacío que dejáis y el sistema cierra sin discusión.',
  'Silencio prolongado: sois candidatos oficiales. El mensaje de hoy puede borraros de la lista. Desperdicio.',
  'El bot limpia inactivos. Escribid si vuestro nick merece quedarse delante del ranking y de la cara sin consuelo de manual de autoayuda.',
  'O hay rastro de mensajes o hay salida. La política no tiene letra pequeña de consuelo con el número hablando solo.',
  'Inactivos: el grupo no os echa de menos hasta que el bot os echa del todo y el archivo queda cerrado hoy.',
  'Escribid antes de que el bot escriba el parte de expulsión con vuestro nombre y duele de lo previsible.',
  'Silencio = señal. El bot la interpreta como baja voluntaria diferida sin derecho a bis ni a matiz con el chat de testigo obligado.',
  'O aparecéis en el hilo o desaparecéis del grupo. Sin términos medios útiles punto final del parte de hoy.',
  'El ranking de inactivos no es decoración: es la lista previa al kick y no hay segunda lectura útil en alta definición de group chat.',
  'Escribid algo real. El bot no salva a quien solo lee y nunca deja rastro como manda el ranking sin filtro.',
  'Inactividad de lujo: el bot la convierte en expulsión sin cargo de conciencia sin descuento emocional posible.',
  'O participáis o el bot os limpia. El resto del grupo seguirá el hilo igual y el contador no miente nunca.',
  'Silencio de más días: el bot os tiene fichados. Escribid si queréis desficharos delante de quien miraba de verdad.',
  'El grupo no es un hotel de nicks apagados. Escribid o fuera con firma legible en el historial y basta de cuento para hoy.',
  'Escribid. El bot no ofrece segunda residencia a los mudos crónicos al natural, sin barniz de consuelo.',
  'Inactivos en la mira: la purga no es amenaza vacía, es procedimiento que es como duele de verdad aquí.',
  'O dejáis mensaje o dejáis el grupo. El bot ejecuta la o sin dramatizar y el resto del hilo es ruido.',
  'Silencio prolongado documentado: el kick es la continuación natural sin modo avión que lo oculte con el bot firmando el veredicto.',
  'Escribid algo o el bot asume que no pintáis nada aquí y actúa en consecuencia y el grupo ya cambió de tema.',
  'El reloj no para para los inactivos. Cuando suene, fuera. Escribid si queréis pararlo en el único idioma del ranking.',
  'O hay actividad o hay expulsión. Esta frase es el aviso, no el debate sin apelación ni letra pequeña.',
  'Inactivos: el bot ya tiene la lista. Un mensaje vuestro puede rayar el nombre con el saldo escrito a la vista.',
  'Escribid antes de que el silencio se convierta en el parte de baja y no hace falta ampliar el parte.',
  'Silencio = candidatura a la salida. El bot no hace campañas de retención en el momento más incómodo del chat.',
  'O participáis en el chat o el bot os devuelve a la intimidad del exterior sin que nadie pida repetición.',
  'El grupo sigue sin vosotros si no escribís. El bot solo adelanta lo inevitable con el eco del fail todavía sonando.',
  'Escribid. La purga no lee la mente: lee el historial vacío y el sistema cierra sin discusión delante del ranking y de la cara.',
  'Inactividad visible: el bot la traduce a kick cuando el contador llega al límite sin consuelo de manual de autoayuda.',
  'O dejáis huella en el hilo o dejáis el grupo. Política corta, efecto largo con el número hablando solo.',
  'Silencio de sobra: escribid o aceptad que el bot os limpie sin funeral y el archivo queda cerrado hoy.'
]
