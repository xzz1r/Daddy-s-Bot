...
let AVISO_PURGA = [
 ...
 'Lista de purga alimentada con nicks sin rastro. El bot no inventa méritos. El grupo lo nota cada día',
 'El historial os delató: no hay sustancia. El kick no necesita más pruebas. Y el ranking no miente',
 ...
 'Nada que salvar en el historial. La lista de salida se llena sola. Y el ranking no miente',
 ...
 'El bot buscó un chiste, un audio, un hilo vuestro. Nada. Lista actualizada. El grupo lo nota cada día',
 ...
 'El bot no hace excepciones por cara: hace excepciones por rastro de mensajes. El grupo lo nota cada día',
 ...
 'Lista de nicks sin obra: el bot la tiene. Un mensaje puede borrar una línea. El grupo lo nota cada día',
...
let AMENAZAS = [
 ...
 'El grupo no guarda sillón a quien no escribe. El bot es el encargado de cobrar el peaje. El grupo lo ve entero y no hace falta replay',
