...
const RELEVANTE = [
  ...
  '%C mensajes de %N. El grupo te nota cuando faltas y te aguanta cuando sobras, mierda. cabrón. Hostia puta, qué nivel.',
  ...
  '%N, %C mensajes. La irrelevancia dejó de ser tu coartada hace rato, patético. asco. Hostia puta, qué nivel.',
  'Actividad de %N medida en %C. El bot te ve; el grupo también, basura. basura. Hostia puta, qué nivel.',
  '%C mensajes. %N convertiste el grupo en segunda oficina, ridículo. ridículo El grupo ya no discute la cifra.',
  '%N no fantasma: lleva %C pruebas en el archivo, fracasado. fracasado Menuda forma de dejar huella. Hostia puta, qué nivel.',
  '%N, %C mensajes y cero intención de bajar el ritmo. Menuda adicción al hilo, joder. joder. Hostia puta, qué nivel.',
  'Con %C, %N es clima del chat, no anécdota, cabrón. mierda El archivo lo confirma en frío. Hostia puta, qué nivel.',
  ...
  '%C de actividad. %N está fijo en el ranking de ruido útil o inútil, coño. gilipollas. Hostia puta, qué nivel.',
  '%N con %C mensajes: el contador es tu sombra, asco. patético. Hostia puta, qué nivel.',
  'Relevancia a lo bruto: %N y sus %C, patético. asco El grupo ya no discute la cifra. Hostia puta, qué nivel.',
  '%C mensajes. %N ya no cabe en el cajón de los que no escriben, basura. basura Menuda forma de dejar huella.',
  '%N lleva %C. Cuando faltas dos días el hilo se nota más muerto, ridículo. ridículo. Hostia puta, qué nivel.',
  '%C en el reloj de %N. No hay modo avión que borre eso, fracasado. fracasado El archivo lo confirma en frío.',
  '%N, %C mensajes. O aportas o ocupas espacio caro, joder. joder Así se ve la presencia de verdad. Hostia puta, qué nivel.',
  'Con %C mensajes %N se plantó y no se fue, cabrón. mierda No hay modo avión que borre esto. Hostia puta, qué nivel.',
  '%C de %N. Currículum de scroll con nombre propio, gilipollas. coño El contador no negocia con excusas.',
  '%N no desaparece: %C veces lo demuestra, mierda. cabrón. Hostia puta, qué nivel.',
  '%C mensajes. %N es parte del mobiliario del grupo, coño. gilipollas El grupo ya no discute la cifra.',
  'La relevancia de %N se mide en %C y a veces duele, asco. patético Menuda forma de dejar huella. Hostia puta, qué nivel.',
  '%N, %C. El bot te pone en el mapa sin pedirte opinión, patético. asco Sin derecho a perfil bajo después.',
  '%C mensajes de presencia pura de %N, basura. basura El archivo lo confirma en frío. Hostia puta, qué nivel.',
  '%N con %C: el hilo te reconoce al vuelo, ridículo. ridículo Así se ve la presencia de verdad. Hostia puta, qué nivel.',
  '%C. %N es residente, no turista del chat, fracasado. fracasado No hay modo avión que borre esto. Hostia puta, qué nivel.',
  '%N lleva %C mensajes. Saturación con firma, joder. joder El contador no negocia con excusas. Hostia puta, qué nivel.',
  'Actividad alta y visible: %N %C, cabrón. mierda El grupo ya no discute la cifra. Hostia puta, qué nivel.',
  ...
  'Con %C, %N ya es estadística del grupo, coño. gilipollas Sin derecho a perfil bajo después. Hostia puta, qué nivel.',
  '%C mensajes de %N. Volumen de quien vive aquí, asco. patético El archivo lo confirma en frío. Hostia puta, qué nivel.',
  '%N no es rumor: son %C datos, patético. asco Así se ve la presencia de verdad No hay modo avión que borre esto.',
  '%C. Relevancia por insistencia de %N, basura. basura No hay modo avión que borre esto. Hostia puta, qué nivel.',
  '%N con %C mensajes y el ranking de presencia te nombra, ridículo. ridículo El contador no negocia con excusas.',
  '%C mensajes. %N, el contador no te suelta, fracasado. fracasado. Hostia puta, qué nivel.',
  '%N lleva %C. Enganche de los que ya no se discuten, joder. joder El grupo ya no discute la cifra. Hostia puta, qué nivel.',
  ...
  '%N, %C mensajes. Importante a la fuerza, mierda. cabrón El archivo lo confirma en frío. Hostia puta, qué nivel.',
  '%C mensajes. %N se hizo fijo sin votación, coño. gilipollas Así se ve la presencia de verdad. Hostia puta, qué nivel.',
  'Actividad de %N: %C. Documentado y sin anestesia, asco. patético No hay modo avión que borre esto. Hostia puta, qué nivel.',
  '%N con %C. El fantasma ya no te queda de disfraz, patético. asco El contador no negocia con excusas.',
  '%C mensajes de %N en el historial vivo, basura. basura. Hostia puta, qué nivel.',
  '%N, %C. Presencia sin modo pausa, ridículo. ridículo El grupo ya no discute la cifra. Hostia puta, qué nivel.',
