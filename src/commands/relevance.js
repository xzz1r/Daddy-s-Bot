...
let PARASITO = [
  ...
  '%N, %C mensajes. Parasitas el contador sin dejar una sola frase útil. Y el ranking no miente, asco delante de todo el hilo sin posibilidad de borrado.',
  ...
  '%N, %C mensajes. Irrelevancia medible: el bot no inventa, cuenta. Y el ranking no miente, pringado en el momento más visible del chat.',
  ...
  '%N, %C mensajes. Mirón de primera: el título no se disputa. Y el ranking no miente, patético con números que no admiten recurso de apelación.',
  ...
  '%N, %C mensajes. Parasito documentado por %C mensajes de nada útil. Y el ranking no miente, asco delante de todo el hilo sin posibilidad de borrado.',
  '%N, %C mensajes. El contador te ve: el hilo no te necesita. Y el ranking no miente, cutre con el ranking como único testigo del veredicto.',
  '%N, %C mensajes. Fantasma de los que leen el drama y nunca lo firman. Y el ranking no miente, pringado.',
  '%N, %C mensajes. Relevancia cero con evidencia numérica. Y el ranking no miente, fracasado en el momento más visible del chat.',
  '%N, %C mensajes. Ocupas espacio de miembro: el espacio no se defiende solo. Y el ranking no miente, joder.',
  '%N, %C mensajes. Parasitas notificaciones ajenas como deporte. Y el ranking no miente, mierda con el parte del comando cerrado en firme.',
  '%N, %C mensajes. El ranking de aporte te deja donde mereces: abajo. Y el ranking no miente, coño y sin segunda oportunidad en este mensaje.',
  '%N, %C mensajes. Silencio que no es estrategia: es vacío. Y el ranking no miente, cabrón mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. Mirón con historial: el bot traduce historial a veredicto. El grupo lo nota cada día, gilipollas.',
  '%N, %C mensajes. Irrelevante de forma estable: no es un mal mes. Y el ranking no miente, patético y el historial del comando queda de testigo.',
  '%N, %C mensajes. El grupo no se cae sin ti: se aligera. Y el ranking no miente, ridículo delante de quien miraba el ranking en ese momento.',
  '%N, %C mensajes. Parasito del contador: sumas presencia y restas sustancia. El grupo lo nota cada día, basura.',
  '%N, %C mensajes. Fantasma oficial del ranking de relevancia. Y el ranking no miente, desperdicio delante de todo el hilo sin posibilidad de borrado.',
  '%N, %C mensajes.  %C mensajes y cero eco útil en el hilo. Y el ranking no miente, asco con el ranking como único testigo del veredicto.',
  ...
  '%N, %C mensajes. Irrelevancia con sello del comando. Y el ranking no miente, fracasado sin que nadie pudiera fingir que no lo vio.',
  '%N, %C mensajes. El mirón del grupo tiene nombre: el tuyo. Y el ranking no miente, joder con el parte del comando cerrado en firme.',
  '%N, %C mensajes. Silencio de relleno: el relleno se expulsa cuando toca. Y el ranking no miente, mierda.',
  '%N, %C mensajes. Relevancia bajo tierra: %C mensajes de prueba. Y el ranking no miente, coño mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. Parasito sin gracia: ni el silencio tiene estilo. Y el ranking no miente, cabrón con números que no admiten recurso de apelación.',
  '%N, %C mensajes. El hilo no te abre hueco: tú no abriste ninguno. Y el ranking no miente, gilipollas.',
  '%N, %C mensajes. Fantasma con contador: la peor combinación. Y el ranking no miente, patético delante de quien miraba el ranking en ese momento.',
  '%N, %C mensajes. Irrelevante y documentado: no hay debate. Y el ranking no miente, ridículo con el sistema firmando debajo sin pedir aclaración.',
  ...
  '%N, %C mensajes. Mirón crónico: el oficio no tiene jubilación aquí. Y el ranking no miente, asco y el contador lo dejó por escrito sin debate.',
  '%N, %C mensajes. Relevancia inexistente con %C mensajes de coartada. Y el ranking no miente, cutre en el momento más visible del chat.',
  '%N, %C mensajes. El chat no nota tu ausencia: nota tu falta de aporte. Y el ranking no miente, pringado.',
  '%N, %C mensajes. Parasito del hilo: diagnóstico cerrado. Y el ranking no miente, fracasado con el parte del comando cerrado en firme.',
  '%N, %C mensajes. Silencio que no aporta misterio: aporta hueco. Y el ranking no miente, joder y sin segunda oportunidad en este mensaje.',
  '%N, %C mensajes. Irrelevancia medible en %C mensajes. Y el ranking no miente, mierda mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. Fantasma que el bot se cansa de no oír. Y el ranking no miente, coño con números que no admiten recurso de apelación.',
  '%N, %C mensajes. Parasitas y el contador no te absuelve. Y el ranking no miente, cabrón y el historial del comando queda de testigo.',
  '%N, %C mensajes. Relevancia en números rojos de sustancia. Y el ranking no miente, gilipollas delante de quien miraba el ranking en ese momento.',
  ...
  '%N, %C mensajes. Parasito sin narrativa heroica: solo el número. Y el ranking no miente, basura con el ranking como único testigo del veredicto.',
  ...
  '%N, %C mensajes. Relevancia cero: %C mensajes no la inventan. Y el ranking no miente, fracasado y sin segunda oportunidad en este mensaje.',
  '%N, %C mensajes. Mirón profesional con carnet del contador. Y el ranking no miente, joder mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. Silencio de quien no aporta: el bot no lo confunde con elegancia. El grupo lo nota cada día, mierda.',
  '%N, %C mensajes. Irrelevante y estable: el peor pronóstico. Y el ranking no miente, coño y el historial del comando queda de testigo.',
  '%N, %C mensajes. Parasito del grupo documentado sin anestesia. Y el ranking no miente, cabrón delante de quien miraba el ranking en ese momento.',
  '%N, %C mensajes. El ranking de aporte te deja en el sótano con %C mensajes de testigo. El grupo lo nota cada día, gilipollas.',
  '%N, %C mensajes. Relevancia bajo mínimos legales del chat. Y el ranking no miente, ridículo delante de todo el hilo sin posibilidad de borrado.',
  '%N, %C mensajes. Parasitas el hilo y el hilo no te devuelve eco. Y el ranking no miente, basura con el ranking como único testigo del veredicto.',
  '%N, %C mensajes. Mirón: el título se gana no escribiendo nada útil. Y el ranking no miente, desperdicio.',
  '%N, %C mensajes. Irrelevancia con %C mensajes de prueba cargada. Y el ranking no miente, asco en el momento más visible del chat.',
  '%N, %C mensajes. El chat no te cita porque no hay material. Y el ranking no miente, cutre sin que nadie pudiera fingir que no lo vio.',
  '%N, %C mensajes. Parasito sin estilo: ni el vacío tiene gracia. Y el ranking no miente, pringado con el parte del comando cerrado en firme.',
  '%N, %C mensajes. Silencio que el bot traduce a irrelevancia. Y el ranking no miente, fracasado y sin segunda oportunidad en este mensaje.',
  ...
  '%N, %C mensajes. Parasitas el contador de miembros sin el de aporte. Y el ranking no miente, coño y el historial del comando queda de testigo.',
  '%N, %C mensajes. Mirón del drama ajeno: el drama no te nombra. Y el ranking no miente, cabrón delante de quien miraba el ranking en ese momento.',
  '%N, %C mensajes. Irrelevante de forma que ya no sorprende. Y el ranking no miente, gilipollas con el sistema firmando debajo sin pedir aclaración.',
  ...
  '%N, %C mensajes. Fantasma que no deja frase: solo rastro de lectura. Y el ranking no miente, asco en el momento más visible del chat.',
  '%N, %C mensajes. Parasitas y el bot no ofrece indulgencia. Y el ranking no miente, cutre sin que nadie pudiera fingir que no lo vio.',
  '%N, %C mensajes. Mirón con %C mensajes: el número no te salva. Y el ranking no miente, pringado con el parte del comando cerrado en firme.',
  '%N, %C mensajes. Irrelevancia documentada: punto final del tramo. Y el ranking no miente, fracasado.',
  '%N, %C mensajes. El hilo no te necesita: el ranking lo certifica. Y el ranking no miente, joder mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. Parasito sin misterio: el vacío se ve. Y el ranking no miente, mierda con números que no admiten recurso de apelación.',
  '%N, %C mensajes. Relevancia cero con evidencia de %C mensajes. Y el ranking no miente, coño y el historial del comando queda de testigo.',
  '%N, %C mensajes. Fantasma del chat: el oficio no se discute. Y el ranking no miente, cabrón delante de quien miraba el ranking en ese momento.',
  '%N, %C mensajes. Mirón crónico: el contador es el carnet. Y el ranking no miente, patético con el sistema firmando debajo sin pedir aclaración.',
  ...
  '%N, %C mensajes. Relevancia bajo tierra: no hay ascensor. Y el ranking no miente, asco en el momento más visible del chat.',
  '%N, %C mensajes. Fantasma con nick: el pack del que no pinta nada. Y el ranking no miente, cutre sin que nadie pudiera fingir que no lo vio.',
  '%N, %C mensajes. Parasitas el promedio y no subes ninguno que importe. Y el ranking no miente, pringado.',
  '%N, %C mensajes. Mirón: el drama se escribe sin tu firma. Y el ranking no miente, fracasado y sin segunda oportunidad en este mensaje.',
  '%N, %C mensajes. Irrelevancia medible y estable. Y el ranking no miente, joder mientras el grupo tomaba nota del resultado.',
  '%N, %C mensajes. El chat sigue igual sin tu aporte: porque no hay aporte. Y el ranking no miente, mierda.',
  '%N, %C mensajes. Parasito documentado por el comando de relevancia. Y el ranking no miente, coño y el historial del comando queda de testigo.',
  '%N, %C mensajes. Relevancia inexistente: %C mensajes no crean sustancia. Y el ranking no miente, cabrón.',
  '%N, %C mensajes. Fantasma oficial del sótano del ranking. Y el ranking no miente, gilipollas con el sistema firmando debajo sin pedir aclaración.',
  '%N, %C mensajes. Parasitas el grupo: el grupo no te parasita de vuelta. Y el ranking no miente, patético.',
  '%N, %C mensajes. Mirón con historial vacío de frases útiles. Y el ranking no miente, ridículo con el ranking como único testigo del veredicto.',
  '%N, %C mensajes. Irrelevante de fábrica: este mensaje es el sello. Y el ranking no miente, basura y el contador lo dejó por escrito sin debate.',
  '%N, %C mensajes. Silencio de quien ocupa sitio: el sitio se puede liberar. El grupo lo nota cada día, desperdicio.',
  '%N, %C mensajes. Parasito sin gracia ni misterio: solo el número %C. Y el ranking no miente, asco sin que nadie pudiera fingir que no lo vio.',
