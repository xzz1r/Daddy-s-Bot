...
const RELEVANTE = [
  ...
  '%N lleva %C mensajes y todavía cree que aporta, gilipollas, y el chat lo tiene claro, joder.',
  '%C mensajes de %N. Volumen alto, sustancia a debate, mierda, y el chat lo tiene claro, mierda.',
  '%N, %C mensajes: o eres el pilar o eres el ruido de fondo con wifi, coño, y el chat lo tiene claro, coño.',
  'Con %C mensajes %N ya no puede alegar perfil bajo, asco, y el chat lo tiene claro, cabrón.',
  '%N ha escrito %C veces. El contador no miente, el contenido a veces sí, patético, y el chat lo tiene claro, gilipollas.',
  '%C mensajes. %N está en modo residente del hilo, basura, y el chat lo tiene claro, patético.',
  '%N, %C mensajes y el ranking de presencia te nombra sin dudar, ridículo, y el chat lo tiene claro, asco.',
  'Actividad de %N: %C. El chat ya te tiene fichado, fracasado, y el chat lo tiene claro, basura.',
  '%N con %C mensajes: o eres útil o eres inevitable, joder, y el chat lo tiene claro, ridículo.',
  '%C en el contador de %N. Menudo compromiso con el ruido, cabrón, y el chat lo tiene claro, fracasado.',
  '%N no desaparece: lleva %C pruebas, gilipollas, y el chat lo tiene claro, joder.',
  '%C mensajes. %N es parte del mobiliario del grupo, mierda, y el chat lo tiene claro, mierda.',
  'La relevancia de %N se mide en %C y duele un poco, coño, y el chat lo tiene claro, coño.',
  '%N, %C mensajes: el bot te ve, el grupo también, asco, y el chat lo tiene claro, cabrón.',
  '%C de actividad. %N no es un fantasma, patético, y el chat lo tiene claro, gilipollas.',
  '%N lleva %C y todavía pide contexto, basura, y el chat lo tiene claro, patético.',
  '%C mensajes de %N. Volumen de quien no sabe irse, ridículo, y el chat lo tiene claro, asco.',
  '%N está en %C. El contador es tu biografía, fracasado, y el chat lo tiene claro, basura.',
  'Relevante a la fuerza: %N con %C mensajes, joder, y el chat lo tiene claro, ridículo.',
  '%C en el reloj de %N. No hay modo avión que te salve, cabrón, y el chat lo tiene claro, fracasado.',
  '%N, %C mensajes. O aportas o ocupas, gilipollas, y el chat lo tiene claro, joder.',
  '%C mensajes. %N ya es clima del chat, mierda, y el chat lo tiene claro, mierda.',
  'Actividad documentada: %N %C, coño, y el chat lo tiene claro, coño.',
  '%N no para: %C y subiendo, asco, y el chat lo tiene claro, cabrón.',
  '%C mensajes de presencia pura de %N, patético, y el chat lo tiene claro, gilipollas.',
  '%N con %C: el hilo te reconoce al vuelo, basura, y el chat lo tiene claro, patético.',
  '%C. %N es residente, no visitante, ridículo, y el chat lo tiene claro, asco.',
  'Relevancia por saturación: %N %C, fracasado, y el chat lo tiene claro, basura.',
  '%N lleva %C mensajes. El archivo lo confirma, joder, y el chat lo tiene claro, ridículo.',
  '%C de %N. Menudo currículum de scroll, cabrón, y el chat lo tiene claro, fracasado.',
  '%N, %C mensajes y cero intención de bajar el ritmo, gilipollas, y el chat lo tiene claro, joder.',
  '%C en el contador. %N no es rumor, es estadística, mierda, y el chat lo tiene claro, mierda.',
  'Presencia de %N medida en %C, coño, y el chat lo tiene claro, coño.',
  '%N ha soltado %C mensajes. El grupo aguanta, asco, y el chat lo tiene claro, cabrón.',
  '%C mensajes. %N se plantó y no se fue, patético, y el chat lo tiene claro, gilipollas.',
  '%N con %C: relevado a base de insistir, basura, y el chat lo tiene claro, patético.',
  '%C. El bot te pone en el mapa, %N, ridículo, y el chat lo tiene claro, asco.',
  'Actividad alta: %N %C, fracasado, y el chat lo tiene claro, basura.',
  '%N, %C mensajes. La irrelevancia ya no es tu coartada, joder, y el chat lo tiene claro, ridículo.',
  '%C mensajes de %N. Volumen de quien vive aquí, cabrón, y el chat lo tiene claro, fracasado.',
  '%N no fantasma: %C pruebas en contra, gilipollas, y el chat lo tiene claro, joder.',
  '%C. %N es fijo del ranking de ruido, mierda, y el chat lo tiene claro, mierda.',
  'Relevante: %N con %C en el pecho, coño, y el chat lo tiene claro, coño.',
  '%N lleva %C. El chat ya ni se sorprende, asco, y el chat lo tiene claro, cabrón.',
  '%C mensajes. %N convertiste el grupo en oficina, patético, y el chat lo tiene claro, gilipollas.',
  '%N, %C. Presencia sin modo pausa, basura, y el chat lo tiene claro, patético.',
  '%C de actividad. %N no pide permiso, ridículo, y el chat lo tiene claro, asco.',
  '%N con %C mensajes: el contador es tu sombra, fracasado, y el chat lo tiene claro, basura.',
  '%C. Relevancia a lo bruto, %N, joder, y el chat lo tiene claro, ridículo.',
  'Actividad documentada: %N %C, coño, fracasado, y el chat lo tiene claro, fracasado.'
];
