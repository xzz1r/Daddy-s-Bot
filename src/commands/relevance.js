...
const RELEVANTE = [
  ...
  'Con %C mensajes %N ya no puede hacerse el perfil bajo. Estás en el mapa a la fuerza, cabrón. Menudo numerito, mierda.',
  '%N lleva %C. Volumen de residente, sustancia a juicio del resto, gilipollas. Menudo numerito, coño Sin derecho a perfil bajo después.',
  '%C mensajes de %N. El grupo te nota cuando faltas y te aguanta cuando sobras, mierda. Menudo numerito, cabrón.',
  '%N con %C: o eres pilar o eres la mula de carga del chat, coño. Menudo numerito, gilipollas Así se ve la presencia de verdad.',
  '%C en el contador de %N. Eso ya no es visita, es empadronamiento, asco. Menudo numerito, patético No hay modo avión que borre esto.',
  '%N, %C mensajes. La irrelevancia dejó de ser tu coartada hace rato, patético. Menudo numerito, asco.',
  'Actividad de %N medida en %C. El bot te ve; el grupo también, basura. Menudo numerito, basura Documentado sin anestesia posible.',
  '%C mensajes. %N convertiste el grupo en segunda oficina, ridículo. Menudo numerito, ridículo El grupo ya no discute la cifra.',
  '%N no fantasma: lleva %C pruebas en el archivo, fracasado. Menudo numerito, fracasado Menuda forma de dejar huella.',
  '%N, %C mensajes y cero intención de bajar el ritmo. Menuda adicción al hilo, joder. Menudo numerito, joder.',
  'Con %C, %N es clima del chat, no anécdota, cabrón. Menudo numerito, mierda El archivo lo confirma en frío.',
  '%C mensajes de %N. Presencia que no pide permiso, gilipollas. Menudo numerito, coño Así se ve la presencia de verdad.',
  '%N ha soltado %C. El archivo lo confirma sin debate, mierda. Menudo numerito, cabrón No hay modo avión que borre esto.',
  '%C de actividad. %N está fijo en el ranking de ruido útil o inútil, coño. Menudo numerito, gilipollas.',
  '%N con %C mensajes: el contador es tu sombra, asco. Menudo numerito, patético Documentado sin anestesia posible.',
  'Relevancia a lo bruto: %N y sus %C, patético. Menudo numerito, asco El grupo ya no discute la cifra.',
  '%C mensajes. %N ya no cabe en el cajón de los que no escriben, basura. Menudo numerito, basura Menuda forma de dejar huella.',
  '%N lleva %C. Cuando faltas dos días el hilo se nota más muerto, ridículo. Menudo numerito, ridículo.',
  '%C en el reloj de %N. No hay modo avión que borre eso, fracasado. Menudo numerito, fracasado El archivo lo confirma en frío.',
  '%N, %C mensajes. O aportas o ocupas espacio caro, joder. Menudo numerito, joder Así se ve la presencia de verdad.',
  'Con %C mensajes %N se plantó y no se fue, cabrón. Menudo numerito, mierda No hay modo avión que borre esto.',
  '%C de %N. Currículum de scroll con nombre propio, gilipollas. Menudo numerito, coño El contador no negocia con excusas.',
  '%N no desaparece: %C veces lo demuestra, mierda. Menudo numerito, cabrón Documentado sin anestesia posible.',
  '%C mensajes. %N es parte del mobiliario del grupo, coño. Menudo numerito, gilipollas El grupo ya no discute la cifra.',
  'La relevancia de %N se mide en %C y a veces duele, asco. Menudo numerito, patético Menuda forma de dejar huella.',
  '%N, %C. El bot te pone en el mapa sin pedirte opinión, patético. Menudo numerito, asco Sin derecho a perfil bajo después.',
  '%C mensajes de presencia pura de %N, basura. Menudo numerito, basura El archivo lo confirma en frío.',
  '%N con %C: el hilo te reconoce al vuelo, ridículo. Menudo numerito, ridículo Así se ve la presencia de verdad.',
  '%C. %N es residente, no turista del chat, fracasado. Menudo numerito, fracasado No hay modo avión que borre esto.',
  '%N lleva %C mensajes. Saturación con firma, joder. Menudo numerito, joder El contador no negocia con excusas.',
  'Actividad alta y visible: %N %C, cabrón. Menudo numerito, mierda Documentado sin anestesia posible El grupo ya no discute la cifra.',
  '%C mensajes. %N no pide contexto: lo genera a martillazos, gilipollas. Menudo numerito, coño El grupo ya no discute la cifra.',
  '%N, %C en el pecho del contador, mierda. Menudo numerito, cabrón Menuda forma de dejar huella Sin derecho a perfil bajo después.',
  'Con %C, %N ya es estadística del grupo, coño. Menudo numerito, gilipollas Sin derecho a perfil bajo después.',
  '%C mensajes de %N. Volumen de quien vive aquí, asco. Menudo numerito, patético El archivo lo confirma en frío.',
  '%N no es rumor: son %C datos, patético. Menudo numerito, asco Así se ve la presencia de verdad No hay modo avión que borre esto.',
  '%C. Relevancia por insistencia de %N, basura. Menudo numerito, basura No hay modo avión que borre esto.',
  '%N con %C mensajes y el ranking de presencia te nombra, ridículo. Menudo numerito, ridículo El contador no negocia con excusas.',
  '%C mensajes. %N, el contador no te suelta, fracasado. Menudo numerito, fracasado Documentado sin anestesia posible.',
  '%N lleva %C. Enganche de los que ya no se discuten, joder. Menudo numerito, joder El grupo ya no discute la cifra.',
  'Con %C mensajes %N carga el grupo a hombros o lo aplasta, cabrón. Menudo numerito, mierda Menuda forma de dejar huella.',
  '%C de %N. Fiel o dependiente: el número no aclara, gilipollas. Menudo numerito, coño Sin derecho a perfil bajo después.',
  '%N, %C mensajes. Importante a la fuerza, mierda. Menudo numerito, cabrón El archivo lo confirma en frío.',
  '%C mensajes. %N se hizo fijo sin votación, coño. Menudo numerito, gilipollas Así se ve la presencia de verdad.',
  'Actividad de %N: %C. Documentado y sin anestesia, asco. Menudo numerito, patético No hay modo avión que borre esto.',
  '%N con %C. El fantasma ya no te queda de disfraz, patético. Menudo numerito, asco El contador no negocia con excusas.',
  '%C mensajes de %N en el historial vivo, basura. Menudo numerito, basura Documentado sin anestesia posible.',
  '%N, %C. Presencia sin modo pausa, ridículo. Menudo numerito, ridículo El grupo ya no discute la cifra.',
  '%C. El grupo ya cuenta contigo a regañadientes, %N, fracasado. Menudo numerito, fracasado Menuda forma de dejar huella.'
];
