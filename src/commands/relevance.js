...
let PARASITO = [
  ...
  '%N, %C mensajes en el contador de silencio útil para nadie. Parasitas el hilo y el ranking te señala. Patético, da asco, da asco.',
  '%N, %C mensajes. Estás en el grupo como el mueble: ocupas sitio y no aportas. El grupo lo nota cada día, desperdicio, qué vergüenza.',
  ...
  '%N, %C mensajes en el contador. Parasito de notificaciones: abres, miras, cierras, nada. El grupo lo nota cada día, desperdicio, qué cutre.',
  '%N, %C mensajes. El ranking de irrelevancia tiene cabeza de cartel y eres tú. El grupo lo nota cada día, pringado, da pena ajena.',
  ...
  '%N, %C mensajes en el contador. Relevancia bajo mínimos: el hilo no te extraña cuando faltas. El grupo lo nota cada día, da asco, da asco.',
  ...
  '%N, %C mensajes. Ocupas un slot del grupo y el slot no se nota si se libera. El grupo lo nota cada día, desperdicio, basura.',
  ...
  '%N, %C mensajes. Relevancia en el sótano: el hilo no te cita porque no hay qué citar. El grupo lo nota cada día, da asco, da asco.',
  ...
  '%N, %C mensajes. Irrelevancia con nick: el pack completo del que no pinta nada. El grupo lo nota cada día, desperdicio, qué miseria.',
  ...
  '%N, %C mensajes. Fantasma de los que leen el drama y nunca lo firman. Y. el ranking no miente, pringado, basura.',
  ...
  '%N, %C mensajes. Parasitas el chat y el ranking te hace el retrato. Y. el ranking no miente, pringado, da asco, da asco.',
  ...
  '%N, %C mensajes. El mirón del grupo tiene nombre: el tuyo. Y. el ranking no miente, joder. y no hay modo de suavizarlo, ridículo.',
  ...
  '%N, %C mensajes. Silencio que no aporta misterio: aporta hueco. Y. el ranking no miente, joder. y el hilo no pide amplificación, menudo desastre.',
  ...
  '%N, %C mensajes. El mirón tiene %C mensajes y cero frases que citar. Y. el ranking no miente, da asco, da asco.',
  ...
  '%N, %C mensajes. Irrelevante de fábrica: el comando solo lo nombra. Y. el ranking no miente, desperdicio, fracasado.',
  ...
  '%N, %C mensajes. Mirón profesional con carnet del contador. Y. el ranking no miente, joder con el chat enterado del cargo, qué cutre.',
  ...
  '%N, %C mensajes. Relevancia inexistente: el comando lo dice en claro. Y. el ranking no miente, da asco, da asco.',
  ...
  '%N, %C mensajes. El hilo no te necesita: el ranking lo certifica. Y. el ranking no miente, joder con el fail todavía caliente, qué vergüenza ajena.',
  ...
  '%N, %C mensajes. Relevancia bajo tierra: no hay ascensor. Y. el ranking no miente, asco en el parte que nadie borra, da asco, da asco.',
  ...
  '%N, %C mensajes. Parasitas el promedio y no subes ninguno que importe. Y. el ranking no miente, pringado, ridículo.',
  ...
  '%N, %C mensajes. Irrelevancia medible y estable. Y. el ranking no miente, joder sin consuelo de manual barato, qué miseria.',
  ...
  '%N, %C mensajes. Silencio de quien ocupa sitio: el sitio se puede liberar. El grupo lo nota cada día, desperdicio, qué vergüenza ajena.',
