...
ntidad EXACTA de mensajes que lleva enviados (misma fuente que !count).
//
// Tramos:
//   < 300  → parásito: inactivo, mirón, gorrón. Insulto brutal.
//   300-699 → intermedio: está, pero no pesa.
...
const RELEVANTE = [
  ...
  '%N ha soltado %C. El archivo lo confirma. La vanidad lo interpreta como legado, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C de actividad. %N fijo en el ranking de ruido. El ego lee \'imprescindible\'; el grupo lee \'inevitable\', coño. El ego lo celebra; el chat lo sopesa.',
  '%N con %C mensajes: el contador es tu sombra y tu muleta de autoestima, asco. El ego lo celebra; el chat lo sopesa.',
  'Relevancia a lo bruto: %N y sus %C. Cantidad gritando para que no se oiga la falta de peso, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N ya no cabe en el cajón de los que no escriben. Ahora cabe en el de los que escriben de más, basura. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C. Cuando faltas dos días el hilo se nota; cuando vuelves, a veces se arrepiente, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C en el reloj de %N. No hay modo avión que borre la dependencia del chat, fracasado. El ego lo celebra; el chat lo sopesa.',
  ...
  'Con %C mensajes %N se plantó y no se fue. Territorialidad de quien no tiene otro escenario, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C de %N. Currículum de scroll con nombre propio. La autoestima firmó el contrato sin leer, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N no desaparece: %C veces lo demuestra. Persistencia confunde con valor, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N es parte del mobiliario del grupo. El mobiliario no pide respeto, coño. El ego lo celebra; el chat lo sopesa.',
  'La \'relevancia\' de %N se mide en %C y a veces duele porque es solo ruido útil a ratos, asco. El ego lo celebra; el chat lo sopesa.',
  '%N, %C. El bot te pone en el mapa sin pedirte opinión. El ego lo enmarca, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de presencia pura de %N. Presencia no es peso. El chat lo sabe, basura. El ego lo celebra; el chat lo sopesa.',
  '%N con %C: el hilo te reconoce al vuelo y a veces suspira, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C. %N es residente, no turista. Los residentes también pueden ser un problema de vecinos, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C mensajes. Saturación con firma. El ego lo llama compromiso, joder. El ego lo celebra; el chat lo sopesa.',
  'Actividad alta y visible: %N %C. Visible no es respetado, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N no pide contexto: lo genera a martillazos de texto, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N, %C en el pecho del contador como medalla. La medalla es de hojalata, mierda. El ego lo celebra; el chat lo sopesa.',
  'Con %C, %N ya es estadística del grupo. Las estadísticas no tienen autoestima, coño. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N. Volumen de quien vive aquí porque fuera no hay escenario, asco. El ego lo celebra; el chat lo sopesa.',
  '%N no es rumor: son %C datos. Los datos no te hacen imprescindible, patético. El ego lo celebra; el chat lo sopesa.',
  '%C. Relevancia por insistencia de %N. La insistencia cansa más que ilumina, basura. El ego lo celebra; el chat lo sopesa.',
  '%N con %C mensajes y el ranking de presencia te nombra. Presencia ≠ valor, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N, el contador no te suelta y tú tampoco al contador, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C. Enganche de los que ya no se discuten. El ego lo celebra en privado, joder. El ego lo celebra; el chat lo sopesa.',
  'Con %C mensajes %N carga el grupo a hombros o lo aplasta. A veces no se distingue, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C de %N. Fiel o dependiente: el número no aclara y tu autoestima elige mal, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. Importante a la fuerza. La fuerza no es respeto, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N se hizo fijo sin votación. Nadie votó tu ego al alza, coño. El ego lo celebra; el chat lo sopesa.',
  'Actividad de %N: %C. Documentado y sin anestesia para la vanidad, asco. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. El fantasma ya no te queda de disfraz; ahora el problema es el exceso, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N en el historial vivo. Historial no es legado, basura. El ego lo celebra; el chat lo sopesa.',
  '%N, %C. Presencia sin modo pausa. La pausa te haría un favor al ego, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C. El grupo cuenta contigo a regañadientes, %N. A regañadientes no es admiración, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. El contador te sube el ego y el contenido te lo baja, joder. El ego lo celebra; el chat lo sopesa.',
  'Con %C, %N ya no es invisible: es inevitable. Inevitable no es querido, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N. La autoestima se alimenta del número; el grupo, del filtro, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C y todavía cree que volumen es argumento. El hilo te desmiente, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C en el marcador. %N ocupa el centro sin pedir el micrófono bien, coño. El ego lo celebra; el chat lo sopesa.',
  '%N con %C mensajes. Relevancia de quien no sabe irse a tiempo, asco. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. El ego de %N leyó \'imprescindible\' donde decía \'presente\', patético. El ego lo celebra; el chat lo sopesa.',
  '%N, %C. Saturación con firma de usuario. El chat no aplaude, basura. El ego lo celebra; el chat lo sopesa.',
  'Con %C mensajes %N convirtió la presencia en identidad. Pobre identidad, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C. %N no pide validación: la fabrica a martillazos de texto, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C mensajes. El número te sostiene la autoestima mejor que el espejo, joder. El ego lo celebra; el chat lo sopesa.',
  'Actividad de %N medida en %C. El bot no mide talento; mide insistencia, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N. La relevancia comprada a plazos de spam emocional, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. Estás en todas las fotos del hilo y en pocas de las citas, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C. El grupo te tiene fichado, %N. Fichado no es admirado, coño. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. El ego hinchado por el contador revienta al primer silencio ajeno, asco. El ego lo celebra; el chat lo sopesa.',
  'Con %C, %N es el clima y a veces el mal clima, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N no desaparece ni cuando convendría, basura. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C. Relevancia de peaje diario pagado en ruido, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C en el pecho. %N, el número no te hace el personaje que crees, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. O eres el pilar o eres el andamio que estorba, joder. El ego lo celebra; el chat lo sopesa.',
  'Con %C mensajes %N ya no tiene coartada de perfil bajo. Solo queda el juicio, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C de %N. Volumen alto, eco selectivo, autoestima engañada, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. El contador es tu CV y está inflado de aire, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N, presencia que confunde cantidad con peso real, coño. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C y el ego lo traduce a \'me necesitan\'. El chat traduce a \'está\', asco. El ego lo celebra; el chat lo sopesa.',
  'Actividad %C de %N. Documentada, visible, discutible en valor, patético. El ego lo celebra; el chat lo sopesa.',
  '%C. %N se plantó en el hilo como quien planta bandera en terreno ajeno, basura. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. La autoestima te la financia el contador a crédito, ridículo. El ego lo celebra; el chat lo sopesa.',
  'Con %C, %N es imposible de ignorar e imposible de citar con orgullo, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N. El ranking de presencia te corona de cartón, joder. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. Relevancia forzada a base de no callar, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C. El grupo te aguanta, %N. Aguantar no es querer, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C mensajes. El ego baila; el contenido a veces no, mierda. El ego lo celebra; el chat lo sopesa.',
  'Con %C mensajes %N convirtió el chat en su escenario principal. Público cautivo, coño. El ego lo celebra; el chat lo sopesa.',
  '%C de actividad. %N, el número te sube y la calidad te mira de reojo, asco. El ego lo celebra; el chat lo sopesa.',
  '%N, %C. Estás en el mapa. El mapa no es un altar, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N no es rumor: es estadística con ego, basura. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. La relevancia se te subió a la cabeza más que al texto, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C. %N, el contador no miente; tu autoestima sí interpreta, fracasado. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C mensajes. Presencia de quien no tiene plan B emocional, joder. El ego lo celebra; el chat lo sopesa.',
  'Con %C, %N ya es parte del mobiliario y del problema de ruido, cabrón. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes de %N. Importante por saturación, no por genio, gilipollas. El ego lo celebra; el chat lo sopesa.',
  '%N con %C. El hilo te reconoce; no siempre te agradece, mierda. El ego lo celebra; el chat lo sopesa.',
  '%C. Relevancia a lo bruto, %N. Bruto también en el ego, coño. El ego lo celebra; el chat lo sopesa.',
  '%N, %C mensajes. El número te sostiene cuando el resto no aplaude, asco. El ego lo celebra; el chat lo sopesa.',
  'Actividad de %N: %C. Visible, insistente, discutible, patético. El ego lo celebra; el chat lo sopesa.',
  '%C mensajes. %N, el ego lee el contador como si fuera un premio, basura. El ego lo celebra; el chat lo sopesa.',
  '%N lleva %C. Saturación con nombre y sin freno, ridículo. El ego lo celebra; el chat lo sopesa.',
  '%C en el marcador. %N, presencia no es perdón del resto, fracasado. El ego lo celebra; el chat lo sopesa.'
];
