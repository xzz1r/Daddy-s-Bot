...
let PARASITO = [
  ...
  '%N, %C mensajes. Parasito del grupo documentado sin anestesia. Y. el ranking no miente, cabrón sin anestesia de verdad esta vez.',
...
const RELEVANTE = [
  ...
  '%N con %C mensajes. Si te dieran un euro por mensaje ya habrías dejado el curro. Como no te lo dan, sigues aquí dale que dale, el más activo con diferencia, coño.',
  ...
  '%N, %C mensajes. Escribes tanto que el resto solo tiene que asentir. No sé si es liderazgo o que no tienes nada mejor que hacer, pero funciona, joder.',
  ...
  'Con %C mensajes, %N, si esto fuera una empresa ya te habrían hecho socio. Como no lo es, solo te queda el mérito y el dedo baldado de tanto escribir, mierda.',
  ...
  '%C mensajes, %N. Ese número dice que este grupo básicamente eres tú hablando solo con público de fondo. Impresionante y un poco triste a la vez, hostia.',
  ...
  'Con %C mensajes, %N, has convertido este chat en tu segunda casa. La primera debe de estar acumulando polvo, pero bueno, aquí se te valora, y con razón, mierda.',
  '%N, %C mensajes. Cada vez que hay drama, apareces con opinión y quince mensajes seguidos. Molesto a veces, imprescindible siempre. Contradicción con nombre, joder.',
  '%C mensajes, %N. Le has metido tantas horas a esto que técnicamente deberías cobrar. Como no cobras, al menos que sepas que se te tiene en cuenta, hostia.',
  ...
  'Con %C mensajes, %N, tienes más presencia aquí que en tu propia casa, seguramente. Y aun así te lo agradecemos, porque este chat sin ti se muere, mierda.',
  ...
  '%C mensajes, %N. No hay conversación de este grupo en la que no hayas metido baza. Eso es dedicación real o directamente no tener vida. Las dos valen, aquí sostienes, hostia.',
  '%N con %C mensajes. Sigues escribiendo aunque nadie te haya preguntado nada, y aun así funciona. Ese descaro tuyo mantiene esto vivo, hay que reconocerlo, coño.',
  'Con %C mensajes, %N, has escrito más que la mitad del grupo junto. O tienes mucho que decir o mucho tiempo libre. El resultado es el mismo: pesas, mierda.',
  ...
  '%N con %C mensajes. El grupo te necesita más de lo que tú necesitas al grupo, y eso se nota cada vez que abres la boca. Poder real, sin cargo ni honores, coño.',
  ...
  '%C mensajes, %N. Si el grupo tuviera nómina serías el empleado del mes cada mes. Como no la tiene, te quedas con la satisfacción y el pulgar cansado, hostia.',
  '%N con %C mensajes. Has convertido tu vicio de mirar el móvil en la columna vertebral de este chat. Enfermedad productiva, pero enfermedad al fin y al cabo, coño.',
  ...
  '%N, %C mensajes. Podrías tener una vida fuera de este chat y aun así eliges estar aquí escribiendo sin parar. Respeto y lástima a partes iguales, la verdad, joder.',
  '%C mensajes, %N. Eres el que más aparece en las capturas de pantalla de este grupo, para bien y para mal. Fama de la buena, la que se gana hablando, hostia.',
  ...
  'Con %C mensajes, %N, has demostrado que se puede vivir prácticamente dentro de un chat de WhatsApp. No sé si admirarte o llamarte a un médico, en serio, mierda.',
  ...
  'Con %C mensajes, %N, si algún día te vas de este grupo va a haber luto oficial. Y no de mentira, del de verdad, porque sostienes esto tú solo, mierda.',
  ...
  '%C mensajes, %N. Has escrito más aquí que en cualquier otra parte de tu vida, seguramente. Y aun así el grupo te lo agradece, porque sin ti esto se apaga, hostia.',
  '%N con %C mensajes. Tienes el dudoso honor de ser el que más notificaciones genera de todo el grupo. Molesto para el móvil, vital para la conversación, coño.',
  'Con %C mensajes, %N, hablas tanto que a veces se te olvida respirar entre mensaje y mensaje. Y aun así el grupo funciona mejor gracias a ese ritmo tuyo, mierda.',
  ...
  '%N con %C mensajes. Cuando entras al chat cambia el ritmo de todo el mundo. Eso es poder real, aunque lo ejerzas desde el sofá en calzoncillos, probablemente, coño.',
  ...
  '%C mensajes, %N. Has convertido este chat en tu terapia, tu entretenimiento y tu curro no pagado. Los tres a la vez, y aun así se agradece el resultado, hostia.',
  ...
  'Con %C mensajes, %N, cualquiera diría que cobras comisión por mensaje. No cobras nada, pero el nivel de implicación es exactamente ese. Respeto total, mierda.',
  ...
  '%C mensajes, %N. Sostienes esto con la constancia de quien no tiene nada mejor que hacer, y precisamente por eso el grupo te debe más de lo que crees, hostia.',
  '%N, %C mensajes. O sostienes el hilo o lo saturas: el contador no distingue heroísmo de ruido, joder.',
  'Con %C mensajes %N ya no puede hacerse el perfil bajo. Estás en el mapa a la fuerza, cabrón. mierda.',
  '%N lleva %C. Volumen de residente, sustancia a juicio del resto, gilipollas. coño Sin derecho a perfil bajo después.',
  '%C mensajes de %N. El grupo te nota cuando faltas y te aguanta cuando sobras, mierda. cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N con %C: o eres pilar o eres la mula de carga del chat, coño. gilipollas Así se ve la presencia de verdad.',
  '%C en el contador de %N. Eso ya no es visita, es empadronamiento, asco. patético No hay modo avión que borre esto.',
  '%N, %C mensajes. La irrelevancia dejó de ser tu coartada hace rato, patético. asco. Se te ve el desastre sin subtítulos, joder.',
  'Actividad de %N medida en %C. El bot te ve; el grupo también, basura. basura. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes. %N convertiste el grupo en segunda oficina, ridículo. ridículo El grupo ya no discute la cifra.',
  '%N no fantasma: lleva %C pruebas en el archivo, fracasado. fracasado Menuda forma de dejar huella. Se te ve el desastre sin subtítulos, joder.',
  '%N, %C mensajes y cero intención de bajar el ritmo. Menuda adicción al hilo, joder. joder. Se te ve el desastre sin subtítulos, joder.',
  'Con %C, %N es clima del chat, no anécdota, cabrón. mierda El archivo lo confirma en frío. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes de %N. Presencia que no pide permiso, gilipollas. coño Así se ve la presencia de verdad.',
  '%N ha soltado %C. El archivo lo confirma sin debate, mierda. cabrón No hay modo avión que borre esto.',
  '%C de actividad. %N está fijo en el ranking de ruido útil o inútil, coño. gilipollas. Se te ve el desastre sin subtítulos, joder.',
  '%N con %C mensajes: el contador es tu sombra, asco. patético. Se te ve el desastre sin subtítulos, joder.',
  'Relevancia a lo bruto: %N y sus %C, patético. asco El grupo ya no discute la cifra. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes. %N ya no cabe en el cajón de los que no escriben, basura. basura Menuda forma de dejar huella.',
  '%N lleva %C. Cuando faltas dos días el hilo se nota más muerto, ridículo. ridículo. Se te ve el desastre sin subtítulos, joder.',
  '%C en el reloj de %N. No hay modo avión que borre eso, fracasado. fracasado El archivo lo confirma en frío.',
  '%N, %C mensajes. O aportas o ocupas espacio caro, joder. joder Así se ve la presencia de verdad. Se te ve el desastre sin subtítulos, joder.',
  'Con %C mensajes %N se plantó y no se fue, cabrón. mierda No hay modo avión que borre esto. Se te ve el desastre sin subtítulos, joder.',
  '%C de %N. Currículum de scroll con nombre propio, gilipollas. coño El contador no negocia con excusas.',
  '%N no desaparece: %C veces lo demuestra, mierda. cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes. %N es parte del mobiliario del grupo, coño. gilipollas El grupo ya no discute la cifra.',
  'La relevancia de %N se mide en %C y a veces duele, asco. patético Menuda forma de dejar huella. Se te ve el desastre sin subtítulos, joder.',
  '%N, %C. El bot te pone en el mapa sin pedirte opinión, patético. asco Sin derecho a perfil bajo después.',
  '%C mensajes de presencia pura de %N, basura. basura El archivo lo confirma en frío. Se te ve el desastre sin subtítulos, joder.',
  '%N con %C: el hilo te reconoce al vuelo, ridículo. ridículo Así se ve la presencia de verdad. Se te ve el desastre sin subtítulos, joder.',
  '%C. %N es residente, no turista del chat, fracasado. fracasado No hay modo avión que borre esto. Se te ve el desastre sin subtítulos, joder.',
  '%N lleva %C mensajes. Saturación con firma, joder. joder El contador no negocia con excusas. Se te ve el desastre sin subtítulos, joder.',
  'Actividad alta y visible: %N %C, cabrón. mierda El grupo ya no discute la cifra. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes. %N no pide contexto: lo genera a martillazos, gilipollas. coño El grupo ya no discute la cifra.',
  '%N, %C en el pecho del contador, mierda. cabrón Menuda forma de dejar huella Sin derecho a perfil bajo después.',
  'Con %C, %N ya es estadística del grupo, coño. gilipollas Sin derecho a perfil bajo después. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes de %N. Volumen de quien vive aquí, asco. patético El archivo lo confirma en frío. Se te ve el desastre sin subtítulos, joder.',
  '%N no es rumor: son %C datos, patético. asco Así se ve la presencia de verdad No hay modo avión que borre esto.',
  '%C. Relevancia por insistencia de %N, basura. basura No hay modo avión que borre esto. Se te ve el desastre sin subtítulos, joder.',
  '%N con %C mensajes y el ranking de presencia te nombra, ridículo. ridículo El contador no negocia con excusas.',
  '%C mensajes. %N, el contador no te suelta, fracasado. fracasado. Se te ve el desastre sin subtítulos, joder.',
  '%N lleva %C. Enganche de los que ya no se discuten, joder. joder El grupo ya no discute la cifra. Se te ve el desastre sin subtítulos, joder.',
  'Con %C mensajes %N carga el grupo a hombros o lo aplasta, cabrón. mierda Menuda forma de dejar huella.',
  '%C de %N. Fiel o dependiente: el número no aclara, gilipollas. coño Sin derecho a perfil bajo después.',
  '%N, %C mensajes. Importante a la fuerza, mierda. cabrón El archivo lo confirma en frío. Se te ve el desastre sin subtítulos, joder.',
  '%C mensajes. %N se hizo fijo sin votación, coño. gilipollas Así se ve la presencia de verdad. Se te ve el desastre sin subtítulos, joder.',
  'Actividad de %N: %C. Documentado y sin anestesia, asco. patético No hay modo avión que borre esto. Se te ve el desastre sin subtítulos, joder.',
  '%N con %C. El fantasma ya no te queda de disfraz, patético. asco El contador no negocia con excusas.',
  '%C mensajes de %N en el historial vivo, basura. basura. Se te ve el desastre sin subtítulos, joder. El chat no necesita traducción del desastre, cabrón.',
  '%N, %C. Presencia sin modo pausa, ridículo. ridículo El grupo ya no discute la cifra. Se te ve el desastre sin subtítulos, joder.',
  '%C. El grupo ya cuenta contigo a regañadientes, %N, fracasado. fracasado Menuda forma de dejar huella.'
];
