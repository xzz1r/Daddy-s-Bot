...
let MOG_PHRASES = [
  ...
  'Diferencia de liga, no de suerte. %M en primera. %L en el barro. Qué asco de intento.',
  ...
  '%L perdió el mog check en silencio. %M ni se enteró del intento. Qué asco de intento.',
  ...
  '%L en el mog check es contenido gratis. %M es el motivo. Qué asco de intento.',
  ...
  '%L puede sofmear el universo. El hard wall sigue en su sitio con nombre %M da asco.',
  ...
  '%M gana por existir. %L pierde por no aceptar el muro. Qué asco de intento.',
