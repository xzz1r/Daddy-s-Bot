...
const CIERRES = [
  'Ranking cerrado. Guardad las capturas para el roast de mañana.',
  'Fin del top. El chat ya sabe quién sobra en la lista, cabrónsin esfuerzo.',
  'Lista servida sin anestesia ni indultos de amigos',
  ...
  'Ranking sellado. Sin apelación elegante posible',
  ...
  'Fin. Sin bis ni redención barata de último minuto',
  ...
  'Top fuera. Captura o cállate. Y encima lo repites, mierda. El numerito queda para el archivo del chat, basura.',
  ...
  'Top documentado en el historial vivo, coño. Y encima lo repites.',
  ...
  'Cierre. El eco sigue con los nombres, ridículo. Y encima lo repites.',
  'Top servido. El chat puede odiar en paz. Y encima lo repites, mierda.',
  'Ranking sellado a fuego, cabrón. Y encima lo repites, coño. El numerito queda para el archivo del chat, miserable.',
  'Fin del show de números, gilipollas. Y encima lo repites. El numerito queda para el archivo del chat, qué cringe.',
  'Cierre del desfile, mierda. Y encima lo repites, cabrón. El numerito queda para el archivo del chat, da asco, qué cringe.',
  'Top archivado, coño. Y encima lo repites, mierda. El numerito queda para el archivo del chat.',
  'Se terminó el listado de la vergüenza, asco. Y encima lo repites, coño.',
  'Lista dolorosa y necesaria, patético. Y encima lo repites. El numerito queda para el archivo del chat, fracasado.',
  ...
  'Ranking sin filtro de relaciones. Y encima lo repites. El numerito queda para el archivo del chat, qué nivel de pena.',
  ...
  'Top en el historial para siempre, coño. Y encima lo repites. El numerito queda para el archivo del chat, da pena ajena.',
  ...
  'Cierre sin apelación de amigos, ridículo. Y encima lo repites.',
  ...
  'Top archivado, coño. Y encima lo repites. El numerito queda para el archivo del chat.',
  'Ranking sellado, patético. Y encima lo repites. El numerito queda para el archivo del chat, patético.',
  ...
  'Lista lista. Quien no salió hoy puede salir mañana. Registro 10 del ranking, mierda.ajena.',
