...
function textoPresentacion(clave) {
  return '*PRESENTACIÓN OBLIGATORIA*\n' +
    '\n' +
    // LO QUE ES ESTE GRUPO, EN SU PROPIO PARRAFO Y LO PRIMERO. Lo pidio el
    // dueño: que el nuevo sepa desde la primera impresion que esto es humor
    // negro y que gente no entra. Una de quince, en baraja por grupo (salen
    // todas antes de repetir ninguna). Ver humorNegroPhrases.js.
    `*Esto es humor negro.* ${pickBaraja(HUMOR_NEGRO, `${clave}|humornegro`)}\n` +
    '\n' +
