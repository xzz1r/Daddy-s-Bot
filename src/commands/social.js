...
const AURA_LINES = [
  ...
  'Cada mensaje que sueltas suma aura. Cada dia que te callas es dinero que te dejas en la puta mesa, cabron, mierda.',
  ...
  'El marcador no tiene amiguitos ni se le olvida una puta coma. Lleva la cuenta exacta de lo que haces y lo que no, ridículo.',
  'El aura es tu reputacion con numeros, y los numeros del grupo no le perdonan la vida a ningun hijo de puta, fracasado.',
  'Se gana con calma y se pierde en un parpadeo, como todo lo que vale algo. Cuidala o jodete, cabron El grupo ya no discute la cifra, joder.',
  'Aqui el silencio cuesta pasta. Cada dia callado es aura que se pudre sin entrar. Abre la puta boca de una vez, mierda.',
  ...
  'Ganar aura es facil: escribe. Mantenerla es lo que separa a los que tienen cojones de los que se rajan a los tres dias, gilipollas.',
  ...
  'La constancia paga mas que la suerte, hostia. El que arrastra el culo aqui todos los dias acaba arriba sin enterarse, ridículo.',
  ...
  'El aura funciona como la puta vida: el que aparece gana, el que desaparece pierde y el que presume sin numeros queda de payaso, coño.',
  'Cada mil mensajes tu suerte de tirada sube un poco, para siempre. El veterano tira mejor porque se lo ha currado, cabron, cabrón.',
  ...
  'El aura no miente, cabron. Es el espejo del grupo y a la mayoria de hijos de puta no les gusta lo que ven, asco.',
  'Dos formas de subir: escribiendo o tirando dados. Pero solo una es gratis. La otra te puede dejar en la puta ruina, basura.',
  ...
  'El aura se gana escribiendo, puto vago. No hay atajos ni trucos de magia barata en este ranking, joder.',
  'Sin mensajes no hay aura. El contador no regala caridad a los fantasmas del grupo, cabrón No hay modo avión que borre esto.',
  'El aura no llega solo: se farmea con presencia real, no con intenciones de madrugada, gilipollas El contador no negocia con excusas.',
  'Escribe o quédate en miseria de ranking. El sótano está lleno de los que esperaban milagros, mierda.',
  'El bot no inventa aura de la nada. Muévete o acepta el número que te mereces, coño El grupo ya no discute la cifra.',
  'Sin actividad el aura se oxida y el ranking te borra del mapa útil, asco Menuda forma de dejar huella.',
  'Presencia o pobreza de ranking. Elige con el teclado, no con la boca, patético Sin derecho a perfil bajo después.',
  'El aura premia al que está. Al fantasma laboral lo ignora sin remordimiento, basura El archivo lo confirma en frío.',
  'No hay atajo: escribe o sigue mirando el sótano desde abajo, ridículo Así se ve la presencia de verdad, ridículo.',
  'El contador de aura lee mensajes, no promesas de que mañana sí vienes, fracasado No hay modo avión que borre esto, fracasado.',
  'El aura se gana escribiendo, puto vago. No hay atajos ni trucos de magia barata en este ranking, joder.',
  'Sin mensajes no hay aura. El contador no regala caridad a los fantasmas del grupo, cabrón Documentado sin anestesia posible.',
  'El aura no llega solo: se farmea con presencia real, no con intenciones de madrugada, gilipollas El grupo ya no discute la cifra.',
  'Escribe o quédate en miseria de ranking. El sótano está lleno de los que esperaban milagros, mierda.',
  'El bot no inventa aura de la nada. Muévete o acepta el número que te mereces, coño Sin derecho a perfil bajo después.',
  'Sin actividad el aura se oxida y el ranking te borra del mapa útil, asco El archivo lo confirma en frío.',
  'Presencia o pobreza de ranking. Elige con el teclado, no con la boca, patético Así se ve la presencia de verdad.',
  'El aura premia al que está. Al fantasma laboral lo ignora sin remordimiento, basura No hay modo avión que borre esto.',
  'No hay atajo: escribe o sigue mirando el sótano desde abajo, ridículo El contador no negocia con excusas, ridículo.',
  'El contador de aura lee mensajes, no promesas de que mañana sí vienes, fracasado Documentado sin anestesia posible, fracasado.',
  'El aura se gana escribiendo, puto vago. No hay atajos ni trucos de magia barata en este ranking, joder.',
  'Sin mensajes no hay aura. El contador no regala caridad a los fantasmas del grupo, cabrón Menuda forma de dejar huella.',
  'El aura no llega solo: se farmea con presencia real, no con intenciones de madrugada, gilipollas Sin derecho a perfil bajo después.',
  'Escribe o quédate en miseria de ranking. El sótano está lleno de los que esperaban milagros, mierda.',
  'El bot no inventa aura de la nada. Muévete o acepta el número que te mereces, coño Así se ve la presencia de verdad.',
  'Sin actividad el aura se oxida y el ranking te borra del mapa útil, asco No hay modo avión que borre esto.',
  'Presencia o pobreza de ranking. Elige con el teclado, no con la boca, patético El contador no negocia con excusas.',
  'El aura premia al que está. Al fantasma laboral lo ignora sin remordimiento, basura Documentado sin anestesia posible.',
  'No hay atajo: escribe o sigue mirando el sótano desde abajo, ridículo El grupo ya no discute la cifra, ridículo.',
  'El contador de aura lee mensajes, no promesas de que mañana sí vienes, fracasado Menuda forma de dejar huella, fracasado.',
  'El aura se gana escribiendo, puto vago. No hay atajos ni trucos de magia barata en este ranking, joder.',
  'Sin mensajes no hay aura. El contador no regala caridad a los fantasmas del grupo, cabrón El archivo lo confirma en frío.',
  'El aura no llega solo: se farmea con presencia real, no con intenciones de madrugada, gilipollas Así se ve la presencia de verdad.',
  'Escribe o quédate en miseria de ranking. El sótano está lleno de los que esperaban milagros, mierda.',
  'El bot no inventa aura de la nada. Muévete o acepta el número que te mereces, coño El contador no negocia con excusas.',
  'Sin actividad el aura se oxida y el ranking te borra del mapa útil, asco Documentado sin anestesia posible.',
  'Presencia o pobreza de ranking. Elige con el teclado, no con la boca, patético El grupo ya no discute la cifra.',
  'El aura premia al que está. Al fantasma laboral lo ignora sin remordimiento, basura Menuda forma de dejar huella.',
  'No hay atajo: escribe o sigue mirando el sótano desde abajo, ridículo Sin derecho a perfil bajo después, ridículo.',
  'El contador de aura lee mensajes, no promesas de que mañana sí vienes, fracasado El archivo lo confirma en frío, fracasado.',
  'El aura se gana escribiendo, puto vago. No hay atajos ni trucos de magia barata en este ranking, joder.',
  'Sin mensajes no hay aura. El contador no regala caridad a los fantasmas del grupo, cabrón No hay modo avión que borre esto.',
  'El aura no llega solo: se farmea con presencia real, no con intenciones de madrugada, gilipollas El contador no negocia con excusas.',
  'Escribe o quédate en miseria de ranking. El sótano está lleno de los que esperaban milagros, mierda.',
