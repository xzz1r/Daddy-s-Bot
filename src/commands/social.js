...
const AURA_LINES = [
  ...
  'Se gana con calma y se pierde en un parpadeo, como todo lo que vale algo. Cuidala o jodete, cabron, y el chat lo tiene claro, joder.',
  ...
  'Sin mensajes no hay aura. El ranking no regala puntos por respirar en el grupo, joder, y el chat lo tiene claro, joder.',
  'Escribe o queda en cero. El bot no lee la mente ni premia a los mirones, mierda, y el chat lo tiene claro, mierda.',
  'Sin mensajes no hay aura. El contador no regala caridad, cabrón, y el chat lo tiene claro, coño.',
  'El aura no llega solo: se farmea con presencia, gilipollas, y el chat lo tiene claro, cabrón.',
  'Escribe o quédate en miseria de ranking, mierda, y el chat lo tiene claro, gilipollas.',
  'El bot no inventa aura de la nada. Muévete, coño, y el chat lo tiene claro, patético.',
  'Sin actividad el aura se oxida, asco, y el chat lo tiene claro, asco.',
  'Presencia o pobreza de ranking. Elige, patético, y el chat lo tiene claro, basura.',
  'El aura premia al que está. Al fantasma lo ignora, basura, y el chat lo tiene claro, ridículo.',
  'No hay atajo: escribe o sigue en el sótano, ridículo, y el chat lo tiene claro, fracasado.',
  'El contador de aura lee mensajes, no intenciones, fracasado, y el chat lo tiene claro, joder.',
  'Farmea o queja. Solo una de las dos suma, joder, y el chat lo tiene claro, mierda.',
  'Aura en cero es diagnóstico de ausencia, cabrón, y el chat lo tiene claro, coño.',
  'El ranking no respeta al silencioso eterno, gilipollas, y el chat lo tiene claro, cabrón.',
  'Escribe. El aura no se descarga por WiFi mental, mierda, y el chat lo tiene claro, gilipollas.',
  'Sin scroll de salida no hay subida de aura, coño, y el chat lo tiene claro, patético.',
  'El aura se gana en el hilo, no en la cabeza, asco, y el chat lo tiene claro, asco.',
  'Miseria de aura = miseria de presencia, patético, y el chat lo tiene claro, basura.',
  'El bot cobra en mensajes. Paga o no juegues, basura, y el chat lo tiene claro, ridículo.',
  'Aura baja es el recibo de no estar, ridículo, y el chat lo tiene claro, fracasado.',
  'No hay cheat code. Solo teclado, fracasado, y el chat lo tiene claro, joder.',
  'Escribe algo o acepta el sótano, joder, y el chat lo tiene claro, mierda.',
  'El aura no perdona al fantasma laboral, cabrón, y el chat lo tiene claro, coño.',
  'Presencia documentada o ranking en dieta, gilipollas, y el chat lo tiene claro, cabrón.',
  'Sin mensajes el aura es un rumor, mierda, y el chat lo tiene claro, gilipollas.',
  'El contador espera tu parte. Muévete, coño, y el chat lo tiene claro, patético.',
  'Aura se farmea. El resto es cuento, asco, y el chat lo tiene claro, asco.',
  'El sótano está lleno de los que no escriben, patético, y el chat lo tiene claro, basura.',
  'No hay aura gratis en este grupo, basura, y el chat lo tiene claro, ridículo.',
  'Escribe o sigue mirando desde abajo, ridículo, y el chat lo tiene claro, fracasado.',
  'El ranking lee actividad, no promesas, fracasado, y el chat lo tiene claro, joder.',
  'Farmea el aura como el resto o cállate, joder, y el chat lo tiene claro, mierda.',
  'Sin teclas no hay subida, cabrón, y el chat lo tiene claro, coño.',
  'El aura premia al presente, gilipollas, y el chat lo tiene claro, cabrón.',
  'Mensajes o miseria. Simple, mierda, y el chat lo tiene claro, gilipollas.',
  'El bot no regala puntos por existir en silencio, coño, y el chat lo tiene claro, patético.',
  'Aura baja: recibo de ausencia, asco, y el chat lo tiene claro, asco.',
  'Escribe. El sótano no es estética, patético, y el chat lo tiene claro, basura.',
  'Sin actividad el ranking te borra del mapa útil, basura, y el chat lo tiene claro, ridículo.',
  'El aura se gana feo: escribiendo, ridículo, y el chat lo tiene claro, fracasado.',
  'No hay atajo de pobre. Hay teclado, fracasado, y el chat lo tiene claro, joder.',
  'Presencia o pobreza de aura documentada, joder, y el chat lo tiene claro, mierda.',
  'El contador no negocia con fantasmas, cabrón, y el chat lo tiene claro, coño.',
  'Escribe algo con sustancia o con ruido, pero escribe, gilipollas, y el chat lo tiene claro, cabrón.',
  'Aura en dietas por falta de mensajes, mierda, y el chat lo tiene claro, gilipollas.',
  'El ranking espera tu check-in diario, coño, y el chat lo tiene claro, patético.',
  'Sin scroll de salida sigues en miseria, asco, y el chat lo tiene claro, asco.',
  'El aura no llega por rezos, patético, y el chat lo tiene claro, basura.',
  'Farmea o acepta el sótano con dignidad, basura, y el chat lo tiene claro, ridículo.',
  'Mensajes = aura. El resto es narrativa, ridículo, y el chat lo tiene claro, fracasado.',
  'El bot cobra presencia. Paga, fracasado, y el chat lo tiene claro, joder.',
  'Sin actividad el aura se oxida, asco, mierda, y el chat lo tiene claro, mierda.',
  'Escribe algo o acepta el sótano, joder, coño, y el chat lo tiene claro, coño.',
  'Sin teclas no hay subida, cabrón, cabrón, y el chat lo tiene claro, cabrón.',
  'El aura premia al presente, gilipollas, gilipollas, y el chat lo tiene claro, gilipollas.',
  'Mensajes o miseria. Simple, mierda, patético, y el chat lo tiene claro, patético.',
  'Aura baja: recibo de ausencia, asco, asco, y el chat lo tiene claro, asco.',
  'El aura no llega por rezos, patético, basura, y el chat lo tiene claro, basura.',
  'El bot cobra presencia. Paga, fracasado, ridículo, y el chat lo tiene claro, ridículo.',
  'Sin actividad el aura se oxida, asco, fracasado, y el chat lo tiene claro, fracasado.',
  'Sin teclas no hay subida, cabrón, joder, y el chat lo tiene claro, joder.',
  'Mensajes o miseria. Simple, mierda, mierda, y el chat lo tiene claro, mierda.',
  'Aura baja: recibo de ausencia, asco, coño, y el chat lo tiene claro, coño.',
  'El aura no llega por rezos, patético, cabrón, y el chat lo tiene claro, cabrón.',
  'Sin actividad el aura se oxida, asco, gilipollas, y el chat lo tiene claro, gilipollas.',
  'Sin teclas no hay subida, cabrón, patético, y el chat lo tiene claro, patético.',
  'Mensajes o miseria. Simple, mierda, asco, y el chat lo tiene claro, asco.',
  'Aura baja: recibo de ausencia, asco, basura, y el chat lo tiene claro, basura.',
  'El aura no llega por rezos, patético, ridículo, y el chat lo tiene claro, ridículo.',
  'Sin teclas no hay subida, cabrón, fracasado, y el chat lo tiene claro, fracasado.'
];
