...
const AURA_LINES = [
  ...
  'Sin mensajes no hay aura. El contador no regala caridad a fantasmassin esfuerzo, joder.',
  'Farmea presencia o acepta el sótano. El bot no cotiza intencionesa indultos, joder.',
  'Aura en cero es recibo de ausencia, no de misterio interesanteir roce, joder.',
  'Escribe o sigue mirando el ranking ajeno desde abajo, cabrónstesia.',
  'El aura premia al que está. Al que desaparece lo borra sin dramaste numerito, joder.',
  ...
  'Escribe aunque sea basura. Basura suma más que cero, coñol en público.',
