...
const AURA_LINES = [
  ...
  'No hay cheat code. Solo teclado y constancia fea',
  ...
  'Primero presencia, después apuestas y tienda',
  ...
  'No hay indulto de pobre para quien no farmea',
  ...
  'La subida no entiende de excusas creativas',
  ...
  'Escribe o que el número te humille en paz',
  ...
  'La moneda del grupo se llama mensaje',
  ...
  'No escribas un ensayo. Escribe algo',
