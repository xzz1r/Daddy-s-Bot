...
let ADMIN_PHRASES = [
  [
    'Número uno Y admin. El cargo y la adicción en la misma persona. El grupo no tiene escapatoria.',
    ...
    'Número uno y admin. Trabajas el grupo más que muchos su empleo. Preocupante y admirable.',
    ...
    'Número uno siendo admin. Un admin que participa vale por diez que solo miran. Y tú vales por veinte.',
  ...
  [
    ...
    'Plata y admin. Mandas más que hablas, y aquí eso se paga con el segundo puesto.',
    ...
    'Segundo y admin. Ganas en poder y pierdes en presencia. Elige que te importa más.',
    ...
    'Plata con cargo. Ser el segundo más activo siendo admin tampoco esta mal. Pero no es ser el primero.',
    ...
    'Segundo y admin. Que un miembro raso te gane el marcador dice mucho de sus horas libres. Y de las tuyas.',
    ...
    'Plata y admin. El cargo pesa y aun así apareces. Eso ya es más de lo que hacen la mayoría.',
  ...
  [
    ...
    'Bronce y admin. Mandas mucho y apareces poco. Aquí eso se ve en un solo renglón.',
    ...
    'Tercero y admin. Estás en el podio de milagro y el milagro se llama constancia mínima.',
    ...
    'Bronce y admin. Moderas bien y hablas poco. Hay perfiles peores, pero también bastante mejores.',
    ...
    'Bronce y admin. Aportas lo suficiente para justificar el cargo. Justo eso y ni un mensaje más.',
    ...
    'Tercero y admin. La placa te sostiene el puesto mejor de lo que lo sostienen tus mensajes.',
