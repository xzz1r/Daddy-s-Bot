...
const MEMBER_PHRASES = [
  [
    ...
    'Primer puesto. Mientras los demás tenían planes, tu tenías teclado. Aquí se te premia, fuera no.',
    'Nadie te ha ganado y nadie lo va a intentar. Competir contigo es aceptar que tampoco tienes nada que hacer.',
    'Número uno indiscutible. El grupo entero podría callarse y tu seguirías manteniendo la conversación solo.',
    ...
    'Número uno. Cuando alguien pregunta quien mueve este grupo, salta tu nombre antes de que lo pregunten.',
    ...
    'Primero. Mientras otros piensan que decir, tu ya lo has dicho tres veces. Rápido y sin filtro.',
    ...
    'Primer lugar. Has ganado a todos los que si tienen vida social. Piénsalo despacio.',
  ...
  [
    ...
    'Número dos. Escribes mucho, si. Pero hay alguien que escribe más y no piensa cansarse.',
    ...
    'Casi lo tocas. Casi. Y ese casi lleva persiguiendote más tiempo del que reconoces en público.',
    ...
    'Número dos. Te sobra presencia y te falta el último empujón. Lleva faltandote desde el principio.',
    ...
    'Número dos. Aportas de sobra, pero el primero aporta más y encima duerme menos. No hay tu tia.',
    'Plata. El grupo te lee y te responde. Y luego se va a leer al de arriba. Que le vamos a hacer.',
    'Segundo. Con más horas serías primero, pero entonces tampoco tendrías vida. Tu decides que prefieres.',
    'Vas segundo porque el primero es una máquina. Consuélate: perder contra eso no es del todo humillante.',
    'Número dos. Todo el mundo sabe quien eres. Nadie te pone el primero. Rumia eso un rato.',
    'Plata. Buen puesto para quien se conforma. Malo para quien no. Ya sabrás tu cual eres.',
  ...
  [
    ...
    'Bronce. Aportas, si. Pero de los tres eres el que menos y eso el marcador lo canta.',
    'Tercer lugar. El primero manda, el segundo aprieta y tu haces bulto en la parte bonita de la tabla.',
    ...
    'Tercero. La gente te reconoce, nadie te teme. Es una posición comoda y absolutamente inofensiva.',
    'Bronce. Los dos de arriba no te miran y los de abajo si. Vive con eso.',
    ...
    'Tercer lugar. Los de arriba llevan otro ritmo y tu lo sabes. Por eso no aprietas: te ahorras el ridículo.',
...
const ADMIN_PHRASES = [
  [
    ...
    'Número uno con placa. Otros admins reparten ordenes; tu además rellenas el chat tu solo.',
    ...
    'Número uno con cargo. El grupo te tiene miedo y te tiene leido. Combinación imbatible.',
    'Admin y líder. Otros usan el cargo para no hacer nada; tu lo usas y encima haces el doble.',
    ...
    'Primero y admin. El único que puede echarte de aquí eres tu mismo, y no pareces por la labor.',
    'Número uno con galones. Un admin que participa vale por diez que solo miran. Y tu vales por veinte.',
    'Admin en la cima del marcador. La autoridad se te nota en el cargo y el vicio en las cifras.',
    'Primero llevando el cargo. Este grupo funciona porque tu no te despegas de el ni para dormir.',
    'Admin y primero. Repartes justicia entre mensaje y mensaje. Nadie sabe cuando descansas.',
    'La placa y el trono. Si esto fuera un país, seriais tu, tu, y otra vez tu.',
  ...
  [
    ...
    'Segundo lugar siendo admin. El cargo lo tienes; la corona la tiene otro. Incomodo, verdad.',
    ...
    'Plata y placa. Nadie va a quitarte el cargo. El puesto en cambio esta bastante en el aire.',
    ...
    'Plata con autoridad real. Aquí mandas tu y escribe otro. Reparto raro pero estable.',
    ...
    'Plata y cargo. Estás justo donde se esta comodo: con poder y sin la obligación de ser el más visible.',
  ...
  [
    ...
    'Bronce con autoridad. Nadie te discute, nadie te sigue. Un mando comodo y silencioso.',
    'Admin en bronce. Los dos de arriba no llevan placa y aun así mandan más en la conversación.',
    'Tercero con galones. Estás en el podio de milagro y el milagro se llama constancia minima.',
    ...
    'Tercer puesto con placa. Un mal mes y sales del podio siendo admin. Eso si que sería un titular.',
    ...
    'Admin tercero. Cumples, moderas y apareces. Los tres verbos en su versión minima, pero cumples.',
  ],
];
