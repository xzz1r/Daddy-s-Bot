...
const LABELS = {
  ...
  friki: {
    ...
    high: [
      ...
      '[nombre], friki que se ofende si no conocen su referencia de sótano. Sótano sin salida útil, joder, joder.',
  ...
  perdedor: {
    ...
    high: [
      ...
      'Perdedor con opinión: la peor clase que existe en este chat, [nombre]. Solo derrota documentada, gilipollas.',
      ...
      'Perdedor con opinión: la peor clase que existe en este chat, [nombre]. El fail es tu marca, gilipollas.',
      ...
      'Fracasado de repertorio: siempre el mismo final en cada historia que cuentas, [nombre]. El fail es tu marca, asco.',
      ...
      'Se te nota el hábito de empujar todo hacia la misma derrota, [nombre]. Cero logros que enseñar, cabrón.',
      '[nombre], no has hecho nada y aun así tienes algo que dictar. El fail es tu marca, patético, joder, y el grupo no se traga el cuento, gilipollas.',
      ...
      'Perdedor de los que llaman mala suerte a su propia falta de oficio, [nombre]. Cero logros que enseñar, fracasado.',
      ...
      '[nombre], tu único mérito es seguir aquí después de tanto ridículo acumulado. Cero logros que enseñar, coño.',
      'Se te nota el hábito de empujar todo hacia la misma derrota, [nombre]. Solo derrota documentada, cabrón.',
      '[nombre], no has hecho nada y aun así tienes algo que dictar. Cero logros que enseñar, patético, joder.',
      'Fracasado de repertorio: siempre el mismo final en cada historia que cuentas, [nombre]. Solo derrota documentada, asco.',
      'Has convertido el fail en identidad y el ranking te nombra sin dudar, [nombre]. El fail es tu marca, basura.',
      '[nombre], coleccionas derrotas como otros coleccionan anécdotas. Cero logros que enseñar, ridículo, joder.',
      'Perdedor de los que llaman mala suerte a su propia falta de oficio, [nombre]. Solo derrota documentada, fracasado.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. El fail es tu marca, joder.',
      'Perdedor de manual: ni una anécdota que no sea derrota reciclada, [nombre]. Cero logros que enseñar, mierda.',
      '[nombre], tu único mérito es seguir aquí después de tanto ridículo acumulado. Solo derrota documentada, coño.',
      ...
      '[nombre], coleccionas derrotas como otros coleccionan anécdotas. Solo derrota documentada, ridículo, joder.',
      ...
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder patético.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder asco.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder basura.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder ridículo.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder fracasado.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder joder.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder mierda.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder coño.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder cabrón.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder gilipollas.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder patético.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder asco.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder basura.',
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar, joder ridículo.',
