...
const LABELS = {
  ...
  delulu: {
    ...
    mid: [
      '[nombre], estás a medias entre verlo y seguir creyendo lo que te conviene, patético.',
      'Delulu moderado, [nombre]: ya sospechas la verdad, pero aún no la firmas, miserable.',
      '[nombre], mezclas datos reales con esperanza. El resultado es confusión estable, qué cringe.',
      '[nombre], no estás en la luna, pero tampoco con los pies del todo en el suelo, da asco.',
      '[nombre], interpretas de más de vez en cuando. No siempre: lo suficiente para notarlo, qué vergüenza.',
      '[nombre], hay un poco de película en cómo te cuentas las cosas, ridículo.',
      '[nombre], tu radar falla en lo que te gusta oír. En lo demás funciona, fracasado.',
      'Delulu de mantenimiento, [nombre]: todavía negocias con la evidencia en vez de aceptarla, qué miseria.',
      '[nombre], a ratos realista, a ratos en modo fanfic personal, da grima.',
      '[nombre], no es extremo, pero tu autoengaño hace turnos, qué nivel de pena.',
      '[nombre], crees la mitad de lo que te inventas. La otra mitad te sostiene el día, basura.',
      '[nombre], estás en la zona gris: ni ciego del todo ni lúcido del todo, qué cutre.',
      '[nombre], a veces amplificas señales. Otras veces las ves bien. da pena ajena.',
      'Delulu mid, [nombre]: el ego discute con los datos y a veces gana el ego, qué vacío.',
      '[nombre], tu relato personal tiene retoques. No es mentira total, pero hay filtro, indignante.',
      '[nombre], dudas, y eso ya es progreso. Falta actuar como si la duda importara, qué flojo.',
      '[nombre], aún guardas versiones optimistas de cosas que ya cerraron, menudo desastre.',
      '[nombre], no vives en una novela, pero le pones banda sonora de más, qué pena.',
      '[nombre], hay lucidez a ratos. También hay relectura esperanzada de más, da vergüenza.',
      '[nombre], el autoengaño no te gobierna siempre, pero tampoco se fue del todo, qué vergüenza ajena.',
      '[nombre], lees bien cuando no te implica. Cuando te implica, inventas margen, patético.',
      '[nombre], estás a un paso de aceptar el dato y a un paso de suavizarlo, miserable.',
      '[nombre], tu versión de los hechos tiene ediciones menores, no un guion nuevo, qué cringe.',
      '[nombre], el hope no te ciega: te nubla lo justo para seguir incómodo, da asco.',
      '[nombre], alternas realismo y cuento según te convenga el tramo, qué vergüenza.',
      '[nombre], no exageras siempre. Solo cuando el resultado te toca de cerca, ridículo.',
      '[nombre], la evidencia entra, pero a veces la dejas en bandeja de entrada, fracasado.',
      '[nombre], te pillas a ti mismo inventando y aun así sigues un rato más, qué miseria.',
      '[nombre], delulu a media potencia: suficiente para no caer, insuficiente para despertar, da grima.',
      '[nombre], tu lectura es decente hasta que aparece lo que querías oír, qué nivel de pena.',
      '[nombre], no fabricas novelas enteras, pero sí capítulos de más, basura.',
      '[nombre], el grupo te ve en modo intermitente: a veces claro, a veces en pose, qué cutre.',
      '[nombre], aceptas el no a medias y lo archivas como \'ya veremos\', da pena ajena.',
      '[nombre], tu ego no grita: susurra justificaciones creíbles, qué vacío.',
      '[nombre], hay filtro, no cieguera. El filtro igual distorsiona, indignante.',
      '[nombre], estás aprendiendo a mirar el dato, pero todavía regateas, qué flojo.',
      '[nombre], la película bajó de categoría: ya no es estreno, sigue en cartelera, menudo desastre.',
      '[nombre], mezclas intuición útil con proyección barata, qué pena.',
      '[nombre], el tira y afloja se te nota en cómo cuentas lo mismo dos veces, da vergüenza.',
      '[nombre], no estás perdido: estás negociando con la realidad, qué vergüenza ajena.',
      '[nombre], a veces el silencio lo dejas en silencio. Otras le inventas trama, patético.',
      '[nombre], tu delulu es de mantenimiento, no de crisis, miserable.',
      '[nombre], ves el rechazo y le pones una nota al pie innecesaria, qué cringe.',
      '[nombre], el hope te hace compañía sin ser tu jefe del todo, da asco.',
      '[nombre], calibras mal solo los temas donde te va el orgullo, qué vergüenza.',
      '[nombre], no es ficción completa: es edición tendenciosa, ridículo.',
      '[nombre], estás más cerca del suelo que ayer, y aún así miras el techo, fracasado.',
      '[nombre], el autoengaño aparece por turnos, no a jornada completa, qué miseria.',
      '[nombre], entiendes el dato y aun así le pides una segunda opinión al ego, da grima.',
      '[nombre], delulu intermedio: ni ciego ni quirúrgico. Justo en el medio molesto, qué nivel de pena.'
    ],
    low: [
      '[nombre], esta vez estás bastante anclado. Pocas películas, más dato, patético.',
      '[nombre], poco delulu: miras el rechazo como rechazo y no como misterio, miserable.',
      '[nombre], tu lectura de la realidad está más limpia de lo habitual, qué cringe.',
      '[nombre], bajo de autoengaño. Se nota cuando no fuerzas la narrativa, da asco.',
      '[nombre], aceptas el no sin convertirlo en epopeya. Eso es raro y sano aquí, qué vergüenza.',
      '[nombre], casi sin filtro fantasioso. El ego no está de turnista hoy, ridículo.',
      '[nombre], interpretas menos y observas más. Buen cambio de software, fracasado.',
      '[nombre], delulu bajo: la evidencia te pesa más que la esperanza, qué miseria.',
      '[nombre], no estás fabricando química con migajas. Progreso real, da grima.',
      '[nombre], lectura sobria. El grupo lo notaría si comparara con tus días peores, qué nivel de pena.',
      '[nombre], dejas que el silencio sea silencio. No le pones guion, basura.',
      '[nombre], poca proyección. Hoy no estás de director de cine emocional, qué cutre.',
      '[nombre], tu autoestima no pide fanfic para sostenerse en este tramo, da pena ajena.',
      '[nombre], anclado. Sin novela paralela detectada en esta tirada, qué vacío.',
      '[nombre], miras el dato aunque moleste. Eso ya no es delulu, indignante.',
      '[nombre], separas deseo de señal. Diferencia clave, qué flojo.',
      '[nombre], no amplificas un \'ok\' a declaración. Bien calibrado, menudo desastre.',
      '[nombre], realismo usable. No perfecto, pero funcional, qué pena.',
      '[nombre], el relato personal y los hechos están más cerca de lo normal, da vergüenza.',
      '[nombre], poco teatro interno. Se agradece el descanso del guion, qué vergüenza ajena.',
      '[nombre], hoy el ego no está reescribiendo el chat en vivo, patético.',
      '[nombre], tomas el no como información, no como acertijo, miserable.',
      '[nombre], menos proyección, más lectura limpia, qué cringe.',
      '[nombre], el hope está en su sitio: abajo del dato, da asco.',
      '[nombre], no inventas continuidad donde hubo un mensaje suelto, qué vergüenza.',
      '[nombre], sobrio para los estándares del grupo, ridículo.',
      '[nombre], el filtro bajó. Se te ve más claro, fracasado.',
      '[nombre], aceptas el límite sin montar una temporada extra, qué miseria.',
      '[nombre], poca fantasía operativa en esta tirada, da grima.',
      '[nombre], estás mirando al frente, no al guion, qué nivel de pena.',
      '[nombre], el autoengaño hoy está en pausa, basura.',
      '[nombre], calibración decente. Sin novela adjunta, qué cutre.',
      '[nombre], dejas el silencio quieto y eso ya es nivel, da pena ajena.',
      '[nombre], no conviertes cortesía en trama romántica, qué vacío.',
      '[nombre], el dato entra sin aduanas del ego, indignante.',
      '[nombre], lectura plana y útil. Sin adornos, qué flojo.',
      '[nombre], poco delulu detectable en el corte, menudo desastre.',
      '[nombre], hoy no estás vendiendo una versión premium de los hechos, qué pena.',
      '[nombre], el rechazo se queda en rechazo. Bien, da vergüenza.',
      '[nombre], sin fanfic de bolsillo en esta pasada, qué vergüenza ajena.',
      '[nombre], más suelo que nube. Se nota, patético.',
      '[nombre], el ego no está de guionista ahora, miserable.',
      '[nombre], interpretas poco y aciertas más, qué cringe.',
      '[nombre], la realidad te cabe sin retorcerla, da asco.',
      '[nombre], bajo de proyección, alto de lectura, qué vergüenza.',
      '[nombre], no hay película paralela abierta, ridículo.',
      '[nombre], sobriedad usable en el hilo, fracasado.',
      '[nombre], el hope no te está manejando el volante, qué miseria.',
      '[nombre], hoy el espejo no tiene filtro de historias, da grima.',
      '[nombre], anclado y legible. Sin teatro extra, qué nivel de pena.'
    ],
  },
