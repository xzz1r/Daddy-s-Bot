...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel de manual: repartes culpa y no te has mirado nunca de verdad, [nombre]. Se te ve a la legua, coño.',
      'Se te nota el rastro de incel hasta en los mensajes que pretenden ser neutrales, [nombre], ridículo.',
      'Incel como un anuncio repetido que nadie pidió, joder. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Has convertido el resentimiento en identidad. y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Incel sin una carta nueva: siempre la misma mano sucia. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre]. Se te ve a la legua, joder.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre]. Menudo numerito, mierda.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre]. Se te ve a la legua, ridículo.',
      'No hay misterio interesante: hay previsible y amargado, el combo del high, [nombre]. Menudo numerito, fracasado.',
      'Tienes el historial de un foro abandonado: posts de odio, cero vida, [nombre]. Pura vergüenza, joder.',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu mismo sótano, [nombre]. Se te ve a la legua, asco.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Menudo numerito, basura.',
      'Incel de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre]. Se te ve a la legua, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre]. Menudo numerito, patético.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre]. Pura vergüenza, asco.',
      ...
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre]. Se te ve a la legua, coño.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Se te nota el peso de arrastrar el mismo sótano por cada conversación, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'No hay barniz de genio incomprendido: hay amargura y el high lo cobra, [nombre]. Se te ve a la legua, joder.',
      'Tienes el tono de quien acumula fichas de odio y nunca invita a jugar limpio, [nombre]. Menudo numerito, mierda.',
      'Incel de las que alardean del sótano porque el exterior las deja sin personaje, [nombre]. Pura vergüenza, coño.',
      ...
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre]. Se te ve a la legua, ridículo.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre]. Menudo numerito, fracasado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre]. Pura vergüenza, joder.',
      ...
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre]. Se te ve a la legua, asco.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. Menudo numerito, basura.',
      'No hay barniz de antihéroe nerd: hay amargura y el high la nombra, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Se te nota el hábito de empujar cada hilo hacia el rincón sin ventana, [nombre]. Se te ve a la legua, gilipollas.',
      'La compostura del nivel no te reconoce en el elenco social, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre]. Pura vergüenza, asco.',
      ...
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre]. Se te ve a la legua, coño.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre]. Menudo numerito, cabrón.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'El high no es un mal día de humor: es.joder. Hostia puta. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre]. Pura vergüenza, coño.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] El ranking firma y listo. El chat no discute, cabrón.',
      ...
      'No es estilo amargo con gracia: eres incel y el high no discute la evidencia, [nombre]. Se te ve a la legua, ridículo.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], no es que te falte ángulo: es que te faltan los tres y el cuarto también. Se te ve a la legua, joder.',
      'Tienes el atractivo de un martes lluvioso en una sala de espera, [nombre]. Pura mierda. Estética, mierda.',
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco con piernas. El chat no discute, cabrón.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Se te nota la fealdad hasta en la miniatura del estado, [nombre]. Ridículo de bulto. Sin indulto, patético.',
      '[nombre], el modo retrato de tu móvil debería venir con advertencia sanitaria. El grupo ya tomó nota, asco.',
      'Fea de las que hacen que el fotógrafo cobre extra por trauma, [nombre]. Mierda. Pura. Sin anestesia, basura.',
      '[nombre], no hay misterio: hay huesos de mala suerte y piel que no perdona. Se te ve a la legua, ridículo.',
      'Tu simetría es un chiste malo contado dos veces, [nombre]. Fracasado. Del catálogo visual, fracasado.',
      '[nombre], si te miran de frente es por educación, no por interés. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. De material. El chat no discute, mierda.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'La luz natural te delata como un puto detector de mentiras, [nombre]. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], no eres \\\'interesante\\\': eres difícil de mirar y punto. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el group selfie se recorta solo, [nombre]. Ridículo automático. Sin anestesia, patético.',
      '[nombre], tu cara pide un softbox y un milagro, y no hay presupuesto para ninguno. Se te ve a la legua, asco.',
      'Si el atractivo fuera nota, tú irías a recuperación en agosto, [nombre]. Mierda. Académica. Menudo numerito, basura.',
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. Sin plot twist. El chat no discute, fracasado.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético. Empate. Sin indulto, mierda.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de las que el espejo del ascensor tiene traumas, [nombre]. Ridículo móvil. Sin anestesia, cabrón.',
      '[nombre], tienes el tipo de cara que hace cambiar de acera sin confesarlo. Se te ve a la legua, gilipollas.',
      'No es un mal día: es el material de base, [nombre]. Puta mierda. Estructural. Menudo numerito, patético.',
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón. De manual. El chat no discute, basura.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Tienes más ángulos muertos que un parking en U, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], la cámara frontal de tu móvil merece una medalla al valor. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de las que el maquillaje es daño colateral, [nombre]. Ridículo. Con base. Sin anestesia, mierda.',
      '[nombre], no hay \\\'te ves mejor en persona\\\': hay decepción escalonada. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Tu cara es un argumento contra la natalidad irresponsable, [nombre]. Mierda. Heredada. Menudo numerito, cabrón.',
      '[nombre], el high de fea te queda de casa y de apodo. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón. Del ranking. El chat no discute, patético.',
      '[nombre], si te describen es por contraste con lo normal. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea de las que el retrato robado se borra por piedad, [nombre]. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano. Se te ve a la legua, joder.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón. Documentado. El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Tienes una presencia que baja el promedio del group photo, [nombre]. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], si el atractivo fuera propina, te dejarían monedas de cinco. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de las que el flash avisa antes de disparar, [nombre]. Ridículo preventivo. Sin anestesia, basura.',
      '[nombre], el techo de tu cara es el suelo de casi cualquiera. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda. Rara. Menudo numerito, fracasado.',
      '[nombre], la fealdad te queda tan natural que parece look. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre] El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'El modo retrato te trata como amenaza, [nombre]. Patético. Software. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], si te miran mucho es porque no creen lo que ven. El grupo ya tomó nota, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\' Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el high de fea no es insulto, es inventario. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón. Plano. El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el atractivo te bloqueó en todas las redes. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda. Viral. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón. Firme. El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], tienes cara de final de temporada cancelada. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de las que el group chat prefiere stickers, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda. Legal. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el high te mide y el chat no discute el número. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón. Seco. El chat no discute, patético.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], ni con ring light de influencer te inventas un punto focal. El grupo ya tomó nota, ridículo.',
      'Fea de las que el fotógrafo finge que se le acabó la batería, [nombre]. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], tu cara es un almost eterno que nunca llega a decente. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. Con voz, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], el ranking de fea te tiene de inquilino fijo. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre] El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], tienes más fallos faciales que un examen a última hora. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'El close-up es una denuncia anónima contra tu genética, [nombre]. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], si el atractivo fuera crédito, tu score sería. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre]. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], te ves como un borrador que nadie quiso terminar. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre]. Menudo numerito, fracasado.',
      '[nombre], el high de fea te queda de tatuaje invisible. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre] El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'cabrón,cabrón. Hostia puta, cabrón, joder. Hostia puta. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas. Documentado. El chat no discute, fracasado.',
      '[nombre], tienes una geometría facial que ofende a Euclides. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'El atractivo te dio de baja y no dejó forwarding, [nombre]. Asco. Administrativo. Sin indulto, mierda.',
      '[nombre], si la belleza fuera propina, el camarero te ignoraría. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de las que el selfie se queda en el carrete por vergüenza, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el high no es bullying: es el espejo con números. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], se te nota la falta de suerte genética en cada pixel. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], si te miran de reojo es para no comprometerse. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea de veredicto público y sin narrador emocional, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], tienes más asimetría que un debate en este puto chat. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco. De altura. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], si el atractivo fuera examen, irías a septiembre. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre]. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], tu cara es un almost de humano decente.joder. Hostia puta. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], no hay redención en un ángulo ni en un tutorial. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de manual: el bot firma y el chat archiva, [nombre] El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre]. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], si te hacen un cumplido es por pena o por agenda. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre]. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el sótano visual te queda de residencia fiscal. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas. Del ranking. El chat no discute, mierda.',
      '[nombre], tienes cara de final boss de la mala suerte genética. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre]. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Tu frame es el gag del día. y el grupo no pide replay, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el high te mide con regla y te deja en negativo. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea sin consuelo de \\\'personalidad\\\': el comando no mide eso, [nombre] El chat no discute, fracasado.',
      '[nombre], tienes más problemas de proporciones que un plano de arquitecto borracho. Hostia puta, joder.',
      'La luz del flash te trata como evidencia del crimen, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de las que el selfie stick se acorta solo, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el material de base no admite segunda oportunidad. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Tu cara es un informe sin anexos de caridad, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], se te ve el sótano desde la notificación.asco. Hostia puta. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de veredicto que el chat confirma en silencio, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], si el atractivo fuera crédito, estarías en mora. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], no hay ángulo: hay rendición documentada.coño. Hostia puta. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Tu simetría perdió el norte y el sur, [nombre].cabrón. Hostia puta. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el high de fea te queda de apodo no oficial. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea sin plot twist de redención en tres mensajes, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], tienes cara de borrador olvidado en la papelera. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], si te miran fijo es porque no procesan el input. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea de las que el group chat prefiere audio a foto, [nombre]. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], el bot te midió dos veces y las dos dio sótano. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], el atractivo te dio de baja sin carta de despido. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas. Del comando. El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre]. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2 El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre]. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], te ves como un almost que se quedó en almost, puta. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El close-up es una denuncia con firma digital, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], se te ve el techo y está por los suelos.joder. Hostia puta. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de tramo que no admite narrador emocional, [nombre] El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco. Firmado. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], si te hacen un retrato es por relleno de álbum. El grupo ya tomó nota, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Tu cara es el gag visual y nadie pide bis, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el high te deja en el sótano sin ascensor. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre] El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], tienes una geometría que ofende al compás. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el atractivo te vio y cambió de acera digital. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], no hay segundo chance: el primero ya fue bastante. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], tienes el glow up invertido certificado por el ranking. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'La luz natural te delata igual que un interrogatorio, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], si te describen en una palabra, esa palabra insulta. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el high de fea no es opinión: es el puto número. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre] Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
  ...
  gay: {
    ...
    goodIsHigh: false,
    high: [
      'Maricón de historial público: no hace falta escarbar, está en la superficie, [nombre] Hostia puta, coño.',
      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre]. Sin indulto, cabrón.',
      'Maricón de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre]. El grupo ya tomó nota, gilipollas.',
      'Maricón sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre]. Sin anestesia, patético.',
      'Maricón convertido en wallpaper del fail colectivo.asco. Hostia puta. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre]. Menudo numerito, basura.',
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre]. Pura vergüenza, ridículo.',
      'Maricón de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] El chat no discute, fracasado.',
      'Maricón con el mismo gag de siempre y cero variación. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Maricón de las que confunden natural con abandono total del estándar, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'Maricón de superficie suficiente: no hace falta abrir el cubo, huele, [nombre]. El grupo ya tomó nota, coño.',
      'Maricón de estribillo que empeora con cada bis del mismo número cutre, [nombre]. Sin anestesia, cabrón.',
      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre]. Se te ve a la legua, gilipollas.',
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre]. Menudo numerito, patético.',
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre] El chat no discute, basura.',
      'Maricón de puta madre: el high no suaviza el teatro ni el personajito del ranking, [nombre]. Patético.',
      'Maricón cutre de manual: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Sin indulto, fracasado.',
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. El grupo ya tomó nota, joder.',
      'Maricón de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre]. Sin anestesia, mierda.',
      'Maricón de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre]. Se te ve a la legua, coño.',
      'El asco No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre]. Menudo numerito, cabrón.',
      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre]. Pura vergüenza, gilipollas.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] El chat no discute, patético.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre] Hostia puta, asco.',
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre]. Sin indulto, basura.',
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre]. El grupo ya tomó nota, ridículo.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre]. Se te ve a la legua, joder.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre]. Menudo numerito, mierda.',
      'Maricón constante: la única racha que mantienes es la del mismo número, [nombre]. Pura vergüenza, coño.',
      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre] El chat no discute, cabrón.',
      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre] Hostia puta, gilipollas.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre]. Sin indulto, patético.',
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre]. El grupo ya tomó nota, asco.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de pose, [nombre]. Sin anestesia, basura.',
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre]. Se te ve a la legua, ridículo.',
      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre]. Menudo numerito, fracasado.',
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre] El chat no discute, mierda.',
      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'Has convertido el personajito en identidad. y no hay detergente narrativo, [nombre]. Sin indulto, cabrón.',
      'Has firmado el personajito con grasa en cada mensaje como única firma, [nombre]. El grupo ya tomó nota, gilipollas.',
      'No hay eco de estilo: hay eco de pose. Y el chat lo amplifica de más, [nombre]. Sin anestesia, patético.',
      'Maricón visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Se te ve a la legua, asco.',
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. Menudo numerito, basura.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre]. Pura vergüenza, ridículo.',
      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre] El chat no discute, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Tienes más episodios de pose que de algo que. El chat respete de verdad, [nombre]. Sin indulto, mierda.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. El grupo ya tomó nota, coño.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Sin anestesia, cabrón.',
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre]. Se te ve a la legua, gilipollas.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre]. Menudo numerito, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Tu mensaje es un aviso de lo que no hay que tomar en serio en el grupo, [nombre] El chat no discute, basura.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre] Hostia puta, ridículo.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. Sin indulto, fracasado.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre]. El grupo ya tomó nota, joder.',
      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. Y el chat lo tiene claro, asco.',
      'Maricón sin capa de carisma que disimule el agujero.coño. Hostia puta. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Menudo numerito, cabrón.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre]. Pura vergüenza, gilipollas.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre] El chat no discute, patético.',
      'Maricón de ranking: bajas la media del nivel con constancia molesta, [nombre] Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. El grupo ya tomó nota, ridículo.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]. Sin anestesia, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre]. Se te ve a la legua, joder.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. Menudo numerito, mierda.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre] El chat no discute, cabrón.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre] Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre]. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre]. El grupo ya tomó nota, asco.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre]. Sin anestesia, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. Se te ve a la legua, ridículo.',
      'Has hecho del bajo listón tu residencia. y no hay mudanza a la vista, [nombre]. Menudo numerito, fracasado.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Y el chat lo tiene claro, joder.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre] El chat no discute, mierda.',
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. Y el chat lo tiene claro, coño.',
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre]. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Maricón de los que el high del ranking no perdona ni un frame, [nombre]. El grupo ya tomó nota, gilipollas.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      'No hay barniz que salve: hay pose pura y no se vende como carisma, [nombre]. Y el chat lo tiene claro, asco.',
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'El high no es un mal día de pose: es.ridículo. Hostia puta. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      ...
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre] El chat no discute, basura.',
      ...
      'Se te nota que ensuciaste el hilo de pose hace tiempo y perdiste el bayeta, [nombre]. Sin indulto, fracasado.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre]. Menudo numerito, cabrón.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga sola, [nombre]. Menudo numerito, fracasado.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre]. Pura vergüenza, gilipollas.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo, joder. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Has convertido la sumisión en identidad. y no hay detergente que la limpie, [nombre]. Menudo numerito, basura.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Has hecho del bajo listón tu residencia. y no hay mudanza a la vista, [nombre]. Menudo numerito, patético.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre]. Pura vergüenza, asco.',
      ...
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre]. Se te ve a la legua, coño.',
      'Simp de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Menudo numerito, cabrón.',
      'El recato de dignidad te queda lejos y la distancia es rechazo, no mística, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Simp de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Se te ve a la legua, joder.',
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Tienes más grasa de validación ajena que un foro de fans sin moderación, [nombre]. Pura vergüenza, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de síes ajenos, [nombre]. Se te ve a la legua, ridículo.',
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre]. Menudo numerito, fracasado.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre]. Pura vergüenza, joder.',
      ...
      'Se te nota el peso de arrastrar el mismo pedestal por cada conversación, [nombre]. Se te ve a la legua, asco.',
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Simp de feria de validación: ruido interno, cero ganas de volver del resto, [nombre]. Pura vergüenza, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre]. Menudo numerito, patético.',
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre]. Se te ve a la legua, coño.',
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre]. Menudo numerito, cabrón.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre]. Menudo numerito, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'No es estilo: es simp previsible y el high te lo nombra entero, [nombre]. Menudo numerito, fracasado.',
      'Tienes más episodios de pedestal que intentos de subir el listón propio, [nombre]. Pura vergüenza, joder.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. Se te ve a la legua, asco.',
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre]. Pura vergüenza, ridículo.',
      ...
      'El high no es un mal día de carácter: es.mierda. Hostia puta. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Simp sin complejo útil: el complejo al menos indicaría que viste el pedestal, [nombre]. Menudo numerito, patético.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
  ...
  rata: {
    ...
    high: [
      ...
      'El listón de la dignidad lo usas de rampa para trepar sobre otros en el chat, [nombre] Hostia puta, asco.',
      ...
      'El recato te queda a años luz y la distancia es rechazo, no mística de rata, [nombre]. El grupo ya tomó nota, ridículo.',
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre]. Sin anestesia, fracasado.',
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado en el ranking, [nombre]. Se te ve a la legua, joder.',
      'Rata de inercia: el grupo te soporta por costumbre, no por interés real, [nombre]. Menudo numerito, mierda.',
      'Tienes el tono de quien acumula restos ajenos y nunca pasa el estropajo, [nombre]. Pura vergüenza, coño.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] Hostia puta, gilipollas.',
      ...
      'Rata de feria: grasa, ruido, suelo peor y cero ganas de volver a la atracción, [nombre]. Sin indulto, cabrón.',
      ...
      'Rata de las que. El ranking de aporte deja en el sótano con razón documentada, [nombre]. Se te ve a la legua, asco.',
      'No es gracia sucia: es ratez sin gracia, la versión que no entretiene a nadie, [nombre]. Menudo numerito, basura.',
      'Rata de fondo: bajas la media con la constancia de quien no se cansa de sacar, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Se te oye el masticar del bajo listón hasta en los mensajes serios del chat, [nombre]. Sin indulto, mierda.',
      ...
      'El recato te saluda desde la orilla limpia y tú no sales del barro del chat, [nombre]. Menudo numerito, patético.',
      'No es estilo: es ratez previsible y el high te la cobra entera en el nivel, [nombre]. Pura vergüenza, asco.',
      ...
      'Rata sin redención estética: solo hambre de lo ajeno y cero de producción, [nombre] Hostia puta, ridículo.',
      'No hay misterio interesante: hay previsible y rata, el combo flojo del high, [nombre]. Sin indulto, fracasado.',
      'Rata de las que el mute ajeno lee como invitación y se equivoca de libro, [nombre]. El grupo ya tomó nota, joder.',
      'Se te nota el peso de arrastrar el interés propio por cada hilo del grupo, [nombre]. Sin anestesia, mierda.',
      'Rata de las que roban el oxígeno del hilo y no devuelven ni un mensaje útil, [nombre]. Se te ve a la legua, coño.',
      'Rata de manual: te aprovechas del grupo y encima miras con cara de víctima, [nombre]. Menudo numerito, cabrón.',
      'Se te nota el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      ...
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre]. Se te ve a la legua, joder.',
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre]. Menudo numerito, mierda.',
      'Has convertido. El chat en tu despensa y al resto en inventario de provecho, [nombre]. Pura vergüenza, coño.',
      ...
      'Has convertido lo rata en marca personal y la marca se pega en los dedos, [nombre]. Se te ve a la legua, ridículo.',
      'Rata de estribillo que mancha más con cada repetición del mismo plato, [nombre]. Menudo numerito, fracasado.',
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Has convertido la rata en identidad. y no hay detergente narrativo, [nombre]. Se te ve a la legua, asco.',
      'Rata cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. Menudo numerito, basura.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Rata de estribillo sin punto final limpio ni redención posible, [nombre]. Se te ve a la legua, gilipollas.',
      'La compostura cruza de acera cuando te ve en el ranking del high, [nombre]. Menudo numerito, patético.',
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'La clase te suena a ataque y respondes dejando más migas de interés ajeno, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre]. Menudo numerito, mierda.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre]. Se te ve a la legua, ridículo.',
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Has convertido la rata en carnet. y no hay renovación limpia, [nombre]. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Rata de puta madre en el sentido literal: el high no suaviza el hocico, [nombre]. Menudo numerito, basura.',
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Rata con la disciplina de quien nunca ha devuelto una puta favor, [nombre]. Se te ve a la legua, gilipollas.',
      'El high no es un mal día de ética: es.patético. Hostia puta. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Tienes una presencia que ensucia el hilo en un solo movimiento de rata, [nombre]. Pura vergüenza, asco.',
      ...
      'Rata de las que confunden astucia con no tener vergüenza en el ranking, [nombre]. Se te ve a la legua, coño.',
      'No es viveza con gracia: eres rata y el high no discute la evidencia, [nombre]. Menudo numerito, cabrón.',
      ...
      'Se te ve el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre] El chat no discute, patético.',
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de las ratas, [nombre] Hostia puta, asco.',
      'Tienes más episodios de rata documentados que intentos de subir el nivel, [nombre]. Sin indulto, basura.',
      ...
      'Has hecho de lo rata una marca personal y la marca se pega en los dedos, [nombre]. Se te ve a la legua, joder.',
      'Has convertido el bajo listón en residencia fija sin mudanza a la vista, [nombre]. Menudo numerito, mierda.',
      'No es atrevimiento: es suciedad de interés y el high te la cobra entera, [nombre]. Pura vergüenza, coño.',
      'Tienes más grasa de rata en el discurso que un freidor de feria al cierre, [nombre] El chat no discute, cabrón.',
      ...
      'El olor a rata se te nota en cada mensaje que pide sin dar nada a cambio, [nombre]. El grupo ya tomó nota, asco.',
      'Se te oye el arrastre de la rata hasta en los mensajes cortos del hilo, [nombre]. Sin anestesia, basura.',
      'Rata sin punto final limpio: el estribillo se repite y mancha más cada vez, [nombre]. Se te ve a la legua, ridículo.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro, [nombre]. Menudo numerito, fracasado.',
      'Tienes el aura de quien pide prestado y nunca devuelve ni las gracias, [nombre]. Pura vergüenza, joder.',
      'Rata de las que el grupo aguanta por inercia y no por respeto de verdad, [nombre] El chat no discute, mierda.',
      'Rata de repertorio gastado: las mismas manchas, el mismo plato de siempre, [nombre] Hostia puta, coño.',
      'El promedio de ratez es este: el nivel no es un mal día, es el nivel, [nombre]. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Has convertido. El chat en tu zona de obras grasientas sin fecha de fin, [nombre]. El grupo ya tomó nota, gilipollas.',
      ...
      'Has hecho de lo rata tu plato favorito y lo sirves en todas las mesas, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
  ...
  friki: {
    ...
    high: [
      ...
      'La dignidad del nivel no para: tú eres el tráfico del arcén social, [nombre]. Se te ve a la legua, ridículo.',
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      ...
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre]. Pura vergüenza, asco.',
      ...
      'Friki de manual cutre: el estereotipo sin el carisma que a veces salva al raro, [nombre]. Se te ve a la legua, coño.',
      'La compostura social no te reconoce y tú no has buscado el espejo del chat, [nombre]. Menudo numerito, cabrón.',
      ...
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre]. Se te ve a la legua, joder.',
      'Friki que se enfada porque no valoran su afición. Nadie está obligado, gilipollas. Y exigir valoración ya es haber perdido.',
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre]. Pura vergüenza, coño.',
      ...
      'Friki con el bucle eterno del mismo error en bucle, joder. Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Se te ve a la legua, ridículo.',
      'No es profundidad: es aislamiento con teclado y el nivel te lo cobra, [nombre]. Menudo numerito, fracasado.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Friki de malinterpretar el silencio ajeno como interés por el lore, [nombre]. Se te ve a la legua, asco.',
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Has convertido el nicho en identidad. y no hay detergente de salida, [nombre]. Pura vergüenza, ridículo.',
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] El ranking firma y listo, gilipollas.',
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre]. Pura vergüenza, asco.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre]. Pura vergüenza, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo sin estilo: el desastre sin estética es solo un problema de higiene del hilo. Hostia puta, ridículo.',
      'Tienes más episodios de cerdez documentada que intentos de subir el nivel un punto. Sin indulto, fracasado.',
      'El promedio de cerdez es el nivel: no un pico, el suelo del nivel, [nombre]. El grupo ya tomó nota, joder.',
      'El asco Colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre]. Sin anestesia, mierda.',
      'Cerdo de las que alardean de la grasa porque callar las dejaría sin personaje. Se te ve a la legua, coño.',
      'Das asco. De entrada y el resto del mensaje solo confirma el desastre, [nombre]. Menudo numerito, cabrón.',
      '[nombre], tu manera de fregar el suelo es esperar a que se seque solo. Cada mancha se queda a vivir. Puta casa de mierda.',
      'Se te nota la prisa por embadurnar el chat y cero ganas de limpiar después. El chat no discute, patético.',
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'El asco No es moralina: es el termómetro y te marca cerdez crónica, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'Tienes más restos en el relato que un cubo de basura. El día de recogida. El grupo ya tomó nota, ridículo.',
      ...
      'No es atrevimiento: es suciedad previsible y el high te la cobra sin descuento, [nombre] El chat no discute, basura.',
      'Se te oye el masticar de la cerdez hasta en los mensajes que quieren parecer neutros. Hostia puta, ridículo.',
      ...
      'Has convertido el grupo en tu comedero y los demás en testigos del banquete, [nombre]. El grupo ya tomó nota, joder.',
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre]. Sin anestesia, mierda.',
      'Cerdo sin capa de carisma que disimule el agujero. Fracasado. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'El listón de lo decente lo usas de servilleta y lo tiras al suelo del chat, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'La palabra compostura te suena a idioma de otro planeta y no has abierto el diccionario. El grupo ya tomó nota, ridículo.',
      ...
      'Cerdo de historial público: la grasa está en la superficie, no hace falta escarbar. Menudo numerito, mierda.',
      'Se te ve la prisa por embadurnar y la ausencia total de plan de limpieza, [nombre]. Pura vergüenza, coño.',
      'Cerdo de fondo permanente: baja la media del grupo con constancia de metrónomo, [nombre] El chat no discute, cabrón.',
      'Tu escritorio tiene manchas superpuestas que ya forman un patrón geológico, cerdo. Cada capa es un mes de mierda. Acumulada.',
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre]. Sin indulto, patético.',
      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre]. El grupo ya tomó nota, asco.',
      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre]. Sin anestesia, basura.',
      'Tienes más grasa en el discurso que un freidora de feria al cierre de la noche. Se te ve a la legua, ridículo.',
      'El promedio de cerdez es este: el nivel no es un mal día, es el nivel, [nombre]. Menudo numerito, fracasado.',
      'Cerdo de error de lectura: confundes límites con permiso para seguir manchando. Pura vergüenza, joder.',
      'Tienes cepillos de dientes viejos criando ahí al lado del que usas, [nombre]. Un puto museo de bacterias con vaso propio.',
      'Cerdo sin redención estética: solo grasa, sin capa de carisma que disimule el agujero. Hostia puta, coño.',
      ...
      'Tienes más migas en el historial que un mantel de bar después del desayuno eterno. Se te ve a la legua, asco.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos de limpieza. Menudo numerito, basura.',
      'No es estilo atrevido: es grasa previsible y el high te la cobra entera, [nombre]. Pura vergüenza, ridículo.',
      ...
      'No es libertad: es falta de criterio con migas y el resultado se huele, [nombre]. Sin indulto, mierda.',
      'Se te nota el hábito de empujar cada tema hacia el mismo plato sin fregar, [nombre]. El grupo ya tomó nota, coño.',
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar. Se te ve a la legua, gilipollas.',
      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre]. Menudo numerito, patético.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, joder, con el grupo de testigo. Sin indulto, fracasado.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'El listón de lo presentable lo usas de tobogán hacia abajo, joder, [nombre]. Se te ve a la legua, coño.',
      'Cerdo sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. Menudo numerito, cabrón.',
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre]. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      ...
      'El asco No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre]. Se te ve a la legua, joder.',
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre]. Menudo numerito, mierda.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'Cerdo de ranking: bajas la media del nivel con constancia de mancha, [nombre]. Se te ve a la legua, ridículo.',
      'Has convertido el bajo listón en casa fija sin fecha de mudanza, [nombre]. Menudo numerito, fracasado.',
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Se te ve a la legua, asco.',
      'Has convertido la porquería en carnet. y no hay renovación limpia, [nombre]. Menudo numerito, basura.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. Pura vergüenza, ridículo.',
      ...
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado, [nombre]. Se te ve a la legua, gilipollas.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Cerdo de superficie: no hace falta abrir el cubo, huele de lejos, [nombre]. Se te ve a la legua, coño.',
      'No hay barniz que salve: hay cerdo puro y no se vende como carisma, [nombre]. Menudo numerito, cabrón.',
      'Tienes el tono de quien acumula restos y nunca pasa el estropajo, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'La clase te suena a ataque y respondes con más migas de suciedad, [nombre]. Se te ve a la legua, joder.',
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre]. Menudo numerito, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'La compostura del nivel no te reconoce en el elenco, [nombre]. Y el chat lo tiene claro. Se te ve a la legua, asco.',
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre]. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre]. Se te ve a la legua, gilipollas.',
      'Cerdo hasta para el modo oscuro: ni la sombra tapa lo que dejas, [nombre]. Menudo numerito, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'El high no es un mal día de orden: es.mierda. Hostia puta. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      ...
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo. Menudo numerito, mierda.',
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Has hecho de lo indecente tu plato favorito y lo sirves en todas las mesas. El chat no discute, cabrón.',
      'No es gracia sucia: es suciedad sin gracia, la versión que no entretiene, [nombre] Hostia puta, gilipollas.',
      'El listón está en el suelo y tú lo usas de pan para mojar sin vergüenza, [nombre]. Sin indulto, patético.',
      'Cerdo de oficio: el rastro de grasa es tu firma y aparece en cada párrafo. El grupo ya tomó nota, asco.',
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Dejas el baño de tal manera que hay que limpiarlo antes de poder usarlo. Puta escena del crimen con toalla húmeda.',
      'Tienes el tono de quien come con la boca abierta en un restaurante en silencio. Menudo numerito, fracasado.',
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Tienes una manta que huele desde hace meses y duermes con ella cada noche. Ni un animal aguanta eso, puto guarro.',
      'Has hecho de lo cutre una marca y la marca se pega en los dedos del que lee. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'La palabra clase te suena a reproche y respondes ensuciando un poco más. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Se te oye el arrastre de la grasa hasta en los mensajes cortos del chat. El grupo ya tomó nota, gilipollas.',
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio. Sin anestesia, patético.',
      'Tienes más manchas documentadas que intentos serios de pasar un trapo al relato. Se te ve a la legua, asco.',
      'Has convertido la grasa en carnet. y no hay renovación limpia a la vista. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla. Pura vergüenza, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Has convertido la mancha en identidad. y no hay detergente narrativo a la vista. Hostia puta, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre]. El grupo ya tomó nota, coño.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Cerdo sin higiene narrativa: ensucias el hilo y no recoges nunca el escombro. Se te ve a la legua, gilipollas.',
    ],
    mid: [
  ...
  femboy: {
    ...
    high: [
      ...
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. Se te ve a la legua, ridículo.',
      'Femboy como un anuncio repetido que nadie pidió, joder, con el grupo de testigo. Menudo numerito, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre]. Pura vergüenza, joder.',
      'Femboy en crudo: ni el maquillaje del ranking te cubre. El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      ...
      'Femboy sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. Sin indulto, cabrón.',
      ...
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre]. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. Pura vergüenza, ridículo.',
      ...
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre]. Se te ve a la legua, gilipollas.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      'Femboy de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Pura vergüenza, asco.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Se te ve a la legua, coño.',
      'Femboy de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Menudo numerito, cabrón.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Se te ve a la legua, joder.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Menudo numerito, mierda.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre]. Se te ve a la legua, ridículo.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]. Menudo numerito, fracasado.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Femboy de puta madre: el high no suaviza el teatro ni el personajito, [nombre]. Se te ve a la legua, asco.',
      ...
      'Tu historial de búsquedas, tus compras y tu forma de sentarte ya formaron un tribunal. Hostia puta, gilipollas.',
    ],
    mid: [
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el nivel, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'La clase de aportar te suena a reproche, [nombre], coño. Y el chat lo tiene claro. Menudo numerito, fracasado.',
      'El asco Del nivel es este: presencia sin función, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Se te ve venir el vacío en la primera palabra del mensaje del hilo, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'Se te oye el eco del vacío cada vez que intentas llenar un silencio del hilo, [nombre]. Sin indulto, cabrón.',
      ...
      'Has firmado lo inútil en cada mensaje largo que no sostiene nada del hilo, [nombre]. Se te ve a la legua, asco.',
      'No hay misterio útil: hay previsible vacío en el nivel del comando, [nombre]. Menudo numerito, basura.',
      'El promedio de inutilidad es el nivel: no un mal día, el suelo del high, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Inútil de superficie suficiente: no hace falta el sótano del historial, [nombre] Hostia puta, joder.',
      'La vergüenza ajena te sigue cuando pretendes ser necesarios en el chat, [nombre]. Sin indulto, mierda.',
      ...
      'Inútil de error crónico: confundes mute con misterio en el ranking, [nombre]. Se te ve a la legua, gilipollas.',
      'Tu forma de contribuir es asentir a lo que decidan otros. Eso no es contribuir, gilipollas. Eso es hacer bulto con opinión.',
      'Inútil documentado: el ranking de aporte te deja donde mereces sin debate, [nombre]. Pura vergüenza, asco.',
      ...
      'Inútil con las mismas cartas manchadas de siempre y sin plan B, joder, diagnóstico cerrado. Menudo numerito, cabrón.',
      'Inútil de cartel vacío: se ve el marco. y no hay obra detrás del nick, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre]. Se te ve a la legua, joder.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre]. Menudo numerito, mierda.',
      'Inútil sin capa de carisma que disimule el agujero. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre]. Y el chat lo tiene claro. Pura vergüenza, coño.',
      ...
      'El precio de tu repertorio vacío lo paga el hilo en tiempo perdido del chat, [nombre]. Se te ve a la legua, asco.',
      ...
      'Tienes la utilidad de un mando sin pilas: se ve, no sirve, estorba en el ranking, [nombre]. Sin indulto, mierda.',
      'Inútil de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. El grupo ya tomó nota, coño.',
      ...
      'Inútil de error de lectura: confundes estar con importar en el chat del grupo, [nombre]. Pura vergüenza, asco.',
      ...
      'Inútil sin redención: el hueco que dejas cuando te vas es un alivio medible, [nombre] El chat no discute, patético.',
      'Has convertido el no aportar en un hábito y el hábito en identidad del ranking, [nombre] Hostia puta, asco.',
      'No es discreción: es falta de material útil con nick incluido en el ranking, [nombre]. Sin indulto, basura.',
      'Inútil de estribillo que empeora con cada repetición del mismo vacío, [nombre]. El grupo ya tomó nota, ridículo.',
      ...
      'Inútil constante: la única racha que mantienes es la de no servir en el chat, [nombre]. Menudo numerito, mierda.',
      'Inútil de feria ambulante: ruido sin recuerdo bueno en el historial del chat, [nombre]. Pura vergüenza, coño.',
      'Has firmado lo inútil como quien no sabe firmar otra cosa en el ranking, [nombre] El chat no discute, cabrón.',
      'No hay misterio de inutilidad interesante: hay lo previsible del high, [nombre] Hostia puta, gilipollas.',
      ...
      'Inútil de feria: ruido, cero sustancia, el suelo igual de sucio del ranking, [nombre]. El grupo ya tomó nota, asco.',
      'Inútil de inercia: el grupo te soporta por costumbre, no por interés real, [nombre]. Sin anestesia, basura.',
      'La vergüenza ajena te sigue cuando intentas parecer necesarios en el hilo, [nombre]. Se te ve a la legua, ridículo.',
      ...
      'El recato de no hablar no te salva: cuando hablas se confirma el diagnóstico, [nombre] El chat no discute, mierda.',
      'Se te nota la prisa por ocupar sitio y cero plan de justificarlo en el chat, [nombre] Hostia puta, coño.',
      'Tienes el tono de quien acumula mensajes sin acumular peso en el ranking, [nombre]. Sin indulto, cabrón.',
      'Has convertido el no servir en carnet de identidad del ranking del grupo, [nombre]. El grupo ya tomó nota, gilipollas.',
      ...
      'Tienes más ausencias de criterio que mensajes con sustancia en el chat, [nombre]. Menudo numerito, basura.',
      'La dignidad del aporte no para: tú eres el tráfico del arcén del ranking, [nombre]. Pura vergüenza, ridículo.',
      'Inútil de inercia: el grupo te lee por costumbre, no por interés real, [nombre] El chat no discute, fracasado.',
      'Tienes el tono de noches de chat sin una frase que pese en el ranking, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Inútil visible desde lejos: el letrero no compensa la parada del chat, [nombre]. Se te ve a la legua, gilipollas.',
      'Se te nota que perdiste el mapa del aporte hace tiempo en el ranking, [nombre]. Menudo numerito, patético.',
      ...
      'Has dejado. El chat como obra sin plano: escombro de mensajes sin función, [nombre] Hostia puta, ridículo.',
      'Tienes más episodios de no aportar que de intentarlo en serio en el chat, [nombre]. Sin indulto, fracasado.',
      ...
      'No es gracia seca: es vacío sin gracia en el nivel del comando, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'La dignidad del aporte hace autostop y el tráfico eres tú en el ranking, [nombre]. Menudo numerito, cabrón.',
      '[nombre], inútil de mierda: no sabes hacer, no sabes pedir ayuda y no sabes apartarte. El pack completo del estorbo con patas.',
      'Inútil de malinterpretar el silencio ajeno como interés por el vacío, [nombre] El chat no discute, patético.',
      'Se te nota el hábito de empujar cada hilo hacia ninguna parte útil, [nombre] Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Se te nota el arrastre de no empujar nunca hacia arriba del ranking, [nombre]. Menudo numerito, mierda.',
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      'Inútil de malinterpretar el silencio como invitación a seguir vacíos, [nombre] El chat no discute, cabrón.',
      ...
      'La compostura del aporte no te reconoce en el ranking del grupo, [nombre]. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'No hay barniz de personaje: hay inutilidad pura en el nivel, [nombre]. Se te ve a la legua, ridículo.',
      'No hay barniz: hay inutilidad pura en el nivel del comando, [nombre]. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'El asco resume el nivel: presencia sin función en el chat del grupo, [nombre] El chat no discute, mierda.',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre]. Pura vergüenza, ridículo.',
      'La clase de aportar te suena a reproche en el ranking del grupo, [nombre] El chat no discute, fracasado.',
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre]. El grupo ya tomó nota, coño.',
      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Inútil de racha: lo único constante es no servir en el ranking, [nombre]. Se te ve a la legua, gilipollas.',
      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del nivel, [nombre] Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre]. El grupo ya tomó nota, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre] Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'No hay eco de sustancia: hay eco de hueco en el nivel, [nombre]. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Menudo numerito, patético.',
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre]. Pura vergüenza, asco.',
      ...
      'Se te oye el eco del fail hasta en los mensajes que pretenden sonar a plan B, [nombre]. Pura vergüenza, joder.',
      ...
      'Perdedor de los que el high del ranking no perdona ni un frame del historial, [nombre]. Se te ve a la legua, asco.',
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del nivel, [nombre]. Menudo numerito, basura.',
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Perdedor sin el barniz: solo el material flojo a la vista. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre]. Menudo numerito, patético.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre]. Pura vergüenza, asco.',
      ...
      'No hay barniz que salve: hay derrota pura y no se vende como carisma, [nombre]. Se te ve a la legua, coño.',
      '[nombre], perdedor de mierda: esperas a ver qué pasa y nunca pasa nada bueno. Y encima te sorprende, cada puta vez.',
      'Se te oye el masticar del listón bajo hasta en los neutros del hilo, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre]. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Has hecho del bajo listón tu casa. y no hay mudanza a la vista, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre] El chat no discute, mierda.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. Pura vergüenza, coño.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Se te ve a la legua, asco.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Menudo numerito, basura.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Pura vergüenza, ridículo.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Se te ve a la legua, gilipollas.',
    ],
    mid: [
  ...
  puta: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], te repartes tan barato que hasta el puticlub te pediría referencia negativa. Sin indulto, basura.',
      ...
      'Has convertido el sí fácil en identidad. y el grupo ya no se sorprende, [nombre]. Se te ve a la legua, joder.',
      '[nombre], tienes más kilometraje que un taxi de aeropuerto en temporada alta. Menudo numerito, mierda.',
      'Puta de las que el silencio ajeno lo leen como invitación a más teatro, [nombre]. Pura vergüenza, coño.',
      '[nombre], te abres en canal por atención y luego te ofendes si te tratan como producto. El chat no discute, cabrón.',
      'El listón del respeto lo enterraste tú misma con cada estribillo barato, [nombre] Hostia puta, gilipollas.',
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre]. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Puta de repertorio corto: las mismas cartas de \'mírame\' en cada mano, [nombre]. Se te ve a la legua, ridículo.',
      '[nombre], has hecho del almost de intocable tu marca personal. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], puta de las que el putero profesional pediría descuento por volumen. El chat no discute, mierda.',
      'Te repartes como flyer de discoteca mala: nadie lo pidió y acaba en el suelo, [nombre] Hostia puta, coño.',
      '[nombre], tu sí vale menos que un like anónimo de madrugada. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Puta sin el barniz de \'liberada\': solo hambre de validación barata, [nombre]. El grupo ya tomó nota, gilipollas.',
      '[nombre], has convertido el chat en tu escaparate y el producto está en oferta. Sin anestesia, patético.',
      'Se te oye el estribillo de disponibilidad hasta en los mensajes \'serios\', [nombre]. Se te ve a la legua, asco.',
      '[nombre], puta de manual: el ranking te nombra y tú posas. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Si el puterío fuera currículum, tendrías páginas de relleno y cero logros, [nombre]. Pura vergüenza, ridículo.',
      '[nombre], te abres más fácil que un zip de archivo corrupto. El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Puta de las que confunden atención con respeto y se caen del pedestal, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], el grupo ya no debate: te tiene catalogada y archivada. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'Has hecho del \'cualquier mira vale\' tu política exterior, [nombre]. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], puta de kilometraje alto y mantenimiento cero. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Te vendes en liquidación permanente y aun así no se agota el stock, [nombre]. Se te ve a la legua, gilipollas.',
      '[nombre], el sí fácil te quedó de tatuaje invisible. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Puta de las que el silencio de los demás es el único filtro que te queda, [nombre]. Pura vergüenza, asco.',
      '[nombre], tienes más vueltas que un portero automático de edificio viejo. El chat no discute, basura.',
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre] Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], te repartes con la frialdad de quien ya no espera nada a cambio. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Puta de fondo: el chat te usa de gag y tú sigues el libreto, [nombre]. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'Has convertido cada hilo en casting improvisado, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre]. Pura vergüenza, gilipollas.',
      '[nombre], el ranking de puta te tiene de inquilina fija. El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre] Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre]. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], puta de manual negro: el grupo firma y tú posas. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], has hecho del escaparate tu única personalidad. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Puta de las que confunden circulacion con deseo real, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], te repartes como menú del día: predecible y frío. El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre] Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      '[nombre], puta de kilometraje visible y orgullo de cartón. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre]. El grupo ya tomó nota, asco.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], has convertido el almost de intocable en chiste interno. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada. El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco. Documentado. El grupo ya tomó nota, gilipollas.',
      '[nombre], te repartes con la elegancia de un anuncio popup. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre]. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], puta de las que el sí vale menos que un sticker. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Has hecho del chat tu puticlub sin cover, [nombre]. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], el ranking te nombra y el resto asiente sin debate. El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre] Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], te abres en canal por atención de segunda. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre]. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], tienes más vueltas que el rumor del grupo. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre]. Se te ve a la legua, gilipollas.',
      '[nombre], te vendes en liquidación y el stock no baja. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre]. Pura vergüenza, asco.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso. El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre] Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], has convertido cada mirada en ticket de entrada. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre]. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], el sí fácil te delata más que un historial público. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre]. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], puta de kilometraje alto y narrativa baja. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre]. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      '[nombre], has hecho del escaparate tu único argumento. El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      'Puta de las que confunden ruido con valor, [nombre].asco. Hostia puta. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre]. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], puta de manual negro delante del puto chat. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\' Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Puta de fondo de ranking: inquilina fija del nivel, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], has convertido el almost de misterio en chiste gastado. El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre] Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      '[nombre], puta de las que el chat archiva sin pedir bis. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre]. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Puta sin plot twist: solo el mismo libreto, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], te abres en canal por migajas de atención. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El puterío te queda de uniforme de diario, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], has hecho del sí tu única estrategia social. El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], te vendes en oferta y el precio sigue cayendo. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Se te nota el hambre de validación a la legua, [nombre]. El grupo ya tomó nota, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros. Se te ve a la legua, asco.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], te repartes como anuncio que nadie puede cerrar. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El sí fácil te quedó de cicatriz pública, [nombre] El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Puta de las que confunden circulación con deseo, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'El listón del respeto está en el sótano con tu nombre, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], puta de fondo: siempre el mismo gag. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Te vendes barato y el stock no se agota nunca, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Has hecho del almost de intocable tu mayor fail, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], puta de las que el putero amateur pediría recibo. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Te repartes con la elegancia de un popup de virus, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti. Se te ve a la legua, coño.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], el grupo ya no se sorprende: solo documenta. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Te abres en canal por ruido de segunda división, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'El sí fácil te delata más que cualquier captura, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre]. El grupo ya tomó nota, ridículo.',
      '[nombre], te vendes en liquidación permanente. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], puta de fondo de hilo y de ranking.mierda. Hostia puta. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí. El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre] Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      '[nombre], te repartes como menú del día en bar de carretera. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre]. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre]. Se te ve a la legua, ridículo, y el grupo lo tiene más que claro, ridículo.',
      '[nombre], te abres más fácil que la privacidad en cero. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El puterío te quedó de marca y no de accidente, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], puta de kilometraje que ya no admite garantía. El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      'Te vendes barato y luego quieres trato de boutique, [nombre] Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Puta de manual: el bot confirma lo que el grupo ya sabía, [nombre]. El grupo ya tomó nota, gilipollas.',
      'Si la dignidad tuviera alarma, sonaría cada vez que escribes, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], puta de fondo: el eco te devuelve el mismo asco. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], el almost de misterio se te escapó en el primer sí. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Puta de las que confunden atención con respeto y caen, [nombre] El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], te abres en canal por migajas y aún así das las gracias. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], puta de ranking fijo en el sótano del respeto. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Te vendes en oferta y el precio solo baja, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], se te nota el hambre de validación en cada puto sticker. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Puta sin plot de redención en tres actos, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], has hecho del escaparate tu personalidad completa. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], puta de las que el silencio es el único que te pone límite. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Te repartes como flyer de after de mala muerte, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión. El grupo ya tomó nota, joder, y el grupo lo tiene más que claro, joder.',
      'Puta de manual negro delante de todo el grupo, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], te abres más que un debate vacío y con menos contenido. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre] El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], te vendes barato y el stock parece infinito. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre]. Sin indulto, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], puta de fondo de chat: el gag eres tú. El grupo ya tomó nota, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El listón del respeto está enterrado con tu historial, [nombre]. Sin anestesia, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre]. Se te ve a la legua, joder, y el grupo lo tiene más que claro, joder.',
      '[nombre], has hecho del sí tu política exterior completa. Menudo numerito, mierda, y el grupo lo tiene más que claro, mierda.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0 El chat no discute, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre] Hostia puta, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo. Sin indulto, patético, y el grupo lo tiene más que claro, patético.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre]. El grupo ya tomó nota, asco, y el grupo lo tiene más que claro, asco.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía. Sin anestesia, basura, y el grupo lo tiene más que claro, basura.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre]. Se te ve a la legua, ridículo.',
      '[nombre], puta de las que el almost de intocable es el gag del año. Menudo numerito, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre] El chat no discute, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m. Hostia puta, coño, y el grupo lo tiene más que claro, coño.',
      'El sí fácil te quedó de firma digital en el chat, [nombre]. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones. El grupo ya tomó nota, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Te abres más fácil que la configuración por defecto, [nombre]. Sin anestesia, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Puta de fondo: siempre el mismo libreto, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre] El chat no discute, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], has hecho del escaparate tu único talento documentado. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], si el puterío cotizara, serías warning del bróker. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre]. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], puta de manual negro: el grupo firma, tú posas. Se te ve a la legua, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre]. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre] El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      '[nombre], te abres en canal por migajas y aún pides propina. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'El puterío te quedó de uniforme de diario del chat, [nombre]. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo. El grupo ya tomó nota, joder.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre]. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre]. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      '[nombre], puta de fondo de hilo, de ranking y de meme. Pura vergüenza, gilipollas, y el grupo lo tiene más que claro, gilipollas.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre] El chat no discute, patético.',
      '[nombre], el bot te midió. y el grupo ya había firmado el parte. Hostia puta, asco, y el grupo lo tiene más que claro, asco.',
    ],
    mid: [
  ...
  guarra: {
    ...
    goodIsHigh: false,
    high: [
      'El nivel de guarrada que sueltas haría que un camión de basura. Pidiera la baja por. Hostia puta, coño.',
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Sin indulto, cabrón, y el grupo lo tiene más que claro, cabrón.',
      ...
      'Guarra de estribillo que empeora con cada repetición del mismo tema sucio, [nombre]. Se te ve a la legua, asco.',
      'Guarra cutre y constante: la única racha que mantienes sin fallar nunca, [nombre]. Menudo numerito, basura.',
      'Tienes más manchas en el discurso que un delantal de cocina de barrio a las tres. Pura vergüenza, ridículo.',
      'Guarra de las que el grupo lee con una ceja levantada y cero respeto, [nombre] El chat no discute, fracasado.',
      'El resumen corto es que das asco; el largo es que ni la dignidad te queda a mano. Hostia puta, joder.',
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre]. Sin indulto, mierda, y el grupo lo tiene más que claro, mierda.',
      'Das asco con cada mensaje y ni siquiera aportas una idea nueva. El grupo ya tomó nota, coño, y el grupo lo tiene más que claro, coño.',
      'Se te ve la prisa por ensuciar el hilo y cero ganas de limpiarlo después. Sin anestesia, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'El asco No es moralina: es diagnóstico de cómo ocupas el espacio del chat. Se te ve a la legua, gilipollas.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis. Menudo numerito, patético, y el grupo lo tiene más que claro, patético.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      'El asco Es.basura,basura. Hostia puta. Hostia puta. El chat no discute, basura, y el grupo lo tiene más que claro, basura.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile. Hostia puta, ridículo, y el grupo lo tiene más que claro, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat. Sin indulto, fracasado, y el grupo lo tiene más que claro, fracasado.',
      'El asco No es pruderie: es el termómetro y te marca fiebre de cutrez crónica. El grupo ya tomó nota, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. Sin anestesia, mierda, y el grupo lo tiene más que claro, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. Se te ve a la legua, coño, y el grupo lo tiene más que claro, coño.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día. Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para. El chat no discute, patético, y el grupo lo tiene más que claro, patético.',
      ...
      'Guarra de fondo de chat: siempre ahí, siempre igual, siempre bajando la media, [nombre]. Menudo numerito, basura.',
      'Guarra de superficie suficiente: no hace falta abrir cajones, está a la vista, [nombre]. Pura vergüenza, ridículo.',
      'Guarra profesional: cobras en atención y pagas con vergüenza ajena al que te lee, [nombre], fracasado.',
      'Guarra cutre de feria: mucho ruido, poca sustancia y el suelo peor que antes, [nombre] Hostia puta, joder.',
      'Se te oye el arrastre de la guarrada hasta en los mensajes que quieren parecer neutros. Sin indulto, mierda.',
      'Guarra de las que alardean y el alarde es el último recurso del aburrimiento, [nombre]. El grupo ya tomó nota, coño.',
      ...
      'Guarra sin redención en el nivel: el número alto es la paliza merecida, [nombre]. Menudo numerito, patético.',
      'Guarra de repertorio corto y manchado: siempre las mismas cartas grasientas, [nombre]. Pura vergüenza, asco.',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de lo previsible y sucio. El grupo ya tomó nota, joder.',
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante. Sin anestesia, mierda.',
      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre]. Se te ve a la legua, coño.',
      'Guarra con las mismas cartas manchadas de siempre y sin plan B Menudo numerito, cabrón, y el grupo lo tiene más que claro, cabrón.',
      'Guarra de las que leen el silencio como invitación y se equivocan siempre, [nombre]. Pura vergüenza, gilipollas.',
      'Tienes el aura del cenicero que nadie vacía: presente, lleno y olvidado en el borde. El chat no discute, patético.',
      'Has convertido el descaro en falta de vergüenza y la falta de vergüenza en marca. Hostia puta, asco.',
      'Guarra cutre y orgullosa: el orgullo es lo único que te queda de interesante, [nombre]. Sin indulto, basura.',
      ...
      'Guarra sin estilo: el desastre sin estética es solo desastre, y tú lo clavas, [nombre]. Se te ve a la legua, joder.',
      'Guarra de fondo de ranking: bajas la media con la constancia de un metrónomo, [nombre]. Menudo numerito, mierda.',
      '[nombre], tu repertorio es de patio de colegio y tienes edad de sobra para saberlo. Puta cutrez con documento de identidad.',
      'Guarra de las que el grupo mutea con educación y sigue leyendo por morbo barato, [nombre] El chat no discute, cabrón.',
      'Guarra de cartel roto: la promesa era estilo y el producto es solo suciedad, [nombre] Hostia puta, gilipollas.',
      'Guarra de error de lectura crónico: confundes límites con juego siempre, [nombre]. Sin indulto, patético.',
      ...
      'No es libertad sexual: es falta de criterio y el resultado se huele en el hilo. Se te ve a la legua, ridículo.',
      'Eres tan poco cuidadosa, [nombre], que el descuido dejó de ser accidente y pasó a ser método. Puta cochambre con sistema.',
      'Has convertido. El chat en tu callejón. Y el grupo en el público que no pidió entrada. Pura vergüenza, joder.',
      'Guarra con antigüedad: el óxido de tanto oficio se te ve en cada broma de más, [nombre] El chat no discute, mierda.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'Has convertido la suciedad en identidad. y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder. Pura vergüenza, ridículo, y el grupo lo tiene más que claro, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre]. Menudo numerito, patético.',
      'Guarra de las que el mute ajeno lee como misterio y es solo asco. Documentado, [nombre]. Pura vergüenza, asco.',
      ...
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre]. Se te ve a la legua, coño.',
      'Guarra de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Menudo numerito, cabrón.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] el nivel te nombra sin permiso, fracasado.',
      'Guarra de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Se te ve a la legua, joder.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre]. Menudo numerito, mierda.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre]. Pura vergüenza, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Se te ve a la legua, ridículo.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. Menudo numerito, fracasado.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre]. Pura vergüenza, joder.',
      ...
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre]. Se te ve a la legua, asco, y el grupo lo tiene más que claro, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Menudo numerito, basura, y el grupo lo tiene más que claro, basura.',
      'Guarra de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre]. Pura vergüenza, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre]. Se te ve a la legua, gilipollas.',
      'Has firmado la guarrería con grasa en cada mensaje como única firma, [nombre]. Menudo numerito, patético.',
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Pura vergüenza, asco, y el grupo lo tiene más que claro, asco.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre]. Se te ve a la legua, coño.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. Menudo numerito, cabrón.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre]. Pura vergüenza, gilipollas.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre]. Se te ve a la legua, joder.',
      'Guarra de malinterpretar el mute como interés por el personaje barato, [nombre]. Menudo numerito, mierda.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre]. Pura vergüenza, coño, y el grupo lo tiene más que claro, coño.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre]. Se te ve a la legua, ridículo.',
      'Guarra de respeto ajeno en números rojos del ranking del grupo, [nombre]. Menudo numerito, fracasado.',
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre]. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre]. Se te ve a la legua, asco.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre]. Menudo numerito, basura.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el puto grupo, [nombre]. Pura vergüenza, ridículo.',
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] El ranking firma y listo, fracasado.',
      'El high no es un mal día de orden: es.joder. Hostia puta. Hostia puta, joder, y el grupo lo tiene más que claro, joder.',
      ...
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre]. Menudo numerito, patético.',
      'Has hecho de la guarrería tu marca y la marca se pega en los dedos ajenos, [nombre]. Pura vergüenza, asco.',
      ...
      'Has hecho del bajo listón una residencia fija: sin opción a mudanza, [nombre]. Sin indulto, fracasado.',
      'Guarra sin glamour: el desastre sin estética es solo un problema de higiene narrativa. El grupo ya tomó nota, joder.',
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre]. Sin anestesia, mierda.',
      'Guarra de las que confunden mute con coquetería: error de lectura crónico, [nombre]. Se te ve a la legua, coño.',
      'Guarra cutre de feria ambulante: ruido, grasa y nada que llevarse a casa, [nombre]. Menudo numerito, cabrón.',
      'Nadie te tiene por divertida, [nombre]. Te tienen por ruidosa, que no es lo mismo ni de lejos. Puta alarma sin incendio.',
      'La dignidad te hace gestos desde el andén contrario y tú no te bajas del vagón. El chat no discute, patético.',
      'Guarra de las que el grupo soporta con una ceja arriba y respeto en cero, [nombre] Hostia puta, asco.',
      'El asco Colectivo es el precio de tu repertorio. Y el grupo lo paga cada día. Vergüenza. Sin indulto, basura.',
      ...
      'Has convertido el barro en carnet de identidad. y no hay renovación a la vista. Se te ve a la legua, joder.',
      'Has convertido cada conversación en un parte de guerra de la vergüenza colectiva. Menudo numerito, mierda.',
      'El asco Crónico es el nivel: no un mal día, el promedio del nivel. Desperdicio.desperdicio. Pura vergüenza, coño.',
      'Eres la que deja la conversación como deja todo lo demás, [nombre]: hecha una mierda. Y sin que nadie quiera recogerla.',
      'Tienes más manchas en el relato que un mantel de bar a las seis de la mañana. Hostia puta, gilipollas.',
      'Tienes el aura de un cenicero lleno a las cuatro de la mañana en un local dudoso. Sin indulto, patético.',
      'Guarra de las que el mute ajeno interpreta como juego y no como frontera, [nombre]. El grupo ya tomó nota, asco.',
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma. Sin anestesia, basura.',
      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre]. Se te ve a la legua, ridículo.',
      'Has hecho de lo cutre una marca personal y la marca huele desde el primer mensaje. Menudo numerito, fracasado.',
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar. Pura vergüenza, joder, y el grupo lo tiene más que claro, joder.',
      'Guarra de fondo permanente: baja la media del grupo sin pedir permiso, [nombre] El chat no discute, mierda.',
    ],
    mid: [
