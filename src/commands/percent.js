...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel como un anuncio repetido que nadie pidió. El grupo no necesita subtítulos, gilipollas.',
      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre Sin anestesia y sin narrador, asco. Joder, qué nivel, basura.',
      ...
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre]. El grupo no necesita subtítulos, joder.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre]. Se te ve el fail a la primera, mierda.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Sin anestesia y sin narrador, coño.',
      ...
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre] Sin anestesia y sin narrador, ridículo.',
      'No hay misterio interesante: hay previsible y amargado, el combo del high, [nombre]. El grupo no necesita subtítulos, fracasado.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] Sin anestesia y sin narrador, basura.',
      'Incel de fondo permanente: el high no es un mal día, es el nivel, [nombre]. El grupo no necesita subtítulos, ridículo.',
      ...
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre]. El grupo no necesita subtítulos, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre]. Se te ve el fail a la primera, patético.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre] Sin anestesia y sin narrador, asco.',
      ...
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Sin anestesia y sin narrador, coño.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre]. El grupo no necesita subtítulos, cabrón.',
      ...
      'Tienes el tono de quien acumula fichas de odio y nunca invita a jugar limpio, [nombre] Sin anestesia y sin narrador, mierda.',
      'Incel de las que alardean del sótano porque el exterior las deja sin personaje, [nombre]. El grupo no necesita subtítulos, coño.',
      ...
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre]. El grupo no necesita subtítulos, ridículo.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre]. Se te ve el fail a la primera, fracasado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre] Sin anestesia y sin narrador, joder.',
      ...
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre] Sin anestesia y sin narrador, asco.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. El grupo no necesita subtítulos, basura.',
      ...
      'La compostura del nivel no te reconoce en el elenco social, [nombre] Sin anestesia y sin narrador, patético.',
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre]. El grupo no necesita subtítulos, asco.',
      ...
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre]. El grupo no necesita subtítulos, coño.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre]. Se te ve el fail a la primera, cabrón.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre] Sin anestesia y sin narrador, gilipollas.',
      ...
      'El high no es un mal día de humor: es Sin anestesia y sin narrador, joder. Joder, qué nivel, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre]. El grupo no necesita subtítulos, mierda.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre]. Se te ve el fail a la primera, coño.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. El ranking firma y listo Sin anestesia y sin narrador, cabrón.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], el high te mide y el número. La cámara frontal merece hazard pay, gilipollas. Joder, qué nivel, patético.',
      ...
      'cabrón,cabrón. El atractivo te bloqueó sin forwarding, cabrón. Joder, qué nivel, gilipollas, joder.',
  ...
  masculinidad: {
    ...
    low: [
      ...
      'Se va el color solo, [nombre]. Gilipollas. Y se nota a la legua. Se nota en cada mensaje, joder.',
      'El viento se lleva el cartel. Gilipollas. Pura vergüenza ajena. Se nota en cada mensaje, joder.',
      'Escaparate sin trastienda. Gilipollas. Y se nota a la legua. Se nota en cada mensaje, joder. El ranking no miente, joder.',
  ...
  gay: {
    ...
    goodIsHigh: false,
    high: [
      'Maricón de historial público: no hace falta escarbar, está en la superficie, [nombre] Niegas y se te pone la voz de final de mes, coño.',
      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre]. El grupo ya tiene apuestas abiertas, cabrón.',
      'Maricón de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre]. Se te ve la pose en la primera palabra, gilipollas.',
      'Maricón sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre]. Sin anestesia, patético.',
      'Maricón convertido en wallpaper del fail colectivo. El grupo ya tiene apuestas abiertas, asco. Joder, qué nivel, basura.',
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre]. Se te ve la pose en la primera palabra, basura.',
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre] Niegas y se te pone la voz de final de mes, ridículo.',
      'Maricón de malinterpretar el silencio ajeno como invitación a más teatro, [nombre]. El grupo ya tiene apuestas abiertas, fracasado.',
      'Maricón con el mismo gag de siempre y cero variación. Se te ve la pose en la primera palabra, joder.',
      'Maricón de las que confunden natural con abandono total del estándar, [nombre] Niegas y se te pone la voz de final de mes, mierda.',
      'Maricón de superficie suficiente: no hace falta abrir el cubo, huele, [nombre]. El grupo ya tiene apuestas abiertas, coño.',
      'Maricón de estribillo que empeora con cada bis del mismo número cutre, [nombre]. Sin anestesia, cabrón.',
      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre] Niegas y se te pone la voz de final de mes, gilipollas.',
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre]. El grupo ya tiene apuestas abiertas, patético.',
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre]. Se te ve la pose en la primera palabra, asco.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre] Niegas y se te pone la voz de final de mes, basura.',
      'Maricón de puta madre: el high no suaviza el teatro ni el personajito del ranking, [nombre]. Patético.',
      'Maricón cutre de manual: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Se te ve la pose en la primera palabra, fracasado.',
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre] Niegas y se te pone la voz de final de mes, joder.',
      'Maricón de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre]. Sin anestesia, mierda.',
      'Maricón de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre]. Se te ve la pose en la primera palabra, coño.',
      'El asco No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre] Niegas y se te pone la voz de final de mes, cabrón.',
      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre]. El grupo ya tiene apuestas abiertas, gilipollas.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Se te ve la pose en la primera palabra, patético.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre] Niegas y se te pone la voz de final de mes, asco.',
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre]. El grupo ya tiene apuestas abiertas, basura.',
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre]. Se te ve la pose en la primera palabra, ridículo.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre]. El grupo ya tiene apuestas abiertas, joder.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre]. Se te ve la pose en la primera palabra, mierda.',
      'Maricón constante: la única racha que mantienes es la del mismo número, [nombre] Niegas y se te pone la voz de final de mes, coño.',
      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre]. El grupo ya tiene apuestas abiertas, cabrón.',
      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre]. Se te ve la pose en la primera palabra, gilipollas.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre] Niegas y se te pone la voz de final de mes, patético.',
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre]. El grupo ya tiene apuestas abiertas, asco.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de pose, [nombre]. Sin anestesia, basura.',
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre] Niegas y se te pone la voz de final de mes, ridículo.',
      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre]. El grupo ya tiene apuestas abiertas, fracasado.',
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. Se te ve la pose en la primera palabra, joder.',
      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre] Niegas y se te pone la voz de final de mes, mierda.',
      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre]. El grupo ya tiene apuestas abiertas, coño.',
      'Has convertido el personajito en identidad y no hay detergente narrativo, [nombre]. Se te ve la pose en la primera palabra, cabrón.',
      'Has firmado el personajito con grasa en cada mensaje como única firma, [nombre] Niegas y se te pone la voz de final de mes, gilipollas.',
      'No hay eco de estilo: hay eco de pose. Y el chat lo amplifica de más, [nombre]. Sin anestesia, patético.',
      'Maricón visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Se te ve la pose en la primera palabra, asco.',
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre] Niegas y se te pone la voz de final de mes, basura.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre]. El grupo ya tiene apuestas abiertas, ridículo.',
      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre]. Se te ve la pose en la primera palabra, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Niegas y se te pone la voz de final de mes, joder.',
      'Tienes más episodios de pose que de algo que. El chat respete de verdad, [nombre]. El grupo ya tiene apuestas abiertas, mierda.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Se te ve la pose en la primera palabra, coño.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Sin anestesia, cabrón.',
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre]. El grupo ya tiene apuestas abiertas, gilipollas.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre]. Se te ve la pose en la primera palabra, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Niegas y se te pone la voz de final de mes, asco.',
      'Tu mensaje es un aviso de lo que no hay que tomar en serio en el grupo, [nombre]. El grupo ya tiene apuestas abiertas, basura.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre]. Se te ve la pose en la primera palabra, ridículo.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre] Niegas y se te pone la voz de final de mes, fracasado.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre]. El grupo ya tiene apuestas abiertas, joder.',
      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. Y el chat lo tiene claro, asco.',
      'Maricón sin capa de carisma que disimule el agujero. Niegas y se te pone la voz de final de mes, coño.',
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre]. El grupo ya tiene apuestas abiertas, cabrón.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre]. Se te ve la pose en la primera palabra, gilipollas.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre] Niegas y se te pone la voz de final de mes, patético.',
      'Maricón de ranking: bajas la media del nivel con constancia molesta, [nombre]. El grupo ya tiene apuestas abiertas, asco.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre]. Se te ve la pose en la primera palabra, basura.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] Niegas y se te pone la voz de final de mes, ridículo.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]. Sin anestesia, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre]. Se te ve la pose en la primera palabra, joder.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre] Niegas y se te pone la voz de final de mes, mierda.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. El grupo ya tiene apuestas abiertas, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre]. Se te ve la pose en la primera palabra, cabrón.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre] Niegas y se te pone la voz de final de mes, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre]. El grupo ya tiene apuestas abiertas, patético.',
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre]. Se te ve la pose en la primera palabra, asco.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre]. Sin anestesia, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. El grupo ya tiene apuestas abiertas, ridículo.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. Se te ve la pose en la primera palabra, fracasado.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Y el chat lo tiene claro, joder.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre]. El grupo ya tiene apuestas abiertas, mierda.',
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. Y el chat lo tiene claro, coño.',
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre] Niegas y se te pone la voz de final de mes, cabrón.',
      'Maricón de los que el high del ranking no perdona ni un frame, [nombre]. El grupo ya tiene apuestas abiertas, gilipollas.',
      ...
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre]. El grupo ya tiene apuestas abiertas, basura.',
      'El high no es un mal día de pose: es. Se te ve la pose en la primera palabra, ridículo. Joder, qué nivel, fracasado.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Se te ve la pose en la primera palabra, mierda.',
      ...
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre]. Se te ve la pose en la primera palabra, basura.',
      ...
      'Se te nota que ensuciaste el hilo de pose hace tiempo y perdiste el bayeta, [nombre]. El grupo ya tiene apuestas abiertas, fracasado.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre]. Se te ve la pose en la primera palabra, cabrón.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga sola, [nombre] Niegas y se te pone la voz de final de mes, fracasado.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre] Niegas y se te pone la voz de final de mes, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Se te ve la pose en la primera palabra, fracasado.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre]. El grupo ya tiene apuestas abiertas, gilipollas.',
      ...
      'Cada vez que un tío se agacha se te para el reloj. Luego sigues como si nada, peromaricón. Niegas y se te pone la voz de final de mes, mierda.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo Sin anestesia y sin narrador, asco. Joder, qué nivel, basura.',
      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre]. El grupo no necesita subtítulos, basura.',
      ...
      'Simp con el mismo gag de siempre y cero variación. El grupo no necesita subtítulos, joder. Joder, qué nivel, mierda.',
      ...
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre] Sin anestesia y sin narrador, patético.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre]. El grupo no necesita subtítulos, asco.',
      ...
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre]. El grupo no necesita subtítulos, coño.',
      'Simp de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Se te ve el fail a la primera, cabrón.',
      'El recato de dignidad te queda lejos y la distancia es rechazo, no mística, [nombre] Sin anestesia y sin narrador, gilipollas.',
      ...
      'Simp de fondo permanente: el high no es un mal día, es el nivel, [nombre] Sin anestesia y sin narrador, joder.',
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre]. El grupo no necesita subtítulos, mierda.',
      ...
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre] Sin anestesia y sin narrador, fracasado.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre]. El grupo no necesita subtítulos, joder.',
      ...
      'Se te nota el peso de arrastrar el mismo pedestal por cada conversación, [nombre]. El grupo no necesita subtítulos, asco.',
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre]. Se te ve el fail a la primera, basura.',
      'Simp de feria de validación: ruido interno, cero ganas de volver del resto, [nombre] Sin anestesia y sin narrador, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre]. El grupo no necesita subtítulos, patético.',
      ...
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre] Sin anestesia y sin narrador, cabrón.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre]. El grupo no necesita subtítulos, gilipollas.',
      ...
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre]. El grupo no necesita subtítulos, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre]. Se te ve el fail a la primera, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre] Sin anestesia y sin narrador, coño.',
      ...
      'No es estilo: es simp previsible y el high te lo nombra entero, [nombre]. El grupo no necesita subtítulos, fracasado.',
      ...
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre] Sin anestesia y sin narrador, basura.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre]. El grupo no necesita subtítulos, ridículo.',
      ...
      'El high no es un mal día de carácter: es. El grupo no necesita subtítulos, mierda. Joder, qué nivel, coño.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. El grupo no necesita subtítulos, gilipollas.',
      ...
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Sin anestesia y sin narrador, asco.',
  ...
  rata: {
    ...
    high: [
      ...
      'Rata de puta madre en el sentido literal: el high no suaviza el hocico, [nombre] Tu palabra no vale una mierda aquí, basura.',
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre] Resuelves conflictos alimentándolos, ridículo.',
      ...
      'El high no es un mal día de ética: es Trepar sobre otros te queda de oficio, patético. Joder, qué nivel, asco.',
      ...
      'El promedio de ratez es este: el nivel no es un mal día, es el nivel, [nombre] Tu palabra no vale una mierda aquí, cabrón.',
  ...
  maricon: {
    ...
    goodIsHigh: false,
    high: [
      'Joder, un personaje hetero tan frágil que se cae con una mirada de más y se cae cada puto día, yhace tiempo. Basura.',
      'Coño, tarde a aceptarlo y temprano a disimularlo: el desfase se nota en cada puta frase, yhace tiempo. Basura.',
      'Coño, cada negación añade capa de ridículo: la tarta ya tiene demasiadas capas de mentira, yhace tiempo. Asco.',
      'Coño, habla se te ilumina la cara dos segundos de más y esos dos segundos son toda la confesión, yhace tiempo. Cabrón.',
      ...
      'Joder, un detalle que solo tiene quien está eligiendo de verdad, y estás eligiendo sin disimulo, yhace tiempo. Ridículo.',
      'Hostia, cuándo vas a salir: las apuestas están abiertas y las cuotas bajan cada puta semana, yhace tiempo. Pringado.',
      'Coño, pasa un tío en forma: el reflejo es más honesto que toda tu boca junta en el chat, yhace tiempo. Fracasado.',
      'Mierda, haciendo de hetero: el público se fue en el primer acto y tú sigues en el escenario solo, yhace tiempo. Joder.',
      'Joder, gritas que no eres y el eco te devuelve la mentira con reverb de mentiroso profesional, yhace tiempo. Coño.',
      'Coño, ya no cuenta como secreto: es un anuncio a toda página y tú sigues en modo incógnito, yhace tiempo. Gilipollas.',
      'Mierda, tu cuerpo responde antes que tu boca: el cuerpo no ha firmado el pacto de silencio, yhace tiempo. Patético.',
      'Coño, se quita la camiseta se te para el tiempo y luego reanudas el guion como si nadie hubiera visto, yhace tiempo. Asco.',
      'Coño, dejó de preguntar, ahora afirma: tú sigues respondiendo como si fuera un debate abierto, yhace tiempo. Joder.',
      ...
      'Joder, la negación cansa más que la verdad y aun así eliges el cansancio como si fuera una virtud, yhace tiempo. Cabrón.',
      'Coño, niegas y se te sube la voz media octava: el cuerpo delata hasta en el tono de la mentira, yhace tiempo. Patético.',
      'Joder, cada no homo es un ladrillo: llevas una muralla y todavía crees que estás escondido detrás, yhace tiempo. Fracasado.',
      'Coño, mujeres como manual leído en voz alta: sin pasión y con ganas de que termine la escena, yhace tiempo. Mierda.',
      'Mierda, cuello, pausas y sonrisas de más ya escribieron el informe: solo falta tu firma al pie, yhace tiempo. Coño.',
      'Joder, evidencia forense en tus reacciones: el juicio se celebra cada vez que pasa un tío bueno, yhace tiempo. Gilipollas.',
      'Coño, versión macho es un skin para el grupo: en cuanto bajas la guardia el skin se cae solo, yhace tiempo. Ridículo.',
      'Mierda, el armario ya no te protege, te exhibe: cada capa de negación hace el contorno más claro, yhace tiempo. Basura.',
      'Joder, tanto en el disfraz que el día que te lo quites vas a sentir el aire: conviene sentirlo, yhace tiempo. Asco.',
      'Mierda, pack de reprimido: miradas, pausas, bromas y ofensa selectiva: el pack se vende solo, yhace tiempo. Pringado.',
      'Mierda, ya no se sorprende, se aburre de esperarte: eso también es un diagnóstico del grupo, yhace tiempo. Cabrón.',
      'Joder, hetero cabe en un tuit: tu gay reprimido llena el resto del timeline sin esfuerzo, yhace tiempo. Patético.',
      'Coño, fútbol como trámite: los heteros de verdad a veces se aburren pero no se les nota tanto, yhace tiempo. Pringado.',
      'Mierda, años construyendo la coartada: la coartada ya no sostiene el peso de las pruebas, yhace tiempo. Fracasado.',
      'Joder, no soy gay suena a todavía no lo he dicho en voz alta: la diferencia es mínima, yhace tiempo. Mierda.',
      'Coño, culos con concentración de cirujano: luego dices que era por el corte del pantalón, yhace tiempo. Cabrón.',
      'Mierda, duda en zona de confort y evidencia en invitado molesto: el invitado ya vive contigo, yhace tiempo. Gilipollas.',
      'Joder, versión pública y privada ya no se saludan: la privada lleva ganando años enteros, yhace tiempo. Ridículo.',
      'Mierda, tanto negando que la negación se te quedó de gesto: hasta en las fotos se ve el tic, yhace tiempo. Asco.',
      'Coño, tías como letra de canción en otro idioma: sin sentirla y con ganas de que acabe, yhace tiempo. Fracasado.',
      'Mierda, el grupo te resume en una palabra: tú necesitas un párrafo para no decirla, el resumen gana, yhace tiempo. Joder.',
      'Joder, tío se ríe y tú medio segundo después: se te ve el retraso del disimulo a la legua, yhace tiempo. Coño.',
      'Coño, única persona sorprendida eres tú: el resto está en la grada desde el primer acto, yhace tiempo. Gilipollas.',
      'Mierda, tíos como escaparates y no es de ropa: es de otra cosa que no quieres poner en palabras, yhace tiempo. Patético.',
      ...
      'Joder, pack de reprimido con manual incluido: el manual se te cae a menudo y se lee solo, yhace tiempo. Basura.',
      'Coño, cuerpo de amigos con inventario: tallas, proporciones y nota mental que no confiesas, yhace tiempo. Joder.',
      'Joder, coherencia se fue el día que combinaste miradas de hambre con discurso de hetero, yhace tiempo. Cabrón.',
      'Coño, cuerpo ya hizo el anuncio: tú sigues en la rueda de prensa negando el comunicado oficial, yhace tiempo. Patético.',
      'Mierda, dices que no miras y la pupila se dilata sola: la biología no firmó el pacto de silencio, yhace tiempo. Ridículo.',
      'Joder, negación es tu deporte olímpico: llevas medallas de mentira y el podio se nota, yhace tiempo. Fracasado.',
      'Coño, cada pista es más clara que la anterior: la curva de aprendizaje del grupo es perfecta, yhace tiempo. Mierda.',
      'Mierda, boca dice no y tiempo de reacción dice sí: el tiempo de reacción no miente nunca, yhace tiempo. Coño.',
      'Joder, única salida digna es dejar de pelearte con lo evidente: el resto son vueltas de más, yhace tiempo. Gilipollas.',
      'Coño, tíos como quien elige en una carta: y la carta no es de restaurante de ninguna clase, yhace tiempo. Ridículo.',
      'Mierda, hetero es traje de alquiler: se devuelve al final de la función y la función se alarga, yhace tiempo. Basura.',
      'Mierda, años en modo avestruz: el agujero ya es profundo. Y el grupo ve el resto del cuerpo, yhace tiempo. Pringado.',
      'Joder, miras con hambre y hablas con dieta: el hambre se te ve en los ojos. Sin filtro, yhace tiempo. Patético.',
      '[nombre] es tan maricón que duda en estilo y certeza en peligro: el estilo se te está quedando viejo, yhace tiempo. Asco.',
      'Coño, dices que no pasa nada y se te nota que pasa todo: el no pasa nada es el peor disfraz, yhace tiempo. Pringado.',
      'Mierda, tanto negociando contigo que el grupo firmó la paz por ti hace meses enteros, yhace tiempo. Fracasado.',
      'Joder, boca es abogado defensor y cuerpo es el testigo que lo hunde: el juicio está visto, yhace tiempo. Mierda.',
      'Mierda, grupo no necesita pruebas nuevas: necesita que tú te enteres de las viejas de una vez, yhace tiempo. Gilipollas.',
      'Joder, estética de la duda y discurso de la certeza: ninguna de las dos te queda limpia, yhace tiempo. Ridículo.',
      'Mierda, miras a tíos con calma de quien ya eligió y boca de quien todavía no firmó nada, yhace tiempo. Asco.',
      'Coño, años en el limbo entre lo que eres y lo que dices: el limbo también cansa al público, yhace tiempo. Fracasado.',
      'Mierda, grupo te tiene en la categoría correcta: tú sigues en la de reclamaciones sin avanzar, yhace tiempo. Joder.',
      'Joder, negación hecha reflejo: el reflejo ya es más rápido que tu pensamiento consciente, yhace tiempo. Coño.',
      'Coño, salida del armario convertida en tráiler eterno: el estreno no llega y el público se fue, yhace tiempo. Gilipollas.',
      'Mierda, culo con más honestidad que el discurso: y se nota en cómo te sientas cuando hay tíos, yhace tiempo. Patético.',
      'Joder, no en la boca y sí en los ojos: los ojos se ven de más lejos y no mienten nunca, yhace tiempo. Basura.',
      'Coño, has llegado al final del debate: solo falta que te enteres de que acabó hace meses, yhace tiempo. Asco.',
      ...
      'Joder, disimulo cansa más al grupo que a ti: y eso ya es mucho decir en este chat, yhace tiempo. Pringado.',
      'Mierda, lo obvio en debate eterno: el debate ya no entretiene a nadie en este grupo, yhace tiempo. Cabrón.',
      ...
      'Joder, el grupo te ve venir a kilómetros: la forma de mirar es el faro que no apagas, yhace tiempo. Asco.',
      ...
      'Coño, evidencia en las pausas: las pausas hablan más que tus frases de negación, yhace tiempo. Basura.',
      'Coño, outfit de disimulo y gesto de más suman: la suma ya es pública en el chat, yhace tiempo. Cabrón.',
      ...
      'Hostia, se ve la estructura por debajo. Y el grupo ya no se cree ni el montaje más elaborado del chat, yhace tiempo. Coño.',
      'Hostia, el estribillo de una canción que todo el grupo se sabe de memoria desde el primer mes, yhace tiempo. Basura.',
      'Coño, la devoción de quien reza y luego niegas la religión con la boca todavía llena de amén, yhace tiempo. Desperdicio.',
      ...
      'Joder, quien repasa un guion mal aprendido: sin improvisación, sin ganas y con prisa de que acabe, yhace tiempo. Cutre.',
      'Hostia, intensidad de catálogo y el catálogo no es de amistad, es de otra cosa que no nombras, yhace tiempo. Cabrón.',
      'Hostia, no te esconde, te expone: cada negación es otra capa de pintura que no tapa la forma, yhace tiempo. Desperdicio, mierda.',
      'Mierda, pausas, miradas y sonrisas de más ya formaron un expediente completo: solo falta tu firma, yhace tiempo. Vergüenza.',
      'Hostia, tu culo y tu boca están en guerra civil: el culo quiere y la boca sigue con el comunicado, yhace tiempo. Fracasado.',
      'Hostia, la única persona que compra tu versión hetero eres tú y cada día con menos convicción, yhace tiempo. Gilipollas.',
      'Joder, el teatro dura lo que dura la paciencia del grupo y la paciencia se mide en semanas, yhace tiempo. Desperdicio.',
      'Hostia, la duda en estilo de vida y la evidencia en ruido de fondo: el ruido ya es ensordecedor, yhace tiempo. Asco.',
      'Coño, culos masculinos con la misma atención con que otros miran el móvil: y no es el pantalón, yhace tiempo. Vergüenza.',
      'Mierda, castillo de arena: la marea de la verdad sube cada día y se lleva otro muro de tu coartada, yhace tiempo. Cutre.',
      'Hostia, fichado con más precisión que tú a ti mismo: eso ya es el colmo de la negación diaria, yhace tiempo. Joder.',
      'Hostia, no eres con la frecuencia con que respiras: quien no lo es no necesita el recordatorio, yhace tiempo. Patético.',
      'Hostia, un tío se agacha se te para el reloj: luego sigues como si el tiempo no hubiera pausado, yhace tiempo. Vergüenza, mierda.',
      'Coño, boca niega y cuerpo confirma: el grupo se queda con el testigo más fiable del expediente, yhace tiempo. Cutre.',
      'Joder, tías con la pasión de un vegetariano describiendo un chuletón: se nota que no te apetece, yhace tiempo. Joder.',
      'Hostia, armario con wifi, calefacción y suscripciones: a este ritmo pides comida a domicilio dentro, yhace tiempo. Mierda.',
      'Coño, pista es miga: el camino llega hasta la puerta y la puerta está entreabierta hace meses, yhace tiempo. Coño.',
      'Hostia, físico de bros con detalle de inventario personal: tallas, proporciones y nota mental, yhace tiempo. Ridículo.',
      'Mierda, negación forma parte del personaje: sin ella el papel se cae, por eso la repites tanto, yhace tiempo. Desperdicio.',
      'Joder, cuerpo responde a tíos y boca a presión social: el cuerpo no ha leído las normas del chat, yhace tiempo. Vergüenza.',
      'Hostia, armario tan profundo que tus negaciones hacen eco y el eco suena a mentira profesional, yhace tiempo. Cutre, asco.',
      'Hostia, memes internos sobre tu armario: los memes son más honestos que tus estados de WhatsApp, yhace tiempo. Coño.',
      'Hostia, te gustan las mujeres pero la atención se va sola a los tíos: la atención no miente, yhace tiempo. Basura.',
      'Coño, teatro en intermedio: llevas meses en el intermedio y el público quiere el segundo acto, yhace tiempo. Desperdicio.',
      'Hostia, evidencia ordenada por fecha en tus reacciones: es un diario sin metáforas ni disculpas, yhace tiempo. Pringado.',
      'Hostia, invertido en parecer y no en ser: la factura llega cada vez que alguien te mira de más, yhace tiempo. Cabrón.',
      'Hostia, día que digas la verdad el grupo dirá por fin: y eso también va a doler un poco, yhace tiempo. Desperdicio, mierda.',
      'Mierda, hetero es un DLC que casi nadie activa: el juego base es otro y todo el mundo lo sabe, yhace tiempo. Vergüenza.',
      'Hostia, armario con puerta de vaivén: sales un segundo y vuelves a entrar, se ve desde fuera, yhace tiempo. Fracasado.',
      'Mierda, es broma es el punto final de cada confesión: sin él el párrafo quedaría demasiado claro, yhace tiempo. Mierda.',
      'Hostia, niegas con datos inventados. Y el grupo anota la contradicción: el cuaderno está lleno, yhace tiempo. Gilipollas.',
      'Joder, grupo ya no debate el diagnóstico: debate el plazo y tú sigues en fase de alegaciones, yhace tiempo. Desperdicio.',
      'Hostia, culos con devoción y tías con deber: el contraste es el chiste del día en el grupo, yhace tiempo. Asco.',
      'Coño, hetero cabe en un mensaje de ocho segundos: tu gay reprimido no cabe en un hilo entero, yhace tiempo. Vergüenza.',
      'Mierda, tanto corrector discursivo que la verdad necesita pala: y sale igual de clara, yhace tiempo. Cutre.',
      'Hostia, armario ya tiene vecinos: tus excusas viven en el piso de abajo y hacen ruido de noche, yhace tiempo. Joder.',
      'Hostia, hasta los nuevos te clasifican en una tarde: eficiente sin querer y sin remedio, yhace tiempo. Patético.',
      'Hostia, invertido en el personaje y olvidado de la persona: el personaje ya no te queda, yhace tiempo. Vergüenza, mierda.',
      'Coño, te gustan las tías y el historial de atención dice otra cosa: el historial gana, yhace tiempo. Cutre.',
      'Hostia, día que coincidas con lo que todos ven vas a ganar tiempo: hasta entonces lo pierdes, yhace tiempo. Mierda.',
      'Coño, mujeres como quien rellena un formulario: campos obligatorios y cero emoción real, yhace tiempo. Coño.',
      'Hostia, pack completo y nota a pie de no soy gay: nadie lee la nota y todos leen el pack, yhace tiempo. Ridículo.',
      'Mierda, tío se ríe contigo y se te olvida el personaje medio segundo: ese medio segundo basta, yhace tiempo. Desperdicio.',
      'Joder, armario con horarios de visita: el grupo ya conoce los turnos de entrada y salida, yhace tiempo. Vergüenza.',
      'Hostia, tu versión y la del grupo ya no comparten ni el pronombre implícito del asunto, yhace tiempo. Cutre, asco.',
      'Hostia, cuando niegas se te pone la voz de quien defiende un final de mes: forzado y sin margen, yhace tiempo. Basura.',
      'Coño, armario convertido en oficina: trabajas ahí más horas que en tu vida real, yhace tiempo. Desperdicio.',
      ...
      'Joder, cuerpo anuncia y boca desmiente: el anuncio tiene más alcance que el desmentido, yhace tiempo. Cutre.',
      'Hostia, cada no homo es una firma: llevas el documento lleno y todavía dices que está en borrador, yhace tiempo. Pringado.',
      'Hostia, miras con el estómago y hablas con el protocolo: el estómago tiene mejor criterio, yhace tiempo. Cabrón.',
      'Hostia, la verdad no te va a matar: el disfraz a largo plazo sí te está cobrando peaje cada día, yhace tiempo. Desperdicio, mierda.',
      'Joder, cada negación es un ladrillo: la casa de la mentira ya tiene terraza y vistas, yhace tiempo. Joder.',
      ...
      'Hostia, mentira es más trabajo que la verdad y aun así eliges el trabajo cada día, yhace tiempo. Coño.',
      ...
      'Joder, ambigüedad en escudo y el escudo se te queda pequeño cada mes que pasa, yhace tiempo. Cutre. El grupo no necesita subtítulos, ridículo.',
  ...
  friki: {
    ...
    high: [
      ...
      'La dignidad del nivel no para: tú eres el tráfico del arcén social, [nombre] Sin anestesia y sin narrador, ridículo.',
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre]. El grupo no necesita subtítulos, fracasado.',
      ...
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre] Sin anestesia y sin narrador, asco.',
      ...
      'Friki de manual cutre: el estereotipo sin el carisma que a veces salva al raro, [nombre] Sin anestesia y sin narrador, coño.',
      'La compostura social no te reconoce y tú no has buscado el espejo del chat, [nombre]. El grupo no necesita subtítulos, cabrón.',
      ...
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre]. El grupo no necesita subtítulos, coño.',
      ...
      'Friki con el bucle eterno del mismo error en bucle Sin anestesia y sin narrador, gilipollas.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. El grupo no necesita subtítulos, ridículo.',
      'No es profundidad: es aislamiento con teclado y el nivel te lo cobra, [nombre]. Se te ve el fail a la primera, fracasado.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Sin anestesia y sin narrador, joder.',
      ...
      'Friki de malinterpretar el silencio ajeno como interés por el lore, [nombre] Sin anestesia y sin narrador, asco.',
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre]. El grupo no necesita subtítulos, basura.',
      ...
      'Friki sin ni siquiera el barniz barato que salva a otros desastres. El grupo no necesita subtítulos, joder.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre]. El grupo no necesita subtítulos, asco.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre] Sin anestesia y sin narrador, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre]. El grupo no necesita subtítulos, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo sin estilo: el desastre sin estética es solo un problema de higiene del hilo. Dejas grasa en cada puto mensaje, ridículo.',
      'Tienes más episodios de cerdez documentada que intentos de subir el nivel un punto. Tu higiene es un museo de bacterias, fracasado.',
      'El promedio de cerdez es el nivel: no un pico, el suelo del nivel, [nombre]. El cepillo nuevo con etiqueta te delata, joder.',
      'El asco. Colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre]. Sin anestesia, mierda.',
      'Cerdo de las que alardean de la grasa porque callar las dejaría sin personaje. Tu higiene es un museo de bacterias, coño.',
      'Das asco de entrada y el resto del mensaje solo confirma el desastre, [nombre]. El cepillo nuevo con etiqueta te delata, cabrón.',
      '[nombre], tu manera de fregar el suelo es esperar a que se seque solo. Cada mancha se queda a vivir. Puta casa de mierda.',
      'Se te nota la prisa por embadurnar el chat y cero ganas de limpiar después. Tu higiene es un museo de bacterias, patético.',
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor. El cepillo nuevo con etiqueta te delata, asco.',
      'El asco No es moralina: es el termómetro y te marca cerdez crónica, [nombre] Dejas grasa en cada puto mensaje, basura.',
      'Tienes más restos en el relato que un cubo de basura. El día de recogida. Tu higiene es un museo de bacterias, ridículo.',
      ...
      'No es atrevimiento: es suciedad previsible y el high te la cobra sin descuento, [nombre] Dejas grasa en cada puto mensaje, basura.',
      'Se te oye el masticar de la cerdez hasta en los mensajes que quieren parecer neutros. Tu higiene es un museo de bacterias, ridículo.',
      ...
      'Has convertido el grupo en tu comedero y los demás en testigos del banquete, [nombre] Dejas grasa en cada puto mensaje, joder.',
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre]. Sin anestesia, mierda.',
      'Cerdo sin capa de carisma que disimule el agujero. El cepillo nuevo con etiqueta te delata, coño, joder.',
      ...
      'El listón de lo decente lo usas de servilleta y lo tiras al suelo del chat, [nombre] Tu higiene es un museo de bacterias, gilipollas.',
      ...
      'La palabra compostura te suena a idioma de otro planeta y no has abierto el diccionario. El cepillo nuevo con etiqueta te delata, ridículo.',
      ...
      'Cerdo de historial público: la grasa está en la superficie, no hace falta escarbar. El cepillo nuevo con etiqueta te delata, mierda.',
      'Se te ve la prisa por embadurnar y la ausencia total de plan de limpieza, [nombre] Dejas grasa en cada puto mensaje, coño.',
      'Cerdo de fondo permanente: baja la media del grupo con constancia de metrónomo, [nombre] Tu higiene es un museo de bacterias, cabrón.',
      'Tu escritorio tiene manchas superpuestas que ya forman un patrón geológico, cerdo. Cada capa es un mes de mierda. Acumulada.',
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre] Dejas grasa en cada puto mensaje, patético.',
      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre] Tu higiene es un museo de bacterias, asco.',
      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre]. Sin anestesia, basura.',
      'Tienes más grasa en el discurso que un freidora de feria al cierre de la noche. Dejas grasa en cada puto mensaje, ridículo.',
      'El promedio de cerdez es este: el nivel no es un mal día, es el nivel, [nombre] Tu higiene es un museo de bacterias, fracasado.',
      'Cerdo de error de lectura: confundes límites con permiso para seguir manchando. El cepillo nuevo con etiqueta te delata, joder.',
      'Tienes cepillos de dientes viejos criando ahí al lado del que usas, [nombre]. Un puto museo de bacterias con vaso propio.',
      'Cerdo sin redención estética: solo grasa, sin capa de carisma que disimule el agujero. Tu higiene es un museo de bacterias, coño.',
      ...
      'Tienes más migas en el historial que un mantel de bar después del desayuno eterno. El cepillo nuevo con etiqueta te delata, asco.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos de limpieza. Dejas grasa en cada puto mensaje, basura.',
      'No es estilo atrevido: es grasa previsible y el high te la cobra entera, [nombre] Tu higiene es un museo de bacterias, ridículo.',
      ...
      'No es libertad: es falta de criterio con migas y el resultado se huele, [nombre] Tu higiene es un museo de bacterias, mierda.',
      'Se te nota el hábito de empujar cada tema hacia el mismo plato sin fregar, [nombre]. El cepillo nuevo con etiqueta te delata, coño.',
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre]. Sin anestesia. Dejas grasa en cada puto mensaje, cabrón.',
      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar. Tu higiene es un museo de bacterias, gilipollas.',
      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre]. El cepillo nuevo con etiqueta te delata, patético.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, joder, con el grupo de testigo. Dejas grasa en cada puto mensaje, fracasado.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre. Sin anestesia. El cepillo nuevo con etiqueta te delata, mierda.',
      'El listón de lo presentable lo usas de tobogán hacia abajo, joder, [nombre] Dejas grasa en cada puto mensaje, coño.',
      'Cerdo sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. Tu higiene es un museo de bacterias, cabrón.',
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre]. El cepillo nuevo con etiqueta te delata, gilipollas.',
      ...
      'El asco No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre]. El cepillo nuevo con etiqueta te delata, joder.',
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre] Dejas grasa en cada puto mensaje, mierda.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Tu higiene es un museo de bacterias, coño.',
      ...
      'Cerdo de ranking: bajas la media del nivel con constancia de mancha, [nombre] Tu higiene es un museo de bacterias, ridículo.',
      'Has convertido el bajo listón en casa fija sin fecha de mudanza, [nombre]. El cepillo nuevo con etiqueta te delata, fracasado.',
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre] Dejas grasa en cada puto mensaje, joder.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] Dejas grasa en cada puto mensaje, asco.',
      'Has convertido la porquería en carnet y no hay renovación limpia, [nombre] Tu higiene es un museo de bacterias, basura.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El cepillo nuevo con etiqueta te delata, ridículo.',
      ...
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado, [nombre]. El cepillo nuevo con etiqueta te delata, gilipollas.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre] Dejas grasa en cada puto mensaje, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Tu higiene es un museo de bacterias, asco.',
      ...
      'Cerdo de superficie: no hace falta abrir el cubo, huele de lejos, [nombre] Tu higiene es un museo de bacterias, coño.',
      'No hay barniz que salve: hay cerdo puro y no se vende como carisma, [nombre]. El cepillo nuevo con etiqueta te delata, cabrón.',
      'Tienes el tono de quien acumula restos y nunca pasa el estropajo, [nombre] Dejas grasa en cada puto mensaje, gilipollas.',
      ...
      'La clase te suena a ataque y respondes con más migas de suciedad, [nombre] Dejas grasa en cada puto mensaje, joder.',
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre] Tu higiene es un museo de bacterias, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre]. El cepillo nuevo con etiqueta te delata, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. El cepillo nuevo con etiqueta te delata, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre] Dejas grasa en cada puto mensaje, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Tu higiene es un museo de bacterias, joder.',
      ...
      'La compostura del nivel no te reconoce en el elenco, [nombre]. Y el chat lo tiene claro. Tu higiene es un museo de bacterias, asco.',
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre]. El cepillo nuevo con etiqueta te delata, basura.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre] Dejas grasa en cada puto mensaje, ridículo.',
      ...
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre] Dejas grasa en cada puto mensaje, gilipollas.',
      'Cerdo hasta para el modo oscuro: ni la sombra tapa lo que dejas, [nombre] Tu higiene es un museo de bacterias, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. El cepillo nuevo con etiqueta te delata, asco.',
      ...
      'El high no es un mal día de orden: es.mierda. Sin anestesia. Tu higiene es un museo de bacterias, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre]. El cepillo nuevo con etiqueta te delata, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre] Dejas grasa en cada puto mensaje, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Tu higiene es un museo de bacterias, gilipollas.',
      ...
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo. El cepillo nuevo con etiqueta te delata, mierda.',
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual. Dejas grasa en cada puto mensaje, coño.',
      'Has hecho de lo indecente tu plato favorito y lo sirves en todas las mesas. Tu higiene es un museo de bacterias, cabrón.',
      'No es gracia sucia: es suciedad sin gracia, la versión que no entretiene, [nombre]. El cepillo nuevo con etiqueta te delata, gilipollas.',
      'El listón está en el suelo y tú lo usas de pan para mojar sin vergüenza, [nombre] Dejas grasa en cada puto mensaje, patético.',
      'Cerdo de oficio: el rastro de grasa es tu firma y aparece en cada párrafo. Tu higiene es un museo de bacterias, asco.',
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible. Sin anestesia. El cepillo nuevo con etiqueta te delata, basura.',
      'Dejas el baño de tal manera que hay que limpiarlo antes de poder usarlo. Puta escena del crimen con toalla húmeda.',
      'Tienes el tono de quien come con la boca abierta en un restaurante en silencio. Tu higiene es un museo de bacterias, fracasado.',
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual. El cepillo nuevo con etiqueta te delata, joder.',
      'Tienes una manta que huele desde hace meses y duermes con ella cada noche. Ni un animal aguanta eso, puto guarro.',
      'Has hecho de lo cutre una marca y la marca se pega en los dedos del que lee. Tu higiene es un museo de bacterias, coño.',
      'La palabra clase te suena a reproche y respondes ensuciando un poco más. El cepillo nuevo con etiqueta te delata, cabrón.',
      'Se te oye el arrastre de la grasa hasta en los mensajes cortos del chat. Dejas grasa en cada puto mensaje, gilipollas.',
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio. Sin anestesia, patético.',
      'Tienes más manchas documentadas que intentos serios de pasar un trapo al relato. El cepillo nuevo con etiqueta te delata, asco.',
      'Has convertido la grasa en carnet y no hay renovación limpia a la vista. Dejas grasa en cada puto mensaje, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla. Tu higiene es un museo de bacterias, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B El cepillo nuevo con etiqueta te delata, fracasado.',
      'Has convertido la mancha en identidad y no hay detergente narrativo a la vista. Dejas grasa en cada puto mensaje, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Tu higiene es un museo de bacterias, mierda.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre]. El cepillo nuevo con etiqueta te delata, coño.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro. Sin anestesia. Dejas grasa en cada puto mensaje, cabrón.',
      'Cerdo sin higiene narrativa: ensucias el hilo y no recoges nunca el escombro. Tu higiene es un museo de bacterias, gilipollas.',
    ],
    mid: [
  ...
  femboy: {
    ...
    high: [
      ...
      'Femboy como un anuncio repetido que nadie pidió, joder, con el grupo de testigo Sin anestesia y sin narrador, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre]. El grupo no necesita subtítulos, joder.',
      ...
      'Femboy sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. El grupo no necesita subtítulos, cabrón.',
      ...
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre]. El grupo no necesita subtítulos, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Se te ve el fail a la primera, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre] Sin anestesia y sin narrador, ridículo.',
      ...
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre] Sin anestesia y sin narrador, gilipollas.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      ...
      'Femboy de fondo permanente: el high no es un mal día, es el nivel, [nombre] Sin anestesia y sin narrador, cabrón.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre]. El grupo no necesita subtítulos, gilipollas.',
      ...
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. El grupo no necesita subtítulos, joder.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Se te ve el fail a la primera, mierda.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Sin anestesia y sin narrador, coño.',
      ...
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre] Sin anestesia y sin narrador, ridículo.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]. El grupo no necesita subtítulos, fracasado.',
      ...
      'Femboy de puta madre: el high no suaviza el teatro ni el personajito, [nombre]. Se te ve el fail a la primera, asco.',
      ...
      'Tu historial de búsquedas, tus compras y tu forma de sentarte ya formaron un tribunal. El grupo no necesita subtítulos, gilipollas.',
    ],
    mid: [
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el nivel, [nombre] Presencia sin función, ruido de fondo, ridículo.',
      'La clase de aportar te suena a reproche, [nombre], coño. Y el chat lo tiene claro. Ni para el drama aportas nada útil, fracasado.',
      'El asco. Del nivel es este: presencia sin función, [nombre]. El eco del vacío te delata en cada hilo, joder.',
      ...
      'Se te ve venir el vacío en la primera palabra del mensaje del hilo, [nombre]. Ni para el drama aportas nada útil, coño.',
      'Se te oye el eco del vacío cada vez que intentas llenar un silencio del hilo, [nombre]. El eco del vacío te delata en cada hilo, cabrón.',
      ...
      'Has firmado lo inútil en cada mensaje largo que no sostiene nada del hilo, [nombre]. El eco del vacío te delata en cada hilo, asco.',
      'No hay misterio útil: hay previsible vacío en el nivel del comando, [nombre] Presencia sin función, ruido de fondo, basura.',
      'El promedio de inutilidad es el nivel: no un mal día, el suelo del high, [nombre]. Ni para el drama aportas nada útil, ridículo.',
      ...
      'Inútil de superficie suficiente: no hace falta el sótano del historial, [nombre] Presencia sin función, ruido de fondo, joder.',
      'La vergüenza ajena te sigue cuando pretendes ser necesarios en el chat, [nombre]. Ni para el drama aportas nada útil, mierda.',
      ...
      'Inútil de error crónico: confundes mute con misterio en el ranking, [nombre]. Ni para el drama aportas nada útil, gilipollas.',
      'Tu forma de contribuir es asentir a lo que decidan otros. Eso no es contribuir, gilipollas. Eso es hacer bulto con opinión.',
      'Inútil documentado: el ranking de aporte te deja donde mereces sin debate, [nombre] Presencia sin función, ruido de fondo, asco.',
      ...
      'Inútil con las mismas cartas manchadas de siempre y sin plan B, joder, diagnóstico cerrado. Ni para el drama aportas nada útil, cabrón.',
      'Inútil de cartel vacío: se ve el marco y no hay obra detrás del nick, [nombre]. El eco del vacío te delata en cada hilo, gilipollas.',
      ...
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre]. El eco del vacío te delata en cada hilo, joder.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre] Presencia sin función, ruido de fondo, mierda.',
      'Inútil sin capa de carisma que disimule el agujero. Ni para el drama aportas nada útil, coño. Joder, qué nivel, cabrón.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre]. Ni para el drama aportas nada útil, ridículo.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre]. El eco del vacío te delata en cada hilo, fracasado.',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre]. Y el chat lo tiene claro. El eco del vacío te delata en cada hilo, coño.',
      ...
      'El precio de tu repertorio vacío lo paga el hilo en tiempo perdido del chat, [nombre]. Ni para el drama aportas nada útil, asco.',
      ...
      'Tienes la utilidad de un mando sin pilas: se ve, no sirve, estorba en el ranking, [nombre] Presencia sin función, ruido de fondo, mierda.',
      'Inútil de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. Ni para el drama aportas nada útil, coño.',
      ...
      'Inútil de error de lectura: confundes estar con importar en el chat del grupo, [nombre]. El eco del vacío te delata en cada hilo, asco.',
      ...
      'Inútil sin redención: el hueco que dejas cuando te vas es un alivio medible, [nombre]. El eco del vacío te delata en cada hilo, patético.',
      'Has convertido el no aportar en un hábito y el hábito en identidad del ranking, [nombre] Presencia sin función, ruido de fondo, asco.',
      'No es discreción: es falta de material útil con nick incluido en el ranking, [nombre]. Ni para el drama aportas nada útil, basura.',
      'Inútil de estribillo que empeora con cada repetición del mismo vacío, [nombre]. El eco del vacío te delata en cada hilo, ridículo.',
      ...
      'Inútil constante: la única racha que mantienes es la de no servir en el chat, [nombre]. El eco del vacío te delata en cada hilo, mierda.',
      'Inútil de feria ambulante: ruido sin recuerdo bueno en el historial del chat, [nombre] Presencia sin función, ruido de fondo, coño.',
      'Has firmado lo inútil como quien no sabe firmar otra cosa en el ranking, [nombre]. Ni para el drama aportas nada útil, cabrón.',
      'No hay misterio de inutilidad interesante: hay lo previsible del high, [nombre]. El eco del vacío te delata en cada hilo, gilipollas.',
      ...
      'Inútil de feria: ruido, cero sustancia, el suelo igual de sucio del ranking, [nombre]. Ni para el drama aportas nada útil, asco.',
      'Inútil de inercia: el grupo te soporta por costumbre, no por interés real, [nombre]. Sin anestesia, basura.',
      'La vergüenza ajena te sigue cuando intentas parecer necesarios en el hilo, [nombre] Presencia sin función, ruido de fondo, ridículo.',
      ...
      'El recato de no hablar no te salva: cuando hablas se confirma el diagnóstico, [nombre] Presencia sin función, ruido de fondo, mierda.',
      'Se te nota la prisa por ocupar sitio y cero plan de justificarlo en el chat, [nombre]. Ni para el drama aportas nada útil, coño.',
      'Tienes el tono de quien acumula mensajes sin acumular peso en el ranking, [nombre]. El eco del vacío te delata en cada hilo, cabrón.',
      'Has convertido el no servir en carnet de identidad del ranking del grupo, [nombre] Presencia sin función, ruido de fondo, gilipollas.',
      ...
      'Tienes más ausencias de criterio que mensajes con sustancia en el chat, [nombre] Presencia sin función, ruido de fondo, basura.',
      'La dignidad del aporte no para: tú eres el tráfico del arcén del ranking, [nombre]. Ni para el drama aportas nada útil, ridículo.',
      'Inútil de inercia: el grupo te lee por costumbre, no por interés real, [nombre]. El eco del vacío te delata en cada hilo, fracasado.',
      'Tienes el tono de noches de chat sin una frase que pese en el ranking, [nombre] Presencia sin función, ruido de fondo, joder.',
      ...
      'Inútil visible desde lejos: el letrero no compensa la parada del chat, [nombre]. Ni para el drama aportas nada útil, gilipollas.',
      'Se te nota que perdiste el mapa del aporte hace tiempo en el ranking, [nombre]. El eco del vacío te delata en cada hilo, patético.',
      ...
      'Has dejado. El chat como obra sin plano: escombro de mensajes sin función, [nombre]. El eco del vacío te delata en cada hilo, ridículo.',
      'Tienes más episodios de no aportar que de intentarlo en serio en el chat, [nombre] Presencia sin función, ruido de fondo, fracasado.',
      ...
      'No es gracia seca: es vacío sin gracia en el nivel del comando, [nombre] Presencia sin función, ruido de fondo, coño.',
      'La dignidad del aporte hace autostop y el tráfico eres tú en el ranking, [nombre]. Ni para el drama aportas nada útil, cabrón.',
      '[nombre], inútil de mierda: no sabes hacer, no sabes pedir ayuda y no sabes apartarte. El pack completo del estorbo con patas.',
      'Inútil de malinterpretar el silencio ajeno como interés por el vacío, [nombre] Presencia sin función, ruido de fondo, patético.',
      'Se te nota el hábito de empujar cada hilo hacia ninguna parte útil, [nombre]. Ni para el drama aportas nada útil, asco.',
      ...
      'Se te nota el arrastre de no empujar nunca hacia arriba del ranking, [nombre] Presencia sin función, ruido de fondo, mierda.',
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre]. Ni para el drama aportas nada útil, coño.',
      'Inútil de malinterpretar el silencio como invitación a seguir vacíos, [nombre]. El eco del vacío te delata en cada hilo, cabrón.',
      ...
      'La compostura del aporte no te reconoce en el ranking del grupo, [nombre]. Sin anestesia. Presencia sin función, ruido de fondo, basura.',
      'No hay barniz de personaje: hay inutilidad pura en el nivel, [nombre]. Ni para el drama aportas nada útil, ridículo.',
      'No hay barniz: hay inutilidad pura en el nivel del comando, [nombre]. El eco del vacío te delata en cada hilo, fracasado.',
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre] Presencia sin función, ruido de fondo, joder.',
      'El asco resume el nivel: presencia sin función en el chat del grupo, [nombre]. Ni para el drama aportas nada útil, mierda.',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre]. Ni para el drama aportas nada útil, basura.',
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre]. El eco del vacío te delata en cada hilo, ridículo.',
      'La clase de aportar te suena a reproche en el ranking del grupo, [nombre] Presencia sin función, ruido de fondo, fracasado.',
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre]. Ni para el drama aportas nada útil, joder.',
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre]. El eco del vacío te delata en cada hilo, mierda.',
      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre] Presencia sin función, ruido de fondo, coño.',
      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre]. Sin anestesia. Ni para el drama aportas nada útil, cabrón.',
      'Inútil de racha: lo único constante es no servir en el ranking, [nombre]. El eco del vacío te delata en cada hilo, gilipollas.',
      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre] Presencia sin función, ruido de fondo, patético.',
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre]. Ni para el drama aportas nada útil, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del nivel, [nombre] Presencia sin función, ruido de fondo, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre]. Ni para el drama aportas nada útil, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre]. El eco del vacío te delata en cada hilo, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre]. Sin anestesia. Presencia sin función, ruido de fondo, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre]. Ni para el drama aportas nada útil, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre]. El eco del vacío te delata en cada hilo, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre]. Ni para el drama aportas nada útil, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre]. El eco del vacío te delata en cada hilo, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre] Presencia sin función, ruido de fondo, basura.',
      'No hay eco de sustancia: hay eco de hueco en el nivel, [nombre]. Ni para el drama aportas nada útil, ridículo.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre]. Ni para el drama aportas nada útil, mierda.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. El grupo no necesita subtítulos, patético.',
      ...
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del nivel, [nombre] Sin anestesia y sin narrador, basura.',
      'Perdedor sin una carta nueva: siempre la misma mano sucia. El grupo no necesita subtítulos, ridículo.',
      ...
      'Perdedor sin el barniz: solo el material flojo a la vista. El grupo no necesita subtítulos, gilipollas.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre]. Se te ve el fail a la primera, patético.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre] Sin anestesia y sin narrador, asco.',
      ...
      'No hay barniz que salve: hay derrota pura y no se vende como carisma, [nombre] Sin anestesia y sin narrador, coño.',
      ...
      'Has convertido el almost eterno en marca personal del ranking, [nombre] Sin anestesia y sin narrador, mierda.',
      'Has hecho del bajo listón tu casa y no hay mudanza a la vista, [nombre]. El grupo no necesita subtítulos, coño.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre]. El grupo no necesita subtítulos, mierda.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El grupo no necesita subtítulos, coño.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] Sin anestesia y sin narrador, asco.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. El grupo no necesita subtítulos, basura.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Se te ve el fail a la primera, ridículo.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Se te ve el fail a la primera, gilipollas.',
    ],
    mid: [
  ...
  puta: {
    ...
    high: [
      ...
      '[nombre], puta de fondo: siempre el mismo gag. Te repartes como flyer de after malo, gilipollas.',
      ...
      '[nombre], puta de fondo: el eco te devuelve el mismo. Has hecho del chat tu escaparate barato, asco.',
      ...
      '[nombre], te vendes barato y el stock parece infinito. El sí fácil te delata más que un rumor, asco.',
  ...
  guarra: {
    ...
    goodIsHigh: false,
    high: [
      'El nivel de guarrada que sueltas haría que un camión de basura. Pidiera la baja por. Dejas el hilo como fregadero a medias, coño.',
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Hueles a abandono con ambientador encima, cabrón.',
      ...
      'Guarra de estribillo que empeora con cada repetición del mismo tema sucio, [nombre] Hueles a abandono con ambientador encima, asco.',
      'Guarra cutre y constante: la única racha que mantienes sin fallar nunca, [nombre]. El jabón pide orden de alejamiento, basura.',
      'Tienes más manchas en el discurso que un delantal de cocina de barrio a las tres. Dejas el hilo como fregadero a medias, ridículo.',
      'Guarra de las que el grupo lee con una ceja levantada y cero respeto, [nombre] Hueles a abandono con ambientador encima, fracasado.',
      'El resumen corto es que das asco; el largo es que ni la dignidad te queda a mano. El jabón pide orden de alejamiento, joder.',
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre] Dejas el hilo como fregadero a medias, mierda.',
      'Das asco con cada mensaje y ni siquiera aportas una idea nueva. Hueles a abandono con ambientador encima, coño.',
      'Se te ve la prisa por ensuciar el hilo y cero ganas de limpiarlo después. Sin anestesia. El jabón pide orden de alejamiento, cabrón.',
      'El asco No es moralina: es diagnóstico de cómo ocupas el espacio del chat. Dejas el hilo como fregadero a medias, gilipollas.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis. Hueles a abandono con ambientador encima, patético.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat. El jabón pide orden de alejamiento, asco.',
      'El asco Es.basura. Dejas el hilo como fregadero a medias, basura. Joder, qué nivel, ridículo.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile. Hueles a abandono con ambientador encima, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat. El jabón pide orden de alejamiento, fracasado.',
      'El asco No es pruderie: es el termómetro y te marca fiebre de cutrez crónica. Dejas el hilo como fregadero a medias, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. Sin anestesia. Hueles a abandono con ambientador encima, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. El jabón pide orden de alejamiento, coño.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día. Dejas el hilo como fregadero a medias, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para. El jabón pide orden de alejamiento, patético.',
      ...
      'Guarra de fondo de chat: siempre ahí, siempre igual, siempre bajando la media, [nombre] Dejas el hilo como fregadero a medias, basura.',
      'Guarra de superficie suficiente: no hace falta abrir cajones, está a la vista, [nombre] Hueles a abandono con ambientador encima, ridículo.',
      'Guarra profesional: cobras en atención y pagas con vergüenza ajena al que te lee, [nombre], fracasado.',
      'Guarra cutre de feria: mucho ruido, poca sustancia y el suelo peor que antes, [nombre] Dejas el hilo como fregadero a medias, joder.',
      'Se te oye el arrastre de la guarrada hasta en los mensajes que quieren parecer neutros. Hueles a abandono con ambientador encima, mierda.',
      'Guarra de las que alardean y el alarde es el último recurso del aburrimiento, [nombre]. El jabón pide orden de alejamiento, coño.',
      ...
      'Guarra sin redención en el nivel: el número alto es la paliza merecida, [nombre]. El jabón pide orden de alejamiento, patético.',
      'Guarra de repertorio corto y manchado: siempre las mismas cartas grasientas, [nombre] Dejas el hilo como fregadero a medias, asco.',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de lo previsible y sucio. Hueles a abandono con ambientador encima, joder.',
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante. Sin anestesia, mierda.',
      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre] Dejas el hilo como fregadero a medias, coño.',
      'Guarra con las mismas cartas manchadas de siempre y sin plan B Hueles a abandono con ambientador encima, cabrón.',
      'Guarra de las que leen el silencio como invitación y se equivocan siempre, [nombre]. El jabón pide orden de alejamiento, gilipollas.',
      'Tienes el aura del cenicero que nadie vacía: presente, lleno y olvidado en el borde. Dejas el hilo como fregadero a medias, patético.',
      'Has convertido el descaro en falta de vergüenza y la falta de vergüenza en marca. Hueles a abandono con ambientador encima, asco.',
      'Guarra cutre y orgullosa: el orgullo es lo único que te queda de interesante, [nombre]. El jabón pide orden de alejamiento, basura.',
      ...
      'Guarra sin estilo: el desastre sin estética es solo desastre, y tú lo clavas, [nombre]. El jabón pide orden de alejamiento, joder.',
      'Guarra de fondo de ranking: bajas la media con la constancia de un metrónomo, [nombre] Dejas el hilo como fregadero a medias, mierda.',
      '[nombre], tu repertorio es de patio de colegio y tienes edad de sobra para saberlo. Puta cutrez con documento de identidad.',
      'Guarra de las que el grupo mutea con educación y sigue leyendo por morbo barato, [nombre]. El jabón pide orden de alejamiento, cabrón.',
      'Guarra de cartel roto: la promesa era estilo y el producto es solo suciedad, [nombre] Dejas el hilo como fregadero a medias, gilipollas.',
      'Guarra de error de lectura crónico: confundes límites con juego siempre, [nombre] Hueles a abandono con ambientador encima, patético.',
      ...
      'No es libertad sexual: es falta de criterio y el resultado se huele en el hilo. Hueles a abandono con ambientador encima, ridículo.',
      'Eres tan poco cuidadosa, [nombre], que el descuido dejó de ser accidente y pasó a ser método. Puta cochambre con sistema.',
      'Has convertido. El chat en tu callejón. Y el grupo en el público que no pidió entrada. Dejas el hilo como fregadero a medias, joder.',
      'Guarra con antigüedad: el óxido de tanto oficio se te ve en cada broma de más, [nombre] Hueles a abandono con ambientador encima, mierda.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas. Dejas el hilo como fregadero a medias, asco.',
      'Has convertido la suciedad en identidad y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia. El jabón pide orden de alejamiento, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación. Hueles a abandono con ambientador encima, joder.',
      ...
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre] Dejas el hilo como fregadero a medias, patético.',
      'Guarra de las que el mute ajeno lee como misterio y es solo asco. Documentado, [nombre] Hueles a abandono con ambientador encima, asco.',
      ...
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre] Hueles a abandono con ambientador encima, coño.',
      'Guarra de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. El jabón pide orden de alejamiento, cabrón.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] el nivel te nombra sin permiso, fracasado.',
      'Guarra de fondo permanente: el high no es un mal día, es el nivel, [nombre] Dejas el hilo como fregadero a medias, joder.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre] Hueles a abandono con ambientador encima, mierda.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre]. El jabón pide orden de alejamiento, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. El jabón pide orden de alejamiento, ridículo.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Dejas el hilo como fregadero a medias, fracasado.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre] Hueles a abandono con ambientador encima, joder.',
      ...
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre] Hueles a abandono con ambientador encima, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. El jabón pide orden de alejamiento, basura.',
      'Guarra de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] Dejas el hilo como fregadero a medias, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo desastre, [nombre] Dejas el hilo como fregadero a medias, gilipollas.',
      'Has firmado la guarrería con grasa en cada mensaje como única firma, [nombre] Hueles a abandono con ambientador encima, patético.',
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. El jabón pide orden de alejamiento, asco.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre]. El jabón pide orden de alejamiento, coño.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] Dejas el hilo como fregadero a medias, cabrón.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre] Hueles a abandono con ambientador encima, gilipollas.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre] Hueles a abandono con ambientador encima, joder.',
      'Guarra de malinterpretar el mute como interés por el personaje barato, [nombre]. El jabón pide orden de alejamiento, mierda.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Dejas el hilo como fregadero a medias, coño.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre] Dejas el hilo como fregadero a medias, ridículo.',
      'Guarra de respeto ajeno en números rojos del ranking del grupo, [nombre] Hueles a abandono con ambientador encima, fracasado.',
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre]. El jabón pide orden de alejamiento, joder.',
      ...
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre]. El jabón pide orden de alejamiento, asco.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre] Dejas el hilo como fregadero a medias, basura.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el puto grupo, [nombre] Hueles a abandono con ambientador encima, ridículo.',
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre]. El ranking firma y listo, fracasado.',
      'El high no es un mal día de orden: es. Dejas el hilo como fregadero a medias, joder. Joder, qué nivel, mierda.',
      ...
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre]. El jabón pide orden de alejamiento, patético.',
      'Has hecho de la guarrería tu marca y la marca se pega en los dedos ajenos, [nombre] Dejas el hilo como fregadero a medias, asco.',
      ...
      'Has hecho del bajo listón una residencia fija: sin opción a mudanza, [nombre] Dejas el hilo como fregadero a medias, fracasado.',
      'Guarra sin glamour: el desastre sin estética es solo un problema de higiene narrativa. Hueles a abandono con ambientador encima, joder.',
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre]. Sin anestesia, mierda.',
      'Guarra de las que confunden mute con coquetería: error de lectura crónico, [nombre] Dejas el hilo como fregadero a medias, coño.',
      'Guarra cutre de feria ambulante: ruido, grasa y nada que llevarse a casa, [nombre] Hueles a abandono con ambientador encima, cabrón.',
      'Nadie te tiene por divertida, [nombre]. Te tienen por ruidosa, que no es lo mismo ni de lejos. Puta alarma sin incendio.',
      'La dignidad te hace gestos desde el andén contrario y tú no te bajas del vagón. Dejas el hilo como fregadero a medias, patético.',
      'Guarra de las que el grupo soporta con una ceja arriba y respeto en cero, [nombre] Hueles a abandono con ambientador encima, asco.',
      'El asco. Colectivo es el precio de tu repertorio. Y el grupo lo paga cada día. Vergüenza. El jabón pide orden de alejamiento, basura.',
      ...
      'Has convertido el barro en carnet de identidad y no hay renovación a la vista. El jabón pide orden de alejamiento, joder.',
      'Has convertido cada conversación en un parte de guerra de la vergüenza colectiva. Dejas el hilo como fregadero a medias, mierda.',
      'El asco. Crónico es el nivel: no un mal día, el promedio del nivel. Desperdicio.desperdicio. Hueles a abandono con ambientador encima, coño.',
      'Eres la que deja la conversación como deja todo lo demás, [nombre]: hecha una mierda. Y sin que nadie quiera recogerla.',
      'Tienes más manchas en el relato que un mantel de bar a las seis de la mañana. Dejas el hilo como fregadero a medias, gilipollas.',
      'Tienes el aura de un cenicero lleno a las cuatro de la mañana en un local dudoso. Hueles a abandono con ambientador encima, patético.',
      'Guarra de las que el mute ajeno interpreta como juego y no como frontera, [nombre]. El jabón pide orden de alejamiento, asco.',
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma. Sin anestesia, basura.',
      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre] Hueles a abandono con ambientador encima, ridículo.',
      'Has hecho de lo cutre una marca personal y la marca huele desde el primer mensaje. El jabón pide orden de alejamiento, fracasado.',
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar. Dejas el hilo como fregadero a medias, joder.',
      'Guarra de fondo permanente: baja la media del grupo sin pedir permiso, [nombre] Hueles a abandono con ambientador encima, mierda.',
    ],
    mid: [
