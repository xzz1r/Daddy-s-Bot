...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre] No hay segunda lectura útil, sin filtro ni consuelo, joder.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre] El material habla solo, diagnóstico cerrado, mierda.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua, coño.',
      'Has hecho del bajo listón social tu residencia y no hay mudanza, [nombre] El ranking firma y listo, el bot no regala décimas, cabrón.',
      'Incel de las que el mute ajeno lee como rechazo y es solo desinterés, [nombre] Se ve desde el primer mensaje, archivo sin apelación, gilipollas.',
      ...
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre] No hay segunda lectura útil, el veredicto es ese, ridículo.',
      ...
      'Incel de ceja ajena levantada y respeto social en el sótano, [nombre] El grupo no necesita subtítulos, y el ranking no miente, mierda.',
      ...
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre] No hay segunda lectura útil, nivel sótano puro, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre] El material habla solo, sin filtro ni consuelo, patético.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado, asco.',
      'Incel de letrero de sótano: se lee y no invita a bajar, [nombre] El ranking firma y listo, y se te nota a la legua, basura.',
      'No hay misterio de amargura con estilo: hay lo previsible y el high lo nombra, [nombre] Se ve desde el primer mensaje, el bot no regala décimas, ridículo.',
      'Tienes el historial de un servidor vacío: roles de odio, cero gente, [nombre] El grupo no necesita subtítulos, archivo sin apelación, fracasado.',
      'Incel de malinterpretar el silencio ajeno como prueba de conspiración, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena, joder.',
      ...
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] No hay segunda lectura útil, sin maquillaje posible, coño.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre] El material habla solo, el veredicto es ese, cabrón.',
      ...
      'Se te nota que te encerraste en el hilo hace tiempo y perdiste la llave, [nombre] Eso no se maquilla con ángulo, y el ranking no miente, asco.',
      ...
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre] No hay segunda lectura útil, el chat ya lo sabía, ridículo.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre] El material habla solo, nivel sótano puro, fracasado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en. El ranking, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo, joder.',
      ...
      'Has hecho ranking de desconexión y el oro es tuyo sin rival, [nombre] El grupo no necesita subtítulos, el bot no regala décimas, cabrón.',
      'Incel de feria ambulante de un solo puesto: el mismo show, cero nostalgia ajena, [nombre]. Fracasado.',
      'Se te ve venir el monólogo en el primer punto del mensaje, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena, patético.',
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre] No hay segunda lectura útil, con el grupo de testigo, asco.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre] El material habla solo, sin maquillaje posible, basura.',
      'No hay barniz de antihéroe nerd: hay amargura y el high la nombra, [nombre] Aquí no hay modo avión que salve, el veredicto es ese, ridículo.',
      ...
      'Has convertido el incel en carnet y no hay renovación de salida a la vista, [nombre] El tramo te nombra sin permiso, y el ranking no miente, mierda.',
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre] El material habla solo, el chat ya lo sabía, cabrón.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre] Aquí no hay modo avión que salve, nivel sótano puro, gilipollas.',
      ...
      'Tu mensaje es un aviso de lo que no hay que alimentar en el grupo, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas, ridículo.',
      'Incel con la disciplina de quien nunca ha aceptado el espejo, [nombre] El tramo te nombra sin permiso, archivo sin apelación, fracasado.',
      'El high no es un mal día de humor: es. El veredicto y te nombra, [nombre] No hay segunda lectura útil, pura vergüenza ajena, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre] El material habla solo, con el grupo de testigo, mierda.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible, coño.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] El ranking firma y listo, el veredicto es ese, cabrón.',
  ...
  fea: {
    ...
    high: [
      ...
      'Fea de las que bajan el promedio visual del grupo solo con aparecer, [nombre] Eso no se maquilla con ángulo, y el ranking no miente, asco.',
      'Tu cara es un argumento contra la simetría y. El ranking lo firma sin dudar, [nombre] El tramo te nombra sin permiso, sin anestesia, basura.',
      'Fea cutre: ni el caos tiene estilo ni el desastre tiene misterio de antihéroe, [nombre] No hay segunda lectura útil, el chat ya lo sabía, ridículo.',
      'Se te ve venir la fealdad en la primera miniatura del mensaje de estado, [nombre] El material habla solo, nivel sótano puro, fracasado.',
      'Fea de historial público: no hace falta zoom, se lee en la superficie del chat, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo, joder.',
      'El listón de lo presentable lo miras desde el sótano y no has subido un peldaño, [nombre], diagnóstico cerrado, mierda.',
      ...
      'Tienes más ángulos malos que un piso de alquiler en reforma eterna, [nombre] El grupo no necesita subtítulos, el bot no regala décimas, cabrón.',
      ...
      'Fea constante: la única racha que mantienes es la de no mejorar el frame, [nombre] No hay segunda lectura útil, con el grupo de testigo, asco.',
      'Se te nota la prisa por tapar y cero plan de arreglar lo que se ve de lejos, [nombre] El material habla solo, sin maquillaje posible, basura.',
      'Fea de cartel de aviso: se lee de lejos y nadie quiere acercarse al producto, [nombre] Aquí no hay modo avión que salve, el veredicto es ese, ridículo.',
      ...
      'Fea de ceja ajena levantada y respeto visual en el sótano del ranking, [nombre] El tramo te nombra sin permiso, y el ranking no miente, mierda.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, sin anestesia, coño.',
      'Has convertido la fealdad en carnet y no hay detergente narrativo a la vista, [nombre] El material habla solo, el chat ya lo sabía, cabrón.',
      'Fea cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, nivel sótano puro, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] El ranking firma y listo, sin filtro ni consuelo, patético.',
      'La dignidad facial no te coge el teléfono: el buzón está lleno de avisos, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado, asco.',
      'Fea de letrero grasiento: se lee de lejos y no invita a entrar al frame, [nombre] El grupo no necesita subtítulos, y se te nota a la legua, basura.',
      'No hay misterio de fealdad con estilo: hay lo previsible y el high lo nombra, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas, ridículo.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] El tramo te nombra sin permiso, archivo sin apelación, fracasado.',
      'Fea de malinterpretar el silencio ajeno como respeto al underdog visual, [nombre] No hay segunda lectura útil, pura vergüenza ajena, joder.',
      'El grupo paga tu rastro facial en cuotas diarias de hastío documentado, [nombre] El material habla solo, con el grupo de testigo, mierda.',
      'Has dejado. El chat como vestuario de derrota visual: restos de almost eternos, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible, coño.',
      'Fea de estribillo sin punto final limpio ni redención posible en. El ranking, [nombre] El ranking firma y listo, el veredicto es ese, cabrón.',
      ...
      'La clase te suena a ataque y respondes con más del mismo plato de fail, [nombre] No hay segunda lectura útil, y el ranking no miente, asco.',
      'Fea de racha perfecta: lo único que no fallas es fallar el frame, [nombre] El material habla solo, sin anestesia, basura.',
      'No hay eco de estilo: hay eco de fealdad. Y el chat lo amplifica de más, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía, ridículo.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de almost, [nombre] El ranking firma y listo, nivel sótano puro, fracasado.',
      'Fea de error de lectura: confundes límites con permiso para seguir igual, [nombre] Se ve desde el primer mensaje, sin filtro ni consuelo, joder.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado, mierda.',
      'Has hecho ranking de fealdad y el oro es tuyo sin rival serio, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua, coño.',
      ...
      'Se te ve venir el almost visual en el primer punto del mensaje del hilo, [nombre] No hay segunda lectura útil, archivo sin apelación, gilipollas.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre] El material habla solo, pura vergüenza ajena, patético.',
      'Fea de superficie: basta la vista, no hace falta el sótano del historial, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo, asco.',
      'No hay barniz de antihéroe: hay fealdad y el high la cobra sin descuento, [nombre] El ranking firma y listo, sin maquillaje posible, basura.',
      'Tienes el tono de noches de chat sin una foto que se sostenga sola, [nombre] Se ve desde el primer mensaje, el veredicto es ese, ridículo.',
      ...
      'Tu cara es un argumento contra la genética y. El ranking no admite recurso, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'Se te cae el frame solo con abrir la cámara y el high lo documenta sin piedad, [nombre] Se ve desde el primer mensaje, nivel sótano puro, gilipollas.',
      'Fea de las que el algoritmo de embellecer se rinde y pide la baja, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo, patético.',
      'No hay filtro que te salve: hay fealdad de base y el comando la cobra cara, [nombre] Eso no se maquilla con ángulo, diagnóstico cerrado, asco.',
      ...
      'Fea con la disciplina de quien nunca se ha mirado de verdad al espejo, [nombre] No hay segunda lectura útil, el bot no regala décimas, ridículo.',
      'El high no es un mal día de luz: es. El veredicto del tramo y te nombra, [nombre] El material habla solo, archivo sin apelación, fracasado.',
      'Tienes una presencia visual que baja el promedio del grupo en un mensaje, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena, joder.',
      'Fea de repertorio: siempre la misma cara de almost y cero plan B facial, [nombre] El ranking firma y listo, con el grupo de testigo, mierda.',
      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre] Se ve desde el primer mensaje, sin maquillaje posible, coño.',
      'Fea sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre] El grupo no necesita subtítulos, el veredicto es ese, cabrón.',
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre]. El veredicto Aquí no hay modo avión que salve, y el ranking no miente, asco.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre]. El veredicto El ranking firma y listo, sin anestesia, basura.',
      ...
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. El veredicto, y se te nota a la legua, basura.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre]. El veredicto asco.',
      ...
      'Maricón de ranking: bajas la media del tramo con constancia molesta, [nombre]. El veredicto, y el ranking no miente, asco.',
      'No es atrevimiento: es suciedad de personaje y el tramo te la cobra, [nombre]. El veredicto, sin anestesia, basura.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. El veredicto, el chat ya lo sabía, ridículo.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]. El veredicto, nivel sótano puro, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre]. El veredicto, sin filtro ni consuelo, joder.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. El veredicto, diagnóstico cerrado, mierda.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. El veredicto, y se te nota a la legua, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre]. El veredicto del high no suaviza nada, coño.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre]. El veredicto Se ve desde el primer mensaje, archivo sin apelación, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre]. El veredicto El grupo no necesita subtítulos, pura vergüenza ajena, patético.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre]. El veredicto Eso no se maquilla con ángulo, con el grupo de testigo, asco.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre]. El veredicto, sin maquillaje posible, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. El veredicto, el veredicto es ese, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. El veredicto El grupo no necesita subtítulos, y el ranking no miente, mierda.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre]. El veredicto Aquí no hay modo avión que salve, nivel sótano puro, gilipollas.',
  ...
  simp: {
    ...
    high: [
      ...
      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre] El material habla solo, sin anestesia, basura.',
      ...
      'Tienes más episodios de simp documentados que intentos de tener criterio, [nombre] El tramo te nombra sin permiso, el bot no regala décimas, cabrón.',
      'Simp cutre: ni la entrega tiene gracia ni la falta de dignidad tiene misterio, [nombre] No hay segunda lectura útil, archivo sin apelación, gilipollas.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre] El material habla solo, pura vergüenza ajena, patético.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo, asco.',
      ...
      'Simp constante: la única racha es la de no decir no cuando toca, [nombre] Se ve desde el primer mensaje, el veredicto es ese, ridículo.',
      ...
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre] El material habla solo, y el ranking no miente, mierda.',
      'Tienes más grasa de validación ajena que un foro de fans sin moderación, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de síes ajenos, [nombre] No hay segunda lectura útil, el bot no regala décimas, ridículo.',
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre] El material habla solo, archivo sin apelación, fracasado.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena, joder.',
      ...
      'El grupo paga tu monólogo de validación en cuotas diarias de scroll, [nombre] El grupo no necesita subtítulos, el veredicto es ese, cabrón.',
      ...
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre] Aquí no hay modo avión que salve, y el ranking no miente, asco.',
      ...
      'Tienes el aura del post olvidado: presente en el archivo, frío en. El ranking, [nombre] No hay segunda lectura útil, y se te nota a la legua, coño.',
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre], el bot no regala décimas, cabrón.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre] Aquí no hay modo avión que salve, archivo sin apelación, gilipollas.',
      'Has hecho ranking de simp y el oro es tuyo sin rival serio, [nombre] El ranking firma y listo, pura vergüenza ajena, patético.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] Eso no se maquilla con ángulo, el veredicto es ese, ridículo.',
      ...
      'Simp de respeto ajeno en números rojos del ranking de dignidad, [nombre] El ranking firma y listo, y el ranking no miente, mierda.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] No hay segunda lectura útil, diagnóstico cerrado, asco.',
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre] El material habla solo, y se te nota a la legua, basura.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas, ridículo.',
      'Tu mensaje es un aviso de lo que no hay que imitar en el grupo, [nombre] El ranking firma y listo, archivo sin apelación, fracasado.',
      'Simp con la disciplina de quien nunca ha dicho no cuando tocaba, [nombre] Se ve desde el primer mensaje, pura vergüenza ajena, joder.',
      'El high no es un mal día de carácter: es. El veredicto y te nombra, [nombre] El grupo no necesita subtítulos, con el grupo de testigo, mierda.',
      ...
      'Simp de repertorio: siempre la misma validación y cero plan B de dignidad, [nombre] El tramo te nombra sin permiso, el veredicto es ese, cabrón.',
  ...
  rata: {
    ...
    high: [
      ...
      'Has hecho del aprovechamiento un deporte y vas líder de la clasificación cutre, [nombre] Se ve desde el primer mensaje, y el ranking no miente, asco.',
      ...
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre] No hay segunda lectura útil, sin filtro ni consuelo, joder.',
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre] El material habla solo, diagnóstico cerrado, mierda.',
      'Has convertido. El chat en tu despensa y al resto en inventario de provecho, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua, coño.',
      ...
      'Rata constante: la única disciplina es no soltar lo que no es tuyo, [nombre] Se ve desde el primer mensaje, archivo sin apelación, gilipollas.',
      'Se te nota la prisa por agarrar y la ausencia total de plan de devolver, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena, patético.',
      ...
      'Has convertido lo rata en marca personal y la marca se pega en los dedos, [nombre] No hay segunda lectura útil, el veredicto es ese, ridículo.',
      ...
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] El grupo no necesita subtítulos, y el ranking no miente, mierda.',
      ...
      'Rata de estribillo sin punto final limpio ni redención posible, [nombre] No hay segunda lectura útil, nivel sótano puro, gilipollas.',
      'La compostura cruza de acera cuando te ve en. El ranking del high, [nombre] El material habla solo, sin filtro ni consuelo, patético.',
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado, asco.',
      'La dignidad no para el coche: tú eres el tráfico del arcén, [nombre] El ranking firma y listo, y se te nota a la legua, basura.',
      'Rata de superficie suficiente: no hace falta abrir el cubo, huele, [nombre] Se ve desde el primer mensaje, el bot no regala décimas, ridículo.',
      'No hay barniz: hay ratez pura y no se vende como carisma, [nombre] El grupo no necesita subtítulos, archivo sin apelación, fracasado.',
      'Rata de las que alardean del aprovecho porque callar las deja sin personaje, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena, joder.',
      ...
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre] No hay segunda lectura útil, sin maquillaje posible, coño.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre] El material habla solo, el veredicto es ese, cabrón.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre] Eso no se maquilla con ángulo, y el ranking no miente, asco.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre] No hay segunda lectura útil, el chat ya lo sabía, ridículo.',
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre] El material habla solo, nivel sótano puro, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo, joder.',
      ...
      'Tienes más manchas de interés ajeno que intentos de pasar un trapo, [nombre] El grupo no necesita subtítulos, el bot no regala décimas, cabrón.',
      'Rata de respeto ajeno en números rojos del ranking del grupo, [nombre] Eso no se maquilla con ángulo, archivo sin apelación, gilipollas.',
      'El promedio de ratez es el nivel: no un pico, el suelo del high, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena, patético.',
      'Has convertido la rata en carnet y no hay renovación limpia, [nombre] No hay segunda lectura útil, con el grupo de testigo, asco.',
      ...
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre] Aquí no hay modo avión que salve, el veredicto es ese, ridículo.',
      ...
      'Has hecho de la rata tu marca y la marca se pega en los dedos ajenos, [nombre] El tramo te nombra sin permiso, y el ranking no miente, mierda.',
      'Rata de las que confunden astucia con no tener vergüenza en. El ranking, [nombre] No hay segunda lectura útil, sin anestesia, coño.',
      'No es viveza con gracia: eres rata y el high no discute la evidencia, [nombre] El material habla solo, el chat ya lo sabía, cabrón.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo, asco.',
      ...
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, el bot no regala décimas, ridículo.',
      'No es profundidad: es aislamiento con teclado y el tramo te lo cobra, [nombre] El material habla solo, archivo sin apelación, fracasado.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena, joder.',
      ...
      'Has hecho del nicho una trinchera y la trinchera apesta a cerrado, [nombre] El grupo no necesita subtítulos, el veredicto es ese, cabrón.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre] No hay segunda lectura útil, sin anestesia, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre] Aquí no hay modo avión que salve, nivel sótano puro, gilipollas.',
      ...
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas, ridículo.',
      ...
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre] El material habla solo, con el grupo de testigo, mierda.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible, coño.',
      'Cerdo de cartel grasiento: se ve de lejos y nadie quiere acercarse, [nombre] El ranking firma y listo, el veredicto es ese, cabrón.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, y el ranking no miente, asco.',
      'Has convertido la porquería en carnet y no hay renovación limpia, [nombre] El material habla solo, sin anestesia, basura.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía, ridículo.',
      ...
      'Cerdo de malinterpretar el silencio como invitación a más suciedad, [nombre] El tramo te nombra sin permiso, el bot no regala décimas, cabrón.',
      'El grupo paga tu rastro en cuotas diarias de asco documentado, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre] El material habla solo, pura vergüenza ajena, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo, asco.',
      ...
      'La compostura cruza de acera cuando te ve en el high, [nombre] Se ve desde el primer mensaje, el veredicto es ese, ridículo.',
      ...
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre] El material habla solo, y el ranking no miente, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] No hay segunda lectura útil, el bot no regala décimas, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre] El material habla solo, archivo sin apelación, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena, joder.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre] El grupo no necesita subtítulos, el veredicto es ese, cabrón.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Aquí no hay modo avión que salve, y el ranking no miente, asco.',
      ...
      'El high no es un mal día de orden: es. El veredicto y te nombra, [nombre] El tramo te nombra sin permiso, diagnóstico cerrado, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] No hay segunda lectura útil, y se te nota a la legua, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre] El material habla solo, el bot no regala décimas, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Aquí no hay modo avión que salve, archivo sin apelación, gilipollas.',
      'Cerdo sin complejo útil: el complejo al menos indicaría que viste el desastre, [nombre] El ranking firma y listo, pura vergüenza ajena, patético.',
      ...
      'Cerdo de las que confunden natural con abandono total del estándar, [nombre] Eso no se maquilla con ángulo, el veredicto es ese, ridículo.',
  ...
  femboy: {
    ...
    high: [
      ...
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre] No hay segunda lectura útil, diagnóstico cerrado, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre] El material habla solo, y se te nota a la legua, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas, ridículo.',
      'Femboy de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre] El ranking firma y listo, archivo sin apelación, fracasado.',
      ...
      'Femboy de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre] El tramo te nombra sin permiso, el veredicto es ese, cabrón.',
      ...
      'Femboy de ceja ajena levantada y respeto en el sótano del ranking, [nombre] Se ve desde el primer mensaje, y el ranking no miente, asco.',
      ...
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] No hay segunda lectura útil, sin filtro ni consuelo, joder.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] El material habla solo, diagnóstico cerrado, mierda.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua, coño.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre] El ranking firma y listo, el bot no regala décimas, cabrón.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Se ve desde el primer mensaje, archivo sin apelación, gilipollas.',
      'Femboy de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena, patético.',
      ...
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre] No hay segunda lectura útil, el veredicto es ese, ridículo.',
  ...
  inutil: {
    ...
    high: [
      ...
      'Inútil de las que el mute ajeno interpreta como misterio y no como desinterés, [nombre] El tramo te nombra sin permiso, el veredicto es ese, cabrón.',
      ...
      'Inútil de los que ocupan sitio y no condicionan ni un hilo del chat, [nombre] Se ve desde el primer mensaje, y el ranking no miente, asco.',
      ...
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre] No hay segunda lectura útil, sin filtro ni consuelo, joder.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre] El material habla solo, diagnóstico cerrado, mierda.',
      'Inútil sin capa de carisma que disimule el agujero, joder, el chat ya lo archivó El ranking no miente, joder.',
      'Inútil de cartas en blanco: el mismo mazo vacío en cada mano, [nombre] El ranking firma y listo, el bot no regala décimas, cabrón.',
      'Has hecho de la inutilidad una presencia estable en. El chat, [nombre] Se ve desde el primer mensaje, archivo sin apelación, gilipollas.',
      'Inútil de racha perfecta: lo único que no fallas es no servir, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena, patético.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre] No hay segunda lectura útil, el veredicto es ese, ridículo.',
  ...
  perdedor: {
    ...
    high: [
      ...
      'Perdedor de los que el high del ranking no perdona ni un frame del historial, [nombre] No hay segunda lectura útil, y el ranking no miente, asco.',
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del tramo, [nombre] El material habla solo, sin anestesia, basura.',
      ...
      'Perdedor de estribillo que mancha más con cada repetición del mismo fail, [nombre] El tramo te nombra sin permiso, el bot no regala décimas, cabrón.',
      'Perdedor sin el barniz: solo el material flojo a la vista, joder, pura vergüenza ajena El ranking no miente, joder.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre] El material habla solo, pura vergüenza ajena, patético.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo, asco.',
      ...
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Se ve desde el primer mensaje, el veredicto es ese, ridículo.',
      ...
      'Has convertido el almost eterno en marca personal del ranking, [nombre] El material habla solo, y el ranking no miente, mierda.',
      'Has hecho del bajo listón tu casa y no hay mudanza a la vista, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'Perdedor cutre: ni el fallo tiene gracia ni la racha tiene misterio de antihéroe, [nombre], y el ranking no miente, mierda.',
  ...
  puta: {
    ...
    high: [
      ...
      'Has convertido el puterío en identidad y no hay detergente que la limpie, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua, coño.',
      ...
      'Se te oye el arrastre del personaje hasta en los neutros del chat, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo, asco.',
      ...
      'Has convertido el personajito en carnet y no hay renovación limpia, [nombre] El grupo no necesita subtítulos, y el ranking no miente, mierda.',
      'Puta de estribillo que mancha más con cada bis del mismo plato, [nombre] Eso no se maquilla con ángulo, sin anestesia.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre] El tramo te nombra sin permiso, el chat ya lo sabía, cabrón.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] No hay segunda lectura útil, nivel sótano puro, gilipollas.',
      'Puta de fondo permanente: el high no es un mal día, es el nivel, [nombre] El material habla solo, sin filtro ni consuelo.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado, asco.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] El grupo no necesita subtítulos, archivo sin apelación, fracasado.',
      ...
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] No hay segunda lectura útil, sin maquillaje posible, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre] El material habla solo, el veredicto es ese, cabrón.',
      ...
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre] No hay segunda lectura útil, el chat ya lo sabía, ridículo.',
      ...
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el bayeta, [nombre] El grupo no necesita subtítulos, el bot no regala décimas, cabrón.',
      'La clase te suena a ataque y respondes con más del mismo plato, [nombre] Eso no se maquilla con ángulo, archivo sin apelación, gilipollas.',
      ...
      'Tienes el aura del plato olvidado: presente, frío y con restos, [nombre] El material habla solo, sin maquillaje posible, basura.',
      ...
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre] El tramo te nombra sin permiso, y el ranking no miente, mierda.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre] No hay segunda lectura útil, sin anestesia, coño.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón, [nombre] El ranking firma y listo, sin filtro ni consuelo, patético.',
      'Puta de respeto ajeno en números rojos del ranking del grupo, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] El grupo no necesita subtítulos, y se te nota a la legua, basura.',
      ...
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre] No hay segunda lectura útil, pura vergüenza ajena, joder.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible, coño.',
  ...
  guarra: {
    ...
    high: [
      ...
      'Tienes más restos de suciedad en el discurso que un cubo sin recogida semanal, [nombre] El tramo te nombra sin permiso, el bot no regala décimas, cabrón.',
      'Guarra cutre: ni el caos tiene estilo ni el abandono tiene carisma de antihéroe, [nombre], archivo sin apelación, gilipollas.',
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre] El material habla solo, pura vergüenza ajena, patético.',
      ...
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre] El material habla solo, y el ranking no miente, mierda.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre] Aquí no hay modo avión que salve, sin anestesia, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] No hay segunda lectura útil, el bot no regala décimas, ridículo.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] El material habla solo, archivo sin apelación, fracasado.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena, joder.',
      ...
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Aquí no hay modo avión que salve, y el ranking no miente, asco.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre] No hay segunda lectura útil, y se te nota a la legua, coño.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] El material habla solo, el bot no regala décimas, cabrón.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre] Aquí no hay modo avión que salve, archivo sin apelación, gilipollas.',
      ...
      'Guarra de superficie: basta la vista, no hace falta el sótano, [nombre] Eso no se maquilla con ángulo, el veredicto es ese, ridículo.',
      ...
      'Has convertido la guarrería en identidad sin renovación limpia a la vista, [nombre] El ranking firma y listo, y el ranking no miente, mierda.',
      ...
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre] No hay segunda lectura útil, diagnóstico cerrado, asco.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre] El material habla solo, y se te nota a la legua, basura.',
      ...
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] El ranking firma y listo, archivo sin apelación, fracasado.',
      'El high no es un mal día de orden: es. El veredicto y te nombra, [nombre] Se ve desde el primer mensaje, pura vergüenza ajena, joder.',
      ...
      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre] El tramo te nombra sin permiso, el veredicto es ese, cabrón.',
