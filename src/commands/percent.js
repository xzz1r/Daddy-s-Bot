...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel como un anuncio repetido que nadie pidió. El grupo no necesita subtítulos, gilipollas, gilipollas.',
      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre Sin anestesia y sin narrador, asco, asco Joder, qué nivel, basura.',
  ...
  fea: {
    ...
    high: [
      ...
      'Fea de manual negro: sin misterio, sin estilo[nombre]. La cámara frontal merece hazard pay, cabrón, cabrón.',
      ...
      'cabrón,cabrón. El atractivo te bloqueó sin forwarding, cabrón, cabrón Joder, qué nivel, gilipollas, joder.',
      ...
      '[nombre], tu cara es un almost de humano decente. El atractivo te bloqueó sin forwarding, joder, joder.',
      ...
      'Tu simetría perdió el norte y el sur, [nombre]. El atractivo te bloqueó sin forwarding, cabrón, cabrón.',
      ...
      '[nombre], se te ve el techo y está por los suelos. La cámara frontal merece hazard pay, joder, joder.',
      ...
      '[nombre], tienes una geometría que ofende al compás. El atractivo te bloqueó sin forwarding, joder, joder.',
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón convertido en wallpaper del fail colectivo. El grupo ya tiene apuestas abiertas, asco, asco Joder, qué nivel, basura.',
      ...
      'El high no es un mal día de pose: es. Se te ve la pose en la primera palabra, ridículo, ridículo Joder, qué nivel, fracasado.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo Sin anestesia y sin narrador, asco, asco Joder, qué nivel, basura.',
  ...
  rata: {
    ...
    high: [
      ...
      'El high no es un mal día de ética: es Trepar sobre otros te queda de oficio, patético, patético Joder, qué nivel, asco.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki con el bucle eterno del mismo error en bucle Sin anestesia y sin narrador, gilipollas, gilipollas.',
  ...
  puta: {
    ...
    high: [
      ...
      'Te vendes en cuotas y nadie pidió el recibo, [nombre]. Te repartes como flyer de after malo, joder, joder.',
      ...
      'El puterío te queda de uniforme de diario, [nombre]. El sí fácil te delata más que un rumor, joder, joder.',
  ...
  guarra: {
    ...
    high: [
      ...
      'El asco Es.basura. Dejas el hilo como fregadero a medias, basura, basura Joder, qué nivel, ridículo.',
      ...
      'Guarra en modo sin filtro y el filtro pedía clemencia. El jabón pide orden de alejamiento, ridículo, ridículo.',
