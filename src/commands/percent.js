...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Virgen de mierda. Con la costumbre de dar lecciones, [nombre]. Empieza por hacer algo tú una sola vez y luego hablamos. Hasta entonces, cállate',
      ...
      '[nombre], incel de saldo: mucha frustración acumulada y ninguna intención de cambiar el método. Repites lo mismo y esperas otro resultado, da asco.',
      ...
      'Eres el que se cree fuera del sistema, [nombre]. Estás fuera porque no entraste nunca, gilipollas. Nadie te echó de ningún sitio, da asco.',
      ...
      'Incel sin misterio: solo amargura, foros y cero cita en el historial real, [nombre]. El espejo sigue esperando',
      ...
      'Incel puro con la frustración acumulada de una década y la iniciativa acumulada de cero minutos, [nombre]. Toda esa rabia y ni un solo intento real',
      ...
      'Virgen absoluto con la seguridad de un experto, [nombre]. Esa desconexión entre lo que crees saber y lo que has hecho es lo más, patético. De todo el asunto, da asco.',
      ...
      'Incel sin misterio: solo amargura, foros y cero cita en el historial real, [nombre]. Solo culpa hacia fuera',
      ...
      'Eres el pringado que se cree en una guerra que nadie más pelea, [nombre]. Solo estás tú ahí, gritándole al techo de tu cuarto. Da una pena tremenda, da asco.',
      ...
      'Incel como un anuncio repetido que nadie pidió. Cero autoexamen de verdad, gilipollas, y el grupo no se traga el cuento, qué vergüenza.',

      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético, ridículo.',

      'Incel en crudo: ni el maquillaje del ranking te cubre, asco. El espejo sigue esperando',
      ...
      '[nombre], perdiste una guerra en la que ni te inscribiste. El espejo sigue esperando',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu mismo sótano, [nombre]. Se te ve el fail a la primera',
      ...
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre]. Cero autoexamen de verdad, da asco.',
      ...
      'Incel de feria de odio: ruido interno, cero ganas de volver del resto, [nombre]. Cero autoexamen de verdad',

      'Se te ve venir la queja en la primera palabra del mensaje, [nombre]. Solo culpa hacia fuera',
      ...
      'Incel de feria ambulante de un solo puesto: el mismo show, cero nostalgia ajena, [nombre]. Fracasado, da asco.',

      'Se te ve venir el monólogo en el primer punto del mensaje, [nombre]. Solo culpa hacia fuera, patético.',

      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre]. El espejo sigue esperando',
      ...
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre]. Cero autoexamen de verdad',
      ...
      'Incel de las que el algoritmo de empatía se rinde y pide la baja, [nombre] cerrado. Solo culpa hacia fuera',
      ...
      'Has hecho del incel tu marca y la marca se pega en los dedos ajenos, [nombre]. El espejo sigue esperando',
    ...
    mid: [
      ...
      'Has tenido rachas y sequías con la misma frecuencia. La media queda exactamente aquí con la firma legible',
  ...
  linda: {
    ...
    mid: [
      ...
      'Coño, [nombre], no hay material para el debate de looks contigo. Hay material para cambiar de tema',
    ...
    low: [
      ...
      'Coño, [nombre], el problema no se esconde. Se exhibe en cada ángulo. Incluido el que elegiste tú',
      ...
      'Linda de las que el low del ranking te deja donde mereces: en el sótano visual, [nombre].',
      ...
      'Tienes más ángulos malos que un piso de alquiler en reforma, [nombre]. El veredicto, archivo',

      'Linda cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre].',
      ...
      'Se te nota la prisa por tapar y cero plan de arreglar lo que se ve, [nombre]. El veredicto. Y.',
      ...
      'Tienes el historial de un local cerrado por salubridad estética, [nombre].',
      ...
      'Linda de ranking: bajas la media visual del tramo con constancia, [nombre]',
      ...
      'No es mala suerte de luz: es patrón y el low te lo cobra, [nombre].',
      ...
      'Linda de letrero grasiento: se lee de lejos y no invita a entrar, [nombre].',
      ...
      'Linda de estribillo sin punto final limpio ni redención, [nombre].',

      'Se te nota el peso de arrastrar la misma cara por cada hilo, [nombre].',

      'La compostura cruza de acera cuando te ve en el low del comando, [nombre]',

      'Linda de feria: ruido de fail visual, suelo peor y cero ganas de volver, [nombre]. El veredicto coño.',

      'Se te ve venir la fealdad en la primera miniatura del estado, [nombre]',
      ...
      'Se te cae el frame solo con abrir la cámara y el low lo documenta, [nombre].',
      ...
      'Linda de repertorio: siempre la misma cara de almost y cero plan B, [nombre]. El veredicto, archivo',

      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre].',
      ...
      'No es luz mala: eres tú, y el low no discute con la evidencia, [nombre].',
      ...
      'Linda de ranking roto: el número bajo te nombra sin anestesia, [nombre]',

      'Se te ve el fail visual desde el otro lado del puto chat, [nombre]. El veredicto Aquí.',

      'Linda con más filtros que argumentos y aun así no cuela en el low, [nombre]. El veredicto, asco. Y.',
      ...
      'Linda de las que el modo retrato pide perdón por existir a tu lado, [nombre].',
      ...
      'Linda de almost documentado: autor tú, testigo el puto grupo, [nombre]',
      ...
      'Has convertido el almost visual en residencia fiscal del low, [nombre].',
      ...
      'Se te ve venir el fail visual en la primera miniatura del estado, [nombre]. El veredicto Aquí',
      ...
      'Linda de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto, archivo',
      ...
      'El low no es caridad: es veredicto y te nombra sin anestesia, [nombre].',

      'Linda de puto desastre: ni el ángulo ni la luz colaboran contigo, [nombre]. El veredicto. No hay segunda lectura útil, mierda.',

      'Tu presencia visual es un aviso de lo que no hay que reproducir, [nombre]',
      ...
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre].',

      'Linda con más pretensión que frame y el comando no se traga el cuento, [nombre]. El veredicto, basura.',

      'Tu selfie es el gag del tramo. Y el grupo no pide repetición, [nombre]',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto. El ranking firma y listo',
      ...
      'Se te cae el personaje visual en la primera foto del hilo, [nombre]. El veredicto Aquí, archivo',

      'Linda de las que necesitan tutorial de peinado y de dignidad facial, [nombre]. El veredicto fracasado, qué miseria.',

      'El low no regala décimas: el número habla y tú estás abajo, [nombre]. El veredicto. Se ve desde el primer mensaje, con el grupo de testigo',
  ...
  fea: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], tienes una cara que hace que el flash se arrepienta a mitad de disparo. El atractivo te bloqueó sin dejar visto, basura.',
      'Fea de las que el espejo pide indulto antes de reflejarte, [nombre]. Desgracia visual con ego de filtro gratis, patético.',
      '[nombre], no te faltan ángulos: te faltan los tres y el cuarto. Ni ring light inventa un punto focal decente, ridículo.',
      '[nombre], si la belleza fuera wifi, estarías en modo avión permanente. El grupo lo nota sin abrirte el perfil, qué asco.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis. El algoritmo prefiere un sticker a tu selfie, fracasado.',
      '[nombre], el modo retrato debería venir con advertencia sanitaria. Hazard pay para la cámara frontal, basura.',
      '[nombre], no hay misterio: hay huesos de mala suerte y piel que no perdona. El atractivo pasó de largo sin nota, cutre.',
      '[nombre], si te miran de frente es por educación, no por interés. Documentado en cada foto de grupo que te recorta, desperdicio visual.',
      'Fea de close-up, [nombre]: el zoom solo empeora el informe. Material de archivo, no de portada El tramo high solo certifica lo evidente, qué vergüenza.',
      '[nombre], tienes el tipo de cara que hace el ascensor más lento. Nadie quiere ese silencio a solas con tu reflejo, escoria con wifi.',
      '[nombre], el maquillaje en ti no es estilo: es diplomacia fallida. Capa tras capa y el parte de guerra sigue abierto, basura.',
      'Fea de las que el group selfie se recorta solo, [nombre]. Ridículo automático. El chat prefiere stickers a tu foto.',
      '[nombre], tienes una simetría de accidente industrial. El atractivo no es subjetivo cuando el material grita en 4K, ridículo.',
      '[nombre], tu cara pide soft focus permanente y el mundo te da resolución completa. Crueldad del hardware, no del grupo, qué asco.',
      'Fea clínica, [nombre]: ni el ángulo de tres cuartos te salva. El bot no opina; el material habla y te deja sin recurso, fracasado.',
      '[nombre], si la fealdad fuera un deporte, serías selección nacional. Medalla de plomo en cada selfie sin filtro, qué miseria.',
      '[nombre], el espejo del baño tiene PTSD con tu nombre. Cada mañana es reincidencia, no desayuno Hasta el sticker tiene más carisma que tú, cutre.',
      ...
      '[nombre], tu atractivo cotiza en negativo y el mercado no miente. El ranking visual del chat te tiene en sótano, basura.',
      'Fea de horario restringido, [nombre]: solo sobrevives a cierta distancia y con poca luz. En HD eres evento de riesgo, patético.',
      '[nombre], el filtro más caro del mundo en tu cara es tirita en hemorragia. El hardware no perdona, fracasado.',
      '[nombre], tienes una cara de "borra y vuelve a sacar" permanente. El rollo nunca llega al like sincero, qué asco.',
      'Fea de las que el selfie stick se acorta solo, [nombre]. Hasta el plástico tiene dignidad y la ejerce lejos de ti, fracasado.',
      '[nombre], si te miran dos segundos es cortesía social, no magnetismo. El tercer segundo ya es tortura compartida, qué miseria.',
      '[nombre], tu cara es la razón por la que inventaron el modo paisaje. El retrato se niega a colaborar, ridículo.',
      'Fea de informe médico, [nombre]: el atractivo te diagnosticó y te dio el alta sin tratamiento posible, desperdicio visual.',
      '[nombre], tienes más ángulos muertos que un coche blindado. Y ninguno es favorecedor, qué miseria visual.',
      '[nombre], el maquillaje es daño colateral en tu caso. No embellece: negocia una tregua que el hueso no firma, escoria con wifi.',
      'Fea de las que el bar apaga la luz un punto más cuando entras, [nombre]. El ambiente también quiere sobrevivir, basura.',
      '[nombre], tu selfie parece modo nocturno a plena luz del día. El sensor se rinde, el ego no, patético.',
      '[nombre], si la belleza es objetiva, tú eres el contraejemplo de libro. El material no discute: sentencia, ridículo.',
      'Fea de close-up prohibido, [nombre]. El zoom es un arma y la usamos. Resultado: parte sin consuelo visual, qué asco.',
      '[nombre], tienes una cara que hace que el espejo del ascensor finja estar ocupado. Nadie quiere ese reflejo, fracasado.',
      ...
      '[nombre], tu rostro prueba que el filtro Beauty existe por una razón y aun así no te alcanza el milagro, desperdicio visual.',
      '[nombre], tienes el tipo de fealdad que no se arregla con corte ni actitud. Hardware, no software, fracasado.',
      'Fea de espejo roto, [nombre]: ni siete años de mala suerte compensan lo que se ve cuando te enfocas bien, escoria con wifi.',
      '[nombre], si te etiquetan en una foto, la gente entra solo para reírse. Engagement de pena ajena, no de deseo, basura.',
      '[nombre], tu cara hace que el modo retrato active el modo pánico. El algoritmo prefiere recortarte del frame, patético.',
      'Fea de las que el ring light parece interrogatorio, [nombre]. Cuanta más luz, peor el veredicto. Apaga eso, ridículo.',
      '[nombre], no es "estilo único": es desastre simétrico. El marketing personal no tapa un informe en rojo, qué asco.',
      '[nombre], tienes una presencia facial que baja el promedio de la foto de grupo sin esfuerzo. Logro miserable, fracasado.',
      'Fea de archivo adjunto que nadie abre, [nombre]. Preview suficiente para decir que no, gracias, basura.',
      '[nombre], el atractivo no es un derecho humano. En tu caso es mitología. El material te desmintió en 4K, cutre.',
      '[nombre], tienes cara de que el maquillaje se aplica en defensa propia. Y aun así pierde cada mañana, desperdicio visual.',
      'Fea de las que el visor se niega a colaborar, [nombre]. La cámara frontal merece hazard pay y sindicato, qué vergüenza.',
      ...
      '[nombre], el cloud borra tu selfie por piedad. Hasta la nube tiene compasión selectiva, [nombre] Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], el espejo del baño tiene más criterio que tu círculo de "estás bien". Ellos mienten El espejo firmó antes que el comando, qué asco.',
      ...
      '[nombre], el espejo firma el veredicto antes de que el bot abra el comando. Coincidencia cruel Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], el maquillaje te dura menos que la esperanza de que hoy se ve mejor. Spoiler: no La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], capas de base no tapan un problema de fábrica. El marketing personal tiene límite El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], el group foto se edita en silencio. Crop estratégico. Tú eras el problema del frame El chat ya lo archivó sin debate, basura.',
      ...
      '[nombre], foto grupal sin [nombre] se volvió política no escrita. Evolución natural del hilo Documentado en cada selfie sin filtro, ridículo.',
      ...
      '[nombre], el fondo gana más carisma que tú. Hasta la pared es mejor personaje secundario Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], el algoritmo prefiere un anuncio de seguros a tu cara. Prioridades del feed, [nombre] El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], cuando el chat necesita ejemplo de desastre facial, te etiquetan. Eres la plantilla Hasta el sticker tiene más carisma que tú, cutre.',
      ...
      '[nombre], el atractivo te auditó y el balance salió en rojo. Sin capital que salve el trimestre El chat ya lo archivó sin debate, basura.',
      '[nombre], el atractivo te dejó en visto hace años. Sin doble check azul en tu historial visual El material no deja margen a la duda, patético.',
      '[nombre], el atractivo te puso un wall y tiró la llave. Solo queda el espejo de las siete Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], el atractivo firmó el desahucio de tu ego. Orden de desalojo visual sin prórroga El espejo firmó antes que el comando, qué asco.',
      '[nombre], si la belleza fuera crédito, lista negra del bureau. Score visual en números rojos Sin recurso ni segunda oportunidad visual, fracasado.',
      ...
      '[nombre], si la belleza fuera GPS, fuera de cobertura permanente. Recalculando… error infinito Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], si la belleza fuera examen, suspenso histórico. Sin recuperatorio que te salve, [nombre] La autoestima de prestado se embarga sola, desperdicio visual.',
      ...
      '[nombre], el deseo colectivo pidió la baja el día que te enfocaron en HD. Documentado El chat ya lo archivó sin debate, basura.',
      '[nombre], el ranking no negocia simpatía cuando el hardware grita tan alto. El número te mide El material no deja margen a la duda, patético.',
      ...
      '[nombre], no hay ángulo de gracia: hay ángulos de menos daño. El menos malo igual duele El espejo firmó antes que el comando, qué asco.',
      '[nombre], hipótesis de atractivo falsificada cada mañana por el espejo. Ciencia dura, [nombre] Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], selfie que se borra sola por piedad. El rollo tiene más empatía que tu ego El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], cara de "tiene buen corazón" porque no pueden decir otra cosa sin perjurar Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], te miran para validar su suerte. Al menos no soy [nombre]. Servicio de contraste La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], evento de riesgo laboral para el retratista. Cobran extra y aun así tiemblan El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], "es interesante" quiere decir "es difícil de mirar". Traducción del cumplido flojo El chat ya lo archivó sin debate, basura.',
      '[nombre], de reojo no es coquetería: es daño colateral. De frente duele más, patético El material no deja margen a la duda.',
      '[nombre], tutorial de cómo no salir en la foto. El grupo ya aprendió la lección contigo Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], archivo que pesa más en vergüenza que en megas. Nadie lo descarga dos veces El espejo firmó antes que el comando.',
      '[nombre], "sonríe" suena a amenaza. Sonreír empeora el radio de daño, [nombre] Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], close-up no es arte: es autopsia. Forense visual firmó causa: hardware El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], "buenos días" se convierte en acto de valor. El café no alcanza para mirarte Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], el "quiérete" tiene límites prácticos. El espejo pone el tope cada mañana La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], veredicto sin recurso. Primera instancia, única instancia, archivo cerrado El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], "está bien de cara" es sarcasmo de alto nivel. No está bien. Punto. Material El material no deja margen a la duda, patético.',
      ...
      '[nombre], argumento final contra "todo el mundo es hermoso". El material tiene veto Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], maquillaje es negociar con un terremoto. Mañana vuelve el temblor, [nombre] El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], close-up con consentimiento informado. Quien mira asume el riesgo emocional Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], bajas el valor inmobiliario de la foto de grupo. Nadie quiere vivir a tu lado La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], el algoritmo entierra tu selfie bajo el feed. La IA tiene piedad selectiva El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], si la fealdad fuera trabajo, asalariado del mes. Constancia en el desastre El chat ya lo archivó sin debate, basura.',
      '[nombre], ring light como quirófano. Operación fallida. Paciente sin mejora, basura El material no deja margen a la duda.',
      '[nombre], ego que ignora la evidencia. El espejo es el fiscal y ya ganó el juicio Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], el atractivo no discute: te exhibe. El grupo toma nota sin narrador, [nombre] El espejo firmó antes que el comando, qué asco.',
      '[nombre], informe sin segunda opinión. Primera vista basta. Segunda es ensañamiento Sin recurso ni segunda oportunidad visual, fracasado.',
      ...
      '[nombre], close-up con daño emocional al espectador. Menores no admitidos al frame La autoestima de prestado se embarga sola, desperdicio visual.',
      ...
      '[nombre], más capas de maquillaje que de esperanza. La esperanza se agotó primero El chat ya lo archivó sin debate, basura.',
      '[nombre], error de casting del group selfie. El fondo gana mejor actor secundario El material no deja margen a la duda, patético.',
      '[nombre], modo retrato activa evacuación. El teléfono quiere salir de ahí, [nombre] Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], el ring light te procesa. Veredicto público y cruel. Sin apelación visual El espejo firmó antes que el comando, qué asco.',
      '[nombre], el disco duro mueve tu selfie a la papelera solo. Hasta el hardware tiene criterio Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], "esto no era el plan del genético". El plan falló. El espejo lo recuerda diario El ranking facial del grupo no negocia, qué miseria.',
      ...
      '[nombre], el flash pide abogado antes del click. Nadie quiere la demanda por daño visual La autoestima de prestado se embarga sola, desperdicio visual.',
      ...
      '[nombre], close-up clasificación X. El estómago avisa antes que los ojos, [nombre] El chat ya lo archivó sin debate, basura.',
      '[nombre], el piropo sincero se extinguió en tu código postal. Especie en peligro El material no deja margen a la duda, patético.',
      '[nombre], de frente el cerebro pide buffer. El buffer no llega. Parpadeo de emergencia Documentado en cada selfie sin filtro, ridículo.',
      ...
      '[nombre], el cloud marca tu selfie como sensible y la oculta. Favor de la privacidad El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], simetría de burla. No trágica: cómica. El chiste eres tú y el grupo ya rio Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], si la belleza fuera derecho, demanda desestimada con costas. Sin recurso La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], "mala racha" insulta al calendario. No es racha: es planta fija, [nombre] El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], inventaron "mejor de lejos" por casos como el tuyo. De cerca es delito de daño Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], close-up con efectos permanentes en quien mira. Daño colateral certificado El espejo firmó antes que el comando, qué asco.',
      '[nombre], "te ves bien hoy" es perjurio. El tribunal del espejo te condena, [nombre] Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], si la fealdad fuera clima, invierno permanente. Sin deshielo. Solo escarcha en el ego El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], el crop del group selfie es arte del escape. Artistas del recorte, basura Hasta el sticker tiene más carisma que tú.',
      '[nombre], rumor de atractivo asesinado por la primera foto. Fin de la investigación La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], ring light igual a museo de horrores. Visita guiada. No tocar. No mirar mucho El tramo high solo certifica lo evidente, qué vergüenza.',
      '[nombre], tu selfie debería pagar impuesto por daño al feed. Multa visual, patético Basura con wifi y pretensión de portada.',
      '[nombre], más ángulos de escape que de favor. El que mira usa el escape, no la cámara El chat ya lo archivó sin debate, basura.',
      '[nombre], el tramo high es metrología. El número te mide y el material confirma, [nombre] El material no deja margen a la duda, patético.',
      '[nombre], sentencia firme: sin filtro, sin ángulo, sin milagro. El bot lee el espejo Documentado en cada selfie sin filtro, ridículo.',
      '[nombre], "sonríe más" es una trampa. Sonreír aumenta el radio de daño, ridículo El espejo firmó antes que el comando.',
      '[nombre], pozo de gravedad facial: absorbe likes, esperanza y ganas de otra foto Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], plantilla histórica de desastre facial del chat. Cuando hace falta ejemplo, te etiquetan El ranking facial del grupo no negocia, qué miseria.',
      ...
      '[nombre], el bar baja la luz cuando entras. Instinto de supervivencia del ambiente, [nombre] La autoestima de prestado se embarga sola, desperdicio visual.',
      '[nombre], el selfie stick se acorta solo. El plástico tiene más dignidad que tu ego El tramo high solo certifica lo evidente, qué vergüenza.',
      ...
      '[nombre], el espejo del gym no es cómplice. El vidrio también tiene ética, [nombre] El material no deja margen a la duda, patético.',
      '[nombre], el espejo prefiere empañarse. El vapor es el único favor que te hacen Documentado en cada selfie sin filtro, ridículo.',
      ...
      '[nombre], el filtro agresivo te deja reconocible y ese es el problema, [nombre] Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], el botón de desenfoque existe por ti. Úsalo. Es lo más generoso que puedes hacer La autoestima de prestado se embarga sola, desperdicio visual.',
      ...
      '[nombre], el bokeh se siente mal de cómplice. El fondo pide asilo lejos de ti, [nombre] El chat ya lo archivó sin debate, basura.',
      '[nombre], el atractivo pasó de largo sin nota. Hardware de mala suerte, piel sin perdón El material no deja margen a la duda, patético.',
      '[nombre], el atractivo te dio alta sin tratamiento. Fea de informe médico cerrado Documentado en cada selfie sin filtro, ridículo.',
      ...
      '[nombre], "borra y vuelve a sacar" permanente. El like sincero no existe en tu feed El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], dos segundos cortesía, el tercero tortura. Cronómetro social, [nombre] Hasta el sticker tiene más carisma que tú, cutre.',
      ...
      '[nombre], belleza objetiva: eres el contraejemplo de libro. El material sentencia El chat ya lo archivó sin debate, basura.',
      '[nombre], espejo de ascensor finge ocupado. Nadie quiere tu reflejo compartido, [nombre] El material no deja margen a la duda, patético.',
      ...
      '[nombre], espejo roto: ni siete años compensan el enfoque nítido, [nombre] El ranking facial del grupo no negocia, qué miseria.',
      '[nombre], etiquetan y entran a reírse. Engagement de pena ajena, no de deseo Hasta el sticker tiene más carisma que tú, cutre.',
      '[nombre], modo retrato igual a modo pánico. El algoritmo te recorta del frame La autoestima de prestado se embarga sola, desperdicio visual.',
      ...
      '[nombre], bajas el promedio del group sin esfuerzo. Logro miserable, [nombre] El chat ya lo archivó sin debate, basura.',
      ...
      '[nombre], visor en huelga. Cámara frontal con sindicato, [nombre] Sin recurso ni segunda oportunidad visual, fracasado.',
      '[nombre], fealdad con podio e himno. Medalla de plomo en el ranking facial El ranking facial del grupo no negocia, qué miseria.',
  ...
  sexy: {
    ...
    mid: [
      ...
      'El flash de atracción ya no ilusiona a nadie: se conoce el apagón de antemano siempre. Gilipollas.',

      'El ranking promedia tu zigzag y te deja aquí sin mudanza cercana posible en el mapa. Gilipollas. El ranking no miente.',

      'No cierras de forma memorable: ni para el álbum ni para el meme del grupo, [nombre]. Gilipollas.',

      'Luz dudosa de neón de atracción a punto de fundirse sin repuesto en el almacén. Gilipollas. El chat ya lo archivó.',

      'Espera de versión del día: el grupo no sabe qué build de sexy va a cargar hoy. Gilipollas.',

      'No hay hilo que abrir sobre tu sexy: la ausencia de hilo es el dato más claro. Gilipollas.',

      'Sin portada al acabar la temporada de sexy: archivo gris y siguiente comando. Gilipollas.',

      'Silencio de grada sin olé ni abucheo: respiración normal y nada más que eso. Gilipollas. El bot no regala décimas.',

      'El bot te debe este medio: no un high de cartón ni un low de teatro barato. Gilipollas.',
      ...
      'No hay firma estable de deseo: hay intentos y los intentos se notan a la legua, [nombre]. Patético.',
      ...
      'Hay momentos en que el ángulo ayuda y momentos en que el material no da para más, [nombre]. Cabrón.',

      'Medallero corto y sin brillo de atracción: ni vacío dramático ni lleno orgulloso, [nombre]. Basura.',

      'A medias es tu tramo natural y el número te lo confirma sin anestesia ni regalo, [nombre]. Cabrón.',
      ...
      'Spoiler de tibieza permanente: nadie se sorprende del resultado medio del tramo, [nombre]. Cabrón.',

      'Ni estable en el deseo ni estable en el vacío: inestable en las dos direcciones a la vez. Mierda. Nivel sótano',

      'A ratos el silencio de interés y a ratos el ruido de no saber qué hacer con la presencia. Basura.',
      ...
      'Sexy de menú del día: a veces hay plato y a veces solo pan sin ganas de pedir más, [nombre]. Asco.',

      'Salva el rato y pierde el día de atracción: prioridades raras y resultados tibios, [nombre]. Coño.',
      ...
      'El medio no pide aplausos: pide el número y el número es este sin adornos, [nombre]. Patético.',

      'Estás en el tramo que no emociona: constata y sigue como el resto del ranking, [nombre]. Mierda. Nivel sótano',

      'No ser noticia es tu forma de estar: el silencio de centro es tu marca registrada, [nombre]. Asco.',
      ...
      'Tu sexy en silencio con mensajes raros: chat casi muerto y algún ping suelto, [nombre]. Mierda.',

      'Temblor sin etiqueta clara: ni fiebre de deseo ni normalidad clara en el tramo, [nombre].',

      'Sin leyenda ni maldición de sexy: solo la continuidad gris del promedio del chat, [nombre]. Coño.',
      ...
      'Andamio visible de la pose: se ve la obra y falta la fachada terminada del todo, [nombre]. Asco. Nivel sótano',

      'Manos y mirada que no saben qué hacer a ratos: el vacío se nota en el gesto, [nombre]. Basura.',

      'El único sitio sin mentir el relato: el medio es lo único que no es ficción. Desperdicio. El ranking no miente.desperdicio.',

      'Ni generas deseo claro ni rechazo interesante: el medio pelo de la atracción medible. Mierda.',

      'Sexy con luz piloto: se ve que hay algo pero no se sabe cuánto ni de qué calidad. Ridículo. El chat ya lo archivó.',

      'Una frase de atracción y vuelta al bloque de tibieza como si nada hubiera pasado. Patético.',

      'Depende como sentencia de tu atracción: el veredicto es el depende y punto final. Patético.',

      'Sin material para fanatismo ni desprecio: material para el siguiente mensaje, [nombre].',

      'El magnetismo no ha firmado indefinido contigo: es temporal y sin renovación automática. Asco. El bot no regala décimas.',

      'El depende es. El veredicto de tu atracción y no hay apelación al número del bot. Patético.',

      'Sin horario fijo en el calendario del deseo: espontánea y rara como la lluvia de agosto. Coño. Nivel sótano',

      'Ni dentro ni fuera del deseo del todo: umbral sin empadronamiento claro en. El ranking.',

      'Sexy de solo entrantes sin plato fuerte: bocados y poco más en la carta del día. Ridículo. El ranking no miente.',

      'El quizás cansado del promedio: ni sí ni no, solo la duda hecha presencia en. El ranking. Coño.',

      'Tu rango estrecho de sexy: vibras en el medio sin salir nunca del todo del espectro. Mierda. El chat ya lo archivó.',

      'Tu sitio es el centro del espectro de sexy: coordenada exacta y sin mudanza cercana. Mierda.',

      'El bot te deja aquí sin regalo y sin ensañamiento: medio y punto final del análisis. Cabrón.',

      'Ni clutch del mes ni fail de la semana: el partido de trámite del ranking, [nombre]. Cabrón.',

      'Ni llegas con gloria ni te caes antes: terminas sin titular de portada de sexy. Ridículo. El bot no regala décimas.',

      'El medio por media de presencia: por número puro y sin anestesia del bot, [nombre]. Mierda.',

      'Hay días de sí y días de no: el promedio es un quizás cansado de tanto dudar aquí. Cabrón. Nivel sótano',

      'Olvidable en el acierto y en el fallo de sexy: doble olvido. Sin derecho a réplica. Cabrón.',

      'Temporal sin renovar el magnetismo: el contrato caducó y nadie lo ha firmado de nuevo. Asco. El ranking no miente.',

      'Continuidad gris de presencia: sin picos de gloria ni valles de rechazo interesante.',

      'Resumen sin adjetivos fuertes de atracción: la falta de adjetivos es. El veredicto. Basura. El chat ya lo archivó.',

      'Tu magnetismo va y viene según el día: el grupo ya no apuesta a ninguna versión tuya. Coño.',

      'Ni ejemplo de sexy ni antiejemplo claro: caso del promedio tembloroso sin etiqueta.',

      'Sexy sin fecha de estreno: ensayo perpetuo sin noche de inauguración posible. Ridículo.',

      'Ni te suben ni te bajan con ganas: te dejan en el centro sin drama añadido, [nombre]. Asco. El bot no regala décimas.',

      'Ni cartel de deseo ni ausencia total: pasillo con luz de fluorescente barato. Ridículo.',

      'Ranking frío y correcto: centro sin narrativa extra que vender a nadie, [nombre]. Basura. Nivel sótano',
      ...
      'El centro del espectro es poco comercial y es tuyo por derecho estadístico puro. Mierda.',

      'El grupo espera el zigzag de tu atracción y el zigzag llega sin sorpresa ninguna. El chat ya lo archivó.',

      'Citas sueltas con el deseo sin noviazgo ni compromiso de ninguna clase posible. Cabrón.',

      'A veces sin buscarlo se enciende y cuando lo fuerzas se apaga: al revés del manual. Asco.',

      'Tu atracción con RSVP irregular: a veces viene y a veces deja el asiento vacío. Mierda.',
      ...
      'Tu presencia a tiempo parcial sin opción a upgrade ni a jornada completa nunca. Mierda.',
      ...
      'El medio te queda como ropa lavada demasiadas veces: sin color fuerte y usable. Mierda.',

      'Gloria y fracaso de paso: tú te quedas en medio sin que te inviten a vivir. Patético. El ranking no miente, fracasado.',

      'Momentos que no compensan la tibieza de la semana entera en el historial del chat. Coño.',

      'Oscila sin llegar a puerto: ni naufragio ni atraque, solo el movimiento tibio. Basura. El chat ya lo archivó, da grima.',

      'Sin remontada ni debacle de atracción: partidos que se juegan y se olvidan al día. Coño.',

      'Historial sin chapters fuertes de atracción: páginas grises y sin subrayados. Basura.',

      'Gestos sueltos que no suman magnetismo que se sostenga en serio en el grupo. Basura.',

      'Media agua sin orilla de atracción: flotas sin dirección ni puerto a la vista. El bot no regala décimas, da pena ajena.',

      'El apagón del flash se conoce de antemano: nadie se ilusiona del todo nunca. Cabrón.',

      'Día laborable de sexy: funcional, sin picos y sin ganas de recordarlo jamás. Cabrón. Nivel sótano documentado, indignante.',

      'Asumir el promedio también es honestidad: y esta es la tuya sin adornos. Patético.ajena.',

      'Se va pronto la chispa y deja el espacio vacío sin dejar rastro memorable aquí. Asco. El ranking no miente, da vergüenza.',

      'Sin titular de portada de atracción: ficha de quien terminó y nada más que eso. Asco.',

      'Gris previsible como marca: el spoiler es la tibieza siempre en este tramo. Cabrón. El chat ya lo archivó, menudo desastre.',

      'Más páginas grises que capítulos: el libro de tu presencia es así de plano. Basura.',

      'Ni anillo ni crónica: ficha de quien terminó sin estrellas ni tachones. Ridículo.',

      'Tu lugar es el control del experimento: sin extremos no hay escala posible. Mierda.',

      'Lo más predecible del ranking de sexy: y lo menos comentado del chat entero. El bot no regala décimas, qué cringe.',

      'Tramo que no abre hilos: la no apertura es el dato más claro del pool. Patético.',

    ],
    low: [
      'No hay un ángulo de salvación: el problema es de base y se ve en todos lados, [nombre]. Gilipollas. Nivel sótano',

      'No hay narrativa de deseo: hay un punto final prematuro en la frase visual, [nombre]. Gilipollas.',

      'Cero de lo que se siente antes de nombrarse: ese algo no está y no va a estar aquí. Gilipollas. El ranking no miente.',

      'La atracción te ha marcado en no volver a llamar y no llama desde hace temporadas. Gilipollas.',

      'Cero de sensualidad espontánea en todo tu historial de mensajes y fotos del grupo. Gilipollas. El chat ya lo archivó.',

      'La habitación no cambia cuando entras: y ese es el diagnóstico completo del tramo. Gilipollas.',

      'La temperatura del deseo no te incluye: la ecuación se resuelve sin tu variable. Gilipollas.',

      'Cero de presencia que diga atracción sin que el esfuerzo se note a la legua. Gilipollas.',

      'La temperatura del grupo no te incluye en la ecuación del deseo de nadie. Gilipollas. El bot no regala décimas.',

      'Cero de temperatura que se note en la habitación cuando ocupas el centro. Gilipollas.',

      'La atracción y tú no compartís ni el código postal en el mapa del grupo. Gilipollas. Nivel sótano',
      ...
      'No generas el silencio de alguien atractivo: generas el de cambiar de tema sin mirar atrás. Mierda.',

      'No eres memorable: eres el espacio en blanco entre dos caras que sí se recuerdan, [nombre]. Cabrón. El bot no regala décimas.',

      'No generas el tipo de mirada que se guarda: generas la que se olvida al instante, [nombre]. Mierda.',

      'No hay un segundo de ventaja: el reloj del deseo empieza en desventaja total, [nombre]. Ridículo. Nivel sótano',

      'No generas deseo ni rechazo interesante: generas indiferencia, y eso es peor, [nombre]. Patético.',

      'No hay ángulo de salvación: el problema es de base y se ve desde todos lados, [nombre]. Ridículo. El ranking no miente.',

      'No hay magnetismo: hay ocupación del espacio sin carga eléctrica de ninguna clase medible. Basura.',

      'No generas el silencio de la admiración: generas el del siguiente tema del hilo, [nombre]. Cabrón. El chat ya lo archivó.',

      'No eres memorable en clave sexual: eres el silencio entre dos opiniones fuertes, [nombre]. Basura.',

      'No levantas el listón del deseo: el listón sigue en el suelo sin que lo toques jamás. Ridículo.',

      'No hay magia en el detalle porque no hay detalle que encienda nada en nadie aquí, [nombre].',

      'No hay redención en el tramo bajo de sexy: hay el número y el número habla, [nombre]. Ridículo. El bot no regala décimas.',

      'No hay material para el close-up: hay material para el plano general y el olvido, [nombre].',

      'Tu cuerpo pide un rediseño completo: no un retoque, un rediseño desde los cimientos. Patético. Nivel sótano',

      'No hay close-up que merezca la pena porque el material no da para el primer plano, [nombre]. Coño.',

      'Cero atracción real: la gente mira y sigue de largo sin que se mueva un músculo facial. Mierda. El ranking no miente.',

      'Cero de lo que hace que la gente afine el foco: el foco se va a otra parte siempre. Ridículo.',

      'No eres el close-up: eres el plano general donde nadie detiene la mirada, [nombre]. Patético. El chat ya lo archivó.',

      'Tu look no genera debate: genera el encogimiento de hombros y el siguiente mensaje. Patético.',

      'Cero de magnetismo: ni por luz, ni por ángulo, ni por pose forzada de ningún tipo. Patético.',

      'No hay chispa en la forma de estar ni en la mirada ni en cómo ocupas el espacio del chat. Coño.',

      'Cero de presencia erótica: ni un segundo de duda en quien te mira de frente en. El chat. El bot no regala décimas.',

      'No eres memorable en clave de atracción: eres olvidable en tiempo récord plano, [nombre]. Asco.',

      'No hay magia, no hay duda, no hay segundo de interés: hay el no claro y seco, [nombre]. Nivel sótano',

      'No eres el primer plano: eres el fondo que el director no acerca nunca, [nombre]. Ridículo.',

      'Tu presencia es la del control del experimento: sin extremos de deseo que medir. Patético. El ranking no miente.',

      'No generas capturas ni comentarios de deseo: generas el scroll silencioso, [nombre]. Basura.',

      'No hay close-up que merezca la pena: el material no da para el primer plano, [nombre]. El chat ya lo archivó.',

      'La atracción te evitó. Y el grupo lo nota sin necesidad de decírtelo en voz alta. Ridículo.',

      'No hay un ángulo que te convierta en otra persona: eres tú en versión siempre fría. Cabrón.',

      'Cero de chispa en cualquiera de las capas: superficie y fondo en números rojos. Patético.',

      'Cero de magnetismo: ni por luz, ni por ángulo, ni por esfuerzo de pose forzada. Patético. El bot no regala décimas.',

      'No generas deseo ni rechazo nítido: generas el vacío, y el vacío es peor, [nombre]. Cabrón.',

      'No hay duda en. El veredicto: el no es redondo, claro, seco y sin matices, [nombre]. Cabrón. Nivel sótano',

      'Tu look no genera capturas de pantalla ni comentarios de deseo en. El chat del grupo.',

      'La atracción y tú sois líneas paralelas: no se cruzan en esta geometría del grupo. Cabrón. El ranking no miente.',

      'No hay narrativa de deseo: hay un plano secuencia del vacío visual del chat, [nombre]. Coño.',

      'Cero de lo que se siente antes de pensar: ese algo no te pertenece de ninguna forma. El chat ya lo archivó.',

      'Cero de chispa que encienda algo más que un cambio de tema educado en. El chat. Ridículo.',

      'Tu presencia sexual es un trámite: se procesa y se archiva sin comentarios largos. Basura.',

      'No generas el silencio de quien se queda mirando: generas el de quien sigue, [nombre]. Asco.',
      ...
      'Tienes un almost de atracción que. El ranking grita. Sin filtro, [nombre].',
      ...
      'Sexy de fondo de ranking: siempre el mismo almost y cero chispa, [nombre]. El veredicto. No hay segunda lectura útil',
      ...
      'Tienes más pretensión que magnetismo y el low no se traga el cuento, [nombre]. El veredicto, archivo',

      'Sexy cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre].',
      ...
      'Se te nota la prisa por parecer y cero plan de ser deseable de verdad, [nombre].',
      ...
      'El recato del deseo te queda lejos y la distancia es rechazo, [nombre]. El veredicto Aquí.',
      ...
      'Sexy de estribillo que mancha más con cada pose del mismo fail, [nombre].',

      'Se te nota el hábito de empujar cada foto hacia el mismo almost, [nombre].',
      ...
      'No es mala suerte de química: es patrón y el low te lo cobra, [nombre].',
      ...
      'Sexy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre].',
      ...
      'Sexy de estribillo sin punto final limpio ni redención, [nombre]',
      ...
      'No hay barniz que salve: hay almost puro y el low lo cobra, [nombre].',
      ...
      'Se te cae el personaje sexy solo con abrir la cámara, [nombre]. El veredicto Aquí',
      ...
      'Sexy de ranking roto: el número bajo te queda de apodo, [nombre]',
      ...
      'Sexy de las que confunden pose con deseo y pierden las dos, [nombre].',
      ...
      'Sexy de almost documentado: autor tú, testigo el grupo, [nombre].',
      ...
      'El low te nombra sin suavizar: almost de base y punto, [nombre]. El veredicto. El ranking firma y listo',
      ...
      'Sexy de almost eterno con firma legible en cada pose del chat, [nombre]. El veredicto Aquí, archivo',
      ...
      'Sexy de superficie: basta la vista, no hace falta el sótano, [nombre]',
      ...
      'El ranking de deseo te deja en el sótano del low sin debate, [nombre].',
      ...
      'Tu almost es el gag del tramo. Y el grupo no pide repetición, [nombre]',
      ...
      'Sexy de las que el deseo y. El ranking coinciden en. El veredicto, [nombre].',
      ...
      'Sexy de almost eterno: el comando no convierte el casi en victoria, [nombre]. El veredicto, archivo',
      ...
      'Sexy de las que el natural es no atraer, [nombre].',
      ...
      'El low te nombra sin suavizar ni media coma del veredicto, [nombre].',

      'Sexy de almost: ni el low light te favorece. Y el chat lo ve, [nombre].',

      'Tu presencia es un argumento contra la química del grupo, [nombre].',
      ...
      'El comando no discute contigo: el low firma y punto, [nombre].',
      ...
      'Sexy de almost eterno con. El chat de testigo notarial, [nombre]. El veredicto. Se ve desde el primer mensaje, archivo',

      'No es un mal día de fotos: es el nivel y el low te lo cobra, [nombre].',
    ...
    extreme: [
      ...
      'La gente va a recordar exactamente qué llevabas puesto el día que os conocisteis, archivo',
  ...
  crack: {
    ...
    mid: [
      ...
      'El flash de respeto ya no ilusiona a nadie: se conoce el apagón de antemano siempre. Gilipollas. Nivel sótano',

      'El ranking promedia tu zigzag y te deja aquí sin mudanza cercana posible en el mapa. Gilipollas.',

      'No cierras de forma memorable: ni para el álbum ni para el meme del grupo, [nombre]. Gilipollas. El ranking no miente.',

      'Espera de versión del día: el grupo no sabe qué build de crack va a cargar hoy. Gilipollas.',

      'No hay hilo que abrir sobre tu crack: la ausencia de hilo es el dato más claro. Gilipollas. El chat ya lo archivó.',

      'Sin portada al acabar la temporada de crack: archivo gris y siguiente comando. Gilipollas.',

      'Luz dudosa de neón de respeto a punto de fundirse sin repuesto en el almacén. Gilipollas.',

      'Silencio de grada sin olé ni abucheo: respiración normal y nada más que eso. Gilipollas.',
      ...
      'Crack de menú del día: a veces hay plato y a veces solo pan sin ganas de pedir más, [nombre]. Asco.',

      'A ratos el silencio de interés y a ratos el ruido de no saber qué hacer con la presencia. Basura. Nivel sótano',

      'Cliente ocasional del respeto sin puntos de fidelidad ni programa de socios del chat. Patético.',

      'Pila de borradores de pose sin versión final que firmar ni publicar en el grupo, [nombre]. Gilipollas.',

      'Temblor sin etiqueta clara: ni fiebre de respeto ni normalidad clara en el tramo, [nombre].',
      ...
      'El medio no pide aplausos: pide el número y el número es este sin adornos, [nombre]. Patético. Nivel sótano',

      'Estás en el tramo que no emociona: constata y sigue como el resto del ranking, [nombre]. Mierda.',

      'No ser noticia es tu forma de estar: el silencio de centro es tu marca registrada, [nombre]. Asco. El ranking no miente.',

      'Sin leyenda ni maldición de crack: solo la continuidad gris del promedio del chat, [nombre]. Coño.',
      ...
      'Crack con luz piloto: se ve que hay algo pero no se sabe cuánto ni de qué calidad. Ridículo.',

      'Sin horario fijo en el calendario del respeto: espontánea y rara como la lluvia de agosto. Coño. El bot no regala décimas.',

      'Andamio visible de la pose: se ve la obra y falta la fachada terminada del todo, [nombre]. Asco.',

      'Ni dentro ni fuera del respeto del todo: umbral sin empadronamiento claro en. El ranking. Nivel sótano',

      'Salva el rato y pierde el día de respeto: prioridades raras y resultados tibios, [nombre]. Coño.',
      ...
      'Crack de solo entrantes sin plato fuerte: bocados y poco más en la carta del día. Ridículo.',

      'Tu rango estrecho de crack: vibras en el medio sin salir nunca del todo del espectro. Mierda.',

      'Tu sitio es el centro del espectro de crack: coordenada exacta y sin mudanza cercana. Mierda.',

      'Sin material para fanatismo ni desprecio: material para el siguiente mensaje, [nombre]. El bot no regala décimas.',

      'El magnetismo no ha firmado indefinido contigo: es temporal y sin renovación automática. Asco.',

      'El quizás cansado del promedio: ni sí ni no, solo la duda hecha presencia en. El ranking. Coño. Nivel sótano',
      ...
      'Una frase de respeto y vuelta al bloque de tibieza como si nada hubiera pasado. Patético.',

      'Depende como sentencia de tu respeto: el veredicto es el depende y punto final. Patético.',

      'Ni cartel de respeto ni ausencia total: pasillo con luz de fluorescente barato. Ridículo.',

      'El medio por media de presencia: por número puro y sin anestesia del bot, [nombre]. Mierda. El bot no regala décimas.',

      'Hay días de sí y días de no: el promedio es un quizás cansado de tanto dudar aquí. Cabrón.',

      'Ni ejemplo de crack ni antiejemplo claro: caso del promedio tembloroso sin etiqueta. Nivel sótano',

      'El depende es. El veredicto de tu respeto y no hay apelación al número del bot. Patético.',

      'Crack sin fecha de estreno: ensayo perpetuo sin noche de inauguración posible. Ridículo. El ranking no miente.',

      'Temporal sin renovar el magnetismo: el contrato caducó y nadie lo ha firmado de nuevo. Asco.',

      'Continuidad gris de presencia: sin picos de gloria ni valles de rechazo interesante. El chat ya lo archivó.',

      'Tu magnetismo va y viene según el día: el grupo ya no apuesta a ninguna versión tuya. Coño.',

      'Citas sueltas con el respeto sin noviazgo ni compromiso de ninguna clase posible. Cabrón.',

      'Ni te suben ni te bajan con ganas: te dejan en el centro sin drama añadido, [nombre]. Asco.',
      ...
      'Resumen sin adjetivos fuertes de respeto: la falta de adjetivos es. El veredicto. Basura.',
      ...
      'Resultado tibio como costumbre: la costumbre no genera leyendas ni memes del grupo. Asco.',
      ...
      'El grupo espera el zigzag de tu respeto y el zigzag llega sin sorpresa ninguna.',

      'Tu respeto con RSVP irregular: a veces viene y a veces deja el asiento vacío. Mierda. El ranking no miente, da grima.',

      'Día laborable de crack: funcional, sin picos y sin ganas de recordarlo jamás. Cabrón.',

      'Gestos sueltos que no suman magnetismo que se sostenga en serio en el grupo. Basura. El chat ya lo archivó, basura.',

      'El apagón del flash se conoce de antemano: nadie se ilusiona del todo nunca. Cabrón.',

      'Sin remontada ni debacle de respeto: partidos que se juegan y se olvidan al día. Coño.',

      'Asumir el promedio también es honestidad: y esta es la tuya sin adornos. Patético.',

      'Se va pronto la chispa y deja el espacio vacío sin dejar rastro memorable aquí. Asco. El bot no regala décimas, indignante.',

      'Historial sin chapters fuertes de respeto: páginas grises y sin subrayados. Basura.ajena.',

      'Gris previsible como marca: el spoiler es la tibieza siempre en este tramo. Cabrón. Nivel sótano documentado, da vergüenza.',

      'Más páginas grises que capítulos: el libro de tu presencia es así de plano. Basura.',

      'Lo más predecible del ranking de crack: y lo menos comentado del chat entero. El ranking no miente, menudo desastre.',

      'Ni anillo ni crónica: ficha de quien terminó sin estrellas ni tachones. Ridículo.',

      'Tu lugar es el control del experimento: sin extremos no hay escala posible. Mierda. El chat ya lo archivó, patético.',

      'Media agua sin orilla de respeto: flotas sin dirección ni puerto a la vista.',

      'El respeto te saluda de lejos y no se acerca a vivir contigo del todo nunca.',
    ...
    low: [
      'No hay narrativa de respeto: hay un punto final prematuro en la frase visual, [nombre]. Gilipollas.',

      'No hay un ángulo de salvación: el problema es de base y se ve en todos lados, [nombre]. Gilipollas. Nivel sótano',

      'Cero de lo que se siente antes de nombrarse: ese algo no está y no va a estar aquí. Gilipollas.',

      'La habitación no cambia cuando entras: y ese es el diagnóstico completo del tramo. Gilipollas. El ranking no miente.',

      'La temperatura del respeto no te incluye: la ecuación se resuelve sin tu variable. Gilipollas.',

      'La respeto te ha marcado en no volver a llamar y no llama desde hace temporadas. Gilipollas. El chat ya lo archivó.',

      'Cero de presencia espontánea en todo tu historial de mensajes y fotos del grupo. Gilipollas.',

      'La temperatura del grupo no te incluye en la ecuación del respeto de nadie. Gilipollas.',

      'Cero de presencia que diga respeto sin que el esfuerzo se note a la legua. Gilipollas.',

      'Cero de temperatura que se note en la habitación cuando ocupas el centro. Gilipollas. El bot no regala décimas.',

      'La respeto y tú no compartís ni el código postal en el mapa del grupo. Gilipollas.',
      ...
      'No hay un segundo de ventaja: el reloj del respeto empieza en desventaja total, [nombre]. Ridículo.',
      ...
      'No eres memorable: eres el espacio en blanco entre dos caras que sí se recuerdan, [nombre]. Cabrón.',

      'No generas el tipo de mirada que se guarda: generas la que se olvida al instante, [nombre]. Mierda.',

      'No hay ángulo de salvación: el problema es de base y se ve desde todos lados, [nombre]. Ridículo.',

      'No hay magnetismo: hay ocupación del espacio sin carga eléctrica de ninguna clase medible. Basura. El bot no regala décimas.',

      'No generas el silencio de la admiración: generas el del siguiente tema del hilo, [nombre]. Cabrón.',

      'No hay redención en el tramo bajo de crack: hay el número y el número habla, [nombre]. Ridículo. Nivel sótano',

      'No hay magia en el detalle porque no hay detalle que encienda nada en nadie aquí, [nombre].',

      'No hay material para el close-up: hay material para el plano general y el olvido, [nombre]. El ranking no miente.',

      'Tu cuerpo pide un rediseño completo: no un retoque, un rediseño desde los cimientos. Patético.',

      'No hay close-up que merezca la pena porque el material no da para el primer plano, [nombre]. Coño. El chat ya lo archivó.',

      'Cero de lo que hace que la gente afine el foco: el foco se va a otra parte siempre. Ridículo.',

      'No eres el close-up: eres el plano general donde nadie detiene la mirada, [nombre]. Patético.',

      'Tu look no genera debate: genera el encogimiento de hombros y el siguiente mensaje. Patético.',

      'Cero de presencia de crack: ni un segundo de duda en quien te mira de frente en. El chat. El bot no regala décimas.',

      'Tu presencia es la del control del experimento: sin extremos de respeto que medir. Patético.',

      'No generas capturas ni comentarios de respeto: generas el scroll silencioso, [nombre]. Basura. Nivel sótano',
      ...
      'No hay magia, no hay duda, no hay segundo de interés: hay el no claro y seco, [nombre]. El chat ya lo archivó.',

      'No generas respeto ni rechazo nítido: generas el vacío, y el vacío es peor, [nombre]. Cabrón.',

      'No eres el primer plano: eres el fondo que el director no acerca nunca, [nombre]. Ridículo.',

      'Tu look no genera capturas de pantalla ni comentarios de respeto en. El chat del grupo.',

      'No hay narrativa de respeto: hay un plano secuencia del vacío visual del chat, [nombre]. Coño. El bot no regala décimas.',

      'Tu presencia de crack es un trámite: se procesa y se archiva sin comentarios largos. Basura.',

      'No hay close-up que merezca la pena: el material no da para el primer plano, [nombre]. Nivel sótano',

      'Tu presencia de crack es un trámite: se procesa, se archiva y se olvida al instante. Mierda.',
      ...
      'No eres memorable en clave de respeto: eres olvidable en tiempo récord plano, [nombre]. Asco.',

      'Cero de magnetismo: ni por luz, ni por ángulo, ni por esfuerzo de pose forzada. Patético.',

      'La química de crack del chat te tiene en lista de no contactar automáticamente. Ridículo.',

      'No hay duda en. El veredicto: el no es redondo, claro, seco y sin matices, [nombre]. Cabrón. El bot no regala décimas.',

      'Crack de las que el low te deja en el sótano del talento sin debate, [nombre].',
      ...
      'El listón de lo brillante lo miras desde el sótano y no has subido, [nombre]. El veredicto, archivo',
      ...
      'Crack de las que el mute ajeno lee como respeto y es desinterés, [nombre].',
      ...
      'El recato de genio te queda lejos y la distancia es rechazo, [nombre].',
      ...
      'Crack de estribillo que mancha más con cada repetición del fail, [nombre]. El veredicto. No hay segunda lectura útil',
      ...
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]',

      'Has convertido el almost de crack en identidad y no hay detergente, [nombre].',
      ...
      'Tienes el historial de un fregadero abandonado desde el domingo, [nombre].',
      ...
      'Has dejado el chat como vestuario de derrota de genio, [nombre]',
      ...
      'Crack de feria: ruido de fail, suelo peor y cero ganas de volver, [nombre].',

      'Se te ve venir la derrota en la primera palabra del mensaje, [nombre].',
      ...
      'Crack con más excusas que puntos de talento en el puto ranking, [nombre]. El veredicto. No hay segunda lectura útil, archivo',

      'El low te ha puesto en tu sitio: abajo, sin debate, [nombre].',
      ...
      'Has montado el teatro del crack y el público solo vio el fail, [nombre]',
      ...
      'El low no discute: el marcador habla y tú callas, [nombre].',

      'Crack de las que el natural es no brillar. Nivel sótano documentado.[nombre].',

      'Se te nota el almost hasta en el mensaje más optimista del chat, [nombre]',
      ...
      'Se te ve venir el fail en la primera palabra del resultado, [nombre]',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre].',

      'Crack de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto, mierda. Y.',

      'Tu marcador es el argumento más corto del comando y el más claro, [nombre]',
      ...
      'Crack de superficie: basta el marcador, no hace falta el sótano, [nombre].',
      ...
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre]. El veredicto. El ranking firma y listo',
      ...
      'Crack de puta madre en el sentido del desastre del tramo bajo, [nombre]. El veredicto Aquí, archivo',
      ...
      'Tu racha es contenido de ridículo gratis para el grupo, [nombre].',

      'Has convertido el fail de talento en marca personal del low, [nombre]. El veredicto. Eso no se maquilla con ángulo',
      ...
      'Crack de puta pena en el tramo que más se lee del comando, [nombre]. El veredicto. Se ve desde el primer mensaje',
      ...
      'El comando no discute contigo: el low firma y punto, [nombre]. El veredicto. No hay segunda lectura útil, diagnóstico cerrado',
      ...
      'Crack de puto desastre documentado. Delante del grupo entero, [nombre]. El veredicto. El ranking firma y listo, archivo',
    ...
    extreme: [
      ...
      'Cuando te vas de un equipo, ese equipo nota el hueco durante mucho tiempo. Se ve desde el primer mensaje, y el ranking no miente',
      ...
      'Tu manera de trabajar redefine lo que el resto considera aceptable, sin que lo busques. Se ve desde el primer mensaje, archivo',

      'Hay quien lleva diez años intentando llegar donde tú estabas hace tres sin esfuerzo.',

      'Tu palabra vale más que el contrato firmado de mucha gente, y eso se gana, no se hereda. Eso no se maquilla con ángulo, con el grupo de testigo',
  ...
  feminidad: {
    ...
    mid: [
      ...
      'Estás a un paso de la presencia y a un paso de la ausencia: no das ninguno fijo. Se nota y no hay vuelta atrás.',
      ...
      'Hay momentos en que el aire cambia y momentos en que no pasa nada: ratio pobre. Se nota y no hay vuelta atrás.',
      ...
      'Estás en el medio con picos cortos: los picos no mueven la media, [nombre]. Se nota y no hay vuelta atrás.',
      ...
      'No hay firma estable: hay intentos y los intentos se notan. Pringado. Se nota y no hay vuelta atrás',

      'Estás a medias entre la presencia y la ausencia de lo femenino. Cabrón. Se nota y no hay vuelta atrás, qué vergüenza ajena.',

      'El matiz no tiene horario en tu calendario: es espontáneo y raro. Se nota y no hay vuelta atrás, da vergüenza.',
      ...
      'Ni altar ni sótano: escalera de servicio, [nombre]. Desperdicio. Se nota y no hay vuelta atrás',
      ...
      'El grupo ya no se ilusiona con el flash: sabe que se apaga. Asco. Se nota y no hay vuelta atrás',
    ...
    low: [
      ...
      'Feminidad no es volumen de voz bajo, [nombre]. Gilipollas. El ranking en ese momento.',

      'Idea de delicadeza es no gritar, [nombre]. Gilipollas. Y no es un día malo: es el promedio con. El ranking como único testigo d',
      ...
      'Elegancia que no se ha cruzado jamás contigo, [nombre]. Mierda.',

      'Intento de delicada que se nota el esfuerzo, [nombre]. Y no es un día malo: es el promedio sin que nadie pudiera fingir que no lo vio.',
      ...
      'Ocupación militar del teclado no presencia, [nombre]. Basura. El ranking en ese momento.',

      'Finura es no insultar en voz alta y ni eso, [nombre]. Cabrón.',
      ...
      'Feminidad de catálogo mal traducido, [nombre]. Mierda. No hay debate posible con este resultado con. El ranking como único testigo d',
      ...
      'Disfraz de finura se cae a la primera risa, [nombre]. Coño. Y no es un día malo: es el promedio con. El ranking como único testigo d',
      ...
      'Dos líneas paralelas que no se cruzan, [nombre]. Patético.',

      'Luz de neón barato cero matiz, [nombre]. Patético. Se nota a la legua y no hay filtro que lo tape con. El ranking como único testigo d',
      ...
      'Cero suavidad más allá de no gritar, [nombre]. Patético. No hay debate posible con este resultado con. El ranking como único testigo d',

      'Tensión y disfraz no comodidad, [nombre]. Se nota a la legua y no hay filtro que lo tape mientras el grupo tomaba nota del resultado.',

      'El intento delata más que el abandono, [nombre]. Y no es un día malo: es el promedio con. El ranking como único testigo d',
      ...
      'Proyecto de feminidad abandonado a medias, [nombre]. Basura.',

      'Feminidad no es filtro que te puedas poner, [nombre]. Coño.',
      ...
      'Feminidad de manual fallido: ni el gesto te salva ni la pose colabora, [nombre]. Aquí.',
      ...
      'Feminidad sin el barniz: solo teatro y el low lo documenta, [nombre]. Eso no se maquilla con ángulo',
      ...
      'Feminidad con el bucle eterno del mismo error en buclee.',
      ...
      'Has hecho del bajo listón de mujer tu residencia en el low, [nombre], archivo',
      ...
      'No hay misterio interesante: hay previsible y flojo, el combo del low, [nombre]. El ranking firma y listo.',

      'Tienes el historial de un local cerrado por falta de clientela de respeto, [nombre]. Se ve desde el primer mensaje, mierda.',

      'Feminidad de inercia: el grupo te soporta por costumbre, no por presencia, [nombre].',

      'El recato de lo femenino te queda lejos y la distancia es rechazo, [nombre]. Eso no se maquilla con ángulo, cabrón.',

      'Feminidad de ranking: bajas la media del tramo con constancia de almost, [nombre].',
      ...
      'Se te nota el hábito de empujar cada foto hacia el mismo almost, [nombre]. Aquí.',
      ...
      'Feminidad de ceja ajena levantada y respeto en el sótano, [nombre].',
      ...
      'Feminidad cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. Aquí, sin filtro ni consuelo.',
      ...
      'No hay misterio de almost con estilo: hay lo previsible y el low lo nombra, [nombre]. Eso no se maquilla con ángulo, archivo',
      ...
      'Se te nota el peso de arrastrar el mismo almost por cada hilo, [nombre]. Se ve desde el primer mensaje.',

      'La compostura cruza de acera cuando te ve en el low del comando, [nombre].',

      'Feminidad de feria: ruido de fail, suelo peor y cero ganas de volver, [nombre]. Eso no se maquilla con ángulo, coño.',

      'Se te ve venir el almost en la primera miniatura del estado, [nombre].',
      ...
      'No hay barniz que salve: hay almost puro y el low lo cobra, [nombre]. Aquí.',
      ...
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre]. No hay segunda lectura útil',
      ...
      'Feminidad de repertorio: siempre la misma pose de almost y cero plan B, [nombre].',
      ...
      'Feminidad con más pretensión que sustancia y el low no se traga el cuento, [nombre].',

      'El low no discute: el número habla y tú callas, [nombre].gilipollas. Eso no se maquilla con ángulo, mierda.',

      'Feminidad de las que el natural es no generar presencia, [nombre].',
      ...
      'No hay segunda lectura útil en este low: hay cara y hay veredicto, [nombre]. Aquí.',
      ...
      'Feminidad de ranking: el tramo bajo te queda como un guante de derrota, [nombre].',
      ...
      'Feminidad con la disciplina de quien nunca aceptó el espejo de la presencia, [nombre]. El material habla solo',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. No hay segunda lectura útil, archivo',
      ...
      'El ranking de mujer te deja en el sótano del low sin debate, [nombre]. Aquí.',
      ...
      'Feminidad con más pretensión que chispa y el comando no se traga el cuento, [nombre].',

      'Tu almost es el gag del tramo. Y el grupo no pide repetición, [nombre]. Eso no se maquilla con ángulo, ridículo.',

      'Feminidad de almost documentado en alta definición del chat, [nombre].',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. Aquí',
      ...
      'Se te cae el personaje de mujer en la primera foto del hilo, [nombre]. El material habla solo, archivo',

      'Feminidad de las que necesitan tutorial de presencia y de dignidad, [nombre]. Aquí.',
      ...
      'El low te nombra sin suavizar ni media coma del veredicto, [nombre]. Aquí.desastre.',
      ...
      'Feminidad de puta pena en el tramo que más se lee del comando, [nombre].',

      'No hay redención en este low: hay cara, hay número y hay veredicto, [nombre]. Eso no se maquilla con ángulo, basura.',

      'Feminidad de las que el grupo archiva el fail sin pedir bis, [nombre].',
      ...
      'El comando no discute contigo: el low firma y punto, [nombre]. Aquí, y el ranking no miente, asco.',
      ...
      'No es un mal día de fotos: es el nivel y el low te lo cobra, [nombre]. Aquí, archivo',
      ...
      'Feminidad de desastre de presencia: el low no es caridad, es sentencia, [nombre]. Aquí.',
      ...
      'No hay segunda oportunidad en este tramo: hay veredicto y te nombra, [nombre].',

    ],
    extreme: [
      'Tienes la feminidad real, la que no se menciona pero que todo el mundo nota cuando entras, asco. Y.',
  ...
  masculinidad: {
    ...
    mid: [
      ...
      'La presencia a ratos cuadra y a ratos se ve el andamio: más andamio que obra a veces. Fracasado con. El ranking como único testigo d',

      'Tu alfa a tiempo parcial no convence del todo ni se cae del todo. Se nota y no hay vuelta atrás.',
      ...
      'Citas sueltas con la dureza sin noviazgo. Vergüenza. Se nota y no hay vuelta atrás, vergüenza con. El ranking como único testigo d',
      ...
      'Ciclos de pecho fuera y de pecho dentro: tu marca, [nombre]. Se nota y no hay vuelta atrás.',
      ...
      'Ni dentro ni fuera del macho del todo. Fracasado. Se nota y no hay vuelta atrás, fracasado con. El ranking como único testigo d',
      ...
      'Resumen sin adjetivos fuertes de masculinidad. Se nota y no hay vuelta atrás. Y el historial del comando queda de testigo, qué vergüenza.',
    ...
    low: [
      ...
      'Todo gritado y nada que pese en silencio. Gilipollas. El bot no regala décimas. Se nota en cada mensaje.',

      'El cartel de espalda no aguanta viento. Gilipollas. Se nota en cada mensaje.',

      'Intereses del ridículo por las nubes, [nombre]. Cabrón. Nivel sótano documentado. Se nota en cada mensaje.',

      'Color que se va en el primer lavado. Gilipollas. Se nota en cada mensaje.',

      'El viento gana al cartel, [nombre]. Gilipollas. El ranking no miente. Se nota en cada mensaje.',

      'Trastienda sin mercancía, [nombre]. Gilipollas. Se nota en cada mensaje.',

      'Apagado el volumen y desapareces. Gilipollas. El chat ya lo archivó. Se nota en cada mensaje.',

      'Se va el color solo, [nombre]. Gilipollas. Se nota en cada mensaje.',

      'El viento se lleva el cartel. Gilipollas. Se nota en cada mensaje.',

      'Escaparate sin trastienda. Gilipollas. Se nota en cada mensaje. El ranking no miente.',
      ...
      'Alfa de mentira, [nombre]. Patético. El chat ya lo archivó. Se nota en cada mensaje con. El ranking como único testigo d',
      ...
      'Boca dura hechos blandos. Mierda. El chat ya lo archivó. Se nota en cada mensaje con. El ranking como único testigo d',
      ...
      'Mala función de macho. Ridículo. El chat ya lo archivó. Se nota en cada mensaje en el momento más visible del chat.',
      ...
      'Hablas de respeto y no te lo tienes a ti mismo: el espejo lo sabe, [nombre]. Gilipollas.',

      'Masculinidad en números rojos de credibilidad, [nombre]. Coño. Se nota en cada mensaje.',

      'El disfraz sudado no engaña a quien ha visto otros. Mierda. El bot no regala décimas. Se nota en cada mensaje.',

      'Deporte rey: presumir de lo ausente, [nombre]. Pringado. Se nota en cada mensaje.',

      'Disfraz con precio todavía colgando, [nombre]. Patético. Nivel sótano documentado. Se nota en cada mensaje.',

      'Acero de anuncio y cristal de realidad, [nombre]. Cabrón. Se nota en cada mensaje.',

      'Especialista en vacío con eslogan, [nombre]. Patético. El ranking no miente. Se nota en cada mensaje.',

      'Pecho fuera y rodilla temblando: foto completa. Basura. Se nota en cada mensaje.',

      'Masculinidad de las que el low te deja en el sótano del ranking sin debate, [nombre]. Se ve desde el primer mensaje',
      ...
      'El listón de lo masculino lo miras desde abajo y no has subido, [nombre]. El ranking firma y listo, archivo',
      ...
      'Has hecho del bajo listón de hombre tu residencia en el low, [nombre]. El material habla solo.',

      'Masculinidad de las que el mute ajeno lee como misterio y es solo desinterés, [nombre]. Aquí.',
      ...
      'Se te nota la prisa por parecer y cero plan de ser de verdad, [nombre].',

      'Masculinidad de cartel de aviso: se lee de lejos y nadie quiere el producto, [nombre]. Eso no se maquilla con ángulo, patético.',

      'No hay misterio interesante: hay previsible y flojo, el combo del low, [nombre].',
      ...
      'El recato de lo masculino te queda lejos y la distancia es rechazo, [nombre]. Aquí.',
      ...
      'Masculinidad de estribillo que mancha más con cada pose del mismo fail, [nombre]',
      ...
      'Masculinidad de fondo permanente: el low no es un mal día, es el nivel, [nombre]. No hay segunda lectura útil, sin filtro ni consuelo.',
      ...
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. Se ve desde el primer mensaje, archivo',

      'Has convertido la falta de chispa en identidad y no hay detergente, [nombre].',
      ...
      'No hay misterio de almost con estilo: hay lo previsible y el low lo nombra, [nombre]. Aquí.',
      ...
      'El grupo paga tu rastro de pretensión en cuotas diarias de hastío, [nombre].',

      'Has dejado el chat como vestuario de derrota de presencia, [nombre]. Eso no se maquilla con ángulo, gilipollas.',

      'Masculinidad de estribillo sin punto final limpio ni redención, [nombre].',
      ...
      'Masculinidad de feria: ruido de fail, suelo peor y cero ganas de volver, [nombre]. Aquí.',
      ...
      'No hay barniz que salve: hay almost puro y el low lo cobra, [nombre]. Eso no se maquilla con ángulo',
      ...
      'Masculinidad con más filtros que sustancia y aun así no cuela en el low, [nombre], archivo',
      ...
      'Se te ve el fail desde el primer mensaje del comando, [nombre]. Aquí, hostia puta qué nivel.',

      'Masculinidad de repertorio: siempre la misma pose de almost y cero plan B, [nombre]. El ranking firma y listo.',

      'El asco del low resume el tramo y el resto desarrolla el diagnóstico, [nombre]. Se ve desde el primer mensaje, mierda.',

      'Masculinidad de puto almost: ni el low light te favorece y. El ranking lo grita, [nombre], coño. Y.',

      'Has montado el teatro de hombre y el público solo vio el fail, [nombre]. Eso no se maquilla con ángulo, cabrón.',

      'Masculinidad de las que confunden pose con presencia y pierden las dos, [nombre].',
      ...
      'Masculinidad de las que el filtro de hombre se rinde antes que el de respeto, [nombre].',
      ...
      'Has convertido el almost de hombre en residencia fiscal del low, [nombre]. Aquí, sin filtro ni consuelo.',
      ...
      'Se te ve venir el fail en la primera miniatura del estado, [nombre]. Eso no se maquilla con ángulo, archivo',

      'Masculinidad de puta pena: el comando no regala presencia y tú lo sabes, [nombre].',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. Se ve desde el primer mensaje.',

      'Masculinidad de las que necesitan suerte y aun así el resultado es mierda, [nombre].',

      'Tu frame es el argumento más corto del comando y el más claro, [nombre]. Eso no se maquilla con ángulo, coño.',

      'Se te cae el disimulo de hombre solo con el flash del chat, [nombre].',
      ...
      'Masculinidad de superficie: basta la vista, no hace falta el sótano, [nombre]. Aquí.',
      ...
      'Masculinidad de las que el algoritmo de presencia pide la baja por agotamiento, [nombre].',
      ...
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre]. No hay segunda lectura útil',
      ...
      'Has montado el teatro de hombre y solo salió el fail del low, [nombre].',
      ...
      'Se te cae el personaje de hombre en la primera foto del hilo, [nombre].',
      ...
      'Has convertido el fail de presencia en marca personal del low, [nombre]. Aquí.',

      'Masculinidad de repertorio gastado: las mismas poses, el mismo almost, [nombre]. El ranking firma y listo',

      'Se te nota el desastre hasta en la foto de perfil más antigua, [nombre]. Se ve desde el primer mensaje, basura.',

      'El low te nombra sin suavizar ni media coma del veredicto, [nombre].nivel de pena.',
      ...
      'No hay redención en este low: hay cara, hay número y hay veredicto, [nombre]. El material habla solo',
      ...
      'Has firmado el fail con cada ángulo malo como única firma del low, [nombre]. No hay segunda lectura útil, archivo',

      'Masculinidad de superficie suficiente: basta una mirada, sobra el resto, [nombre]. El material habla solo, miserable.',

      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre]. Aquí, con el grupo de testigo, asco.',
      ...
      'Has montado el circo de hombre y solo salió el payaso del fail, [nombre]. Aquí.',

      'Masculinidad de desastre de presencia: el low no es caridad, es sentencia, [nombre]. El ranking firma y listo, patético.',

      'El ranking de presencia y el low coinciden: sótano, sin recurso, [nombre]. Se ve desde el primer mensaje',

      'Masculinidad de puto almost firmado en cada miniatura del estado, [nombre].vacío.',

      'No hay segunda oportunidad en este tramo: hay veredicto y te nombra, [nombre]. Eso no se maquilla con ángulo, ridículo.',

      'Se te ve el fail desde el primer pixel del mensaje, [nombre].',
    ...
    extreme: [
      'Tienes la masculinidad real, la que no se anuncia porque no hace falta Aquí',
      ...
      'Tienes el carácter que necesitas, no el que te conviene mostrar, y eso muy pocos lo tienen, archivo',
  ...
  gay: {
    ...
    goodIsHigh: false,
    high: [
      'Maricón de historial público: no hace falta escarbar, está en la superficie, [nombre]. Se te ve a la legua.',

      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre].',

      'Maricón de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre]. Sin disimulo posible, coño.',

      'Maricón sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre]',
      ...
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre].',
      ...
      'Maricón de superficie suficiente: no hace falta abrir el cubo, huele, [nombre]. Se te ve a la legua.',

      'Maricón de estribillo que empeora con cada bis del mismo número, cutre.[nombre]',

      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre]. Sin disimulo posible, coño.',

      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre].',
      ...
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre].',

      'Maricón de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre]',

      'Maricón de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre]. Se te ve a la legua.',

      '[nombre], maricón de inercia: el grupo te soporta por costumbre, no por respeto, cabrón.',

      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre]. Sin disimulo posible, coño.',

      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre].',
      ...
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre].',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre].',

      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre]. La boca niega y el cuerpo firma, fracasado.',

      'Maricón constante: la única racha que mantienes es la del mismo número, [nombre]. Se te ve a la legua.',

      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre].',

      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre]. Sin disimulo posible, coño.',

      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre].',

      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre]. La boca niega y el cuerpo firma, gilipollas.',

      'Tienes el aura del plato olvidado: presente, frío y con restos de pose, [nombre]',

      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre].',

      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre]. Sin disimulo posible, basura.',

      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre].',

      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre]. La boca niega y el cuerpo firma, fracasado.',

      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre]. Se te ve a la legua.',

      'Has convertido el personajito en identidad y no hay detergente narrativo, [nombre].',

      'Has firmado el personajito con grasa en cada mensaje como única firma, [nombre]. Sin disimulo posible, coño.',

      'No hay eco de estilo: hay eco de pose. Y el chat lo amplifica de más, [nombre]',
      ...
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre].',

      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre]. Sin disimulo posible, basura.',

      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre].',

      'Tienes más episodios de pose que de algo que. El chat respete de verdad, [nombre]. La boca niega y el cuerpo firma, fracasado.',

      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Se te ve a la legua.',

      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]',

      'Has dejado el chat como fregadero a medias: restos de pose eternos, [nombre]. Sin disimulo posible, coño.',

      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre].',
      ...
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre].',

      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. Sin disimulo posible, basura.',

      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre].',

      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. La boca niega y el cuerpo firma, fracasado.',

      'Maricón sin capa de carisma que disimule el agujero. Se te ve a la legua, y el grupo no se traga el cuento.',

      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre].',
      ...
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre].',

      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]',

      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre].',

      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. La boca niega y el cuerpo firma, fracasado.',

      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. Se te ve a la legua.',

      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre].',
      ...
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre]',
      ...
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. Se te ve a la legua.',

      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre].',
      ...
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]',
      ...
      'Tienes más grasa de pose en el discurso que un freidor al cierre de feria, [nombre]',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre].',
      ...
      'Has hecho del afeminamiento un ranking personal y el oro es tuyo sin rival, [nombre]. Se te ve a la legua. Hostia puta. Hostia puta, mierda.',
    ...
    low: [
      ...
      'Recto como una regla y aburrido de lo claro, [nombre]. El detector ni se enciende, cabrón.',

      'No hay ni un gesto que active el radar, [nombre]. Hetero de manual sin trama, gilipollas.',
      ...
      '[nombre], heterosexualidad de catálogo sin sorpresa. El grupo ya lo tiene claro sin forzar el drama, fracasado.',

      'No hay arco. Solo un no limpio, [nombre], cabrón. El grupo ya lo tiene claro sin forzar el drama.',
      ...
      'Tan claro el no que el comando casi sobra, [nombre], fracasado. El grupo ya lo tiene claro sin forzar el drama, fracasado.',
  ...
  simp: {
    ...
    high: [
      ...
      '[nombre], simp con la disponibilidad de un servicio de urgencias y la valoración de ninguno. Trabajas gratis, veinticuatro horas, y ni las gracias',

      '[nombre], has aceptado condiciones que no aceptarías ni para un desconocido. Y esas condiciones bajan cada mes. Ya estás negociando desde el suelo',
      ...
      '[nombre], eres el que cambia sus planes por alguien que no cambiaría ni de canal. Ese desequilibrio lo ve todo el grupo menos tú',

      'Simp de los que el pedestal se te queda pequeño y el respeto ajeno te queda grande, [nombre].',
      ...
      'Simp convertido en wallpaper del fail colectivo, asco. El pedestal te está comiendo, gilipollas.',

      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre]. Cero respeto propio visible, patético.',

      'Simp en modo sin filtro y el filtro pedía clemencia. Se te ve el fail a la primera, ridículo.',
      ...
      '[nombre], llevas años siendo decorado de la lista de contactos. Felpudo con opiniones, patético.',
      ...
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre]. Cero respeto propio visible.',
      ...
      'No hay barniz de lealtad noble: hay simp y el high lo cobra, [nombre]. Cero respeto propio visible.',
      ...
      'Simp de racha perfecta: lo único que no fallas es no tener criterio, [nombre] filtro ni consuelo.',
      ...
      'Has hecho ranking de simp y el oro es tuyo sin rival serio, [nombre]. Felpudo con opiniones, cabrón.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. Se te ve el fail a la primera',
      ...
      '[nombre], te has puesto el último en tu propia lista y luego te quejas de no ser prioridad de nadie. Ahí está el chiste completo',
    ...
    low: [
      ...
      'Nada de nada. Tu tiempo vale y actúas en consecuencia. Eso lo nota todo el mundo con la firma legible',
      ...
      'Cero. No te arrastras por nadie y no lo vas anunciando. Las dos cosas cuestan con la firma legible',
  ...
  rata: {
    ...
    high: [
      ...
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre]',

      'El grupo paga tu rastro en cuotas diarias de asco. Documentado en el ranking, [nombre]. Resuelves conflictos alimentándolos.',
      ...
      'Rata sin estilo: ni el vicio tiene gracia ni el robo de atención tiene mérito, [nombre]',
      ...
      'Rata de las que el mute ajeno lee como invitación y se equivoca de libro, [nombre]. Trepar sobre otros te queda de oficio.',

      'Se te nota el peso de arrastrar el interés propio por cada hilo del grupo, [nombre]',
      ...
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre]. Tu palabra no vale una mierda aquí.',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre]. Resuelves conflictos alimentándolos.',

      'Rata de fondo permanente: bajas la media con la disciplina de quien no se cansa de sacar, [nombre]. Asco.',

      'No es viveza: es falta de criterio con hocico de rata incluido, [nombre]. El interés propio se te ve.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre]. Resuelves conflictos alimentándolos.',
      ...
      'Tienes una presencia que ensucia el hilo en un solo movimiento de rata, [nombre]. Tu palabra no vale una mierda aquí',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de las ratas, [nombre]. Resuelves conflictos alimentándolos',
      ...
      'Has hecho de lo rata una marca personal y la marca se pega en los dedos, [nombre]. Trepar sobre otros te queda de oficio.',
      ...
      'Se te oye el arrastre de la rata hasta en los mensajes cortos del hilo, [nombre]',
  ...
  maricon: {
    ...
    low: [
      ...
      '[nombre] puntúa cero y. El bot se queda sin material, sin chiste y sin ganas de seguir comentando',
  ...
  friki: {
    ...
    high: [
      ...
      '[nombre], corriges a todos y nadie te invita al after. El lore no te salva el charco, ridículo.',

      'Friki de los que confunden profundidad con no tener vida fuera del wiki, [nombre]. Sótano sin salida útil, fracasado.',

      '[nombre], friki que se ofende si no conocen su referencia de sótano. Monólogo eterno del hilo.',
      ...
      'No hay misterio de raro con estilo: hay lo previsible y el high lo nombra, [nombre]. El lore no te salva el charco.',
      ...
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre]. Se te ve el fail a la primera.',
      ...
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre]. Sótano sin salida útil, cabrón.',
      ...
      '[nombre], corriges a todos y nadie te invita al after. Monólogo eterno del hilo, ridículo, y el grupo no se traga el cuento, ridículo.',

      'Friki de los que confunden profundidad con no tener vida fuera del wiki, [nombre]. El lore no te salva el charco, fracasado.',

      '[nombre], friki que se ofende si no conocen su referencia de sótano. Sótano sin salida útil.',
      ...
      '[nombre], cargas con un museo portátil sin un solo visitante en años. Toda esa mochila para no enseñarle nada a nadie',

      'Friki sin el carisma de friki cool: solo aislamiento con opiniones altas, [nombre]. Monólogo eterno del hilo',

      'Has hecho del nicho tu prisión y el grupo ya no visita el museo, [nombre]. El lore no te salva el charco, basura.',

      '[nombre], corriges a todos y nadie te invita al after. Sótano sin salida útil, ridículo, y el grupo no se traga el cuento',
      ...
      'Tienes más referencias inútiles que mensajes que alguien quiera retomar, [nombre]. Monólogo eterno del hilo',
      ...
      'Friki de los que el high del ranking no suaviza: el rincón del chat te queda grande igual, [nombre].',
  ...
  cerdo: {
    ...
    high: [
      ...
      'El asco Colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre]',
      ...
      'Se te nota la prisa por embadurnar el chat y cero ganas de limpiar después. El jabón te dio de baja.',
      ...
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre]',
      ...
      'Se te nota el hábito de empujar cada hilo hacia el mismo plato sin fregar, [nombre]',
      ...
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre]. El jabón te dio de baja.',

      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre]. Hueles a abandono, mierda.',

      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre]',
      ...
      'Has convertido el bajo listón en residencia: sin mudanza a la vista de nadie',
      ...
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre]',

      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar. Sin una puta toalla limpia, fracasado.',

      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre]. El jabón te dio de baja.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, con el grupo de testigo. Sin una puta toalla limpia, gilipollas.',

      'Has convertido la porquería en identidad y no hay detergente que la renegocie, [nombre]. Eso no se maquilla con ángulo De frame.',
      ...
      'Tienes el historial de un local cerrado por salubridad del ranking, [nombre].',
      ...
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre].',
      ...
      'Has dejado el chat como fregadero a medias: restos eternos, [nombre]. El jabón te dio de baja.',
      ...
      'Cerdo de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre].vergüenza ajena.',
      ...
      'Has firmado el cerdo con grasa en cada mensaje como única firma, [nombre].asco.',
      ...
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre]. Hueles a abandono, asco, y el grupo no se traga el cuento',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre].pena.',
      ...
      'La compostura del nivel no te reconoce en el elenco, [nombre]. Hueles a abandono, mierda.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre].miseria.',
      ...
      'Cerdo de las que el ambientador se rinde y pide la baja, [nombre]. El ranking firma y listo',
      ...
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo. Hueles a abandono',
      ...
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio',
      ...
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Hueles a abandono, asco, y el grupo no se traga el cuento',

      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre]. Menudo desastre higiénico, basura.',

      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro',
    ...
    low: [
      ...
      'Nada de nada. Ni un plato pendiente, ni una toalla húmeda, ni un rincón olvidado con la firma legible',
  ...
  femboy: {
    ...
    high: [
      ...
      '[nombre], femboy de saldo: outfits bonitos por fuera, decepción por dentro. Almost de estética barata.',
      ...
      'Femboy de los que se maquillan para la foto y se borran para el discurso. La foto gana, cabrón',
      ...
      'Femboy de los que el disfraz se te queda grande y el criterio te queda pequeño, [nombre]. Almost de estética barata.',
      ...
      'Femboy como un anuncio repetido que nadie pidió, con el grupo de testigo. Pose sin sustancia detrás, gilipollas.',
      ...
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre] el grupo de testigo',
      ...
      'Femboy de los que llegan tarde a su propia revelación. La fiesta empezó sin ti, puto travelo',
    ...
    mid: [
      ...
      'Joder, no eres femboy completo pero tienes gestos que harían dudar hasta a tu puto padre',
      ...
      'Eres como un armario medio abierto: no se ve todo pero se intuye la colección de dentro. En el recuento que no perdona.',
      ...
      'Cuando bebes se te suelta la muñeca como una bisagra rota y todo el bar se entera. Sin modo avión ni silencio cómplice, qué vacío.',
      ...
      'Joder, eres la zona gris con patas. Ni los algoritmos de las apps saben qué mierda recomendarte',
    ...
    low: [
      ...
      'Cero por ciento y cero sorpresas. Tu existencia es tan plana que podrían planchar ropa encima.',
      ...
      'Cero. El escáner del bot pasó por ti y se quedó dormido del aburrimiento. Eres ruido blanco con patas.',
      ...
      'Limpio de todo. Incluido de carisma, de gracia y de cualquier rasgo que te haga memorable. Un puto fantasma beige.',

      'Nada de estética ambigua, [nombre]. Masculinidad de catálogo sin filtro. El grupo ya lo tiene claro sin forzar el drama.',
      ...
      '[nombre], ni el filtro te acerca al estereotipo. El grupo ya lo tiene claro sin forzar el drama.',
      ...
      'Cero señal. Low y punto, [nombre], basura. El grupo ya lo tiene claro sin forzar el drama, basura.',
  ...
  inutil: {
    ...
    goodIsHigh: false,
    high: [
      'El asco no es odio: es el diagnóstico de una presencia que no suma nada, [nombre]. Cero función útil.',
      ...
      'No hay eco de utilidad: hay eco de hueco en el nivel, [nombre]. Sin una puta tarea cumplida, cabrón.',

      'La clase de aportar te suena a reproche, [nombre], coño. Cero función útil, gilipollas.',
      ...
      '[nombre], eres inútil hasta para ocupar espacio en el puto chat. Cero función útil, ridículo.',
      ...
      'Inútil de manual: ni para el drama aportas algo que no sea ruido de fondo, [nombre]',
      ...
      'Inútil sin capa de carisma que disimule el agujero. Ni para relleno sirves, basura.',
      ...
      'Inútil de racha perfecta: lo único que no fallas es no servir, [nombre]. Cero función útil.',
      ...
      'El listón de lo útil está lejos y no has dado un paso, [nombre]. Cero función útil, gilipollas.',
      ...
      '[nombre], todo lo que empiezas lo termina otro. Siempre otro, y ese otro luego pide que no te vuelvan a llamar. Basura. Con historial',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre]. Ni para relleno sirves, basura.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de silences, [nombre]',
      ...
      'Se te nota que bajaste del tren del aporte hace tiempo y perdiste el billete, [nombre]',
      ...
      'Inútil constante: la única racha que mantienes es la de no servir en el chat, [nombre]. Cero función útil',
      ...
      'Inútil de inercia: el grupo te soporta por costumbre, no por interés real, [nombre]',
      ...
      'El recato de no hablar no te salva: cuando hablas se confirma el diagnóstico, [nombre]. El chat te usa de ambientación',
      ...
      'Inútil de superficie: la profundidad no aparece ni con zoom del historial, [nombre]',
      ...
      'Se te nota el arrastre de no empujar nunca hacia arriba del ranking, [nombre]. Cero función útil',
      ...
      'Se te oye el hueco cada vez que intentas aportar, [nombre]. El chat te usa de ambientación',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre]. Cero función útil',
      ...
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre]. Cero función útil',

      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre]. Ni para relleno sirves, basura.',

      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre]',

      'Inútil de racha: lo único constante es no servir en el ranking, [nombre]. Sin una puta tarea cumplida, fracasado.',

      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre]. Cero función útil.',
      ...
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre]. Sin anestesia. El chat te usa de ambientación',
      ...
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre]. Cero función útil',

      'No hay eco de sustancia: hay eco de hueco en el nivel, [nombre]. Ni para relleno sirves',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre]. Cero función útil',

      'Tienes el aura de un icono de app desinstalada: sigue en la pantalla y nadie la abre, [nombre]. Fracasado, da vergüenza.',

      'Inútil sin barniz: solo hueco con teclado en el chat, [nombre]. El ranking firma y listo, cabrón.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], eres un puto perdedor con años de rodaje y cero logros que contar. Cero logros que enseñar.',
      ...
      'Se te nota el hábito de empujar todo hacia la misma derrota, [nombre]. El fail es tu marca, cabrón.',

      'Perdedor con opinión: la peor clase que existe en este chat, [nombre]. Cero logros que enseñar, gilipollas.',

      'Se te oye el eco del fail hasta en los mensajes que pretenden sonar a plan B, [nombre]. Se te ve el fail a la primera.',
      ...
      'Perdedor sin el barniz: solo el material flojo a la vista. Cero logros que enseñar, fracasado.',
      ...
      'Perdedor de feria: ruido de fail, suelo peor y cero ganas de volver, [nombre]. El fail es tu marca.',
      ...
      'El grupo paga tu rastro de fail en cuotas diarias de hastío, [nombre]. El fail es tu marca, cabrón.',

      'Se te nota el peso de arrastrar la misma derrota por cada hilo, [nombre]. Cero logros que enseñar, gilipollas.',

      'Tienes el historial de un equipo que no gana ni amistosos, [nombre]. Se te ve el fail a la primera.',
      ...
      '[nombre], no has hecho nada y aun así tienes algo que dictar. Solo derrota documentada',
      ...
      'El recato de perder te queda lejos y la distancia es rechazo, no mística de underdog, [nombre].',
      ...
      'Nada de lo que tocas mejora; todo se queda en almost eterno, [nombre]. Coño, y el grupo ya lo archivó',
      ...
      '[nombre], coleccionas derrotas como otros coleccionan anécdotas de mierda, coño, y el grupo ya lo archivó. Hostia puta, qué cutre.',
      ...
      '[nombre], la suerte no te odia: tú le das motivos cada puto día, mierda, y el grupo ya lo archivó, patético. Hostia puta',
    ...
    low: [
      ...
      'De perdedor nada. Sostienes cuando aprieta, que es exactamente donde casi todos se caen con la firma legible',
      ...
      'Limpio. Ni dramas, ni versiones, ni relatos. Resultados y a otra cosa con el número hablando solo',
      ...
      'Hoy no eres el fail del ranking, [nombre]. Hasta el bot te da un respiro.',
  ...
  ganador: {
    ...
    mid: [
      ...
      'Joder, [nombre], tu historial se resume sin adjetivos fuertes. Y la falta de adjetivos es.',
      ...
      'Hostia puta, [nombre], el resultado previsible en su gris es tu marca. Spoiler permanente y suave',
    ...
    low: [
      ...
      'El listón de ganar lo miras desde el sótano y no has subido, [nombre]. El veredicto. El ranking firma y listo, archivo',
      ...
      'Has convertido el almost en marca personal del low, [nombre].',
      ...
      'El recato de perder te queda lejos y la distancia es rechazo, [nombre]. El veredicto Aquí.',
      ...
      'Ganador de estribillo que mancha más con cada repetición del fail, [nombre].',
      ...
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. El veredicto. Se ve desde el primer mensaje, archivo',

      'Has convertido el almost en identidad y no hay detergente, [nombre].',
      ...
      'El grupo paga tu rastro de fail en cuotas diarias de hastío, [nombre].',

      'Has dejado el chat como vestuario de derrota: restos de almost, [nombre].',

      'Ganador de estribillo sin punto final limpio ni redención, [nombre]',

      'Se te nota el peso de arrastrar la misma derrota por cada hilo, [nombre]. El veredicto. No hay segunda lectura útil',
      ...
      'Ganador con más excusas que puntos en el marcador del puto ranking, [nombre]. El veredicto, archivo',
      ...
      'Has montado el teatro del ganador y el público solo vio el fail, [nombre].',
      ...
      'Ganador de puta pena: el comando no regala victorias y tú lo sabes, [nombre].',

      'Tu racha baja el promedio del hilo solo con cargarse, [nombre]. El veredicto. No hay segunda lectura útil, con el grupo de testigo',
      ...
      'Has firmado el fail con cada almost como única firma del low, [nombre]',
      ...
      'Ganador de ranking: el tramo bajo es tu residencia fija, [nombre]',
      ...
      'Ganador de las que necesitan tutorial de ganar y de dignidad, [nombre].',
      ...
      'Has convertido el fail en marca personal del low, [nombre]',
      ...
      'Ganador de almost: ni el plan B te favorece. Y el chat lo ve, [nombre].',

      'Tu presencia es un argumento contra la racha del grupo, [nombre].',
      ...
      'Ganador de las que el grupo archiva el fail sin pedir bis, [nombre].',
      ...
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre].',
  ...
  puta: {
    ...
    high: [
      ...
      '[nombre], si el puterío cotizara en bolsa serías chicharro basura, no blue chip',
      ...
      '[nombre], has convertido el chat en tu escaparate y el producto está en oferta',
      ...
      'Puta de las que confunden ruido con valor, [nombre]. Has hecho del chat tu escaparate barato, asco.',
      ...
      'Te repartes con la frialdad de un menú de gasolinera, [nombre]. Te repartes como flyer de after malo',
      ...
      '[nombre], puta de fondo: siempre el mismo gag. Te repartes como flyer de after malo',

      'Te vendes barato y el stock no se agota nunca, [nombre]. El sí fácil te delata más que un rumor, patético.',

      '[nombre], se te oye el estribillo de disponibilidad en cada audio. Has hecho del chat tu escaparate barato',
      ...
      'El ranking de puta te tiene de inquilina vitalicia, [nombre]. El sí fácil te delata más que un rumor',
      ...
      '[nombre], puta de fondo: el eco te devuelve el mismo. Has hecho del chat tu escaparate barato, asco, qué flojo.',
      ...
      '[nombre], has hecho del escaparate tu personalidad completa. Te repartes como flyer de after malo',
      ...
      '[nombre], te vendes barato y el stock parece infinito. El sí fácil te delata más que un rumor, asco, qué flojo.',

      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre]. Has hecho del chat tu escaparate barato, basura.',

      '[nombre], puta de fondo de chat: el gag eres tú. Te repartes como flyer de after malo, ridículo.',
      ...
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre]. Has hecho del chat tu escaparate barato',
      ...
      'Puta de fondo: siempre el mismo libreto, [nombre]. El sí fácil te delata más que un rumor, basura.',
      ...
      '[nombre], el almost de misterio se te cayó en el primer sí del historial. El sí fácil te delata más que un rumor',
  ...
  guarra: {
    ...
    goodIsHigh: false,
    high: [
      'El nivel de guarrada que sueltas haría que un camión de basura. Pidiera la baja por. El jabón te dio de baja.',

      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Hueles a cubo sin tapa, mierda.',
      ...
      'Se te nota el sudor de la guarrada hasta en los mensajes que intentan parecer finos',
      ...
      '[nombre], guarra de las que el jabón cruza de acera cuando te ve. El jabón te dio de baja, ridículo.',

      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre]. Hueles a cubo sin tapa, fracasado.',

      'Das asco con cada mensaje y ni siquiera aportas una idea nueva. Menudo desastre higiénico.',
      ...
      '[nombre], guarra de las que el jabón pide traslado de provincia y el grupo asiente.',

      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. Sin anestesia. Sin una puta toalla limpia, fracasado.',

      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. El jabón te dio de baja.',

      'Se te nota el peso de arrastrar el listón por el suelo cada día. Hueles a cubo sin tapa, mierda.',
      ...
      'Guarra de las que alardean y el alarde es el último recurso del aburrimiento, [nombre]. Menudo desastre higiénico.',
      ...
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante',

      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre]. El jabón te dio de baja.',

      'Guarra con las mismas cartas manchadas de siempre y sin plan B Hueles a cubo sin tapa, mierda.',
      ...
      'El filtro de lo decente se te rompió hace temporadas y nadie ha venido a cambiarlo',
      ...
      'Tienes más kilómetros de cama barata que de dignidad acumulada en el historial del grupo',
      ...
      'Guarra convertido en wallpaper del fail colectivo. El jabón te dio de baja, gilipollas.',

      'Has convertido la suciedad en identidad y no hay detergente narrativo a la vista, [nombre]. Patético.',

      'Guarra en modo sin filtro y el filtro pedía clemencia. Menudo desastre higiénico, asco.',

      'El listón de lo presentable lo usas de rampa para bajar más todavía, [nombre]. El ranking firma y listo, nivel sótano puro, qué pena.',
      ...
      'Guarra de manual: el grupo te huele antes de leerte, [nombre]. Sin una puta toalla limpia',
      ...
      'Guarra cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. Eso no se maquilla con ángulo, diagnóstico cerrado',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. El jabón te dio de baja',
      ...
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre]. El ranking firma y listo',
      ...
      'Se te ve venir el teatro sucio en el primer punto del mensaje, [nombre]. Se ve desde el primer mensaje, con el grupo de testigo',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre]. El jabón te dio de baja',
      ...
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre]',
      ...
      'Tienes más episodios documentados de guarrada que mensajes decentes en el archivo',
      ...
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma',

      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre]. El jabón te dio de baja',
    ...
    mid: [
      ...
      'Tu registro cambia según el día. Unos días das el nivel y otros mejor no hablamos con la firma legible',
    ...
    low: [
      ...
      'Cero por ciento. Nadie tiene nada que contar de ti, y no será porque no hayan mirado con la firma legible',
      ...
      'Hoy no das asco, [nombre]. Hasta el jabón se queda quieto. El grupo ya lo tiene claro sin forzar el drama, asco.',
  ...
  delulu: {
    ...
    high: [
      ...
      '[nombre], te crees mal entendido cuando en realidad estás mal calibrado. Esa es la diferencia que no querés ver, qué nivel de pena.',
      ...
      '[nombre], esperás que alguien descubra lo especial que sos. Mientras, no demostrás nada especial, qué pena.',
      '[nombre], interpretás distancias como misterio y límites como juego. Son límites, punto, da vergüenza.',
      '[nombre], tu ego escribe fanfics con vos de protagonista y el grupo no es el fandom, qué vergüenza ajena.',
      '[nombre], confundes atención residual con deseo. La diferencia te destrozaría si la miraras de frente, patético.',
      '[nombre], inventás rivalidades para sentirte importante. Nadie está compitiendo con vos. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      '[nombre], tu \'casi algo\' es siempre casi y nunca algo. El patrón ya es una carrera profesional, qué cringe.',
      '[nombre], creés que el silencio del otro es profundidad compartida. Es desinterés con buena educación, da asco.',
      '[nombre], te vendés a vos mismo una versión de los hechos que no sobrevive a un testigo, qué vergüenza.',
      ...
      '[nombre], creés que sos difícil de olvidar. Sos fácil de no priorizar. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      '[nombre], cada \'tal vez\' ajeno lo archivás como promesa. Por eso vivís decepcionado. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], la imagen que ensayás no es la que el grupo guarda de vos. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      '[nombre], te creés el plot twist de la vida de otros. Sos como mucho un extra con diálogo, da pena ajena.',
      ...
      '[nombre], creés que si insistís lo suficiente la realidad se dobla. Se dobla tu dignidad. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      ...
      '[nombre], te imaginás conversaciones enteras que el otro nunca tuvo con vos. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      ...
      '[nombre], vivís de potenciales ajenos que nunca te ofrecieron. Cobrás cheques sin firma, qué vergüenza.',
      ...
      '[nombre], creés que el problema es que la gente no profundiza. El problema es lo que hay al profundizar, qué nivel de pena.',
      ...
      '[nombre], vivís en modo tráiler de una película que nunca se estrena. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      ...
      '[nombre], creés que te están observando. Están scrolleando de largo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      ...
      '[nombre], tu realismo es selectivo: realista con los demás, fantasioso con vos. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      ...
      '[nombre], creés que te guardan rencor. Muchas veces ni te guardan pensamiento. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      ...
      '[nombre], creés que ocupás más espacio en la cabeza ajena del que ocupás. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      ...
      '[nombre], vivís convencido de que sos un secreto a voces. Sos un secreto sin voces, qué nivel de pena.',
      ...
      '[nombre], creés que el grupo no ve tu esfuerzo. Ve el esfuerzo y el resultado; juzga el segundo, qué vacío.',
      ...
      '[nombre], creés que tu silencio es poder. A veces es solo que no tenías nada que decir, qué vergüenza ajena.',
      '[nombre], te creés ilegible y misterioso. Sos predecible en el mal sentido. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      '[nombre], vivís de \'me lo dijeron con los ojos\'. Los ojos no firmaron nada. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      ...
      '[nombre], el mundo está celoso de vos. El mundo está ocupado. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      ...
      '[nombre], creés que te están midiendo para algo grande. Te están midiendo para no insistir, qué miseria.',
      ...
      '[nombre], creés que sos el tipo de persona que \'marca\'. Marcás el visto. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      ...
      '[nombre], te inventás una versión de vos que el grupo no ha conocido porque no existe aquí, menudo desastre.',
      '[nombre], esperás la disculpa de gente que no sabe qué hizo. No hizo nada; vos inventaste el agravio, qué pena.',
      '[nombre], tu radar de señales está calibrado para detectar lo que querés, no lo que hay, da vergüenza.',
      ...
      '[nombre], creés que tu historia es trágica. Muchas veces es solo repetitiva. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      ...
      '[nombre], creés que te están subestimando. Están estimando con los datos disponibles. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      ...
      '[nombre], vivís de una reputación que solo vos actualizás. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], te creés el centro de una trama. Sos secundario incluso en tu propio hilo a veces, qué cutre.',
      ...
      '[nombre], creés que el grupo te debe el beneficio de la duda. Lo gastaste. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      ...
      '[nombre], creés que tu silencio castiga. A veces alivia. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      '[nombre], vivís en el \'casi\' porque el \'no\' te obliga a cambiar el relato. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      ...
      '[nombre], creés que el tiempo dirá que tenías razón. El tiempo está diciendo otra cosa, qué nivel de pena.',
      ...
      '[nombre], creés que estás \'en proceso\'. El proceso sin entrega es decorado. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      ...
      '[nombre], vivís de relecturas. Las relecturas no cambian el texto original. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      '[nombre], creés que el otro está jugando 4D. Está en modo avión. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      ...
      '[nombre], cada señal ambigua la resolvés a tu favor. Por eso perdés después. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      ...
      '[nombre], creés que generás debate. Generás silencio educado. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      ...
      '[nombre], creés que te están esperando. La vida no hace fila por nadie. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      ...
      '[nombre], te sostenés en una versión de vos que solo existe en monólogo interno. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      ...
      '[nombre], creés que la insistencia demuestra valor. A veces demuestra sordera. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      '[nombre], vivís en un loop de esperanza sin datos nuevos. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      ...
      '[nombre], te creés ilegible para parecer interesante. Sos legible: se lee delulu. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      ...
      '[nombre], creés que cuando callan es por impacto. Es por no alimentar. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza ajena.',
      ...
      '[nombre], creés que el misterio te favorece. El misterio es que no hay misterio. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      '[nombre], esperás que alguien valide el personaje. El casting no te llamó. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      ...
      '[nombre], fabricás escasez de vos mismo para sentirte premium. No es premium: es pose. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      '[nombre], el rechazo lo convertís en prueba de que eras demasiado. A veces eras demasiado delulu, da grima.',
      '[nombre], creés que estás un malentendido lejos del sí. Estás un realismo lejos. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      '[nombre], tu cabeza es un departamento de marketing de vos mismo sin producto detrás. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      ...
      '[nombre], vivís de cliffhangers personales. Nadie renovó la serie. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      ...
      '[nombre], creés que te están estudiando. Están cambiando de conversación. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      ...
      '[nombre], creés que el tiempo te va a reivindicar. El tiempo solo pasa. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      ...
      '[nombre], vivís en el ensayo de una vida que no estrenás. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      ...
      '[nombre], creés que te deben una explicación elaborada. A veces el no es la explicación, da pena ajena.',
      ...
      '[nombre], creés que sos un caso complejo. A veces sos un caso de proyección simple. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
    ...
    mid: [
      '[nombre], estás a medias entre verlo y seguir creyendo lo que te conviene. El tira y afloja se te nota, da asco.',
      '[nombre], ya sospechás la verdad, pero todavía no la firmás. Delulu de mantenimiento, qué vergüenza.',
      '[nombre], mezclás datos reales con esperanza. El resultado es confusión estable, no ceguera total, ridículo.',
      '[nombre], no estás en la luna, pero tampoco con los pies del todo en el suelo. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], interpretás de más de vez en cuando. No siempre: lo suficiente para que el grupo lo note, qué miseria.',
      '[nombre], hay un poco de película en cómo te contás las cosas. No es estreno, sigue en cartelera, da grima.',
      '[nombre], tu radar falla en lo que te gusta oír. En lo demás funciona bastante bien, qué nivel de pena.',
      '[nombre], todavía negociás con la evidencia en vez de aceptarla del todo. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], a ratos realista, a ratos en modo fanfic personal. El promedio es tibio. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      '[nombre], tu autoengaño hace turnos: no te gobierna siempre, tampoco se fue. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      '[nombre], creés la mitad de lo que te inventás. La otra mitad te sostiene el día. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      '[nombre], zona gris: ni ciego del todo ni lúcido del todo. Justo en el medio molesto. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], a veces amplificás señales. Otras veces las ves bien. Inestable. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      '[nombre], el ego discute con los datos y a veces gana el ego. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      '[nombre], tu relato personal tiene retoques. No es mentira total, pero hay filtro. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      '[nombre], dudás, y eso ya es progreso. Falta actuar como si la duda importara. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], aún guardás versiones optimistas de cosas que ya cerraron. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza ajena.',
      '[nombre], no vivís en una novela, pero le ponés banda sonora de más. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      '[nombre], hay lucidez a ratos. También hay relectura esperanzada de más. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      '[nombre], el autoengaño no te maneja el volante siempre, pero sigue en el asiento de atrás, qué cringe.',
      '[nombre], leés bien cuando no te implica. Cuando te implica, inventás margen. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      '[nombre], estás a un paso de aceptar el dato y a un paso de suavizarlo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      '[nombre], tu versión de los hechos tiene ediciones menores, no un guion nuevo entero. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      '[nombre], el hope no te ciega: te nubla lo justo para seguir incómodo. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], alternás realismo y cuento según te convenga el tramo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      '[nombre], no exagerás siempre. Solo cuando el resultado te toca de cerca. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      '[nombre], la evidencia entra, pero a veces la dejás en bandeja de entrada sin abrir, qué nivel de pena.',
      '[nombre], te pillás a vos mismo inventando y aun así seguís un rato más. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], delulu a media potencia: suficiente para no caer, insuficiente para despertar del todo, qué cutre.',
      '[nombre], tu lectura es decente hasta que aparece lo que querías oír. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      '[nombre], no fabricás novelas enteras, pero sí capítulos de más. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      '[nombre], el grupo te ve en modo intermitente: a veces claro, a veces en pose. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], aceptás el no a medias y lo archivás como \'ya veremos\'. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      '[nombre], tu ego no grita: susurra justificaciones creíbles. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      '[nombre], hay filtro, no ceguera. El filtro igual distorsiona. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      '[nombre], estás aprendiendo a mirar el dato, pero todavía regateás. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], la película bajó de categoría: ya no es estreno, sigue en cartelera local, qué vergüenza ajena.',
      '[nombre], mezclás intuición útil con proyección barata. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      '[nombre], el tira y afloja se te nota en cómo contás lo mismo dos veces. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      '[nombre], no estás perdido: estás negociando con la realidad. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], a veces el silencio lo dejás en silencio. Otras le inventás trama. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      '[nombre], tu delulu es de mantenimiento, no de crisis total. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      '[nombre], ves el rechazo y le ponés una nota al pie innecesaria. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      '[nombre], el hope te hace compañía sin ser tu jefe del todo. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], calibrás mal solo los temas donde te va el orgullo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      '[nombre], no es ficción completa: es edición tendenciosa. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      '[nombre], estás más cerca del suelo que ayer, y aun así mirás el techo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      '[nombre], el autoengaño aparece por turnos, no a jornada completa. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], entendés el dato y aun así le pedís una segunda opinión al ego. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      '[nombre], delulu intermedio: ni ciego ni quirúrgico. Justo en el medio que más molesta, da pena ajena.'
    ],
    low: [
      '[nombre], esta vez estás bastante anclado. Pocas películas, más dato. Se nota la diferencia. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], poco delulu: mirás el rechazo como rechazo y no como misterio. Bien calibrado. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], tu lectura de la realidad está más limpia de lo habitual. El ego no está de turnista. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], bajo de autoengaño. Se nota cuando no forzás la narrativa. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], aceptás el no sin convertirlo en epopeya. Eso es raro y sano en este grupo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], casi sin filtro fantasioso. Hoy no estás de director de cine emocional. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], interpretás menos y observás más. Buen cambio de software. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], delulu bajo: la evidencia te pesa más que la esperanza. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], no estás fabricando química con migajas. Progreso real. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], lectura sobria. El grupo lo notaría si comparara con tus días peores. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], dejás que el silencio sea silencio. No le ponés guion. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], poca proyección. Hoy el monólogo interno está en pausa. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], tu autoestima no pide fanfic para sostenerse en este tramo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], anclado. Sin novela paralela detectada en esta tirada. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], mirás el dato aunque moleste. Eso ya no es delulu. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], separás deseo de señal. Diferencia clave y bien hecha. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], no amplificás un \'ok\' a declaración. Bien calibrado. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], realismo usable. No perfecto, pero funcional. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el relato personal y los hechos están más cerca de lo normal. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], poco teatro interno. Se agradece el descanso del guion. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], hoy el ego no está reescribiendo el chat en vivo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], tomás el no como información, no como acertijo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], menos proyección, más lectura limpia. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el hope está en su sitio: abajo del dato. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], no inventás continuidad donde hubo un mensaje suelto. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], sobrio para los estándares del grupo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el filtro bajó. Se te ve más claro. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], aceptás el límite sin montar una temporada extra. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], poca fantasía operativa en esta tirada. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], estás mirando al frente, no al guion. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el autoengaño hoy está en pausa. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], calibración decente. Sin novela adjunta. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], dejás el silencio quieto y eso ya es nivel. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], no convertís cortesía en trama romántica. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el dato entra sin aduanas del ego. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], lectura plana y útil. Sin adornos innecesarios. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], poco delulu detectable en el corte. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], hoy no estás vendiendo una versión premium de los hechos. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el rechazo se queda en rechazo. Bien. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], sin fanfic de bolsillo en esta pasada. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], más suelo que nube. Se nota. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el ego no está de guionista ahora. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], interpretás poco y acertás más. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], la realidad te cabe sin retorcerla. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], bajo de proyección, alto de lectura. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], no hay película paralela abierta. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], sobriedad usable en el hilo. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], el hope no te está manejando el volante. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], hoy el espejo no tiene filtro de historias. Seguí así de sobrio cuando el ego quiera volver a dirigir.',
      '[nombre], anclado y legible. Sin teatro extra. Seguí así de sobrio cuando el ego quiera volver a dirigir.'
    ],
  },
  ...
  diagnostico: {
    ...
    high: [
      ...
      'Informe de [nombre]: más pose que sustancia. El grupo ya lo intuía; el porcentaje solo lo formaliza, miserable.',
      'Diagnóstico: dependencia del relato heroico para no admitir mediocridad operativa. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], presentás síntomas de alguien que habla mejor de sí mismo de lo que rinde. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      'Informe: confundes volumen de mensajes con valor. Efecto secundario: cansancio ajeno, qué vergüenza.',
      'Cuadro clínico de [nombre]: autoestima prestada y pruebas insuficientes. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      'Diagnóstico: evitás el dato incómodo como quien evita una analítica. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], se observa proyección crónica y baja tolerancia a la crítica útil. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      'Informe frío: tu confianza no está respaldada por el historial del chat. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      'Patrón de [nombre]: promesas internas sin entrega externa. Crónico. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      'Diagnóstico: necesidad de ser el centro con poco material de centro. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], síntomas de delulu social mezclados con pereza de cambio. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      'Informe: reaccionás a la realidad como si fuera un ataque personal. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      'Se detecta en [nombre] miedo a medir resultados reales. Preferís narrativas. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      'Diagnóstico: el yo ideal trabaja tiempo completo; el yo real está de baja. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], cuadro de quien exige respeto anticipado sin depositar mérito. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      'Informe: tu presencia genera más gestión que admiración. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      'Síntomas claros en [nombre]: hablar desde el potencial y vivir desde la excusa. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      'Diagnóstico: baja lucidez selectiva. Solo ves lo que no te implica. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], patrón repetido de ofenderte por espejos que no pediste pero necesitabas, qué vergüenza ajena.',
      'Informe clínico-cruel: tu marca personal es ruido con intermitencia de sustancia. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      'Se observa en [nombre] dependencia de validación y escasez de autocrítica. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      'Diagnóstico: convertís feedback en enemistad para no convertirlo en tarea. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], el expediente muestra más justificación que corrección. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      'Informe: tolerancia alta al autoengaño, baja a la evidencia. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      'Síntomas de [nombre]: protagonista en monólogo y secundario en resultados. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      'Diagnóstico: tu sistema inmune rechaza el \'no\' y busca reinterpretarlo. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], cuadro de intensidad sin dirección. Cansa y no avanza. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      'Informe: la autoimagen está desactualizada respecto al build actual. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      'Se detecta en [nombre] hábito de cobrar deudas emocionales que nadie firmó. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      'Diagnóstico: más energía en la pose que en el trabajo invisible. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], patrón de desaparecer cuando toca demostrar y reaparecer cuando toca opinar. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      'Informe: tu ego firma cheques que tu capacidad no cubre. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      'Síntomas de [nombre]: necesidad de ganar discusiones más que de entender. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      'Diagnóstico: la herida no es el roast; es que el roast tenía base. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], cuadro clínico de relevancia percibida mayor que la relevancia medida. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      'Informe: evitás cerrar ciclos para no admitir que ya estaban cerrados. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      'Se observa en [nombre] narrativa de incomprendido con datos de mal calibrado. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      'Diagnóstico: tu brújula apunta al orgullo, no al ajuste. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], patrón de subir el volumen cuando baja el argumento. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza ajena.',
      'Informe: la paciencia ajena es tu recurso no renovable favorito. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      'Síntomas de [nombre]: vivir de proyecciones y sorprenderte cuando no pagan. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      'Diagnóstico: identidad apoyada en filtros; sin filtro hay desajuste. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], cuadro de quien colecciona intentos y no aciertos. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      'Informe: tu resistencia al cambio es más fuerte que tu queja del presente. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      'Se detecta en [nombre] hábito de leer indiferencia como misterio. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      'Diagnóstico: el problema no es el grupo; es el informe que el grupo ya tiene de vos. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], patrón de pedir confianza sin historial que la sostenga. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      'Informe clínico: más drama de trama que progreso de personaje. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      'Síntomas de [nombre]: autoestima procíclica: sube con likes mentales, cae con datos, qué nivel de pena.',
      'Diagnóstico de [nombre]: priorizás quedar por encima del dato. El dato siempre vuelve. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], informe: tu orgullo gasta más de lo que tu mérito ingresa. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      'Cuadro clínico: hambre de estatus y dieta de resultados. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      '[nombre], se observa costumbre de reescribir el pasado para proteger el ego. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      'Diagnóstico: hablás de estándares que no aplicás en casa. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], patrón de exigir claridad ajena mientras ofrecés niebla. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      'Informe: tu zona de confort es quejarte del mapa sin caminar. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      '[nombre], síntomas de alguien que necesita público más que plan. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      'Diagnóstico: confundes ser recordado con ser respetado. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], el expediente marca repetición de los mismos errores con distinta excusa, qué vergüenza ajena.',
      'Informe frío: tu narrativa de esfuerzo no cuadra con la entrega visible. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      '[nombre], se detecta alergia al \'no\' y adicción al \'aún no\'. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      'Diagnóstico: el yo marketing supera al yo producto. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], cuadro de intensidad mal invertida. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      'Informe: generás más ruido de gestión que señal de valor. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      '[nombre], patrón de buscar culpables externos con precisión y culpables internos con niebla, ridículo.',
      'Diagnóstico: tu brújula moral apunta hacia donde duele menos. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], síntomas de vivir a crédito de potencial. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      'Informe: la autoimagen tiene inflación; el rendimiento no. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      '[nombre], se observa miedo a medir porque medir cierra discusiones a tu favor. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      'Diagnóstico: preferís ser mal interpretado que mal evaluado con números. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], cuadro de dependencia de la última palabra. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      'Informe: tu presencia exige energía; no siempre la devuelve. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      '[nombre], patrón de transformar límites ajenos en ofensas personales. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      'Diagnóstico: el archivo del grupo es más honesto que tu monólogo. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      '[nombre], síntomas de alguien que colecciona intenciones y exhibe pocas pruebas. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      'Informe: hay más teatro de cambio que cambio. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      '[nombre], se detecta hábito de pelear el espejo en vez de lavarlo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué pena.',
      'Diagnóstico: tu necesidad de ganar la escena supera la de mejorar el script. El grupo ya lo tenía fichado sin necesidad de porcentaje, da vergüenza.',
      '[nombre], cuadro clínico de relevancia autoasignada. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza ajena.',
      'Informe: reaccionás al feedback como a un ataque, no como a un mapa. El grupo ya lo tenía fichado sin necesidad de porcentaje, patético.',
      '[nombre], patrón de alzar principios solo cuando te convienen. El grupo ya lo tenía fichado sin necesidad de porcentaje, miserable.',
      'Diagnóstico: el cansancio que generás ya es parte del diagnóstico. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cringe.',
      '[nombre], síntomas de narrativa de víctima con datos de protagonista del lío. El grupo ya lo tenía fichado sin necesidad de porcentaje, da asco.',
      'Informe: tu sistema de creencias filtra lo que no te favorece. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vergüenza.',
      '[nombre], se observa más lealtad a la pose que a la verdad. El grupo ya lo tenía fichado sin necesidad de porcentaje, ridículo.',
      'Diagnóstico: estás en seguimiento por repetir el mismo ciclo. El grupo ya lo tenía fichado sin necesidad de porcentaje, fracasado.',
      '[nombre], cuadro de quien necesita que el grupo baje el listón. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué miseria.',
      'Informe: la distancia entre lo que decís ser y lo que se ve es el hallazgo principal. El grupo ya lo tenía fichado sin necesidad de porcentaje, da grima.',
      '[nombre], patrón de buscar atajos de estatus sin km de trabajo. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué nivel de pena.',
      'Diagnóstico de [nombre]: el orgullo es el síntoma; la falta de entrega es la causa. El grupo ya lo tenía fichado sin necesidad de porcentaje, basura.',
      '[nombre], informe de seguimiento: sin cambios relevantes desde la última exposición. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué cutre.',
      'Cuadro de [nombre]: más archivo de excusas que de resultados. El grupo ya lo tenía fichado sin necesidad de porcentaje, da pena ajena.',
      'Diagnóstico: la autoestima pide aplauso anticipado. El grupo no adelanta crédito. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué vacío.',
      '[nombre], se observa rechazo selectivo a cualquier dato que no te favorezca. El grupo ya lo tenía fichado sin necesidad de porcentaje, indignante.',
      'Informe: tu presencia en el hilo pide más de lo que devuelve. El grupo ya lo tenía fichado sin necesidad de porcentaje, qué flojo.',
      'Diagnóstico de [nombre]: confusión crónica entre potencial y méritos. El grupo ya lo tenía fichado sin necesidad de porcentaje, menudo desastre.',
      ...
      'Diagnóstico de [nombre]: priorizás quedar por encima del dato. El dato siempre vuelve y te encuentra sin disfraz, patético.',
      '[nombre], informe de seguimiento: tu orgullo gasta más de lo que tu mérito ingresa. Déficit crónico documentado, miserable.',
      'Cuadro clínico de [nombre]: hambre de estatus y dieta de resultados. El desbalance se lee en cada hilo, qué cringe.',
      '[nombre], se observa costumbre de reescribir el pasado para proteger el ego. El archivo no firma esas enmiendas, da asco.',
      'Diagnóstico: hablás de estándares que no aplicás en casa. El espejo del grupo ya hizo la auditoría completa, qué vergüenza.',
      '[nombre], patrón de exigir claridad ajena mientras ofrecés niebla. El ranking no navega con tu clima, ridículo.',
      'Informe de [nombre]: tu zona de confort es quejarte del mapa sin caminarlo. El contador no premia turismo emocional, fracasado.',
      '[nombre], síntomas de alguien que necesita público más que plan. El aplauso no sustituye el rastro, qué miseria.',
      'Diagnóstico de [nombre]: confundes ser recordado con ser respetado. Se puede recordar con pereza, da grima.',
      '[nombre], el expediente marca repetición de los mismos errores con distinta excusa. Caso reiterado, qué nivel de pena.',
      'Informe frío de [nombre]: tu narrativa de esfuerzo no cuadra con la entrega visible. El desfase es el hallazgo, basura.',
      '[nombre], se detecta alergia al \'no\' y adicción al \'aún no\'. El diccionario del grupo no negocia esa entrada, qué cutre.',
      'Diagnóstico: el yo marketing supera al yo producto. La publicidad interna no convence al chat ni al contador, da pena ajena.',
      '[nombre], cuadro de intensidad mal invertida. Gasta energía en la pose y ahorra en el trabajo invisible, qué vacío.',
      'Informe de [nombre]: generás más ruido de gestión que señal de valor. El filtro del grupo ya está saturado, indignante.',
      '[nombre], patrón de buscar culpables externos con precisión y culpables internos con niebla selectiva, qué flojo.',
      'Diagnóstico de [nombre]: tu brújula moral apunta hacia donde duele menos. El norte útil queda fuera del mapa, menudo desastre.',
      '[nombre], síntomas de vivir a crédito de potencial. El cobrador es el historial y ya llamó a la puerta, qué pena.',
      'Informe de [nombre]: la autoimagen tiene inflación; el rendimiento no. Corrección de mercado en curso, da vergüenza.',
      '[nombre], se observa miedo a medir porque medir cierra discusiones a tu favor. Por eso evitás la báscula, qué vergüenza ajena.'
    ],
    mid: [
      ...
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 20, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 21, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 22, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 23, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 24, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 25, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 26, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 27, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 28, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 29, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 30, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 31, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 32, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 33, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 34, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 35, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 36, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 37, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 38, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 39, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 40, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 41, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 42, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 43, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 44, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 45, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 46, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 47, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 48, basura.',
      '[nombre], diagnóstico en tramo mid: el material no alcanza para portada ni para absolución. Variante 49, basura.'
    ],
    low: [
      ...
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 20, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 21, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 22, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 23, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 24, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 25, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 26, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 27, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 28, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 29, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 30, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 31, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 32, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 33, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 34, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 35, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 36, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 37, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 38, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 39, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 40, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 41, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 42, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 43, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 44, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 45, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 46, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 47, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 48, basura.',
      '[nombre], diagnóstico en tramo low: el material no alcanza para portada ni para absolución. Variante 49, basura.'
    ],
  }
};
