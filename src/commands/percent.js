...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel como un anuncio repetido que nadie pidió, joder. Pura vergüenza, gilipollas.',
      'Has convertido el resentimiento en identidad. y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder. Hostia puta, asco.',
      ...
      'Incel sin una carta nueva: siempre la misma mano sucia. El grupo ya tomó nota, ridículo.',
      ...
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Pura vergüenza, coño.',
      ...
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre] Menudo numerito, cabrón.',
      ...
      'La compostura del nivel no te reconoce en el elenco social, [nombre] Menudo numerito, patético.',
      ...
      'El high no es un mal día de humor: es.joder. Hostia puta. Se te ve a la legua, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre] Menudo numerito, mierda.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente. Pura vergüenza, coño.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco. Con piernas. El chat no discute, cabrón.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis. Hostia puta, gilipollas.',
      ...
      '[nombre], si te miran de frente es por educación, no por interés. Pura vergüenza, joder.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. De material. El chat no discute, mierda.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet. Hostia puta, coño.',
      'La luz natural te delata como un puto detector de mentiras, [nombre] Sin indulto, cabrón.',
      ...
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo. Pura vergüenza, ridículo.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. Sin plot twist. El chat no discute, fracasado.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes. Hostia puta, joder.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético. Empate. Sin indulto, mierda.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta. El grupo ya tomó nota, coño.',
      ...
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza. Pura vergüenza, asco.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón. De manual. El chat no discute, basura.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil. Hostia puta, ridículo.',
      'Tienes más ángulos muertos que un parking en U, [nombre] Sin indulto, fracasado.',
      '[nombre], la cámara frontal de tu móvil merece una medalla al valor. El grupo ya tomó nota, joder.',
      'Fea de las que el maquillaje es daño colateral, [nombre]. Ridículo. Con base. Sin anestesia, mierda.',
      '[nombre], no hay \\\'te ves mejor en persona\\\': hay decepción escalonada. Se te ve a la legua, coño.',
      'Tu cara es un argumento contra la natalidad irresponsable, [nombre]. Mierda. Heredada. Menudo numerito, cabrón.',
      '[nombre], el high de fea te queda de casa y de apodo. Pura vergüenza, gilipollas.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón. Del ranking. El chat no discute, patético.',
      '[nombre], si te describen es por contraste con lo normal. Hostia puta, asco.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre] Sin indulto, basura.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada. El grupo ya tomó nota, ridículo.',
      'Fea de las que el retrato robado se borra por piedad, [nombre] Sin anestesia, fracasado.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano. Se te ve a la legua, joder.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual. Menudo numerito, mierda.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar. Pura vergüenza, coño.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón. Documentado. El chat no discute, cabrón.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar. Hostia puta, gilipollas.',
      'Tienes una presencia que baja el promedio del group photo, [nombre] Sin indulto, patético.',
      '[nombre], si el atractivo fuera propina, te dejarían monedas de cinco. El grupo ya tomó nota, asco.',
      'Fea de las que el flash avisa antes de disparar, [nombre]. Ridículo preventivo. Sin anestesia, basura.',
      '[nombre], el techo de tu cara es el suelo de casi cualquiera. Se te ve a la legua, ridículo.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda. Rara. Menudo numerito, fracasado.',
      '[nombre], la fealdad te queda tan natural que parece look. Pura vergüenza, joder.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre] El chat no discute, mierda.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado. Hostia puta, coño.',
      'El modo retrato te trata como amenaza, [nombre]. Patético. Software. Sin indulto, cabrón.',
      '[nombre], si te miran mucho es porque no creen lo que ven. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre] Sin anestesia, patético.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\' Se te ve a la legua, asco.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad. Menudo numerito, basura.',
      '[nombre], el high de fea no es insulto, es inventario. Pura vergüenza, ridículo.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón. Plano. El chat no discute, fracasado.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico. Hostia puta, joder.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre] Sin indulto, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta. El grupo ya tomó nota, coño.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral. Sin anestesia, cabrón.',
      '[nombre], el atractivo te bloqueó en todas las redes. Se te ve a la legua, gilipollas.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda. Viral. Menudo numerito, patético.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad. Pura vergüenza, asco.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón. Firme. El chat no discute, basura.',
      '[nombre], tienes cara de final de temporada cancelada. Hostia puta, ridículo.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre] Sin indulto, fracasado.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve. El grupo ya tomó nota, joder.',
      'Fea de las que el group chat prefiere stickers, [nombre] Sin anestesia, mierda.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo. Se te ve a la legua, coño.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda. Legal. Menudo numerito, cabrón.',
      '[nombre], el high te mide y el chat no discute el número. Pura vergüenza, gilipollas.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón. Seco. El chat no discute, patético.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos. Hostia puta, asco.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre] Sin indulto, basura.',
      '[nombre], ni con ring light de influencer te inventas un punto focal. El grupo ya tomó nota, ridículo.',
      'Fea de las que el fotógrafo finge que se le acabó la batería, [nombre] Sin anestesia, fracasado.',
      '[nombre], tu cara es un almost eterno que nunca llega a decente. Se te ve a la legua, joder.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. Con voz, [nombre] Menudo numerito, mierda.',
      '[nombre], el ranking de fea te tiene de inquilino fijo. Pura vergüenza, coño.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre] El chat no discute, cabrón.',
      '[nombre], tienes más fallos faciales que un examen a última hora. Hostia puta, gilipollas.',
      'El close-up es una denuncia anónima contra tu genética, [nombre] Sin indulto, patético.',
      '[nombre], si el atractivo fuera crédito, tu score sería. El grupo ya tomó nota, asco.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre] Sin anestesia, basura.',
      '[nombre], te ves como un borrador que nadie quiso terminar. Se te ve a la legua, ridículo.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre] Menudo numerito, fracasado.',
      '[nombre], el high de fea te queda de tatuaje invisible. Pura vergüenza, joder.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre] El chat no discute, mierda.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué. Hostia puta, coño.',
      'cabrón,cabrón. Hostia puta, cabrón, joder. Hostia puta. Sin indulto, cabrón.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre] Sin anestesia, patético.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta. Se te ve a la legua, asco.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre] Menudo numerito, basura.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre. Pura vergüenza, ridículo.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas. Documentado. El chat no discute, fracasado.',
      '[nombre], tienes una geometría facial que ofende a Euclides. Hostia puta, joder.',
      'El atractivo te dio de baja y no dejó forwarding, [nombre]. Asco. Administrativo. Sin indulto, mierda.',
      '[nombre], si la belleza fuera propina, el camarero te ignoraría. El grupo ya tomó nota, coño.',
      'Fea de las que el selfie se queda en el carrete por vergüenza, [nombre] Sin anestesia, cabrón.',
      '[nombre], el high no es bullying: es el espejo con números. Se te ve a la legua, gilipollas.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre] Menudo numerito, patético.',
      '[nombre], se te nota la falta de suerte genética en cada pixel. Pura vergüenza, asco.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre] El chat no discute, basura.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes. Hostia puta, ridículo.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre] Sin indulto, fracasado.',
      '[nombre], si te miran de reojo es para no comprometerse. El grupo ya tomó nota, joder.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre] Sin anestesia, mierda.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail. Se te ve a la legua, coño.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre] Menudo numerito, cabrón.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano. Pura vergüenza, gilipollas.',
      'Fea de veredicto público y sin narrador emocional, [nombre] El chat no discute, patético.',
      '[nombre], tienes más asimetría que un debate en este puto chat. Hostia puta, asco.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco. De altura. Sin indulto, basura.',
      '[nombre], si el atractivo fuera examen, irías a septiembre. El grupo ya tomó nota, ridículo.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre] Sin anestesia, fracasado.',
      '[nombre], tu cara es un almost de humano decente.joder. Hostia puta. Se te ve a la legua, joder.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre] Menudo numerito, mierda.',
      '[nombre], no hay redención en un ángulo ni en un tutorial. Pura vergüenza, coño.',
      'Fea de manual: el bot firma y el chat archiva, [nombre] El chat no discute, cabrón.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana. Hostia puta, gilipollas.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre] Sin indulto, patético.',
      '[nombre], si te hacen un cumplido es por pena o por agenda. El grupo ya tomó nota, asco.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre] Sin anestesia, basura.',
      '[nombre], el sótano visual te queda de residencia fiscal. Se te ve a la legua, ridículo.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre] Menudo numerito, fracasado.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible. Pura vergüenza, joder.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas. Del ranking. El chat no discute, mierda.',
      '[nombre], tienes cara de final boss de la mala suerte genética. Hostia puta, coño.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre] Sin indulto, cabrón.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre] Sin anestesia, patético.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno. Se te ve a la legua, asco.',
      'Tu frame es el gag del día y el grupo no pide replay, [nombre] Menudo numerito, basura.',
      '[nombre], el high te mide con regla y te deja en negativo. Pura vergüenza, ridículo.',
      ...
      'La luz del flash te trata como evidencia del crimen, [nombre] Sin indulto, mierda.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada. El grupo ya tomó nota, coño.',
      'Fea de las que el selfie stick se acorta solo, [nombre] Sin anestesia, cabrón.',
      '[nombre], el material de base no admite segunda oportunidad. Se te ve a la legua, gilipollas.',
      'Tu cara es un informe sin anexos de caridad, [nombre] Menudo numerito, patético.',
      '[nombre], se te ve el sótano desde la notificación.asco. Hostia puta. Pura vergüenza, asco.',
      'Fea de veredicto que el chat confirma en silencio, [nombre] El chat no discute, basura.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano. Hostia puta, ridículo.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre] Sin indulto, fracasado.',
      '[nombre], si el atractivo fuera crédito, estarías en mora. El grupo ya tomó nota, joder.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre] Sin anestesia, mierda.',
      '[nombre], no hay ángulo: hay rendición documentada.coño. Hostia puta. Se te ve a la legua, coño.',
      'Tu simetría perdió el norte y el sur, [nombre].cabrón. Hostia puta. Menudo numerito, cabrón.',
      '[nombre], el high de fea te queda de apodo no oficial. Pura vergüenza, gilipollas.',
      'Fea sin plot twist de redención en tres mensajes, [nombre] El chat no discute, patético.',
      '[nombre], tienes cara de borrador olvidado en la papelera. Hostia puta, asco.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre] Sin indulto, basura.',
      '[nombre], si te miran fijo es porque no procesan el input. El grupo ya tomó nota, ridículo.',
      'Fea de las que el group chat prefiere audio a foto, [nombre] Sin anestesia, fracasado.',
      '[nombre], el bot te midió dos veces y las dos dio sótano. Se te ve a la legua, joder.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre] Menudo numerito, mierda.',
      '[nombre], el atractivo te dio de baja sin carta de despido. Pura vergüenza, coño.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas. Del comando. El chat no discute, cabrón.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado. Hostia puta, gilipollas.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre] Sin indulto, patético.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2 El grupo ya tomó nota, asco.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre] Sin anestesia, basura.',
      '[nombre], te ves como un almost que se quedó en almost, puta. Se te ve a la legua, ridículo.',
      'El close-up es una denuncia con firma digital, [nombre] Menudo numerito, fracasado.',
      '[nombre], se te ve el techo y está por los suelos.joder. Hostia puta. Pura vergüenza, joder.',
      'Fea de tramo que no admite narrador emocional, [nombre] El chat no discute, mierda.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza. Hostia puta, coño.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco. Firmado. Sin indulto, cabrón.',
      '[nombre], si te hacen un retrato es por relleno de álbum. El grupo ya tomó nota, gilipollas.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre] Sin anestesia, patético.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel. Se te ve a la legua, asco.',
      'Tu cara es el gag visual y nadie pide bis, [nombre] Menudo numerito, basura.',
      '[nombre], el high te deja en el sótano sin ascensor. Pura vergüenza, ridículo.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre] El chat no discute, fracasado.',
      '[nombre], tienes una geometría que ofende al compás. Hostia puta, joder.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre] Sin indulto, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto. El grupo ya tomó nota, coño.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre] Sin anestesia, cabrón.',
      '[nombre], el atractivo te vio y cambió de acera digital. Se te ve a la legua, gilipollas.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre] Menudo numerito, patético.',
      '[nombre], no hay segundo chance: el primero ya fue bastante. Pura vergüenza, asco.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre] El chat no discute, basura.',
      '[nombre], tienes el glow up invertido certificado por el ranking. Hostia puta, ridículo.',
      'La luz natural te delata igual que un interrogatorio, [nombre] Sin indulto, fracasado.',
      '[nombre], si te describen en una palabra, esa palabra insulta. El grupo ya tomó nota, joder.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre] Sin anestesia, mierda.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta. Se te ve a la legua, coño.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre] Menudo numerito, cabrón.',
      '[nombre], el high de fea no es opinión: es el puto número. Pura vergüenza, gilipollas.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre] El chat no discute, patético.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre] Hostia puta, asco.',
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón convertido en wallpaper del fail colectivo.asco. Hostia puta. Se te ve a la legua, asco.',
      ...
      'Maricón con el mismo gag de siempre y cero variación. Hostia puta, joder.',
      'Maricón de las que confunden natural con abandono total del estándar, [nombre] Sin indulto, mierda.',
      ...
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre] Pura vergüenza, asco.',
      ...
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Pura vergüenza, joder.',
      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre] El chat no discute, mierda.',
      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre] Hostia puta, coño.',
      ...
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Hostia puta, joder.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Pura vergüenza, asco.',
      ...
      'Maricón sin capa de carisma que disimule el agujero.coño. Hostia puta. Se te ve a la legua, coño.',
      ...
      'Maricón de ranking: bajas la media del nivel con constancia molesta, [nombre] Hostia puta, asco.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre] Sin indulto, basura.',
      ...
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Pura vergüenza, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre] El chat no discute, cabrón.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre] Hostia puta, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre] Sin indulto, patético.',
      ...
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre] Sin indulto, cabrón.',
      ...
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre] Menudo numerito, basura.',
      'El high no es un mal día de pose: es.ridículo. Hostia puta. Pura vergüenza, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Sin indulto, mierda.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre] Hostia puta, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Sin indulto, fracasado.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo, joder. Se te ve a la legua, asco.',
      'Has convertido la sumisión en identidad. y no hay detergente que la limpie, [nombre] Menudo numerito, basura.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder. Pura vergüenza, ridículo.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder. Hostia puta, joder.',
      ...
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre] Menudo numerito, mierda.',
      ...
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre] Menudo numerito, basura.',
      ...
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre] Pura vergüenza, asco.',
      ...
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre] Se te ve a la legua, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre] Menudo numerito, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre] Pura vergüenza, coño.',
      ...
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre] Menudo numerito, basura.',
      ...
      'El high no es un mal día de carácter: es.mierda. Hostia puta. Sin indulto, mierda.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Se te ve a la legua, gilipollas.',
      'Simp sin complejo útil: el complejo al menos indicaría que viste el pedestal, [nombre] Menudo numerito, patético.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Pura vergüenza, asco.',
  ...
  rata: {
    ...
    high: [
      ...
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder. Sin indulto, basura.',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre] Pura vergüenza, joder.',
      ...
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre] Pura vergüenza, asco.',
      ...
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre] Se te ve a la legua, coño.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Menudo numerito, cabrón.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre] Se te ve a la legua, joder.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre] Menudo numerito, mierda.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre] Pura vergüenza, coño.',
      ...
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre] Menudo numerito, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre] Pura vergüenza, joder.',
      ...
      'Has convertido la rata en carnet. y no hay renovación limpia, [nombre] Se te ve a la legua, asco.',
      ...
      'El high no es un mal día de ética: es.patético. Hostia puta. Menudo numerito, patético.',
      ...
      'El promedio de ratez es este: el nivel no es un mal día, es el nivel, [nombre] Sin indulto, cabrón.',
      ...
      'Has hecho de lo rata tu plato favorito y lo sirves en todas las mesas, [nombre] Hostia puta, joder.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre] Menudo numerito, fracasado.',
      ...
      'Friki con el bucle eterno del mismo error en bucle, joder. Hostia puta, gilipollas.',
      ...
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Pura vergüenza, joder.',
      ...
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre] Menudo numerito, basura.',
      ...
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder. Hostia puta, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre] Se te ve a la legua, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor. Hostia puta, asco.',
      'El asco. No es moralina: es el termómetro y te marca cerdez crónica, [nombre] Sin indulto, basura.',
      ...
      'Cerdo sin capa de carisma que disimule el agujero. Fracasado. Se te ve a la legua, coño.',
      ...
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre] Sin anestesia, cabrón.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre. Sin anestesia, mierda.',
      ...
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre] Pura vergüenza, gilipollas.',
      ...
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Pura vergüenza, coño.',
      ...
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre] Pura vergüenza, joder.',
      ...
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre] Menudo numerito, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Pura vergüenza, asco.',
      ...
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre] Menudo numerito, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre] Pura vergüenza, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] Se te ve a la legua, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre] Menudo numerito, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Pura vergüenza, joder.',
      ...
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre] Menudo numerito, basura.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre] Pura vergüenza, ridículo.',
      ...
      'El high no es un mal día de orden: es.mierda. Hostia puta. Sin anestesia, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] Se te ve a la legua, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre] Menudo numerito, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Pura vergüenza, gilipollas.',
      ...
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual. Pura vergüenza, coño.',
      ...
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible. Sin anestesia, basura.',
      ...
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual. Pura vergüenza, joder.',
      'Tienes una manta que huele desde hace meses y duermes con ella cada noche. Ni un animal aguanta eso, puto guarro.',
      'Has hecho de lo cutre una marca y la marca se pega en los dedos del que lee. Hostia puta, coño.',
      'La palabra clase te suena a reproche y respondes ensuciando un poco más. Sin indulto, cabrón.',
      ...
      'Has convertido la grasa en carnet. y no hay renovación limpia a la vista. Menudo numerito, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla. Pura vergüenza, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B El chat no discute, fracasado.',
      'Has convertido la mancha en identidad. y no hay detergente narrativo a la vista. Hostia puta, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Sin indulto, mierda.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre] El grupo ya tomó nota, coño.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro. Sin anestesia, cabrón.',
  ...
  femboy: {
    ...
    high: [
      ...
      'Femboy en crudo: ni el maquillaje del ranking te cubre. El chat no discute, mierda.',
      ...
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre] Se te ve a la legua, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre] Menudo numerito, basura.',
      ...
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Pura vergüenza, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Pura vergüenza, joder.',
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el nivel, [nombre] Se te ve a la legua, ridículo.',
      'La clase de aportar te suena a reproche, [nombre], coño. Y el chat lo tiene claro. Menudo numerito, fracasado.',
      'El asco. Del nivel es este: presencia sin función, [nombre] Pura vergüenza, joder.',
      ...
      'Se te ve venir el vacío en la primera palabra del mensaje del hilo, [nombre] Hostia puta, coño.',
      ...
      'Inútil sin capa de carisma que disimule el agujero. Pura vergüenza, coño.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre] Se te ve a la legua, ridículo.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre] Menudo numerito, fracasado.',
      ...
      'Tienes el tono de noches de chat sin una frase que pese en el ranking, [nombre] Hostia puta, joder.',
      ...
      'No es gracia seca: es vacío sin gracia en el nivel del comando, [nombre] Se te ve a la legua, coño.',
      ...
      'Se te nota el hábito de empujar cada hilo hacia ninguna parte útil, [nombre] Hostia puta, asco.',
      ...
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre] Pura vergüenza, coño.',
      ...
      'La compostura del aporte no te reconoce en el ranking del grupo, [nombre] Sin anestesia, basura.',
      'No hay barniz de personaje: hay inutilidad pura en el nivel, [nombre] Se te ve a la legua, ridículo.',
      'No hay barniz: hay inutilidad pura en el nivel del comando, [nombre] Menudo numerito, fracasado.',
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre] Pura vergüenza, joder.',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre] Menudo numerito, basura.',
      ...
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre] Hostia puta, joder.',
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre] Sin indulto, mierda.',
      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre] El grupo ya tomó nota, coño.',
      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre] Sin anestesia, cabrón.',
      'Inútil de racha: lo único constante es no servir en el ranking, [nombre] Se te ve a la legua, gilipollas.',
      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre] Menudo numerito, patético.',
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre] Pura vergüenza, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del nivel, [nombre] Hostia puta, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre] Sin indulto, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre] El grupo ya tomó nota, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre] Sin anestesia, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre] Se te ve a la legua, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre] Menudo numerito, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre] El chat no discute, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre] Hostia puta, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre] Sin indulto, basura.',
      'No hay eco de sustancia: hay eco de hueco en el nivel, [nombre] El grupo ya tomó nota, ridículo.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre] Menudo numerito, mierda.',
  ...
  perdedor: {
    ...
    high: [
      ...
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder. Pura vergüenza, ridículo.',
      ...
      'Perdedor sin el barniz: solo el material flojo a la vista. Se te ve a la legua, gilipollas.',
      ...
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre] Se te ve a la legua, joder.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre] Menudo numerito, mierda.',
      'Has hecho del bajo listón tu casa. y no hay mudanza a la vista, [nombre] Pura vergüenza, coño.',
  ...
  puta: {
    ...
    high: [
      ...
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio. Sin indulto, patético.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre] El grupo ya tomó nota, asco.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin. Sin anestesia, basura.',
      'Puta de repertorio corto: las mismas cartas de \'mírame\' en cada mano, [nombre] Se te ve a la legua, ridículo.',
      '[nombre], has hecho del almost de intocable tu marca personal y. Menudo numerito, fracasado.',
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre] Pura vergüenza, joder.',
      ...
      '[nombre], tu sí vale menos que un like anónimo de madrugada. Sin indulto, cabrón.',
      ...
      '[nombre], puta de manual: el ranking te nombra y tú posas. Menudo numerito, basura.',
      'Si el puterío fuera currículum, tendrías páginas de relleno y cero logros, [nombre] Pura vergüenza, ridículo.',
      '[nombre], te abres más fácil que un zip de archivo corrupto. El chat no discute, fracasado.',
      'Puta de las que confunden atención con respeto y se caen del pedestal, [nombre] Hostia puta, joder.',
      '[nombre], el grupo ya no debate: te tiene catalogada y archivada. Sin indulto, mierda.',
      'Has hecho del \'cualquier mira vale\' tu política exterior, [nombre] El grupo ya tomó nota, coño.',
      '[nombre], puta de kilometraje alto y mantenimiento cero. Sin anestesia, cabrón.',
      'Te vendes en liquidación permanente y aun así no se agota el stock, [nombre] Se te ve a la legua, gilipollas.',
      '[nombre], el sí fácil te quedó de tatuaje invisible. Menudo numerito, patético.',
      ...
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre] Hostia puta, ridículo.',
      '[nombre], te repartes con la frialdad de quien ya no espera nada a cambio. Sin indulto, fracasado.',
      'Puta de fondo: el chat te usa de gag y tú sigues el libreto, [nombre] El grupo ya tomó nota, joder.',
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años. Sin anestesia, mierda.',
      'Has convertido cada hilo en casting improvisado, [nombre] Se te ve a la legua, coño.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí. Menudo numerito, cabrón.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre] Pura vergüenza, gilipollas.',
      '[nombre], el ranking de puta te tiene de inquilina fija. El chat no discute, patético.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre] Hostia puta, asco.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza. Sin indulto, basura.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre] El grupo ya tomó nota, ridículo.',
      '[nombre], puta de manual negro: el grupo firma y tú posas. Sin anestesia, fracasado.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre] Se te ve a la legua, joder.',
      '[nombre], has hecho del escaparate tu única personalidad. Menudo numerito, mierda.',
      'Puta de las que confunden circulacion con deseo real, [nombre] Pura vergüenza, coño.',
      '[nombre], te repartes como menú del día: predecible y frío. El chat no discute, cabrón.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre] Hostia puta, gilipollas.',
      '[nombre], puta de kilometraje visible y orgullo de cartón. Sin indulto, patético.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre] El grupo ya tomó nota, asco.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno. Sin anestesia, basura.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre] Se te ve a la legua, ridículo.',
      '[nombre], has convertido el almost de intocable en chiste interno. Menudo numerito, fracasado.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre] Pura vergüenza, joder.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada. El chat no discute, mierda.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre] Hostia puta, coño.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios. Sin indulto, cabrón.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco. Documentado. El grupo ya tomó nota, gilipollas.',
      '[nombre], te repartes con la elegancia de un anuncio popup. Sin anestesia, patético.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre] Se te ve a la legua, asco.',
      '[nombre], puta de las que el sí vale menos que un sticker. Menudo numerito, basura.',
      'Has hecho del chat tu puticlub sin cover, [nombre] Pura vergüenza, ridículo.',
      '[nombre], el ranking te nombra y el resto asiente sin debate. El chat no discute, fracasado.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre] Hostia puta, joder.',
      '[nombre], te abres en canal por atención de segunda. Sin indulto, mierda.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre] El grupo ya tomó nota, coño.',
      '[nombre], tienes más vueltas que el rumor del grupo. Sin anestesia, cabrón.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre] Se te ve a la legua, gilipollas.',
      '[nombre], te vendes en liquidación y el stock no baja. Menudo numerito, patético.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre] Pura vergüenza, asco.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso. El chat no discute, basura.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre] Hostia puta, ridículo.',
      '[nombre], has convertido cada mirada en ticket de entrada. Sin indulto, fracasado.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre] El grupo ya tomó nota, joder.',
      '[nombre], el sí fácil te delata más que un historial público. Sin anestesia, mierda.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre] Se te ve a la legua, coño.',
      '[nombre], puta de kilometraje alto y narrativa baja. Menudo numerito, cabrón.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre] Pura vergüenza, gilipollas.',
      '[nombre], has hecho del escaparate tu único argumento. El chat no discute, patético.',
      'Puta de las que confunden ruido con valor, [nombre].asco. Hostia puta. Hostia puta, asco.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero. Sin indulto, basura.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre] El grupo ya tomó nota, ridículo.',
      '[nombre], puta de manual negro delante del puto chat. Sin anestesia, fracasado.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre] Se te ve a la legua, joder.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\' Menudo numerito, mierda.',
      'Puta de fondo de ranking: inquilina fija del nivel, [nombre] Pura vergüenza, coño.',
      '[nombre], has convertido el almost de misterio en chiste gastado. El chat no discute, cabrón.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre] Hostia puta, gilipollas.',
      '[nombre], puta de las que el chat archiva sin pedir bis. Sin indulto, patético.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre] El grupo ya tomó nota, asco.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano. Sin anestesia, basura.',
      'Puta sin plot twist: solo el mismo libreto, [nombre] Se te ve a la legua, ridículo.',
      '[nombre], te abres en canal por migajas de atención. Menudo numerito, fracasado.',
      'El puterío te queda de uniforme de diario, [nombre] Pura vergüenza, joder.',
      '[nombre], has hecho del sí tu única estrategia social. El chat no discute, mierda.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre] Hostia puta, coño.',
      '[nombre], te vendes en oferta y el precio sigue cayendo. Sin indulto, cabrón.',
      'Se te nota el hambre de validación a la legua, [nombre] El grupo ya tomó nota, gilipollas.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre] Sin anestesia, patético.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros. Se te ve a la legua, asco.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre] Menudo numerito, basura.',
      '[nombre], te repartes como anuncio que nadie puede cerrar. Pura vergüenza, ridículo.',
      'El sí fácil te quedó de cicatriz pública, [nombre] El chat no discute, fracasado.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos. Hostia puta, joder.',
      'Puta de las que confunden circulación con deseo, [nombre] Sin indulto, mierda.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado. El grupo ya tomó nota, coño.',
      'El listón del respeto está en el sótano con tu nombre, [nombre] Sin anestesia, cabrón.',
      '[nombre], puta de fondo: siempre el mismo gag. Se te ve a la legua, gilipollas.',
      'Te vendes barato y el stock no se agota nunca, [nombre] Menudo numerito, patético.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio. Pura vergüenza, asco.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre] El chat no discute, basura.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste. Hostia puta, ridículo.',
      'Has hecho del almost de intocable tu mayor fail, [nombre] Sin indulto, fracasado.',
      '[nombre], puta de las que el putero amateur pediría recibo. El grupo ya tomó nota, joder.',
      'Te repartes con la elegancia de un popup de virus, [nombre] Sin anestesia, mierda.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti. Se te ve a la legua, coño.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre] Menudo numerito, cabrón.',
      '[nombre], el grupo ya no se sorprende: solo documenta. Pura vergüenza, gilipollas.',
      'Te abres en canal por ruido de segunda división, [nombre] El chat no discute, patético.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo. Hostia puta, asco.',
      'El sí fácil te delata más que cualquier captura, [nombre] Sin indulto, basura.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre] El grupo ya tomó nota, ridículo.',
      '[nombre], te vendes en liquidación permanente. Sin anestesia, fracasado.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre] Se te ve a la legua, joder.',
      '[nombre], puta de fondo de hilo y de ranking.mierda. Hostia puta. Menudo numerito, mierda.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre] Pura vergüenza, coño.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí. El chat no discute, cabrón.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre] Hostia puta, gilipollas.',
      '[nombre], te repartes como menú del día en bar de carretera. Sin indulto, patético.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre] El grupo ya tomó nota, asco.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja. Sin anestesia, basura.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre] Se te ve a la legua, ridículo.',
      '[nombre], te abres más fácil que la privacidad en cero. Menudo numerito, fracasado.',
      'El puterío te quedó de marca y no de accidente, [nombre] Pura vergüenza, joder.',
      '[nombre], puta de kilometraje que ya no admite garantía. El chat no discute, mierda.',
      'Te vendes barato y luego quieres trato de boutique, [nombre] Hostia puta, coño.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo. Sin indulto, cabrón.',
      'Puta de manual: el bot confirma lo que el grupo ya sabía, [nombre] El grupo ya tomó nota, gilipollas.',
      'Si la dignidad tuviera alarma, sonaría cada vez que escribes, [nombre] Sin anestesia, patético.',
      '[nombre], puta de fondo: el eco te devuelve el mismo asco. Se te ve a la legua, asco.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre] Menudo numerito, basura.',
      '[nombre], el almost de misterio se te escapó en el primer sí. Pura vergüenza, ridículo.',
      'Puta de las que confunden atención con respeto y caen, [nombre] El chat no discute, fracasado.',
      '[nombre], te abres en canal por migajas y aún así das las gracias. Hostia puta, joder.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre] Sin indulto, mierda.',
      '[nombre], puta de ranking fijo en el sótano del respeto. El grupo ya tomó nota, coño.',
      'Te vendes en oferta y el precio solo baja, [nombre] Sin anestesia, cabrón.',
      '[nombre], se te nota el hambre de validación en cada puto sticker. Se te ve a la legua, gilipollas.',
      'Puta sin plot de redención en tres actos, [nombre] Menudo numerito, patético.',
      '[nombre], has hecho del escaparate tu personalidad completa. Pura vergüenza, asco.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre] El chat no discute, basura.',
      '[nombre], puta de las que el silencio es el único que te pone límite. Hostia puta, ridículo.',
      'Te repartes como flyer de after de mala muerte, [nombre] Sin indulto, fracasado.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión. El grupo ya tomó nota, joder.',
      'Puta de manual negro delante de todo el grupo, [nombre] Sin anestesia, mierda.',
      '[nombre], te abres más que un debate vacío y con menos contenido. Se te ve a la legua, coño.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre] Menudo numerito, cabrón.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo. Pura vergüenza, gilipollas.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre] El chat no discute, patético.',
      '[nombre], te vendes barato y el stock parece infinito. Hostia puta, asco.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre] Sin indulto, basura.',
      '[nombre], puta de fondo de chat: el gag eres tú. El grupo ya tomó nota, ridículo.',
      'El listón del respeto está enterrado con tu historial, [nombre] Sin anestesia, fracasado.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre] Se te ve a la legua, joder.',
      '[nombre], has hecho del sí tu política exterior completa. Menudo numerito, mierda.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre] Pura vergüenza, coño.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0 El chat no discute, cabrón.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre] Hostia puta, gilipollas.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo. Sin indulto, patético.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre] El grupo ya tomó nota, asco.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía. Sin anestesia, basura.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre] Se te ve a la legua, ridículo.',
      '[nombre], puta de las que el almost de intocable es el gag del año. Menudo numerito, fracasado.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre] Pura vergüenza, joder.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre] El chat no discute, mierda.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m. Hostia puta, coño.',
      'El sí fácil te quedó de firma digital en el chat, [nombre] Sin indulto, cabrón.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones. El grupo ya tomó nota, gilipollas.',
      'Te abres más fácil que la configuración por defecto, [nombre] Sin anestesia, patético.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano. Se te ve a la legua, asco.',
      'Puta de fondo: siempre el mismo libreto, [nombre] Menudo numerito, basura.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas. Pura vergüenza, ridículo.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre] El chat no discute, fracasado.',
      '[nombre], has hecho del escaparate tu único talento documentado. Hostia puta, joder.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre] Sin indulto, mierda.',
      '[nombre], si el puterío cotizara, serías warning del bróker. El grupo ya tomó nota, coño.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre] Sin anestesia, cabrón.',
      '[nombre], puta de manual negro: el grupo firma, tú posas. Se te ve a la legua, gilipollas.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre] Menudo numerito, patético.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial. Pura vergüenza, asco.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre] El chat no discute, basura.',
      '[nombre], te abres en canal por migajas y aún pides propina. Hostia puta, ridículo.',
      'El puterío te quedó de uniforme de diario del chat, [nombre] Sin indulto, fracasado.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo. El grupo ya tomó nota, joder.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre] Sin anestesia, mierda.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo. Se te ve a la legua, coño.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre] Menudo numerito, cabrón.',
      '[nombre], puta de fondo de hilo, de ranking y de meme. Pura vergüenza, gilipollas.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre] El chat no discute, patético.',
      '[nombre], el bot te midió y el grupo ya había firmado el parte. Hostia puta, asco.',
    ],
    mid: [
  ...
  guarra: {
    ...
    high: [
      ...
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Sin indulto, cabrón.',
      ...
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre] Sin indulto, mierda.',
      'Das asco con cada mensaje y ni siquiera aportas una idea nueva. El grupo ya tomó nota, coño.',
      'Se te ve la prisa por ensuciar el hilo y cero ganas de limpiarlo después. Sin anestesia, cabrón.',
      'El asco. No es moralina: es diagnóstico de cómo ocupas el espacio del chat. Se te ve a la legua, gilipollas.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis. Menudo numerito, patético.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat. Pura vergüenza, asco.',
      'El asco. Es.basura,basura. Hostia puta. Hostia puta. El chat no discute, basura.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile. Hostia puta, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat. Sin indulto, fracasado.',
      'El asco. No es pruderie: es el termómetro y te marca fiebre de cutrez crónica. El grupo ya tomó nota, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. Sin anestesia, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. Se te ve a la legua, coño.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día. Menudo numerito, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para. El chat no discute, patético.',
      ...
      'Guarra con las mismas cartas manchadas de siempre y sin plan B Menudo numerito, cabrón.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder. Se te ve a la legua, asco.',
      'Has convertido la suciedad en identidad. y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder. Pura vergüenza, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder. Hostia puta, joder.',
      ...
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre] Se te ve a la legua, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Menudo numerito, basura.',
      ...
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Pura vergüenza, asco.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Pura vergüenza, coño.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre] Pura vergüenza, joder.',
      ...
      'El high no es un mal día de orden: es.joder. Hostia puta. Hostia puta, joder.',
      ...
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar. Pura vergüenza, joder.',
