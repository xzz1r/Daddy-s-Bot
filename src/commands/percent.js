...
const LABELS = {
  ...
  maricon: {
    ...
    high: [
      ...
      'Se te ve la pluma hasta en el audio de buenos días, [nombre]. Gilipollas, y el chat ya tomó nota, gilipollas.',
      'Maricón de historial público: no hace falta escarbar, está en la superficie del chat, [nombre]. Coño.',
      '[nombre], dices que te gustan las tías pero el cuerpo te delata en cada puto hilo, cabrón, y el chat ya tomó nota, asco.',
      'Maricón sin disimulo útil: el disimulo al menos indicaría vergüenza, [nombre]. Asco, y el chat ya tomó nota, basura.',
      'El grupo no necesita detector: te basta abrir la boca dos segundos de más, [nombre]. Patético, y el chat ya tomó nota, ridículo.',
      '[nombre], has hecho de la pose tu única personalidad y el chat te tiene de meme, mierda, y el chat ya tomó nota, fracasado.',
      'Maricón de cartel: se ve el anuncio y nadie quiere la función, [nombre]. Ridículo, y el chat ya tomó nota, joder.',
      '[nombre], confundes límites ajenos con permiso para seguir el show, fracasado, y el chat ya tomó nota, mierda.',
      'Se te oye la voz de final de mes cada vez que niegas de más, [nombre]. Basura, y el chat ya tomó nota, coño.',
      'Maricón de los que miran con devoción y luego predican lo contrario, [nombre]. Joder, y el chat ya tomó nota, cabrón.',
      '[nombre], el almost de hetero se te cae en cada reacción del chat, gilipollas, y el chat ya tomó nota, gilipollas.',
      'Has convertido la ambigüedad en gag y el grupo ya no se ríe, solo documenta, [nombre]. Coño, y el chat ya tomó nota, patético.',
      'Maricón de superficie: huele el cerrado sin abrir el cubo, [nombre]. Cabrón, y el chat ya tomó nota, asco.',
      '[nombre], niegas tanto que el propio no se te nota forzado, asco, y el chat ya tomó nota, basura, y el grupo no se traga el cuento, basura.',
      'El ranking de maricón te tiene de ejemplo cuando alguien pregunta, [nombre]. Patético, y el chat ya tomó nota, ridículo.',
      '[nombre], tu disimulo dura menos que un estado de 24 horas, mierda, y el chat ya tomó nota, fracasado.'
    ],
    mid: [
  ...
  perdedor: {
    ...
    high: [
      ...
      '[nombre], coleccionas derrotas como otros coleccionan anécdotas de mierda, coño, y el grupo ya lo archivó, joder.',
      'Perdedor de los que llaman mala suerte a su propia falta de oficio, [nombre]. Gilipollas, y el grupo ya lo archivó, mierda.',
