...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      '[nombre], llevas tanto sin que te toquen que ya no es abstinencia, es un diagnóstico. Y el diagnóstico lo firma el grupo entero por unanimidad, pringado, asco.',
      ...
      'Incel de manual: repartes culpa y no te has mirado nunca de verdad, [nombre]. Sin anestesia posible, coño.',
      'Se te nota el rastro de incel hasta en los mensajes que pretenden ser neutrales, [nombre], ridículo.',
      'Incel como un anuncio repetido que nadie pidió, joder. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      ...
      'Incel sin una carta nueva: siempre la misma mano sucia, joder. Y no hay forma de maquillarlo, ridículo.',
      ...
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre]. Sin anestesia posible, joder.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre]. Puro circo barato, mierda.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre]. Sin anestesia posible, ridículo.',
      'No hay misterio interesante: hay previsible y amargado, el combo del high, [nombre]. Puro circo barato, fracasado.',
      'Tienes el historial de un foro abandonado: posts de odio, cero vida, [nombre] Menudo desastre, joder.',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu mismo sótano, [nombre]. Sin anestesia posible, asco.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Puro circo barato, basura.',
      'Incel de fondo permanente: el high no es un mal día, es el nivel, [nombre] Menudo desastre, ridículo.',
      'No es profundidad: es amargura con teclado y el high te la cobra, [nombre] El ranking firma y listo, fracasado.',
      'Tienes más grasa de resentimiento que un wiki sin editores decentes, [nombre] Se ve desde el primer mensaje De frame, joder.',
      ...
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre]. Sin anestesia posible, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre]. Puro circo barato, patético.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre] Menudo desastre, asco.',
      ...
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre]. Sin anestesia posible, coño.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre]. Puro circo barato, cabrón.',
      'Se te nota el peso de arrastrar el mismo sótano por cada conversación, [nombre] Menudo desastre, gilipollas.',
      ...
      'No hay barniz de genio incomprendido: hay amargura y el high lo cobra, [nombre]. Sin anestesia posible, joder.',
      'Tienes el tono de quien acumula fichas de odio y nunca invita a jugar limpio, [nombre]. Puro circo barato, mierda.',
      'Incel de las que alardean del sótano porque el exterior las deja sin personaje, [nombre] Menudo desastre, coño.',
      ...
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre]. Sin anestesia posible, ridículo.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre]. Puro circo barato, fracasado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre] Menudo desastre, joder.',
      ...
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre]. Sin anestesia posible, asco.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. Puro circo barato, basura.',
      'No hay barniz de antihéroe nerd: hay amargura y el high la nombra, [nombre] Menudo desastre, ridículo.',
      ...
      'Se te nota el hábito de empujar cada hilo hacia el rincón sin ventana, [nombre]. Sin anestesia posible, gilipollas.',
      'La compostura del tramo no te reconoce en el elenco social, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre] Menudo desastre, asco.',
      ...
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] Eso no se maquilla con ángulo De frame, joder.',
      ...
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre]. Sin anestesia posible, coño.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre]. Puro circo barato, cabrón.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre] Menudo desastre, gilipollas.',
      ...
      'El high no es un mal día de humor: es. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre] Menudo desastre, coño.',
      ...
      'No es estilo amargo con gracia: eres incel y el high no discute la evidencia, [nombre]. Sin anestesia posible, ridículo.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], no es que te falte ángulo: es que te faltan los tres y el cuarto también. Sin anestesia posible, joder.',
      'Tienes el atractivo de un martes lluvioso en una sala de espera, [nombre]. Pura mierda. Estética, mierda.',
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente. Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco. Con piernas. Se te ve el forro, cabrón.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Se te nota la fealdad hasta en la miniatura del estado, [nombre]. Ridículo de bulto. Sin debate útil, patético.',
      '[nombre], el modo retrato de tu móvil debería venir con advertencia sanitaria. Y no hay forma de maquillarlo, asco.',
      'Fea de las que hacen que el fotógrafo cobre extra por trauma, [nombre]. Mierda. Pura. El grupo ya lo huele, basura.',
      '[nombre], no hay misterio: hay huesos de mala suerte y piel que no perdona. Sin anestesia posible, ridículo.',
      'Tu simetría es un chiste malo contado dos veces, [nombre]. Fracasado. Del catálogo visual, fracasado.',
      '[nombre], si te miran de frente es por educación, no por interés. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. De material. Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet. Hostia qué nivel, coño.',
      'La luz natural te delata como un puto detector de mentiras, [nombre]. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], no eres \\\'interesante\\\': eres difícil de mirar y punto. Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el group selfie se recorta solo, [nombre]. Ridículo automático. El grupo ya lo huele, patético.',
      '[nombre], tu cara pide un softbox y un milagro, y no hay presupuesto para ninguno. Sin anestesia posible, asco.',
      'Si el atractivo fuera nota, tú irías a recuperación en agosto, [nombre]. Mierda. Académica. Puro circo barato, basura.',
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. Sin plot twist. Se te ve el forro, fracasado.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético. Empate. Sin debate útil, mierda.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta. Y no hay forma de maquillarlo, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de las que el espejo del ascensor tiene traumas, [nombre]. Ridículo móvil. El grupo ya lo huele, cabrón.',
      '[nombre], tienes el tipo de cara que hace cambiar de acera sin confesarlo. Sin anestesia posible, gilipollas.',
      'No es un mal día: es el material de base, [nombre]. Puta mierda. Estructural. Puro circo barato, patético.',
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón. De manual. Se te ve el forro, basura.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Tienes más ángulos muertos que un parking en U, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], la cámara frontal de tu móvil merece una medalla al valor. Y no hay forma de maquillarlo, joder.',
      'Fea de las que el maquillaje es daño colateral, [nombre]. Ridículo. Con base. El grupo ya lo huele, mierda.',
      '[nombre], no hay \\\'te ves mejor en persona\\\': hay decepción escalonada. Sin anestesia posible, coño.',
      'Tu cara es un argumento contra la natalidad irresponsable, [nombre]. Mierda. Heredada. Puro circo barato, cabrón.',
      '[nombre], el high de fea te queda de casa y de apodo. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón. Del ranking. Se te ve el forro, patético.',
      '[nombre], si te describen es por contraste con lo normal. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada. Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el retrato robado se borra por piedad, [nombre] El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano. Sin anestesia posible, joder.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar. Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón. Documentado. Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Tienes una presencia que baja el promedio del group photo, [nombre]. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], si el atractivo fuera propina, te dejarían monedas de cinco. Y no hay forma de maquillarlo, asco.',
      'Fea de las que el flash avisa antes de disparar, [nombre]. Ridículo preventivo. El grupo ya lo huele, basura.',
      '[nombre], el techo de tu cara es el suelo de casi cualquiera. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda. Rara. Puro circo barato, fracasado.',
      '[nombre], la fealdad te queda tan natural que parece look. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre] Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      'El modo retrato te trata como amenaza, [nombre]. Patético. Software. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], si te miran mucho es porque no creen lo que ven. Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\' Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], el high de fea no es insulto, es inventario. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón. Plano. Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta. Y no hay forma de maquillarlo, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral. El grupo ya lo huele, cabrón.',
      '[nombre], el atractivo te bloqueó en todas las redes. Sin anestesia posible, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda. Viral. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón. Firme. Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], tienes cara de final de temporada cancelada. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve. Y no hay forma de maquillarlo, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de las que el group chat prefiere stickers, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda. Legal. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el high te mide y el chat no discute el número. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón. Seco. Se te ve el forro, patético.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], ni con ring light de influencer te inventas un punto focal. Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el fotógrafo finge que se le acabó la batería, [nombre] El grupo ya lo huele, fracasado.',
      '[nombre], tu cara es un almost eterno que nunca llega a decente. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. Con voz, [nombre]. Puro circo barato, mierda.',
      '[nombre], el ranking de fea te tiene de inquilino fijo. Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre] Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], tienes más fallos faciales que un examen a última hora. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'El close-up es una denuncia anónima contra tu genética, [nombre]. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], si el atractivo fuera crédito, tu score sería basura. Y no hay forma de maquillarlo, asco.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre] El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], te ves como un borrador que nadie quiso terminar. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre]. Puro circo barato, fracasado.',
      '[nombre], el high de fea te queda de tatuaje invisible. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre] Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué. Hostia qué nivel, coño.',
      ' Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón Hostia puta, cabrón, joder Y el grupo no necesita más pruebas, joder.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos. Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas. Documentado. Se te ve el forro, fracasado.',
      '[nombre], tienes una geometría facial que ofende a Euclides. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'El atractivo te dio de baja y no dejó forwarding, [nombre]. Asco. Administrativo. Sin debate útil, mierda.',
      '[nombre], si la belleza fuera propina, el camarero te ignoraría. Y no hay forma de maquillarlo, coño.',
      'Fea de las que el selfie se queda en el carrete por vergüenza, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], el high no es bullying: es el espejo con números. Sin anestesia posible, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], se te nota la falta de suerte genética en cada pixel. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], si te miran de reojo es para no comprometerse. Y no hay forma de maquillarlo, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Fea de veredicto público y sin narrador emocional, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], tienes más asimetría que un debate en este puto chat. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco. De altura. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], si el atractivo fuera examen, irías a septiembre. Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre] El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], tu cara es un almost de humano decente. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], no hay redención en un ángulo ni en un tutorial. Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de manual: el bot firma y el chat archiva, [nombre] Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre]. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], si te hacen un cumplido es por pena o por agenda. Y no hay forma de maquillarlo, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre] El grupo ya lo huele, basura.',
      '[nombre], el sótano visual te queda de residencia fiscal. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre]. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas. Del ranking. Se te ve el forro, mierda.',
      '[nombre], tienes cara de final boss de la mala suerte genética. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre]. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa. Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Tu frame es el gag del día y el grupo no pide replay, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], el high te mide con regla y te deja en negativo. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea sin consuelo de \\\'personalidad\\\': el comando no mide eso, [nombre] Se te ve el forro, fracasado.',
      '[nombre], tienes más problemas de proporciones que un plano de arquitecto borracho. Hostia qué nivel, joder.',
      'La luz del flash te trata como evidencia del crimen, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada. Y no hay forma de maquillarlo, coño.',
      'Fea de las que el selfie stick se acorta solo, [nombre] El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el material de base no admite segunda oportunidad, puta. Sin anestesia posible, gilipollas.',
      'Tu cara es un informe sin anexos de caridad, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], se te ve el sótano desde la notificación. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de veredicto que el chat confirma en silencio, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], si el atractivo fuera crédito, estarías en mora. Y no hay forma de maquillarlo, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], no hay ángulo: hay rendición documentada. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Tu simetría perdió el norte y el sur, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el high de fea te queda de apodo no oficial. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Fea sin plot twist de redención en tres mensajes, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], tienes cara de borrador olvidado en la papelera. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], si te miran fijo es porque no procesan el input. Y no hay forma de maquillarlo, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea de las que el group chat prefiere audio a foto, [nombre] El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], el bot te midió dos veces y las dos dio sótano. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], el atractivo te dio de baja sin carta de despido. Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas. Del comando. Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre]. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2 Y no hay forma de maquillarlo, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre] El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], te ves como un almost que se quedó en almost, puta. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El close-up es una denuncia con firma digital, [nombre]. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], se te ve el techo y está por los suelos. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Fea de tramo que no admite narrador emocional, [nombre] Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco. Firmado. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], si te hacen un retrato es por relleno de álbum. Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel. Sin anestesia posible, asco.',
      'Tu cara es el gag visual y nadie pide bis, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], el high te deja en el sótano sin ascensor. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre] Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], tienes una geometría que ofende al compás. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto. Y no hay forma de maquillarlo, coño.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre] El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el atractivo te vio y cambió de acera digital. Sin anestesia posible, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], no hay segundo chance: el primero ya fue bastante. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], tienes el glow up invertido certificado por el ranking. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'La luz natural te delata igual que un interrogatorio, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], si te describen en una palabra, esa palabra insulta. Y no hay forma de maquillarlo, joder.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el high de fea no es opinión: es el puto número. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre]. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
  ...
  gay: {
    ...
    goodIsHigh: false,
    high: [
      'Maricón de historial público: no hace falta escarbar, está en la superficie, [nombre]. Hostia qué nivel, coño.',
      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre]. Sin debate útil, cabrón.',
      'Maricón de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      'Maricón sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre] El grupo ya lo huele, patético.',
      'Maricón convertido en wallpaper del fail colectivo. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre]. Puro circo barato, basura.',
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre] Menudo desastre, ridículo.',
      'Maricón de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] Se te ve el forro, fracasado.',
      'Maricón con el mismo gag de siempre y cero variación. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Maricón de las que confunden natural con abandono total del estándar, [nombre]. Sin debate útil, mierda.',
      'Maricón de superficie suficiente: no hace falta abrir el cubo, huele, [nombre]. Y no hay forma de maquillarlo, coño.',
      'Maricón de estribillo que empeora con cada bis del mismo número cutre, [nombre] El grupo ya lo huele, cabrón.',
      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre]. Sin anestesia posible, gilipollas.',
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre]. Puro circo barato, patético.',
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre] Se te ve el forro, basura.',
      'Maricón de puta madre: el high no suaviza el teatro ni el personajito del ranking, [nombre]. Patético.',
      'Maricón cutre de manual: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Sin debate útil, fracasado.',
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. Y no hay forma de maquillarlo, joder.',
      'Maricón de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre] El grupo ya lo huele, mierda.',
      'Maricón de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre]. Sin anestesia posible, coño.',
      'El asco No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre]. Puro circo barato, cabrón.',
      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre] Menudo desastre, gilipollas.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] Se te ve el forro, patético.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre]. Hostia qué nivel, asco.',
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre]. Sin debate útil, basura.',
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre]. Sin anestesia posible, joder.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre]. Puro circo barato, mierda.',
      'Maricón constante: la única racha que mantienes es la del mismo número, [nombre] Menudo desastre, coño.',
      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre] Se te ve el forro, cabrón.',
      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre]. Hostia qué nivel, gilipollas.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre]. Sin debate útil, patético.',
      'La dignidad del tramo no para el coche: tú eres el tráfico del arcén, [nombre]. Y no hay forma de maquillarlo, asco.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de pose, [nombre] El grupo ya lo huele, basura.',
      'El promedio del high es este: no un mal día, el nivel del tramo completo, [nombre]. Sin anestesia posible, ridículo.',
      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre]. Puro circo barato, fracasado.',
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Menudo desastre, joder.',
      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre] Se te ve el forro, mierda.',
      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre]. Hostia qué nivel, coño.',
      'Has convertido el personajito en identidad y no hay detergente narrativo, [nombre]. Sin debate útil, cabrón.',
      'Has firmado el personajito con grasa en cada mensaje como única firma, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      'No hay eco de estilo: hay eco de pose. Y el chat lo amplifica de más, [nombre] El grupo ya lo huele, patético.',
      'Maricón visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Sin anestesia posible, asco.',
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. Puro circo barato, basura.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Menudo desastre, ridículo.',
      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre] Se te ve el forro, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre]. Hostia qué nivel, joder.',
      'Tienes más episodios de pose que de algo que. El chat respete de verdad, [nombre]. Sin debate útil, mierda.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Y no hay forma de maquillarlo, coño.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] El grupo ya lo huele, cabrón.',
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre]. Sin anestesia posible, gilipollas.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre]. Puro circo barato, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Menudo desastre, asco.',
      'Tu mensaje es un aviso de lo que no hay que tomar en serio en el grupo, [nombre] Se te ve el forro, basura.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre]. Hostia qué nivel, ridículo.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. Sin debate útil, fracasado.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre]. Y no hay forma de maquillarlo, joder.',
      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. Y el chat lo tiene claro, asco.',
      'Maricón sin capa de carisma que disimule el agujero. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Puro circo barato, cabrón.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre] Menudo desastre, gilipollas.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre] Se te ve el forro, patético.',
      'Maricón de ranking: bajas la media del tramo con constancia molesta, [nombre]. Hostia qué nivel, asco.',
      'No es atrevimiento: es suciedad de personaje y el tramo te la cobra, [nombre]. Sin debate útil, basura.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre] El grupo ya lo huele, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre]. Sin anestesia posible, joder.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. Puro circo barato, mierda.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Menudo desastre, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre] Se te ve el forro, cabrón.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre]. Hostia qué nivel, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre]. Sin debate útil, patético.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre]. Y no hay forma de maquillarlo, asco.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre] El grupo ya lo huele, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. Sin anestesia posible, ridículo.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. Puro circo barato, fracasado.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Y el chat lo tiene claro, joder.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre] Se te ve el forro, mierda.',
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. Y el chat lo tiene claro, coño.',
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre]. Sin debate útil, cabrón.',
      'Maricón de los que el high del ranking no perdona ni un frame, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre] El grupo ya lo huele, patético.',
      'No hay barniz que salve: hay pose pura y no se vende como carisma, [nombre]. Y el chat lo tiene claro, asco.',
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'El high no es un mal día de pose: es. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      ...
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre] Se te ve el forro, basura.',
      ...
      'Se te nota que ensuciaste el hilo de pose hace tiempo y perdiste el bayeta, [nombre]. Sin debate útil, fracasado.',
      ...
      'Tienes más grasa de pose en el discurso que un freidor al cierre de feria, [nombre] El grupo ya lo huele, mierda.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre]. Puro circo barato, cabrón.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga sola, [nombre]. Puro circo barato, fracasado.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre]. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Sin debate útil, fracasado.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre] Menudo desastre, gilipollas.',
  ...
  simp: {
    ...
    high: [
      ...
      'Se te nota el rastro de simp hasta en los mensajes que pretenden ser neutrales, [nombre] El tramo te nombra sin permiso De frame, patético.',
      'Simp convertido en wallpaper del fail colectivo, joder. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre]. Puro circo barato, basura.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. Puro circo barato, patético.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre] Menudo desastre, asco.',
      ...
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre]. Sin anestesia posible, coño.',
      'Simp de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Puro circo barato, cabrón.',
      'El recato de dignidad te queda lejos y la distancia es rechazo, no mística, [nombre] Menudo desastre, gilipollas.',
      ...
      'Simp de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Sin anestesia posible, joder.',
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Tienes más grasa de validación ajena que un foro de fans sin moderación, [nombre] Menudo desastre, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de síes ajenos, [nombre]. Sin anestesia posible, ridículo.',
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre]. Puro circo barato, fracasado.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre] Menudo desastre, joder.',
      ...
      'Se te nota el peso de arrastrar el mismo pedestal por cada conversación, [nombre]. Sin anestesia posible, asco.',
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'Simp de feria de validación: ruido interno, cero ganas de volver del resto, [nombre] Menudo desastre, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre]. Puro circo barato, patético.',
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      ...
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre]. Sin anestesia posible, coño.',
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre]. Puro circo barato, cabrón.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre] Menudo desastre, gilipollas.',
      ...
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre]. Sin anestesia posible, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre]. Puro circo barato, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'No es estilo: es simp previsible y el high te lo nombra entero, [nombre]. Puro circo barato, fracasado.',
      'Tienes más episodios de pedestal que intentos de subir el listón propio, [nombre] Menudo desastre, joder.',
      ...
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre]. Sin anestesia posible, asco.',
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre] Menudo desastre, ridículo.',
      ...
      'El high no es un mal día de carácter: es. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. Sin anestesia posible, gilipollas.',
      'Simp sin complejo útil: el complejo al menos indicaría que viste el pedestal, [nombre]. Puro circo barato, patético.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Menudo desastre, asco.',
  ...
  rata: {
    ...
    high: [
      ...
      'El listón de la dignidad lo usas de rampa para trepar sobre otros en el chat, [nombre]. Hostia qué nivel, asco.',
      ...
      'El recato te queda a años luz y la distancia es rechazo, no mística de rata, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre] El grupo ya lo huele, fracasado.',
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado en el ranking, [nombre]. Sin anestesia posible, joder.',
      'Rata de inercia: el grupo te soporta por costumbre, no por interés real, [nombre]. Puro circo barato, mierda.',
      'Tienes el tono de quien acumula restos ajenos y nunca pasa el estropajo, [nombre] Menudo desastre, coño.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Hostia qué nivel, gilipollas.',
      ...
      'Rata de feria: grasa, ruido, suelo peor y cero ganas de volver a la atracción, [nombre]. Sin debate útil, cabrón.',
      'Tienes más caras que un dado y menos dignidad que un cenicero de bar a las seis, [nombre], gilipollas.',
      'Rata sin estilo: ni el vicio tiene gracia ni el robo de atención tiene mérito, [nombre] El grupo ya lo huele, patético.',
      'Rata de las que. El ranking de aporte deja en el sótano con razón documentada, [nombre]. Sin anestesia posible, asco.',
      'No es gracia sucia: es ratez sin gracia, la versión que no entretiene a nadie, [nombre]. Puro circo barato, basura.',
      'Rata de fondo: bajas la media con la constancia de quien no se cansa de sacar, [nombre] Menudo desastre, ridículo.',
      ...
      'Se te oye el masticar del bajo listón hasta en los mensajes serios del chat, [nombre]. Sin debate útil, mierda.',
      ...
      'El recato te saluda desde la orilla limpia y tú no sales del barro del chat, [nombre]. Puro circo barato, patético.',
      'No es estilo: es ratez previsible y el high te la cobra entera en el tramo, [nombre] Menudo desastre, asco.',
      ...
      'Rata sin redención estética: solo hambre de lo ajeno y cero de producción, [nombre]. Hostia qué nivel, ridículo.',
      'No hay misterio interesante: hay previsible y rata, el combo flojo del high, [nombre]. Sin debate útil, fracasado.',
      'Rata de las que el mute ajeno lee como invitación y se equivoca de libro, [nombre]. Y no hay forma de maquillarlo, joder.',
      'Se te nota el peso de arrastrar el interés propio por cada hilo del grupo, [nombre] El grupo ya lo huele, mierda.',
      'Rata de las que roban el oxígeno del hilo y no devuelven ni un mensaje útil, [nombre]. Sin anestesia posible, coño.',
      'Rata de manual: te aprovechas del grupo y encima miras con cara de víctima, [nombre]. Puro circo barato, cabrón.',
      'Se te nota el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre] Menudo desastre, gilipollas.',
      ...
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      ...
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre]. Sin anestesia posible, joder.',
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre]. Puro circo barato, mierda.',
      'Has convertido. El chat en tu despensa y al resto en inventario de provecho, [nombre] Menudo desastre, coño.',
      ...
      'Has convertido lo rata en marca personal y la marca se pega en los dedos, [nombre]. Sin anestesia posible, ridículo.',
      'Rata de estribillo que mancha más con cada repetición del mismo plato, [nombre]. Puro circo barato, fracasado.',
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre] Menudo desastre, joder.',
      ...
      'Has convertido la rata en identidad y no hay detergente narrativo, [nombre]. Sin anestesia posible, asco.',
      'Rata cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. Puro circo barato, basura.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre] Menudo desastre, ridículo.',
      'Rata de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] El ranking firma y listo, fracasado.',
      'No hay misterio de ratez con estilo: hay lo previsible y sucio del high, [nombre] Se ve desde el primer mensaje De frame, joder.',
      ...
      'Rata de estribillo sin punto final limpio ni redención posible, [nombre]. Sin anestesia posible, gilipollas.',
      'La compostura cruza de acera cuando te ve en el ranking del high, [nombre]. Puro circo barato, patético.',
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      ...
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre]. Sin anestesia posible, coño.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre]. Puro circo barato, cabrón.',
      'La clase te suena a ataque y respondes dejando más migas de interés ajeno, [nombre] Menudo desastre, gilipollas.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre]. Puro circo barato, mierda.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'No hay barniz de antihéroe: hay ratez y el high la cobra, [nombre] El grupo no necesita subtítulos De frame, patético.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre]. Sin anestesia posible, ridículo.',
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre]. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Has convertido la rata en carnet y no hay renovación limpia, [nombre]. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Rata de puta madre en el sentido literal: el high no suaviza el hocico, [nombre]. Puro circo barato, basura.',
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre] Menudo desastre, ridículo.',
      ...
      'Rata con la disciplina de quien nunca ha devuelto una puta favor, [nombre]. Sin anestesia posible, gilipollas.',
      'El high no es un mal día de ética: es. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      'Tienes una presencia que ensucia el hilo en un solo movimiento de rata, [nombre] Menudo desastre, asco.',
      ...
      'El ranking de confianza te deja donde mereces: en el sótano del high, [nombre] Eso no se maquilla con ángulo De frame, joder.',
      'Has hecho de la rata tu marca y la marca se pega en los dedos ajenos, [nombre] El tramo te nombra sin permiso, y, mierda.',
      'Rata de las que confunden astucia con no tener vergüenza en el ranking, [nombre]. Sin anestesia posible, coño.',
      'No es viveza con gracia: eres rata y el high no discute la evidencia, [nombre]. Puro circo barato, cabrón.',
      ...
      'Se te ve el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre] Se te ve el forro, patético.',
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de las ratas, [nombre]. Hostia qué nivel, asco.',
      'Tienes más episodios de rata documentados que intentos de subir el nivel, [nombre]. Sin debate útil, basura.',
      ...
      'Has hecho de lo rata una marca personal y la marca se pega en los dedos, [nombre]. Sin anestesia posible, joder.',
      'Has convertido el bajo listón en residencia fija sin mudanza a la vista, [nombre]. Puro circo barato, mierda.',
      'No es atrevimiento: es suciedad de interés y el high te la cobra entera, [nombre] Menudo desastre, coño.',
      'Tienes más grasa de rata en el discurso que un freidor de feria al cierre, [nombre] Se te ve el forro, cabrón.',
      ...
      'El olor a rata se te nota en cada mensaje que pide sin dar nada a cambio, [nombre]. Y no hay forma de maquillarlo, asco.',
      'Se te oye el arrastre de la rata hasta en los mensajes cortos del hilo, [nombre] El grupo ya lo huele, basura.',
      'Rata sin punto final limpio: el estribillo se repite y mancha más cada vez, [nombre]. Sin anestesia posible, ridículo.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro, [nombre]. Puro circo barato, fracasado.',
      'Tienes el aura de quien pide prestado y nunca devuelve ni las gracias, [nombre] Menudo desastre, joder.',
      'Rata de las que el grupo aguanta por inercia y no por respeto de verdad, [nombre] Se te ve el forro, mierda.',
      'Rata de repertorio gastado: las mismas manchas, el mismo plato de siempre, [nombre]. Hostia qué nivel, coño.',
      'El promedio de ratez es este: el tramo high no es un mal día, es el nivel, [nombre]. Sin debate útil, cabrón.',
      'Has convertido. El chat en tu zona de obras grasientas sin fecha de fin, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      ...
      'Has hecho de lo rata tu plato favorito y lo sirves en todas las mesas, [nombre]. Hostia qué nivel, joder.',
  ...
  friki: {
    ...
    high: [
      ...
      'La dignidad del tramo no para: tú eres el tráfico del arcén social, [nombre]. Sin anestesia posible, ridículo.',
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre]. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      ...
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre] Menudo desastre, asco.',
      ...
      'Friki de manual cutre: el estereotipo sin el carisma que a veces salva al raro, [nombre]. Sin anestesia posible, coño.',
      'La compostura social no te reconoce y tú no has buscado el espejo del chat, [nombre]. Puro circo barato, cabrón.',
      ...
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre]. Sin anestesia posible, joder.',
      'Friki que se enfada porque no valoran su afición. Nadie está obligado, gilipollas. Y exigir valoración ya es haber perdido.',
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre] Menudo desastre, coño.',
      ...
      'Friki con el bucle eterno del mismo error en bucle, joder. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Sin anestesia posible, ridículo.',
      'No es profundidad: es aislamiento con teclado y el tramo te lo cobra, [nombre]. Puro circo barato, fracasado.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Menudo desastre, joder.',
      ...
      'Friki de malinterpretar el silencio ajeno como interés por el lore, [nombre]. Sin anestesia posible, asco.',
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre]. Puro circo barato, basura.',
      'Has convertido el nicho en identidad y no hay detergente de salida, [nombre] Menudo desastre, ridículo.',
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] El ranking firma y listo, gilipollas.',
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre] Menudo desastre, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre]. Sin anestesia posible, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo sin estilo: el desastre sin estética es solo un problema de higiene del hilo. Hostia qué nivel, ridículo.',
      'Tienes más episodios de cerdez documentada que intentos de subir el nivel un punto. Sin debate útil, fracasado.',
      'El promedio de cerdez es el nivel: no un pico, el suelo del tramo high, [nombre]. Y no hay forma de maquillarlo, joder.',
      'El asco colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre] El grupo ya lo huele, mierda.',
      'Cerdo de las que alardean de la grasa porque callar las dejaría sin personaje. Gilipollas. El chat ya lo archivó.',
      'El asco resume el tramo y el resto solo desarrolla el mismo diagnóstico, [nombre]. Puro circo barato, cabrón.',
      '[nombre], tu manera de fregar el suelo es esperar a que se seque solo. Cada mancha se queda a vivir. Puta casa de mierda.',
      'Se te nota la prisa por embadurnar. El chat y cero ganas de limpiar después. Se te ve el forro, patético.',
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'El asco No es moralina: es el termómetro y te marca cerdez crónica, [nombre]. Sin debate útil, basura.',
      'Tienes más restos en el relato que un cubo de basura. El día de recogida. Y no hay forma de maquillarlo, ridículo.',
      ...
      'No es atrevimiento: es suciedad previsible y el high te la cobra sin descuento, [nombre] Se te ve el forro, basura.',
      'Se te oye el masticar de la cerdez hasta en los mensajes que quieren parecer neutros. Hostia qué nivel, ridículo.',
      ...
      'Has convertido el grupo en tu comedero y los demás en testigos del banquete, [nombre]. Y no hay forma de maquillarlo, joder.',
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre] El grupo ya lo huele, mierda.',
      ...
      'El listón de lo decente lo usas de servilleta y lo tiras al suelo del chat, [nombre] Menudo desastre, gilipollas.',
      ...
      'La palabra compostura te suena a idioma de otro planeta y no has abierto el diccionario. Y no hay forma de maquillarlo, ridículo.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo plato sin fregar, [nombre] El grupo ya lo huele, fracasado.',
      'Eres el guarro que deja el pelo en el lavabo y se va, [nombre]. Que lo recoja el siguiente, como todo lo tuyo. Puta dejadez.',
      'Cerdo de historial público: la grasa está en la superficie, no hace falta escarbar. Puro circo barato, mierda.',
      'Se te ve la prisa por embadurnar y la ausencia total de plan de limpieza, [nombre]. Patético. El chat ya lo archivó.',
      'Cerdo de fondo permanente: baja la media del grupo con constancia de metrónomo, [nombre] Se te ve el forro, cabrón.',
      'Tu escritorio tiene manchas superpuestas que ya forman un patrón geológico, cerdo. Cada capa es un mes de mierda. Acumulada.',
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre]. Sin debate útil, patético.',
      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre]. Y no hay forma de maquillarlo, asco.',
      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre] El grupo ya lo huele, basura.',
      'Tienes más grasa en el discurso que un freidora de feria al cierre de la noche. Sin anestesia posible, ridículo.',
      'El promedio de cerdez es este: el tramo high no es un mal día, es el nivel, [nombre]. Puro circo barato, fracasado.',
      'Cerdo de error de lectura: confundes límites con permiso para seguir manchando. Menudo desastre, joder.',
      ...
      'Has convertido el bajo listón en residencia: sin mudanza a la vista de nadie. El grupo ya lo huele, patético.',
      'Tienes más migas en el historial que un mantel de bar después del desayuno eterno. Sin anestesia posible, asco.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos de limpieza. Puro circo barato, basura.',
      'No es estilo atrevido: es grasa previsible y el high te la cobra entera, [nombre] Menudo desastre, ridículo.',
      ...
      'No es libertad: es falta de criterio con migas y el resultado se huele, [nombre]. Sin debate útil, mierda.',
      'Se te nota el hábito de empujar cada tema hacia el mismo plato sin fregar, [nombre]. Asco. El chat ya lo archivó.',
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre] El grupo ya lo huele, cabrón.',
      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar. Sin anestesia posible, gilipollas.',
      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre]. Puro circo barato, patético.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, joder, con el grupo de testigo. Sin debate útil, fracasado.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre, joder, sin anestesia posible. El grupo ya lo huele, mierda.',
      'El listón de lo presentable lo usas de tobogán hacia abajo, joder, [nombre]. Sin anestesia posible, coño.',
      'Cerdo sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. Puro circo barato, cabrón.',
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre] Menudo desastre, gilipollas.',
      ...
      'El asco No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre]. Sin anestesia posible, joder.',
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre]. Puro circo barato, mierda.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'Cerdo de ranking: bajas la media del tramo con constancia de mancha, [nombre]. Sin anestesia posible, ridículo.',
      'Has convertido el bajo listón en casa fija sin fecha de mudanza, [nombre]. Puro circo barato, fracasado.',
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Cerdo de ceja ajena levantada y respeto en el sótano del ranking, [nombre] El tramo te nombra sin permiso De frame, patético.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. Sin anestesia posible, asco.',
      'Has convertido la porquería en carnet y no hay renovación limpia, [nombre]. Puro circo barato, basura.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Menudo desastre, ridículo.',
      ...
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado, [nombre]. Sin anestesia posible, gilipollas.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      ...
      'Cerdo de superficie: no hace falta abrir el cubo, huele de lejos, [nombre]. Sin anestesia posible, coño.',
      'No hay barniz que salve: hay cerdo puro y no se vende como carisma, [nombre]. Puro circo barato, cabrón.',
      'Tienes el tono de quien acumula restos y nunca pasa el estropajo, [nombre] Menudo desastre, gilipollas.',
      ...
      'La clase te suena a ataque y respondes con más migas de suciedad, [nombre]. Sin anestesia posible, joder.',
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre]. Puro circo barato, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'La compostura del tramo no te reconoce en el elenco, [nombre]. Y el chat lo tiene claro. Sin anestesia posible, asco.',
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre]. Puro circo barato, basura.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre] Menudo desastre, ridículo.',
      ...
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre]. Sin anestesia posible, gilipollas.',
      'Cerdo hasta para el modo oscuro: ni la sombra tapa lo que dejas, [nombre]. Puro circo barato, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Menudo desastre, asco.',
      ...
      'El high no es un mal día de orden: es. El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre]. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      ...
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo. Puro circo barato, mierda.',
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual. Ridículo. El chat ya lo archivó.',
      'Has hecho de lo indecente tu plato favorito y lo sirves en todas las mesas. Se te ve el forro, cabrón.',
      'No es gracia sucia: es suciedad sin gracia, la versión que no entretiene, [nombre]. Hostia qué nivel, gilipollas.',
      'El listón está en el suelo y tú lo usas de pan para mojar sin vergüenza, [nombre]. Sin debate útil, patético.',
      'Cerdo de oficio: el rastro de grasa es tu firma y aparece en cada párrafo. Y no hay forma de maquillarlo, asco.',
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible. El grupo ya lo huele, basura.',
      'Dejas el baño de tal manera que hay que limpiarlo antes de poder usarlo. Puta escena del crimen con toalla húmeda.',
      'Tienes el tono de quien come con la boca abierta en un restaurante en silencio. Puro circo barato, fracasado.',
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'La palabra clase te suena a reproche y respondes ensuciando un poco más. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Se te oye el arrastre de la grasa hasta en los mensajes cortos del chat. Y no hay forma de maquillarlo, gilipollas.',
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio. El grupo ya lo huele, patético.',
      'Tienes más manchas documentadas que intentos serios de pasar un trapo al relato. Sin anestesia posible, asco.',
      'Has convertido la grasa en carnet y no hay renovación limpia a la vista. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla. Menudo desastre, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Has convertido la mancha en identidad y no hay detergente narrativo a la vista. Hostia qué nivel, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre]. Cabrón. El chat ya lo archivó.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro. El grupo ya lo huele, cabrón.',
      'Cerdo sin higiene narrativa: ensucias el hilo y no recoges nunca el escombro. Sin anestesia posible, gilipollas.',
    ],
    mid: [
  ...
  femboy: {
    ...
    high: [
      ...
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. Sin anestesia posible, ridículo.',
      'Femboy como un anuncio repetido que nadie pidió, joder, con el grupo de testigo. Puro circo barato, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Menudo desastre, joder.',
      'Femboy en crudo: ni el maquillaje del ranking te cubre, joder, sin anestesia posible. Se te ve el forro, mierda.',
      ...
      'Femboy sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado. Sin debate útil, cabrón.',
      ...
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre]. Sin anestesia posible, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre] Menudo desastre, ridículo.',
      ...
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre]. Sin anestesia posible, gilipollas.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      'Femboy de inercia: el grupo te soporta por costumbre, no por respeto, [nombre] Menudo desastre, asco.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre]. Sin anestesia posible, coño.',
      'Femboy de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Puro circo barato, cabrón.',
      'No es atrevimiento: es suciedad de personaje y el tramo te la cobra, [nombre] Menudo desastre, gilipollas.',
      'Tienes más grasa de pose en el discurso que un freidor al cierre de feria, [nombre] El ranking firma y listo De frame, patético.',
      ...
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Sin anestesia posible, joder.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Puro circo barato, mierda.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre]. Sin anestesia posible, ridículo.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]. Puro circo barato, fracasado.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Femboy de puta madre: el high no suaviza el teatro ni el personajito, [nombre]. Sin anestesia posible, asco.',
      ...
      'Tu historial de búsquedas, tus compras y tu forma de sentarte ya formaron un tribunal. Hostia qué nivel, gilipollas.',
    ],
    mid: [
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el tramo high, [nombre]. Sin anestesia posible, ridículo.',
      'La clase de aportar te suena a reproche, [nombre], coño. Y el chat lo tiene claro. Puro circo barato, fracasado.',
      'El asco Del tramo high es este: presencia sin función, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Se te ve venir el vacío en la primera palabra del mensaje del hilo, [nombre]. Hostia qué nivel, coño.',
      'Se te oye el eco del vacío cada vez que intentas llenar un silencio del hilo, [nombre]. Sin debate útil, cabrón.',
      ...
      'Inútil de manual: ni para el drama aportas algo que no sea ruido de fondo, [nombre] El grupo ya lo huele, patético.',
      'Has firmado lo inútil en cada mensaje largo que no sostiene nada del hilo, [nombre]. Sin anestesia posible, asco.',
      'No hay misterio útil: hay previsible vacío en el tramo high del comando, [nombre]. Puro circo barato, basura.',
      'El promedio de inutilidad es el nivel: no un mal día, el suelo del high, [nombre] Menudo desastre, ridículo.',
      ...
      'Inútil de superficie suficiente: no hace falta el sótano del historial, [nombre]. Hostia qué nivel, joder.',
      'La vergüenza ajena te sigue cuando pretendes ser necesarios en el chat, [nombre]. Sin debate útil, mierda.',
      ...
      'Inútil de error crónico: confundes mute con misterio en el ranking, [nombre]. Sin anestesia posible, gilipollas.',
      'Tu forma de contribuir es asentir a lo que decidan otros. Eso no es contribuir, gilipollas. Eso es hacer bulto con opinión.',
      'Inútil documentado: el ranking de aporte te deja donde mereces sin debate, [nombre] Menudo desastre, asco.',
      ...
      'Inútil con las mismas cartas manchadas de siempre y sin plan B, joder, diagnóstico cerrado. Puro circo barato, cabrón.',
      'Inútil de cartel vacío: se ve el marco y no hay obra detrás del nick, [nombre] Menudo desastre, gilipollas.',
      ...
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre]. Sin anestesia posible, joder.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre]. Puro circo barato, mierda.',
      'Inútil sin capa de carisma que disimule el agujero, joder, el chat ya lo archivó. Menudo desastre, coño.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre]. Sin anestesia posible, ridículo.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre]. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre]. Y el chat lo tiene claro. Menudo desastre, coño.',
      ...
      'El precio de tu repertorio vacío lo paga el hilo en tiempo perdido del chat, [nombre]. Sin anestesia posible, asco.',
      ...
      'Tienes la utilidad de un mando sin pilas: se ve, no sirve, estorba en el ranking, [nombre]. Sin debate útil, mierda.',
      'Inútil de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. Y no hay forma de maquillarlo, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de silences, [nombre] El grupo ya lo huele, cabrón.',
      ...
      'Inútil de error de lectura: confundes estar con importar en el chat del grupo, [nombre] Menudo desastre, asco.',
      ...
      'Se te nota que bajaste del tren del aporte hace tiempo y perdiste el billete, [nombre] El grupo ya lo huele, mierda.',
      ...
      'Inútil sin redención: el hueco que dejas cuando te vas es un alivio medible, [nombre] Se te ve el forro, patético.',
      'Has convertido el no aportar en un hábito y el hábito en identidad del ranking, [nombre]. Hostia qué nivel, asco.',
      'No es discreción: es falta de material útil con nick incluido en el ranking, [nombre]. Sin debate útil, basura.',
      'Inútil de estribillo que empeora con cada repetición del mismo vacío, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      ...
      'Inútil constante: la única racha que mantienes es la de no servir en el chat, [nombre]. Puro circo barato, mierda.',
      'Inútil de feria ambulante: ruido sin recuerdo bueno en el historial del chat, [nombre] Menudo desastre, coño.',
      'Has firmado lo inútil como quien no sabe firmar otra cosa en el ranking, [nombre] Se te ve el forro, cabrón.',
      'No hay misterio de inutilidad interesante: hay lo previsible del high, [nombre]. Hostia qué nivel, gilipollas.',
      '[nombre], nadie te espera para empezar nada. Empiezan y ya te enteras si te enteras. Ahí tienes tu peso real en este grupo, pringado, patético.',
      'Inútil de feria: ruido, cero sustancia, el suelo igual de sucio del ranking, [nombre]. Y no hay forma de maquillarlo, asco.',
      'Inútil de inercia: el grupo te soporta por costumbre, no por interés real, [nombre] El grupo ya lo huele, basura.',
      'La vergüenza ajena te sigue cuando intentas parecer necesarios en el hilo, [nombre]. Sin anestesia posible, ridículo.',
      ...
      'El recato de no hablar no te salva: cuando hablas se confirma el diagnóstico, [nombre] Se te ve el forro, mierda.',
      'Se te nota la prisa por ocupar sitio y cero plan de justificarlo en el chat, [nombre]. Hostia qué nivel, coño.',
      'Tienes el tono de quien acumula mensajes sin acumular peso en el ranking, [nombre]. Sin debate útil, cabrón.',
      'Has convertido el no servir en carnet de identidad del ranking del grupo, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      'Inútil de superficie: la profundidad no aparece ni con zoom del historial, [nombre] El grupo ya lo huele, patético.',
      ...
      'Tienes más ausencias de criterio que mensajes con sustancia en el chat, [nombre]. Puro circo barato, basura.',
      'La dignidad del aporte no para: tú eres el tráfico del arcén del ranking, [nombre] Menudo desastre, ridículo.',
      'Inútil de inercia: el grupo te lee por costumbre, no por interés real, [nombre] Se te ve el forro, fracasado.',
      'Tienes el tono de noches de chat sin una frase que pese en el ranking, [nombre]. Hostia qué nivel, joder.',
      ...
      'Tienes el historial de un cierre sanitario de sustancia en el ranking, [nombre] El grupo ya lo huele, cabrón.',
      'Inútil visible desde lejos: el letrero no compensa la parada del chat, [nombre]. Sin anestesia posible, gilipollas.',
      'Se te nota que perdiste el mapa del aporte hace tiempo en el ranking, [nombre]. Puro circo barato, patético.',
      ...
      'Has dejado. El chat como obra sin plano: escombro de mensajes sin función, [nombre]. Hostia qué nivel, ridículo.',
      'Tienes más episodios de no aportar que de intentarlo en serio en el chat, [nombre]. Sin debate útil, fracasado.',
      ...
      'No es gracia seca: es vacío sin gracia en el tramo high del comando, [nombre]. Sin anestesia posible, coño.',
      'La dignidad del aporte hace autostop y el tráfico eres tú en el ranking, [nombre]. Puro circo barato, cabrón.',
      '[nombre], inútil de mierda: no sabes hacer, no sabes pedir ayuda y no sabes apartarte. El pack completo del estorbo con patas.',
      'Inútil de malinterpretar el silencio ajeno como interés por el vacío, [nombre] Se te ve el forro, patético.',
      'Se te nota el hábito de empujar cada hilo hacia ninguna parte útil, [nombre]. Hostia qué nivel, asco.',
      ...
      'Se te nota el arrastre de no empujar nunca hacia arriba del ranking, [nombre]. Puro circo barato, mierda.',
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      'Inútil de malinterpretar el silencio como invitación a seguir vacíos, [nombre] Se te ve el forro, cabrón.',
      ...
      'La compostura del aporte no te reconoce en el ranking del grupo, [nombre] El grupo ya lo huele, basura.',
      'No hay barniz de personaje: hay inutilidad pura en el tramo high, [nombre]. Sin anestesia posible, ridículo.',
      'No hay barniz: hay inutilidad pura en el tramo high del comando, [nombre]. Puro circo barato, fracasado.',
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'El asco resume el tramo: presencia sin función en el chat del grupo, [nombre] Se te ve el forro, mierda.',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre]. Puro circo barato, basura.',
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre] Menudo desastre, ridículo.',
      'La clase de aportar te suena a reproche en el ranking del grupo, [nombre] Se te ve el forro, fracasado.',
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre]. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre]. Sin debate útil, mierda.',
      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre]. Y no hay forma de maquillarlo, coño.',
      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre] El grupo ya lo huele, cabrón.',
      'Inútil de racha: lo único constante es no servir en el ranking, [nombre]. Sin anestesia posible, gilipollas.',
      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre]. Puro circo barato, patético.',
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del tramo high, [nombre]. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre]. Y no hay forma de maquillarlo, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre]. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre]. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      'No hay eco de sustancia: hay eco de hueco en el tramo high, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Puro circo barato, patético.',
      'La dignidad del tramo no para el coche: tú eres el tráfico del arcén, [nombre] Menudo desastre, asco.',
      ...
      'Se te oye el eco del fail hasta en los mensajes que pretenden sonar a plan B, [nombre] Menudo desastre, joder.',
      ...
      'Tienes más grasa de derrota en el discurso que un vestuario después del 0-5, [nombre] El tramo te nombra sin permiso De frame, patético.',
      'Perdedor de los que el high del ranking no perdona ni un frame del historial, [nombre]. Sin anestesia posible, asco.',
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del tramo, [nombre]. Puro circo barato, basura.',
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      ...
      'Perdedor sin el barniz: solo el material flojo a la vista, joder. Sin anestesia posible, gilipollas.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre]. Puro circo barato, patético.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre] Menudo desastre, asco.',
      ...
      'No hay barniz que salve: hay derrota pura y no se vende como carisma, [nombre]. Sin anestesia posible, coño.',
      '[nombre], perdedor de mierda: esperas a ver qué pasa y nunca pasa nada bueno. Y encima te sorprende, cada puta vez.',
      'Se te oye el masticar del listón bajo hasta en los neutros del hilo, [nombre] Menudo desastre, gilipollas.',
      ...
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre]. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Has hecho del bajo listón tu casa y no hay mudanza a la vista, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Menudo desastre, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] El grupo no necesita subtítulos De frame, patético.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Sin anestesia posible, asco.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Puro circo barato, basura.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] Menudo desastre, ridículo.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre]. Sin anestesia posible, gilipollas.',
    ],
    mid: [
  ...
  puta: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], te repartes tan barato que hasta el puticlub te pediría referencia negativa. Sin debate útil, basura.',
      'Puta de rotación de cajero automático: sacan lo suyo y ni te miran a la cara, [nombre]. Qué, ridículo.',
      '[nombre], si el puterío cotizara en bolsa serías chicharro basura, no blue chip. El grupo ya lo huele, fracasado.',
      'Has convertido el sí fácil en identidad y el grupo ya no se sorprende, [nombre]. Sin anestesia posible, joder.',
      '[nombre], tienes más kilometraje que un taxi de aeropuerto en temporada alta, puta. Puro circo barato, mierda.',
      'Puta de las que el silencio ajeno lo leen como invitación a más teatro, [nombre] Menudo desastre, coño.',
      '[nombre], te abres en canal por atención y luego te ofendes si te tratan como producto. Se te ve el forro, cabrón.',
      'El listón del respeto lo enterraste tú misma con cada estribillo barato, [nombre]. Hostia qué nivel, gilipollas.',
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre]. Y no hay forma de maquillarlo, asco.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin. El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      'Puta de repertorio corto: las mismas cartas de \'mírame\' en cada mano, [nombre]. Sin anestesia posible, ridículo.',
      '[nombre], has hecho del almost de intocable tu marca personal y se te ve el forro. Puro circo barato, fracasado.',
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], puta de las que el putero profesional pediría descuento por volumen. Se te ve el forro, mierda.',
      'Te repartes como flyer de discoteca mala: nadie lo pidió y acaba en el suelo, [nombre]. Hostia qué nivel, coño.',
      '[nombre], tu sí vale menos que un like anónimo de madrugada. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Puta sin el barniz de \'liberada\': solo hambre de validación barata, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      '[nombre], has convertido el chat en tu escaparate y el producto está en oferta. El grupo ya lo huele, patético.',
      'Se te oye el estribillo de disponibilidad hasta en los mensajes \'serios\', [nombre]. Sin anestesia posible, asco.',
      '[nombre], puta de manual: el ranking te nombra y tú posas. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'Si el puterío fuera currículum, tendrías páginas de relleno y cero logros, [nombre] Menudo desastre, ridículo.',
      '[nombre], te abres más fácil que un zip de archivo corrupto. Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Puta de las que confunden atención con respeto y se caen del pedestal, [nombre]. Hostia qué nivel, joder.',
      '[nombre], el grupo ya no debate: te tiene catalogada y archivada. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      'Has hecho del \'cualquier mira vale\' tu política exterior, [nombre]. Y no hay forma de maquillarlo, coño.',
      '[nombre], puta de kilometraje alto y mantenimiento cero. El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Te vendes en liquidación permanente y aun así no se agota el stock, [nombre]. Sin anestesia posible, gilipollas.',
      '[nombre], el sí fácil te quedó de tatuaje invisible. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      'Puta de las que el silencio de los demás es el único filtro que te queda, [nombre] Menudo desastre, asco.',
      '[nombre], tienes más vueltas que un portero automático de edificio viejo. Se te ve el forro, basura.',
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre]. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      '[nombre], te repartes con la frialdad de quien ya no espera nada a cambio. Sin debate útil, fracasado.',
      'Puta de fondo: el chat te usa de gag y tú sigues el libreto, [nombre]. Y no hay forma de maquillarlo, joder.',
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años. El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      'Has convertido cada hilo en casting improvisado, [nombre]. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre] Menudo desastre, gilipollas.',
      '[nombre], el ranking de puta te tiene de inquilina fija. Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre]. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      '[nombre], puta de manual negro: el grupo firma y tú posas. El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], has hecho del escaparate tu única personalidad. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Puta de las que confunden circulacion con deseo real, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], te repartes como menú del día: predecible y frío. Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre]. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      '[nombre], puta de kilometraje visible y orgullo de cartón. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre]. Y no hay forma de maquillarlo, asco.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno. El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre]. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      '[nombre], has convertido el almost de intocable en chiste interno. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada. Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre]. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco. Documentado. Y no hay forma de maquillarlo, gilipollas.',
      '[nombre], te repartes con la elegancia de un anuncio popup. El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre]. Sin anestesia posible, asco.',
      '[nombre], puta de las que el sí vale menos que un sticker. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      'Has hecho del chat tu puticlub sin cover, [nombre] Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      '[nombre], el ranking te nombra y el resto asiente sin debate. Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre]. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], te abres en canal por atención de segunda. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre]. Y no hay forma de maquillarlo, coño.',
      '[nombre], tienes más vueltas que el rumor del grupo. El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre]. Sin anestesia posible, gilipollas.',
      '[nombre], te vendes en liquidación y el stock no baja. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre] Menudo desastre, asco.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso. Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre]. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      '[nombre], has convertido cada mirada en ticket de entrada. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre]. Y no hay forma de maquillarlo, joder.',
      '[nombre], el sí fácil te delata más que un historial público. El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre]. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], puta de kilometraje alto y narrativa baja. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre] Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      '[nombre], has hecho del escaparate tu único argumento. Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      'Puta de las que confunden ruido con valor, [nombre]. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      '[nombre], puta de manual negro delante del puto chat. El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\' Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Puta de fondo de ranking: inquilina fija del tramo, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], has convertido el almost de misterio en chiste gastado. Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre]. Hostia qué nivel, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      '[nombre], puta de las que el chat archiva sin pedir bis. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre]. Y no hay forma de maquillarlo, asco, y el grupo no necesita más pruebas, asco.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano. El grupo ya lo huele, basura.',
      'Puta sin plot twist: solo el mismo libreto, [nombre]. Sin anestesia posible, ridículo, y el grupo no necesita más pruebas, ridículo.',
      '[nombre], te abres en canal por migajas de atención. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'El puterío te queda de uniforme de diario, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], has hecho del sí tu única estrategia social. Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre]. Hostia qué nivel, coño.',
      '[nombre], te vendes en oferta y el precio sigue cayendo. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Se te nota el hambre de validación a la legua, [nombre]. Y no hay forma de maquillarlo, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros. Sin anestesia posible, asco.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], te repartes como anuncio que nadie puede cerrar. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El sí fácil te quedó de cicatriz pública, [nombre] Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Puta de las que confunden circulación con deseo, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado. Y no hay forma de maquillarlo, coño.',
      'El listón del respeto está en el sótano con tu nombre, [nombre] El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], puta de fondo: siempre el mismo gag. Sin anestesia posible, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Te vendes barato y el stock no se agota nunca, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Has hecho del almost de intocable tu mayor fail, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], puta de las que el putero amateur pediría recibo. Y no hay forma de maquillarlo, joder, y el grupo no necesita más pruebas, joder.',
      'Te repartes con la elegancia de un popup de virus, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti. Sin anestesia posible, coño.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], el grupo ya no se sorprende: solo documenta. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Te abres en canal por ruido de segunda división, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'El sí fácil te delata más que cualquier captura, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre]. Y no hay forma de maquillarlo, ridículo.',
      '[nombre], te vendes en liquidación permanente. El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], puta de fondo de hilo y de ranking. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí. Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre]. Hostia qué nivel, gilipollas.',
      '[nombre], te repartes como menú del día en bar de carretera. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre]. Y no hay forma de maquillarlo, asco, y el grupo no necesita más pruebas, asco.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja. El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre]. Sin anestesia posible, ridículo.',
      '[nombre], te abres más fácil que la privacidad en cero. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'El puterío te quedó de marca y no de accidente, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], puta de kilometraje que ya no admite garantía. Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      'Te vendes barato y luego quieres trato de boutique, [nombre]. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Puta de manual: el bot confirma lo que el grupo ya sabía, [nombre]. Y no hay forma de maquillarlo, gilipollas.',
      'Si la dignidad tuviera alarma, sonaría cada vez que escribes, [nombre] El grupo ya lo huele, patético.',
      '[nombre], puta de fondo: el eco te devuelve el mismo asco. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], el almost de misterio se te escapó en el primer sí. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Puta de las que confunden atención con respeto y caen, [nombre] Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], te abres en canal por migajas y aún así das las gracias. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], puta de ranking fijo en el sótano del respeto. Y no hay forma de maquillarlo, coño, y el grupo no necesita más pruebas, coño.',
      'Te vendes en oferta y el precio solo baja, [nombre] El grupo ya lo huele, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], se te nota el hambre de validación en cada puto sticker. Sin anestesia posible, gilipollas.',
      'Puta sin plot de redención en tres actos, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], has hecho del escaparate tu personalidad completa. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], puta de las que el silencio es el único que te pone límite. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Te repartes como flyer de after de mala muerte, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión. Y no hay forma de maquillarlo, joder, y el grupo no necesita más pruebas, joder.',
      'Puta de manual negro delante de todo el grupo, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], te abres más que un debate vacío y con menos contenido. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo. Menudo desastre, gilipollas.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], te vendes barato y el stock parece infinito. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre]. Sin debate útil, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], puta de fondo de chat: el gag eres tú. Y no hay forma de maquillarlo, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El listón del respeto está enterrado con tu historial, [nombre] El grupo ya lo huele, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre]. Sin anestesia posible, joder, y el grupo no necesita más pruebas, joder.',
      '[nombre], has hecho del sí tu política exterior completa. Puro circo barato, mierda, y el grupo no necesita más pruebas, mierda.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre] Menudo desastre, coño, y el grupo no necesita más pruebas, coño.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0 Se te ve el forro, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre]. Hostia qué nivel, gilipollas.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo. Sin debate útil, patético, y el grupo no necesita más pruebas, patético.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre]. Y no hay forma de maquillarlo, asco, y el grupo no necesita más pruebas, asco.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía. El grupo ya lo huele, basura, y el grupo no necesita más pruebas, basura.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre]. Sin anestesia posible, ridículo.',
      '[nombre], puta de las que el almost de intocable es el gag del año. Puro circo barato, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre] Se te ve el forro, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m. Hostia qué nivel, coño, y el grupo no necesita más pruebas, coño.',
      'El sí fácil te quedó de firma digital en el chat, [nombre]. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones. Y no hay forma de maquillarlo, gilipollas.',
      'Te abres más fácil que la configuración por defecto, [nombre] El grupo ya lo huele, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Puta de fondo: siempre el mismo libreto, [nombre]. Puro circo barato, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre] Se te ve el forro, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], has hecho del escaparate tu único talento documentado. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre]. Sin debate útil, mierda.',
      '[nombre], si el puterío cotizara, serías warning del bróker. Y no hay forma de maquillarlo, coño, y el grupo no necesita más pruebas, coño.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], puta de manual negro: el grupo firma, tú posas. Sin anestesia posible, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre]. Puro circo barato, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre] Se te ve el forro, basura, y el grupo no necesita más pruebas, basura.',
      '[nombre], te abres en canal por migajas y aún pides propina. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'El puterío te quedó de uniforme de diario del chat, [nombre]. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo. Y no hay forma de maquillarlo, joder.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre] El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo. Sin anestesia posible, coño, y el grupo no necesita más pruebas, coño.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre]. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      '[nombre], puta de fondo de hilo, de ranking y de meme. Menudo desastre, gilipollas, y el grupo no necesita más pruebas, gilipollas.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre] Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      '[nombre], el bot te midió y el grupo ya había firmado el parte. Hostia qué nivel, asco, y el grupo no necesita más pruebas, asco.',
    ],
    mid: [
  ...
  guarra: {
    ...
    high: [
      ...
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Sin debate útil, cabrón, y el grupo no necesita más pruebas, cabrón.',
      ...
      'Se te nota el sudor de la guarrada hasta en los mensajes que intentan parecer finos. El grupo ya lo huele, patético.',
      'Guarra de estribillo que empeora con cada repetición del mismo tema sucio, [nombre]. Sin anestesia posible, asco.',
      'Guarra cutre y constante: la única racha que mantienes sin fallar nunca, [nombre]. Puro circo barato, basura.',
      'Tienes más manchas en el discurso que un delantal de cocina de barrio a las tres. Menudo desastre, ridículo.',
      'Guarra de las que el grupo lee con una ceja levantada y cero respeto, [nombre] Se te ve el forro, fracasado.',
      'El asco es el resumen corto: el largo es este tramo y se te queda grande de digno. Hostia qué nivel, joder.',
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre]. Sin debate útil, mierda, y el grupo no necesita más pruebas, mierda.',
      'El asco resume el tramo y el resto del mensaje solo desarrolla el mismo punto. Pringado. El chat ya lo archivó.',
      'Se te ve la prisa por ensuciar el hilo y cero ganas de limpiarlo después. El grupo ya lo huele, cabrón.',
      'El asco No es moralina: es diagnóstico de cómo ocupas el espacio del chat. Sin anestesia posible, gilipollas.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis. Puro circo barato, patético.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat. Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      'El asco es. Se te ve el forro, basura, y el grupo no necesita más pruebas, basura Hostia puta, basura.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile. Hostia qué nivel, ridículo, y el grupo no necesita más pruebas, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat. Sin debate útil, fracasado, y el grupo no necesita más pruebas, fracasado.',
      'El asco No es pruderie: es el termómetro y te marca fiebre de cutrez crónica. Y no hay forma de maquillarlo, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. El grupo ya lo huele, mierda, y el grupo no necesita más pruebas, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. Patético. El chat ya lo archivó.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día. Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para. Se te ve el forro, patético, y el grupo no necesita más pruebas, patético.',
      ...
      'Guarra de fondo de chat: siempre ahí, siempre igual, siempre bajando la media, [nombre]. Puro circo barato, basura.',
      'Guarra de superficie suficiente: no hace falta abrir cajones, está a la vista, [nombre] Menudo desastre, ridículo.',
      'Guarra profesional: cobras en atención y pagas con vergüenza ajena al que te lee, [nombre], fracasado.',
      'Guarra cutre de feria: mucho ruido, poca sustancia y el suelo peor que antes, [nombre]. Hostia qué nivel, joder.',
      'Se te oye el arrastre de la guarrada hasta en los mensajes que quieren parecer neutros. Sin debate útil, mierda.',
      ...
      'Guarra sin redención en el tramo high: el número alto es la paliza merecida, [nombre]. Puro circo barato, patético.',
      'Guarra de repertorio corto y manchado: siempre las mismas cartas grasientas, [nombre] Menudo desastre, asco.',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de lo previsible y sucio. Y no hay forma de maquillarlo, joder.',
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante. El grupo ya lo huele, mierda.',
      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre]. Ridículo. El chat ya lo archivó.',
      'Guarra con las mismas cartas manchadas de siempre y sin plan B Puro circo barato, cabrón, y el grupo no necesita más pruebas, cabrón.',
      'Guarra de las que leen el silencio como invitación y se equivocan siempre, [nombre] Menudo desastre, gilipollas.',
      'Tienes el aura del cenicero que nadie vacía: presente, lleno y olvidado en el borde. Se te ve el forro, patético.',
      'Has convertido el descaro en falta de vergüenza y la falta de vergüenza en marca. Hostia qué nivel, asco.',
      'Guarra cutre y orgullosa: el orgullo es lo único que te queda de interesante, [nombre]. Sin debate útil, basura.',
      'No es libertad: es falta de filtro y el resultado es basura. Con eco en el grupo. Vergüenza.vergüenza.',
      'El filtro de lo decente se te rompió hace temporadas y nadie ha venido a cambiarlo. El grupo ya lo huele, fracasado.',
      'Guarra sin estilo: el desastre sin estética es solo desastre, y tú lo clavas, [nombre]. Sin anestesia posible, joder.',
      'Guarra de fondo de ranking: bajas la media con la constancia de un metrónomo, [nombre]. Puro circo barato, mierda.',
      '[nombre], tu repertorio es de patio de colegio y tienes edad de sobra para saberlo. Puta cutrez con documento de identidad.',
      'Guarra de las que el grupo mutea con educación y sigue leyendo por morbo barato, [nombre] Se te ve el forro, cabrón.',
      'Guarra de cartel roto: la promesa era estilo y el producto es solo suciedad, [nombre]. Hostia qué nivel, gilipollas.',
      'Guarra de error de lectura crónico: confundes límites con juego siempre, [nombre]. Sin debate útil, patético.',
      'Tu presencia obliga al grupo a bajar el listón de lo aceptable, [nombre]. Y ya estaba en el suelo. Puta cutrez contagiosa.',
      'Tienes más kilómetros de cama barata que de dignidad acumulada en el historial del grupo. El grupo ya lo huele, basura.',
      'No es libertad sexual: es falta de criterio y el resultado se huele en el hilo. Sin anestesia posible, ridículo.',
      'Eres tan poco cuidadosa, [nombre], que el descuido dejó de ser accidente y pasó a ser método. Puta cochambre con sistema.',
      'Has convertido. El chat en tu callejón. Y el grupo en el público que no pidió entrada. Menudo desastre, joder.',
      'Guarra con antigüedad: el óxido de tanto oficio se te ve en cada broma de más, [nombre] Se te ve el forro, mierda.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder. Sin anestesia posible, asco, y el grupo no necesita más pruebas, asco.',
      'Has convertido la suciedad en identidad y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder. Menudo desastre, ridículo, y el grupo no necesita más pruebas, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre]. Puro circo barato, patético.',
      'Guarra de las que el mute ajeno lee como misterio y es solo asco. Documentado, [nombre] Menudo desastre, asco.',
      ...
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre]. Sin anestesia posible, coño.',
      'Guarra de inercia: el grupo te soporta por costumbre, no por respeto, [nombre]. Puro circo barato, cabrón.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] El tramo te nombra sin permiso, fracasado.',
      'Guarra de fondo permanente: el high no es un mal día, es el nivel, [nombre]. Sin anestesia posible, joder.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre]. Puro circo barato, mierda.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre] Menudo desastre, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre]. Sin anestesia posible, ridículo.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. Puro circo barato, fracasado.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre] Menudo desastre, joder.',
      ...
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre]. Sin anestesia posible, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. Puro circo barato, basura.',
      'Guarra de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] Menudo desastre, ridículo.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre]. Sin anestesia posible, gilipollas.',
      'Has firmado la guarrería con grasa en cada mensaje como única firma, [nombre]. Puro circo barato, patético.',
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Menudo desastre, asco, y el grupo no necesita más pruebas, asco.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre]. Sin anestesia posible, coño.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. Puro circo barato, cabrón.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre] Menudo desastre, gilipollas.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre]. Sin anestesia posible, joder.',
      'Guarra de malinterpretar el mute como interés por el personaje barato, [nombre]. Puro circo barato, mierda.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Menudo desastre, coño.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre]. Sin anestesia posible, ridículo.',
      'Guarra de respeto ajeno en números rojos del ranking del grupo, [nombre]. Puro circo barato, fracasado.',
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre]. Sin anestesia posible, asco.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre]. Puro circo barato, basura.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el puto grupo, [nombre] Menudo desastre, ridículo.',
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] El ranking firma y listo,, fracasado.',
      'El high no es un mal día de orden: es. Hostia qué nivel, joder, y el grupo no necesita más pruebas, joder.',
      ...
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre]. Puro circo barato, patético.',
      'Has hecho de la guarrería tu marca y la marca se pega en los dedos ajenos, [nombre] Menudo desastre, asco.',
      ...
      'Has hecho del bajo listón una residencia fija: sin opción a mudanza, [nombre]. Sin debate útil, fracasado.',
      'Guarra sin glamour: el desastre sin estética es solo un problema de higiene narrativa. Y no hay forma de maquillarlo, joder.',
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre] El grupo ya lo huele, mierda.',
      'Guarra de las que confunden mute con coquetería: error de lectura crónico, [nombre]. Cabrón. El chat ya lo archivó.',
      'Guarra cutre de feria ambulante: ruido, grasa y nada que llevarse a casa, [nombre]. Puro circo barato, cabrón.',
      'Nadie te tiene por divertida, [nombre]. Te tienen por ruidosa, que no es lo mismo ni de lejos. Puta alarma sin incendio.',
      'La dignidad te hace gestos desde el andén contrario y tú no te bajas del vagón. Se te ve el forro, patético.',
      'Guarra de las que el grupo soporta con una ceja arriba y respeto en cero, [nombre]. Hostia qué nivel, asco.',
      'El asco colectivo es el precio de tu repertorio. Y el grupo lo paga cada día. Vergüenza. Sin debate útil, basura.',
      'Tu manera de aportar es restar, [nombre], y llevas años restando sin parar. Un puto sumidero conversacional con nombre.',
      'Tienes más episodios documentados de guarrada que mensajes decentes en el archivo. El grupo ya lo huele, fracasado.',
      'Has convertido el barro en carnet de identidad y no hay renovación a la vista. Sin anestesia posible, joder.',
      'Has convertido cada conversación en un parte de guerra de la vergüenza colectiva. Puro circo barato, mierda.',
      ...
      'Tienes más manchas en el relato que un mantel de bar a las seis de la mañana. Hostia qué nivel, gilipollas.',
      'Tienes el aura de un cenicero lleno a las cuatro de la mañana en un local dudoso. Sin debate útil, patético.',
      'Guarra de las que el mute ajeno interpreta como juego y no como frontera, [nombre]. Y no hay forma de maquillarlo, asco.',
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma. El grupo ya lo huele, basura.',
      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre]. Sin anestesia posible, ridículo.',
      'Has hecho de lo cutre una marca personal y la marca huele desde el primer mensaje. Puro circo barato, fracasado.',
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar. Menudo desastre, joder, y el grupo no necesita más pruebas, joder.',
      'Guarra de fondo permanente: baja la media del grupo sin pedir permiso, [nombre] Se te ve el forro, mierda.',
    ],
    mid: [
