...
const LABELS = {
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre] El chat ya tomó nota, mierda.',
      ...
      'Maricón convertido en wallpaper del fail colectivo., asco Joder, qué nivel. La boca niega y el cuerpo firma, gilipollas.',
      'Maricón de los que miran culos de tíos con devoción de misa y luego niegan la religión, [nombre]. Joder.',
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre] El chat ya tomó nota, asco.',
      'Maricón de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] Sin disimulo posible, basura.',
      'Maricón con el mismo gag de siempre y cero variación. Menudo numerito, ridículo, y el grupo no se traga el cuento, ridículo.',
      ...
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] Menudo numerito, cabrón.',
      ...
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre] Menudo numerito, ridículo.',
      ...
      'El asco No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre] El chat ya tomó nota, mierda.',
      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre] Sin disimulo posible, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] Menudo numerito, cabrón.',
      ...
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre] El chat ya tomó nota, asco.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre] Menudo numerito, ridículo.',
      ...
      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre] El chat ya tomó nota, mierda.',
      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre] Sin disimulo posible, coño.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre] Menudo numerito, cabrón.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre] El chat ya tomó nota, asco.',
      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre] Sin disimulo posible, basura.',
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Menudo numerito, ridículo.',
      ...
      'Has convertido el personajito en identidad. y no hay detergente narrativo, [nombre] El chat ya tomó nota, mierda.',
      ...
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] El chat ya tomó nota, asco.',
      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre] Sin disimulo posible, basura.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Menudo numerito, ridículo.',
      ...
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Menudo numerito, cabrón.',
      ...
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre] El chat ya tomó nota, asco.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre] Sin disimulo posible, basura.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre] Menudo numerito, ridículo.',
      ...
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre] El chat ya tomó nota, mierda.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre] Sin disimulo posible, coño.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre] Menudo numerito, cabrón, y el grupo no se traga el cuento, cabrón.',
      ...
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] El chat ya tomó nota, asco.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]. Sin anestesia, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre] Menudo numerito, ridículo.',
      ...
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre] El chat ya tomó nota, mierda.',
      'Has hecho del afeminamiento un ranking personal y el oro es tuyo sin rival, [nombre] Sin disimulo posible, coño.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre] Menudo numerito, cabrón, y el grupo no se traga el cuento, cabrón.',
      ...
      'Has convertido el armario en escenario y la función aburre al patio, [nombre] El chat ya tomó nota, asco.',
      'Has hecho del bajo listón tu residencia. y no hay mudanza a la vista, [nombre] Sin disimulo posible, basura.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] Menudo numerito, ridículo.',
      ...
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre] El chat ya tomó nota, mierda.',
      ...
      'El high no es un mal día de pose: es., ridículo Joder, qué nivel El chat ya tomó nota, asco, y el grupo no se traga el cuento, asco.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre] El chat ya tomó nota, mierda.',
      ...
      'Has hecho del afeminamiento un ranking personal y el oro es tuyo sin rival, [nombre] Se te ve a la legua, joder Hostia puta, joder.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'El asco No es moralina: es el termómetro y te marca cerdez crónica, [nombre] Menudo desastre higiénico, coño.',
      ...
      'Eres el guarro que deja el pelo en el lavabo y se va, [nombre]. Que lo recoja el siguiente, como todo lo tuyo. Puta dejadez Qué asco, mierda.',
      ...
      '[nombre], tienes migas en el sofá que llevan ahí más tiempo que algunos muebles. Un yacimiento con cojines, puto guarro Qué asco, mierda.',
      ...
      'El asco No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre] El jabón te dio de baja, patético.',
      ...
      'La compostura del nivel no te reconoce en el elenco, [nombre]. Y el chat lo tiene claro. Hueles a abandono, mierda.',
