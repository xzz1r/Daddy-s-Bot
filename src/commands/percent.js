...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Tienes más diagnósticos ajenos que visitas al espejo en tu puta vida, [nombre] el nivel te nombra sin permiso, asco.',
      'Incel de manual: repartes culpa y no te has mirado nunca de verdad, [nombre], y no hay quien te salve el papelón, coño.',
      'Se te nota el rastro de incel hasta en los mensajes que pretenden ser neutrales, [nombre], ridículo.',
      'Incel como un anuncio repetido que nadie pidió, joder.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Has convertido el resentimiento en identidad. y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder.asco, y no hay quien te salve el papelón, asco.',
      ...
      'Incel sin una carta nueva: siempre la misma mano sucia, joder, y no hay quien te salve el papelón, ridículo.',
      'Se te oye el arrastre del resentimiento hasta en los neutros del chat, [nombre] el nivel te nombra sin permiso, nivel sótano puro, fracasado.',
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre], y no hay quien te salve el papelón, joder.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre], y no hay quien te salve el papelón, mierda.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'Se te nota la prisa por culpar y cero plan de mirarte a ti, [nombre] el nivel te nombra sin permiso, sin maquillaje posible, basura.',
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre], y no hay quien te salve el papelón, ridículo.',
      'No hay misterio interesante: hay previsible y amargado, el combo del high, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes el historial de un foro abandonado: posts de odio, cero vida, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Incel de ranking: bajas la media del nivel con monólogos de culpa ajena, [nombre] El grupo no necesita subtítulos, cabrón.',
      'Has convertido el resentimiento en carnet. y no hay renovación limpia, [nombre] Eso no se maquilla con ángulo, gilipollas.',
      'Incel de estribillo que mancha más con cada bis de la misma queja, [nombre] el nivel te nombra sin permiso, patético.',
      'Se te nota el hábito de empujar cada tema hacia tu mismo sótano, [nombre], y no hay quien te salve el papelón, asco.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre], y no hay quien te salve el papelón, basura.',
      'Incel de fondo permanente: el high no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Has convertido el incel en identidad. y no hay detergente a la vista, [nombre] el nivel te nombra sin permiso, el chat ya lo sabía, cabrón.',
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre], y no hay quien te salve el papelón, patético.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] el nivel te nombra sin permiso, con el grupo de testigo, mierda.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre], y no hay quien te salve el papelón, coño.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Se te nota el peso de arrastrar el mismo sótano por cada conversación, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'La dignidad del nivel no para: tú eres el tráfico del arcén social, [nombre] Eso no se maquilla con ángulo, cabrón.',
      'Incel de superficie suficiente: no hace falta abrir el wiki, se huele el cerrado, [nombre]. Patético.',
      'No hay barniz de genio incomprendido: hay amargura y el high lo cobra, [nombre], y no hay quien te salve el papelón, joder.',
      'Tienes el tono de quien acumula fichas de odio y nunca invita a jugar limpio, [nombre], y no hay quien te salve el papelón, mierda.',
      'Incel de las que alardean del sótano porque el exterior las deja sin personaje, [nombre], y no hay quien te salve el papelón, coño.',
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre, [nombre] El ranking firma y listo, ridículo.',
      ...
      'La clase social te suena a ataque y respondes con más del mismo mazo, [nombre] el nivel te nombra sin permiso, sin anestesia, basura.',
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre], y no hay quien te salve el papelón, ridículo.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Se te ve venir el monólogo en el primer punto del mensaje, [nombre] el nivel te nombra sin permiso, patético.',
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre], y no hay quien te salve el papelón, asco.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre], y no hay quien te salve el papelón, basura.',
      'No hay barniz de antihéroe nerd: hay amargura y el high la nombra, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Incel de estribillo que empeora con cada bis del mismo mazo, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Se te nota el hábito de empujar cada hilo hacia el rincón sin ventana, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'La compostura del nivel no te reconoce en el elenco social, [nombre].patético, y no hay quien te salve el papelón, patético.',
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre] Eso no se maquilla con ángulo De frame, joder.',
      'Has convertido el incel en carnet. y no hay renovación de salida a la vista, [nombre] el nivel te nombra sin permiso, y, mierda.',
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre], y no hay quien te salve el papelón, coño.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Incel con la disciplina de quien nunca ha aceptado el espejo, [nombre] el nivel te nombra sin permiso, fracasado.',
      'El high no es un mal día de humor: es.joder, y no hay quien te salve el papelón, joder Hostia puta, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre], y no hay quien te salve el papelón, coño.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] El ranking firma y listo, y no hay quien te salve el papelón, cabrón.',
      ...
      'Incel de las que confunden profundidad con abandono total del estándar social, [nombre] el nivel te nombra sin permiso, coño.',
      'No es estilo amargo con gracia: eres incel y el high no discute la evidencia, [nombre], y no hay quien te salve el papelón, ridículo.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], no es que te falte ángulo: es que te faltan los tres y el cuarto también, y no hay quien te salve el papelón, joder.',
      'Tienes el atractivo de un martes lluvioso en una sala de espera, [nombre]. Pura mierda. Estética, mierda.',
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente.coño, y no hay quien te salve el papelón, coño.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco. Con piernas, y no hay quien te salve el papelón, cabrón.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Se te nota la fealdad hasta en la miniatura del estado, [nombre]. Ridículo de bulto, y no hay quien te salve el papelón, patético.',
      '[nombre], el modo retrato de tu móvil debería venir con advertencia sanitaria, y no hay quien te salve el papelón, asco.',
      'Fea de las que hacen que el fotógrafo cobre extra por trauma, [nombre]. Mierda. Pura, y no hay quien te salve el papelón, basura.',
      '[nombre], no hay misterio: hay huesos de mala suerte y piel que no perdona, y no hay quien te salve el papelón, ridículo.',
      'Tu simetría es un chiste malo contado dos veces, [nombre]. Fracasado. Del catálogo visual, fracasado.',
      '[nombre], si te miran de frente es por educación, no por interés.joder, y no hay quien te salve el papelón, joder.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. De material.mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet, y no hay quien te salve el papelón, coño.',
      'La luz natural te delata como un puto detector de mentiras, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], no eres \\\'interesante\\\': eres difícil de mirar y punto, y no hay quien te salve el papelón, gilipollas.',
      'Fea de las que el group selfie se recorta solo, [nombre]. Ridículo automático, y no hay quien te salve el papelón, patético.',
      '[nombre], tu cara pide un softbox y un milagro, y no hay presupuesto para ninguno, y no hay quien te salve el papelón, asco.',
      'Si el atractivo fuera nota, tú irías a recuperación en agosto, [nombre]. Mierda. Académica, y no hay quien te salve el papelón, basura.',
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. Sin plot twist, y no hay quien te salve el papelón, fracasado.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes.joder, y no hay quien te salve el papelón, joder.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético. Empate, y no hay quien te salve el papelón, mierda.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta.coño, y no hay quien te salve el papelón, coño.',
      'Fea de las que el espejo del ascensor tiene traumas, [nombre]. Ridículo móvil, y no hay quien te salve el papelón, cabrón.',
      '[nombre], tienes el tipo de cara que hace cambiar de acera sin confesarlo, y no hay quien te salve el papelón, gilipollas.',
      'No es un mal día: es el material de base, [nombre]. Puta mierda. Estructural, y no hay quien te salve el papelón, patético.',
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza.asco, y no hay quien te salve el papelón, asco.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón. De manual, y no hay quien te salve el papelón, basura.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Tienes más ángulos muertos que un parking en U, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], la cámara frontal de tu móvil merece una medalla al valor, y no hay quien te salve el papelón, joder.',
      'Fea de las que el maquillaje es daño colateral, [nombre]. Ridículo. Con base, y no hay quien te salve el papelón, mierda.',
      '[nombre], no hay \\\'te ves mejor en persona\\\': hay decepción escalonada, y no hay quien te salve el papelón, coño.',
      'Tu cara es un argumento contra la natalidad irresponsable, [nombre]. Mierda. Heredada, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el high de fea te queda de casa y de apodo.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón. Del ranking, y no hay quien te salve el papelón, patético.',
      '[nombre], si te describen es por contraste con lo normal.asco, y no hay quien te salve el papelón, asco.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada, y no hay quien te salve el papelón, ridículo.',
      'Fea de las que el retrato robado se borra por piedad, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano, y no hay quien te salve el papelón, joder.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual.mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar.coño, y no hay quien te salve el papelón, coño.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón. Documentado.cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Tienes una presencia que baja el promedio del group photo, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], si el atractivo fuera propina, te dejarían monedas de cinco, y no hay quien te salve el papelón, asco.',
      'Fea de las que el flash avisa antes de disparar, [nombre]. Ridículo preventivo, y no hay quien te salve el papelón, basura.',
      '[nombre], el techo de tu cara es el suelo de casi cualquiera.ridículo, y no hay quien te salve el papelón, ridículo.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda. Rara, y no hay quien te salve el papelón, fracasado.',
      '[nombre], la fealdad te queda tan natural que parece look.joder, y no hay quien te salve el papelón, joder.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado.coño, y no hay quien te salve el papelón, coño.',
      'El modo retrato te trata como amenaza, [nombre]. Patético. Software.cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], si te miran mucho es porque no creen lo que ven, y no hay quien te salve el papelón, gilipollas.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\'asco, y no hay quien te salve el papelón, asco.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad.basura, y no hay quien te salve el papelón, basura.',
      '[nombre], el high de fea no es insulto, es inventario.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón. Plano.fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico.joder, y no hay quien te salve el papelón, joder.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta.coño, y no hay quien te salve el papelón, coño.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el atractivo te bloqueó en todas las redes.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda. Viral.patético, y no hay quien te salve el papelón, patético.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad.asco, y no hay quien te salve el papelón, asco.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón. Firme.basura, y no hay quien te salve el papelón, basura.',
      '[nombre], tienes cara de final de temporada cancelada.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve.joder, y no hay quien te salve el papelón, joder.',
      'Fea de las que el group chat prefiere stickers, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo.coño, y no hay quien te salve el papelón, coño.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda. Legal.cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el high te mide y el chat no discute el número.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón. Seco, y no hay quien te salve el papelón, patético.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos.asco, y no hay quien te salve el papelón, asco.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], ni con ring light de influencer te inventas un punto focal, y no hay quien te salve el papelón, ridículo.',
      'Fea de las que el fotógrafo finge que se le acabó la batería, [nombre], y no hay quien te salve el papelón, fracasado.',
      '[nombre], tu cara es un almost eterno que nunca llega a decente.joder, y no hay quien te salve el papelón, joder.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. Con voz, [nombre], y no hay quien te salve el papelón, mierda.',
      '[nombre], el ranking de fea te tiene de inquilino fijo.coño, y no hay quien te salve el papelón, coño.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], tienes más fallos faciales que un examen a última hora.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'El close-up es una denuncia anónima contra tu genética, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], si el atractivo fuera crédito, tu score sería basura, y no hay quien te salve el papelón, asco.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], te ves como un borrador que nadie quiso terminar.ridículo, y no hay quien te salve el papelón, ridículo.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre], y no hay quien te salve el papelón, fracasado.',
      '[nombre], el high de fea te queda de tatuaje invisible.joder, y no hay quien te salve el papelón, joder.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué, y no hay quien te salve el papelón, coño.',
      'cabrón,cabrón. Hostia puta, cabrón, joder, y no hay quien te salve el papelón, cabrón Hostia puta, cabrón.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos, y no hay quien te salve el papelón, gilipollas.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta.asco, y no hay quien te salve el papelón, asco.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas. Documentado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], tienes una geometría facial que ofende a Euclides.joder, y no hay quien te salve el papelón, joder.',
      'El atractivo te dio de baja y no dejó forwarding, [nombre]. Asco. Administrativo, y no hay quien te salve el papelón, mierda.',
      '[nombre], si la belleza fuera propina, el camarero te ignoraría, y no hay quien te salve el papelón, coño.',
      'Fea de las que el selfie se queda en el carrete por vergüenza, [nombre], y no hay quien te salve el papelón, cabrón.',
      '[nombre], el high no es bullying: es el espejo con números.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], se te nota la falta de suerte genética en cada pixel.asco, y no hay quien te salve el papelón, asco.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes.ridículo, y no hay quien te salve el papelón, ridículo.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], si te miran de reojo es para no comprometerse.joder, y no hay quien te salve el papelón, joder.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail.coño, y no hay quien te salve el papelón, coño.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Fea de veredicto público y sin narrador emocional, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], tienes más asimetría que un debate en este puto chat.asco, y no hay quien te salve el papelón, asco.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco. De altura.basura, y no hay quien te salve el papelón, basura.',
      '[nombre], si el atractivo fuera examen, irías a septiembre, y no hay quien te salve el papelón, ridículo.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], tu cara es un almost de humano decente.joder, y no hay quien te salve el papelón, joder Hostia puta, joder.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], no hay redención en un ángulo ni en un tutorial.coño, y no hay quien te salve el papelón, coño.',
      'Fea de manual: el bot firma y el chat archiva, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], si te hacen un cumplido es por pena o por agenda.asco, y no hay quien te salve el papelón, asco.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre], y no hay quien te salve el papelón, basura.',
      '[nombre], el sótano visual te queda de residencia fiscal.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible.joder, y no hay quien te salve el papelón, joder.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas. Del ranking, y no hay quien te salve el papelón, mierda.',
      '[nombre], tienes cara de final boss de la mala suerte genética.coño, y no hay quien te salve el papelón, coño.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa, y no hay quien te salve el papelón, gilipollas.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno.asco, y no hay quien te salve el papelón, asco.',
      'Tu frame es el gag del día y el grupo no pide replay, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], el high te mide con regla y te deja en negativo.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea sin consuelo de \\\'personalidad\\\': el comando no mide eso, [nombre], y no hay quien te salve el papelón, fracasado.',
      '[nombre], tienes más problemas de proporciones que un plano de arquitecto borracho, y no hay quien te salve el papelón, joder.',
      'La luz del flash te trata como evidencia del crimen, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada, y no hay quien te salve el papelón, coño.',
      'Fea de las que el selfie stick se acorta solo, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el material de base no admite segunda oportunidad, puta, y no hay quien te salve el papelón, gilipollas.',
      'Tu cara es un informe sin anexos de caridad, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], se te ve el sótano desde la notificación.asco, y no hay quien te salve el papelón, asco Hostia puta, asco.',
      'Fea de veredicto que el chat confirma en silencio, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], si el atractivo fuera crédito, estarías en mora.joder, y no hay quien te salve el papelón, joder.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], no hay ángulo: hay rendición documentada.coño, y no hay quien te salve el papelón, coño Hostia puta, coño.',
      'Tu simetría perdió el norte y el sur, [nombre].cabrón, y no hay quien te salve el papelón, cabrón Hostia puta, cabrón.',
      '[nombre], el high de fea te queda de apodo no oficial.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Fea sin plot twist de redención en tres mensajes, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], tienes cara de borrador olvidado en la papelera.asco, y no hay quien te salve el papelón, asco.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], si te miran fijo es porque no procesan el input.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea de las que el group chat prefiere audio a foto, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], el bot te midió dos veces y las dos dio sótano.joder, y no hay quien te salve el papelón, joder.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], el atractivo te dio de baja sin carta de despido.coño, y no hay quien te salve el papelón, coño.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas. Del comando.cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2asco, y no hay quien te salve el papelón, asco.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], te ves como un almost que se quedó en almost, puta.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El close-up es una denuncia con firma digital, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], se te ve el techo y está por los suelos.joder, y no hay quien te salve el papelón, joder Hostia puta, joder.',
      'Fea de tramo que no admite narrador emocional, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza.coño, y no hay quien te salve el papelón, coño.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco. Firmado.cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], si te hacen un retrato es por relleno de álbum, y no hay quien te salve el papelón, gilipollas.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel, y no hay quien te salve el papelón, asco.',
      'Tu cara es el gag visual y nadie pide bis, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], el high te deja en el sótano sin ascensor.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], tienes una geometría que ofende al compás.joder, y no hay quien te salve el papelón, joder.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto, y no hay quien te salve el papelón, coño.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el atractivo te vio y cambió de acera digital.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], no hay segundo chance: el primero ya fue bastante.asco, y no hay quien te salve el papelón, asco.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], tienes el glow up invertido certificado por el ranking.ridículo, y no hay quien te salve el papelón, ridículo.',
      'La luz natural te delata igual que un interrogatorio, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], si te describen en una palabra, esa palabra insulta, y no hay quien te salve el papelón, joder.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta.coño, y no hay quien te salve el papelón, coño.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el high de fea no es opinión: es el puto número.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre]patético, y no hay quien te salve el papelón, patético.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre].asco, y no hay quien te salve el papelón, asco.',
  ...
  gay: {
    ...
    goodIsHigh: false,
    high: [
      'Maricón de historial público: no hace falta escarbar, está en la superficie, [nombre], y no hay quien te salve el papelón, coño.',
      'Maricón de inercia: el grupo te soporta por costumbre, no por respeto real, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Maricón de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Maricón sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre], y no hay quien te salve el papelón, patético.',
      'Maricón convertido en wallpaper del fail colectivo.asco, y no hay quien te salve el papelón, asco Hostia puta, asco.',
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre, [nombre], y no hay quien te salve el papelón, basura.',
      'Maricón de estribillo que mancha más con cada repetición del mismo plato, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Maricón de malinterpretar el silencio ajeno como invitación a más teatro, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Maricón con el mismo gag de siempre y cero variación.joder, y no hay quien te salve el papelón, joder.',
      'Maricón de las que confunden natural con abandono total del estándar, [nombre], y no hay quien te salve el papelón, mierda.',
      'Maricón de superficie suficiente: no hace falta abrir el cubo, huele, [nombre], y no hay quien te salve el papelón, coño.',
      'Maricón de estribillo que empeora con cada bis del mismo número cutre, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre], y no hay quien te salve el papelón, patético.',
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre]asco, y no hay quien te salve el papelón, asco.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre], y no hay quien te salve el papelón, basura.',
      'Maricón de puta madre: el high no suaviza el teatro ni el personajito del ranking, [nombre]. Patético.',
      'Maricón cutre de manual: ni el vicio tiene gracia ni la pose tiene mérito, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Maricón de superficie: basta la vista, no hace falta el sótano del historial, [nombre], y no hay quien te salve el papelón, joder.',
      'Maricón de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre], y no hay quien te salve el papelón, mierda.',
      'Maricón de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre], y no hay quien te salve el papelón, coño.',
      'El asco. No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Maricón de malinterpretar el mute como interés por el personaje barato, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre], y no hay quien te salve el papelón, patético.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre], y no hay quien te salve el papelón, asco.',
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre], y no hay quien te salve el papelón, basura.',
      'Has hecho del personajito tu marca y la marca se pega en los dedos ajenos, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre], y no hay quien te salve el papelón, joder.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre], y no hay quien te salve el papelón, mierda.',
      'Maricón constante: la única racha que mantienes es la del mismo número, [nombre], y no hay quien te salve el papelón, coño.',
      'Maricón de racha perfecta: lo único que no fallas es el mismo número, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Maricón de estribillo sin punto final limpio ni redención posible, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre], y no hay quien te salve el papelón, patético.',
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre], y no hay quien te salve el papelón, asco.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de pose, [nombre], y no hay quien te salve el papelón, basura.',
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Maricón de ceja ajena levantada y respeto en el sótano del ranking, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Maricón de letrero grasiento: se lee de lejos y no invita a entrar, [nombre], y no hay quien te salve el papelón, joder.',
      'Maricón de las que alardean del teatro porque callar las deja sin rol, [nombre], y no hay quien te salve el papelón, mierda.',
      'Maricón de error de lectura: confundes límites con permiso para seguir, [nombre], y no hay quien te salve el papelón, coño.',
      'Has convertido el personajito en identidad. y no hay detergente narrativo, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has firmado el personajito con grasa en cada mensaje como única firma, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'No hay eco de estilo: hay eco de pose. Y el chat lo amplifica de más, [nombre], y no hay quien te salve el papelón, patético.',
      'Maricón visible desde lejos: el rastro se ve, la parada no compensa, [nombre], y no hay quien te salve el papelón, asco.',
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre], y no hay quien te salve el papelón, basura.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre], y no hay quien te salve el papelón, ridículo.',
      'La clase te suena a ataque y respondes con más del mismo plato grasiento, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre], y no hay quien te salve el papelón, joder.',
      'Tienes más episodios de pose que de algo que. El chat respete de verdad, [nombre], y no hay quien te salve el papelón, mierda.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre], y no hay quien te salve el papelón, coño.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre], y no hay quien te salve el papelón, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre], y no hay quien te salve el papelón, asco.',
      'Tu mensaje es un aviso de lo que no hay que tomar en serio en el grupo, [nombre], y no hay quien te salve el papelón, basura.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje de teatro, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre], y no hay quien te salve el papelón, joder.',
      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. Y el chat lo tiene claro, asco.',
      'Maricón sin capa de carisma que disimule el agujero.coño, y no hay quien te salve el papelón, coño Hostia puta, coño.',
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, cabrón.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre], y no hay quien te salve el papelón, patético.',
      'Maricón de ranking: bajas la media del nivel con constancia molesta, [nombre], y no hay quien te salve el papelón, asco.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre], y no hay quien te salve el papelón, basura.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre], y no hay quien te salve el papelón, ridículo.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre], y no hay quien te salve el papelón, fracasado.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre], y no hay quien te salve el papelón, joder.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre], y no hay quien te salve el papelón, mierda.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre], y no hay quien te salve el papelón, coño.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre], y no hay quien te salve el papelón, patético.',
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre], y no hay quien te salve el papelón, asco.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre], y no hay quien te salve el papelón, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Has hecho del bajo listón tu residencia. y no hay mudanza a la vista, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. Y el chat lo tiene claro, joder.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre], y no hay quien te salve el papelón, mierda.',
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. Y el chat lo tiene claro, coño.',
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Maricón de los que el high del ranking no perdona ni un frame, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre], y no hay quien te salve el papelón, patético.',
      'No hay barniz que salve: hay pose pura y no se vende como carisma, [nombre]. Y el chat lo tiene claro, asco.',
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'El high no es un mal día de pose: es.ridículo, y no hay quien te salve el papelón, ridículo Hostia puta, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      ...
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre], y no hay quien te salve el papelón, basura.',
      ...
      'Se te nota que ensuciaste el hilo de pose hace tiempo y perdiste el bayeta, [nombre], y no hay quien te salve el papelón, fracasado.',
      ...
      'Tienes más grasa de pose en el discurso que un freidor al cierre de feria, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga sola, [nombre], y no hay quien te salve el papelón, fracasado.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre].coño, y no hay quien te salve el papelón, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre], y no hay quien te salve el papelón, fracasado.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre], y no hay quien te salve el papelón, gilipollas.',
  ...
  simp: {
    ...
    high: [
      ...
      'Se te nota el rastro de simp hasta en los mensajes que pretenden ser neutrales, [nombre] el nivel te nombra sin permiso De frame, patético.',
      'Simp convertido en wallpaper del fail colectivo, joder.asco, y no hay quien te salve el papelón, asco.',
      'Has convertido la sumisión en identidad. y no hay detergente que la limpie, [nombre], y no hay quien te salve el papelón, basura.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder.joder, y no hay quien te salve el papelón, joder.',
      ...
      'Tienes más episodios de simp documentados que intentos de tener criterio, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Simp cutre: ni la entrega tiene gracia ni la falta de dignidad tiene misterio, [nombre], gilipollas.',
      'Has hecho del bajo listón tu residencia. y no hay mudanza a la vista, [nombre], y no hay quien te salve el papelón, patético.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'No hay misterio interesante: hay previsible y simp, el combo del high, [nombre] el nivel te nombra sin permiso, mierda.',
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre], y no hay quien te salve el papelón, coño.',
      'Simp de inercia: el grupo te soporta por costumbre, no por respeto, [nombre], y no hay quien te salve el papelón, cabrón.',
      'El recato de dignidad te queda lejos y la distancia es rechazo, no mística, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Simp de ranking: bajas la media del nivel con monólogos de validación ajena, [nombre] El ranking firma y listo, patético.',
      ...
      'Simp de fondo permanente: el high no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, joder.',
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      'Tienes más grasa de validación ajena que un foro de fans sin moderación, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre] el nivel te nombra sin permiso, y se te nota a la legua, basura.',
      'La dignidad no te coge el teléfono: el buzón está lleno de síes ajenos, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre], y no hay quien te salve el papelón, fracasado.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Simp de estribillo sin punto final limpio ni redención posible, [nombre] el nivel te nombra sin permiso, joder.',
      'Se te nota el peso de arrastrar el mismo pedestal por cada conversación, [nombre], y no hay quien te salve el papelón, asco.',
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'Simp de feria de validación: ruido interno, cero ganas de volver del resto, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Se te ve venir el sí en la primera palabra del mensaje, [nombre] El ranking firma y listo, gilipollas.',
      'La dignidad del nivel no para: tú eres el tráfico del arcén del pedestal, [nombre] Se ve desde el primer mensaje, patético.',
      ...
      'Tienes el tono de quien acumula fichas de validación y nunca dice no, [nombre] el nivel te nombra sin permiso, ridículo.',
      'Simp de las que alardean del pedestal porque el criterio las deja sin personaje, [nombre]. Ridículo.',
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre, [nombre], y no hay quien te salve el papelón, patético.',
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre]asco, y no hay quien te salve el papelón, asco.',
      ...
      'No hay eco de dignidad: hay eco de pedestal. Y el chat lo amplifica, [nombre] el nivel te nombra sin permiso, diagnóstico cerrado, mierda.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en el ranking, [nombre], y no hay quien te salve el papelón, coño.',
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre], y no hay quien te salve el papelón, cabrón.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Simp de superficie: basta la vista, no hace falta el sótano del historial, [nombre] el nivel te nombra sin permiso, fracasado.',
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre], y no hay quien te salve el papelón, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre], y no hay quien te salve el papelón, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre] el nivel te nombra sin permiso, basura.',
      'Simp de fondo: bajas la media del high con la constancia de quien no se levanta, [nombre]. Pringado, ridículo.',
      'No es estilo: es simp previsible y el high te lo nombra entero, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes más episodios de pedestal que intentos de subir el listón propio, [nombre], y no hay quien te salve el papelón, joder.',
      'Simp de respeto ajeno en números rojos del ranking de dignidad, [nombre] El ranking firma y listo, y, mierda.',
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre] Se ve desde el primer mensaje, sin anestesia, coño.',
      ...
      'Simp hasta para el modo oscuro: ni la sombra tapa el sí eterno, [nombre] el nivel te nombra sin permiso, sin filtro ni consuelo, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre], y no hay quien te salve el papelón, asco.',
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El high no es un mal día de carácter: es.mierda, y no hay quien te salve el papelón, mierda Hostia puta, mierda.',
      ...
      'Simp de repertorio: siempre la misma validación y cero plan B de dignidad, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Simp sin complejo útil: el complejo al menos indicaría que viste el pedestal, [nombre], y no hay quien te salve el papelón, patético.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre], y no hay quien te salve el papelón, asco.',
  ...
  rata: {
    ...
    high: [
      ...
      'El listón de la dignidad lo usas de rampa para trepar sobre otros en el chat, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El recato te queda a años luz y la distancia es rechazo, no mística de rata, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre], y no hay quien te salve el papelón, fracasado.',
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado en el ranking, [nombre], y no hay quien te salve el papelón, joder.',
      'Rata de inercia: el grupo te soporta por costumbre, no por interés real, [nombre], y no hay quien te salve el papelón, mierda.',
      'Tienes el tono de quien acumula restos ajenos y nunca pasa el estropajo, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Rata de feria: grasa, ruido, suelo peor y cero ganas de volver a la atracción, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Tienes más caras que un dado y menos dignidad que un cenicero de bar a las seis, [nombre], gilipollas.',
      'Rata sin estilo: ni el vicio tiene gracia ni el robo de atención tiene mérito, [nombre], y no hay quien te salve el papelón, patético.',
      'Rata de las que. El ranking de aporte deja en el sótano con razón documentada, [nombre], y no hay quien te salve el papelón, asco.',
      'No es gracia sucia: es ratez sin gracia, la versión que no entretiene a nadie, [nombre], y no hay quien te salve el papelón, basura.',
      'Rata de fondo: bajas la media con la constancia de quien no se cansa de sacar, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Se te oye el masticar del bajo listón hasta en los mensajes serios del chat, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'El recato te saluda desde la orilla limpia y tú no sales del barro del chat, [nombre], y no hay quien te salve el papelón, patético.',
      'No es estilo: es ratez previsible y el high te la cobra entera en el nivel, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Rata sin redención estética: solo hambre de lo ajeno y cero de producción, [nombre], y no hay quien te salve el papelón, ridículo.',
      'No hay misterio interesante: hay previsible y rata, el combo flojo del high, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Rata de las que el mute ajeno lee como invitación y se equivoca de libro, [nombre], y no hay quien te salve el papelón, joder.',
      'Se te nota el peso de arrastrar el interés propio por cada hilo del grupo, [nombre], y no hay quien te salve el papelón, mierda.',
      'Rata de las que roban el oxígeno del hilo y no devuelven ni un mensaje útil, [nombre], y no hay quien te salve el papelón, coño.',
      'Rata de manual: te aprovechas del grupo y encima miras con cara de víctima, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Se te nota el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder.basura, y no hay quien te salve el papelón, basura.',
      ...
      'Rata de historial público: no hace falta escarbar, está en la superficie, [nombre] el nivel te nombra sin permiso, nivel sótano puro, fracasado.',
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre], y no hay quien te salve el papelón, joder.',
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre], y no hay quien te salve el papelón, mierda.',
      'Has convertido. El chat en tu despensa y al resto en inventario de provecho, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'Rata de ranking: bajas la media del grupo con constancia molesta, [nombre] el nivel te nombra sin permiso, sin maquillaje posible, basura.',
      'Has convertido lo rata en marca personal y la marca se pega en los dedos, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Rata de estribillo que mancha más con cada repetición del mismo plato, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'El promedio de ratez es este: el high no es un mal día, es el nivel, [nombre] el nivel te nombra sin permiso, patético.',
      'Has convertido la rata en identidad. y no hay detergente narrativo, [nombre], y no hay quien te salve el papelón, asco.',
      'Rata cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre], y no hay quien te salve el papelón, basura.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Has dejado. El chat como fregadero a medias: restos eternos de ratez, [nombre] el nivel te nombra sin permiso, el chat ya lo sabía, cabrón.',
      'Rata de estribillo sin punto final limpio ni redención posible, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'La compostura cruza de acera cuando te ve en el ranking del high, [nombre], y no hay quien te salve el papelón, patético.',
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre]asco, y no hay quien te salve el papelón, asco.',
      ...
      'Das asco. De entrada y el resto del mensaje solo confirma el desastre, [nombre] el nivel te nombra sin permiso, con el grupo de testigo.',
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre], y no hay quien te salve el papelón, coño.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre], y no hay quien te salve el papelón, cabrón.',
      'La clase te suena a ataque y respondes dejando más migas de interés ajeno, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] el nivel te nombra sin permiso, gilipollas.',
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre].joder, y no hay quien te salve el papelón, joder.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre], y no hay quien te salve el papelón, mierda.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'Rata de malinterpretar el mute como invitación a seguir sacando, [nombre] el nivel te nombra sin permiso, sin anestesia, basura.',
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre] Se ve desde el primer mensaje, y se te nota a la legua, coño.',
      ...
      'El promedio de ratez es el nivel: no un pico, el suelo del high, [nombre] el nivel te nombra sin permiso, patético.',
      'Has convertido la rata en carnet. y no hay renovación limpia, [nombre].asco, y no hay quien te salve el papelón, asco.',
      'Rata de puta madre en el sentido literal: el high no suaviza el hocico, [nombre], y no hay quien te salve el papelón, basura.',
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Tu mensaje es un aviso de lo que no hay que dejar suelto en el grupo, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Rata con la disciplina de quien nunca ha devuelto una puta favor, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'El high no es un mal día de ética: es.patético, y no hay quien te salve el papelón, patético Hostia puta, patético.',
      'Tienes una presencia que ensucia el hilo en un solo movimiento de rata, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Has hecho de la rata tu marca y la marca se pega en los dedos ajenos, [nombre] el nivel te nombra sin permiso, y, mierda.',
      'Rata de las que confunden astucia con no tener vergüenza en el ranking, [nombre], y no hay quien te salve el papelón, coño.',
      'No es viveza con gracia: eres rata y el high no discute la evidencia, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'Se te ve el hocico de rata cada vez que huele a beneficio fácil en el chat, [nombre], y no hay quien te salve el papelón, patético.',
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de las ratas, [nombre], y no hay quien te salve el papelón, asco.',
      'Tienes más episodios de rata documentados que intentos de subir el nivel, [nombre], y no hay quien te salve el papelón, basura.',
      ...
      'Has hecho de lo rata una marca personal y la marca se pega en los dedos, [nombre], y no hay quien te salve el papelón, joder.',
      'Has convertido el bajo listón en residencia fija sin mudanza a la vista, [nombre], y no hay quien te salve el papelón, mierda.',
      'No es atrevimiento: es suciedad de interés y el high te la cobra entera, [nombre], y no hay quien te salve el papelón, coño.',
      'Tienes más grasa de rata en el discurso que un freidor de feria al cierre, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'El olor a rata se te nota en cada mensaje que pide sin dar nada a cambio, [nombre], y no hay quien te salve el papelón, asco.',
      'Se te oye el arrastre de la rata hasta en los mensajes cortos del hilo, [nombre], y no hay quien te salve el papelón, basura.',
      'Rata sin punto final limpio: el estribillo se repite y mancha más cada vez, [nombre], y no hay quien te salve el papelón, ridículo.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes el aura de quien pide prestado y nunca devuelve ni las gracias, [nombre], y no hay quien te salve el papelón, joder.',
      'Rata de las que el grupo aguanta por inercia y no por respeto de verdad, [nombre], y no hay quien te salve el papelón, mierda.',
      'Rata de repertorio gastado: las mismas manchas, el mismo plato de siempre, [nombre], y no hay quien te salve el papelón, coño.',
      'El promedio de ratez es este: el nivel no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has convertido. El chat en tu zona de obras grasientas sin fecha de fin, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Has hecho de lo rata tu plato favorito y lo sirves en todas las mesas, [nombre], y no hay quien te salve el papelón, joder.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki de puta madre: el high no suaviza el sótano ni el monólogo eterno, [nombre] el nivel te nombra sin permiso, coño.',
      'La dignidad del nivel no para: tú eres el tráfico del arcén social, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      ...
      'La compostura del nivel no te reconoce en el elenco social del chat, [nombre]. El high no suaviza, gilipollas.',
      'Tienes más grasa de referencia inútil que un wiki sin editores en el chat, [nombre]. El high no suaviza, patético.',
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Friki de manual cutre: el estereotipo sin el carisma que a veces salva al raro, [nombre], y no hay quien te salve el papelón, coño.',
      'La compostura social no te reconoce y tú no has buscado el espejo del chat, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'Friki de ceja ajena levantada y respeto social en el sótano del ranking, [nombre] el nivel te nombra sin permiso, fracasado.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre], y no hay quien te salve el papelón, joder.',
      'Friki que se enfada porque no valoran su afición. Nadie está obligado, gilipollas. Y exigir valoración ya es haber perdido.',
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre], y no hay quien te salve el papelón, coño.',
      'Friki de fondo permanente: el high no es un mal día, es el nivel del nivel, [nombre] El ranking firma y listo, el chat ya lo sabía, cabrón.',
      'Friki con el bucle eterno del mismo error en bucle, joder.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre], y no hay quien te salve el papelón, ridículo.',
      'No es profundidad: es aislamiento con teclado y el nivel te lo cobra, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Has hecho del bajo listón social tu casa. y no hay mudanza a la vista, [nombre] el nivel te nombra sin permiso, joder.',
      'Friki de malinterpretar el silencio ajeno como interés por el lore, [nombre], y no hay quien te salve el papelón, asco.',
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre], y no hay quien te salve el papelón, basura.',
      'Has convertido el nicho en identidad. y no hay detergente de salida, [nombre], y no hay quien te salve el papelón, ridículo.',
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] El ranking firma y listo, gilipollas.',
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder.joder, y no hay quien te salve el papelón, joder.',
      ...
      'Tienes el historial de un servidor vacío: roles, cero gente, [nombre] el nivel te nombra sin permiso, ridículo.',
      ...
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Friki de ranking: bajas la media del nivel con monólogos que no piden respuesta, [nombre], nivel sótano puro, gilipollas.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre]. El high no suaviza, joder.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre], y no hay quien te salve el papelón, coño.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo sin estilo: el desastre sin estética es solo un problema de higiene del hilo, y no hay quien te salve el papelón, ridículo.',
      'Tienes más episodios de cerdez documentada que intentos de subir el nivel un punto, y no hay quien te salve el papelón, fracasado.',
      'El promedio de cerdez es el nivel: no un pico, el suelo del nivel, [nombre], y no hay quien te salve el papelón, joder.',
      'El asco. Colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre], y no hay quien te salve el papelón, mierda.',
      'Cerdo de las que alardean de la grasa porque callar las dejaría sin personaje, y no hay quien te salve el papelón, coño.',
      'Das asco. De entrada y el resto del mensaje solo confirma el desastre, [nombre], y no hay quien te salve el papelón, cabrón.',
      '[nombre], tu manera de fregar el suelo es esperar a que se seque solo. Cada mancha se queda a vivir. Puta casa de mierda.',
      'Se te nota la prisa por embadurnar el chat y cero ganas de limpiar después, y no hay quien te salve el papelón, patético.',
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor.asco, y no hay quien te salve el papelón, asco.',
      'El asco. No es moralina: es el termómetro y te marca cerdez crónica, [nombre], y no hay quien te salve el papelón, basura.',
      'Tienes más restos en el relato que un cubo de basura. El día de recogida, y no hay quien te salve el papelón, ridículo.',
      ...
      'No es atrevimiento: es suciedad previsible y el high te la cobra sin descuento, [nombre], y no hay quien te salve el papelón, basura.',
      'Se te oye el masticar de la cerdez hasta en los mensajes que quieren parecer neutros, y no hay quien te salve el papelón, ridículo.',
      ...
      'Has convertido el grupo en tu comedero y los demás en testigos del banquete, [nombre], y no hay quien te salve el papelón, joder.',
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre], y no hay quien te salve el papelón, mierda.',
      'Cerdo sin capa de carisma que disimule el agujero. Fracasado. Joder, y no hay quien te salve el papelón, coño.',
      ...
      'El listón de lo decente lo usas de servilleta y lo tiras al suelo del chat, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'La palabra compostura te suena a idioma de otro planeta y no has abierto el diccionario, y no hay quien te salve el papelón, ridículo.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo plato sin fregar, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Eres el guarro que deja el pelo en el lavabo y se va, [nombre]. Que lo recoja el siguiente, como todo lo tuyo. Puta dejadez.',
      'Cerdo de historial público: la grasa está en la superficie, no hace falta escarbar, y no hay quien te salve el papelón, mierda.',
      'Se te ve la prisa por embadurnar y la ausencia total de plan de limpieza, [nombre], y no hay quien te salve el papelón, coño.',
      'Cerdo de fondo permanente: baja la media del grupo con constancia de metrónomo, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Tu escritorio tiene manchas superpuestas que ya forman un patrón geológico, cerdo. Cada capa es un mes de mierda. Acumulada.',
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre], y no hay quien te salve el papelón, patético.',
      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre], y no hay quien te salve el papelón, asco.',
      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre], y no hay quien te salve el papelón, basura.',
      'Tienes más grasa en el discurso que un freidora de feria al cierre de la noche, y no hay quien te salve el papelón, ridículo.',
      'El promedio de cerdez es este: el nivel no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Cerdo de error de lectura: confundes límites con permiso para seguir manchando, y no hay quien te salve el papelón, joder.',
      'Tienes cepillos de dientes viejos criando ahí al lado del que usas, [nombre]. Un puto museo de bacterias con vaso propio.',
      'Cerdo sin redención estética: solo grasa, sin capa de carisma que disimule el agujero, y no hay quien te salve el papelón, coño.',
      ...
      'Has convertido el bajo listón en residencia: sin mudanza a la vista de nadie, y no hay quien te salve el papelón, patético.',
      'Tienes más migas en el historial que un mantel de bar después del desayuno eterno, y no hay quien te salve el papelón, asco.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos de limpieza, y no hay quien te salve el papelón, basura.',
      'No es estilo atrevido: es grasa previsible y el high te la cobra entera, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'No es libertad: es falta de criterio con migas y el resultado se huele, [nombre], y no hay quien te salve el papelón, mierda.',
      'Se te nota el hábito de empujar cada tema hacia el mismo plato sin fregar, [nombre], y no hay quien te salve el papelón, coño.',
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar, y no hay quien te salve el papelón, gilipollas.',
      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre], y no hay quien te salve el papelón, patético.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, joder, con el grupo de testigo, y no hay quien te salve el papelón, fracasado.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre, joder, y no hay quien te salve el papelón, mierda.',
      'El listón de lo presentable lo usas de tobogán hacia abajo, joder, [nombre], y no hay quien te salve el papelón, coño.',
      'Cerdo sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado, y no hay quien te salve el papelón, cabrón.',
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'El asco. No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre], y no hay quien te salve el papelón, joder.',
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre], y no hay quien te salve el papelón, mierda.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'Cerdo de ranking: bajas la media del nivel con constancia de mancha, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Has convertido el bajo listón en casa fija sin fecha de mudanza, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre], y no hay quien te salve el papelón, asco.',
      'Has convertido la porquería en carnet. y no hay renovación limpia, [nombre], y no hay quien te salve el papelón, basura.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El grupo paga tu rastro en cuotas diarias de asco. Documentado, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre].patético, y no hay quien te salve el papelón, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre]asco, y no hay quien te salve el papelón, asco.',
      ...
      'Cerdo de superficie: no hace falta abrir el cubo, huele de lejos, [nombre], y no hay quien te salve el papelón, coño.',
      'No hay barniz que salve: hay cerdo puro y no se vende como carisma, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Tienes el tono de quien acumula restos y nunca pasa el estropajo, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'La clase te suena a ataque y respondes con más migas de suciedad, [nombre], y no hay quien te salve el papelón, joder.',
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre], y no hay quien te salve el papelón, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'La compostura del nivel no te reconoce en el elenco, [nombre]. Y el chat lo tiene claro, y no hay quien te salve el papelón, asco.',
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre], y no hay quien te salve el papelón, basura.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre] El grupo no necesita subtítulos, asco.',
      ...
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Cerdo hasta para el modo oscuro: ni la sombra tapa lo que dejas, [nombre], y no hay quien te salve el papelón, patético.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El high no es un mal día de orden: es.mierda, y no hay quien te salve el papelón, mierda Hostia puta, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre].coño, y no hay quien te salve el papelón, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]gilipollas, y no hay quien te salve el papelón, gilipollas.',
      ...
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo, y no hay quien te salve el papelón, mierda.',
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual, y no hay quien te salve el papelón, coño.',
      'Has hecho de lo indecente tu plato favorito y lo sirves en todas las mesas, y no hay quien te salve el papelón, cabrón.',
      'No es gracia sucia: es suciedad sin gracia, la versión que no entretiene, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'El listón está en el suelo y tú lo usas de pan para mojar sin vergüenza, [nombre], y no hay quien te salve el papelón, patético.',
      'Cerdo de oficio: el rastro de grasa es tu firma y aparece en cada párrafo, y no hay quien te salve el papelón, asco.',
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible, y no hay quien te salve el papelón, basura.',
      'Dejas el baño de tal manera que hay que limpiarlo antes de poder usarlo. Puta escena del crimen con toalla húmeda.',
      'Tienes el tono de quien come con la boca abierta en un restaurante en silencio, y no hay quien te salve el papelón, fracasado.',
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual.joder, y no hay quien te salve el papelón, joder.',
      'Tienes una manta que huele desde hace meses y duermes con ella cada noche. Ni un animal aguanta eso, puto guarro.',
      'Has hecho de lo cutre una marca y la marca se pega en los dedos del que lee, y no hay quien te salve el papelón, coño.',
      'La palabra clase te suena a reproche y respondes ensuciando un poco más.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Se te oye el arrastre de la grasa hasta en los mensajes cortos del chat, y no hay quien te salve el papelón, gilipollas.',
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio, y no hay quien te salve el papelón, patético.',
      'Tienes más manchas documentadas que intentos serios de pasar un trapo al relato, y no hay quien te salve el papelón, asco.',
      'Has convertido la grasa en carnet. y no hay renovación limpia a la vista.basura, y no hay quien te salve el papelón, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla, y no hay quien te salve el papelón, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan Bfracasado, y no hay quien te salve el papelón, fracasado.',
      'Has convertido la mancha en identidad. y no hay detergente narrativo a la vista, y no hay quien te salve el papelón, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar.mierda, y no hay quien te salve el papelón, mierda.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre], y no hay quien te salve el papelón, coño.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro, y no hay quien te salve el papelón, cabrón.',
      'Cerdo sin higiene narrativa: ensucias el hilo y no recoges nunca el escombro, y no hay quien te salve el papelón, gilipollas.',
    ],
    mid: [
  ...
  femboy: {
    ...
    high: [
      ...
      'Femboy de manual cutre: el estereotipo sin el carisma que a veces lo salva, [nombre] el nivel te nombra sin permiso, basura.',
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Femboy como un anuncio repetido que nadie pidió, joder, con el grupo de testigo, y no hay quien te salve el papelón, fracasado.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre], y no hay quien te salve el papelón, joder.',
      'Femboy en crudo: ni el maquillaje del ranking te cubre, joder, y no hay quien te salve el papelón, mierda.',
      ...
      'Femboy sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado, y no hay quien te salve el papelón, cabrón.',
      ...
      'Femboy de historial público: no hace falta escarbar, está en la superficie, [nombre] el nivel te nombra sin permiso, sin filtro ni consuelo, patético.',
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre], y no hay quien te salve el papelón, asco.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Femboy de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre] el nivel te nombra sin permiso, cabrón.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      'Femboy de inercia: el grupo te soporta por costumbre, no por respeto, [nombre], y no hay quien te salve el papelón, asco.',
      'El recato te queda lejos y la distancia es rechazo, no mística de personaje, [nombre] El ranking firma y listo, coño.',
      'Femboy de ranking: bajas la media del nivel con constancia molesta, [nombre] Se ve desde el primer mensaje, cabrón.',
      ...
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre] el nivel te nombra sin permiso, asco.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre], y no hay quien te salve el papelón, coño.',
      'Femboy de fondo permanente: el high no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, cabrón.',
      'No es atrevimiento: es suciedad de personaje y el nivel te la cobra, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Femboy cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre] el nivel te nombra sin permiso, nivel sótano puro, fracasado.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre], y no hay quien te salve el papelón, joder.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre], y no hay quien te salve el papelón, mierda.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre] el nivel te nombra sin permiso, sin maquillaje posible, basura.',
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre], y no hay quien te salve el papelón, fracasado.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre] El grupo no necesita subtítulos, cabrón.',
      'Femboy de superficie suficiente: no hace falta abrir el cubo, huele, [nombre] Eso no se maquilla con ángulo, gilipollas.',
      'No hay barniz que salve: hay pose pura y no se vende como carisma, [nombre] el nivel te nombra sin permiso, patético.',
      'Femboy de puta madre: el high no suaviza el teatro ni el personajito, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El grupo te aguanta el teatro por educación. Por dentro todos tienen el mismo desastre y no es amable, cabrón.',
      ...
      'Tu historial de búsquedas, tus compras y tu forma de sentarte ya formaron un tribunal, y no hay quien te salve el papelón, gilipollas.',
    ],
    mid: [
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el nivel, [nombre], y no hay quien te salve el papelón, ridículo.',
      'La clase de aportar te suena a reproche, [nombre], coño. Y el chat lo tiene claro, y no hay quien te salve el papelón, fracasado.',
      'El asco. Del nivel es este: presencia sin función, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'Se te ve venir el vacío en la primera palabra del mensaje del hilo, [nombre], y no hay quien te salve el papelón, coño.',
      'Se te oye el eco del vacío cada vez que intentas llenar un silencio del hilo, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'Inútil de manual: ni para el drama aportas algo que no sea ruido de fondo, [nombre], y no hay quien te salve el papelón, patético.',
      'Has firmado lo inútil en cada mensaje largo que no sostiene nada del hilo, [nombre], y no hay quien te salve el papelón, asco.',
      'No hay misterio útil: hay previsible vacío en el nivel del comando, [nombre], y no hay quien te salve el papelón, basura.',
      'El promedio de inutilidad es el nivel: no un mal día, el suelo del high, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Inútil de superficie suficiente: no hace falta el sótano del historial, [nombre], y no hay quien te salve el papelón, joder.',
      'La vergüenza ajena te sigue cuando pretendes ser necesarios en el chat, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'Inútil de error crónico: confundes mute con misterio en el ranking, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Tu forma de contribuir es asentir a lo que decidan otros. Eso no es contribuir, gilipollas. Eso es hacer bulto con opinión.',
      'Inútil documentado: el ranking de aporte te deja donde mereces sin debate, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Inútil con las mismas cartas manchadas de siempre y sin plan B, joder, diagnóstico cerrado, y no hay quien te salve el papelón, cabrón.',
      'Inútil de cartel vacío: se ve el marco. y no hay obra detrás del nick, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre], y no hay quien te salve el papelón, joder.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre], y no hay quien te salve el papelón, mierda.',
      'Inútil sin capa de carisma que disimule el agujero, joder, y no hay quien te salve el papelón, coño.',
      ...
      'No es silencio estratégico: es ausencia de contenido útil, [nombre], y no hay quien te salve el papelón, ridículo.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre]. Y el chat lo tiene claro, y no hay quien te salve el papelón, coño.',
      ...
      'El precio de tu repertorio vacío lo paga el hilo en tiempo perdido del chat, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Tienes la utilidad de un mando sin pilas: se ve, no sirve, estorba en el ranking, [nombre], y no hay quien te salve el papelón, mierda.',
      'Inútil de superficie: basta la vista, no hace falta el sótano del historial, [nombre], y no hay quien te salve el papelón, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de silences, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'Inútil de error de lectura: confundes estar con importar en el chat del grupo, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Se te nota que bajaste del tren del aporte hace tiempo y perdiste el billete, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'Inútil sin redención: el hueco que dejas cuando te vas es un alivio medible, [nombre], y no hay quien te salve el papelón, patético.',
      'Has convertido el no aportar en un hábito y el hábito en identidad del ranking, [nombre], y no hay quien te salve el papelón, asco.',
      'No es discreción: es falta de material útil con nick incluido en el ranking, [nombre], y no hay quien te salve el papelón, basura.',
      'Inútil de estribillo que empeora con cada repetición del mismo vacío, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Inútil constante: la única racha que mantienes es la de no servir en el chat, [nombre], y no hay quien te salve el papelón, mierda.',
      'Inútil de feria ambulante: ruido sin recuerdo bueno en el historial del chat, [nombre], y no hay quien te salve el papelón, coño.',
      'Has firmado lo inútil como quien no sabe firmar otra cosa en el ranking, [nombre], y no hay quien te salve el papelón, cabrón.',
      'No hay misterio de inutilidad interesante: hay lo previsible del high, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Inútil de feria: ruido, cero sustancia, el suelo igual de sucio del ranking, [nombre], y no hay quien te salve el papelón, asco.',
      'Inútil de inercia: el grupo te soporta por costumbre, no por interés real, [nombre], y no hay quien te salve el papelón, basura.',
      'La vergüenza ajena te sigue cuando intentas parecer necesarios en el hilo, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El recato de no hablar no te salva: cuando hablas se confirma el diagnóstico, [nombre], y no hay quien te salve el papelón, mierda.',
      'Se te nota la prisa por ocupar sitio y cero plan de justificarlo en el chat, [nombre], y no hay quien te salve el papelón, coño.',
      'Tienes el tono de quien acumula mensajes sin acumular peso en el ranking, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has convertido el no servir en carnet de identidad del ranking del grupo, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Inútil de superficie: la profundidad no aparece ni con zoom del historial, [nombre], y no hay quien te salve el papelón, patético.',
      ...
      'Tienes más ausencias de criterio que mensajes con sustancia en el chat, [nombre], y no hay quien te salve el papelón, basura.',
      'La dignidad del aporte no para: tú eres el tráfico del arcén del ranking, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Inútil de inercia: el grupo te lee por costumbre, no por interés real, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes el tono de noches de chat sin una frase que pese en el ranking, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Tienes el historial de un cierre sanitario de sustancia en el ranking, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Inútil visible desde lejos: el letrero no compensa la parada del chat, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Se te nota que perdiste el mapa del aporte hace tiempo en el ranking, [nombre], y no hay quien te salve el papelón, patético.',
      ...
      'Has dejado. El chat como obra sin plano: escombro de mensajes sin función, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Tienes más episodios de no aportar que de intentarlo en serio en el chat, [nombre], y no hay quien te salve el papelón, fracasado.',
      ...
      'No es gracia seca: es vacío sin gracia en el nivel del comando, [nombre], y no hay quien te salve el papelón, coño.',
      'La dignidad del aporte hace autostop y el tráfico eres tú en el ranking, [nombre], y no hay quien te salve el papelón, cabrón.',
      '[nombre], inútil de mierda: no sabes hacer, no sabes pedir ayuda y no sabes apartarte. El pack completo del estorbo con patas.',
      'Inútil de malinterpretar el silencio ajeno como interés por el vacío, [nombre], y no hay quien te salve el papelón, patético.',
      'Se te nota el hábito de empujar cada hilo hacia ninguna parte útil, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Se te nota el arrastre de no empujar nunca hacia arriba del ranking, [nombre], y no hay quien te salve el papelón, mierda.',
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre]coño, y no hay quien te salve el papelón, coño.',
      'Inútil de malinterpretar el silencio como invitación a seguir vacíos, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'La compostura del aporte no te reconoce en el ranking del grupo, [nombre], y no hay quien te salve el papelón, basura.',
      'No hay barniz de personaje: hay inutilidad pura en el nivel, [nombre], y no hay quien te salve el papelón, ridículo.',
      'No hay barniz: hay inutilidad pura en el nivel del comando, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre]joder, y no hay quien te salve el papelón, joder.',
      'El asco. Resume el nivel: presencia sin función en el chat del grupo, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'Se te oye el tacón del listón bajo hasta en los neutros del chat, [nombre], y no hay quien te salve el papelón, basura.',
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre], y no hay quien te salve el papelón, ridículo.',
      'La clase de aportar te suena a reproche en el ranking del grupo, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre].joder, y no hay quien te salve el papelón, joder.',
      'Has hecho de lo inútil tu estribillo sin público nuevo en el hilo, [nombre], y no hay quien te salve el papelón, mierda.',
      'Has hecho ranking de no aportar y vas primero sin rival serio, [nombre], y no hay quien te salve el papelón, coño.',
      'Se te ve venir el vacío en la primera frase del mensaje del hilo, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Inútil de racha: lo único constante es no servir en el ranking, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Inútil de feria: ruido, cero recuerdo, suelo peor del ranking, [nombre], y no hay quien te salve el papelón, patético.',
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre]asco, y no hay quien te salve el papelón, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del nivel, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre], y no hay quien te salve el papelón, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre].coño, y no hay quien te salve el papelón, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre]patético, y no hay quien te salve el papelón, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre].asco, y no hay quien te salve el papelón, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'No hay eco de sustancia: hay eco de hueco en el nivel, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre], y no hay quien te salve el papelón, patético.',
      'La dignidad del nivel no para el coche: tú eres el tráfico del arcén, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Se te oye el eco del fail hasta en los mensajes que pretenden sonar a plan B, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Tienes más grasa de derrota en el discurso que un vestuario después del 0-5, [nombre] el nivel te nombra sin permiso De frame, patético.',
      'Perdedor de los que el high del ranking no perdona ni un frame del historial, [nombre], y no hay quien te salve el papelón, asco.',
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del nivel, [nombre], y no hay quien te salve el papelón, basura.',
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder.ridículo, y no hay quien te salve el papelón, ridículo.',
      ...
      'Perdedor de estribillo que mancha más con cada repetición del mismo fail, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Perdedor sin el barniz: solo el material flojo a la vista, joder, y no hay quien te salve el papelón, gilipollas.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre], y no hay quien te salve el papelón, patético.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Has convertido el almost en identidad. y no hay detergente narrativo, [nombre] el nivel te nombra sin permiso, mierda.',
      'No hay barniz que salve: hay derrota pura y no se vende como carisma, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], perdedor de mierda: esperas a ver qué pasa y nunca pasa nada bueno. Y encima te sorprende, cada puta vez.',
      'Se te oye el masticar del listón bajo hasta en los neutros del hilo, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Se te nota el peso de arrastrar la misma derrota por cada hilo, [nombre] el nivel te nombra sin permiso, fracasado.',
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre].joder, y no hay quien te salve el papelón, joder.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      'Has hecho del bajo listón tu casa. y no hay mudanza a la vista, [nombre]coño, y no hay quien te salve el papelón, coño.',
      ...
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre del ranking, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'La compostura del nivel no te reconoce en el elenco del ranking del grupo, [nombre]. El high no suaviza, joder.',
      ...
      'El promedio del high es este: no un mal día, el nivel del nivel completo, [nombre]. El high no suaviza, ridículo.',
      'Tienes más derrotas documentadas que intentos serios de subir el listón, [nombre] el nivel te nombra sin permiso, gilipollas.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre], y no hay quien te salve el papelón, asco.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre], y no hay quien te salve el papelón, basura.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] el nivel te nombra sin permiso, cabrón.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre], y no hay quien te salve el papelón, gilipollas.',
    ],
    mid: [
  ...
  puta: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], te repartes tan barato que hasta el puticlub te pediría referencia negativa, y no hay quien te salve el papelón, basura.',
      'Puta de rotación de cajero automático: sacan lo suyo y ni te miran a la cara, [nombre]. Qué, ridículo.',
      '[nombre], si el puterío cotizara en bolsa serías chicharro basura, no blue chip, y no hay quien te salve el papelón, fracasado.',
      'Has convertido el sí fácil en identidad y el grupo ya no se sorprende, [nombre], y no hay quien te salve el papelón, joder.',
      '[nombre], tienes más kilometraje que un taxi de aeropuerto en temporada alta, puta, y no hay quien te salve el papelón, mierda.',
      'Puta de las que el silencio ajeno lo leen como invitación a más teatro, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], te abres en canal por atención y luego te ofendes si te tratan como producto, y no hay quien te salve el papelón, cabrón.',
      'El listón del respeto lo enterraste tú misma con cada estribillo barato, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio.patético, y no hay quien te salve el papelón, patético.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin, basura, y no hay quien te salve el papelón, basura.',
      'Puta de repertorio corto: las mismas cartas de \'mírame\' en cada mano, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], has hecho del almost de intocable tu marca personal y, y no hay quien te salve el papelón, fracasado.',
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre]joder, y no hay quien te salve el papelón, joder.',
      '[nombre], puta de las que el putero profesional pediría descuento por volumen, y no hay quien te salve el papelón, mierda.',
      'Te repartes como flyer de discoteca mala: nadie lo pidió y acaba en el suelo, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], tu sí vale menos que un like anónimo de madrugada.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Puta sin el barniz de \'liberada\': solo hambre de validación barata, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], has convertido el chat en tu escaparate y el producto está en oferta, y no hay quien te salve el papelón, patético.',
      'Se te oye el estribillo de disponibilidad hasta en los mensajes \'serios\', [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], puta de manual: el ranking te nombra y tú posas.basura, y no hay quien te salve el papelón, basura.',
      'Si el puterío fuera currículum, tendrías páginas de relleno y cero logros, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], te abres más fácil que un zip de archivo corrupto.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Puta de las que confunden atención con respeto y se caen del pedestal, [nombre], y no hay quien te salve el papelón, joder.',
      '[nombre], el grupo ya no debate: te tiene catalogada y archivada.mierda, y no hay quien te salve el papelón, mierda.',
      'Has hecho del \'cualquier mira vale\' tu política exterior, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], puta de kilometraje alto y mantenimiento cero.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Te vendes en liquidación permanente y aun así no se agota el stock, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], el sí fácil te quedó de tatuaje invisible.patético, y no hay quien te salve el papelón, patético.',
      'Puta de las que el silencio de los demás es el único filtro que te queda, [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], tienes más vueltas que un portero automático de edificio viejo, y no hay quien te salve el papelón, basura.',
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      '[nombre], te repartes con la frialdad de quien ya no espera nada a cambio, y no hay quien te salve el papelón, fracasado.',
      'Puta de fondo: el chat te usa de gag y tú sigues el libreto, [nombre], y no hay quien te salve el papelón, joder.',
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años.mierda, y no hay quien te salve el papelón, mierda.',
      'Has convertido cada hilo en casting improvisado, [nombre].coño, y no hay quien te salve el papelón, coño.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], el ranking de puta te tiene de inquilina fija.patético, y no hay quien te salve el papelón, patético.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre].asco, y no hay quien te salve el papelón, asco.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza.basura, y no hay quien te salve el papelón, basura.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], puta de manual negro: el grupo firma y tú posas.fracasado, y no hay quien te salve el papelón, fracasado.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre].joder, y no hay quien te salve el papelón, joder.',
      '[nombre], has hecho del escaparate tu única personalidad.mierda, y no hay quien te salve el papelón, mierda.',
      'Puta de las que confunden circulacion con deseo real, [nombre]coño, y no hay quien te salve el papelón, coño.',
      '[nombre], te repartes como menú del día: predecible y frío.cabrón, y no hay quien te salve el papelón, cabrón.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre].gilipollas, y no hay quien te salve el papelón, gilipollas.',
      '[nombre], puta de kilometraje visible y orgullo de cartón.patético, y no hay quien te salve el papelón, patético.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno.basura, y no hay quien te salve el papelón, basura.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      '[nombre], has convertido el almost de intocable en chiste interno.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre]joder, y no hay quien te salve el papelón, joder.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada.mierda, y no hay quien te salve el papelón, mierda.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre].coño, y no hay quien te salve el papelón, coño.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco. Documentado, y no hay quien te salve el papelón, gilipollas.',
      '[nombre], te repartes con la elegancia de un anuncio popup.patético, y no hay quien te salve el papelón, patético.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], puta de las que el sí vale menos que un sticker.basura, y no hay quien te salve el papelón, basura.',
      'Has hecho del chat tu puticlub sin cover, [nombre]ridículo, y no hay quien te salve el papelón, ridículo.',
      '[nombre], el ranking te nombra y el resto asiente sin debate.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre].joder, y no hay quien te salve el papelón, joder.',
      '[nombre], te abres en canal por atención de segunda.mierda, y no hay quien te salve el papelón, mierda.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], tienes más vueltas que el rumor del grupo.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], te vendes en liquidación y el stock no baja.patético, y no hay quien te salve el papelón, patético.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre], y no hay quien te salve el papelón, asco.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso.basura, y no hay quien te salve el papelón, basura.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      '[nombre], has convertido cada mirada en ticket de entrada.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre], y no hay quien te salve el papelón, joder.',
      '[nombre], el sí fácil te delata más que un historial público.mierda, y no hay quien te salve el papelón, mierda.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre].coño, y no hay quien te salve el papelón, coño.',
      '[nombre], puta de kilometraje alto y narrativa baja.cabrón, y no hay quien te salve el papelón, cabrón.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre]gilipollas, y no hay quien te salve el papelón, gilipollas.',
      '[nombre], has hecho del escaparate tu único argumento.patético, y no hay quien te salve el papelón, patético.',
      'Puta de las que confunden ruido con valor, [nombre].asco, y no hay quien te salve el papelón, asco Hostia puta, asco.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero.basura, y no hay quien te salve el papelón, basura.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], puta de manual negro delante del puto chat.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre].joder, y no hay quien te salve el papelón, joder.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\'mierda, y no hay quien te salve el papelón, mierda.',
      'Puta de fondo de ranking: inquilina fija del nivel, [nombre]coño, y no hay quien te salve el papelón, coño.',
      '[nombre], has convertido el almost de misterio en chiste gastado.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre].gilipollas, y no hay quien te salve el papelón, gilipollas.',
      '[nombre], puta de las que el chat archiva sin pedir bis.patético, y no hay quien te salve el papelón, patético.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre].asco, y no hay quien te salve el papelón, asco.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano, y no hay quien te salve el papelón, basura.',
      'Puta sin plot twist: solo el mismo libreto, [nombre].ridículo, y no hay quien te salve el papelón, ridículo.',
      '[nombre], te abres en canal por migajas de atención.fracasado, y no hay quien te salve el papelón, fracasado.',
      'El puterío te queda de uniforme de diario, [nombre]joder, y no hay quien te salve el papelón, joder.',
      '[nombre], has hecho del sí tu única estrategia social.mierda, y no hay quien te salve el papelón, mierda.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre], y no hay quien te salve el papelón, coño.',
      '[nombre], te vendes en oferta y el precio sigue cayendo.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Se te nota el hambre de validación a la legua, [nombre].gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros, y no hay quien te salve el papelón, asco.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], te repartes como anuncio que nadie puede cerrar.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El sí fácil te quedó de cicatriz pública, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos.joder, y no hay quien te salve el papelón, joder.',
      'Puta de las que confunden circulación con deseo, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado, y no hay quien te salve el papelón, coño.',
      'El listón del respeto está en el sótano con tu nombre, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], puta de fondo: siempre el mismo gag.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Te vendes barato y el stock no se agota nunca, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio.asco, y no hay quien te salve el papelón, asco.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Has hecho del almost de intocable tu mayor fail, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], puta de las que el putero amateur pediría recibo.joder, y no hay quien te salve el papelón, joder.',
      'Te repartes con la elegancia de un popup de virus, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti, y no hay quien te salve el papelón, coño.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], el grupo ya no se sorprende: solo documenta.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Te abres en canal por ruido de segunda división, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo.asco, y no hay quien te salve el papelón, asco.',
      'El sí fácil te delata más que cualquier captura, [nombre].basura, y no hay quien te salve el papelón, basura.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], te vendes en liquidación permanente.fracasado, y no hay quien te salve el papelón, fracasado.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre].joder, y no hay quien te salve el papelón, joder.',
      '[nombre], puta de fondo de hilo y de ranking.mierda, y no hay quien te salve el papelón, mierda Hostia puta, mierda.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre]coño, y no hay quien te salve el papelón, coño.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], te repartes como menú del día en bar de carretera.patético, y no hay quien te salve el papelón, patético.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre].asco, y no hay quien te salve el papelón, asco.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja.basura, y no hay quien te salve el papelón, basura.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], te abres más fácil que la privacidad en cero.fracasado, y no hay quien te salve el papelón, fracasado.',
      'El puterío te quedó de marca y no de accidente, [nombre]joder, y no hay quien te salve el papelón, joder.',
      '[nombre], puta de kilometraje que ya no admite garantía.mierda, y no hay quien te salve el papelón, mierda.',
      'Te vendes barato y luego quieres trato de boutique, [nombre].coño, y no hay quien te salve el papelón, coño.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Puta de manual: el bot confirma lo que el grupo ya sabía, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Si la dignidad tuviera alarma, sonaría cada vez que escribes, [nombre], y no hay quien te salve el papelón, patético.',
      '[nombre], puta de fondo: el eco te devuelve el mismo asco.asco, y no hay quien te salve el papelón, asco.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], el almost de misterio se te escapó en el primer sí.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Puta de las que confunden atención con respeto y caen, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], te abres en canal por migajas y aún así das las gracias.joder, y no hay quien te salve el papelón, joder.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], puta de ranking fijo en el sótano del respeto.coño, y no hay quien te salve el papelón, coño.',
      'Te vendes en oferta y el precio solo baja, [nombre]cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], se te nota el hambre de validación en cada puto sticker, y no hay quien te salve el papelón, gilipollas.',
      'Puta sin plot de redención en tres actos, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], has hecho del escaparate tu personalidad completa.asco, y no hay quien te salve el papelón, asco.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], puta de las que el silencio es el único que te pone límite.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Te repartes como flyer de after de mala muerte, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión.joder, y no hay quien te salve el papelón, joder.',
      'Puta de manual negro delante de todo el grupo, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], te abres más que un debate vacío y con menos contenido.coño, y no hay quien te salve el papelón, coño.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo, y no hay quien te salve el papelón, gilipollas.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], te vendes barato y el stock parece infinito.asco, y no hay quien te salve el papelón, asco.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], puta de fondo de chat: el gag eres tú.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El listón del respeto está enterrado con tu historial, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre].joder, y no hay quien te salve el papelón, joder.',
      '[nombre], has hecho del sí tu política exterior completa.mierda, y no hay quien te salve el papelón, mierda.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre]coño, y no hay quien te salve el papelón, coño.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0cabrón, y no hay quien te salve el papelón, cabrón.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre], y no hay quien te salve el papelón, gilipollas.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo.patético, y no hay quien te salve el papelón, patético.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre].asco, y no hay quien te salve el papelón, asco.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía.basura, y no hay quien te salve el papelón, basura.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre], y no hay quien te salve el papelón, ridículo.',
      '[nombre], puta de las que el almost de intocable es el gag del año.fracasado, y no hay quien te salve el papelón, fracasado.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre]joder, y no hay quien te salve el papelón, joder.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m.coño, y no hay quien te salve el papelón, coño.',
      'El sí fácil te quedó de firma digital en el chat, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones, y no hay quien te salve el papelón, gilipollas.',
      'Te abres más fácil que la configuración por defecto, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano.asco, y no hay quien te salve el papelón, asco.',
      'Puta de fondo: siempre el mismo libreto, [nombre].basura, y no hay quien te salve el papelón, basura.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas.ridículo, y no hay quien te salve el papelón, ridículo.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre]fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], has hecho del escaparate tu único talento documentado.joder, y no hay quien te salve el papelón, joder.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre], y no hay quien te salve el papelón, mierda.',
      '[nombre], si el puterío cotizara, serías warning del bróker.coño, y no hay quien te salve el papelón, coño.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre], y no hay quien te salve el papelón, cabrón.',
      '[nombre], puta de manual negro: el grupo firma, tú posas.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre].patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial.asco, y no hay quien te salve el papelón, asco.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre]basura, y no hay quien te salve el papelón, basura.',
      '[nombre], te abres en canal por migajas y aún pides propina.ridículo, y no hay quien te salve el papelón, ridículo.',
      'El puterío te quedó de uniforme de diario del chat, [nombre].fracasado, y no hay quien te salve el papelón, fracasado.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo, y no hay quien te salve el papelón, joder.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre]mierda, y no hay quien te salve el papelón, mierda.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo.coño, y no hay quien te salve el papelón, coño.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre].cabrón, y no hay quien te salve el papelón, cabrón.',
      '[nombre], puta de fondo de hilo, de ranking y de meme.gilipollas, y no hay quien te salve el papelón, gilipollas.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre]patético, y no hay quien te salve el papelón, patético.',
      '[nombre], el bot te midió y el grupo ya había firmado el parte.asco, y no hay quien te salve el papelón, asco.',
    ],
    mid: [
  ...
  guarra: {
    ...
    goodIsHigh: false,
    high: [
      'El nivel de guarrada que sueltas haría que un camión de basura. Pidiera la baja por asco, y no hay quien te salve el papelón, coño.',
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica.cabrón, y no hay quien te salve el papelón, cabrón.',
      ...
      'Se te nota el sudor de la guarrada hasta en los mensajes que intentan parecer finos, y no hay quien te salve el papelón, patético.',
      'Guarra de estribillo que empeora con cada repetición del mismo tema sucio, [nombre], y no hay quien te salve el papelón, asco.',
      'Guarra cutre y constante: la única racha que mantienes sin fallar nunca, [nombre], y no hay quien te salve el papelón, basura.',
      'Tienes más manchas en el discurso que un delantal de cocina de barrio a las tres, y no hay quien te salve el papelón, ridículo.',
      'Guarra de las que el grupo lee con una ceja levantada y cero respeto, [nombre], y no hay quien te salve el papelón, fracasado.',
      'El resumen corto es que das asco; el largo es que ni la dignidad te queda a mano, y no hay quien te salve el papelón, joder.',
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre].mierda, y no hay quien te salve el papelón, mierda.',
      'Das asco con cada mensaje y ni siquiera aportas una idea nueva, y no hay quien te salve el papelón, coño.',
      'Se te ve la prisa por ensuciar el hilo y cero ganas de limpiarlo después, y no hay quien te salve el papelón, cabrón.',
      'El asco. No es moralina: es diagnóstico de cómo ocupas el espacio del chat, y no hay quien te salve el papelón, gilipollas.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis, y no hay quien te salve el papelón, patético.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat.asco, y no hay quien te salve el papelón, asco.',
      'El asco. Es.basura,basura. Hostia puta, y no hay quien te salve el papelón, basura Hostia puta, basura.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile.ridículo, y no hay quien te salve el papelón, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat.fracasado, y no hay quien te salve el papelón, fracasado.',
      'El asco. No es pruderie: es el termómetro y te marca fiebre de cutrez crónica, y no hay quien te salve el papelón, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca.mierda, y no hay quien te salve el papelón, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel, y no hay quien te salve el papelón, coño.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día.cabrón, y no hay quien te salve el papelón, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para.patético, y no hay quien te salve el papelón, patético.',
      ...
      'Guarra de fondo de chat: siempre ahí, siempre igual, siempre bajando la media, [nombre], y no hay quien te salve el papelón, basura.',
      'Guarra de superficie suficiente: no hace falta abrir cajones, está a la vista, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Guarra profesional: cobras en atención y pagas con vergüenza ajena al que te lee, [nombre], fracasado.',
      'Guarra cutre de feria: mucho ruido, poca sustancia y el suelo peor que antes, [nombre], y no hay quien te salve el papelón, joder.',
      'Se te oye el arrastre de la guarrada hasta en los mensajes que quieren parecer neutros, y no hay quien te salve el papelón, mierda.',
      'Guarra de las que alardean y el alarde es el último recurso del aburrimiento, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'Guarra sin redención en el nivel: el número alto es la paliza merecida, [nombre], y no hay quien te salve el papelón, patético.',
      'Guarra de repertorio corto y manchado: siempre las mismas cartas grasientas, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de lo previsible y sucio, y no hay quien te salve el papelón, joder.',
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante, y no hay quien te salve el papelón, mierda.',
      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre], y no hay quien te salve el papelón, coño.',
      'Guarra con las mismas cartas manchadas de siempre y sin plan Bcabrón, y no hay quien te salve el papelón, cabrón.',
      'Guarra de las que leen el silencio como invitación y se equivocan siempre, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Tienes el aura del cenicero que nadie vacía: presente, lleno y olvidado en el borde, y no hay quien te salve el papelón, patético.',
      'Has convertido el descaro en falta de vergüenza y la falta de vergüenza en marca, y no hay quien te salve el papelón, asco.',
      'Guarra cutre y orgullosa: el orgullo es lo único que te queda de interesante, [nombre], y no hay quien te salve el papelón, basura.',
      'No es libertad: es falta de filtro y el resultado es basura. Con eco en el grupo. Vergüenza.vergüenza.',
      'El filtro de lo decente se te rompió hace temporadas y nadie ha venido a cambiarlo, y no hay quien te salve el papelón, fracasado.',
      'Guarra sin estilo: el desastre sin estética es solo desastre, y tú lo clavas, [nombre], y no hay quien te salve el papelón, joder.',
      'Guarra de fondo de ranking: bajas la media con la constancia de un metrónomo, [nombre], y no hay quien te salve el papelón, mierda.',
      '[nombre], tu repertorio es de patio de colegio y tienes edad de sobra para saberlo. Puta cutrez con documento de identidad.',
      'Guarra de las que el grupo mutea con educación y sigue leyendo por morbo barato, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Guarra de cartel roto: la promesa era estilo y el producto es solo suciedad, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Guarra de error de lectura crónico: confundes límites con juego siempre, [nombre], y no hay quien te salve el papelón, patético.',
      'Tu presencia obliga al grupo a bajar el listón de lo aceptable, [nombre]. Y ya estaba en el suelo. Puta cutrez contagiosa.',
      'Tienes más kilómetros de cama barata que de dignidad acumulada en el historial del grupo, y no hay quien te salve el papelón, basura.',
      'No es libertad sexual: es falta de criterio y el resultado se huele en el hilo, y no hay quien te salve el papelón, ridículo.',
      'Eres tan poco cuidadosa, [nombre], que el descuido dejó de ser accidente y pasó a ser método. Puta cochambre con sistema.',
      'Has convertido. El chat en tu callejón. Y el grupo en el público que no pidió entrada, y no hay quien te salve el papelón, joder.',
      'Guarra con antigüedad: el óxido de tanto oficio se te ve en cada broma de más, [nombre], y no hay quien te salve el papelón, mierda.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder.asco, y no hay quien te salve el papelón, asco.',
      'Has convertido la suciedad en identidad. y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder.ridículo, y no hay quien te salve el papelón, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder.joder, y no hay quien te salve el papelón, joder.',
      ...
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre], y no hay quien te salve el papelón, patético.',
      'Guarra de las que el mute ajeno lee como misterio y es solo asco. Documentado, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre], y no hay quien te salve el papelón, coño.',
      'Guarra de inercia: el grupo te soporta por costumbre, no por respeto, [nombre], y no hay quien te salve el papelón, cabrón.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] el nivel te nombra sin permiso, fracasado.',
      'Guarra de fondo permanente: el high no es un mal día, es el nivel, [nombre], y no hay quien te salve el papelón, joder.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre], y no hay quien te salve el papelón, mierda.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre], y no hay quien te salve el papelón, fracasado.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre], y no hay quien te salve el papelón, joder.',
      ...
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre], y no hay quien te salve el papelón, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre], y no hay quien te salve el papelón, basura.',
      'Guarra de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre], y no hay quien te salve el papelón, ridículo.',
      ...
      'El asco. Resume el high y el resto solo desarrolla el mismo desastre, [nombre], y no hay quien te salve el papelón, gilipollas.',
      'Has firmado la guarrería con grasa en cada mensaje como única firma, [nombre], y no hay quien te salve el papelón, patético.',
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre]asco, y no hay quien te salve el papelón, asco.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre], y no hay quien te salve el papelón, coño.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre], y no hay quien te salve el papelón, gilipollas.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre], y no hay quien te salve el papelón, joder.',
      'Guarra de malinterpretar el mute como interés por el personaje barato, [nombre], y no hay quien te salve el papelón, mierda.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre], y no hay quien te salve el papelón, coño.',
      ...
      'La compostura del nivel no te reconoce en el elenco del ranking, [nombre] El grupo no necesita subtítulos, patético.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Guarra de respeto ajeno en números rojos del ranking del grupo, [nombre], y no hay quien te salve el papelón, fracasado.',
      'El promedio del high es este: no un mal día, el nivel del nivel, [nombre]joder, y no hay quien te salve el papelón, joder.',
      ...
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre], y no hay quien te salve el papelón, asco.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre], y no hay quien te salve el papelón, basura.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el puto grupo, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] El ranking firma y listo, fracasado.',
      'El high no es un mal día de orden: es.joder, y no hay quien te salve el papelón, joder Hostia puta, joder.',
      ...
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre], y no hay quien te salve el papelón, patético.',
      'Has hecho de la guarrería tu marca y la marca se pega en los dedos ajenos, [nombre], y no hay quien te salve el papelón, asco.',
      ...
      'Has hecho del bajo listón una residencia fija: sin opción a mudanza, [nombre], y no hay quien te salve el papelón, fracasado.',
      'Guarra sin glamour: el desastre sin estética es solo un problema de higiene narrativa, y no hay quien te salve el papelón, joder.',
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre], y no hay quien te salve el papelón, mierda.',
      'Guarra de las que confunden mute con coquetería: error de lectura crónico, [nombre], y no hay quien te salve el papelón, coño.',
      'Guarra cutre de feria ambulante: ruido, grasa y nada que llevarse a casa, [nombre], y no hay quien te salve el papelón, cabrón.',
      'Nadie te tiene por divertida, [nombre]. Te tienen por ruidosa, que no es lo mismo ni de lejos. Puta alarma sin incendio.',
      'La dignidad te hace gestos desde el andén contrario y tú no te bajas del vagón, y no hay quien te salve el papelón, patético.',
      'Guarra de las que el grupo soporta con una ceja arriba y respeto en cero, [nombre], y no hay quien te salve el papelón, asco.',
      'El asco. Colectivo es el precio de tu repertorio. Y el grupo lo paga cada día. Vergüenza, y no hay quien te salve el papelón, basura.',
      'Tu manera de aportar es restar, [nombre], y llevas años restando sin parar. Un puto sumidero conversacional con nombre.',
      'Tienes más episodios documentados de guarrada que mensajes decentes en el archivo, y no hay quien te salve el papelón, fracasado.',
      'Has convertido el barro en carnet de identidad. y no hay renovación a la vista, y no hay quien te salve el papelón, joder.',
      'Has convertido cada conversación en un parte de guerra de la vergüenza colectiva, y no hay quien te salve el papelón, mierda.',
      'El asco. Crónico es el nivel: no un mal día, el promedio del nivel. Desperdicio.desperdicio, y no hay quien te salve el papelón, coño.',
      'Eres la que deja la conversación como deja todo lo demás, [nombre]: hecha una mierda. Y sin que nadie quiera recogerla.',
      'Tienes más manchas en el relato que un mantel de bar a las seis de la mañana, y no hay quien te salve el papelón, gilipollas.',
      'Tienes el aura de un cenicero lleno a las cuatro de la mañana en un local dudoso, y no hay quien te salve el papelón, patético.',
      'Guarra de las que el mute ajeno interpreta como juego y no como frontera, [nombre], y no hay quien te salve el papelón, asco.',
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma, y no hay quien te salve el papelón, basura.',
      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre], y no hay quien te salve el papelón, ridículo.',
      'Has hecho de lo cutre una marca personal y la marca huele desde el primer mensaje, y no hay quien te salve el papelón, fracasado.',
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar.joder, y no hay quien te salve el papelón, joder.',
      'Guarra de fondo permanente: baja la media del grupo sin pedir permiso, [nombre], y no hay quien te salve el papelón, mierda.',
    ],
    mid: [
