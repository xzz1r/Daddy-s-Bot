...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel de manual: repartes culpa y no te has mirado nunca de verdad, [nombre] No hay segunda lectura útil, basura.',
      'Se te nota el rastro de incel hasta en los mensajes que pretenden ser neutrales, [nombre], ridículo.',
      'Incel como un anuncio repetido que nadie pidió, joder, pura vergüenza ajena El ranking no miente, joder.',
      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder, el bot no regala décimas El ranking no miente, joder.',
      ...
      'Incel sin una carta nueva: siempre la misma mano sucia, joder, nivel sótano documentado El ranking no miente, joder.',
      'Se te oye el arrastre del resentimiento hasta en los neutros del chat, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      'Incel de historial público: no hace falta escarbar, está en la superficie, [nombre] No hay segunda lectura útil, sin filtro ni consuelo.',
      'Tienes más episodios de culpa ajena que intentos de subir el propio nivel, [nombre] El material habla solo, diagnóstico cerrado.',
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Has hecho del bajo listón social tu residencia y no hay mudanza, [nombre] El ranking firma y listo, el bot no regala décimas.',
      'Incel de las que el mute ajeno lee como rechazo y es solo desinterés, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'El asco. No es bullying: es el diagnóstico de cómo ocupas el espacio, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Incel constante: la única racha es la de no aceptar el espejo, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Se te nota la prisa por culpar y cero plan de mirarte a ti, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'Incel de cartel de sótano: se ve el letrero y nadie baja a firmar, [nombre] No hay segunda lectura útil, el veredicto es ese.',
      'No hay misterio interesante: hay previsible y amargado, el combo del high, [nombre] El material habla solo, hostia puta qué nivel.',
      'Tienes el historial de un foro abandonado: posts de odio, cero vida, [nombre] Aquí no hay modo avión que salve, joder.',
      ...
      'Se te nota el hábito de empujar cada tema hacia tu mismo sótano, [nombre] No hay segunda lectura útil, asco.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] El material habla solo, basura.',
      'Incel de fondo permanente: el high no es un mal día, es el nivel, [nombre] Aquí no hay modo avión que salve, ridículo.',
      ...
      'Incel de ceja ajena levantada y respeto social en el sótano, [nombre] El grupo no necesita subtítulos, y el ranking no miente.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] Eso no se maquilla con ángulo, sin anestesia.',
      'Has convertido el incel en identidad y no hay detergente a la vista, [nombre] El tramo te nombra sin permiso, el chat ya lo sabía.',
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre] No hay segunda lectura útil, nivel sótano puro.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre] El material habla solo, sin filtro ni consuelo.',
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Incel de letrero de sótano: se lee y no invita a bajar, [nombre] El ranking firma y listo, y se te nota a la legua.',
      'No hay misterio de amargura con estilo: hay lo previsible y el high lo nombra, [nombre] Se ve desde el primer mensaje, el bot no regala décimas.',
      'Tienes el historial de un servidor vacío: roles de odio, cero gente, [nombre] El grupo no necesita subtítulos, archivo sin apelación.',
      'Incel de malinterpretar el silencio ajeno como prueba de conspiración, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena.',
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] El tramo te nombra sin permiso, con el grupo de testigo.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] No hay segunda lectura útil, sin maquillaje posible.',
      'Incel de estribillo sin punto final limpio ni redención posible, [nombre] El material habla solo, el veredicto es ese.',
      'Se te nota el peso de arrastrar el mismo sótano por cada conversación, [nombre] Aquí no hay modo avión que salve, hostia puta qué nivel.',
      ...
      'No hay barniz de genio incomprendido: hay amargura y el high lo cobra, [nombre] No hay segunda lectura útil, patético.',
      'Tienes el tono de quien acumula fichas de odio y nunca invita a jugar limpio, [nombre] El material habla solo, asco.',
      'Incel de las que alardean del sótano porque el exterior las deja sin personaje, [nombre] Aquí no hay modo avión que salve, basura.',
      ...
      'Se te nota que te encerraste en el hilo hace tiempo y perdiste la llave, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'La clase social te suena a ataque y respondes con más del mismo mazo, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'Incel de racha perfecta: lo único que no fallas es no enganchar fuera del odio, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'No hay eco de conexión: hay eco de sótano. Y el chat lo amplifica, [nombre] El material habla solo, nivel sótano puro.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en. El ranking, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Incel de error de lectura: confundes límites sociales con permiso para seguir solo, [nombre], diagnóstico cerrado.',
      'El listón social lo usas de estantería de figuras y el suelo es tu almacén, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Has hecho ranking de desconexión y el oro es tuyo sin rival, [nombre] El grupo no necesita subtítulos, el bot no regala décimas.',
      'Incel de feria ambulante de un solo puesto: el mismo show, cero nostalgia ajena, [nombre]. Fracasado.',
      'Se te ve venir el monólogo en el primer punto del mensaje, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena.',
      'La dignidad social hace autostop y el tráfico del arcén eres tú, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre] El material habla solo, sin maquillaje posible.',
      'No hay barniz de antihéroe nerd: hay amargura y el high la nombra, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      'Tienes el tono de noches de chat sin una frase que abra puerta al resto, [nombre] El ranking firma y listo, hostia puta qué nivel.',
      ...
      'Se te nota el hábito de empujar cada hilo hacia el rincón sin ventana, [nombre] No hay segunda lectura útil, gilipollas.',
      'La compostura del tramo no te reconoce en el elenco social, [nombre] El material habla solo, patético.',
      'Incel de fondo: bajas la media del high con la constancia de quien no sale, [nombre] Aquí no hay modo avión que salve, asco.',
      ...
      'Has convertido el incel en carnet y no hay renovación de salida a la vista, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'Incel de puta madre en el sentido literal: el high no suaviza el sótano, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Tu presencia baja el promedio de cordura del chat solo con escribir, [nombre] El material habla solo, el chat ya lo sabía.',
      'Incel hasta para el modo oscuro: ni la sombra tapa el lloriqueo, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'Incel de las que el algoritmo de empatía se rinde y pide la baja, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'No hay terapia aquí: hay amargura de base y el comando la cobra, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'Tu mensaje es un aviso de lo que no hay que alimentar en el grupo, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Incel con la disciplina de quien nunca ha aceptado el espejo, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      'El high no es un mal día de humor: es. El veredicto y te nombra, [nombre] No hay segunda lectura útil, pura vergüenza ajena.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre] El material habla solo, con el grupo de testigo.',
      'Incel de repertorio: siempre la misma queja y cero plan B de dignidad, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] El ranking firma y listo, el veredicto es ese.',
      'Incel sin complejo útil: el complejo al menos indicaría que viste el problema, [nombre] Se ve desde el primer mensaje, hostia puta qué nivel.',
      ...
      'No es estilo amargo con gracia: eres incel y el high no discute la evidencia, [nombre] No hay segunda lectura útil, cabrón.',
  ...
  linda: {
    ...
    low: [
      ...
      'Se te nota el almost facial hasta en la foto más retocada del chat, [nombre]. El veredicto, y el ranking no miente.',
      'Linda de fondo de ranking: siempre el mismo fail visual y cero redención, [nombre]. El veredicto gilipollas.',
      'Has convertido la fealdad disfrazada de linda en identidad del low, [nombre]. El veredicto, el chat ya lo sabía.',
      'Linda sin el barniz: solo huesos de mala suerte y el low lo grita, [nombre]. El veredicto, nivel sótano puro.',
      'El listón de lo presentable lo miras desde abajo y no has subido, [nombre]. El veredicto El material habla solo, sin filtro ni consuelo.',
      'Linda repitiendo el mismo fail como si fuera marca personal. El veredicto ridículo, joder, el bot no regala décimas.',
      'Se te oye el eco del fail visual hasta en los mensajes neutros, [nombre]. El veredicto El ranking firma y listo, y se te nota a la legua.',
      'Linda de historial público: no hace falta zoom, se lee en la superficie, [nombre]. El veredicto pringado.',
      'Tienes más ángulos malos que un piso de alquiler en reforma, [nombre]. El veredicto El grupo no necesita subtítulos, archivo sin apelación.',
      'Linda cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El veredicto, pura vergüenza ajena.',
      'Has hecho del bajo listón facial tu residencia en el low, [nombre]. El veredicto El tramo te nombra sin permiso, con el grupo de testigo.',
      ...
      'Linda de fondo permanente: el low no es un mal día, es el nivel, [nombre]. El veredicto Eso no se maquilla con ángulo, y el ranking no miente.',
      'No es mala suerte de luz: es patrón y el low te lo cobra, [nombre]. El veredicto El tramo te nombra sin permiso, sin anestesia.',
      'Tienes más grasa de desastre facial que un freidor al cierre, [nombre]. El veredicto No hay segunda lectura útil, el chat ya lo sabía.',
      'Linda de ceja ajena levantada y respeto visual en el sótano, [nombre]. El veredicto El material habla solo, nivel sótano puro.',
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. El veredicto Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Has convertido la fealdad en identidad y no hay detergente, [nombre]. El veredicto El ranking firma y listo, diagnóstico cerrado.',
      'Linda cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto, y se te nota a la legua.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto El grupo no necesita subtítulos, el bot no regala décimas.',
      'La dignidad facial no te coge el teléfono: el buzón está lleno de avisos, [nombre]. El veredicto cabrón.',
      'Linda de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. El veredicto El tramo te nombra sin permiso, pura vergüenza ajena.',
      ...
      'Linda de malinterpretar el silencio como respeto al underdog visual, [nombre]. El veredicto, el veredicto es ese.',
      ...
      'Linda hasta para el modo oscuro: ni la sombra te favorece, [nombre]. El veredicto El tramo te nombra sin permiso, y el ranking no miente.',
      'Se te cae el frame solo con abrir la cámara y el low lo documenta, [nombre]. El veredicto, sin anestesia.',
      'Linda de las que el algoritmo de embellecer se rinde y pide la baja, [nombre]. El veredicto, el chat ya lo sabía.',
      'No hay filtro que te salve: hay fealdad de base y el comando la cobra, [nombre]. El veredicto, nivel sótano puro.',
      'Tu selfie es un aviso de lo que no hay que reproducir, [nombre]. El veredicto El ranking firma y listo, sin filtro ni consuelo.',
      ...
      'Linda de repertorio: siempre la misma cara de almost y cero plan B, [nombre]. El veredicto, archivo sin apelación.',
      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre]. El veredicto, pura vergüenza ajena.',
      'Linda sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre]. El veredicto ridículo.',
      'El ranking de belleza te deja donde mereces: en el sótano del low, [nombre]. El veredicto, sin maquillaje posible.',
      ...
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre]. El veredicto, y el ranking no miente.',
      'Linda de las que el modo retrato pide perdón por existir a tu lado, [nombre]. El veredicto, sin anestesia.',
      ...
      'Linda de las que bajan el promedio del grupo solo con la miniatura, [nombre]. El veredicto, diagnóstico cerrado.',
      'Se te cae el personaje visual solo con abrir la cámara frontal, [nombre]. El veredicto Eso no se maquilla con ángulo, y se te nota a la legua.',
      ...
      'Has montado el teatro de la linda y el público solo vio el fail, [nombre]. El veredicto Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Linda de las que el natural es abandono y el abandono se nota a la legua, [nombre]. El veredicto, sin maquillaje posible.',
      ...
      'Se te ve venir el fail visual en la primera miniatura del estado, [nombre]. El veredicto Aquí no hay modo avión que salve, sin anestesia.',
      ...
      'Tu frame baja el promedio del hilo solo con cargarse, [nombre]. El veredicto Se ve desde el primer mensaje, nivel sótano puro.',
      'Linda de las que el modo oscuro tampoco salva el desastre, [nombre]. El veredicto El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre]. El veredicto Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'Linda de almost eterno con firma legible en cada selfie del chat, [nombre]. El veredicto El tramo te nombra sin permiso, y se te nota a la legua.',
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El veredicto No hay segunda lectura útil, el bot no regala décimas.',
      'Linda de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto, archivo sin apelación.',
      'Tu cara es el argumento más corto del comando y el más claro, [nombre]. El veredicto Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Se te cae el disimulo visual solo con el flash del chat, [nombre]. El veredicto El ranking firma y listo, con el grupo de testigo.',
      'Linda de las que el grupo no cita porque no hay qué citar del frame, [nombre]. El veredicto patético.',
      'Has firmado el fail facial con cada foto como única firma del low, [nombre]. El veredicto, el veredicto es ese.',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto El ranking firma y listo, sin anestesia.',
      'Has montado el teatro de linda y solo salió el fail del low, [nombre]. El veredicto Se ve desde el primer mensaje, el chat ya lo sabía.',
      'Linda de ranking: el tramo bajo es tu residencia fija, [nombre]. El veredicto El grupo no necesita subtítulos, nivel sótano puro.',
      'Tu cara baja el promedio del grupo en un solo mensaje de estado, [nombre]. El veredicto Eso no se maquilla con ángulo, sin filtro ni consuelo.',
      'Linda de las que el modo retrato se arrepiente de haberse abierto, [nombre]. El veredicto, diagnóstico cerrado.',
      'No es luz mala ni cámara mala: eres tú y el low lo dice claro, [nombre]. El veredicto No hay segunda lectura útil, y se te nota a la legua.',
      'Linda de almost eterno: el comando no convierte el casi en victoria, [nombre]. El veredicto, el bot no regala décimas.',
      'Se te cae el personaje visual en la primera foto del hilo, [nombre]. El veredicto Aquí no hay modo avión que salve, archivo sin apelación.',
  ...
  fea: {
    ...
    high: [
      ...
      'La luz natural no te salva: expone lo que el filtro intentaba esconder sin éxito. Gilipollas. El ranking no miente.',
      'Fea de veredicto limpio: el atractivo bajo no necesita narrativa de enemistad. Gilipollas. Y se nota a la legua.',
      'Estructura y tejidos en la misma dirección baja: no hay compensación interna. Gilipollas. El chat ya lo archivó.',
      'El close-up es un informe clínico y el informe no es favorable al atractivo. Gilipollas. Y se nota a la legua.',
      'Fea de plano que no miente: frente, perfil y tres cuartos firman lo mismo. Gilipollas. Pura vergüenza ajena.',
      '[nombre], tu cara aguanta una foto de cinco y ni esa sobrevive al zoom. Puta estadística de mierda. Y bien medida.',
      'Tercios mal repartidos: el mapa está desequilibrado de fábrica. Gilipollas. El bot no regala décimas.',
      ...
      'Fea medible: no es un mal día de luz, es el nivel del material óseo y de tejidos, [nombre]. Mierda. Nivel sótano documentado.',
      'Fea de conjunto: no un solo rasgo villano, una suma de desajustes medibles, [nombre]. Fracasado. Y se nota a la legua.',
      'La armonía no está en este mapa facial: el GPS del atractivo no marca aquí, [nombre]. Fracasado. El ranking no miente.',
      ...
      'Ojos sin el contraste ni la proporción que sostienen una mirada atractiva de verdad. Fracasado. Pura vergüenza ajena.',
      'El ranking de atractivo te deja donde el material manda: abajo en la escala, [nombre]. Patético. Y se nota a la legua.',
      'El material facial no aguanta análisis: se viene abajo al primer close-up serio, [nombre]. Cabrón. El bot no regala décimas.',
      'Estructura liviana donde hace falta peso: el rostro no tiene el andamiaje, [nombre]. Fracasado. Y se nota a la legua.',
      'Ninguna de tus fotos aguanta un zoom, [nombre]. Ninguna, ni las que más te gustan. Y eso es un dato, no una opinión de mierda.',
      'Fea de perfil y de frente: no hay ángulo de redención que salve el relato clínico, [nombre]. Asco. Y se nota a la legua.',
      'Pómulos sin proyección: el relieve falta y el rostro se aplana en el relato clínico. Patético. El ranking no miente.',
      'Fea de las que el ángulo heroico no existe: todos los ángulos cuentan la misma historia. Basura. Y se nota a la legua.',
      'Nariz, boca y ojos en conflicto: el centro del rostro no encuentra paz visual, [nombre]. Cabrón. El chat ya lo archivó.',
      'El filtro puede maquillar un día: no inventa hueso ni simetría que no hay, [nombre]. Pringado. Y se nota a la legua.',
      ...
      'Mandíbula sin línea clara: el contorno se diluye y el rostro pierde estructura, [nombre]. Joder. El bot no regala décimas.',
      'Ni siquiera tienes un ángulo bueno del que tirar. Y todo el mundo tiene al menos uno. Ahí está tu puta mala suerte técnica.',
      'Simetría por debajo de la media: las desviaciones se suman y rompen la lectura global. Basura. Nivel sótano documentado.',
      'Ni siquiera destacas siendo fea, guapa. Eres olvidable en las dos direcciones, que es la puta peor combinación que existe.',
      'Fea de veredicto cerrado: no hay debate de si hay atractivo alto, el no es claro. Patético. El ranking no miente.',
      '[nombre], cara sin un solo punto donde la mirada quiera pararse. La vista se resbala y se va a otro sitio. Cada puta vez.',
      'Sonrisa que no suma: dientes o gesto que restan en vez de compensar el conjunto. Ridículo. El chat ya lo archivó.',
      'Fea de simetría fallida: el cerebro registra desorden antes que atractivo, [nombre]. Basura. Y se nota a la legua.',
      'Simetría insuficiente: las mitades no dialogan y el cerebro lo nota al instante. Pringado. Pura vergüenza ajena.',
      'Fea de ranking: el high de fea te queda porque el plano no da para otra lectura. Patético. Y se nota a la legua.',
      'Labios, nariz y mentón en ratios que el perfil castiga sin piedad clínica, [nombre]. Mierda. El bot no regala décimas.',
      'Perfil y frente de acuerdo: ambos niegan el atractivo alto sin fisura, [nombre]. Pringado. Y se nota a la legua.',
      'Fea de las que el filtro de Instagram se rinde y apaga la pantalla, [nombre] Eso no se maquilla con ángulo, cabrón.',
      'Tienes una cara que hace que el modo retrato pida perdón por existir, [nombre] El tramo te nombra sin permiso, gilipollas.',
      'Fea de perfil, de frente y de tres cuartos: no hay ángulo que te salve, [nombre] No hay segunda lectura útil, patético.',
      'El espejo te debe una hostia y. El ranking te la está cobrando en público, [nombre] El material habla solo, asco.',
      'Fea con la constancia de quien no ha mirado un tutorial de peinado en su vida, [nombre]. Gilipollas.',
      'Se te nota el desastre facial hasta en la foto más retocada del puto chat, [nombre] El ranking firma y listo, ridículo.',
      'Fea de manual: ni el low light te favorece y el high del comando lo grita, [nombre] Se ve desde el primer mensaje, fracasado.',
      'Has convertido la fealdad en identidad y no hay filtro que la renegocie, [nombre] El grupo no necesita subtítulos, qué asco de frame.',
      'Fea de las que bajan el promedio visual del grupo solo con aparecer, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'Tu cara es un argumento contra la simetría y. El ranking lo firma sin dudar, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'Fea cutre: ni el caos tiene estilo ni el desastre tiene misterio de antihéroe, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'Se te ve venir la fealdad en la primera miniatura del mensaje de estado, [nombre] El material habla solo, nivel sótano puro.',
      'Fea de historial público: no hace falta zoom, se lee en la superficie del chat, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'El listón de lo presentable lo miras desde el sótano y no has subido un peldaño, [nombre], diagnóstico cerrado.',
      'Fea sin barniz: solo huesos de mala suerte y piel que no colabora, joder, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Tienes más ángulos malos que un piso de alquiler en reforma eterna, [nombre] El grupo no necesita subtítulos, el bot no regala décimas.',
      'Fea con el bucle eterno del mismo error en bucle, joder, pura vergüenza ajena El ranking no miente, joder.',
      'El asco. No es bullying barato: es el diagnóstico visual que el high te cobra, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena.',
      'Fea constante: la única racha que mantienes es la de no mejorar el frame, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Se te nota la prisa por tapar y cero plan de arreglar lo que se ve de lejos, [nombre] El material habla solo, sin maquillaje posible.',
      'Fea de cartel de aviso: se lee de lejos y nadie quiere acercarse al producto, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      'No hay misterio interesante: hay previsible y feo, el combo del high, [nombre] El ranking firma y listo, hostia puta qué nivel.',
      'Tienes el historial de un local cerrado por salubridad estética del ranking, [nombre] Se ve desde el primer mensaje, joder.',
      'Fea de inercia: el grupo te soporta por costumbre, no por el frame, [nombre] El grupo no necesita subtítulos, mierda.',
      'El recato facial te queda a años luz y la distancia es rechazo, no mística, [nombre] Eso no se maquilla con ángulo, coño.',
      'Fea de ranking: bajas la media visual del tramo con constancia molesta, [nombre] El tramo te nombra sin permiso, cabrón.',
      'Has hecho del bajo listón facial tu residencia y no hay mudanza a la vista, [nombre] No hay segunda lectura útil, gilipollas.',
      'Fea de estribillo que mancha más con cada selfie del mismo desastre, [nombre] El material habla solo, patético.',
      'Se te nota el hábito de empujar cada foto hacia el mismo fail visual, [nombre] Aquí no hay modo avión que salve, asco.',
      'La compostura del frame no te reconoce y tú no has buscado el espejo en serio, [nombre] El ranking firma y listo, basura.',
      'Fea de fondo permanente: el high no es un mal día, es el nivel del tramo, [nombre] Se ve desde el primer mensaje, ridículo.',
      'No es mala suerte de luz: es patrón y el high te lo cobra sin descuento, [nombre] El grupo no necesita subtítulos, fracasado.',
      'Tienes más grasa de desastre facial en el relato que un freidor al cierre, [nombre] Eso no se maquilla con ángulo, qué asco de frame.',
      'Fea de ceja ajena levantada y respeto visual en el sótano del ranking, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Has convertido la fealdad en carnet y no hay detergente narrativo a la vista, [nombre] El material habla solo, el chat ya lo sabía.',
      'Fea cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'La dignidad facial no te coge el teléfono: el buzón está lleno de avisos, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'Fea de letrero grasiento: se lee de lejos y no invita a entrar al frame, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'No hay misterio de fealdad con estilo: hay lo previsible y el high lo nombra, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      'Fea de malinterpretar el silencio ajeno como respeto al underdog visual, [nombre] No hay segunda lectura útil, pura vergüenza ajena.',
      'El grupo paga tu rastro facial en cuotas diarias de hastío documentado, [nombre] El material habla solo, con el grupo de testigo.',
      'Has dejado. El chat como vestuario de derrota visual: restos de almost eternos, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'Fea de estribillo sin punto final limpio ni redención posible en. El ranking, [nombre] El ranking firma y listo, el veredicto es ese.',
      'Se te nota el peso de arrastrar la misma cara por cada hilo del chat, [nombre] Se ve desde el primer mensaje, hostia puta qué nivel.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] El grupo no necesita subtítulos, joder.',
      'Fea de feria: ruido de fail visual, suelo peor y cero ganas de volver, [nombre] Eso no se maquilla con ángulo, mierda.',
      'La dignidad del tramo no para el coche: tú eres el tráfico del arcén, [nombre] El tramo te nombra sin permiso, coño.',
      'Fea de superficie suficiente: no hace falta abrir el vestuario, huele a fail, [nombre] No hay segunda lectura útil, cabrón.',
      'No hay barniz que salve: hay fealdad pura y no se vende como carisma, [nombre] El material habla solo, gilipollas.',
      'Tienes el tono de quien acumula almost visuales y nunca pasa el estropajo, [nombre] Aquí no hay modo avión que salve, patético.',
      'Fea de las que alardean del natural porque el arreglo las deja peor, [nombre] El ranking firma y listo, asco.',
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre] Se ve desde el primer mensaje, basura.',
      'Has firmado el desastre facial con grasa en cada selfie como única firma, [nombre] El grupo no necesita subtítulos, ridículo.',
      'Fea visible desde lejos: el rastro se ve, la parada no compensa el viaje, [nombre] Eso no se maquilla con ángulo, fracasado.',
      'Se te nota que ensuciaste el frame hace tiempo y perdiste el bayeta, [nombre] El tramo te nombra sin permiso, qué asco de frame.',
      'La clase te suena a ataque y respondes con más del mismo plato de fail, [nombre] No hay segunda lectura útil, y el ranking no miente.',
      'Fea de racha perfecta: lo único que no fallas es fallar el frame, [nombre] El material habla solo, sin anestesia.',
      'No hay eco de estilo: hay eco de fealdad. Y el chat lo amplifica de más, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía.',
      'Tienes el aura del plato olvidado: presente, frío y con restos de almost, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Fea de error de lectura: confundes límites con permiso para seguir igual, [nombre] Se ve desde el primer mensaje, sin filtro ni consuelo.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'Has hecho ranking de fealdad y el oro es tuyo sin rival serio, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Fea de feria ambulante: el mismo show de fail, el mismo asco, cero nostalgia, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'Se te ve venir el almost visual en el primer punto del mensaje del hilo, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre] El material habla solo, pura vergüenza ajena.',
      'Fea de superficie: basta la vista, no hace falta el sótano del historial, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'No hay barniz de antihéroe: hay fealdad y el high la cobra sin descuento, [nombre] El ranking firma y listo, sin maquillaje posible.',
      'Tienes el tono de noches de chat sin una foto que se sostenga sola, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      'Fea de malinterpretar el mute como respeto al underdog del frame, [nombre] El grupo no necesita subtítulos, hostia puta qué nivel.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Eso no se maquilla con ángulo, joder.',
      'Has dejado el hilo como obra sin plano: escombro de almost visual y nada más, [nombre] El tramo te nombra sin permiso, mierda.',
      'Fea de estribillo que empeora con cada bis del mismo fail del ranking, [nombre] No hay segunda lectura útil, coño.',
      'Se te nota el hábito de empujar cada hilo hacia la misma derrota visual, [nombre] El material habla solo, cabrón.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre] Aquí no hay modo avión que salve, gilipollas.',
      'Fea de fondo: bajas la media del high con la constancia de quien no se cansa de fallar el frame, [nombre]. Mierda.',
      'No es estilo: es fealdad previsible y el high te la nombra entero, [nombre] Se ve desde el primer mensaje, asco.',
      'Tienes más episodios de almost visual que intentos de subir el listón de verdad, [nombre], basura. Y el chat lo tiene claro, basura.',
      'Fea de respeto ajeno en números rojos del ranking del grupo, [nombre] Eso no se maquilla con ángulo, ridículo.',
      'El promedio del high es este: no un mal día, el nivel del tramo completo, [nombre] El tramo te nombra sin permiso, fracasado.',
      'Has convertido el almost facial en carnet y no hay renovación limpia a la vista, [nombre], qué asco de frame.',
      'Fea de puta madre en el sentido literal del desastre: no hay redención en el high, [nombre]. Basura.',
      'Tu cara es un argumento contra la genética y. El ranking no admite recurso, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Fea hasta para el modo oscuro: ni la sombra te favorece en el puto chat, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'Se te cae el frame solo con abrir la cámara y el high lo documenta sin piedad, [nombre] Se ve desde el primer mensaje, nivel sótano puro.',
      'Fea de las que el algoritmo de embellecer se rinde y pide la baja, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'No hay filtro que te salve: hay fealdad de base y el comando la cobra cara, [nombre] Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'Tu selfie es un aviso de búsqueda de lo que no hay que reproducir, joder, [nombre] El tramo te nombra sin permiso, y se te nota a la legua.',
      'Fea con la disciplina de quien nunca se ha mirado de verdad al espejo, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'El high no es un mal día de luz: es. El veredicto del tramo y te nombra, [nombre] El material habla solo, archivo sin apelación.',
      'Tienes una presencia visual que baja el promedio del grupo en un mensaje, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Fea de repertorio: siempre la misma cara de almost y cero plan B facial, [nombre] El ranking firma y listo, con el grupo de testigo.',
      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre] Se ve desde el primer mensaje, sin maquillaje posible.',
      'Fea sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre] El grupo no necesita subtítulos, el veredicto es ese.',
      'El ranking de belleza te deja donde mereces: en el sótano del high, [nombre] Eso no se maquilla con ángulo, hostia puta qué nivel.',
      'Has hecho de la fealdad tu marca y la marca se pega en los ojos ajenos, [nombre] El tramo te nombra sin permiso, joder.',
      'Fea de las que confunden natural con abandono total del frame, [nombre] No hay segunda lectura útil, mierda.',
      'No es luz mala: eres tú, y el high no discute con la evidencia, [nombre] El material habla solo, coño.',
      'Sin un solo punto donde la mirada quiera pararse. La vista se resbala y se va, guapa. Cada puta vez y con todo el mundo.',
      'Fea de las que el deseo no registra: el scroll continúa sin pausa de interés. Fracasado. Y se nota a la legua.',
      'Nariz y boca en conflicto con el resto: el centro del rostro no pacifica, [nombre]. Mierda. El ranking no miente.',
      'Simetría insuficiente en puntos que el cerebro no perdona al evaluar atractivo. Patético. Y se nota a la legua.',
      'Labios y contorno sin la proporción que el ojo premia en escalas de atractivo. Pringado. El chat ya lo archivó.',
      'Fea de luz natural y de flash: ninguna de las dos escribe un relato favorable. Patético. Y se nota a la legua.',
      'Fea de las que no hay ángulo de marketing que sostenga el engaño mucho rato. Fracasado. Pura vergüenza ajena.',
      'Tercios, simetría y proyección: los tres pilares fallan en el mismo informe, [nombre]. Coño. Y se nota a la legua.',
      'Cero armonía facial. Cada rasgo va por libre y ninguno se lleva bien con el de al lado. Puta guerra civil en una cara.',
      'Ojos sin brillo de estructura: la mirada no sostiene atención de atractivo, [nombre]. Asco. Y se nota a la legua.',
      'Fea de informe: simetría insuficiente, tercios irregulares, proyección floja. Ridículo. Nivel sótano documentado.',
      'Simetría y proporción en el tramo que las escalas marcan como bajo, [nombre]. Ridículo. Y se nota a la legua.',
      'Atractivo en rojo: el balance de rasgos no da para el tramo medio siquiera, [nombre]. Asco. El ranking no miente.',
      'Fea estable en el tiempo del chat: no es un mal selfi, es el nivel del hueso. Ridículo. Y se nota a la legua.',
      'Fea medible: el comando no inventa, lee el material y el material está abajo. Pringado. El chat ya lo archivó.',
      ...
      'La estructura no hace el trabajo: los tejidos tampoco compensan el vacío de hueso. Joder. Y se nota a la legua.',
      'Fea de las que la media poblacional deja abajo: estás en la cola de la distribución. Coño. El bot no regala décimas.',
      'Conjunto que no cuaja: cada pieza podría pasar sola, juntas no forman atractivo. Cabrón. Y se nota a la legua.',
    ],
    mid: [
  ...
  sexy: {
    ...
    low: [
      ...
      'Se te nota el fail de magnetismo hasta en el mensaje más trabajado, [nombre]. El veredicto, y el ranking no miente.',
      'Sexy de fondo de ranking: siempre el mismo almost y cero chispa, [nombre]. El veredicto No hay segunda lectura útil, sin anestesia.',
      'Has convertido la falta de deseo ajeno en identidad del low, [nombre]. El veredicto El material habla solo, el chat ya lo sabía.',
      'Sexy sin el barniz: solo pretensión y el low lo documenta, [nombre]. El veredicto Aquí no hay modo avión que salve, nivel sótano puro.',
      'El listón de lo deseable lo miras desde abajo y no has subido, [nombre]. El veredicto El ranking firma y listo, sin filtro ni consuelo.',
      'Sexy repitiendo el mismo fail como si fuera marca personal. El veredicto, diagnóstico cerrado, joder.',
      'Se te oye el eco del fail sexual hasta en los neutros del chat, [nombre]. El veredicto El grupo no necesita subtítulos, y se te nota a la legua.',
      'Sexy de historial público: no hace falta zoom, se lee en la superficie, [nombre]. El veredicto pringado.',
      'Tienes más pretensión que magnetismo y el low no se traga el cuento, [nombre]. El veredicto, archivo sin apelación.',
      'Sexy cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El veredicto, pura vergüenza ajena.',
      'Has hecho del bajo listón de deseo tu residencia en el low, [nombre]. El veredicto El material habla solo, con el grupo de testigo.',
      'Sexy de las que el mute ajeno lee como misterio y es solo desinterés, [nombre]. El veredicto, sin maquillaje posible.',
      ...
      'Sexy de fondo permanente: el low no es un mal día, es el nivel, [nombre]. El veredicto No hay segunda lectura útil, y el ranking no miente.',
      'No es mala suerte de química: es patrón y el low te lo cobra, [nombre]. El veredicto El material habla solo, sin anestesia.',
      'Tienes más grasa de pretensión que un freidor al cierre, [nombre]. El veredicto Aquí no hay modo avión que salve, el chat ya lo sabía.',
      'Sexy de ceja ajena levantada y deseo ajeno en el sótano, [nombre]. El veredicto El ranking firma y listo, nivel sótano puro.',
      ...
      'Has convertido la falta de chispa en identidad y no hay detergente, [nombre]. El veredicto, diagnóstico cerrado.',
      'Sexy cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto, y se te nota a la legua.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto El tramo te nombra sin permiso, el bot no regala décimas.',
      'La dignidad del deseo no te coge el teléfono: el buzón está lleno de noes, [nombre]. El veredicto cabrón.',
      'Sexy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre]. El veredicto El material habla solo, pura vergüenza ajena.',
      'No hay misterio de almost con estilo: hay lo previsible y el low lo nombra, [nombre]. El veredicto patético.',
      'Tienes el historial de un fregadero abandonado desde el domingo, [nombre]. El veredicto El ranking firma y listo, sin maquillaje posible.',
      ...
      'Se te cae el personaje sexy solo con abrir la cámara, [nombre]. El veredicto Aquí no hay modo avión que salve, sin anestesia.',
      'Sexy de almost eterno: esta vez tampoco fue la excepción, [nombre]. El veredicto El ranking firma y listo, el chat ya lo sabía.',
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre]. El veredicto, nivel sótano puro.',
      'Sexy con más filtros que magnetismo y aun así no cuela en el low, [nombre]. El veredicto El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'El low te ha puesto en tu sitio: abajo del todo del deseo del grupo, [nombre]. El veredicto, diagnóstico cerrado.',
      'Sexy de las que juraban que esta vez el ángulo sí, y no, [nombre]. El veredicto El tramo te nombra sin permiso, y se te nota a la legua.',
      ...
      'Sexy de ranking roto: el número bajo te queda de apodo, [nombre]. El veredicto El material habla solo, archivo sin apelación.',
      'Se te ve el fail desde el primer mensaje del comando, [nombre]. El veredicto Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Sexy de repertorio: siempre la misma pose de almost y cero plan B, [nombre]. El veredicto, con el grupo de testigo.',
      ...
      'Sexy de las que. El chat archiva el fail sin pedir amplificación, [nombre]. El veredicto Aquí no hay modo avión que salve, y el ranking no miente.',
      'El low te nombra sin suavizar: almost de base y punto, [nombre]. El veredicto El ranking firma y listo, sin anestesia.',
      'Sexy con la disciplina de quien nunca aceptó el espejo del deseo, [nombre]. El veredicto Se ve desde el primer mensaje, el chat ya lo sabía.',
      'Se te ve venir el fail en la primera miniatura del estado, [nombre]. El veredicto El grupo no necesita subtítulos, nivel sótano puro.',
      ...
      'Tu almost baja el promedio del hilo solo con cargarse, [nombre]. El veredicto El tramo te nombra sin permiso, diagnóstico cerrado.',
      'Sexy de las que el modo deseo tampoco es cómplice del fail, [nombre]. El veredicto No hay segunda lectura útil, y se te nota a la legua.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre]. El veredicto El material habla solo, el bot no regala décimas.',
      'Sexy de almost eterno con firma legible en cada pose del chat, [nombre]. El veredicto Aquí no hay modo avión que salve, archivo sin apelación.',
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El veredicto El ranking firma y listo, pura vergüenza ajena.',
      'Sexy de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto, con el grupo de testigo.',
      'Tu frame es el argumento más corto del comando y el más claro, [nombre]. El veredicto El grupo no necesita subtítulos, sin maquillaje posible.',
      'Se te cae el disimulo sexy solo con el flash del chat, [nombre]. El veredicto Eso no se maquilla con ángulo, el veredicto es ese.',
      ...
      'Sexy de las que el deseo y. El ranking coinciden en. El veredicto, [nombre]. El veredicto, sin anestesia.',
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto El grupo no necesita subtítulos, el chat ya lo sabía.',
      'Has montado el teatro de sexy y solo salió el fail del low, [nombre]. El veredicto Eso no se maquilla con ángulo, nivel sótano puro.',
      'Sexy de ranking: el tramo bajo es tu residencia fija, [nombre]. El veredicto El tramo te nombra sin permiso, sin filtro ni consuelo.',
      'Tu almost baja el promedio del grupo en un solo estado, [nombre]. El veredicto No hay segunda lectura útil, diagnóstico cerrado.',
      'Sexy de las que el modo deseo se arrepiente de haberse abierto, [nombre]. El veredicto El material habla solo, y se te nota a la legua.',
      'No es luz mala ni cámara mala: eres tú y el low lo dice claro, [nombre]. El veredicto Aquí no hay modo avión que salve, el bot no regala décimas.',
      'Sexy de almost eterno: el comando no convierte el casi en victoria, [nombre]. El veredicto, archivo sin apelación.',
      'Se te cae el personaje sexy en la primera foto del hilo, [nombre]. El veredicto Se ve desde el primer mensaje, pura vergüenza ajena.',
      'Sexy de las que necesitan tutorial de magnetismo y de dignidad, [nombre]. El veredicto El grupo no necesita subtítulos, con el grupo de testigo.',
      'El low no regala décimas: el número habla y tú estás abajo, [nombre]. El veredicto Eso no se maquilla con ángulo, sin maquillaje posible.',
      ...
      'Sexy de ranking roto: el sótano del tramo te queda de casa, [nombre]. El veredicto Se ve desde el primer mensaje, y el ranking no miente.',
      'El comando no discute contigo: el low firma y punto, [nombre]. El veredicto El grupo no necesita subtítulos, sin anestesia.',
      ...
      'Has firmado el fail con cada ángulo malo como única firma del low, [nombre]. El veredicto, sin filtro ni consuelo.',
      'Sexy de superficie suficiente: basta una mirada, sobra el resto, [nombre]. El veredicto El material habla solo, diagnóstico cerrado.',
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre]. El veredicto Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Se te cae el frame sexy solo con cargar la cámara frontal, [nombre]. El veredicto El ranking firma y listo, el bot no regala décimas.',
      'Sexy de almost eterno con. El chat de testigo notarial, [nombre]. El veredicto Se ve desde el primer mensaje, archivo sin apelación.',
      'No es un mal día de fotos: es el nivel y el low te lo cobra, [nombre]. El veredicto El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Sexy de puta madre: el tramo bajo no suaviza. El veredicto de atracción, [nombre]. El veredicto gilipollas.',
      'Tu frame es el gag más corto y más claro del comando, [nombre]. El veredicto El tramo te nombra sin permiso, sin maquillaje posible.',
    ],
    extreme: [
      'Vas a arruinar muchos días sin proponértelo. Eso no todo el mundo puede decirlo No hay segunda lectura útil, el veredicto es ese.',
      ...
      'Provocas en la gente reacciones que no van a saber explicar ni a sí mismos El grupo no necesita subtítulos, y el ranking no miente.',
      'Quien te tenga cerca va a vivir sabiendo que mucha gente querría estar en su lugar Eso no se maquilla con ángulo, sin anestesia.',
      'Vas a ser el recuerdo que alguien guarda años después de un solo encuentro casual El tramo te nombra sin permiso, el chat ya lo sabía.',
      'Tienes el tipo de cara que la gente describe mucho después de haberte dejado de ver No hay segunda lectura útil, nivel sótano puro.',
      'Provocas en desconocidos reacciones que ellos mismos no van a saber explicar luego El material habla solo, sin filtro ni consuelo.',
      'Eres exactamente lo que la gente imagina cuando le piden que piense en alguien atractivo Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Hay quien va a comparar a todos sus futuros pretendientes contigo sin habértelo dicho nunca, y se te nota a la legua.',
      'Tu atractivo es de los que generan rumores antes de que hayas hablado con nadie Se ve desde el primer mensaje, el bot no regala décimas.',
      'La gente va a recordar exactamente qué llevabas puesto el día que os conocisteis El grupo no necesita subtítulos, archivo sin apelación.',
      'Vas a hacer que más de uno reconsidere su tipo entero solo con cruzarse contigo una vez Eso no se maquilla con ángulo, pura vergüenza ajena.',
      'Eres el estándar imposible con el que otros se miden sin saber siquiera que existes El tramo te nombra sin permiso, con el grupo de testigo.',
      'Tu belleza es de las que se quedan en la cabeza de gente que solo te vio de lejos No hay segunda lectura útil, sin maquillaje posible.',
      'Quien acabe a tu lado va a recibir comentarios que no va a saber cómo responder El material habla solo, el veredicto es ese.',
  ...
  crack: {
    ...
    low: [
      ...
      'Crack de las que el low te deja en el sótano del talento sin debate, [nombre]. El veredicto, sin anestesia.',
      'Tienes más almost de genio que resultados y. El ranking lo grita, [nombre]. El veredicto No hay segunda lectura útil, el chat ya lo sabía.',
      ...
      'Has hecho del almost de crack una residencia fija en el tramo bajo, [nombre]. El veredicto, y se te nota a la legua.',
      'Crack sin el barniz: solo pretensión y el low lo documenta, [nombre]. El veredicto El grupo no necesita subtítulos, el bot no regala décimas.',
      'El listón de lo brillante lo miras desde el sótano y no has subido, [nombre]. El veredicto, archivo sin apelación.',
      'Crack con el mismo gag de siempre y cero variación. El veredicto ridículo, joder, sin maquillaje posible.',
      'Se te oye el eco del fail hasta en los mensajes de plan B, [nombre]. El veredicto No hay segunda lectura útil, con el grupo de testigo.',
      'Crack de historial público: el marcador de genio está en la superficie, [nombre]. El veredicto pringado.',
      'Tienes más episodios de almost que de algo que. El chat respete, [nombre]. El veredicto Aquí no hay modo avión que salve, el veredicto es ese.',
      ...
      'Has hecho del bajo listón de talento tu casa en el low, [nombre]. El veredicto El tramo te nombra sin permiso, y el ranking no miente.',
      'Crack de estribillo que mancha más con cada repetición del fail, [nombre]. El veredicto No hay segunda lectura útil, sin anestesia.',
      'Se te nota el hábito de empujar cada tema hacia la misma derrota, [nombre]. El veredicto El material habla solo, el chat ya lo sabía.',
      'La compostura no te reconoce y tú no has buscado el espejo del marcador, [nombre]. El veredicto patético.',
      'Crack de fondo permanente: el low no es un mal día, es el nivel, [nombre]. El veredicto El ranking firma y listo, sin filtro ni consuelo.',
      'No es mala suerte: es patrón y el low te lo cobra, [nombre]. El veredicto Se ve desde el primer mensaje, diagnóstico cerrado.',
      'Tienes más grasa de almost que un vestuario después del 0-5 de talento, [nombre]. El veredicto ridículo.',
      'Crack de ceja ajena levantada y respeto en el sótano, [nombre]. El veredicto Eso no se maquilla con ángulo, el bot no regala décimas.',
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. El veredicto El tramo te nombra sin permiso, archivo sin apelación.',
      'Has convertido el almost de crack en identidad y no hay detergente, [nombre]. El veredicto, pura vergüenza ajena.',
      'Crack cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto, con el grupo de testigo.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto Aquí no hay modo avión que salve, sin maquillaje posible.',
      ...
      'No hay barniz que salve: hay almost puro y el low lo cobra, [nombre]. El veredicto El material habla solo, sin anestesia.',
      ...
      'Se te cae el personaje de crack solo con abrir el comando, [nombre]. El veredicto El grupo no necesita subtítulos, diagnóstico cerrado.',
      'Crack de almost eterno: esta vez tampoco fue la excepción, [nombre]. El veredicto Eso no se maquilla con ángulo, y se te nota a la legua.',
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre]. El veredicto, el bot no regala décimas.',
      ...
      'El low te ha puesto en tu sitio: abajo, sin debate, [nombre]. El veredicto El material habla solo, pura vergüenza ajena.',
      ...
      'Crack de ranking roto: el número bajo te queda de apodo, [nombre]. El veredicto Se ve desde el primer mensaje, el veredicto es ese.',
      ...
      'Tu presencia en el low es el gag del comando y no el trofeo, [nombre]. El veredicto El ranking firma y listo, el chat ya lo sabía.',
      'Crack de ranking: el tramo bajo te queda como un guante de derrota, [nombre]. El veredicto, nivel sótano puro.',
      'Has convertido el almost de crack en residencia fiscal del low, [nombre]. El veredicto El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'Crack de las que. El chat archiva el fail sin pedir amplificación, [nombre]. El veredicto, diagnóstico cerrado.',
      'El low te nombra sin suavizar: almost de base y punto, [nombre]. El veredicto El tramo te nombra sin permiso, y se te nota a la legua.',
      'Crack con la disciplina de quien nunca aceptó el espejo del marcador, [nombre]. El veredicto gilipollas.',
      'Se te ve venir el fail en la primera palabra del resultado, [nombre]. El veredicto El material habla solo, archivo sin apelación.',
      ...
      'Tu racha baja el promedio del hilo solo con cargarse, [nombre]. El veredicto El ranking firma y listo, con el grupo de testigo.',
      'Crack de las que el modo talento tampoco es cómplice del fail, [nombre]. El veredicto Se ve desde el primer mensaje, sin maquillaje posible.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre]. El veredicto El grupo no necesita subtítulos, el veredicto es ese.',
      ...
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre]. El veredicto El ranking firma y listo, sin anestesia.',
      'Crack con más pretensión que puntos y el comando no se traga el cuento, [nombre]. El veredicto, el chat ya lo sabía.',
      'Tu almost es el gag del tramo. Y el grupo no pide repetición, [nombre]. El veredicto El grupo no necesita subtítulos, nivel sótano puro.',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto El material habla solo, el bot no regala décimas.',
      ...
      'Has montado el teatro de crack y solo salió el fail del low, [nombre]. El veredicto El ranking firma y listo, pura vergüenza ajena.',
      'Crack de ranking: el tramo bajo es tu residencia fija, [nombre]. El veredicto Se ve desde el primer mensaje, con el grupo de testigo.',
      'Tu racha baja el promedio del grupo en un solo resultado, [nombre]. El veredicto El grupo no necesita subtítulos, sin maquillaje posible.',
      'Crack de las que el modo genio se arrepiente de haberse abierto, [nombre]. El veredicto Eso no se maquilla con ángulo, el veredicto es ese.',
      ...
      'Tu presencia es un argumento contra la racha de talento del grupo, [nombre]. El veredicto, y el ranking no miente.',
      ...
      'Crack de las que el grupo archiva el fail sin pedir bis, [nombre]. El veredicto Eso no se maquilla con ángulo, nivel sótano puro.',
      'Crack de ranking roto: el sótano del tramo te queda de casa, [nombre]. El veredicto El tramo te nombra sin permiso, sin filtro ni consuelo.',
      ...
      'Tu almost es el epitafio de la racha de talento de hoy, [nombre]. El veredicto Aquí no hay modo avión que salve, el bot no regala décimas.',
      ...
      'Has firmado el fail con cada cero como única firma del low, [nombre]. El veredicto Se ve desde el primer mensaje, pura vergüenza ajena.',
      'Crack de superficie suficiente: basta el marcador, sobra el resto, [nombre]. El veredicto, con el grupo de testigo.',
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre]. El veredicto Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Se te cae el frame de crack solo con cargar el resultado, [nombre]. El veredicto El tramo te nombra sin permiso, el veredicto es ese.',
    ...
    extreme: [
      ...
      'Eres el ejemplo que ponen los jefes cuando quieren explicar qué es hacer las cosas bien El grupo no necesita subtítulos, sin anestesia.',
      'Tu manera de trabajar redefine lo que el resto consideraba aceptable Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'No hay atajo a lo que tú tienes. Lo construiste haciendo lo que otros evitan El tramo te nombra sin permiso, nivel sótano puro.',
      'La excelencia que muestras bajo presión es la única que cuenta de verdad, y la tienes No hay segunda lectura útil, sin filtro ni consuelo.',
      'Hay gente que persigue tu nivel y nunca entiende que lo tuyo es disciplina, no suerte El material habla solo, diagnóstico cerrado.',
      'Lo que tú resuelves dormido, otros lo persiguen despiertos toda su carrera Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Eres el nombre que ponen los jefes cuando quieren explicar qué es hacer las cosas bien El ranking firma y listo, el bot no regala décimas.',
      'Tu manera de trabajar redefine lo que el resto considera aceptable, sin que lo busques Se ve desde el primer mensaje, archivo sin apelación.',
      'Hay quien lleva diez años intentando llegar donde tú estabas hace tres sin esfuerzo El grupo no necesita subtítulos, pura vergüenza ajena.',
      ...
      'Cuando te vas de un equipo, ese hueco se nota durante mucho tiempo después El tramo te nombra sin permiso, sin maquillaje posible.',
      'La excelencia bajo presión es la única que cuenta, y es justo la que tú tienes de sobra No hay segunda lectura útil, el veredicto es ese.',
  ...
  feminidad: {
    ...
    low: [
      ...
      'Has convertido la falta de feminidad real en identidad del low, [nombre] El grupo no necesita subtítulos, y el ranking no miente.',
      'Feminidad sin el barniz: solo teatro y el low lo documenta, [nombre] Eso no se maquilla con ángulo, sin anestesia.',
      'El listón de lo femenino lo miras desde abajo y no has subido, [nombre] El tramo te nombra sin permiso, el chat ya lo sabía.',
      'Feminidad con el bucle eterno del mismo error en bucle, joder, pura vergüenza ajena El ranking no miente, joder.',
      'Se te oye el eco del fail hasta en los neutros del chat, [nombre] El material habla solo, sin filtro ni consuelo.',
      'Feminidad de historial público: no hace falta zoom, se lee en la superficie, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Tienes más pretensión que magnetismo femenino y el low no se traga el cuento, [nombre] El ranking firma y listo, y se te nota a la legua.',
      'Feminidad cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre] Se ve desde el primer mensaje, el bot no regala décimas.',
      'Has hecho del bajo listón de mujer tu residencia en el low, [nombre] El grupo no necesita subtítulos, archivo sin apelación.',
      'Feminidad de las que el mute ajeno lee como misterio y es solo desinterés, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena.',
      ...
      'Feminidad constante: la única racha es la de no generar presencia real, [nombre] No hay segunda lectura útil, sin maquillaje posible.',
      'Se te nota la prisa por parecer y cero plan de ser de verdad, [nombre] El material habla solo, el veredicto es ese.',
      ...
      'Tienes más grasa de pretensión que un freidor al cierre, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'Feminidad de ceja ajena levantada y respeto en el sótano, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'Has convertido la falta de chispa en identidad y no hay detergente, [nombre] El material habla solo, nivel sótano puro.',
      'Feminidad cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre] El ranking firma y listo, diagnóstico cerrado.',
      'La dignidad de lo femenino no te coge el teléfono: el buzón está lleno de noes, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Feminidad de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] El grupo no necesita subtítulos, el bot no regala décimas.',
      'No hay misterio de almost con estilo: hay lo previsible y el low lo nombra, [nombre] Eso no se maquilla con ángulo, archivo sin apelación.',
      'Tienes el historial de un fregadero abandonado desde el domingo, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena.',
      'Feminidad de malinterpretar el silencio como respeto al underdog, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'El grupo paga tu rastro de pretensión en cuotas diarias de hastío, [nombre] El material habla solo, sin maquillaje posible.',
      'Has dejado. El chat como vestuario de derrota de presencia, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      ...
      'Feminidad de almost eterno: esta vez tampoco fue la excepción, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Feminidad con más filtros que sustancia y aun así no cuela en el low, [nombre] El material habla solo, el chat ya lo sabía.',
      'El low te ha puesto en tu sitio: abajo del todo de la presencia del grupo, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Feminidad de las que juraban que esta vez el gesto sí, y no, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'Tu almost es el contenido gratis de ridículo del hilo, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'Feminidad de ranking roto: el número bajo te queda de apodo, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'Se te ve el fail desde el primer mensaje del comando, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Feminidad de repertorio: siempre la misma pose de almost y cero plan B, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      ...
      'Has montado el teatro de mujer y el público solo vio el fail, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'Feminidad de las que confunden pose con presencia y pierden las dos, [nombre] El ranking firma y listo, el veredicto es ese.',
      ...
      'El low te nombra sin suavizar: almost de base y punto, [nombre] No hay segunda lectura útil, y el ranking no miente.',
      'Feminidad con la disciplina de quien nunca aceptó el espejo de la presencia, [nombre] El material habla solo, sin anestesia.',
      'Se te ve venir el fail en la primera miniatura del estado, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía.',
      ...
      'Feminidad de las que el modo mujer tampoco es cómplice del fail, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Feminidad de almost eterno con firma legible en cada pose del chat, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      ...
      'Tu frame es el argumento más corto del comando y el más claro, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Se te cae el disimulo de mujer solo con el flash del chat, [nombre] El ranking firma y listo, sin maquillaje posible.',
      'Feminidad de las que el grupo no cita porque no hay presencia que citar, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      ...
      'Feminidad de las que la presencia y. El ranking coinciden en. El veredicto, [nombre] El material habla solo, y el ranking no miente.',
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Has montado el teatro de mujer y solo salió el fail del low, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'Feminidad de ranking: el tramo bajo es tu residencia fija, [nombre] Se ve desde el primer mensaje, nivel sótano puro.',
      'Tu almost baja el promedio del grupo en un solo estado, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'Feminidad de las que el modo mujer se arrepiente de haberse abierto, [nombre] Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'No es luz mala ni cámara mala: eres tú y el low lo dice claro, [nombre] El tramo te nombra sin permiso, y se te nota a la legua.',
      'Feminidad de almost eterno: el comando no convierte el casi en victoria, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'Se te cae el personaje de mujer en la primera foto del hilo, [nombre] El material habla solo, archivo sin apelación.',
      'Feminidad de las que necesitan tutorial de presencia y de dignidad, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'El low no regala décimas: el número habla y tú estás abajo, [nombre] El ranking firma y listo, con el grupo de testigo.',
      ...
      'El comando no discute contigo: el low firma y punto, [nombre] Aquí no hay modo avión que salve, y el ranking no miente.',
      ...
      'Has firmado el fail con cada ángulo malo como única firma del low, [nombre] El grupo no necesita subtítulos, nivel sótano puro.',
      'Feminidad de superficie suficiente: basta una mirada, sobra el resto, [nombre] Eso no se maquilla con ángulo, sin filtro ni consuelo.',
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre] El tramo te nombra sin permiso, diagnóstico cerrado.',
      'Se te cae el frame de mujer solo con cargar la cámara frontal, [nombre] No hay segunda lectura útil, y se te nota a la legua.',
      'Feminidad de almost eterno con. El chat de testigo notarial, [nombre] El material habla solo, el bot no regala décimas.',
      'No es un mal día de fotos: es el nivel y el low te lo cobra, [nombre] Aquí no hay modo avión que salve, archivo sin apelación.',
      ...
      'Tu frame es el gag más corto y más claro del comando, [nombre] Se ve desde el primer mensaje, con el grupo de testigo.',
      'Feminidad de las que el algoritmo de respeto pide la baja al verte, [nombre] El grupo no necesita subtítulos, sin maquillaje posible.',
      'El low te deja donde mereces: abajo, sin debate ni consuelo, [nombre] Eso no se maquilla con ángulo, el veredicto es ese.',
    ...
    extreme: [
      ...
      'La elegancia que tienes es la que se queda cuando se quita todo lo demás, y eso no es común, y el ranking no miente.',
      'Tu gracia natural es exactamente lo que otras persiguen durante años sin alcanzarlo nunca, sin anestesia.',
      'Hay una calidez en ti que la gente recuerda mucho después de cualquier conversación contigo, el chat ya lo sabía.',
      'Tu feminidad no necesita ocasión ni público. Es lo que eres cuando nadie está mirando Eso no se maquilla con ángulo, nivel sótano puro.',
      'La suavidad con la que manejas las cosas se queda en la memoria de quien la recibe El tramo te nombra sin permiso, sin filtro ni consuelo.',
    ],
  },
  ...
  masculinidad: {
    ...
    low: [
      ...
      'Masculinidad de las que el low te deja en el sótano del ranking sin debate, [nombre] Se ve desde el primer mensaje, sin anestesia.',
      'Tienes más pretensión de macho que sustancia y el low lo grita, [nombre] El grupo no necesita subtítulos, el chat ya lo sabía.',
      'Masculinidad de manual fallido: ni el gesto te salva ni la pose colabora, [nombre] Eso no se maquilla con ángulo, nivel sótano puro.',
      'Se te nota el almost de hombre hasta en el mensaje más trabajado, [nombre] El tramo te nombra sin permiso, sin filtro ni consuelo.',
      'Masculinidad de fondo de ranking: siempre el mismo fail y cero chispa, [nombre] No hay segunda lectura útil, diagnóstico cerrado.',
      'Has convertido la falta de masculinidad real en identidad del low, [nombre] El material habla solo, y se te nota a la legua.',
      'Masculinidad sin el barniz: solo teatro y el low lo documenta, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas.',
      'El listón de lo masculino lo miras desde abajo y no has subido, [nombre] El ranking firma y listo, archivo sin apelación.',
      'Masculinidad con el mismo gag de siempre y cero variación, joder, el ranking no miente El ranking no miente, joder.',
      'Se te oye el eco del fail hasta en los neutros del chat, [nombre] El grupo no necesita subtítulos, con el grupo de testigo.',
      'Masculinidad de historial público: no hace falta zoom, se lee en la superficie, [nombre] Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Tienes más pretensión que presencia de hombre y el low no se traga el cuento, [nombre] El tramo te nombra sin permiso, el veredicto es ese.',
      ...
      'Masculinidad de estribillo que mancha más con cada pose del mismo fail, [nombre] El grupo no necesita subtítulos, sin anestesia.',
      'Se te nota el hábito de empujar cada foto hacia el mismo almost, [nombre] Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'La compostura de lo masculino no te reconoce y tú no has buscado el espejo, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      ...
      'No es mala suerte de pose: es patrón y el low te lo cobra, [nombre] El material habla solo, diagnóstico cerrado.',
      'Tienes más grasa de pretensión que un freidor al cierre, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Masculinidad de ceja ajena levantada y respeto en el sótano, [nombre] El ranking firma y listo, el bot no regala décimas.',
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'Has convertido la falta de chispa en identidad y no hay detergente, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Masculinidad cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'La dignidad de lo masculino no te coge el teléfono: el buzón está lleno de noes, [nombre], el veredicto es ese.',
      ...
      'No hay barniz que salve: hay almost puro y el low lo cobra, [nombre] Eso no se maquilla con ángulo, sin anestesia.',
      'Masculinidad de puta madre en el sentido del desastre: el low no suaviza la falta de presencia, [nombre]. Basura.',
      'Tu almost de hombre es el gag del tramo. Y el grupo no pide replay, [nombre] No hay segunda lectura útil, nivel sótano puro.',
      'Masculinidad de las que el respeto ajeno te debe una hostia y. El ranking te la cobra, [nombre]. Fracasado.',
      'Se te cae el personaje de hombre solo con abrir la cámara, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Masculinidad de almost eterno: esta vez tampoco fue la excepción, [nombre] El ranking firma y listo, y se te nota a la legua.',
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre] Se ve desde el primer mensaje, el bot no regala décimas.',
      'Masculinidad con más filtros que sustancia y aun así no cuela en el low, [nombre] El grupo no necesita subtítulos, archivo sin apelación.',
      'El low te ha puesto en tu sitio: abajo del todo de la presencia del grupo, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena.',
      'Masculinidad de las que juraban que esta vez el gesto sí, y no, [nombre] El tramo te nombra sin permiso, con el grupo de testigo.',
      'Tu almost es el contenido gratis de ridículo del hilo, [nombre] No hay segunda lectura útil, sin maquillaje posible.',
      'Masculinidad de ranking roto: el número bajo te queda de apodo, [nombre] El material habla solo, el veredicto es ese.',
      ...
      'No hay segunda lectura útil en este low: hay cara y hay veredicto, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'Masculinidad de las que el filtro de hombre se rinde antes que el de respeto, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'Tu presencia en el low es el gag del comando y no el cumplido, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'Masculinidad de ranking: el tramo bajo te queda como un guante de derrota, [nombre] El material habla solo, nivel sótano puro.',
      'Has convertido el almost de hombre en residencia fiscal del low, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Masculinidad de las que. El chat archiva el fail sin pedir amplificación, [nombre] El ranking firma y listo, diagnóstico cerrado.',
      'El low te nombra sin suavizar: almost de base y punto, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Masculinidad con la disciplina de quien nunca aceptó el espejo de la presencia, [nombre]. Gilipollas.',
      'Se te ve venir el fail en la primera miniatura del estado, [nombre] Eso no se maquilla con ángulo, archivo sin apelación.',
      ...
      'Tu almost baja el promedio del hilo solo con cargarse, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Masculinidad de las que el modo hombre tampoco es cómplice del fail, [nombre] El material habla solo, sin maquillaje posible.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      ...
      'Masculinidad de las que confunden natural con no generar nada de presencia, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Masculinidad con más pretensión que chispa y el comando no se traga el cuento, [nombre] El material habla solo, el chat ya lo sabía.',
      'Tu almost es el gag del tramo. Y el grupo no pide repetición, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Masculinidad de almost documentado en alta definición del chat, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'Se te ve el fail desde el otro lado del puto ranking, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'Masculinidad de las que la presencia y. El ranking coinciden en. El veredicto, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Has montado el teatro de hombre y solo salió el fail del low, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      'Masculinidad de ranking: el tramo bajo es tu residencia fija, [nombre] No hay segunda lectura útil, pura vergüenza ajena.',
      'Tu almost baja el promedio del grupo en un solo estado, [nombre] El material habla solo, con el grupo de testigo.',
      'Masculinidad de las que el modo hombre se arrepiente de haberse abierto, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'No es luz mala ni cámara mala: eres tú y el low lo dice claro, [nombre] El ranking firma y listo, el veredicto es ese.',
      ...
      'No hay redención en este low: hay cara, hay número y hay veredicto, [nombre] El material habla solo, sin anestesia.',
      'Masculinidad de las que el grupo archiva el fail sin pedir bis, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía.',
      'Se te ve venir el fail en la primera palabra del estado, [nombre] El ranking firma y listo, nivel sótano puro.',
      ...
      'El comando no discute contigo: el low firma y punto, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      ...
      'Has firmado el fail con cada ángulo malo como única firma del low, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      'Masculinidad de superficie suficiente: basta una mirada, sobra el resto, [nombre] El material habla solo, pura vergüenza ajena.',
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Se te cae el frame de hombre solo con cargar la cámara frontal, [nombre] El ranking firma y listo, sin maquillaje posible.',
      'Masculinidad de almost eterno con. El chat de testigo notarial, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      ...
      'Tu frame es un aviso de lo que no hay que reproducir en. El chat, [nombre] El material habla solo, y el ranking no miente.',
    ],
    extreme: [
      'Tienes la masculinidad real, la que no se anuncia porque no hace falta Aquí no hay modo avión que salve, sin anestesia.',
      'Tu manera de manejar la presión es lo que te define. Los momentos fáciles no dicen nada de nadie, el chat ya lo sabía.',
      'Eres de los pocos que tienen el carácter que necesitan y no el que les conviene mostrar Se ve desde el primer mensaje, nivel sótano puro.',
      'La solidez que tienes no se finge ni se aprende. O se construye o no está El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'Eres de los que la gente recuerda cuando necesita un ejemplo de cómo se hace Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'Tu palabra pesa porque la respaldas con hechos cuando nadie más quiere dar la cara El tramo te nombra sin permiso, y se te nota a la legua.',
      'La calma que mantienes bajo presión es exactamente lo que distingue al hombre del que aparenta, el bot no regala décimas.',
      'Tienes el carácter que necesitas, no el que te conviene mostrar, y eso muy pocos lo tienen, archivo sin apelación.',
      'Cuando todo se complica, eres de los que se quedan, y eso ya dice todo lo que hay que decir, pura vergüenza ajena.',
      'La solidez que proyectas no es actuación. Se construyó con años de ser el mismo siempre El ranking firma y listo, con el grupo de testigo.',
    ],
  },
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón convertido en wallpaper del fail colectivo. El veredicto gilipollas, joder, el bot no regala décimas.',
      ...
      'Maricón con el mismo gag de siempre y cero variación. El veredicto ridículo, joder, el ranking no miente.',
      ...
      'Maricón de las que el filtro de respeto se rinde y pide la baja, [nombre]. El veredicto No hay segunda lectura útil, fracasado.',
      'Maricón de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre]. El veredicto, qué asco de frame.',
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre]. El veredicto Aquí no hay modo avión que salve, y el ranking no miente.',
      'Maricón de respeto ajeno en números rojos del ranking del grupo, [nombre]. El veredicto El ranking firma y listo, sin anestesia.',
      ...
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. El veredicto, y se te nota a la legua.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre]. El veredicto asco.',
      ...
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre]. El veredicto, gilipollas.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre]. El veredicto, patético.',
      'No hay barniz que te salve: hay pose de base y el comando la cobra, [nombre]. El veredicto, asco. Y el chat lo tiene claro, asco.',
      'Maricón sin capa de carisma que disimule el agujero. El veredicto del high no suaviza nada, ridículo.',
      'Maricón de fondo permanente: el high no es un mal día, es el nivel, [nombre]. El veredicto del high no suaviza nada, coño.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre]. El veredicto, fracasado.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre]. El veredicto El ranking firma y listo, qué asco de frame.',
      'Maricón de ranking: bajas la media del tramo con constancia molesta, [nombre]. El veredicto, y el ranking no miente.',
      'No es atrevimiento: es suciedad de personaje y el tramo te la cobra, [nombre]. El veredicto, sin anestesia.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre]. El veredicto, el chat ya lo sabía.',
      'La dignidad hace autostop y el tráfico del arcén del ranking eres tú, [nombre]. El veredicto, nivel sótano puro.',
      'No hay barniz de antihéroe: hay pose y el high la cobra sin descuento, [nombre]. El veredicto, sin filtro ni consuelo.',
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. El veredicto, diagnóstico cerrado.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre]. El veredicto, y se te nota a la legua.',
      'Maricón cutre: el estereotipo sin el carisma que a veces lo salva, [nombre]. El veredicto del high no suaviza nada, coño.',
      'Has hecho ranking de pose cutre y el oro es tuyo sin rival serio, [nombre]. El veredicto Se ve desde el primer mensaje, archivo sin apelación.',
      'Se te ve venir el teatro en el primer punto del mensaje del hilo, [nombre]. El veredicto El grupo no necesita subtítulos, pura vergüenza ajena.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre]. El veredicto Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre]. El veredicto, sin maquillaje posible.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre]. El veredicto, el veredicto es ese.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. El veredicto, hostia puta qué nivel.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. El veredicto, joder. Y el chat lo tiene claro, joder.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre]. El veredicto El ranking firma y listo, mierda.',
      'Se te ve venir la pose en la primera palabra del mensaje del chat, [nombre]. El veredicto, coño. Y el chat lo tiene claro, coño.',
      'Has dejado el hilo como obra sin plano: escombro de pose y nada más, [nombre]. El veredicto, cabrón.',
      'Maricón de los que el high del ranking no perdona ni un frame, [nombre]. El veredicto del high no suaviza nada, joder.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre]. El veredicto El tramo te nombra sin permiso, patético.',
      'No hay barniz que salve: hay pose pura y no se vende como carisma, [nombre]. El veredicto, asco. Y el chat lo tiene claro, asco.',
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre]. El veredicto El material habla solo, basura.',
      'El high no es un mal día de pose: es. El veredicto y te nombra, [nombre]. El veredicto Aquí no hay modo avión que salve, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre]. El veredicto El grupo no necesita subtítulos, y el ranking no miente.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. El veredicto El grupo no necesita subtítulos, fracasado.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre]. El veredicto Aquí no hay modo avión que salve, nivel sótano puro.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo, joder, el bot no regala décimas El ranking no miente, joder.',
      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre] El material habla solo, sin anestesia.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder, nivel sótano documentado El ranking no miente, joder.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder, el ranking no miente El ranking no miente, joder.',
      'Se te oye el arrastre del pedestal hasta en los neutros del chat, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'Simp de historial público: no hace falta escarbar, está en la superficie, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Tienes más episodios de simp documentados que intentos de tener criterio, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'Simp cutre: ni la entrega tiene gracia ni la falta de dignidad tiene misterio, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre] El material habla solo, pura vergüenza ajena.',
      'Simp de las que el mute ajeno lee como misterio y es solo desinterés, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      ...
      'Simp constante: la única racha es la de no decir no cuando toca, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      'Se te nota la prisa por validar y cero plan de validarte a ti, [nombre] El grupo no necesita subtítulos, hostia puta qué nivel.',
      ...
      'Tienes el historial de un local cerrado por exceso de sí y falta de no, [nombre] No hay segunda lectura útil, coño.',
      'Simp de inercia: el grupo te soporta por costumbre, no por respeto, [nombre] El material habla solo, cabrón.',
      'El recato de dignidad te queda lejos y la distancia es rechazo, no mística, [nombre] Aquí no hay modo avión que salve, gilipollas.',
      ...
      'Simp de fondo permanente: el high no es un mal día, es el nivel, [nombre] No hay segunda lectura útil, qué asco de frame.',
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre] El material habla solo, y el ranking no miente.',
      'Tienes más grasa de validación ajena que un foro de fans sin moderación, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Simp de ceja ajena levantada y respeto propio en el sótano, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] Se ve desde el primer mensaje, nivel sótano puro.',
      'Has convertido el simp en identidad y no hay detergente narrativo, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'Simp cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre] Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre] El tramo te nombra sin permiso, y se te nota a la legua.',
      'La dignidad no te coge el teléfono: el buzón está lleno de síes ajenos, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'Simp de letrero de pedestal: se lee de lejos y no invita a respetar, [nombre] El material habla solo, archivo sin apelación.',
      'No hay misterio de entrega con estilo: hay lo previsible y el high lo nombra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Tienes el historial de un servidor vacío: roles de sí, cero criterio, [nombre] El ranking firma y listo, con el grupo de testigo.',
      'Simp de malinterpretar el silencio ajeno como invitación a más pedestal, [nombre] Se ve desde el primer mensaje, sin maquillaje posible.',
      'El grupo paga tu monólogo de validación en cuotas diarias de scroll, [nombre] El grupo no necesita subtítulos, el veredicto es ese.',
      'Has dejado. El chat como foro a medias: hilos de sí con tu firma, [nombre] Eso no se maquilla con ángulo, hostia puta qué nivel.',
      'Simp de estribillo sin punto final limpio ni redención posible, [nombre] El tramo te nombra sin permiso, joder.',
      'Se te nota el peso de arrastrar el mismo pedestal por cada conversación, [nombre] No hay segunda lectura útil, mierda.',
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre] El material habla solo, coño.',
      'Simp de feria de validación: ruido interno, cero ganas de volver del resto, [nombre] Aquí no hay modo avión que salve, cabrón.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre] El material habla solo, qué asco de frame.',
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre] Aquí no hay modo avión que salve, y el ranking no miente.',
      'Simp visible desde lejos: el rastro de sumisión se ve, la parada no compensa, [nombre] El ranking firma y listo, sin anestesia.',
      'Se te nota que te arrodillaste en el hilo hace tiempo y perdiste la llave, [nombre] Se ve desde el primer mensaje, el chat ya lo sabía.',
      'La clase te suena a ataque y respondes con más del mismo sí, [nombre] El grupo no necesita subtítulos, nivel sótano puro.',
      'Simp de racha perfecta: lo único que no fallas es no tener criterio, [nombre] Eso no se maquilla con ángulo, sin filtro ni consuelo.',
      'No hay eco de dignidad: hay eco de pedestal. Y el chat lo amplifica, [nombre] El tramo te nombra sin permiso, diagnóstico cerrado.',
      'Tienes el aura del post olvidado: presente en el archivo, frío en. El ranking, [nombre] No hay segunda lectura útil, y se te nota a la legua.',
      'Simp de error de lectura: confundes límites con permiso para seguir de rodillas, [nombre], el bot no regala décimas.',
      'El listón de dignidad lo usas de felpudo y el suelo es tu zona de confort, [nombre] Aquí no hay modo avión que salve, archivo sin apelación.',
      'Has hecho ranking de simp y el oro es tuyo sin rival serio, [nombre] El ranking firma y listo, pura vergüenza ajena.',
      'Simp de feria ambulante de un solo puesto: el mismo show de sí, cero nostalgia, [nombre]. Fracasado.',
      'Se te ve venir el pedestal en el primer punto del mensaje, [nombre] El grupo no necesita subtítulos, sin maquillaje posible.',
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] Eso no se maquilla con ángulo, el veredicto es ese.',
      'Simp de superficie: basta la vista, no hace falta el sótano del historial, [nombre] El tramo te nombra sin permiso, hostia puta qué nivel.',
      'No hay barniz de antihéroe leal: hay simp y el high lo nombra, [nombre] No hay segunda lectura útil, joder.',
      'Tienes el tono de noches de chat sin una frase que diga no de verdad, [nombre] El material habla solo, mierda.',
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre] Aquí no hay modo avión que salve, coño.',
      ...
      'No es estilo: es simp previsible y el high te lo nombra entero, [nombre] El material habla solo, fracasado.',
      'Tienes más episodios de pedestal que intentos de subir el listón propio, [nombre] Aquí no hay modo avión que salve, qué asco de frame.',
      'Simp de respeto ajeno en números rojos del ranking de dignidad, [nombre] El ranking firma y listo, y el ranking no miente.',
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] Se ve desde el primer mensaje, sin anestesia.',
      ...
      'Tu presencia baja el promedio de criterio del chat solo con escribir, [nombre] Eso no se maquilla con ángulo, nivel sótano puro.',
      'Simp hasta para el modo oscuro: ni la sombra tapa el sí eterno, [nombre] El tramo te nombra sin permiso, sin filtro ni consuelo.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] No hay segunda lectura útil, diagnóstico cerrado.',
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre] El material habla solo, y se te nota a la legua.',
      'No hay barniz que te salve: hay simp de base y el comando lo cobra, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas.',
      'Tu mensaje es un aviso de lo que no hay que imitar en el grupo, [nombre] El ranking firma y listo, archivo sin apelación.',
      'Simp con la disciplina de quien nunca ha dicho no cuando tocaba, [nombre] Se ve desde el primer mensaje, pura vergüenza ajena.',
      'El high no es un mal día de carácter: es. El veredicto y te nombra, [nombre] El grupo no necesita subtítulos, con el grupo de testigo.',
      'Tienes una presencia que ensucia el hilo en un solo sí de más, [nombre] Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Simp de repertorio: siempre la misma validación y cero plan B de dignidad, [nombre] El tramo te nombra sin permiso, el veredicto es ese.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] No hay segunda lectura útil, hostia puta qué nivel.',
      'Simp sin complejo útil: el complejo al menos indicaría que viste el pedestal, [nombre] El material habla solo, joder.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Aquí no hay modo avión que salve, mierda.',
  ...
  rata: {
    ...
    high: [
      ...
      'Rata de las que roban el oxígeno del hilo y no devuelven ni un mensaje útil, [nombre] No hay segunda lectura útil, basura.',
      'Rata de manual: te aprovechas del grupo y encima miras con cara de víctima, [nombre] El material habla solo, ridículo.',
      'Se te nota el hocico de rata cada vez que huele a beneficio fácil en. El chat, [nombre] Aquí no hay modo avión que salve, fracasado.',
      'Rata de fondo de chat: siempre cerca del botín ajeno, nunca del trabajo propio, [nombre]. Gilipollas.',
      'Has hecho del aprovechamiento un deporte y vas líder de la clasificación cutre, [nombre] Se ve desde el primer mensaje, y el ranking no miente.',
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder, archivo sin apelación El ranking no miente, joder.',
      'Se te oye el roce de la cola de rata cada vez que cambias de postura moral, [nombre] Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'Rata de historial público: no hace falta escarbar, está en la superficie, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      'Tienes más giros de chaqueta que un perchero de second hand en liquidación, [nombre] No hay segunda lectura útil, sin filtro ni consuelo.',
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre] El material habla solo, diagnóstico cerrado.',
      'Has convertido. El chat en tu despensa y al resto en inventario de provecho, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua.',
      'El asco. No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre] El ranking firma y listo, el bot no regala décimas.',
      'Rata constante: la única disciplina es no soltar lo que no es tuyo, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'Se te nota la prisa por agarrar y la ausencia total de plan de devolver, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Rata de ranking: bajas la media del grupo con constancia molesta, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'Has convertido lo rata en marca personal y la marca se pega en los dedos, [nombre] No hay segunda lectura útil, el veredicto es ese.',
      'Rata de estribillo que mancha más con cada repetición del mismo plato, [nombre] El material habla solo, hostia puta qué nivel.',
      'Se te nota el hábito de empujar cada tema hacia tu beneficio corto, [nombre] Aquí no hay modo avión que salve, joder.',
      ...
      'Has convertido la rata en identidad y no hay detergente narrativo, [nombre] No hay segunda lectura útil, asco.',
      'Rata cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre] El material habla solo, basura.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre] Aquí no hay modo avión que salve, ridículo.',
      ...
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] El grupo no necesita subtítulos, y el ranking no miente.',
      'Rata de malinterpretar el silencio: siempre sirviendo más en plato que nadie pidió, [nombre]. Basura.',
      'Has dejado. El chat como fregadero a medias: restos eternos de ratez, [nombre] El tramo te nombra sin permiso, el chat ya lo sabía.',
      'Rata de estribillo sin punto final limpio ni redención posible, [nombre] No hay segunda lectura útil, nivel sótano puro.',
      'La compostura cruza de acera cuando te ve en. El ranking del high, [nombre] El material habla solo, sin filtro ni consuelo.',
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'La dignidad no para el coche: tú eres el tráfico del arcén, [nombre] El ranking firma y listo, y se te nota a la legua.',
      'Rata de superficie suficiente: no hace falta abrir el cubo, huele, [nombre] Se ve desde el primer mensaje, el bot no regala décimas.',
      'No hay barniz: hay ratez pura y no se vende como carisma, [nombre] El grupo no necesita subtítulos, archivo sin apelación.',
      'Rata de las que alardean del aprovecho porque callar las deja sin personaje, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena.',
      ...
      'Has firmado lo rata con grasa en cada mensaje como única firma, [nombre] No hay segunda lectura útil, sin maquillaje posible.',
      'Rata visible desde lejos: el rastro se ve, la parada no compensa, [nombre] El material habla solo, el veredicto es ese.',
      'La clase te suena a ataque y respondes dejando más migas de interés ajeno, [nombre] Aquí no hay modo avión que salve, hostia puta qué nivel.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre] No hay segunda lectura útil, patético.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre] El material habla solo, asco.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre] Aquí no hay modo avión que salve, basura.',
      ...
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'Rata de malinterpretar el mute como invitación a seguir sacando, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre] El material habla solo, nivel sótano puro.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Se te nota el hábito de empujar cada hilo hacia tu beneficio corto, [nombre] El ranking firma y listo, diagnóstico cerrado.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Tienes más manchas de interés ajeno que intentos de pasar un trapo, [nombre] El grupo no necesita subtítulos, el bot no regala décimas.',
      'Rata de respeto ajeno en números rojos del ranking del grupo, [nombre] Eso no se maquilla con ángulo, archivo sin apelación.',
      'El promedio de ratez es el nivel: no un pico, el suelo del high, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena.',
      'Has convertido la rata en carnet y no hay renovación limpia, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Rata de puta madre en el sentido literal: el high no suaviza el hocico, [nombre] El material habla solo, sin maquillaje posible.',
      'Tu presencia baja el promedio de confianza del chat solo con escribir, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      'Rata hasta para el modo oscuro: ni la sombra tapa lo que sacas, [nombre] El ranking firma y listo, hostia puta qué nivel.',
      ...
      'Rata con la disciplina de quien nunca ha devuelto una puta favor, [nombre] No hay segunda lectura útil, gilipollas.',
      'El high no es un mal día de ética: es. El veredicto y te nombra, [nombre] El material habla solo, patético.',
      'Tienes una presencia que ensucia el hilo en un solo movimiento de rata, [nombre] Aquí no hay modo avión que salve, asco.',
      ...
      'Has hecho de la rata tu marca y la marca se pega en los dedos ajenos, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'Rata de las que confunden astucia con no tener vergüenza en. El ranking, [nombre] No hay segunda lectura útil, sin anestesia.',
      'No es viveza con gracia: eres rata y el high no discute la evidencia, [nombre] El material habla solo, el chat ya lo sabía.',
  ...
  friki: {
    ...
    high: [
      ...
      'La dignidad del tramo no para: tú eres el tráfico del arcén social, [nombre] No hay segunda lectura útil, cabrón.',
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre] El material habla solo, gilipollas.',
      ...
      'Friki constante: la única racha es la de no enganchar a nadie fuera del nicho, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Friki de los que el sótano del chat te queda grande y. El ranking te queda justo, [nombre], sin maquillaje posible.',
      ...
      'Friki de manual cutre: el estereotipo sin el carisma que a veces salva al raro, [nombre] No hay segunda lectura útil, coño.',
      'La compostura social no te reconoce y tú no has buscado el espejo del chat, [nombre] El material habla solo, cabrón.',
      ...
      'La dignidad social no te coge el teléfono: el buzón está lleno de silences, [nombre] No hay segunda lectura útil, qué asco de frame.',
      'Friki que se enfada porque no valoran su afición. Nadie está obligado, gilipollas. Y exigir valoración ya es haber perdido.',
      'Friki de estribillo que mancha más con cada ficha repetida del mismo mazo, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Friki de fondo permanente: el high no es un mal día, es el nivel del tramo, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'Friki con el bucle eterno del mismo error en bucle, joder, pura vergüenza ajena El ranking no miente, joder.',
      'Friki de cartel de sótano: se ve el letrero y nadie baja las escaleras, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      'No hay barniz de genio incomprendido: hay aislamiento y el high lo cobra, [nombre] Eso no se maquilla con ángulo, diagnóstico cerrado.',
      'Friki que renunció a lo difícil para dominar lo cómodo. Y ya no sabe volver, cabrón. Ese es el precio de la puta cueva.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'No es profundidad: es aislamiento con teclado y el tramo te lo cobra, [nombre] El material habla solo, archivo sin apelación.',
      'Has dejado. El chat como foro a medias: hilos muertos con tu firma, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Se te nota el peso de arrastrar el mismo rincón por cada conversación, [nombre] El ranking firma y listo, con el grupo de testigo.',
      'Friki de feria de nicho: ruido interno, cero ganas de volver del resto, [nombre] Se ve desde el primer mensaje, sin maquillaje posible.',
      'Has hecho del nicho una trinchera y la trinchera apesta a cerrado, [nombre] El grupo no necesita subtítulos, el veredicto es ese.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre] Eso no se maquilla con ángulo, hostia puta qué nivel.',
      'Has hecho del bajo listón social tu casa y no hay mudanza a la vista, [nombre] El tramo te nombra sin permiso, joder.',
      'Friki de malinterpretar el silencio ajeno como interés por el lore, [nombre] No hay segunda lectura útil, mierda.',
      'Friki de historial público: el vacío social se lee sin escarbar, [nombre] El material habla solo, coño.',
      'Has convertido el nicho en identidad y no hay detergente de salida, [nombre] Aquí no hay modo avión que salve, cabrón.',
      'El grupo paga tu monólogo en cuotas diarias de scroll del hilo, [nombre] El ranking firma y listo, gilipollas.',
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder, el ranking no miente El ranking no miente, joder.',
      ...
      'Friki cutre: ni la rareza tiene gracia ni el aislamiento tiene misterio de genio, [nombre], sin anestesia.',
      ...
      'Friki de ranking: bajas la media del tramo con monólogos que no piden respuesta, [nombre], nivel sótano puro.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre] No hay segunda lectura útil, sin anestesia.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo sin estilo: el desastre sin estética es solo un problema de higiene del hilo. Gilipollas. Nivel sótano documentado.',
      'Tienes más episodios de cerdez documentada que intentos de subir el nivel un punto. Gilipollas. Y se nota a la legua.',
      'El promedio de cerdez es el nivel: no un pico, el suelo del tramo high, [nombre]. Gilipollas. El ranking no miente.',
      'El asco colectivo es el precio de tu rastro. Y el grupo lo paga cada día, [nombre]. Ridículo. Y se nota a la legua.',
      ...
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor. Gilipollas. El bot no regala décimas.',
      'El asco. No es moralina: es el termómetro y te marca cerdez crónica, [nombre]. Basura. Y se nota a la legua.',
      'Tienes más restos en el relato que un cubo de basura. El día de recogida. Patético. Nivel sótano documentado.',
      ...
      'No es atrevimiento: es suciedad previsible y el high te la cobra sin descuento, [nombre]. Pringado. Y se nota a la legua.',
      'Se te oye el masticar de la cerdez hasta en los mensajes que quieren parecer neutros. Fracasado. Nivel sótano documentado.',
      ...
      'Has convertido el grupo en tu comedero y los demás en testigos del banquete, [nombre]. Ridículo. El ranking no miente.',
      'No hay capa fina: hay mancha gruesa y la mancha no se maquilla con emojis, [nombre]. Fracasado. Y se nota a la legua.',
      ...
      'El listón de lo decente lo usas de servilleta y lo tiras al suelo del chat, [nombre]. Pringado. Pura vergüenza ajena.',
      ...
      'La palabra compostura te suena a idioma de otro planeta y no has abierto el diccionario. Basura. Nivel sótano documentado.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo plato sin fregar, [nombre]. Pringado. Y se nota a la legua.',
      'Eres el guarro que deja el pelo en el lavabo y se va, [nombre]. Que lo recoja el siguiente, como todo lo tuyo. Puta dejadez.',
      'Cerdo de historial público: la grasa está en la superficie, no hace falta escarbar. Pringado. Y se nota a la legua.',
      'Se te ve la prisa por embadurnar y la ausencia total de plan de limpieza, [nombre]. Patético. El chat ya lo archivó.',
      'Cerdo de fondo permanente: baja la media del grupo con constancia de metrónomo, [nombre]. Joder. Y se nota a la legua.',
      'Tu escritorio tiene manchas superpuestas que ya forman un patrón geológico, cerdo. Cada capa es un mes de mierda acumulada.',
      'Cerdo de los que dejan grasa en cada mensaje: se te ve el rastro sin buscarlo, [nombre]. Joder. Y se nota a la legua.',
      'Has hecho del desorden una personalidad y la personalidad deja. El chat peor, [nombre]. Mierda. El bot no regala décimas.',
      'No hay misterio de cerdez con estilo: hay lo previsible y sucio, sin chispa, [nombre]. Basura. Y se nota a la legua.',
      'Tienes más grasa en el discurso que un freidora de feria al cierre de la noche. Fracasado. Nivel sótano documentado.',
      'El promedio de cerdez es este: el tramo high no es un mal día, es el nivel, [nombre]. Mierda. Y se nota a la legua.',
      'Cerdo de error de lectura: confundes límites con permiso para seguir manchando. Fracasado. El ranking no miente.',
      ...
      'Has convertido el bajo listón en residencia: sin mudanza a la vista de nadie. Fracasado. Y se nota a la legua.',
      'Tienes más migas en el historial que un mantel de bar después del desayuno eterno. Mierda. El bot no regala décimas.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos de limpieza. Patético. Y se nota a la legua.',
      'No es estilo atrevido: es grasa previsible y el high te la cobra entera, [nombre]. Mierda. Nivel sótano documentado.',
      ...
      'No es libertad: es falta de criterio con migas y el resultado se huele, [nombre]. Cabrón. Y se nota a la legua.',
      'Se te nota el hábito de empujar cada tema hacia el mismo plato sin fregar, [nombre]. Asco. El chat ya lo archivó.',
      'No hay barniz: hay grasa pura y la grasa no se vende como carisma, [nombre]. Ridículo. Y se nota a la legua.',
      'Cerdo de fondo: bajas la media con la constancia de quien no se cansa de ensuciar. Joder. Pura vergüenza ajena.',
      'Cerdo de las que el jabón cruza de acera cuando te ve en el puto ranking, [nombre] El material habla solo, patético.',
      ...
      'Cerdo como un anuncio repetido que nadie pidió, joder, con el grupo de testigo El ranking no miente, joder.',
      ...
      'Cerdo en crudo: ni el maquillaje del ranking te cubre, joder, sin anestesia posible El ranking no miente, joder.',
      'El listón de lo presentable lo usas de tobogán hacia abajo, joder, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Cerdo sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado El ranking no miente, joder.',
      'Se te oye el arrastre del cerdo hasta en los neutros del chat, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Cerdo de historial público: no hace falta escarbar, huele en la superficie, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'Tienes más restos en el discurso que un plato de casa sin fregar en días, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'Cerdo cutre: ni el caos tiene estilo ni el abandono tiene misterio, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Cerdo de las que el mute ajeno lee como misterio y es solo asco, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      'El asco. No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre] No hay segunda lectura útil, pura vergüenza ajena.',
      'Cerdo constante: la única racha es la de no pasar un trapo por nada, [nombre] El material habla solo, con el grupo de testigo.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'Cerdo de cartel grasiento: se ve de lejos y nadie quiere acercarse, [nombre] El ranking firma y listo, el veredicto es ese.',
      'No hay misterio interesante: hay previsible y cerdo, el combo del high, [nombre] Se ve desde el primer mensaje, hostia puta qué nivel.',
      ...
      'Cerdo de ranking: bajas la media del tramo con constancia de mancha, [nombre] No hay segunda lectura útil, cabrón.',
      'Has convertido el bajo listón en casa fija sin fecha de mudanza, [nombre] El material habla solo, gilipollas.',
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre] Aquí no hay modo avión que salve, patético.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] No hay segunda lectura útil, y el ranking no miente.',
      'Has convertido la porquería en carnet y no hay renovación limpia, [nombre] El material habla solo, sin anestesia.',
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, el chat ya lo sabía.',
      'Se te oye el masticar del listón bajo hasta en los serios del chat, [nombre] El ranking firma y listo, nivel sótano puro.',
      ...
      'No hay misterio de cerdo con estilo: hay lo previsible y el high lo nombra, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'Tienes el historial de un fregadero abandonado desde el domingo, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Cerdo de malinterpretar el silencio como invitación a más suciedad, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'El grupo paga tu rastro en cuotas diarias de asco documentado, [nombre] No hay segunda lectura útil, archivo sin apelación.',
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre] El material habla solo, pura vergüenza ajena.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre] El ranking firma y listo, sin maquillaje posible.',
      'La compostura cruza de acera cuando te ve en el high, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      'Cerdo de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] El grupo no necesita subtítulos, hostia puta qué nivel.',
      ...
      'Cerdo de superficie: no hace falta abrir el cubo, huele de lejos, [nombre] No hay segunda lectura útil, coño.',
      'No hay barniz que salve: hay cerdo puro y no se vende como carisma, [nombre] El material habla solo, cabrón.',
      'Tienes el tono de quien acumula restos y nunca pasa el estropajo, [nombre] Aquí no hay modo avión que salve, gilipollas.',
      ...
      'La clase te suena a ataque y respondes con más migas de suciedad, [nombre] No hay segunda lectura útil, qué asco de frame.',
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre] El material habla solo, y el ranking no miente.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Tienes el aura del plato olvidado: presente, frío y con restos, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'El listón lo usas de pan y el suelo del chat es tu mantel, [nombre] Se ve desde el primer mensaje, nivel sótano puro.',
      'Has hecho ranking de cerdo y el oro es tuyo sin rival, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      ...
      'Se te ve venir el teatro sucio en el primer punto del mensaje, [nombre] El tramo te nombra sin permiso, y se te nota a la legua.',
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre] El material habla solo, archivo sin apelación.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      'Tienes el tono de noches de chat sin una frase limpia que se sostenga, [nombre] El ranking firma y listo, con el grupo de testigo.',
      'Cerdo de malinterpretar el mute como interés por el personaje barato, [nombre] Se ve desde el primer mensaje, sin maquillaje posible.',
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre] El grupo no necesita subtítulos, el veredicto es ese.',
      'Has dejado el hilo como obra sin plano: escombro de suciedad, [nombre] Eso no se maquilla con ángulo, hostia puta qué nivel.',
      'Cerdo de estribillo que empeora con cada bis del mismo plato, [nombre] El tramo te nombra sin permiso, joder.',
      'La compostura del tramo no te reconoce en el elenco, [nombre] No hay segunda lectura útil, mierda. Y el chat lo tiene claro, mierda.',
      'Cerdo de fondo: bajas la media del high con constancia de mancha, [nombre] El material habla solo, coño.',
      'No es estilo: es cerdo previsible y el high te lo nombra entero, [nombre] Aquí no hay modo avión que salve, cabrón.',
      ...
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre] No hay segunda lectura útil, fracasado.',
      'Cerdo hasta para el modo oscuro: ni la sombra tapa lo que dejas, [nombre] El material habla solo, qué asco de frame.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Aquí no hay modo avión que salve, y el ranking no miente.',
      'Cerdo de las que el ambientador se rinde y pide la baja, [nombre] El ranking firma y listo, sin anestesia.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre] Se ve desde el primer mensaje, el chat ya lo sabía.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el grupo, [nombre] El grupo no necesita subtítulos, nivel sótano puro.',
      'Cerdo con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] Eso no se maquilla con ángulo, sin filtro ni consuelo.',
      'El high no es un mal día de orden: es. El veredicto y te nombra, [nombre] El tramo te nombra sin permiso, diagnóstico cerrado.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] No hay segunda lectura útil, y se te nota a la legua.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre] El material habla solo, el bot no regala décimas.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Aquí no hay modo avión que salve, archivo sin apelación.',
      'Cerdo sin complejo útil: el complejo al menos indicaría que viste el desastre, [nombre] El ranking firma y listo, pura vergüenza ajena.',
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre] Se ve desde el primer mensaje, con el grupo de testigo.',
      'Has hecho del cerdo tu marca y la marca se pega en los dedos ajenos, [nombre] El grupo no necesita subtítulos, sin maquillaje posible.',
      'Cerdo de las que confunden natural con abandono total del estándar, [nombre] Eso no se maquilla con ángulo, el veredicto es ese.',
      'No es estilo sucio con gracia: eres un cerdo y el high no discute la evidencia, [nombre] El tramo te nombra sin permiso, hostia puta qué nivel.',
      'Tu noción de limpieza es apartar la basura. Con el pie para abrir camino. Vives en un nivel de Tetris hecho de mugre.',
      'La vergüenza ajena es el impuesto que pagamos por tu forma de estar en el hilo. Mierda. Y se nota a la legua.',
      'Cerdo de fondo de chat: siempre ahí, siempre dejando rastro, siempre igual. Ridículo. El chat ya lo archivó.',
      'Has hecho de lo indecente tu plato favorito y lo sirves en todas las mesas. Pringado. Y se nota a la legua.',
      'No es gracia sucia: es suciedad sin gracia, la versión que no entretiene, [nombre]. Coño. Pura vergüenza ajena.',
      'El listón está en el suelo y tú lo usas de pan para mojar sin vergüenza, [nombre]. Coño. Y se nota a la legua.',
      'Cerdo de oficio: el rastro de grasa es tu firma y aparece en cada párrafo. Patético. El bot no regala décimas.',
      'Has firmado lo cutre. Con grasa en cada mensaje como única firma posible. Ridículo. Y se nota a la legua.',
      'Dejas el baño de tal manera que hay que limpiarlo antes de poder usarlo. Puta escena del crimen con toalla húmeda.',
      'Tienes el tono de quien come con la boca abierta en un restaurante en silencio. Joder. Y se nota a la legua.',
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual. Patético. El ranking no miente.',
      ...
      'La palabra clase te suena a reproche y respondes ensuciando un poco más. Ridículo. Y se nota a la legua.',
      'Se te oye el arrastre de la grasa hasta en los mensajes cortos del chat. Pringado. Pura vergüenza ajena.',
      'Has hecho ranking de cerdez y el oro es tuyo sin que nadie dispute el podio. Mierda. Y se nota a la legua.',
      'Tienes más manchas documentadas que intentos serios de pasar un trapo al relato. Coño. El bot no regala décimas.',
      'Has convertido la grasa en carnet y no hay renovación limpia a la vista. Patético. Y se nota a la legua.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla. Coño. Nivel sótano documentado.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B. Cabrón. Y se nota a la legua, joder, con el grupo de testigo.',
      'Has convertido la mancha en identidad y no hay detergente narrativo a la vista. Coño. El ranking no miente.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar. Ridículo. Y se nota a la legua.',
      'Se te ve venir la mancha en la primera palabra del mensaje largo, [nombre]. Cabrón. El chat ya lo archivó.',
      'La vergüenza ajena te sigue y no es admiración: es consecuencia del rastro. Joder. Y se nota a la legua.',
      'Cerdo sin higiene narrativa: ensucias el hilo y no recoges nunca el escombro. Coño. Pura vergüenza ajena.',
    ],
    mid: [
  ...
  femboy: {
    ...
    high: [
      ...
      'Se te nota el teatro en cada mensaje y el high no aplaude el montaje, [nombre] No hay segunda lectura útil, ridículo.',
      'Femboy como un anuncio repetido que nadie pidió, joder, con el grupo de testigo El ranking no miente, joder.',
      'Has hecho del personajito una marca que se pega en los dedos ajenos, [nombre] Aquí no hay modo avión que salve, qué asco de frame.',
      'Femboy en crudo: ni el maquillaje del ranking te cubre, joder, sin anestesia posible El ranking no miente, joder.',
      'El listón de la dignidad lo usas de rampa y el high te empuja abajo, [nombre] Se ve desde el primer mensaje, sin anestesia.',
      'Femboy sin una carta nueva: siempre la misma mano sucia, joder, diagnóstico cerrado El ranking no miente, joder.',
      'Se te oye el arrastre del personaje hasta en los mensajes serios, [nombre] Eso no se maquilla con ángulo, nivel sótano puro.',
      'Femboy de historial público: no hace falta escarbar, está en la superficie, [nombre] El tramo te nombra sin permiso, sin filtro ni consuelo.',
      'Tienes más episodios de pose que de algo que. El chat respete, [nombre] No hay segunda lectura útil, diagnóstico cerrado.',
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre] El material habla solo, y se te nota a la legua.',
      'Has convertido el armario en escenario y la función aburre al patio, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas.',
      'Femboy de las que el mute ajeno lee como misterio y se equivoca de libro, [nombre] El ranking firma y listo, archivo sin apelación.',
      'El asco. No es moralina barata: es el diagnóstico de cómo ocupas el espacio, [nombre] Se ve desde el primer mensaje, pura vergüenza ajena.',
      'Femboy constante: la única racha que mantienes es la del mismo número, [nombre] El grupo no necesita subtítulos, con el grupo de testigo.',
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre] Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Femboy de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre] El tramo te nombra sin permiso, el veredicto es ese.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre] No hay segunda lectura útil, hostia puta qué nivel.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      'Femboy de inercia: el grupo te soporta por costumbre, no por respeto, [nombre] Aquí no hay modo avión que salve, mierda.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] No hay segunda lectura útil, basura.',
      'Femboy de fondo permanente: el high no es un mal día, es el nivel, [nombre] El material habla solo, ridículo.',
      'No es atrevimiento: es suciedad de personaje y el tramo te la cobra, [nombre] Aquí no hay modo avión que salve, fracasado.',
      ...
      'Femboy de ceja ajena levantada y respeto en el sótano del ranking, [nombre] Se ve desde el primer mensaje, y el ranking no miente.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] El grupo no necesita subtítulos, sin anestesia.',
      'Has convertido el personajito en identidad y no hay detergente narrativo, [nombre] Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'Femboy cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] No hay segunda lectura útil, sin filtro ni consuelo.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] El material habla solo, diagnóstico cerrado.',
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua.',
      'No hay misterio de pose con estilo: hay lo previsible y el high lo nombra, [nombre] El ranking firma y listo, el bot no regala décimas.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'Femboy de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Has dejado. El chat como fregadero a medias: restos de pose eternos, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'Femboy de estribillo sin punto final limpio ni redención posible, [nombre] No hay segunda lectura útil, el veredicto es ese.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre] El material habla solo, hostia puta qué nivel.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Aquí no hay modo avión que salve, joder.',
      ...
      'Femboy de puta madre: el high no suaviza el teatro ni el personajito, [nombre] No hay segunda lectura útil, asco.',
  ...
  inutil: {
    ...
    high: [
      ...
      'No hay eco de utilidad: hay eco de hueco en el tramo high, [nombre] No hay segunda lectura útil, ridículo.',
      'La clase de aportar te suena a reproche, [nombre].coño. El material habla solo, fracasado. Y el chat lo tiene claro, fracasado.',
      'El asco del tramo high es este: presencia sin función, [nombre] Aquí no hay modo avión que salve, qué asco de frame.',
      ...
      'Inútil visible desde la autovía del chat: el letrero se ve, la parada no compensa, [nombre], sin maquillaje posible.',
      'Inútil de las que el mute ajeno interpreta como misterio y no como desinterés, [nombre] El tramo te nombra sin permiso, el veredicto es ese.',
      ...
      'Inútil documentado: el ranking de aporte te deja donde mereces sin debate, [nombre] Aquí no hay modo avión que salve, mierda.',
      ...
      'Inútil con las mismas cartas manchadas de siempre y sin plan B, joder, diagnóstico cerrado El ranking no miente, joder.',
      'Inútil de cartel vacío: se ve el marco y no hay obra detrás del nick, [nombre] Aquí no hay modo avión que salve, fracasado.',
      'Llevas años sin una responsabilidad real y te quejas de que no confían en ti. Nadie confía en un puto lastre, cabrón.',
      'Inútil de los que ocupan sitio y no condicionan ni un hilo del chat, [nombre] Se ve desde el primer mensaje, y el ranking no miente.',
      'Tienes el aura del cenicero que nadie vacía: presente y olvidado, [nombre] El grupo no necesita subtítulos, sin anestesia.',
      'Has hecho del no condicionar el hilo una marca personal del ranking, [nombre] Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'Tienes más huecos en el aporte que un colador de feria al cierre, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      'Inútil de las que alardean de estar cuando estar no es aportar, [nombre] No hay segunda lectura útil, sin filtro ni consuelo.',
      'La dignidad de aportar te hace autostop y tú no paras en el arcén, [nombre] El material habla solo, diagnóstico cerrado.',
      'Inútil sin capa de carisma que disimule el agujero, joder, el chat ya lo archivó El ranking no miente, joder.',
      'Inútil de cartas en blanco: el mismo mazo vacío en cada mano, [nombre] El ranking firma y listo, el bot no regala décimas.',
      'Has hecho de la inutilidad una presencia estable en. El chat, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'Inútil de racha perfecta: lo único que no fallas es no servir, [nombre] El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Inútil de las que el grupo no cita porque no hay qué citar, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Has hecho ranking de inutilidad y el oro es tuyo sin rival, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'No es silencio estratégico: es ausencia de contenido útil, [nombre] No hay segunda lectura útil, el veredicto es ese.',
      'El listón de lo útil está lejos y no has dado un paso, [nombre] El material habla solo, hostia puta qué nivel.',
      ...
      'Tienes el historial de un hilo que nadie retoma, [nombre] Aquí no hay modo avión que salve, basura. Y el chat lo tiene claro, basura.',
      ...
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre] Aquí no hay modo avión que salve, cabrón.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre] El material habla solo, mierda.',
  ...
  perdedor: {
    ...
    goodIsHigh: false,
    high: [
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] El material habla solo, patético.',
      'La dignidad del tramo no para el coche: tú eres el tráfico del arcén, [nombre] Aquí no hay modo avión que salve, asco.',
      ...
      'Se te oye el eco del fail hasta en los mensajes que pretenden sonar a plan B, [nombre] Aquí no hay modo avión que salve, patético.',
      ...
      'Perdedor de los que el high del ranking no perdona ni un frame del historial, [nombre] No hay segunda lectura útil, y el ranking no miente.',
      'Perdedor de fondo permanente: el high no es un mal día, es el nivel del tramo, [nombre] El material habla solo, sin anestesia.',
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder, nivel sótano documentado El ranking no miente, joder.',
      'Has hecho de la derrota una residencia fija y no hay mudanza a la vista, [nombre] El ranking firma y listo, nivel sótano puro.',
      'La compostura no te reconoce y tú no has buscado el espejo del marcador, [nombre] Se ve desde el primer mensaje, sin filtro ni consuelo.',
      'Has dejado. El chat como vestuario de derrota: restos de almost eternos, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'No hay misterio interesante: hay previsible y flojo, el combo del high, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Perdedor de estribillo que mancha más con cada repetición del mismo fail, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'Perdedor sin el barniz: solo el material flojo a la vista, joder, pura vergüenza ajena El ranking no miente, joder.',
      'Perdedor de las que el mute ajeno lee como respeto y es solo desinterés, [nombre] El material habla solo, pura vergüenza ajena.',
      'El listón de ganar lo miras desde el sótano y no has subido un peldaño, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Perdedor de ceja ajena levantada y respeto en el sótano del ranking, [nombre] El ranking firma y listo, sin maquillaje posible.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] El grupo no necesita subtítulos, hostia puta qué nivel.',
      ...
      'No hay barniz que salve: hay derrota pura y no se vende como carisma, [nombre] No hay segunda lectura útil, coño.',
      '[nombre], perdedor de mierda: esperas a ver qué pasa y nunca pasa nada bueno. Y encima te sorprende, cada puta vez.',
      'Se te oye el masticar del listón bajo hasta en los neutros del hilo, [nombre] Aquí no hay modo avión que salve, gilipollas.',
      ...
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre] No hay segunda lectura útil, qué asco de frame.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre] El material habla solo, y el ranking no miente.',
      'Has hecho del bajo listón tu casa y no hay mudanza a la vista, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Se te ve venir la derrota en la primera palabra del mensaje, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      ...
      'Perdedor cutre: ni el fallo tiene gracia ni la racha tiene misterio de antihéroe, [nombre], y el ranking no miente.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] Aquí no hay modo avión que salve, basura.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] El material habla solo, sin maquillaje posible.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] El ranking firma y listo, hostia puta qué nivel.',
      ...
      'Perdedor de puta madre: el high no suaviza el almost ni el marcador en cero, [nombre] No hay segunda lectura útil, gilipollas.',
    ],
    mid: [
  ...
  ganador: {
    ...
    low: [
      ...
      'Tienes más almost que victorias y. El ranking lo grita. Sin filtro, [nombre]. El veredicto, el chat ya lo sabía.',
      'Ganador de manual fallido: el marcador te conoce por los ceros, [nombre]. El veredicto Eso no se maquilla con ángulo, nivel sótano puro.',
      'Se te nota la racha de casi en cada mensaje y el low no convierte nada, [nombre]. El veredicto cabrón.',
      'Ganador de fondo de ranking: siempre sin el punto que cambia el partido, [nombre]. El veredicto gilipollas.',
      'Has hecho de la derrota una residencia fija en el tramo bajo, [nombre]. El veredicto El material habla solo, y se te nota a la legua.',
      'Ganador sin el barniz: solo almost eterno y el low lo documenta, [nombre]. El veredicto Aquí no hay modo avión que salve, el bot no regala décimas.',
      'El listón de ganar lo miras desde el sótano y no has subido, [nombre]. El veredicto El ranking firma y listo, archivo sin apelación.',
      'Ganador con el mismo gag de siempre y cero variación. El veredicto ridículo, joder, el ranking no miente.',
      'Se te oye el eco del fail hasta en los mensajes de plan B, [nombre]. El veredicto El grupo no necesita subtítulos, con el grupo de testigo.',
      'Ganador de historial público: el marcador está en la superficie, [nombre]. El veredicto Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Tienes más episodios de derrota que de algo que. El chat respete, [nombre]. El veredicto El tramo te nombra sin permiso, el veredicto es ese.',
      ...
      'Ganador de estribillo que mancha más con cada repetición del fail, [nombre]. El veredicto, sin anestesia.',
      'Se te nota el hábito de empujar cada tema hacia la misma derrota, [nombre]. El veredicto Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'La compostura no te reconoce y tú no has buscado el espejo del marcador, [nombre]. El veredicto patético.',
      'Ganador de fondo permanente: el low no es un mal día, es el nivel, [nombre]. El veredicto, sin filtro ni consuelo.',
      'No es mala suerte: es patrón y el low te lo cobra, [nombre]. El veredicto El material habla solo, diagnóstico cerrado.',
      'Tienes más grasa de derrota que un vestuario después del 0-5, [nombre]. El veredicto Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Ganador de ceja ajena levantada y respeto en el sótano, [nombre]. El veredicto El ranking firma y listo, el bot no regala décimas.',
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. El veredicto Se ve desde el primer mensaje, archivo sin apelación.',
      'Has convertido el almost en identidad y no hay detergente, [nombre]. El veredicto El grupo no necesita subtítulos, pura vergüenza ajena.',
      'Ganador cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto, con el grupo de testigo.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto El tramo te nombra sin permiso, sin maquillaje posible.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del marcador, [nombre]. El veredicto cabrón.',
      ...
      'No hay barniz que salve: hay derrota pura y el low la cobra, [nombre]. El veredicto Eso no se maquilla con ángulo, sin anestesia.',
      'Ganador de puta madre en el sentido del almost: el low no suaviza el marcador, [nombre]. El veredicto basura.',
      'Tu racha de ceros es el gag del tramo. Y el grupo no pide replay, [nombre]. El veredicto No hay segunda lectura útil, nivel sótano puro.',
      'Ganador de las que el marcador te debe una hostia y. El ranking te la cobra, [nombre]. El veredicto fracasado.',
      'Se te cae el personaje de ganador solo con abrir el comando, [nombre]. El veredicto Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Ganador de almost eterno: esta vez tampoco fue la excepción, [nombre]. El veredicto El ranking firma y listo, y se te nota a la legua.',
      'No hay redención en este low: hay veredicto y te nombra. Sin filtro, [nombre]. El veredicto, el bot no regala décimas.',
      'Ganador con más excusas que puntos en el marcador del puto ranking, [nombre]. El veredicto, archivo sin apelación.',
      'El low te ha puesto en tu sitio: abajo, sin debate, [nombre]. El veredicto Eso no se maquilla con ángulo, pura vergüenza ajena.',
      ...
      'Ganador de ranking roto: el número bajo te queda de apodo, [nombre]. El veredicto El material habla solo, el veredicto es ese.',
      ...
      'Tu presencia en el low es el gag del comando y no el trofeo, [nombre]. El veredicto No hay segunda lectura útil, el chat ya lo sabía.',
      'Ganador de ranking: el tramo bajo te queda como un guante de derrota, [nombre]. El veredicto, nivel sótano puro.',
      'Has convertido el almost en residencia fiscal del low, [nombre]. El veredicto Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Ganador de las que. El chat archiva el fail sin pedir amplificación, [nombre]. El veredicto, diagnóstico cerrado.',
      'El low te nombra sin suavizar: perdedor de base y punto, [nombre]. El veredicto Se ve desde el primer mensaje, y se te nota a la legua.',
      'Ganador con la disciplina de quien nunca aceptó el espejo del marcador, [nombre]. El veredicto gilipollas.',
      'Se te ve venir el fail en la primera palabra del resultado, [nombre]. El veredicto Eso no se maquilla con ángulo, archivo sin apelación.',
      ...
      'Ganador de las que el modo victoria tampoco es cómplice del fail, [nombre]. El veredicto El material habla solo, sin maquillaje posible.',
      'El low es tu tramo natural y. El ranking no ofrece recurso, [nombre]. El veredicto Aquí no hay modo avión que salve, el veredicto es ese.',
      ...
      'No hay filtro mágico: hay evidencia y el low la firma en público, [nombre]. El veredicto No hay segunda lectura útil, sin anestesia.',
      'Tu almost es el gag del tramo. Y el grupo no pide repetición, [nombre]. El veredicto El material habla solo, el chat ya lo sabía.',
      'Ganador de almost documentado en alta definición del chat, [nombre]. El veredicto Aquí no hay modo avión que salve, nivel sótano puro.',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto El grupo no necesita subtítulos, y se te nota a la legua.',
      'Has montado el teatro de ganador y solo salió el fail del low, [nombre]. El veredicto Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Ganador de ranking: el tramo bajo es tu residencia fija, [nombre]. El veredicto El tramo te nombra sin permiso, archivo sin apelación.',
      'Tu racha baja el promedio del grupo en un solo resultado, [nombre]. El veredicto No hay segunda lectura útil, pura vergüenza ajena.',
      'Ganador de las que el modo victoria se arrepiente de haberse abierto, [nombre]. El veredicto patético.',
      'No es mala racha ni cámara mala: eres tú y el low lo dice claro, [nombre]. El veredicto Aquí no hay modo avión que salve, sin maquillaje posible.',
      ...
      'No hay redención en este low: hay marcador, hay número y hay veredicto, [nombre]. El veredicto joder.',
      'Ganador de las que el grupo archiva el fail sin pedir bis, [nombre]. El veredicto El material habla solo, sin anestesia.',
      'Ganador de ranking roto: el sótano del tramo te queda de casa, [nombre]. El veredicto Aquí no hay modo avión que salve, el chat ya lo sabía.',
      'El comando no discute contigo: el low firma y punto, [nombre]. El veredicto El ranking firma y listo, nivel sótano puro.',
      ...
      'Has firmado el fail con cada cero como única firma del low, [nombre]. El veredicto El tramo te nombra sin permiso, el bot no regala décimas.',
      'Ganador de superficie suficiente: basta el marcador, sobra el resto, [nombre]. El veredicto fracasado.',
      'El low es tu tramo y. El ranking no ofrece mudanza, [nombre]. El veredicto El material habla solo, pura vergüenza ajena.',
      'Se te cae el frame de ganador solo con cargar el resultado, [nombre]. El veredicto Aquí no hay modo avión que salve, con el grupo de testigo.',
      'Ganador de almost eterno con. El chat de testigo notarial, [nombre]. El veredicto El ranking firma y listo, sin maquillaje posible.',
      'No es un mal día de resultados: es el nivel y el low te lo cobra, [nombre]. El veredicto Se ve desde el primer mensaje, el veredicto es ese.',
  ...
  puta: {
    ...
    high: [
      ...
      'Puta de las que el puticlub pediría referencia negativa antes de contratarte, [nombre] El grupo no necesita subtítulos, sin anestesia.',
      'Tienes más nombres en la lista que razones para estar en el puto ranking, [nombre] Eso no se maquilla con ángulo, el chat ya lo sabía.',
      'Puta de manual: ni el precio tiene gracia ni el servicio tiene misterio, [nombre] El tramo te nombra sin permiso, nivel sótano puro.',
      'Se te nota el rastro de puta hasta en los mensajes que pretenden ser serios, [nombre] No hay segunda lectura útil, sin filtro ni consuelo.',
      'Puta convertido en wallpaper del fail colectivo, joder, sin anestesia posible El ranking no miente, joder.',
      'Has convertido el puterío en identidad y no hay detergente que la limpie, [nombre] Aquí no hay modo avión que salve, y se te nota a la legua.',
      'Puta en modo sin filtro y el filtro pedía clemencia, joder, diagnóstico cerrado El ranking no miente, joder.',
      'El listón de la dignidad lo usas de rampa para bajar más todavía, joder, [nombre] Se ve desde el primer mensaje, archivo sin apelación.',
      'Puta con el mismo gag de siempre y cero variación, joder, sin maquillaje posible El ranking no miente, joder.',
      'Se te oye el arrastre del personaje hasta en los neutros del chat, [nombre] Eso no se maquilla con ángulo, con el grupo de testigo.',
      'Puta de historial público: no hace falta escarbar, está en la superficie, [nombre] El tramo te nombra sin permiso, sin maquillaje posible.',
      'Tienes más episodios de puta documentados que intentos de subir el nivel, [nombre] No hay segunda lectura útil, el veredicto es ese.',
      'Puta cutre: ni el vicio tiene gracia ni la pose tiene mérito de antihéroe, [nombre] El material habla solo, hostia puta qué nivel.',
      'Has hecho del bajo listón tu residencia fija sin mudanza a la vista, [nombre] Aquí no hay modo avión que salve, joder.',
      'Puta de las que el mute ajeno lee como interés y es solo desprecio, [nombre] El ranking firma y listo, mierda.',
      'El asco. No es moralina: es el diagnóstico de cómo ocupas el espacio, [nombre] Se ve desde el primer mensaje, coño.',
      'Puta constante: la única racha es la de no cerrar el mismo número, [nombre] El grupo no necesita subtítulos, cabrón.',
      'Se te nota la prisa por ser el personaje y cero plan de ser alguien de peso, [nombre] Eso no se maquilla con ángulo, gilipollas.',
      'Puta de cartel grasiento: se ve el anuncio y nadie quiere la función, [nombre] El tramo te nombra sin permiso, patético.',
      'No hay misterio interesante: hay previsible y puta, el combo del high, [nombre] No hay segunda lectura útil, asco.',
      'Tienes el historial de un local cerrado por exceso de pose y falta de sustancia, [nombre]. Fracasado.',
      'Puta de inercia: el grupo te soporta por costumbre, no por respeto, [nombre] Aquí no hay modo avión que salve, ridículo.',
      'El recato te queda lejos y la distancia es rechazo, no mística, [nombre] El ranking firma y listo, fracasado.',
      'Puta de ranking: bajas la media del tramo con constancia molesta, [nombre] Se ve desde el primer mensaje, qué asco de frame.',
      'Has convertido el personajito en carnet y no hay renovación limpia, [nombre] El grupo no necesita subtítulos, y el ranking no miente.',
      'Puta de estribillo que mancha más con cada bis del mismo plato, [nombre] Eso no se maquilla con ángulo, sin anestesia.',
      'Se te nota el hábito de empujar cada tema hacia el mismo teatro barato, [nombre] El tramo te nombra sin permiso, el chat ya lo sabía.',
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] No hay segunda lectura útil, nivel sótano puro.',
      'Puta de fondo permanente: el high no es un mal día, es el nivel, [nombre] El material habla solo, sin filtro ni consuelo.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre] Aquí no hay modo avión que salve, diagnóstico cerrado.',
      'Tienes más grasa de puta en el discurso que un freidor al cierre de feria, [nombre] El ranking firma y listo, y se te nota a la legua.',
      'Puta de ceja ajena levantada y respeto en el sótano del ranking, [nombre] Se ve desde el primer mensaje, el bot no regala décimas.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] El grupo no necesita subtítulos, archivo sin apelación.',
      'Has convertido la puta en identidad y no hay detergente narrativo, [nombre] Eso no se maquilla con ángulo, pura vergüenza ajena.',
      'Puta cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre] El tramo te nombra sin permiso, con el grupo de testigo.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre] No hay segunda lectura útil, sin maquillaje posible.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre] El material habla solo, el veredicto es ese.',
      'Puta de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Aquí no hay modo avión que salve, hostia puta qué nivel.',
      'No hay misterio de puta con estilo: hay lo previsible y el high lo nombra, [nombre] El ranking firma y listo, joder.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre] Se ve desde el primer mensaje, mierda.',
      'Puta de malinterpretar el silencio ajeno como invitación a más teatro, [nombre] El grupo no necesita subtítulos, coño.',
      'El grupo paga tu rastro en cuotas diarias de hastío documentado, [nombre] Eso no se maquilla con ángulo, cabrón.',
      'Has dejado. El chat como fregadero a medias: restos de puta eternos, [nombre] El tramo te nombra sin permiso, gilipollas.',
      'Puta de estribillo sin punto final limpio ni redención posible, [nombre] No hay segunda lectura útil, patético.',
      'Se te nota el peso de arrastrar el mismo personaje por cada hilo, [nombre] El material habla solo, asco.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Aquí no hay modo avión que salve, basura.',
      'Puta de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] El ranking firma y listo, ridículo.',
      'Se te ve venir la puta en la primera palabra del mensaje, [nombre] Se ve desde el primer mensaje, fracasado.',
      'La dignidad del tramo no para: tú eres el tráfico del arcén, [nombre] El grupo no necesita subtítulos, qué asco de frame.',
      'Puta de superficie suficiente: no hace falta abrir el cubo, huele, [nombre] Eso no se maquilla con ángulo, y el ranking no miente.',
      'No hay barniz que salve: hay puta pura y no se vende como carisma, [nombre] El tramo te nombra sin permiso, sin anestesia.',
      'Tienes el tono de quien acumula restos de personaje y nunca pasa el estropajo, [nombre] No hay segunda lectura útil, el chat ya lo sabía.',
      'Puta de las que alardean del teatro porque callar las deja sin rol, [nombre] El material habla solo, nivel sótano puro.',
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre] Aquí no hay modo avión que salve, sin filtro ni consuelo.',
      'Has firmado la puta con grasa en cada mensaje como única firma, [nombre] El ranking firma y listo, diagnóstico cerrado.',
      'Puta visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Se ve desde el primer mensaje, y se te nota a la legua.',
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el bayeta, [nombre] El grupo no necesita subtítulos, el bot no regala décimas.',
      'La clase te suena a ataque y respondes con más del mismo plato, [nombre] Eso no se maquilla con ángulo, archivo sin apelación.',
      'Puta de racha perfecta: lo único que no fallas es el mismo número, [nombre] El tramo te nombra sin permiso, pura vergüenza ajena.',
      'No hay eco de estilo: hay eco de puta. Y el chat lo amplifica, [nombre] No hay segunda lectura útil, con el grupo de testigo.',
      'Tienes el aura del plato olvidado: presente, frío y con restos, [nombre] El material habla solo, sin maquillaje posible.',
      'Puta de error de lectura: confundes límites con permiso para seguir, [nombre] Aquí no hay modo avión que salve, el veredicto es ese.',
      'El listón lo usas de pan y el suelo del chat es tu mantel, [nombre] El ranking firma y listo, hostia puta qué nivel.',
      'Has hecho ranking de puta y el oro es tuyo sin rival serio, [nombre] Se ve desde el primer mensaje, joder.',
      'Puta de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre] El grupo no necesita subtítulos, mierda.',
      'Se te ve venir el teatro en el primer punto del mensaje, [nombre] Eso no se maquilla con ángulo, coño.',
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] El tramo te nombra sin permiso, cabrón.',
      'Puta de superficie: basta la vista, no hace falta el sótano, [nombre] No hay segunda lectura útil, gilipollas.',
      'No hay barniz de antihéroe: hay puta y el high la cobra, [nombre] El material habla solo, patético. Y el chat lo tiene claro, patético.',
      'Tienes el tono de noches de chat sin una frase que se sostenga sola, [nombre] Aquí no hay modo avión que salve, asco.',
      'Puta de malinterpretar el mute como interés por el personaje barato, [nombre] El ranking firma y listo, basura.',
      'El precio de tu repertorio lo paga el hilo en tiempo y paciencia, [nombre] Se ve desde el primer mensaje, ridículo.',
      'Has dejado el hilo como obra sin plano: escombro de puta y nada más, [nombre] El grupo no necesita subtítulos, fracasado.',
      'Puta de estribillo que empeora con cada bis del mismo número cutre, [nombre] Eso no se maquilla con ángulo, qué asco de frame.',
      'Se te nota el hábito de empujar cada hilo hacia el mismo escenario, [nombre] El tramo te nombra sin permiso, y el ranking no miente.',
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre] No hay segunda lectura útil, sin anestesia.',
      'Puta de fondo: bajas la media del high con la constancia de quien no se cansa, [nombre] El material habla solo, el chat ya lo sabía.',
      'No es estilo: es puta previsible y el high te la nombra entero, [nombre] Aquí no hay modo avión que salve, nivel sótano puro.',
      'Tienes más episodios de personajito que intentos de subir el listón, [nombre] El ranking firma y listo, sin filtro ni consuelo.',
      'Puta de respeto ajeno en números rojos del ranking del grupo, [nombre] Se ve desde el primer mensaje, diagnóstico cerrado.',
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] El grupo no necesita subtítulos, y se te nota a la legua.',
      'Has convertido la puta en carnet y no hay renovación limpia a la vista, [nombre] Eso no se maquilla con ángulo, el bot no regala décimas.',
      'Puta de puta madre en el sentido literal: el high no suaviza el cargo, [nombre] El tramo te nombra sin permiso, archivo sin apelación.',
      'Tu presencia baja el promedio de dignidad del chat solo con escribir, [nombre] No hay segunda lectura útil, pura vergüenza ajena.',
      'Puta hasta para el modo oscuro: ni la sombra tapa lo que dejas atrás, [nombre] El material habla solo, con el grupo de testigo.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] Aquí no hay modo avión que salve, sin maquillaje posible.',
      'Puta de las que el filtro de respeto se rinde y pide la baja, [nombre] El ranking firma y listo, el veredicto es ese.',
      'No hay barniz que te salve: hay puta de base y el comando la cobra, [nombre] Se ve desde el primer mensaje, hostia puta qué nivel.',
      'Tu mensaje es un aviso de lo que no hay que tomar en serio en el grupo, [nombre] El grupo no necesita subtítulos, joder.',
      'Puta con la disciplina de quien nunca ha cerrado el mismo número, [nombre] Eso no se maquilla con ángulo, mierda.',
      'El high no es un mal día de pose: es. El veredicto y te nombra, [nombre] El tramo te nombra sin permiso, coño.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] No hay segunda lectura útil, cabrón.',
      'Puta de repertorio: siempre la misma carta y cero plan B de dignidad, [nombre] El material habla solo, gilipollas.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Aquí no hay modo avión que salve, patético.',
      'Puta sin complejo útil: el complejo al menos indicaría que viste el espejo, [nombre] El ranking firma y listo, asco.',
      'El ranking de dignidad te deja donde mereces: en el sótano del high, [nombre] Se ve desde el primer mensaje, basura.',
      'Has hecho de la puta tu marca y la marca se pega en los dedos ajenos, [nombre] El grupo no necesita subtítulos, ridículo.',
      'Puta de las que confunden natural con abandono total del estándar, [nombre] Eso no se maquilla con ángulo, fracasado.',
      'No es estilo sucio con gracia: eres puta y el high no discute la evidencia, [nombre] El tramo te nombra sin permiso, qué asco de frame.',
  ...
  guarra: {
    ...
    high: [
      ...
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica. Gilipollas. Y se nota a la legua, cabrón.',
      ...
      'Guarra de estribillo que empeora con cada repetición del mismo tema sucio, [nombre]. Gilipollas. El bot no regala décimas.',
      'Guarra cutre y constante: la única racha que mantienes sin fallar nunca, [nombre]. Gilipollas. Y se nota a la legua.',
      'Tienes más manchas en el discurso que un delantal de cocina de barrio a las tres. Gilipollas. Nivel sótano documentado.',
      'Guarra de las que el grupo lee con una ceja levantada y cero respeto, [nombre]. Gilipollas. Y se nota a la legua.',
      'El asco es el resumen corto: el largo es este tramo y se te queda grande de digno. Pringado. El ranking no miente.',
      ...
      'El asco. No es moralina: es diagnóstico de cómo ocupas el espacio del chat. Fracasado. Pura vergüenza ajena.',
      'No hay capa fina encima: hay grasa y la grasa no se maquilla con emojis. Gilipollas. Y se nota a la legua.',
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat. Gilipollas. El bot no regala décimas.',
      'El asco es. El veredicto del tramo high: y. El veredicto no tiene apelación. Ridículo. Y se nota a la legua.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile. Gilipollas. Nivel sótano documentado.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat. Pringado. Y se nota a la legua.',
      'El asco. No es pruderie: es el termómetro y te marca fiebre de cutrez crónica. Coño. El ranking no miente.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca. Gilipollas. Y se nota a la legua, con el grupo de testigo.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. Patético. El chat ya lo archivó.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día. Gilipollas. Y se nota a la legua, el veredicto es ese.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para. Mierda. Y se nota a la legua, sin maquillaje posible.',
      ...
      'Guarra de fondo de chat: siempre ahí, siempre igual, siempre bajando la media, [nombre]. Pringado. Y se nota a la legua.',
      'Guarra de superficie suficiente: no hace falta abrir cajones, está a la vista, [nombre]. Pringado. Nivel sótano documentado.',
      'Guarra profesional: cobras en atención y pagas con vergüenza ajena al que te lee, [nombre]. Cabrón. Y se nota a la legua.',
      'Guarra cutre de feria: mucho ruido, poca sustancia y el suelo peor que antes, [nombre]. Ridículo. El ranking no miente.',
      'Se te oye el arrastre de la guarrada hasta en los mensajes que quieren parecer neutros. Pringado. Y se nota a la legua.',
      ...
      'Guarra de repertorio corto y manchado: siempre las mismas cartas grasientas, [nombre]. Patético. El bot no regala décimas.',
      ...
      'El grupo ya no se sorprende: archiva tus mensajes en la carpeta de lo previsible y sucio. Cabrón. El ranking no miente.',
      'No hay barniz: hay barro puro y el barro no se vende como personalidad interesante. Fracasado. Y se nota a la legua.',
      'Guarra de manual cutre: ni elegancia en el vicio ni gracia en el desastre, [nombre]. Ridículo. El chat ya lo archivó.',
      'Guarra con las mismas cartas manchadas de siempre y sin plan B. Fracasado. Y se nota a la legua, diagnóstico cerrado.',
      'Guarra de las que leen el silencio como invitación y se equivocan siempre, [nombre]. Pringado. Pura vergüenza ajena.',
      'Tienes el aura del cenicero que nadie vacía: presente, lleno y olvidado en el borde. Patético. Y se nota a la legua.',
      'Has convertido el descaro en falta de vergüenza y la falta de vergüenza en marca. Fracasado. El bot no regala décimas.',
      'Guarra cutre y orgullosa: el orgullo es lo único que te queda de interesante, [nombre]. Basura. Y se nota a la legua.',
      'No es libertad: es falta de filtro y el resultado es basura. Con eco en el grupo. Vergüenza. Nivel sótano documentado.vergüenza.',
      'El filtro de lo decente se te rompió hace temporadas y nadie ha venido a cambiarlo. Patético. Y se nota a la legua.',
      'Guarra sin estilo: el desastre sin estética es solo desastre, y tú lo clavas, [nombre]. Mierda. El ranking no miente.',
      ...
      'Guarra de las que el grupo mutea con educación y sigue leyendo por morbo barato, [nombre]. Coño. Y se nota a la legua.',
      'Guarra de cartel roto: la promesa era estilo y el producto es solo suciedad, [nombre]. Basura. Pura vergüenza ajena.',
      'Guarra de error de lectura crónico: confundes límites con juego siempre, [nombre]. Ridículo. Y se nota a la legua.',
      'Tu presencia obliga al grupo a bajar el listón de lo aceptable, [nombre]. Y ya estaba en el suelo. Puta cutrez contagiosa.',
      'Tienes más kilómetros de cama barata que de dignidad acumulada en el historial del grupo. Coño. Y se nota a la legua.',
      'No es libertad sexual: es falta de criterio y el resultado se huele en el hilo. Fracasado. Nivel sótano documentado.',
      'Eres tan poco cuidadosa, [nombre], que el descuido dejó de ser accidente y pasó a ser método. Puta cochambre con sistema.',
      'Has convertido. El chat en tu callejón. Y el grupo en el público que no pidió entrada. Basura. El ranking no miente.',
      'Guarra con antigüedad: el óxido de tanto oficio se te ve en cada broma de más, [nombre]. Asco. Y se nota a la legua.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder, el bot no regala décimas El ranking no miente, joder.',
      'Has convertido la suciedad en identidad y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder, nivel sótano documentado El ranking no miente, joder.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder, el ranking no miente El ranking no miente, joder.',
      'Se te oye el arrastre de la guarrería hasta en los neutros del chat, [nombre] El grupo no necesita subtítulos, diagnóstico cerrado.',
      'Guarra de historial público: no hace falta escarbar, huele en la superficie, [nombre] Eso no se maquilla con ángulo, y se te nota a la legua.',
      'Tienes más restos de suciedad en el discurso que un cubo sin recogida semanal, [nombre] El tramo te nombra sin permiso, el bot no regala décimas.',
      'Guarra cutre: ni el caos tiene estilo ni el abandono tiene carisma de antihéroe, [nombre], archivo sin apelación.',
      'Has hecho del bajo listón de higiene tu residencia fija del ranking, [nombre] El material habla solo, pura vergüenza ajena.',
      'Guarra de las que el mute ajeno lee como misterio y es solo asco documentado, [nombre] Aquí no hay modo avión que salve, con el grupo de testigo.',
      'El asco. No es moralina: es el diagnóstico de cómo ocupas el espacio del grupo, [nombre]. Gilipollas.',
      'Guarra constante: la única racha es la de no pasar un puto trapo por el relato, [nombre] Se ve desde el primer mensaje, el veredicto es ese.',
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo que dejas atrás, [nombre] El grupo no necesita subtítulos, hostia puta qué nivel.',
      ...
      'Tienes el historial de un local cerrado por salubridad moral del ranking, [nombre] No hay segunda lectura útil, coño.',
      'Guarra de inercia: el grupo te soporta por costumbre, no por respeto, [nombre] El material habla solo, cabrón.',
      ...
      'La compostura no te reconoce y tú no has buscado el espejo en serio, [nombre] El tramo te nombra sin permiso, fracasado.',
      'Guarra de fondo permanente: el high no es un mal día, es el nivel, [nombre] No hay segunda lectura útil, qué asco de frame.',
      'No es atrevimiento: es suciedad de personaje y el high te la cobra, [nombre] El material habla solo, y el ranking no miente.',
      'Tienes más grasa en el discurso que un delantal de cocina sin lavar en meses, [nombre] Aquí no hay modo avión que salve, sin anestesia.',
      'Guarra de ceja ajena levantada y respeto en el sótano del ranking, [nombre] El ranking firma y listo, el chat ya lo sabía.',
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre] Se ve desde el primer mensaje, nivel sótano puro.',
      'Has convertido la guarrería en carnet y no hay renovación limpia a la vista, [nombre] El grupo no necesita subtítulos, sin filtro ni consuelo.',
      ...
      'Se te oye el masticar del listón bajo hasta en los mensajes serios, [nombre] El tramo te nombra sin permiso, y se te nota a la legua.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del grupo, [nombre] No hay segunda lectura útil, el bot no regala décimas.',
      'Guarra de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] El material habla solo, archivo sin apelación.',
      'No hay misterio de guarrería con estilo: hay lo previsible y el high lo nombra, [nombre] Aquí no hay modo avión que salve, pura vergüenza ajena.',
      ...
      'Guarra de malinterpretar el silencio ajeno como invitación a más suciedad, [nombre] Se ve desde el primer mensaje, sin maquillaje posible.',
      'El grupo paga tu rastro en cuotas diarias de asco documentado, [nombre] El grupo no necesita subtítulos, el veredicto es ese.',
      'Has dejado. El chat como fregadero a medias: restos eternos de guarrería, [nombre] Eso no se maquilla con ángulo, hostia puta qué nivel.',
      'Guarra de estribillo sin punto final limpio ni redención posible, [nombre] El tramo te nombra sin permiso, joder.',
      'Se te nota el peso de arrastrar la misma mancha por cada hilo, [nombre] No hay segunda lectura útil, mierda.',
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] El material habla solo, coño.',
      'Guarra de feria: grasa, ruido, suelo peor y cero ganas de volver, [nombre] Aquí no hay modo avión que salve, cabrón.',
      ...
      'El asco resume el high y el resto solo desarrolla el mismo diagnóstico, [nombre] No hay segunda lectura útil, fracasado.',
      'Has firmado la guarrería con grasa en cada mensaje como única firma, [nombre] El material habla solo, qué asco de frame.',
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Aquí no hay modo avión que salve, y el ranking no miente.',
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre] El ranking firma y listo, sin anestesia.',
      'La clase te suena a ataque y respondes dejando más migas de suciedad, [nombre] Se ve desde el primer mensaje, el chat ya lo sabía.',
      'Guarra de racha perfecta: lo único que no fallas es manchar. El ranking, [nombre] El grupo no necesita subtítulos, nivel sótano puro.',
      'No hay eco de estilo: hay eco de guarrería. Y el chat lo amplifica, [nombre] Eso no se maquilla con ángulo, sin filtro ni consuelo.',
      ...
      'Guarra de error de lectura: confundes límites con permiso para seguir sucia, [nombre] No hay segunda lectura útil, y se te nota a la legua.',
      'El listón lo usas de pan y el suelo del chat es tu mantel preferido, [nombre] El material habla solo, el bot no regala décimas.',
      'Has hecho ranking de guarrería y el oro es tuyo sin rival serio, [nombre] Aquí no hay modo avión que salve, archivo sin apelación.',
      'Guarra de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre] El ranking firma y listo, pura vergüenza ajena.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] El grupo no necesita subtítulos, sin maquillaje posible.',
      'Guarra de superficie: basta la vista, no hace falta el sótano, [nombre] Eso no se maquilla con ángulo, el veredicto es ese.',
      'No hay barniz de antihéroe: hay guarrería y el high la cobra, [nombre] El tramo te nombra sin permiso, hostia puta qué nivel.',
      'Tienes el tono de noches de chat sin una frase que se sostenga limpia, [nombre] No hay segunda lectura útil, joder.',
      'Guarra de malinterpretar el mute como interés por el personaje barato, [nombre] El material habla solo, mierda.',
      'El precio de tu repertorio lo paga el hilo en tiempo y en paciencia, [nombre] Aquí no hay modo avión que salve, coño.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre] No hay segunda lectura útil, ridículo.',
      'Guarra de respeto ajeno en números rojos del ranking del grupo, [nombre] El material habla solo, fracasado.',
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] Aquí no hay modo avión que salve, qué asco de frame.',
      'Has convertido la guarrería en identidad sin renovación limpia a la vista, [nombre] El ranking firma y listo, y el ranking no miente.',
      'Guarra de puta madre en el sentido literal: el high no suaviza el olor del tramo, [nombre]. Patético.',
      'Tu presencia baja el promedio de higiene del chat solo con escribir, [nombre] El grupo no necesita subtítulos, el chat ya lo sabía.',
      'Guarra hasta para el modo oscuro: ni la sombra tapa lo que dejas atrás, [nombre] Eso no se maquilla con ángulo, nivel sótano puro.',
      'Se te cae el disimulo solo con abrir el hilo y el high lo documenta, [nombre] El tramo te nombra sin permiso, sin filtro ni consuelo.',
      'Guarra de las que el ambientador se rinde y pide la baja del ranking, [nombre] No hay segunda lectura útil, diagnóstico cerrado.',
      'No hay jabón que te salve: hay suciedad de base y el comando la cobra, [nombre] El material habla solo, y se te nota a la legua.',
      'Tu mensaje es un aviso de lo que no hay que tocar en el puto grupo, [nombre] Aquí no hay modo avión que salve, el bot no regala décimas.',
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre] El ranking firma y listo, archivo sin apelación.',
      'El high no es un mal día de orden: es. El veredicto y te nombra, [nombre] Se ve desde el primer mensaje, pura vergüenza ajena.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] El grupo no necesita subtítulos, con el grupo de testigo.',
      'Guarra de repertorio: siempre la misma mancha y cero plan B de limpieza, [nombre] Eso no se maquilla con ángulo, sin maquillaje posible.',
      'Se te nota el desastre hasta en la miniatura más pequeña del estado, [nombre] El tramo te nombra sin permiso, el veredicto es ese.',
      'Guarra sin complejo útil: el complejo al menos indicaría que viste el desastre, [nombre] No hay segunda lectura útil, hostia puta qué nivel.',
      'El ranking de higiene te deja donde mereces: en el sótano del high, [nombre] El material habla solo, joder.',
      'Has hecho de la guarrería tu marca y la marca se pega en los dedos ajenos, [nombre] Aquí no hay modo avión que salve, mierda.',
      ...
      'Has hecho del bajo listón una residencia fija: sin opción a mudanza, [nombre]. Fracasado. Y se nota a la legua.',
      'Guarra sin glamour: el desastre sin estética es solo un problema de higiene narrativa. Joder. El ranking no miente.',
      'Guarra sin punto final: el estribillo se repite y cada vez suena peor, [nombre]. Pringado. Y se nota a la legua.',
      'Guarra de las que confunden mute con coquetería: error de lectura crónico, [nombre]. Cabrón. El chat ya lo archivó.',
      'Guarra cutre de feria ambulante: ruido, grasa y nada que llevarse a casa, [nombre]. Cabrón. Y se nota a la legua.',
      ...
      'Guarra de las que el grupo soporta con una ceja arriba y respeto en cero, [nombre]. Basura. El bot no regala décimas.',
      ...
      'Tienes más episodios documentados de guarrada que mensajes decentes en el archivo. Cabrón. Y se nota a la legua.',
      'Has convertido el barro en carnet de identidad y no hay renovación a la vista. Pringado. El ranking no miente.',
      'Has convertido cada conversación en un parte de guerra de la vergüenza colectiva. Cabrón. Y se nota a la legua.',
      ...
      'Tienes más manchas en el relato que un mantel de bar a las seis de la mañana. Ridículo. Pura vergüenza ajena.',
      'Tienes el aura de un cenicero lleno a las cuatro de la mañana en un local dudoso. Mierda. Y se nota a la legua.',
      'Guarra de las que el mute ajeno interpreta como juego y no como frontera, [nombre]. Joder. El bot no regala décimas.',
      'No es desparpajo con gracia: es falta de filtro sin el beneficio del carisma. Ridículo. Y se nota a la legua.',
      'Guarra visible desde la autovía: el letrero se ve, la parada no compensa, [nombre]. Joder. Nivel sótano documentado.',
      'Has hecho de lo cutre una marca personal y la marca huele desde el primer mensaje. Joder. Y se nota a la legua.',
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar. Fracasado. El ranking no miente.',
      'Guarra de fondo permanente: baja la media del grupo sin pedir permiso, [nombre]. Mierda. Y se nota a la legua.',
    ],
    mid: [
