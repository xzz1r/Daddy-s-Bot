...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Incel como un anuncio repetido que nadie pidió, joder Menudo desastre, gilipollas.',
      'Has convertido el resentimiento en identidad y no hay terapia que la limpie aquí, [nombre]. Patético.',
      'Incel en crudo: ni el maquillaje del ranking te cubre, joder Hostia qué nivel, asco.',
      ...
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre] Menudo desastre, coño.',
      ...
      'La compostura del tramo no te reconoce en el elenco social, [nombre] Puro circo barato, patético.',
      ...
      'El high no es un mal día de humor: es Sin anestesia posible, joder.',
      'Tienes una presencia que ensucia el hilo en un solo monólogo, [nombre] Puro circo barato, mierda.',
  ...
  fea: {
    ...
    high: [
      ...
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente Menudo desastre, coño.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco. Con piernas Se te ve el forro, cabrón.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis Hostia qué nivel, gilipollas.',
      ...
      '[nombre], si te miran de frente es por educación, no por interés Menudo desastre, joder.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. De material Se te ve el forro, mierda.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet Hostia qué nivel, coño.',
      'La luz natural te delata como un puto detector de mentiras, [nombre] Sin debate útil, cabrón.',
      ...
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo Menudo desastre, ridículo.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. Sin plot twist Se te ve el forro, fracasado.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes Hostia qué nivel, joder.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético. Empate Sin debate útil, mierda.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta Y no hay forma de maquillarlo, coño.',
      ...
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza Menudo desastre, asco.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón. De manual Se te ve el forro, basura.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil Hostia qué nivel, ridículo.',
      'Tienes más ángulos muertos que un parking en U, [nombre] Sin debate útil, fracasado.',
      ...
      '[nombre], el high de fea te queda de casa y de apodo Menudo desastre, gilipollas.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón. Del ranking Se te ve el forro, patético.',
      '[nombre], si te describen es por contraste con lo normal Hostia qué nivel, asco.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre] Sin debate útil, basura.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el retrato robado se borra por piedad, [nombre] El grupo ya lo huele, fracasado.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano Sin anestesia posible, joder.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual Puro circo barato, mierda.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar Menudo desastre, coño.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón. Documentado Se te ve el forro, cabrón.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar Hostia qué nivel, gilipollas.',
      'Tienes una presencia que baja el promedio del group photo, [nombre] Sin debate útil, patético.',
      ...
      '[nombre], el techo de tu cara es el suelo de casi cualquiera Sin anestesia posible, ridículo.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda. Rara Puro circo barato, fracasado.',
      '[nombre], la fealdad te queda tan natural que parece look Menudo desastre, joder.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre] Se te ve el forro, mierda.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado Hostia qué nivel, coño.',
      'El modo retrato te trata como amenaza, [nombre]. Patético. Software Sin debate útil, cabrón.',
      '[nombre], si te miran mucho es porque no creen lo que ven Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre] El grupo ya lo huele, patético.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\' Sin anestesia posible, asco.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad Puro circo barato, basura.',
      '[nombre], el high de fea no es insulto, es inventario Menudo desastre, ridículo.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón. Plano Se te ve el forro, fracasado.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico Hostia qué nivel, joder.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre] Sin debate útil, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta Y no hay forma de maquillarlo, coño.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral El grupo ya lo huele, cabrón.',
      '[nombre], el atractivo te bloqueó en todas las redes Sin anestesia posible, gilipollas.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda. Viral Puro circo barato, patético.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad Menudo desastre, asco.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón. Firme Se te ve el forro, basura.',
      '[nombre], tienes cara de final de temporada cancelada Hostia qué nivel, ridículo.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre] Sin debate útil, fracasado.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve Y no hay forma de maquillarlo, joder.',
      'Fea de las que el group chat prefiere stickers, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo Sin anestesia posible, coño.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda. Legal Puro circo barato, cabrón.',
      '[nombre], el high te mide y el chat no discute el número Menudo desastre, gilipollas.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón. Seco Se te ve el forro, patético.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos Hostia qué nivel, asco.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre] Sin debate útil, basura.',
      ...
      '[nombre], tu cara es un almost eterno que nunca llega a decente Sin anestesia posible, joder.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. Con voz, [nombre] Puro circo barato, mierda.',
      '[nombre], el ranking de fea te tiene de inquilino fijo Menudo desastre, coño.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre] Se te ve el forro, cabrón.',
      '[nombre], tienes más fallos faciales que un examen a última hora Hostia qué nivel, gilipollas.',
      'El close-up es una denuncia anónima contra tu genética, [nombre] Sin debate útil, patético.',
      '[nombre], si el atractivo fuera crédito, tu score sería basura Y no hay forma de maquillarlo, asco.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre] El grupo ya lo huele, basura.',
      '[nombre], te ves como un borrador que nadie quiso terminar Sin anestesia posible, ridículo.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre] Puro circo barato, fracasado.',
      '[nombre], el high de fea te queda de tatuaje invisible Menudo desastre, joder.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre] Se te ve el forro, mierda.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué Hostia qué nivel, coño.',
      ' Sin debate útil, cabrón.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre] El grupo ya lo huele, patético.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta Sin anestesia posible, asco.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre] Puro circo barato, basura.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre Menudo desastre, ridículo.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas. Documentado Se te ve el forro, fracasado.',
      '[nombre], tienes una geometría facial que ofende a Euclides Hostia qué nivel, joder.',
      ...
      '[nombre], el high no es bullying: es el espejo con números Sin anestesia posible, gilipollas.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre] Puro circo barato, patético.',
      '[nombre], se te nota la falta de suerte genética en cada pixel Menudo desastre, asco.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre] Se te ve el forro, basura.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes Hostia qué nivel, ridículo.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre] Sin debate útil, fracasado.',
      '[nombre], si te miran de reojo es para no comprometerse Y no hay forma de maquillarlo, joder.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail Sin anestesia posible, coño.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre] Puro circo barato, cabrón.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano Menudo desastre, gilipollas.',
      'Fea de veredicto público y sin narrador emocional, [nombre] Se te ve el forro, patético.',
      '[nombre], tienes más asimetría que un debate en este puto chat Hostia qué nivel, asco.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco. De altura Sin debate útil, basura.',
      '[nombre], si el atractivo fuera examen, irías a septiembre Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre] El grupo ya lo huele, fracasado.',
      '[nombre], tu cara es un almost de humano decente Sin anestesia posible, joder.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre] Puro circo barato, mierda.',
      '[nombre], no hay redención en un ángulo ni en un tutorial Menudo desastre, coño.',
      'Fea de manual: el bot firma y el chat archiva, [nombre] Se te ve el forro, cabrón.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana Hostia qué nivel, gilipollas.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre] Sin debate útil, patético.',
      '[nombre], si te hacen un cumplido es por pena o por agenda Y no hay forma de maquillarlo, asco.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre] El grupo ya lo huele, basura.',
      '[nombre], el sótano visual te queda de residencia fiscal Sin anestesia posible, ridículo.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre] Puro circo barato, fracasado.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible Menudo desastre, joder.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas. Del ranking Se te ve el forro, mierda.',
      '[nombre], tienes cara de final boss de la mala suerte genética Hostia qué nivel, coño.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre] Sin debate útil, cabrón.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre] El grupo ya lo huele, patético.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno Sin anestesia posible, asco.',
      'Tu frame es el gag del día y el grupo no pide replay, [nombre] Puro circo barato, basura.',
      '[nombre], el high te mide con regla y te deja en negativo Menudo desastre, ridículo.',
      ...
      'La luz del flash te trata como evidencia del crimen, [nombre] Sin debate útil, mierda.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada Y no hay forma de maquillarlo, coño.',
      'Fea de las que el selfie stick se acorta solo, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], el material de base no admite segunda oportunidad, puta Sin anestesia posible, gilipollas.',
      'Tu cara es un informe sin anexos de caridad, [nombre] Puro circo barato, patético.',
      '[nombre], se te ve el sótano desde la notificación Menudo desastre, asco.',
      'Fea de veredicto que el chat confirma en silencio, [nombre] Se te ve el forro, basura.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano Hostia qué nivel, ridículo.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre] Sin debate útil, fracasado.',
      '[nombre], si el atractivo fuera crédito, estarías en mora Y no hay forma de maquillarlo, joder.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], no hay ángulo: hay rendición documentada Sin anestesia posible, coño.',
      'Tu simetría perdió el norte y el sur, [nombre] Puro circo barato, cabrón.',
      '[nombre], el high de fea te queda de apodo no oficial Menudo desastre, gilipollas.',
      'Fea sin plot twist de redención en tres mensajes, [nombre] Se te ve el forro, patético.',
      '[nombre], tienes cara de borrador olvidado en la papelera Hostia qué nivel, asco.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre] Sin debate útil, basura.',
      '[nombre], si te miran fijo es porque no procesan el input Y no hay forma de maquillarlo, ridículo.',
      'Fea de las que el group chat prefiere audio a foto, [nombre] El grupo ya lo huele, fracasado.',
      '[nombre], el bot te midió dos veces y las dos dio sótano Sin anestesia posible, joder.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre] Puro circo barato, mierda.',
      '[nombre], el atractivo te dio de baja sin carta de despido Menudo desastre, coño.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas. Del comando Se te ve el forro, cabrón.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado Hostia qué nivel, gilipollas.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre] Sin debate útil, patético.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2 Y no hay forma de maquillarlo, asco.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre] El grupo ya lo huele, basura.',
      '[nombre], te ves como un almost que se quedó en almost, puta Sin anestesia posible, ridículo.',
      'El close-up es una denuncia con firma digital, [nombre] Puro circo barato, fracasado.',
      '[nombre], se te ve el techo y está por los suelos Menudo desastre, joder.',
      'Fea de tramo que no admite narrador emocional, [nombre] Se te ve el forro, mierda.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza Hostia qué nivel, coño.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco. Firmado Sin debate útil, cabrón.',
      '[nombre], si te hacen un retrato es por relleno de álbum Y no hay forma de maquillarlo, gilipollas.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre] El grupo ya lo huele, patético.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel Sin anestesia posible, asco.',
      'Tu cara es el gag visual y nadie pide bis, [nombre] Puro circo barato, basura.',
      '[nombre], el high te deja en el sótano sin ascensor Menudo desastre, ridículo.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre] Se te ve el forro, fracasado.',
      '[nombre], tienes una geometría que ofende al compás Hostia qué nivel, joder.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre] Sin debate útil, mierda.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto Y no hay forma de maquillarlo, coño.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], el atractivo te vio y cambió de acera digital Sin anestesia posible, gilipollas.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre] Puro circo barato, patético.',
      '[nombre], no hay segundo chance: el primero ya fue bastante Menudo desastre, asco.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre] Se te ve el forro, basura.',
      '[nombre], tienes el glow up invertido certificado por el ranking Hostia qué nivel, ridículo.',
      'La luz natural te delata igual que un interrogatorio, [nombre] Sin debate útil, fracasado.',
      '[nombre], si te describen en una palabra, esa palabra insulta Y no hay forma de maquillarlo, joder.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta Sin anestesia posible, coño.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre] Puro circo barato, cabrón.',
      '[nombre], el high de fea no es opinión: es el puto número Menudo desastre, gilipollas.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre] Se te ve el forro, patético.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre] Hostia qué nivel, asco.',
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón convertido en wallpaper del fail colectivo Sin anestesia posible, asco.',
      ...
      'Maricón con el mismo gag de siempre y cero variación Hostia qué nivel, joder.',
      ...
      'Maricón hasta para el modo oscuro: ni la sombra tapa el montaje, [nombre] Menudo desastre, asco.',
      ...
      'Maricón sin capa de carisma que disimule el agujero Sin anestesia posible, coño.',
      ...
      'No es estilo: es pose previsible y el high te la nombra entero, [nombre] Puro circo barato, basura.',
      'El high no es un mal día de pose: es Menudo desastre, ridículo.',
      ...
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Sin debate útil, mierda.',
      ...
      'Has hecho ranking de pose cutre. Y el oro es tuyo sin rival serio, [nombre] Hostia qué nivel, coño.',
  ...
  simp: {
    ...
    high: [
      ...
      'Simp convertido en wallpaper del fail colectivo, joder Sin anestesia posible, asco.',
      'Has convertido la sumisión en identidad y no hay detergente que la limpie, [nombre] Puro circo barato, basura.',
      'Simp en modo sin filtro y el filtro pedía clemencia, joder Menudo desastre, ridículo.',
      'El listón de la dignidad lo usas de felpudo para que otros pasen, joder, [nombre] El ranking firma y listo, nivel sótano puro.',
      'Simp con el mismo gag de siempre y cero variación, joder Hostia qué nivel, joder.',
      ...
      'No es generosidad: es falta de criterio con pedestal incluido, [nombre] Puro circo barato, mierda.',
      ...
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre] Puro circo barato, basura.',
      ...
      'Has firmado el simp con polvo en cada mensaje como única firma, [nombre] Menudo desastre, asco.',
      ...
      'Simp de malinterpretar el mute como respeto al pedestal, [nombre] Menudo desastre, coño.',
      ...
      'Simp de las que el filtro de dignidad se rinde y pide la baja, [nombre] Puro circo barato, basura.',
      ...
      'El high no es un mal día de carácter: es Sin debate útil, mierda.',
  ...
  rata: {
    ...
    high: [
      ...
      'Rata con las mismas cartas manchadas de siempre y sin plan B, joder Sin debate útil, basura.',
      ...
      'Se te ve venir la tajada en la primera palabra del mensaje, [nombre] Menudo desastre, asco.',
      ...
      'Has hecho ranking de ratez y el oro es tuyo sin rival serio, [nombre] Sin anestesia posible, joder.',
      'Rata de feria ambulante: el mismo show, el mismo asco, cero nostalgia, [nombre] Puro circo barato, mierda.',
      'Se te ve venir la tajada en el primer punto del mensaje, [nombre] Menudo desastre, coño.',
      ...
      'Has dejado el hilo como obra sin plano: escombro de ratez, [nombre] Puro circo barato, fracasado.',
      'Rata de estribillo que empeora con cada bis del mismo plato, [nombre] Menudo desastre, joder.',
      ...
      'Has convertido la rata en carnet y no hay renovación limpia, [nombre] Sin anestesia posible, asco.',
      ...
      'El high no es un mal día de ética: es Puro circo barato, patético.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki de letrero de sótano: se lee y no invita a bajar, [nombre] Puro circo barato, fracasado.',
      ...
      'Friki con el bucle eterno del mismo error en bucle, joder Hostia qué nivel, gilipollas.',
      ...
      'Friki sin ni siquiera el barniz barato que salva a otros desastres, joder Hostia qué nivel, joder.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'La dignidad no para el coche: tú eres el tráfico que deja el arcén peor Hostia qué nivel, asco.',
      ...
      'Se te nota la prisa por ensuciar y cero plan de limpiar lo dejado, [nombre] Menudo desastre, coño.',
      ...
      'Cerdo de estribillo que mancha más con cada bis del mismo plato, [nombre] Menudo desastre, joder.',
      ...
      'Has dejado. El chat como fregadero a medias: restos eternos, [nombre] Puro circo barato, patético.',
      'Cerdo de estribillo sin punto final limpio ni redención, [nombre] Menudo desastre, asco.',
      ...
      'Cerdo de racha perfecta: lo único que no fallas es manchar, [nombre] Puro circo barato, mierda.',
      'No hay eco de estilo: hay eco de cerdo. Y el chat lo amplifica, [nombre] Menudo desastre, coño.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre] Sin anestesia posible, ridículo.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre] Puro circo barato, fracasado.',
      'No hay barniz de antihéroe: hay cerdo y el high lo cobra, [nombre] Menudo desastre, joder.',
      ...
      'El high no es un mal día de orden: es El grupo ya lo huele, mierda.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre] Sin anestesia posible, coño.',
      'Cerdo de repertorio: siempre la misma mancha y cero plan B, [nombre] Puro circo barato, cabrón.',
      'Se te nota el desastre hasta en la miniatura del estado, [nombre] Menudo desastre, gilipollas.',
      ...
      'Cerdo de superficie suficiente: no hace falta abrir el cubo, huele igual Menudo desastre, joder.',
      ...
      'La palabra clase te suena a reproche y respondes ensuciando un poco más Sin debate útil, cabrón.',
      ...
      'Has convertido la grasa en carnet y no hay renovación limpia a la vista Puro circo barato, basura.',
      'La higiene del hilo y tú firmasteis no verse: el acuerdo se cumple a rajatabla Menudo desastre, ridículo.',
      'Cerdo con las mismas cartas manchadas de siempre y sin plan B Se te ve el forro, fracasado.',
      'Has convertido la mancha en identidad y no hay detergente narrativo a la vista Hostia qué nivel, joder.',
      'Cerdo de letrero grasiento: se lee igual de lejos y no invita a entrar Sin debate útil, mierda.',
  ...
  femboy: {
    ...
    high: [
      ...
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre] Puro circo barato, basura.',
      ...
      'Femboy de letrero grasiento: se lee de lejos y no invita a entrar, [nombre] Menudo desastre, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre] Menudo desastre, joder.',
  ...
  inutil: {
    ...
    high: [
      ...
      'El asco. Del tramo high es este: presencia sin función, [nombre] Menudo desastre, joder.',
      ...
      'El listón de lo útil está lejos y no has dado un paso, [nombre] Puro circo barato, fracasado.',
      ...
      'El listón de lo útil está enterrado y tú bailas encima en el chat, [nombre] Menudo desastre, coño.',
      ...
      'Tienes más huecos que un delantal de aporte al cierre del ranking, [nombre] Menudo desastre, joder.',
      ...
      'Inútil de fondo de ranking: bajas la media de sustancia del chat, [nombre] Hostia qué nivel, joder.',
      ...
      'El grupo paga tu repertorio vacío en tiempo del hilo del chat, [nombre] Menudo desastre, asco.',
      'Tu forma de responder a una crítica es no cambiar nada. Ni un detalle, nunca. Puta pared con orejas y sin nada detrás.',
      'No es estilo minimalista: es vacío previsible del tramo high, [nombre] Hostia qué nivel, ridículo.',
      'Inútil de ceja ajena levantada y respeto en cero del ranking, [nombre] Sin debate útil, fracasado.',
      'Inútil de letrero mojado: se lee y no invita a bajar al aporte, [nombre] Y no hay forma de maquillarlo, joder.',
      'Inútil de cartas en blanco en cada mano del hilo del grupo, [nombre] El grupo ya lo huele, mierda.',
      'Tienes el aura del icono que nadie toca en el chat del grupo, [nombre] Sin anestesia posible, coño.',
      'Has dejado el hilo como obra sin plano en el ranking del grupo, [nombre] Puro circo barato, cabrón.',
      'Nadie te ha visto sostener una tarea larga. Te caes en la primera semana, siempre. Puta resistencia de papel mojado.',
      'El aporte te saluda y tú no devuelves en el chat del grupo, [nombre] Se te ve el forro, patético.',
      'Inútil sin el barniz del secundario memorable del ranking, [nombre] Hostia qué nivel, asco.',
      'La clase de aportar te suena a ataque en el chat del grupo, [nombre] Sin debate útil, basura.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre] Puro circo barato, mierda.',
  ...
  perdedor: {
    ...
    high: [
      ...
      'Perdedor sin una carta nueva: siempre la misma mano sucia, joder Menudo desastre, ridículo.',
      ...
      'Tienes el historial de un equipo que no gana ni amistosos, [nombre] Sin anestesia posible, joder.',
      'Has convertido el almost eterno en marca personal del ranking, [nombre] Puro circo barato, mierda.',
      'Has hecho del bajo listón tu casa y no hay mudanza a la vista, [nombre] Menudo desastre, coño.',
  ...
  puta: {
    ...
    high: [
      ...
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio Sin debate útil, patético.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre] Y no hay forma de maquillarlo, asco.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin El grupo ya lo huele, basura.',
      ...
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre] Menudo desastre, joder.',
      ...
      '[nombre], tu sí vale menos que un like anónimo de madrugada Sin debate útil, cabrón.',
      ...
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre] Hostia qué nivel, ridículo.',
      ...
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años El grupo ya lo huele, mierda.',
      'Has convertido cada hilo en casting improvisado, [nombre] Sin anestesia posible, coño.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí Puro circo barato, cabrón.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre] Menudo desastre, gilipollas.',
      '[nombre], el ranking de puta te tiene de inquilina fija Se te ve el forro, patético.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre] Hostia qué nivel, asco.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza Sin debate útil, basura.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre] Y no hay forma de maquillarlo, ridículo.',
      '[nombre], puta de manual negro: el grupo firma y tú posas El grupo ya lo huele, fracasado.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre] Sin anestesia posible, joder.',
      '[nombre], has hecho del escaparate tu única personalidad Puro circo barato, mierda.',
      'Puta de las que confunden circulacion con deseo real, [nombre] Menudo desastre, coño.',
      '[nombre], te repartes como menú del día: predecible y frío Se te ve el forro, cabrón.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre] Hostia qué nivel, gilipollas.',
      '[nombre], puta de kilometraje visible y orgullo de cartón Sin debate útil, patético.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre] Y no hay forma de maquillarlo, asco.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno El grupo ya lo huele, basura.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre] Sin anestesia posible, ridículo.',
      '[nombre], has convertido el almost de intocable en chiste interno Puro circo barato, fracasado.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre] Menudo desastre, joder.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada Se te ve el forro, mierda.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre] Hostia qué nivel, coño.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios Sin debate útil, cabrón.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco. Documentado Y no hay forma de maquillarlo, gilipollas.',
      '[nombre], te repartes con la elegancia de un anuncio popup El grupo ya lo huele, patético.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre] Sin anestesia posible, asco.',
      '[nombre], puta de las que el sí vale menos que un sticker Puro circo barato, basura.',
      'Has hecho del chat tu puticlub sin cover, [nombre] Menudo desastre, ridículo.',
      '[nombre], el ranking te nombra y el resto asiente sin debate Se te ve el forro, fracasado.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre] Hostia qué nivel, joder.',
      '[nombre], te abres en canal por atención de segunda Sin debate útil, mierda.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre] Y no hay forma de maquillarlo, coño.',
      '[nombre], tienes más vueltas que el rumor del grupo El grupo ya lo huele, cabrón.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre] Sin anestesia posible, gilipollas.',
      '[nombre], te vendes en liquidación y el stock no baja Puro circo barato, patético.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre] Menudo desastre, asco.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso Se te ve el forro, basura.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre] Hostia qué nivel, ridículo.',
      '[nombre], has convertido cada mirada en ticket de entrada Sin debate útil, fracasado.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre] Y no hay forma de maquillarlo, joder.',
      '[nombre], el sí fácil te delata más que un historial público El grupo ya lo huele, mierda.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre] Sin anestesia posible, coño.',
      '[nombre], puta de kilometraje alto y narrativa baja Puro circo barato, cabrón.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre] Menudo desastre, gilipollas.',
      '[nombre], has hecho del escaparate tu único argumento Se te ve el forro, patético.',
      'Puta de las que confunden ruido con valor, [nombre] Hostia qué nivel, asco.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero Sin debate útil, basura.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre] Y no hay forma de maquillarlo, ridículo.',
      '[nombre], puta de manual negro delante del puto chat El grupo ya lo huele, fracasado.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre] Sin anestesia posible, joder.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\' Puro circo barato, mierda.',
      'Puta de fondo de ranking: inquilina fija del tramo, [nombre] Menudo desastre, coño.',
      '[nombre], has convertido el almost de misterio en chiste gastado Se te ve el forro, cabrón.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre] Hostia qué nivel, gilipollas.',
      '[nombre], puta de las que el chat archiva sin pedir bis Sin debate útil, patético.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre] Y no hay forma de maquillarlo, asco.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano El grupo ya lo huele, basura.',
      'Puta sin plot twist: solo el mismo libreto, [nombre] Sin anestesia posible, ridículo.',
      '[nombre], te abres en canal por migajas de atención Puro circo barato, fracasado.',
      'El puterío te queda de uniforme de diario, [nombre] Menudo desastre, joder.',
      '[nombre], has hecho del sí tu única estrategia social Se te ve el forro, mierda.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre] Hostia qué nivel, coño.',
      '[nombre], te vendes en oferta y el precio sigue cayendo Sin debate útil, cabrón.',
      'Se te nota el hambre de validación a la legua, [nombre] Y no hay forma de maquillarlo, gilipollas.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre] El grupo ya lo huele, patético.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros Sin anestesia posible, asco.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre] Puro circo barato, basura.',
      '[nombre], te repartes como anuncio que nadie puede cerrar Menudo desastre, ridículo.',
      'El sí fácil te quedó de cicatriz pública, [nombre] Se te ve el forro, fracasado.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos Hostia qué nivel, joder.',
      'Puta de las que confunden circulación con deseo, [nombre] Sin debate útil, mierda.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado Y no hay forma de maquillarlo, coño.',
      'El listón del respeto está en el sótano con tu nombre, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], puta de fondo: siempre el mismo gag Sin anestesia posible, gilipollas.',
      'Te vendes barato y el stock no se agota nunca, [nombre] Puro circo barato, patético.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio Menudo desastre, asco.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre] Se te ve el forro, basura.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste Hostia qué nivel, ridículo.',
      'Has hecho del almost de intocable tu mayor fail, [nombre] Sin debate útil, fracasado.',
      '[nombre], puta de las que el putero amateur pediría recibo Y no hay forma de maquillarlo, joder.',
      'Te repartes con la elegancia de un popup de virus, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti Sin anestesia posible, coño.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre] Puro circo barato, cabrón.',
      '[nombre], el grupo ya no se sorprende: solo documenta Menudo desastre, gilipollas.',
      'Te abres en canal por ruido de segunda división, [nombre] Se te ve el forro, patético.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo Hostia qué nivel, asco.',
      'El sí fácil te delata más que cualquier captura, [nombre] Sin debate útil, basura.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre] Y no hay forma de maquillarlo, ridículo.',
      '[nombre], te vendes en liquidación permanente El grupo ya lo huele, fracasado.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre] Sin anestesia posible, joder.',
      '[nombre], puta de fondo de hilo y de ranking Puro circo barato, mierda.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre] Menudo desastre, coño.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí Se te ve el forro, cabrón.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre] Hostia qué nivel, gilipollas.',
      '[nombre], te repartes como menú del día en bar de carretera Sin debate útil, patético.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre] Y no hay forma de maquillarlo, asco.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja El grupo ya lo huele, basura.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre] Sin anestesia posible, ridículo.',
      '[nombre], te abres más fácil que la privacidad en cero Puro circo barato, fracasado.',
      'El puterío te quedó de marca y no de accidente, [nombre] Menudo desastre, joder.',
      '[nombre], puta de kilometraje que ya no admite garantía Se te ve el forro, mierda.',
      'Te vendes barato y luego quieres trato de boutique, [nombre] Hostia qué nivel, coño.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo Sin debate útil, cabrón.',
      ...
      '[nombre], puta de fondo: el eco te devuelve el mismo asco Sin anestesia posible, asco.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre] Puro circo barato, basura.',
      '[nombre], el almost de misterio se te escapó en el primer sí Menudo desastre, ridículo.',
      'Puta de las que confunden atención con respeto y caen, [nombre] Se te ve el forro, fracasado.',
      '[nombre], te abres en canal por migajas y aún así das las gracias Hostia qué nivel, joder.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre] Sin debate útil, mierda.',
      '[nombre], puta de ranking fijo en el sótano del respeto Y no hay forma de maquillarlo, coño.',
      'Te vendes en oferta y el precio solo baja, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], se te nota el hambre de validación en cada puto sticker Sin anestesia posible, gilipollas.',
      'Puta sin plot de redención en tres actos, [nombre] Puro circo barato, patético.',
      '[nombre], has hecho del escaparate tu personalidad completa Menudo desastre, asco.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre] Se te ve el forro, basura.',
      '[nombre], puta de las que el silencio es el único que te pone límite Hostia qué nivel, ridículo.',
      'Te repartes como flyer de after de mala muerte, [nombre] Sin debate útil, fracasado.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión Y no hay forma de maquillarlo, joder.',
      'Puta de manual negro delante de todo el grupo, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], te abres más que un debate vacío y con menos contenido Sin anestesia posible, coño.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre] Puro circo barato, cabrón.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo Menudo desastre, gilipollas.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre] Se te ve el forro, patético.',
      '[nombre], te vendes barato y el stock parece infinito Hostia qué nivel, asco.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre] Sin debate útil, basura.',
      '[nombre], puta de fondo de chat: el gag eres tú Y no hay forma de maquillarlo, ridículo.',
      'El listón del respeto está enterrado con tu historial, [nombre] El grupo ya lo huele, fracasado.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre] Sin anestesia posible, joder.',
      '[nombre], has hecho del sí tu política exterior completa Puro circo barato, mierda.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre] Menudo desastre, coño.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0 Se te ve el forro, cabrón.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre] Hostia qué nivel, gilipollas.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo Sin debate útil, patético.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre] Y no hay forma de maquillarlo, asco.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía El grupo ya lo huele, basura.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre] Sin anestesia posible, ridículo.',
      '[nombre], puta de las que el almost de intocable es el gag del año Puro circo barato, fracasado.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre] Menudo desastre, joder.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre] Se te ve el forro, mierda.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m Hostia qué nivel, coño.',
      'El sí fácil te quedó de firma digital en el chat, [nombre] Sin debate útil, cabrón.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones Y no hay forma de maquillarlo, gilipollas.',
      'Te abres más fácil que la configuración por defecto, [nombre] El grupo ya lo huele, patético.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano Sin anestesia posible, asco.',
      'Puta de fondo: siempre el mismo libreto, [nombre] Puro circo barato, basura.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas Menudo desastre, ridículo.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre] Se te ve el forro, fracasado.',
      '[nombre], has hecho del escaparate tu único talento documentado Hostia qué nivel, joder.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre] Sin debate útil, mierda.',
      '[nombre], si el puterío cotizara, serías warning del bróker Y no hay forma de maquillarlo, coño.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre] El grupo ya lo huele, cabrón.',
      '[nombre], puta de manual negro: el grupo firma, tú posas Sin anestesia posible, gilipollas.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre] Puro circo barato, patético.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial Menudo desastre, asco.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre] Se te ve el forro, basura.',
      '[nombre], te abres en canal por migajas y aún pides propina Hostia qué nivel, ridículo.',
      'El puterío te quedó de uniforme de diario del chat, [nombre] Sin debate útil, fracasado.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo Y no hay forma de maquillarlo, joder.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre] El grupo ya lo huele, mierda.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo Sin anestesia posible, coño.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre] Puro circo barato, cabrón.',
      '[nombre], puta de fondo de hilo, de ranking y de meme Menudo desastre, gilipollas.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre] Se te ve el forro, patético.',
      '[nombre], el bot te midió y el grupo ya había firmado el parte Hostia qué nivel, asco.',
    ],
    mid: [
  ...
  guarra: {
    ...
    high: [
      ...
      'No hay eco de estilo: hay eco de basura. Y. El chat lo amplifica Sin debate útil, cabrón.',
      ...
      'Guarra de fondo que baja la media sin pedir turno en el ranking, [nombre] Sin debate útil, mierda.',
      ...
      'Se te nota el oficio de tanto bajar el listón hasta el sótano del chat Menudo desastre, asco.',
      'El asco. Es Se te ve el forro, basura.',
      'El listón está enterrado y tú has hecho de la fosa tu pista de baile Hostia qué nivel, ridículo.',
      'No hay redención estética: hay basura. Con eco y el eco llena. El chat Sin debate útil, fracasado.',
      'El asco. No es pruderie: es el termómetro y te marca fiebre de cutrez crónica Y no hay forma de maquillarlo, joder.',
      'La vergüenza ajena es tu sombra y la sombra no te abandona nunca El grupo ya lo huele, mierda.',
      'El termómetro del asco. Te marca crónico: no es un pico, es el nivel. Patético. El chat ya lo archivó.',
      'Se te nota el peso de arrastrar el listón por el suelo cada día Puro circo barato, cabrón.',
      'Guarra de fondo de pantalla de motel barato: se ve, se nota y no mejora con el tiempo, [nombre]. Gilipollas.',
      'No hay redención en el tono: hay basura. Con eco y el eco no para Se te ve el forro, patético.',
      ...
      'Guarra con las mismas cartas manchadas de siempre y sin plan B Puro circo barato, cabrón.',
      ...
      'Guarra convertido en wallpaper del fail colectivo. Gilipollas, joder Sin anestesia posible, asco.',
      'Has convertido la suciedad en identidad y no hay detergente narrativo a la vista, [nombre]. Patético.',
      'Guarra en modo sin filtro y el filtro pedía clemencia, joder Menudo desastre, ridículo.',
      ...
      'Guarra con el mismo gag de siempre y cero variación, joder Hostia qué nivel, joder.',
      ...
      'Guarra visible desde lejos: el rastro se ve, la parada no compensa, [nombre] Menudo desastre, asco.',
      ...
      'El promedio del high es este: no un mal día, el nivel del tramo, [nombre] Menudo desastre, joder.',
      ...
      'El high no es un mal día de orden: es Hostia qué nivel, joder.',
      ...
      'Tienes el aura de un cenicero de bar dudoso al cierre: lleno y sin vaciar Menudo desastre, joder.',
