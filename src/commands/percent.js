...
const LABELS = {
  ...
  incel: {
    ...
    high: [
      ...
      'Tienes más diagnósticos ajenos que visitas al espejo en tu puta vida, [nombre]. El high no suaviza una mierda,.',
      ...
      'Incel cutre: ni el odio tiene gracia ni la amargura tiene misterio, [nombre]. El high no suaviza una mierda,.',
      ...
      'Incel de ranking: bajas la media del tramo con monólogos de culpa ajena, [nombre]. El high no suaviza una mierda,.',
      ...
      'Incel cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el high de incel, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te nota que te encerraste en el hilo hace tiempo y perdiste la llave, [nombre]. El high no suaviza una mierda,.',
      ...
      'Incel de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más episodios de desconexión que intentos de subir el listón social, [nombre]. El high no suaviza una mierda,.',
      ...
      'Incel con la disciplina de quien nunca ha aceptado el espejo, [nombre]. El high no suaviza una mierda,.',
  ...
  linda: {
    ...
    low: [
      ...
      'Tienes una belleza tan discutible que el comando ni se molesta en fingir, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Linda cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Linda de ranking: bajas la media visual del tramo con constancia, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Linda cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el low del comando, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No hay filtro que te salve: hay fealdad de base y el comando la cobra, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No es luz mala: eres tú, y el low no discute con la evidencia, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No hay redención en este low: hay veredicto y te nombra. sin filtro, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Linda de las que el natural es abandono y el abandono se nota a la legua, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Has convertido el almost visual en residencia fiscal del low, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Linda de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Se te nota el almost hasta en la foto más trabajada del perfil, [nombre]. El veredicto no suaviza una mierda,.',
  ...
  fea: {
    ...
    high: [
      ...
      'Tienes una cara que hace que el modo retrato pida perdón por existir, [nombre]. El high no suaviza una mierda,.',
      ...
      'Fea de historial público: no hace falta zoom, se lee en la superficie del chat, [nombre]. El high no suaviza una mierda,.',
      ...
      'Fea de inercia: el grupo te soporta por costumbre, no por el frame, [nombre]. El high no suaviza una mierda,.',
      ...
      'El promedio de este tramo es el tuyo: no un pico, el suelo del high, [nombre]. El high no suaviza una mierda,.',
      ...
      'Fea de estribillo sin punto final limpio ni redención posible en. el ranking, [nombre]. El high no suaviza una mierda,.',
      ...
      'Has firmado el desastre facial con grasa en cada selfie como única firma, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te ve venir el almost visual en el primer punto del mensaje del hilo, [nombre]. El high no suaviza una mierda,.',
      ...
      'No hay filtro que te salve: hay fealdad de base y el comando la cobra cara, [nombre]. El high no suaviza una mierda,.',
      ...
      'No es luz mala: eres tú, y el high no discute con la evidencia, [nombre]. El high no suaviza una mierda,.',
  ...
  sexy: {
    ...
    low: [
      ...
      'Tienes un almost de atracción que. el ranking grita. sin filtro, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Sexy cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Sexy de ranking: bajas la media del tramo con constancia de almost, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Sexy cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto no suaviza una mierda, coño.',
      ...
      'Sexy de las que confunden pose con deseo y pierden las dos, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El veredicto no suaviza una mierda, joder.',
      'Sexy de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Tu frame es contenido de ridículo gratis para el grupo, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Sexy de las que el grupo archiva el fail sin pedir bis, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Se te cae el frame sexy solo con cargar la cámara frontal, [nombre]. El veredicto no suaviza una mierda,.',
  ...
  crack: {
    ...
    low: [
      ...
      'Tienes más almost de genio que resultados y. el ranking lo grita, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Crack cutre: ni el fallo tiene gracia ni la racha tiene misterio, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Crack de ranking: bajas la media del tramo con constancia de caer, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Crack cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto no suaviza una mierda, coño.',
      ...
      'Crack de las que confunden intención con resultado y pierden las dos, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Has convertido el almost de crack en residencia fiscal del low, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El veredicto no suaviza una mierda, joder.',
      'Crack de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'El low te ha puesto en tu sitio sin necesidad de narrador, [nombre]. El veredicto no suaviza una mierda, joder.',
      'Crack de puta madre en el sentido del desastre del tramo bajo, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Tu racha es contenido de ridículo gratis para el grupo, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Crack de las que el grupo archiva el fail sin pedir bis, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'El low es tu tramo y. el ranking no ofrece mudanza, [nombre]. El veredicto no suaviza una mierda, pringado.',
      'Se te cae el frame de crack solo con cargar el resultado, [nombre]. El veredicto no suaviza una mierda,.',
  ...
  feminidad: {
    ...
    low: [
      ...
      'Tienes más pretensión de mujer que sustancia y el low lo grita, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad de ranking: bajas la media del tramo con constancia de almost, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El low no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el low del comando, [nombre]. El low no suaviza una mierda,.',
      ...
      'No hay redención en este low: hay veredicto y te nombra. sin filtro, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad de las que confunden pose con presencia y pierden las dos, [nombre]. El low no suaviza una mierda,.',
      ...
      'Has convertido el almost de mujer en residencia fiscal del low, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El low no suaviza una mierda,.',
      ...
      'Tu frame es contenido de ridículo gratis para el grupo, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad de las que el grupo archiva el fail sin pedir bis, [nombre]. El low no suaviza una mierda,.',
      ...
      'Se te cae el frame de mujer solo con cargar la cámara frontal, [nombre]. El low no suaviza una mierda,.',
      ...
      'Feminidad de desastre de presencia: el low no es caridad, es sentencia, [nombre]. El low no suaviza una mierda,.',
  ...
  masculinidad: {
    ...
    low: [
      ...
      'Tienes más pretensión de macho que sustancia y el low lo grita, [nombre]. El low no suaviza una mierda,.',
      ...
      'Masculinidad cutre: ni el caos tiene estilo ni el desastre tiene misterio, [nombre]. El low no suaviza una mierda,.',
      ...
      'Masculinidad de ranking: bajas la media del tramo con constancia de almost, [nombre]. El low no suaviza una mierda,.',
      ...
      'El promedio de este tramo es el tuyo: el suelo del low, [nombre]. El low no suaviza una mierda, pringado.',
      'Has convertido la falta de chispa en identidad y no hay detergente, [nombre]. El low no suaviza una mierda, joder.',
      'Masculinidad cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El low no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El low no suaviza una mierda, coño.',
      ...
      'Masculinidad de las que confunden pose con presencia y pierden las dos, [nombre]. El low no suaviza una mierda,.',
      'Tu almost es un aviso de lo que no hay que perseguir en el grupo, [nombre]. El low no suaviza una mierda, coño.',
      ...
      'Has convertido el almost de hombre en residencia fiscal del low, [nombre]. El low no suaviza una mierda,.',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El low no suaviza una mierda, joder.',
      'Masculinidad de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El low no suaviza una mierda,.',
      'Tu frame es el argumento más corto del comando y el más claro, [nombre]. El low no suaviza una mierda, coño.',
      ...
      'No hay redención en este low: hay cara, hay número y hay veredicto, [nombre]. El low no suaviza una mierda, joder.',
      'Masculinidad de las que el grupo archiva el fail sin pedir bis, [nombre]. El low no suaviza una mierda,.',
      'Se te ve venir el fail en la primera palabra del estado, [nombre]. El low no suaviza una mierda, coño.',
      ...
      'El low es tu tramo y. el ranking no ofrece mudanza, [nombre]. El low no suaviza una mierda, pringado.',
      'Se te cae el frame de hombre solo con cargar la cámara frontal, [nombre]. El low no suaviza una mierda,.',
      ...
      'Masculinidad de desastre de presencia: el low no es caridad, es sentencia, [nombre]. El low no suaviza una mierda,.',
      'El ranking de presencia y el low coinciden: sótano, sin recurso, [nombre]. El low no suaviza una mierda, gilipollas.',
      ...
      'Tu frame es un aviso de lo que no hay que reproducir en. el chat, [nombre]. El low no suaviza una mierda,.',
    ],
    extreme: [
  ...
  gay: {
    ...
    high: [
      ...
      'Maricón cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. El veredicto no suaviza una mierda,.',
      'Tienes el historial de un fregadero que nadie ha tocado desde el domingo, [nombre]. El veredicto no suaviza una mierda, asco.',
      ...
      'Maricón de ranking: bajas la media del tramo con constancia molesta, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Maricón con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón de verdad, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Tienes más pose de armario roto que de personaje con peso real, [nombre]. El veredicto no suaviza una mierda,.',
  ...
  simp: {
    ...
    high: [
      ...
      'Tienes más mensajes de validación que dignidad en el puto ranking del grupo, [nombre]. El high no suaviza una mierda,.',
      ...
      'Simp cutre: ni la entrega tiene gracia ni la falta de dignidad tiene misterio, [nombre]. El high no suaviza una mierda,.',
      ...
      'Simp de ranking: bajas la media del tramo con monólogos de validación ajena, [nombre]. El high no suaviza una mierda,.',
      ...
      'Simp cutre y sin complejo útil: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los intentos de normal, [nombre]. El high no suaviza una mierda, coño.',
      ...
      'La compostura cruza de acera cuando te ve en el high de simp, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te nota que te arrodillaste en el hilo hace tiempo y perdiste la llave, [nombre]. El high no suaviza una mierda,.',
      ...
      'Simp de superficie: basta la vista, no hace falta el sótano del historial, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más episodios de pedestal que intentos de subir el listón propio, [nombre]. El high no suaviza una mierda,.',
      ...
      'Simp con la disciplina de quien nunca ha dicho no cuando tocaba, [nombre]. El high no suaviza una mierda,.',
  ...
  rata: {
    ...
    high: [
      ...
      'Rata cutre: el aprovechamiento sin inteligencia es solo miseria con patas, [nombre]. El high no suaviza una mierda,.',
      ...
      'Rata de ranking: bajas la media del grupo con constancia molesta, [nombre]. El high no suaviza una mierda,.',
      ...
      'Rata cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en. el ranking del high, [nombre]. El high no suaviza una mierda,.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. El high no suaviza una mierda, joder.',
      'Rata de superficie: basta la vista, no hace falta el sótano, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura del tramo no te reconoce en el elenco del ranking, [nombre]. El high no suaviza una mierda, fracasado.',
      'Tienes más manchas de interés ajeno que intentos de pasar un trapo, [nombre]. El high no suaviza una mierda,.',
      ...
      'Rata con la disciplina de quien nunca ha devuelto una puta favor, [nombre]. El high no suaviza una mierda,.',
  ...
  friki: {
    ...
    high: [
      ...
      'Friki cutre: ni la rareza tiene gracia ni el aislamiento tiene misterio de genio, [nombre]. El high no suaviza una mierda,.',
      ...
      'Friki de ranking: bajas la media del tramo con monólogos que no piden respuesta, [nombre]. El high no suaviza una mierda,.',
      ...
      'Friki cutre y sin complejo: el complejo pediría espejo social y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más referencias inútiles que mensajes que alguien quiera retomar, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el high de friki, [nombre]. El high no suaviza una mierda,.',
  ...
  cerdo: {
    ...
    high: [
      ...
      'Cerdo cutre: ni el caos tiene estilo ni el abandono tiene misterio, [nombre]. El high no suaviza una mierda,.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. El high no suaviza una mierda, coño.',
      ...
      'Cerdo de ranking: bajas la media del tramo con constancia de mancha, [nombre]. El high no suaviza una mierda,.',
      ...
      'Cerdo cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el high, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el bayeta, [nombre]. El high no suaviza una mierda,.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. El high no suaviza una mierda, joder.',
      'Cerdo de superficie suficiente: basta la vista, no hace falta el sótano, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo, [nombre]. El high no suaviza una mierda,.',
      ...
      'Cerdo con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre]. El high no suaviza una mierda,.',
  ...
  femboy: {
    ...
    high: [
      ...
      'Tienes más pose de personaje que sustancia que. el chat respete de verdad, [nombre]. El high no suaviza una mierda,.',
      ...
      'Femboy cutre: ni el vicio tiene gracia ni la pose tiene mérito, [nombre]. El high no suaviza una mierda,.',
      ...
      'Femboy de ranking: bajas la media del tramo con constancia molesta, [nombre]. El high no suaviza una mierda,.',
      'Has hecho del bajo listón tu residencia y no hay mudanza a la vista, [nombre]. El high no suaviza una mierda, coño.',
      ...
      'Femboy cutre y sin complejo: el complejo indicaría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'La compostura cruza de acera cuando te ve en el high del comando, [nombre]. El high no suaviza una mierda,.',
  ...
  inutil: {
    ...
    high: [
      ...
      'Inútil cutre: ni el silencio tiene estilo ni la presencia tiene función, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te nota el peso de no empujar nunca el hilo hacia arriba, [nombre]. El high no suaviza una mierda,.',
      'Tienes el aura de un icono de app desinstalada: sigue en la pantalla y nadie la abre, [nombre]. fracasado.',
      'Inútil sin barniz: solo hueco con teclado en. el chat, [nombre]. El high no suaviza una mierda,.',
  ...
  perdedor: {
    ...
    high: [
      ...
      'Perdedor cutre: ni el fallo tiene gracia ni la racha tiene misterio de antihéroe, [nombre]. El high no suaviza una mierda,.',
      ...
      'El promedio del high es este: no un mal día, el nivel del tramo completo, [nombre]. El high no suaviza. el veredicto, coño.',
      'Tienes más derrotas documentadas que intentos serios de subir el listón, [nombre]. El high no suaviza una mierda,.',
      ...
      'Perdedor cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
  ...
  ganador: {
    ...
    low: [
      ...
      'Tienes más almost que victorias y. el ranking lo grita. sin filtro, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Ganador cutre: ni el fallo tiene gracia ni la racha tiene misterio, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Ganador de ranking: bajas la media del tramo con constancia de caer, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Ganador cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El veredicto no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los neutros, [nombre]. El veredicto no suaviza una mierda, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos del marcador, [nombre]. El veredicto no suaviza una mierda, cabrón.',
      ...
      'Ganador de las que confunden intención con resultado y pierden las dos, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'Has convertido el almost en residencia fiscal del low, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'No es un mal día: es el nivel y el low te lo cobra sin descuento, [nombre]. El veredicto no suaviza una mierda, joder.',
      'Ganador de las que necesitan suerte y aun así el resultado es mierda, [nombre]. El veredicto no suaviza una mierda,.',
      'Tu marcador es el argumento más corto del comando y el más claro, [nombre]. El veredicto no suaviza una mierda, coño.',
      ...
      'No hay redención en este low: hay marcador, hay número y hay veredicto, [nombre]. El veredicto no suaviza una mierda, joder.',
      'Ganador de las que el grupo archiva el fail sin pedir bis, [nombre]. El veredicto no suaviza una mierda,.',
      ...
      'El low es tu tramo y. el ranking no ofrece mudanza, [nombre]. El veredicto no suaviza una mierda, pringado.',
      'Se te cae el frame de ganador solo con cargar el resultado, [nombre]. El veredicto no suaviza una mierda,.',
  ...
  puta: {
    ...
    high: [
      ...
      'Tienes más nombres en la lista que razones para estar en el puto ranking, [nombre]. El high no suaviza una mierda,.',
      ...
      'Puta cutre: ni el vicio tiene gracia ni la pose tiene mérito de antihéroe, [nombre]. El high no suaviza una mierda,.',
      ...
      'El recato te queda lejos y la distancia es rechazo, no mística, [nombre]. El high no suaviza una mierda, joder.',
      'Puta de ranking: bajas la media del tramo con constancia molesta, [nombre]. El high no suaviza una mierda,.',
      ...
      'Puta cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      'Se te oye el masticar del listón bajo hasta en los neutros del chat, [nombre]. El high no suaviza una mierda, coño.',
      'La dignidad no te coge el teléfono: el buzón está lleno de avisos, [nombre]. El high no suaviza una mierda, cabrón.',
      ...
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. El high no suaviza una mierda, joder.',
      'Puta de superficie: basta la vista, no hace falta el sótano, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más episodios de personajito que intentos de subir el listón, [nombre]. El high no suaviza una mierda,.',
      ...
      'Puta con la disciplina de quien nunca ha cerrado el mismo número, [nombre]. El high no suaviza una mierda,.',
  ...
  guarra: {
    ...
    high: [
      ...
      'Tienes más grasa en el relato que un freidor de feria al cierre del domingo, [nombre]. El high no suaviza una mierda,.',
      ...
      'Guarra cutre: ni el caos tiene estilo ni el abandono tiene carisma de antihéroe, [nombre]. El high no suaviza una mierda,.',
      ...
      'Guarra de ranking: bajas la media del tramo con constancia de mancha, [nombre]. El high no suaviza una mierda,.',
      ...
      'Guarra cutre y sin complejo: el complejo pediría espejo y no lo hay, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te nota que ensuciaste el hilo hace tiempo y perdiste el mapa del bayeta, [nombre]. El high no suaviza una mierda,.',
      ...
      'Se te ve venir el teatro sucio en el primer punto del mensaje, [nombre]. El high no suaviza una mierda, pringado.',
      'La dignidad hace autostop y el tráfico del arcén eres tú, [nombre]. El high no suaviza una mierda, joder.',
      'Guarra de superficie: basta la vista, no hace falta el sótano, [nombre]. El high no suaviza una mierda,.',
      ...
      'Tienes más episodios de mancha que intentos de pasar un trapo de verdad, [nombre]. El high no suaviza una mierda,.',
      ...
      'Guarra con la disciplina de quien nunca ha pasado un trapo por el relato, [nombre]. El high no suaviza una mierda,.',
      'El high no es un mal día de orden: es. el veredicto y te nombra, [nombre]. El high no suaviza una mierda, coño.',
      'Tienes una presencia que ensucia el hilo en un solo mensaje, [nombre]. El high no suaviza una mierda, cabrón.',
