...
const LABELS = {
  ...
  fea: {
    ...
    high: [
      ...
      'Fea de las que el espejo pide indulto antes de reflejarte, [nombre]. Qué puta desgracia visual Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], no es que te falte ángulo: es que te faltan los tres y el cuarto también, cabrón. El material habla y no pide intérprete, coño.',
      'Tienes el atractivo de un martes lluvioso en una sala de espera, [nombre]. Pura mierda estética Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], si la belleza fuera wifi, tú estarías en modo avión permanente, gilipollas. Se te ve el fail desde la puta notificación, gilipollas.',
      'Fea medible: ni con luz de restaurante caro te salva el frame, [nombre]. Asco. con piernas El chat no necesita subtítulos para este gag, patético.',
      '[nombre], tu cara es el argumento perfecto contra los filtros gratis, patético. Con el espejo y el bot en contra a la vez, asco.',
      'Se te nota la fealdad hasta en la miniatura del estado, [nombre]. Ridículo de bulto Pura sentencia sin narrador emocional, basura.',
      '[nombre], el modo retrato de tu móvil debería venir con advertencia sanitaria, joder. Y el grupo se hace el ciego por educación, ridículo.',
      'Fea de las que hacen que el fotógrafo cobre extra por trauma, [nombre]. Mierda. pura Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], no hay misterio: hay huesos de mala suerte y piel que no perdona, coño. El material habla y no pide intérprete, joder.',
      'Tu simetría es un chiste malo contado dos veces, [nombre]. Fracasado del catálogo visual Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], si te miran de frente es por educación, no por interés, cabrón. Se te ve el fail desde la puta notificación, coño.',
      'Fea de close-up: el zoom solo empeora el informe, [nombre]. Qué asco de material El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], tienes más fallos de fábrica que un electrodoméstico chino de outlet, gilipollas. Con el espejo y el bot en contra a la vez, gilipollas.',
      'La luz natural te delata como un puto detector de mentiras, [nombre]. Patético. Pura sentencia sin narrador emocional, patético.',
      '[nombre], no eres \\\'interesante\\\': eres difícil de mirar y punto, asco. Y el grupo se hace el ciego por educación, asco.',
      'Fea de las que el group selfie se recorta solo, [nombre]. Ridículo automático Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], tu cara pide un softbox y un milagro, y no hay presupuesto para ninguno, joder. El material habla y no pide intérprete, ridículo.',
      'Si el atractivo fuera nota, tú irías a recuperación en agosto, [nombre]. Mierda académica Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], el filtro de Instagram se suicida cuando intentas usarlo, coño. Se te ve el fail desde la puta notificación, joder.',
      'Fea sin narrativa de villana: solo fea, [nombre]. Cabrón. sin plot twist El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], te hicieron con las luces apagadas y prisa de lunes, gilipollas. Con el espejo y el bot en contra a la vez, coño.',
      'Tu perfil izquierdo y el derecho compiten a ver cuál es peor, [nombre]. Patético empate Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], ni el modo noche te hace favor: te hace más honesta, asco. Y el grupo se hace el ciego por educación, gilipollas.',
      'Fea de las que el espejo del ascensor tiene traumas, [nombre]. Ridículo móvil Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], tienes el tipo de cara que hace cambiar de acera sin confesarlo, joder. El material habla y no pide intérprete, asco.',
      'No es un mal día: es el material de base, [nombre]. Puta mierda estructural Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], si la genética fuera un juicio, tú saldrías culpable sin fianza, coño. Se te ve el fail desde la puta notificación, ridículo.',
      'Fea de catálogo de lo que no se debe repetir, [nombre]. Cabrón de manual El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], el atractivo te vio pasar y fingió que miraba el móvil, gilipollas. Con el espejo y el bot en contra a la vez, joder.',
      'Tienes más ángulos muertos que un parking en U, [nombre]. Patético. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], la cámara frontal de tu móvil merece una medalla al valor, asco. Y el grupo se hace el ciego por educación, coño.',
      'Fea de las que el maquillaje es daño colateral, [nombre]. Ridículo. con base Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], no hay \\\'te ves mejor en persona\\\': hay decepción escalonada, joder. El material habla y no pide intérprete, gilipollas.',
      'Tu cara es un argumento contra la natalidad irresponsable, [nombre]. Mierda heredada Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el high de fea te queda de casa y de apodo, coño. Se te ve el fail desde la puta notificación, asco.',
      'Fea sin derecho a matiz ni a filtro de caridad, [nombre]. Cabrón del ranking El chat no necesita subtítulos para este gag, basura.',
      '[nombre], si te describen es por contraste con lo normal, gilipollas. Con el espejo y el bot en contra a la vez, ridículo.',
      'Se te ve el fail visual desde el otro lado del puto chat, [nombre]. Patético. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], tienes el magnetismo de una silla de plástico mojada, asco. Y el grupo se hace el ciego por educación, joder.',
      'Fea de las que el retrato robado se borra por piedad, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], el bot no necesita adjetivos: el número ya te dejó en el sótano, joder. El material habla y no pide intérprete, coño.',
      'No hay segundo chance en este frame, [nombre]. Puta sentencia visual Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], tu belleza es un rumor que nadie pudo confirmar, coño. Se te ve el fail desde la puta notificación, gilipollas.',
      'Fea de informe clínico sin anestesia, [nombre]. Cabrón documentado El chat no necesita subtítulos para este gag, patético.',
      '[nombre], hasta el perro del vecino elige mejor dónde mirar, gilipollas. Con el espejo y el bot en contra a la vez, asco.',
      'Tienes una presencia que baja el promedio del group photo, [nombre]. Patético. Pura sentencia sin narrador emocional, basura.',
      '[nombre], si el atractivo fuera propina, te dejarían monedas de cinco, asco. Y el grupo se hace el ciego por educación, ridículo.',
      'Fea de las que el flash avisa antes de disparar, [nombre]. Ridículo preventivo Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], el techo de tu cara es el suelo de casi cualquiera, joder. El material habla y no pide intérprete, joder.',
      'No eres \\\'única\\\': eres difícil de catalogar sin insultar, [nombre]. Mierda rara Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], la fealdad te queda tan natural que parece look, coño. Se te ve el fail desde la puta notificación, coño.',
      'Fea de tramo alto: el ranking te nombra y el chat asiente, [nombre]. Cabrón. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], tienes más problemas de simetría que un IKEA mal montado, gilipollas. Con el espejo y el bot en contra a la vez, gilipollas.',
      'El modo retrato te trata como amenaza, [nombre]. Patético software Pura sentencia sin narrador emocional, patético.',
      '[nombre], si te miran mucho es porque no creen lo que ven, asco. Y el grupo se hace el ciego por educación, asco.',
      'Fea de las que el espejo del baño del bar tiene PTSD, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], tu cara es la razón por la que inventaron el \\\'desde lejos\\\', joder. El material habla y no pide intérprete, ridículo.',
      'No hay ángulo de salvación: hay rendición, [nombre]. Puta realidad Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], el high de fea no es insulto, es inventario, coño. Se te ve el fail desde la puta notificación, joder.',
      'Fea sin plot de redención en tres actos, [nombre]. Cabrón plano El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], tienes el glow up invertido: cada año confirma el diagnóstico, gilipollas. Con el espejo y el bot en contra a la vez, coño.',
      'La cámara trasera es tu única amiga y aun así miente poco, [nombre]. Patético. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], si la belleza fuera wifi, tú serías zona muerta, asco. Y el grupo se hace el ciego por educación, gilipollas.',
      'Fea de las que el maquillador cobra hazard pay, [nombre]. Ridículo laboral Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], el atractivo te bloqueó en todas las redes, joder. El material habla y no pide intérprete, asco.',
      'Tu frame es contenido de risa ajena gratis, [nombre]. Mierda viral Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], no es luz: es que no hay material que iluminar con dignidad, coño. Se te ve el fail desde la puta notificación, ridículo.',
      'Fea de veredicto que no admite recurso, [nombre]. Cabrón firme El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], tienes cara de final de temporada cancelada, gilipollas. Con el espejo y el bot en contra a la vez, joder.',
      'Se te nota el sótano visual en la primera foto de perfil, [nombre]. Patético. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], el filtro beauty se declara en huelga cuando te ve, asco. Y el grupo se hace el ciego por educación, coño.',
      'Fea de las que el group chat prefiere stickers, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], si te hacen un retrato es por compromiso, no por deseo, joder. El material habla y no pide intérprete, gilipollas.',
      'Tu simetría perdió el juicio y no pagó fianza, [nombre]. Mierda legal Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el high te mide y el chat no discute el número, coño. Se te ve el fail desde la puta notificación, asco.',
      'Fea sin barniz de \\\'carácter\\\': solo el informe, [nombre]. Cabrón seco El chat no necesita subtítulos para este gag, basura.',
      '[nombre], tienes el tipo de cara que hace odiar los selfies ajenos, gilipollas. Con el espejo y el bot en contra a la vez, ridículo.',
      'La belleza objetiva no es opinión: y tú estás en el sótano, [nombre]. Patético. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], ni con ring light de influencer te inventas un punto focal, asco. Y el grupo se hace el ciego por educación, joder.',
      'Fea de las que el fotógrafo finge que se le acabó la batería, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], tu cara es un almost eterno que nunca llega a decente, joder. El material habla y no pide intérprete, coño.',
      'No hay \\\'en persona se ve mejor\\\': hay la misma mierda. con voz, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], el ranking de fea te tiene de inquilino fijo, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Fea de manual negro: sin misterio, sin estilo, sin indulto, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], tienes más fallos faciales que un examen a última hora, patético. Con el espejo y el bot en contra a la vez, asco.',
      'El close-up es una denuncia anónima contra tu genética, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], si el atractivo fuera crédito, tu score sería basura, ridículo. Y el grupo se hace el ciego por educación, ridículo.',
      'Fea de las que el espejo retrovisor se niega a colaborar, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], te ves como un borrador que nadie quiso terminar, mierda. El material habla y no pide intérprete, joder.',
      'La luz del atardecer te delata igual que el fluorescente del súper, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], el high de fea te queda de tatuaje invisible, cabrón. Se te ve el fail desde la puta notificación, coño.',
      'Fea sin derecho a \\\'es el ángulo\\\': son todos, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], tienes el magnetismo inverso: la gente se aleja sin saber por qué, patético. Con el espejo y el bot en contra a la vez, gilipollas.',
      'Se te ve el fail desde la notificación del mensaje, [nombre]. Asco. Pura sentencia sin narrador emocional, patético.',
      '[nombre], si te describieran en tres palabras sobrarían dos insultos, ridículo. Y el grupo se hace el ciego por educación, asco.',
      'Fea de las que el maquillaje es diplomacia fallida, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], el bot te midió y el resultado no admite consuelo, puta mierda. El material habla y no pide intérprete, ridículo.',
      'Tu cara es el gag visual del comando y nadie pide bis, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], no hay segundo acto: el primero ya fue suficiente desastre, cabrón. Se te ve el fail desde la puta notificación, joder.',
      'Fea de tramo que duele porque es verdad, [nombre]. Gilipollas documentado El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], tienes una geometría facial que ofende a Euclides, patético. Con el espejo y el bot en contra a la vez, coño.',
      'El atractivo te dio de baja y no dejó forwarding, [nombre]. Asco administrativo Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], si la belleza fuera propina, el camarero te ignoraría, ridículo. Y el grupo se hace el ciego por educación, gilipollas.',
      'Fea de las que el selfie se queda en el carrete por vergüenza, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], el high no es bullying: es el espejo con números, mierda. El material habla y no pide intérprete, asco.',
      'Tu frame pide un testigo de Jehová y un indulto papal, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], se te nota la falta de suerte genética en cada pixel, cabrón. Se te ve el fail desde la puta notificación, ridículo.',
      'Fea sin modo avión que oculte el diagnóstico, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], tienes el tipo de cara que hace amar los paisajes, patético. Con el espejo y el bot en contra a la vez, joder.',
      'La cámara frontal merece hazard pay por trabajar contigo, [nombre]. Asco. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], si te miran de reojo es para no comprometerse, ridículo. Y el grupo se hace el ciego por educación, coño.',
      'Fea de las que el group photo tiene un hueco estratégico, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], el material óseo y el de tejidos firmaron el mismo fail, mierda. El material habla y no pide intérprete, gilipollas.',
      'No eres un \\\'rostro con carácter\\\': eres un rostrosin suerte, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el ranking te tiene de ejemplo cuando explica el sótano, cabrón. Se te ve el fail desde la puta notificación, asco.',
      'Fea de veredicto público y sin narrador emocional, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], tienes más asimetría que un debate en este puto chat, patético. Con el espejo y el bot en contra a la vez, ridículo.',
      'Se te ve el techo visual y está bajo, [nombre]. Asco de altura Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], si el atractivo fuera examen, irías a septiembre, ridículo. Y el grupo se hace el ciego por educación, joder.',
      'Fea de las que el filtro se rinde y apaga la pantalla, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], tu cara es un almost de humano decente, mierda. El material habla y no pide intérprete, coño.',
      'El high de fea te nombra sin pedir permiso al ego, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], no hay redención en un ángulo ni en un tutorial, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Fea de manual: el bot firma y el chat archiva, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], tienes el glow de un aparcamiento a las tres de la mañana, patético. Con el espejo y el bot en contra a la vez, asco.',
      'La belleza objetiva pasó de largo y no dejó recado, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], si te hacen un cumplido es por pena o por agenda, ridículo. Y el grupo se hace el ciego por educación, ridículo.',
      'Fea de las que el espejo del gym tiene restricción de horario, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], el sótano visual te queda de residencia fiscal, mierda. El material habla y no pide intérprete, joder.',
      'Tu presencia baja el promedio del frame en un mensaje, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], no hay misterio de fealdad cool: hay lo previsible, cabrón. Se te ve el fail desde la puta notificación, coño.',
      'Fea de tramo alto y sin derecho a bis, [nombre]. Gilipollas del ranking El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], tienes cara de final boss de la mala suerte genética, patético. Con el espejo y el bot en contra a la vez, gilipollas.',
      'Se te nota el fail hasta en la sombra del perfil, [nombre]. Asco. Pura sentencia sin narrador emocional, patético.',
      '[nombre], si la genética fuera un juicio oral, no tendrías defensa, ridículo. Y el grupo se hace el ciego por educación, asco.',
      'Fea de las que el maquillador finge dolor de cabeza, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], el atractivo te bloqueó y te dejó en visto eterno, mierda. El material habla y no pide intérprete, ridículo.',
      'Tu frame es el gag del día y el grupo no pide replay, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], el high te mide con regla y te deja en negativo, cabrón. Se te ve el fail desde la puta notificación, joder.',
      'Fea sin consuelo de \\\'personalidad\\\': el comando no mide eso, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], tienes más problemas de proporciones que un plano de arquitecto borracho, patético. Con el espejo y el bot en contra a la vez, coño.',
      'La luz del flash te trata como evidencia del crimen, [nombre]. Asco. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], si te describen \\\'interesante\\\' es código de fea educada, ridículo. Y el grupo se hace el ciego por educación, gilipollas.',
      'Fea de las que el selfie stick se acorta solo, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], el material de base no admite segunda oportunidad, puta mierda. El material habla y no pide intérprete, asco.',
      'Tu cara es un informe sin anexos de caridad, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], se te ve el sótano desde la notificación, cabrón. Se te ve el fail desde la puta notificación, ridículo.',
      'Fea de veredicto que el chat confirma en silencio, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], tienes el tipo de presencia que hace amar el paisaje urbano, patético. Con el espejo y el bot en contra a la vez, joder.',
      'El ranking de fea te tiene de inquilino sin contrato, [nombre]. Asco. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], si el atractivo fuera crédito, estarías en mora, ridículo. Y el grupo se hace el ciego por educación, coño.',
      'Fea de las que el filtro beauty pide apoyo técnico, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], no hay ángulo: hay rendición documentada, mierda. El material habla y no pide intérprete, gilipollas.',
      'Tu simetría perdió el norte y el sur, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el high de fea te queda de apodo no oficial, cabrón. Se te ve el fail desde la puta notificación, asco.',
      'Fea sin plot twist de redención en tres mensajes, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], tienes cara de borrador olvidado en la papelera, patético. Con el espejo y el bot en contra a la vez, ridículo.',
      'Se te nota la falta de suerte en cada puto pixel del estado, [nombre]. Asco. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], si te miran fijo es porque no procesan el input, ridículo. Y el grupo se hace el ciego por educación, joder.',
      'Fea de las que el group chat prefiere audio a foto, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], el bot te midió dos veces y las dos dio sótano, mierda. El material habla y no pide intérprete, coño.',
      'Tu frame pide un testigo y un abogado de oficio, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], el atractivo te dio de baja sin carta de despido, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Fea de manual negro y sin anestesia, [nombre]. Gilipollas del comando El chat no necesita subtítulos para este gag, patético.',
      '[nombre], tienes más fallos faciales que un DNI mal escaneado, patético. Con el espejo y el bot en contra a la vez, asco.',
      'La belleza objetiva no es debate: y tú perdiste, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], si el high de fea fuera un piso, vivirías en el -2, ridículo. Y el grupo se hace el ciego por educación, ridículo.',
      'Fea de las que el espejo del baño tiene horario de duelo, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], te ves como un almost que se quedó en almost, puta mierda. El material habla y no pide intérprete, joder.',
      'El close-up es una denuncia con firma digital, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], se te ve el techo y está por los suelos, cabrón. Se te ve el fail desde la puta notificación, coño.',
      'Fea de tramo que no admite narrador emocional, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], tienes el magnetismo de una silla mojada en la terraza, patético. Con el espejo y el bot en contra a la vez, gilipollas.',
      'El ranking te nombra y el chat no apela, [nombre]. Asco firmado Pura sentencia sin narrador emocional, patético.',
      '[nombre], si te hacen un retrato es por relleno de álbum, ridículo. Y el grupo se hace el ciego por educación, asco.',
      'Fea de las que el maquillaje es daño colateral permanente, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], el material óseo firmó el mismo contrato de fail que la piel, mierda. El material habla y no pide intérprete, ridículo.',
      'Tu cara es el gag visual y nadie pide bis, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], el high te deja en el sótano sin ascensor, cabrón. Se te ve el fail desde la puta notificación, joder.',
      'Fea sin derecho a \\\'es el día\\\': es el material, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], tienes una geometría que ofende al compás, patético. Con el espejo y el bot en contra a la vez, coño.',
      'Se te nota el fail visual en la primera línea del mensaje, [nombre]. Asco. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], si la belleza fuera wifi, tú serías el router muerto, ridículo. Y el grupo se hace el ciego por educación, gilipollas.',
      'Fea de veredicto público delante de todo el puto grupo, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], el atractivo te vio y cambió de acera digital, mierda. El material habla y no pide intérprete, asco.',
      'Tu frame es contenido de risa ajena sin copyright, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], no hay segundo chance: el primero ya fue bastante, cabrón. Se te ve el fail desde la puta notificación, ridículo.',
      'Fea de las que el filtro se suicida al intentar ayudarte, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], tienes el glow up invertido certificado por el ranking, patético. Con el espejo y el bot en contra a la vez, joder.',
      'La luz natural te delata igual que un interrogatorio, [nombre]. Asco. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], si te describen en una palabra, esa palabra insulta, ridículo. Y el grupo se hace el ciego por educación, coño.',
      'Fea de tramo alto: el bot firma y cierra el parte, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], el sótano visual te queda de casa y de apodo, puta mierda. El material habla y no pide intérprete, gilipollas.',
      'Tu presencia baja el promedio del chat solo con existir, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el high de fea no es opinión: es el puto número, cabrón. Se te ve el fail desde la puta notificación, asco.',
      'Fea sin consuelo, sin bis y sin narrador que te salve, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, basura.',
      'Se te ve el diagnóstico desde la puta notificación, [nombre]. Asco. Pura sentencia sin narrador emocional, fracasado.',
  ...
  puta: {
    ...
    goodIsHigh: false,
    high: [
      '[nombre], te repartes tan barato que hasta el puticlub te pediría referencia negativa, joder. Y el grupo se hace el ciego por educación, joder.',
      'Puta de rotación de cajero automático: sacan lo suyo y ni te miran a la cara, [nombre]. Qué asco. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], si el puterío cotizara en bolsa serías chicharro basura, no blue chip, cabrón. El material habla y no pide intérprete, coño.',
      'Has convertido el sí fácil en identidad y el grupo ya no se sorprende, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], tienes más kilometraje que un taxi de aeropuerto en temporada alta, puta mierda. Se te ve el fail desde la puta notificación, gilipollas.',
      'Puta de las que el silencio ajeno lo leen como invitación a más teatro, [nombre]. Patético. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], te abres en canal por atención y luego te ofendes si te tratan como producto, coño. Con el espejo y el bot en contra a la vez, asco.',
      'El listón del respeto lo enterraste tú misma con cada estribillo barato, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], puta de fondo de chat: siempre el mismo gag y cero misterio, basura. Y el grupo se hace el ciego por educación, ridículo.',
      'Te vendes en cuotas y nadie pidió el plan de financiación, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], si la dignidad fuera preservativo, tú cogerías sin, fracasado. El material habla y no pide intérprete, joder.',
      'Puta de repertorio corto: las mismas cartas de \'mírame\' en cada mano, [nombre]. Joder. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], has hecho del almost de intocable tu marca personal y se te ve el forro, mierda. Se te ve el fail desde la puta notificación, coño.',
      'El grupo te tiene de meme sexual sin pedirte permiso, [nombre]. Coño. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], puta de las que el putero profesional pediría descuento por volumen, cabrón. Con el espejo y el bot en contra a la vez, gilipollas.',
      'Te repartes como flyer de discoteca mala: nadie lo pidió y acaba en el suelo, [nombre]. Gilipollas. Pura sentencia sin narrador emocional, patético.',
      '[nombre], tu sí vale menos que un like anónimo de madrugada, patético. Y el grupo se hace el ciego por educación, asco.',
      'Puta sin el barniz de \'liberada\': solo hambre de validación barata, [nombre]. Asco. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], has convertido el chat en tu escaparate y el producto está en oferta, basura. El material habla y no pide intérprete, ridículo.',
      'Se te oye el estribillo de disponibilidad hasta en los mensajes \'serios\', [nombre]. Ridículo. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], puta de manual: el ranking te nombra y tú posas, fracasado. Se te ve el fail desde la puta notificación, joder.',
      'Si el puterío fuera currículum, tendrías páginas de relleno y cero logros, [nombre]. Joder. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], te abres más fácil que un zip de archivo corrupto, mierda. Con el espejo y el bot en contra a la vez, coño.',
      'Puta de las que confunden atención con respeto y se caen del pedestal, [nombre]. Coño. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], el grupo ya no debate: te tiene catalogada y archivada, cabrón. Y el grupo se hace el ciego por educación, gilipollas.',
      'Has hecho del \'cualquier mira vale\' tu política exterior, [nombre]. Gilipollas. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], puta de kilometraje alto y mantenimiento cero, patético. El material habla y no pide intérprete, asco.',
      'Te vendes en liquidación permanente y aun así no se agota el stock, [nombre]. Asco. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], el sí fácil te quedó de tatuaje invisible, basura. Se te ve el fail desde la puta notificación, ridículo.',
      'Puta de las que el silencio de los demás es el único filtro que te queda, [nombre]. Ridículo. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], tienes más vueltas que un portero automático de edificio viejo, fracasado. Con el espejo y el bot en contra a la vez, joder.',
      'El puterío te queda de uniforme y no de disfraz de una noche, [nombre]. Joder. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], te repartes con la frialdad de quien ya no espera nada a cambio, mierda. Y el grupo se hace el ciego por educación, coño.',
      'Puta de fondo: el chat te usa de gag y tú sigues el libreto, [nombre]. Coño. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], si la dignidad tuviera alarma, a ti se te rompió hace años, cabrón. El material habla y no pide intérprete, gilipollas.',
      'Has convertido cada hilo en casting improvisado, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], puta de las que el almost de misterio se fue con el primer sí, patético. Se te ve el fail desde la puta notificación, asco.',
      'Te abres en canal por un poco de ruido y el eco te devuelve asco, [nombre]. Asco. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], el ranking de puta te tiene de inquilina fija, basura. Con el espejo y el bot en contra a la vez, ridículo.',
      'Puta sin plot de redención: solo el mismo estribillo, [nombre]. Ridículo. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], te vendes tan barato que hasta el descuento se avergüenza, fracasado. Y el grupo se hace el ciego por educación, joder.',
      'Se te nota la hambre de validación en cada puto mensaje, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], puta de manual negro: el grupo firma y tú posas, mierda. El material habla y no pide intérprete, coño.',
      'El sí fácil te delata más que cualquier rumor del chat, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], has hecho del escaparate tu única personalidad, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Puta de las que confunden circulacion con deseo real, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], te repartes como menú del día: predecible y frío, patético. Con el espejo y el bot en contra a la vez, asco.',
      'El listón del respeto lo bajaste tú hasta el sótano, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], puta de kilometraje visible y orgullo de cartón, basura. Y el grupo se hace el ciego por educación, ridículo.',
      'Te abres más que un debate en este grupo y con menos sustancia, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], si el puterío fuera deporte, serías suplente eterno, fracasado. El material habla y no pide intérprete, joder.',
      'Puta de las que el chat ya no se sorprende: solo archiva, [nombre]. Joder. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], has convertido el almost de intocable en chiste interno, mierda. Se te ve el fail desde la puta notificación, coño.',
      'Te vendes en cuotas y nadie pidió el recibo, [nombre]. Coño. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], puta de fondo de hilo: siempre disponible, nunca respetada, cabrón. Con el espejo y el bot en contra a la vez, gilipollas.',
      'El grupo te tiene de meme y tú sigues alimentando el formato, [nombre]. Gilipollas. Pura sentencia sin narrador emocional, patético.',
      '[nombre], se te oye el estribillo de \'miradme\' hasta en los audios, patético. Y el grupo se hace el ciego por educación, asco.',
      'Puta sin barniz de misterio ni de estilo, [nombre]. Asco documentado Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], te repartes con la elegancia de un anuncio popup, basura. El material habla y no pide intérprete, ridículo.',
      'Si la dignidad fuera contraseña, a ti te la hackearon en 2019, [nombre]. Ridículo. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], puta de las que el sí vale menos que un sticker, fracasado. Se te ve el fail desde la puta notificación, joder.',
      'Has hecho del chat tu puticlub sin cover, [nombre]. Joder. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], el ranking te nombra y el resto asiente sin debate, mierda. Con el espejo y el bot en contra a la vez, coño.',
      'Puta de manual: disponibilidad alta, respeto en cero, [nombre]. Coño. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], te abres en canal por atención de segunda, cabrón. Y el grupo se hace el ciego por educación, gilipollas.',
      'El puterío te quedó de marca personal y no de noche suelta, [nombre]. Gilipollas. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], tienes más vueltas que el rumor del grupo, patético. El material habla y no pide intérprete, asco.',
      'Puta de las que el almost de clase se fue con el primer post, [nombre]. Asco. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], te vendes en liquidación y el stock no baja, basura. Se te ve el fail desde la puta notificación, ridículo.',
      'Se te nota el hambre hasta en los mensajes que quieren parecer fríos, [nombre]. Ridículo. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], puta de fondo: el chat te usa y tú agradeces el uso, fracasado. Con el espejo y el bot en contra a la vez, joder.',
      'Si el puterío cotizara, serías el chicharro del día, [nombre]. Joder. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], has convertido cada mirada en ticket de entrada, mierda. Y el grupo se hace el ciego por educación, coño.',
      'Puta sin derecho a ofenderte cuando te tratan como catálogo, [nombre]. Coño. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], el sí fácil te delata más que un historial público, cabrón. El material habla y no pide intérprete, gilipollas.',
      'Te repartes como flyer mojado: nadie lo guarda, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], puta de kilometraje alto y narrativa baja, patético. Se te ve el fail desde la puta notificación, asco.',
      'El grupo ya no discute el diagnóstico: lo da por cerrado, [nombre]. Asco. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], has hecho del escaparate tu único argumento, basura. Con el espejo y el bot en contra a la vez, ridículo.',
      'Puta de las que confunden ruido con valor, [nombre]. Ridículo. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], te abres más fácil que la configuración de privacidad en cero, fracasado. Y el grupo se hace el ciego por educación, joder.',
      'El listón del respeto lo enterraste con cada estribillo, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], puta de manual negro delante del puto chat, mierda. El material habla y no pide intérprete, coño.',
      'Te vendes barato y luego quieres tarifa de lujo, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], se te oye la disponibilidad hasta en el \'buenos días\', cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Puta de fondo de ranking: inquilina fija del tramo, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], has convertido el almost de misterio en chiste gastado, patético. Con el espejo y el bot en contra a la vez, asco.',
      'Si la dignidad tuviera seguro, a ti te lo cancelaron, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], puta de las que el chat archiva sin pedir bis, basura. Y el grupo se hace el ciego por educación, ridículo.',
      'Te repartes con la frialdad de un menú de gasolinera, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], el ranking de puta te tiene de ejemplo cuando explica el sótano, fracasado. El material habla y no pide intérprete, joder.',
      'Puta sin plot twist: solo el mismo libreto, [nombre]. Joder. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], te abres en canal por migajas de atención, mierda. Se te ve el fail desde la puta notificación, coño.',
      'El puterío te queda de uniforme de diario, [nombre]. Coño. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], has hecho del sí tu única estrategia social, cabrón. Con el espejo y el bot en contra a la vez, gilipollas.',
      'Puta de las que el silencio ajeno es el único límite que no cruzas, [nombre]. Gilipollas. Pura sentencia sin narrador emocional, patético.',
      '[nombre], te vendes en oferta y el precio sigue cayendo, patético. Y el grupo se hace el ciego por educación, asco.',
      'Se te nota el hambre de validación a la legua, [nombre]. Asco. Sin derecho a filtro ni a segunda pose, basura.',
      'El grupo te tiene catalogada: el bot solo confirma, [nombre]. Ridículo. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], si el puterío fuera currículum, tendrías relleno y cero logros, fracasado. Se te ve el fail desde la puta notificación, joder.',
      'Puta de manual: el chat firma el parte y tú posas, [nombre]. Joder. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], te repartes como anuncio que nadie puede cerrar, mierda. Con el espejo y el bot en contra a la vez, coño.',
      'El sí fácil te quedó de cicatriz pública, [nombre]. Coño. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], has convertido cada hilo en tu pasarela de descuentos, cabrón. Y el grupo se hace el ciego por educación, gilipollas.',
      'Puta de las que confunden circulación con deseo, [nombre]. Gilipollas. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], te abres más que un zip dañado y con el mismo resultado, patético. El material habla y no pide intérprete, asco.',
      'El listón del respeto está en el sótano con tu nombre, [nombre]. Asco. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], puta de fondo: siempre el mismo gag, basura. Se te ve el fail desde la puta notificación, ridículo.',
      'Te vendes barato y el stock no se agota nunca, [nombre]. Ridículo. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], se te oye el estribillo de disponibilidad en cada audio, fracasado. Con el espejo y el bot en contra a la vez, joder.',
      'Puta sin barniz de \'empoderada\': solo hambre, [nombre]. Joder. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], el ranking te nombra y el resto del chat entiende el chiste, mierda. Y el grupo se hace el ciego por educación, coño.',
      'Has hecho del almost de intocable tu mayor fail, [nombre]. Coño. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], puta de las que el putero amateur pediría recibo, cabrón. El material habla y no pide intérprete, gilipollas.',
      'Te repartes con la elegancia de un popup de virus, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], si la dignidad fuera contraseña, ya la habrían cambiado por ti, patético. Se te ve el fail desde la puta notificación, asco.',
      'Puta de kilometraje alto y misterio en quiebra, [nombre]. Asco. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], el grupo ya no se sorprende: solo documenta, basura. Con el espejo y el bot en contra a la vez, ridículo.',
      'Te abres en canal por ruido de segunda división, [nombre]. Ridículo. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], puta de manual negro: disponibilidad máxima, respeto nulo, fracasado. Y el grupo se hace el ciego por educación, joder.',
      'El sí fácil te delata más que cualquier captura, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      'Puta de las que el almost de clase se fue en el primer mensaje, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], te vendes en liquidación permanente, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'Se te nota el hambre hasta cuando finges indiferencia, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      '[nombre], puta de fondo de hilo y de ranking, patético. Con el espejo y el bot en contra a la vez, asco.',
      'Si el puterío cotizara, serías el valor que nadie recomienda, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], el listón del respeto lo bajaste tú con cada sí, basura. Y el grupo se hace el ciego por educación, ridículo.',
      'Puta sin derecho a victimismo cuando el catálogo te describe, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], te repartes como menú del día en bar de carretera, fracasado. El material habla y no pide intérprete, joder.',
      'El ranking de puta te tiene de inquilina vitalicia, [nombre]. Joder. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], has hecho del sí tu única carta y se te ve la baraja, mierda. Se te ve el fail desde la puta notificación, coño.',
      'Puta de las que el chat usa de gag y tú sigues el libreto, [nombre]. Coño. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], te abres más fácil que la privacidad en cero, cabrón. Con el espejo y el bot en contra a la vez, gilipollas.',
      'El puterío te quedó de marca y no de accidente, [nombre]. Gilipollas. Pura sentencia sin narrador emocional, patético.',
      '[nombre], puta de kilometraje que ya no admite garantía, patético. Y el grupo se hace el ciego por educación, asco.',
      'Te vendes barato y luego quieres trato de boutique, [nombre]. Asco. Sin derecho a filtro ni a segunda pose, basura.',
      '[nombre], se te oye la disponibilidad en el \'hola\' del desbloqueo, basura. El material habla y no pide intérprete, ridículo.',
      'Puta de manual: el bot confirma lo que el grupo ya sabía, [nombre]. Ridículo. Aquí no hay modo avión que te salve el frame, fracasado.',
      'Si la dignidad tuviera alarma, sonaría cada vez que escribes, [nombre]. Joder. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], puta de fondo: el eco te devuelve el mismo asco, mierda. Con el espejo y el bot en contra a la vez, coño.',
      'Te repartes con la frialdad de quien ya aceptó el catálogo, [nombre]. Coño. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], el almost de misterio se te escapó en el primer sí, cabrón. Y el grupo se hace el ciego por educación, gilipollas.',
      'Puta de las que confunden atención con respeto y caen, [nombre]. Gilipollas. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], te abres en canal por migajas y aún así das las gracias, patético. El material habla y no pide intérprete, asco.',
      'El grupo te tiene de meme sexual sin pedirte royalties, [nombre]. Asco. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], puta de ranking fijo en el sótano del respeto, basura. Se te ve el fail desde la puta notificación, ridículo.',
      'Te vendes en oferta y el precio solo baja, [nombre]. Ridículo. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], se te nota el hambre de validación en cada puto sticker, fracasado. Con el espejo y el bot en contra a la vez, joder.',
      'Puta sin plot de redención en tres actos, [nombre]. Joder. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], has hecho del escaparate tu personalidad completa, mierda. Y el grupo se hace el ciego por educación, coño.',
      'El sí fácil te quedó de cicatriz que el chat lee en voz alta, [nombre]. Coño. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], puta de las que el silencio es el único que te pone límite, cabrón. El material habla y no pide intérprete, gilipollas.',
      'Te repartes como flyer de after de mala muerte, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], el ranking te nombra y nadie pide segunda opinión, patético. Se te ve el fail desde la puta notificación, asco.',
      'Puta de manual negro delante de todo el grupo, [nombre]. Asco. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], te abres más que un debate vacío y con menos contenido, basura. Con el espejo y el bot en contra a la vez, ridículo.',
      'Si el puterío fuera deporte, estarías en la grada del almost, [nombre]. Ridículo. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], has convertido el almost de clase en chiste gastado del hilo, fracasado. Y el grupo se hace el ciego por educación, joder.',
      'Puta de kilometraje alto y dignidad en números rojos, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], te vendes barato y el stock parece infinito, mierda. El material habla y no pide intérprete, coño.',
      'Se te oye el estribillo de \'disponible\' hasta en los estados, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], puta de fondo de chat: el gag eres tú, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
      'El listón del respeto está enterrado con tu historial, [nombre]. Gilipollas. El chat no necesita subtítulos para este gag, patético.',
      'Puta de las que el chat archiva sin aplauso ni bis, [nombre]. Asco. Pura sentencia sin narrador emocional, basura.',
      '[nombre], has hecho del sí tu política exterior completa, basura. Y el grupo se hace el ciego por educación, ridículo.',
      'Si la dignidad fuera seguro, a ti te lo negaron por riesgo, [nombre]. Ridículo. Sin derecho a filtro ni a segunda pose, fracasado.',
      '[nombre], puta de manual: disponibilidad de 24h, respeto de 0, fracasado. El material habla y no pide intérprete, joder.',
      'Te abres en canal por ruido y el eco te devuelve el diagnóstico, [nombre]. Joder. Aquí no hay modo avión que te salve el frame, mierda.',
      '[nombre], el puterío te delata más que cualquier rumor del grupo, mierda. Se te ve el fail desde la puta notificación, coño.',
      'Puta de ranking: el bot solo pone número a lo obvio, [nombre]. Coño. El chat no necesita subtítulos para este gag, cabrón.',
      '[nombre], te vendes en liquidación y aun así sobra mercancía, cabrón. Con el espejo y el bot en contra a la vez, gilipollas.',
      'Se te nota el hambre hasta cuando intentas parecer selectiva, [nombre]. Gilipollas. Pura sentencia sin narrador emocional, patético.',
      '[nombre], puta de las que el almost de intocable es el gag del año, patético. Y el grupo se hace el ciego por educación, asco.',
      'El grupo te catalogó y el comando confirma el pasillo, [nombre]. Asco. Sin derecho a filtro ni a segunda pose, basura.',
      'Puta sin barniz, sin misterio y sin derecho a ofenderte, [nombre]. Ridículo. Aquí no hay modo avión que te salve el frame, fracasado.',
      '[nombre], te repartes como menú de gasolinera a las 3 a.m., fracasado. Se te ve el fail desde la puta notificación, joder.',
      'El sí fácil te quedó de firma digital en el chat, [nombre]. Joder. El chat no necesita subtítulos para este gag, mierda.',
      '[nombre], puta de kilometraje que ya no admite reclamaciones, mierda. Con el espejo y el bot en contra a la vez, coño.',
      'Te abres más fácil que la configuración por defecto, [nombre]. Coño. Pura sentencia sin narrador emocional, cabrón.',
      '[nombre], el ranking de puta te tiene de ejemplo del sótano, cabrón. Y el grupo se hace el ciego por educación, gilipollas.',
      'Puta de fondo: siempre el mismo libreto, [nombre]. Gilipollas. Sin derecho a filtro ni a segunda pose, patético.',
      '[nombre], te vendes barato y quieres reseñas de cinco estrellas, patético. El material habla y no pide intérprete, asco.',
      'Se te oye la disponibilidad en el primer \'jeje\' del hilo, [nombre]. Asco. Aquí no hay modo avión que te salve el frame, basura.',
      '[nombre], has hecho del escaparate tu único talento documentado, basura. Se te ve el fail desde la puta notificación, ridículo.',
      'Puta de las que el chat usa de meme y tú sigues subiendo material, [nombre]. Ridículo. El chat no necesita subtítulos para este gag, fracasado.',
      '[nombre], si el puterío cotizara, serías warning del bróker, fracasado. Con el espejo y el bot en contra a la vez, joder.',
      'El listón del respeto lo tocaste vos y lo dejaste en el piso, [nombre]. Joder. Pura sentencia sin narrador emocional, mierda.',
      '[nombre], puta de manual negro: el grupo firma, tú posas, mierda. Y el grupo se hace el ciego por educación, coño.',
      'Te repartes con la frialdad de un catálogo PDF, [nombre]. Coño. Sin derecho a filtro ni a segunda pose, cabrón.',
      '[nombre], el almost de misterio se te cayó en el primer sí del historial, cabrón. El material habla y no pide intérprete, gilipollas.',
      'Puta de ranking fijo y sin plan de rehabilitación, [nombre]. Gilipollas. Aquí no hay modo avión que te salve el frame, patético.',
      '[nombre], te abres en canal por migajas y aún pides propina, patético. Se te ve el fail desde la puta notificación, asco.',
      'El puterío te quedó de uniforme de diario del chat, [nombre]. Asco. El chat no necesita subtítulos para este gag, basura.',
      '[nombre], has convertido el sí en tu única estrategia y se te ve el mazo, basura. Con el espejo y el bot en contra a la vez, ridículo.',
      'Puta de las que el silencio ajeno es el único que te frena, [nombre]. Ridículo. Pura sentencia sin narrador emocional, fracasado.',
      '[nombre], te vendes en oferta permanente y el precio no toca suelo, fracasado. Y el grupo se hace el ciego por educación, joder.',
      'Se te nota el hambre de validación en cada puto emoji, [nombre]. Joder. Sin derecho a filtro ni a segunda pose, mierda.',
      '[nombre], puta de fondo de hilo, de ranking y de meme, mierda. El material habla y no pide intérprete, coño.',
      'Si la dignidad tuviera caducidad, la tuya estaría en el cubo, [nombre]. Coño. Aquí no hay modo avión que te salve el frame, cabrón.',
      '[nombre], el bot te midió y el grupo ya había firmado el parte, cabrón. Se te ve el fail desde la puta notificación, gilipollas.',
    ],
    mid: [
