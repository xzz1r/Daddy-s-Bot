...
const HEADERS = [
  '*ROAST SIN ANESTESIA DE MIERDA*',
  '*EJECUCIÓN PÚBLICA DE MIERDA*',
  '*AUTOPSIA EN DIRECTO DE MIERDA*',
  '*DESTRUCCIÓN TOTAL DE MIERDA*',
  '*ENTIERRO ABIERTO AL PÚBLICO DE MIERDA*',
  '*MASACRE DOCUMENTADA DE MIERDA*',
  '*ASADO HASTA EL HUESO DE MIERDA*',
  '*DEMOLICIÓN CONTROLADA DE MIERDA*',
  '*VOLADURA PSICOLÓGICA DE MIERDA*',
  '*SENTENCIA SIN APELACIÓN DE MIERDA*',
  '*NECROPSIA SIN GUANTES DE MIERDA*',
  '*HUMILLACIÓN OFICIAL DE MIERDA*',
  '*CREMACIÓN EN DIRECTO DE MIERDA*',
  '*INFORME DE DAÑOS DE MIERDA*',
  '*EL VEREDICTO DE MIERDA*',
  '*DERRIBO PROGRAMADO DE MIERDA*',
  '*DISECCIÓN PÚBLICA DE MIERDA*',
  '*SACRIFICIO RITUAL DE MIERDA*',
  '*EXPEDIENTE ABIERTO DE MIERDA*',
  '*FUNERAL EN DIFERIDO DE MIERDA*',
  '*OPERACIÓN SIN ANESTESIA DE MIERDA*',
  '*ACCIDENTE CONTROLADO DE MIERDA*',
  '*INCINERACIÓN VOLUNTARIA DE MIERDA*',
  '*VIVISECCIÓN EN GRUPO DE MIERDA*',
  '*PERITAJE DE DAÑOS DE MIERDA*',
  '*MATANZA CON ESTILO DE MIERDA*',
  '*AJUSTICIAMIENTO EN VIVO DE MIERDA*',
  '*DERRUMBE PERSONAL DE MIERDA*',
  '*CRÁTER DONDE HABÍA EGO DE MIERDA*',
  '*TUMBA ABIERTA DE MIERDA*',
  '*JUICIO SUMARÍSIMO DE MIERDA*',
  '*FUSILAMIENTO SIMBÓLICO DE MIERDA*',
  '*APLASTAMIENTO DOCUMENTADO DE MIERDA*',
  '*RUINA PÚBLICA DE MIERDA*',
  '*CAÍDA LIBRE DE MIERDA*',
  '*EXPLOSIÓN CONTROLADA DEL EGO DE MIERDA*',
  '*DESGUACE EN DIRECTO DE MIERDA*',
  '*LIQUIDACIÓN TOTAL DE MIERDA*',
  '*CIERRE DE EXPEDIENTE DE MIERDA*',
  '*ÚLTIMA LLAMADA DE MIERDA*',
  '*DESMONTAJE EN DIRECTO DE MIERDA*',
  '*VEREDICTO DEL CHAT DE MIERDA*',
  '*HUMILLACIÓN TÉCNICA DE MIERDA*',
  '*QUEMA CONTROLADA DE MIERDA*',
  '*AJUSTE DE CUENTAS DE MIERDA*',
  '*DERROTA SIMBÓLICA DE MIERDA*',
  '*EXPOSICIÓN TOTAL DE MIERDA*',
  '*GOLPE DE GRACIA DE MIERDA*',
  '*CIERRE CON LLAVE DE MIERDA*',
  '*ROAST SIN ANESTESIA, JODER*',
  '*EJECUCIÓN PÚBLICA DE MIERDA*',
  '*AUTOPSIA EN DIRECTO, CABRÓN*',
  '*DESTRUCCIÓN TOTAL DEL EGO DE MIERDA*',
  '*AJUSTICIAMIENTO SIN PIEDAD DE MIERDA*',
  '*DERRUMBE PERSONAL DOCUMENTADO DE MIERDA*',
  '*CRÁTER DONDE HABÍA EGO, ASCO*',
  '*TUMBA ABIERTA, GILIPOLLAS*',
  '*JUICIO SUMARÍSIMO DE MIERDA*',
  '*FUSILAMIENTO SIMBÓLICO, COÑO*',
  '*RUINA PÚBLICA, PATÉTICO*',
  '*CAÍDA LIBRE DEL ORGULLO DE MIERDA*',
  '*DESGUACE EN DIRECTO, BASURA*',
  '*LIQUIDACIÓN TOTAL, RIDÍCULO*',
  '*CIERRE DE EXPEDIENTE, FRACASADO*',
  '*ÚLTIMA LLAMADA, JODER*',
  '*DESMONTAJE EN DIRECTO DE MIERDA*',
  '*VEREDICTO DEL CHAT, CABRÓN*',
  '*HUMILLACIÓN TÉCNICA SIN FILTRO DE MIERDA*',
  '*QUEMA CONTROLADA DEL EGO DE MIERDA*',
  '*AJUSTE DE CUENTAS, GILIPOLLAS*',
  '*DERROTA SIMBÓLICA, COÑO*',
  '*EXPOSICIÓN TOTAL, ASCO*',
  '*GOLPE DE GRACIA, PATÉTICO*',
  '*CIERRE CON LLAVE, BASURA*',
  '*ROAST DE MIERDA EN VIVO*',
  '*EJECUCIÓN SIN NARRADOR AMIGO DE MIERDA*',
  '*AUTOPSIA DEL EGO, RIDÍCULO*',
  '*ENTIERRO CON PÚBLICO, FRACASADO*',
  '*JUICIO DEL GRUPO, JODER*',
  '*FUSILAMIENTO DEL ORGULLO DE MIERDA*',
  '*RUINA DOCUMENTADA, CABRÓN*',
  '*CAÍDA SIN RED, GILIPOLLAS*',
  '*DESGUACE PERSONAL, MIERDA*',
  '*LIQUIDACIÓN DEL PERSONAJE DE MIERDA*',
  '*SENTENCIA FIRME, COÑO*',
  '*VEREDICTO SIN ANESTESIA DE MIERDA*',
  '*HUMILLACIÓN EN DIRECTO, ASCO*',
  '*QUEMA DEL EGO, PATÉTICO*',
  '*EXPOSICIÓN SIN FILTRO, BASURA*',
  '*GOLPE LIMPIO, RIDÍCULO*',
  '*CIERRE DEL ACTA, FRACASADO*',
  '*ROAST ARCHIVADO, JODER*',
  '*EJECUCIÓN DEL PERSONAJE DE MIERDA*',
  '*AUTOPSIA PÚBLICA, CABRÓN*',
  '*DERRUMBE SIN PIEDAD, MIERDA*',
  '*CRÁTER DE ORGULLO, COÑO*',
  '*TUMBA DEL EGO, ASCO*',
  '*JUICIO EN VIVO, PATÉTICO*',
  '*APLASTAMIENTO DEL RELATO DE MIERDA*',
...
const HEADERS = [
  ...
  '*AJUSTICIAMIENTO SIN PIEDAD*',
  '*DERRUMBE PERSONAL DOCUMENTADO*',
  '*CRÁTER DONDE HABÍA EGO, ASCO*',
  '*TUMBA ABIERTA, GILIPOLLAS*',
  '*JUICIO SUMARÍSIMO DE MIERDA*',
  '*FUSILAMIENTO SIMBÓLICO, COÑO*',
  '*RUINA PÚBLICA, PATÉTICO*',
  '*CAÍDA LIBRE DEL ORGULLO*',
  '*DESGUACE EN DIRECTO, BASURA*',
  '*LIQUIDACIÓN TOTAL, RIDÍCULO*',
  '*CIERRE DE EXPEDIENTE, FRACASADO*',
  '*ÚLTIMA LLAMADA, JODER*',
  '*DESMONTAJE EN DIRECTO DE MIERDA*',
  '*VEREDICTO DEL CHAT, CABRÓN*',
  '*HUMILLACIÓN TÉCNICA SIN FILTRO*',
...
const CLOSERS = [
  ...
  '_Sin piedad, sin filtro y sin la mentira de que esto se arregla, joder._',
  '_El grupo ya firmó el parte. Tú solo pon la cara, cabrón._',
  '_No hay terapia que te devuelva lo que acabas de perder aquí, gilipollas._',
  '_Caso cerrado. El archivo no admite recurso, mierda._',
  '_Duele porque es verdad. Y la verdad no pide permiso, coño._',
  '_Recoge los restos del ego. No te caben en el bolsillo, asco._',
  '_Esto no era un aviso. Era el golpe limpio, basura._',
  '_El chat no olvida. Esto queda en el historial, ridículo._',
  '_Fin del trayecto. Baja aquí y no mires atrás, fracasado._',
  '_No se puede maquillar lo que acabamos de nombrar, joder._',
  '_Aplaude si quieres. No te devuelve dignidad, gilipollas._',
  '_Documentado, archivado y sin derecho a bis, mierda._',
  '_Lo que queda de ti cabe en este mensaje, coño._',
  '_Sin retorno. Sin narrador amigo. Sin indulto, asco._',
  '_Hecho polvo en público. Siguiente, basura._',
  '_Guarda el orgullo. Aquí no te cabe, fracasado._',
  '_Pásate por terapia. Esto solo fue el diagnóstico, joder._',
  '_El grupo es testigo. Que conste, cabrón._',
  '_No fue personal. Fue precisión quirúrgica, gilipollas._',
  '_Llora si quieres. El ranking no se inmuta, mierda._',
  '_Sin anestesia. Sin segunda oportunidad barata, coño._',
  '_La verdad te quedó grande y a la vista, asco._',
  '_Cierre de expediente. Firma invisible, patético._',
  '_Esto no se cura: se asume en silencio, basura._',
  '_El roast terminó. Tú todavía estás cayendo, ridículo._',
  '_Sin piedad útil. Solo el veredicto crudo, fracasado._',
  '_Que alguien recoja lo que queda. Esto acabó, joder._',
  '_El chat archivó. Tú procesa, gilipollas._',
  '_Defunción simbólica confirmada, mierda._',
  '_Sin terapia express. Solo el golpe y el eco, coño._',
  '_Te dejamos el espejo. Úsalo o no, asco._',
  '_El daño está hecho y documentado, patético._',
  '_No busques consuelo en este hilo, basura._',
  '_Cerrado. Sin apelación ni narrador suave, ridículo._',
  '_Lo dicho queda. Lo que eras, también, fracasado._',
  '_Sin filtro. Sin caridad. Sin retorno, joder._',
  '_El grupo no discute el resultado, cabrón._',
  '_Esto fue el final del argumento a tu favor, gilipollas._',
  '_Duele. Bueno. Así se nota que pegó, mierda._',
  '_Sin maquillaje posible después de esto, coño._',
  '_Archivo cerrado. Ego en ruinas, asco._',
...
const OWNER_ROAST = [
  ...
  'El owner de turno, %N, con el aura de quien no necesita pedir permiso. Qué asco de privilegio bien usado, coño.',
  '%N se cree el centro del chat y el contador a veces le hace el favor. Menudo numerito, asco Y el grupo lo tiene claro, joder.',
  'Ahí va %N, repartiendo juicio como quien reparte pan. El pan es castigo, patético Y el grupo lo tiene claro, joder.',
  '%N, el intocable de broma que resulta no ser tan broma, basura Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, asco.',
  'Cuando %N habla, el grupo mide dos veces. No por respeto: por cálculo, ridículo Y el grupo lo tiene claro, joder.',
  '%N tiene el privilegio y encima lo disfruta. El resto mira, fracasado Y el grupo lo tiene claro, joder.',
  'El puto %N otra vez en modo diésel: avanza y no pregunta, joder Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, fracasado.',
  '%N, creído con evidencia. Lo peor de las dos cosas, cabrón Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, joder.',
  'Míralo a %N: suerte, ego y el chat de testigo, gilipollas Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, mierda.',
  '%N no pide la corona. Actúa como si ya la llevara, mierda Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, coño.',
  'El grupo aguanta a %N porque el ranking a veces no deja otra, coño Y el grupo lo tiene claro, joder.',
  '%N, privilegiado de los que ni disimulan el desprecio suave, asco Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, gilipollas.',
  'Cuando cae el roast sobre %N, el universo parpadea y sigue, patético Y el grupo lo tiene claro, joder.',
  '%N se cree incombustible. El chat tiene fósforos, basura Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, asco.',
  'Ahí está %N, invicto por reglamento y por cara, ridículo Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, basura.',
  '%N, el jefe oficioso del hilo. Nadie votó, fracasado Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, ridículo.',
  'El aura de %N viene con seguro a todo riesgo, joder Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, fracasado.',
  '%N habla y el resto traduce a privilegio, cabrón Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, joder.',
  'Mira quién no necesita pedir perdón: %N, gilipollas Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, mierda.',
  '%N, sortudo con manual de instrucciones de creído, mierda Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, coño.',
  'El chat le hace el caldo a %N y él ni agradece, coño Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, cabrón.',
  '%N en modo intocable. El roast es el peaje simbólico, asco Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, gilipollas.',
  'Cuando %N pierde, es noticia. Cuando gana, es el clima, patético Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, patético.',
  '%N, el favorito del RNG y de su propio espejo, basura Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, asco.',
  'Ahí va el puto %N otra vez, sin pedir turno, ridículo Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, basura.',
  '%N se cree el final boss. El grupo es el tutorial, fracasado Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, ridículo.',
  'Privilegio con nombre de usuario: %N, joder Y el grupo lo tiene claro, joder Y se nota en cada puto hilo, fracasado.',
  '%N en modo intocable. El roast es el único peaje simbólico, asco El grupo lo tiene más que asumido, joder.',
  'Privilegio con nombre de usuario: %N, y se nota en cada mensaje, joder El grupo lo tiene más que asumido, mierda.',
  '%N reparte veredictos como quien regala stickers, cabrón El grupo lo tiene más que asumido, coño Y se nota en cada puto hilo, coño.',
  'El ego de %N tiene más aura que medio ranking junto, gilipollas El grupo lo tiene más que asumido, cabrón.',
  '%N no baja del pedestal ni para atarse los cordones, mierda El grupo lo tiene más que asumido, gilipollas.',
  'Con %N el chat practica la paciencia a la fuerza, coño El grupo lo tiene más que asumido, patético Y se nota en cada puto hilo, patético.',
  '%N, el que nunca pide contexto porque el contexto es él, asco El grupo lo tiene más que asumido, asco.',
  'Suerte de %N y cara de %N: combo ilegal en tres países, patético El grupo lo tiene más que asumido, basura.',
  '%N gana y el grupo finge que era obvio, basura El grupo lo tiene más que asumido, ridículo Y se nota en cada puto hilo, ridículo.',
  'El roast a %N es el deporte de riesgo del hilo, ridículo El grupo lo tiene más que asumido, fracasado.',
  '%N, intocable de facto y creído de derecho, fracasado El grupo lo tiene más que asumido, joder Y se nota en cada puto hilo, joder.',
  'Cuando %N entra, el tono del chat cambia de gravidez, joder El grupo lo tiene más que asumido, mierda.',
  '%N no necesita introducción: el privilegio ya lo presenta, cabrón El grupo lo tiene más que asumido, coño.',
  'Mira a %N, campeón de las excepciones, gilipollas El grupo lo tiene más que asumido, cabrón Y se nota en cada puto hilo, cabrón.',
  '%N tiene el manual del que siempre aterriza de pie, mierda El grupo lo tiene más que asumido, gilipollas.',
  'El grupo es el público cautivo de %N, coño El grupo lo tiene más que asumido, patético Y se nota en cada puto hilo, patético.',
  '%N, ego con wifi y cobertura total, asco El grupo lo tiene más que asumido, asco Y se nota en cada puto hilo, asco.',
  'Nadie votó a %N. El ranking a veces sí, patético El grupo lo tiene más que asumido, basura Y se nota en cada puto hilo, basura.',
  '%N disfruta el papel y no lo esconde, basura El grupo lo tiene más que asumido, ridículo Y se nota en cada puto hilo, ridículo.',
  'El puto aura de %N molesta hasta cuando calla, ridículo El grupo lo tiene más que asumido, fracasado.',
  '%N es el DLC pago que el grupo no pidió, fracasado El grupo lo tiene más que asumido, joder Y se nota en cada puto hilo, joder.',
  'Con %N el rest del chat juega en otra liga de respeto forzado, joder El grupo lo tiene más que asumido, mierda.',
  '%N, sortudo con manual de instrucciones de creído, mierda Y se nota en cada puto hilo, coño.',
  'El chat le hace el caldo a %N y él ni agradece el cubierto, coño Y se nota en cada puto hilo, cabrón.',
  '%N en modo intocable. El roast es el único peaje simbólico, asco Y se nota en cada puto hilo, gilipollas.',
  'Cuando %N pierde, es noticia. Cuando gana, es el clima del grupo, patético Y se nota en cada puto hilo, patético.',
  '%N, el favorito del RNG y de su propio espejo, basura Y se nota en cada puto hilo, asco.',
  'Ahí va el puto %N otra vez, sin pedir turno en el hilo, ridículo Y se nota en cada puto hilo, basura.',
  '%N se cree el final boss. El grupo es el tutorial eterno, fracasado Y se nota en cada puto hilo, ridículo.',
  'Privilegio con nombre de usuario: %N, y se nota en cada mensaje, joder Y se nota en cada puto hilo, fracasado.',
  '%N reparte veredictos como quien regala stickers, cabrón Y se nota en cada puto hilo, joder.',
  'El ego de %N tiene más aura que medio ranking junto, gilipollas Y se nota en cada puto hilo, mierda.',
  '%N no baja del pedestal ni para atarse los cordones, mierda Y se nota en cada puto hilo, coño.',
  'Con %N el chat practica la paciencia a la fuerza, coño Y se nota en cada puto hilo, cabrón.',
  '%N, el que nunca pide contexto porque el contexto es él, asco Y se nota en cada puto hilo, gilipollas.',
  'Suerte de %N y cara de %N: combo ilegal en tres países, patético Y se nota en cada puto hilo, patético.',
  '%N gana y el grupo finge que era obvio, basura Y se nota en cada puto hilo, asco.',
  'El roast a %N es el deporte de riesgo del hilo, ridículo Y se nota en cada puto hilo, basura.',
  '%N, intocable de facto y creído de derecho, fracasado Y se nota en cada puto hilo, ridículo.',
  'Cuando %N entra, el tono del chat cambia de gravidez, joder Y se nota en cada puto hilo, fracasado.',
  '%N no necesita introducción: el privilegio ya lo presenta, cabrón Y se nota en cada puto hilo, joder.',
  'Mira a %N, campeón de las excepciones, gilipollas Y se nota en cada puto hilo, mierda.',
  '%N tiene el manual del que siempre aterriza de pie, mierda Y se nota en cada puto hilo, coño.',
  'El grupo es el público cautivo de %N, coño Y se nota en cada puto hilo, cabrón.',
  '%N, ego con wifi y cobertura total, asco Y se nota en cada puto hilo, gilipollas.',
  'Nadie votó a %N. El ranking a veces sí, patético Y se nota en cada puto hilo, patético.',
  '%N disfruta el papel y no lo esconde, basura Y se nota en cada puto hilo, asco.',
  'El puto aura de %N molesta hasta cuando calla, ridículo Y se nota en cada puto hilo, basura.',
  '%N es el DLC pago que el grupo no pidió, fracasado Y se nota en cada puto hilo, ridículo.',
  'Con %N el rest del chat juega en otra liga de respeto forzado, joder Y se nota en cada puto hilo, fracasado.'
];
