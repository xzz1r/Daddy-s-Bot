...
const HEADERS = [
  ...
  '*SIN FILTRO NI HOSTIAS*',
  '*LO QUE NADIE TE DICE A LA CARA*',
  '*TE LO HAS BUSCADO*',
  '*QUE SE ENTERE EL GRUPO*',
  '*A VER SI TE ENTERAS*',
  '*CALLA Y ESCUCHA*',
  '*AQUÍ NO TE SALVA NI DIOS*',
  '*VENGA, AL LÍO*',
  '*QUE TE DEN*',
  '*ABRE LA BOCA*',
  '*A LA CARA Y SIN ADORNOS*',
  '*ESTO NO SE ARREGLA*',
  '*Y ENCIMA LO PEDISTE*',
  '*POR PEDIRLO, IMBÉCIL*',
  '*MENUDO PERSONAJE*',
...
const CLOSERS = [
  ...
  '_Y ni una sola palabra de ahí arriba tenía arreglo._',
