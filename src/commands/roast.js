...
const CLOSERS = [
  '_Ni terapia ni nada. Esto se queda así._',
  '_Esto no se cura, se asume._',
  '_Y lo ha visto el grupo entero, que es lo que jode._',
  '_No es una opinión. Es que eres así de malo._',
  ...
  '_Se acabó. Vete a llorar a otro lado._',
  '_Recoge lo que queda de tu dignidad de camino a la salida._',
  '_No hay segunda parte porque no hace falta._',
  '_No se arregla. Acostúmbrate._',
  '_La verdad jode. La tuya más._',
  '_Ni te odio ni nada. Es que da la puta casualidad de que es verdad._',
  '_Y no hay ni una línea de ahí arriba que puedas discutir._',
  '_Guárdate el cope. Nadie te lo va a comprar aquí._',
  '_Ahí queda eso. Que te jodan._',
  '_Ya está todo dicho. Llora en privado, que aquí no cuela._',
  '_Esto no se arregla ni con dinero, y tú encima no tienes._',
  '_Ni terapia ni cope. Esto es permanente._',
  '_Lo pediste tú, así que ni una queja, cabrón._',
  '_Nadie quería ofenderte. Ha salido solo, de lo evidente que era._',
  '_Lo dicho, dicho está. No pienso retirarlo._',
  '_Se cierra el tema. No queda una mierda que rascar._',
  '_Ni cope ni excusa. Lo que eres está escrito ahí arriba y no se borra._',
  '_Esto se queda en el grupo y no lo va a borrar nadie._',
  '_El grupo entero está de acuerdo y eso ya no lo arregla nadie._',
  '_No es cosa mía. Es que lo eres de verdad, y se nota._',
  '_Hecho mierda y con público delante. Siguiente._',
  '_De ésta no se sale. Calla y aguanta._',
  '_Ya está. Recoge tus cosas._',
];
...
COMBINED_INACTIVE = COMBINED_INACTIVE;
