...
const OWNER_ROAST = [
  ...
  '%N, el intocable de broma que resulta no ser tan broma, basura Y el grupo lo tiene claro, joder.',
  ...
  'El puto %N otra vez en modo diésel: avanza y no pregunta, joder Y el grupo lo tiene claro, joder.',
  '%N, creído con evidencia. Lo peor de las dos cosas, cabrón Y el grupo lo tiene claro, joder.',
  'Míralo a %N: suerte, ego y el chat de testigo, gilipollas Y el grupo lo tiene claro, joder.',
  '%N no pide la corona. Actúa como si ya la llevara, mierda Y el grupo lo tiene claro, joder.',
  'El grupo aguanta a %N porque el ranking a veces no deja otra, coño Y el grupo lo tiene claro, joder.',
  '%N, privilegiado de los que ni disimulan el desprecio suave, asco Y el grupo lo tiene claro, joder.',
  'Cuando cae el roast sobre %N, el universo parpadea y sigue, patético Y el grupo lo tiene claro, joder.',
  '%N se cree incombustible. El chat tiene fósforos, basura Y el grupo lo tiene claro, joder.',
  'Ahí está %N, invicto por reglamento y por cara, ridículo Y el grupo lo tiene claro, joder.',
  '%N, el jefe oficioso del hilo. Nadie votó, fracasado Y el grupo lo tiene claro, joder.',
  'El aura de %N viene con seguro a todo riesgo, joder Y el grupo lo tiene claro, joder.',
  '%N habla y el resto traduce a privilegio, cabrón Y el grupo lo tiene claro, joder.',
  'Mira quién no necesita pedir perdón: %N, gilipollas Y el grupo lo tiene claro, joder.',
  '%N, sortudo con manual de instrucciones de creído, mierda Y el grupo lo tiene claro, joder.',
  'El chat le hace el caldo a %N y él ni agradece, coño Y el grupo lo tiene claro, joder.',
  '%N en modo intocable. El roast es el peaje simbólico, asco Y el grupo lo tiene claro, joder.',
  'Cuando %N pierde, es noticia. Cuando gana, es el clima, patético Y el grupo lo tiene claro, joder.',
