...
const COUNTRY_ROAST = {
  ...
  ES: {
    ...
    lines: [
      ...
      'De %PAIS, %N. Te crees el adulto de la sala hispana y no sostenés el hilo cuando pesa. Eres superioridad de manual escolar. La dignidad no se firma en la UE del ego.',
  ...
  PE: {
    ...
    lines: [
      ...
      'De %PAIS, %N. Te crees el adulto de la sala y no sostenés el hilo cuando pesa. Superioridad sin expediente.',
