...
const CLOSERS = [
  ...
  '_El roast terminó. Tú no, cabrón._ El ranking no perdona este frame, joder.',
  ...
  'Y el ranking lo firma sin anestesia, joder.',
  'El grupo ya tomó nota del fail, mierda El ranking no perdona este frame, joder.',
  'Sin derecho a apelación ni a consuelo, cabrón.',
  'El bot no suaviza este roast, coño El ranking no perdona este frame, joder.',
  'Archivo cerrado. Siguiente, gilipollas El ranking no perdona este frame, joder.',
  'Y se nota en cada puto mensaje que dejas, patético.',
  'El chat se caga de risa y tú callas, asco.',
  'Sólo queda el eco del fail, basura El ranking no perdona este frame, joder.',
  'El número y la frase coinciden en el sótano, ridículo.',
  'Sin filtro, sin consuelo, sin bis, fracasado.'
bareJid, sameUser, fetchAbout } = require('../utils/wa');
const { pick, pickFresh, fmt, ordenarPorDureza } = require('../utils/helpers');
const { getUserCount } = require('../utils/messageCounter');
