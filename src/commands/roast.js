...
let COMBINED_INACTIVE = [
  'Mírate, %N, con esa bio de perdedor escrita por un virgen de treinta años que aún vive con su mamá y se hace pajas llorando. Ni escribes nada, ni aportas nada. Solo un fantasma de mierda que nadie quiere cerca, patético.',
  '%N, con ese nombre de cornudo y esa bio de fracasado, eres tan irrelevante que ni los mosquitos te hacen caso. No escribes una puta palabra y el grupo agradece el silencio. Puto inútil sin remedio, miserable.',
  'Con esa bio que grita "soy un fracaso con patas", %N, eres el error que nadie corrige porque ya no merece el esfuerzo. Ni escribes nada. Existes por inercia, das pena y no aportas una mierda, qué cringe.',
  '%N, pareces el hijo secreto de un condón roto y una mala decisión. Tu bio grita abandono, tu vida sexual es nula y encima ni escribes nada. Un desperdicio humano con patas que sobra en la lista, da, asco, da asco.',
  'Acumulas años de frustración sexual y pajas frustradas, %N. Esa bio ridícula de don nadie y tu inactividad de cadáver digital confirman que naciste para ser el chiste que nadie quiere contar en ningún grupo, qué vergüenza.',
  '%N, tu nombre ya da risa y tu bio de mierda lo confirma. Que encima ni escribas nada remata al puto inútil más completo y prescindible que ha pasado por este grupo de mierda, ridículo.',
  'Con esa bio de perdedor profesional y una actividad de muerto sin enterrar, %N, eres un error de la naturaleza. Ni aportas, ni escribes, ni vales. El pack completo del fracasado sin ningún atenuante posible, fracasado.',
  '%N, tu bio es más triste que tu vida sexual, que es absolutamente nula. Tu silencio en el grupo remata la faena. Un fantasma virgen que no aporta una puta cosa. Consistencia del fracasado nato, qué miseria.',
  'Con esa bio que huele a frustración acumulada de años, %N, no escribes nada porque ya sabes que todo lo que digas solo añade contexto al ridículo que ya eres. Puto parásito sin una gota de valor, da grima.',
  '%N, eres tan patético que ni tu puta madre te escribiría. Bio de mierda, nombre de fracasado y una presencia tan nula que el grupo no sabe si estás o no, y la respuesta no cambia nada para absolutamente nadie, qué nivel de pena.',
  'Qué pena de nombre, %N. Bio de mierda y cero mensajes en el grupo. El don nadie moderno, completo y documentado, para que todo el grupo vea al parásito que ocupa sitio sin aportar una mierda, basura.',
  '%N, eres el tipo que se pone una bio patética para tapar lo poco que vale. Y aun así no escribes nada porque el silencio es lo único que te protege del ridículo absoluto que te mereces, qué cutre.',
  'Con ese nombre de cornudo, %N, y esa bio que da vergüenza ajena, eres exactamente lo que todo el mundo imagina cuando alguien dice "fracaso con patas y sin una puta excusa". Y encima ni escribes, da pena ajena.',
  '%N, tu bio grita inseguridad y tu silencio confirma que hasta tú sabes que no tienes una puta mierda que aportar. El don nadie perfecto: sin cojones, sin valor y sin remedio posible, qué vacío.',
  'No sé qué da más asco, %N, si tu bio de cuatro duros o el silencio constante de un parásito que lleva aquí sin dejar una sola marca que justifique el espacio que ocupa en la lista, indignante.',
  '%N, llevas aquí tiempo de sobra para haber soltado algo y no lo hiciste. Con esa bio de mierda, callarte es lo único inteligente que has hecho, porque cada palabra tuya solo confirmaría el puto inútil que eres, qué vergüenza ajena.',
  'Eres un desperdicio humano, %N. Bio que da lástima, vida sexual nula y presencia de fantasma de, mierda. El grupo te aguanta por inercia pura, no porque hayas justificado tu existencia aquí, da vergüenza.',
  '%N, tu bio es la autobiografía de un don nadie que no lee ni su puta madre, y tu silencio el historial de un fantasma de mierda sin una sola gota de dignidad. Un desastre completo y sin arreglo, qué flojo.',
  'Con esa bio de perdedor crónico, %N, no escribes nada porque cada cosa que dijeras solo añadiría contexto al asco que el grupo ya siente cuando ve tu puto nombre en la lista, menudo desastre.',
  '%N, eres el gilipollas que tiene una bio que da vergüenza y la desfachatez de seguir en el grupo sin aportar absolutamente nada. Existes como el olor a humedad: molesto, sin valor y sin remedio, qué pena.',
  'Tu nombre, %N, ya da asco antes de que nadie hable contigo. La bio de mierda confirma los peores pronósticos y tu silencio de fantasma remata la faena. Un puto desastre perfecto en todos los sentidos, patético.',
  '%N, combinas bio de mierda, vida sexual nula y presencia de fantasma con la naturalidad de alguien que lleva toda la vida siendo exactamente esto sin enterarse nunca. El fracasado inconsciente en estado puro, miserable.',
  'Lo que pusiste en la bio, %N, es lo que te gustaría ser. Lo que realmente eres es un puto fracasado, y no escribir nada lo confirma. El retrato más honesto del don nadie que arrastras desde siempre, qué cringe.',
  '%N, la bio es una mierda y no has escrito nada relevante en tu puta vida aquí. No es mala racha, es quien eres desde siempre. Y quien eres no le interesa a nadie en este grupo ni fuera de él, da, asco, da asco.',
  'Con ese nombre, %N, y esa bio de mierda, eres la representación más completa del concepto de "sobrar en todos los sentidos posibles" sin tener ni la más mínima idea de ello. Un parásito silencioso, qué vergüenza.',
  '%N, tu bio es el único texto que escribiste por voluntad propia y aun así salió esa, mierda. Tu silencio confirma que en el grupo tampoco tienes una puta cosa que ofrecer. El pack completo del inútil de manual, ridículo.',
  'La bio que tienes, %N, es el grito de socorro de alguien que no sabe quién coño es. Tu silencio lo certifica sin ninguna necesidad de más palabras: un fantasma virgen sin una puta cosa dentro, fracasado.',
  '%N, llevas aquí de fantasma con una bio puesta para que alguien piense algo mínimamente bueno de ti. El resultado es siempre el mismo: una puta nada que no le importa a nadie y que nadie echaría de menos, qué miseria.',
  'Lo más triste de ti, %N, no es la bio patética ni la inactividad de fantasma. Lo más triste es que crees que aportas algo y el grupo entero lleva tiempo sabiendo que no. Nadie te lo dice por pura lástima, da grima.',
  ...
  '%N, entras al grupo como entra el frío por una rendija: nadie te invitó, nadie te quiere y todos preferirían taparte. Bio de perdedor y un silencio que es lo mejor que ofreces. Puto estorbo, basura.',
  'Tu bio es humo, %N, y tu actividad es un desierto. Dos pruebas de que naciste para ser el nombre que el grupo tarda un mes en notar que ya no está. Y no lo notará ni entonces, qué cutre.',
  '%N, eres lo que queda cuando a una persona le quitas todo lo que la hace interesante: un nombre, una bio triste y un silencio de fantasma. El kit básico del don nadie sin un solo extra que salvar, da pena ajena.',
  'Con esa bio de fracasado, %N, y esa presencia de cadáver digital, el grupo te tiene en la lista por pereza de borrarte, no por otra cosa. Ocupas espacio como ocupa polvo un rincón olvidado, qué vacío.',
  '%N, tu bio da pena y tu inactividad da igual. Has conseguido lo imposible: ser insignificante en todos los frentes a la vez, con una coherencia que solo alcanza el fracasado de vocación, indignante.',
  'Naciste, %N, y desde entonces el saldo es negativo en todo lo medible: bio patética, vida sexual nula y cero rastro en el grupo. Un error que la naturaleza no corrige porque ya no merece ni el gasto, qué vergüenza ajena.',
  '%N, eres el puto ejemplo de que estar en la lista no es lo mismo que existir. Bio de relleno y un silencio de mueble viejo. Al grupo le da exactamente igual si estás o si te mueres, y esa nada es tu única aportación, da vergüenza.',
  'Con bio de don nadie, %N, y una presencia que ni los mosquitos registran, eres el ejemplo que se pone cuando alguien pregunta qué es sobrar. Sobras entero, en todo, sin una sola puta excusa, qué flojo.',
];

let COMBINED_ACTIVE = [
  'Mírate, %N, con esa bio de perdedor escrita por un virgen eterno que lleva años sin que nadie le haga caso. Escribes mucho, pero cada mensaje solo confirma la frustración sexual y el fracaso que la bio ya anunciaba, menudo desastre.',
  '%N, con ese nombre de cornudo y esa bio de perdedor, ni toda la actividad del mundo te va a lavar la imagen que el grupo tiene de ti. Escribes sin parar y sigues siendo la misma basura. Cabrón sin remedio, qué pena.',
  'Con esa bio que grita "soy un fracaso con patas", %N, eres el fraude que habla mucho y aporta nada. Mucho ruido, cero impacto, ninguna huella real. Un don nadie con el pulgar rápido y la cabeza vacía, patético.',
  '%N, tu bio de don nadie te retrata entero. Un puto fraude que escribe mucho, aporta poco y se cree más de lo que el marcador y el grupo confirman cada puto día sin excepción, miserable.',
  'Esa bio confirma que eres un fracaso con patas, %N, y por mucho que escribas no hay un puto mensaje tuyo que haya cambiado esa mierda. Mucho ruido, cero huella, cero valor. Consistente solo en lo peor, qué cringe.',
  'Tu bio es un chiste malo, %N, y hueles a desesperación barata y pajas frustradas. Escribes y escribes y sigues siendo lo mismo: un nadie con nombre y una vida sexual tan nula como tu relevancia, da asco.',
  '%N, pareces sacado de la bio más patética del mundo, con esa cara de víctima nata. Nadie te respeta, nadie te toma en serio, y sigues escupiendo mensajes como si eso fuera a cambiar el puto don nadie que eres. No cambia una mierda, qué vergüenza.',
  'Esa bio de perdedor profesional, %N, te convierte en el tipo de basura que merece que le recuerden lo insignificante que es cada vez que abre la boca. Y la abres mucho, para desgracia de todos, ridículo.',
  'Tu bio es una mierda, %N, y eres un error de la naturaleza con patas. Escribe todo lo que te salga del culo, que el marcador y la bio ya dijeron lo único relevante sobre ti: que no vales una puta mierda, fracasado.',
  '%N, tu bio es puro llanto de fracasado y cada mensaje tuyo es un vómito de inseguridad. Eres tan predecible que el grupo entero te tiene calado desde la primera gilipollez que soltaste aquí. Nada te salva, qué miseria.',
  'Qué pena de nombre, %N. Bio de mierda y una verborrea de fracasado. El grupo entero te tiene como ejemplo de lo que no hay que ser, y tiene toda la razón del mundo con esa clasificación sin necesitar discutirla, da grima.',
  '%N, eres el tipo que se pone una bio patética para tapar lo poco que vale. Y encima hablas como si alguien te hubiera pedido que participaras. Nadie te pidió nada, gilipollas. Cierra el puto pico, qué nivel de pena.',
  'Con ese nombre de cornudo, %N, y esa bio de llorón crónico, eres exactamente lo que todo el mundo imagina cuando alguien dice "fracaso que no se calla". Escribes mil mensajes y ninguno vale una mierda, basura.',
  '%N, tu bio grita inseguridad. Manda todos los putos mensajes que quieras, que el marcador grita más fuerte que cualquier gilipollez que hayas soltado: que eres un don nadie de manual con el dedo hiperactivo, qué cutre.',
  'No sé qué da más asco, %N, si tu bio de cuatro duros o la cantidad de mierda que escribes. Todo junto es un milagro de mediocridad sostenida y documentada sin ningún esfuerzo. Puto fraude, da pena ajena.',
  '%N, llevas tiempo aquí escribiendo sin haber dejado una sola huella que merezca recordarse. Con esa bio de mierda, al menos la cantidad de mensajes da material de sobra para confirmar el diagnóstico que ya teníamos, qué vacío.',
  'Eres un desperdicio humano, %N. Bio que da lástima y una cháchara que da asco. El grupo te aguanta porque ya está acostumbrado a tu ruido, no porque hayas aportado nada que justifique seguir, indignante.',
  '%N, tu bio es la autobiografía de un don nadie que no lee ni su puta madre. El grupo lleva tiempo leyendo la mierda que escribes y la opinión es unánime: no vales para nada y no hay fisura posible, qué vergüenza ajena.',
  'Con esa bio de perdedor, %N, cada puto mensaje que sueltas solo añade otra pincelada al retrato de inútil que el grupo ya tiene de ti. Y es un retrato que da asco mirar. Mucho hablar para nada, da vergüenza.',
  '%N, eres el gilipollas que tiene una bio que da vergüenza y aun así sigue mandando mensajes como si alguien estuviera esperando lo que tiene que decir. Nadie espera nada tuyo, puto. Nunca lo ha esperado, qué flojo.',
  'Tu nombre, %N, ya da asco antes de que nadie hable contigo. La bio de mierda confirma los peores pronósticos, y cada cosa que sueltas en el grupo solo suma pruebas a un caso cerrado: eres un puto inútil, menudo desastre.',
  '%N, combinas bio de mierda con una verborrea que no ha cambiado nada desde que llegaste. Lo mismo de siempre, en todos los indicadores, en la misma dirección: abajo sin freno y sin dignidad, qué pena.',
  'La bio que tienes, %N, es la versión escrita de alguien que no sabe quién coño es. Y lo que mandas al grupo confirma que cada mensaje que escribes lo empeora. Hablas mucho solo para hundirte más, patético.',
  '%N, esa bio de mierda confirma que no es mala racha, es quién coño eres. Y quién eres provoca la misma reacción en el grupo desde el primer día: una mueca de asco, silencio y pasar de ti como de la peste, escribas lo que escribas, miserable.',
  'Con ese nombre, %N, y esa bio de mierda de dos duros, eres la puta definición andante de "ruido inútil": ocupas sitio, gastas datos y no aportas una mierda a nadie. Sin excusa ni remedio, qué cringe.',
  '%N, tu bio es una promesa que el puto producto no cumple. La pusiste creyendo que te dejaba bien y lo único que grita es que no tienes ni puta idea de lo poco que vales para el resto del mundo. Publicidad engañosa de un fraude que no calla, da asco.',
  'Lo más triste de ti, %N, no es la bio patética. Lo más triste es que llevas tiempo participando creyendo que aportas algo, y el grupo entero sabe que no. Nadie te lo dice por pura compasión, qué vergüenza.',
  '%N, con bio de don nadie, eres el miembro más consistentemente mediocre que ha pasado por este grupo. Ni siquiera el peor, que eso al menos se recordaría. El más gris, el más olvidable, la puta nada con nombre y verborrea, ridículo.',
  'Llevas la bio de quien quiere aparentar algo, %N, y no lo consigues ni de coña. Todo lo que sueltas en el grupo es mucho esfuerzo de inútil para seguir siendo exactamente la misma nada de siempre, fracasado.',
  '%N, tu bio dice lo que quieres que piensen de ti, y lo que sueltas en el grupo dice lo que el resto piensa de verdad. Y en las dos sale lo mismo: que eres un puto don nadie que encima no se calla, qué miseria.',
  '%N, hablas para que se note que estás y lo único que se nota es que estorbas. Cada mensaje tuyo es un recordatorio de que ocupas un hueco que cualquiera con algo que decir usaría mejor. Puto relleno, da grima.',
  'Escribes mucho, %N, y el grupo retiene cero. Tu bio adorna a un don nadie y tu cháchara constante solo sirve para que nadie pueda decir que no te dio la oportunidad de callarte a tiempo, qué nivel de pena.',
  '%N, eres ruido con forma de persona. La bio miente y tú entre medias insistes en participar como si alguien hubiera pedido tu opinión alguna vez. No la pidió nadie, gilipollas. Nunca, basura.',
  'Con esa bio de fracasado con pretensiones, %N, hablar tanto solo te desnuda más. Cada puta palabra tuya es otra prueba de que el grupo tenía razón desde el principio: no vales nada y nunca vas a valer, qué cutre.',
  '%N, tu problema no es que no hables. Es que hablas y sigues siendo exactamente la misma nada de antes, solo que ahora documentada. Bio de mierda y un historial que lo firma todo, da pena ajena.',
  'Escribes como un pobre gilipollas gritando en un cuarto vacío, %N. La bio pretende y el grupo pasa de ti. Mucho esfuerzo para confirmar lo único constante en ti: que hagas lo que hagas, sigues sobrando, qué vacío.',
  '%N, tu bio te delata y tu insistencia en participar remata la faena. Dos formas distintas de decir lo mismo: que estás aquí de relleno y que ni tú te lo crees ya, puto fraude sin una gota de valor, indignante.',
  'Con esa bio de mierda, %N, y esa manía de opinar sin que nadie te pregunte una puta cosa, eres el fondo de pantalla del grupo: siempre ahí, nunca importante y sustituible por cualquier mierda igual de irrelevante, qué vergüenza ajena.',
];
...
let NAME_ONLY = [
  ...
  '%N. El nombre resume lo que eres en lo que tarda en decirse: breve, sin sustancia, olvidable. Dos sílabas para un tío que da tanto de sí como un condón usado tirado en la calle. Basura y ni de la reciclable, qué pena.',
];
...
let BIO_EMPTY = [
  ...
  'Tu bio está en blanco y es lo más honesto que has hecho en tu vida: reconocer implícitamente que no hay nada dentro que merezca una sola línea. Autoconsciencia involuntaria del fracasado, patético.',
];
