...
const OWNER_ROAST = [
  ...
  '%N, creído con evidencia. Lo peor de las dos cosas, cabrón Y el grupo lo tiene claro, joder joder. Se te ve el desastre sin subtítulos, joder.',
  'Míralo a %N: suerte, ego y el chat de testigo, gilipollas Y el grupo lo tiene claro, joder mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N no pide la corona. Actúa como si ya la llevara, mierda Y el grupo lo tiene claro, joder coño. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N se cree incombustible. El chat tiene fósforos, basura Y el grupo lo tiene claro, joder asco. Se te ve el desastre sin subtítulos, joder.',
  'Ahí está %N, invicto por reglamento y por cara, ridículo Y el grupo lo tiene claro, joder basura. Se te ve el desastre sin subtítulos, joder.',
  '%N, el jefe oficioso del hilo. Nadie votó, fracasado Y el grupo lo tiene claro, joder ridículo. Se te ve el desastre sin subtítulos, joder.',
  'El aura de %N viene con seguro a todo riesgo, joder Y el grupo lo tiene claro, joder fracasado. Se te ve el desastre sin subtítulos, joder.',
  '%N habla y el resto traduce a privilegio, cabrón Y el grupo lo tiene claro, joder joder. Se te ve el desastre sin subtítulos, joder.',
  'Mira quién no necesita pedir perdón: %N, gilipollas Y el grupo lo tiene claro, joder mierda. Se te ve el desastre sin subtítulos, joder.',
  '%N, sortudo con manual de instrucciones de creído, mierda Y el grupo lo tiene claro, joder coño. Se te ve el desastre sin subtítulos, joder.',
  'El chat le hace el caldo a %N y él ni agradece, coño Y el grupo lo tiene claro, joder cabrón. Se te ve el desastre sin subtítulos, joder.',
  ...
  '%N, el favorito del RNG y de su propio espejo, basura Y el grupo lo tiene claro, joder asco. Se te ve el desastre sin subtítulos, joder.',
  'Ahí va el puto %N otra vez, sin pedir turno, ridículo Y el grupo lo tiene claro, joder basura. Se te ve el desastre sin subtítulos, joder.',
  '%N se cree el final boss. El grupo es el tutorial, fracasado Y el grupo lo tiene claro, joder ridículo.',
  'Privilegio con nombre de usuario: %N, joder Y el grupo lo tiene claro, joder fracasado. Se te ve el desastre sin subtítulos, joder.',
  ...
  'Mira a %N, campeón de las excepciones, gilipollas El grupo lo tiene más que asumido, cabrón cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N tiene el manual del que siempre aterriza de pie, mierda El grupo lo tiene más que asumido, gilipollas.',
  'El grupo es el público cautivo de %N, coño El grupo lo tiene más que asumido, patético patético. Se te ve el desastre sin subtítulos, joder.',
  '%N, ego con wifi y cobertura total, asco El grupo lo tiene más que asumido, asco asco. Se te ve el desastre sin subtítulos, joder.',
  'Nadie votó a %N. El ranking a veces sí, patético El grupo lo tiene más que asumido, basura basura. Se te ve el desastre sin subtítulos, joder.',
  '%N disfruta el papel y no lo esconde, basura El grupo lo tiene más que asumido, ridículo ridículo. Se te ve el desastre sin subtítulos, joder.',
  'El puto aura de %N molesta hasta cuando calla, ridículo El grupo lo tiene más que asumido, fracasado.',
  '%N es el DLC pago que el grupo no pidió, fracasado El grupo lo tiene más que asumido, joder joder. Se te ve el desastre sin subtítulos, joder.',
  'Con %N el rest del chat juega en otra liga de respeto forzado, joder El grupo lo tiene más que asumido, mierda.',
  '%N, sortudo con manual de instrucciones de creído, mierda coño. Se te ve el desastre sin subtítulos, joder Nota 72.',
  'El chat le hace el caldo a %N y él ni agradece el cubierto, coño cabrón. Se te ve el desastre sin subtítulos, joder.',
  '%N en modo intocable. El roast es el único peaje simbólico, asco gilipollas. Se te ve el desastre sin subtítulos, joder Nota 74.',
  'Cuando %N pierde, es noticia. Cuando gana, es el clima del grupo, patético patético. Se te ve el desastre sin subtítulos, joder Nota 75.',
  '%N, el favorito del RNG y de su propio espejo, basura asco. Se te ve el desastre sin subtítulos, joder Nota 76.',
  'Ahí va el puto %N otra vez, sin pedir turno en el hilo, ridículo basura. Se te ve el desastre sin subtítulos, joder.',
  '%N se cree el final boss. El grupo es el tutorial eterno, fracasado ridículo. Se te ve el desastre sin subtítulos, joder.',
  'Privilegio con nombre de usuario: %N, y se nota en cada mensaje, joder fracasado. Se te ve el desastre sin subtítulos, joder Nota 79.',
  '%N reparte veredictos como quien regala stickers, cabrón joder. Se te ve el desastre sin subtítulos, joder Nota 80.',
  'El ego de %N tiene más aura que medio ranking junto, gilipollas mierda. Se te ve el desastre sin subtítulos, joder Nota 81.',
  '%N no baja del pedestal ni para atarse los cordones, mierda coño. Se te ve el desastre sin subtítulos, joder Nota 82.',
  'Con %N el chat practica la paciencia a la fuerza, coño cabrón. Se te ve el desastre sin subtítulos, joder Nota 83.',
  '%N, el que nunca pide contexto porque el contexto es él, asco gilipollas. Se te ve el desastre sin subtítulos, joder Nota 84.',
  'Suerte de %N y cara de %N: combo ilegal en tres países, patético patético. Se te ve el desastre sin subtítulos, joder Nota 85.',
  '%N gana y el grupo finge que era obvio, basura asco. Se te ve el desastre sin subtítulos, joder. El chat no necesita traducción del desastre, cabrón.',
  'El roast a %N es el deporte de riesgo del hilo, ridículo basura. Se te ve el desastre sin subtítulos, joder Nota 87.',
  '%N, intocable de facto y creído de derecho, fracasado ridículo. Se te ve el desastre sin subtítulos, joder Nota 88.',
  'Cuando %N entra, el tono del chat cambia de gravidez, joder fracasado. Se te ve el desastre sin subtítulos, joder Nota 89.',
  '%N no necesita introducción: el privilegio ya lo presenta, cabrón joder. Se te ve el desastre sin subtítulos, joder Nota 90.',
  'Mira a %N, campeón de las excepciones, gilipollas mierda. Se te ve el desastre sin subtítulos, joder Nota 91.',
  '%N tiene el manual del que siempre aterriza de pie, mierda coño. Se te ve el desastre sin subtítulos, joder Nota 92.',
  'El grupo es el público cautivo de %N, coño cabrón. Se te ve el desastre sin subtítulos, joder. El chat no necesita traducción del desastre, cabrón.',
  '%N, ego con wifi y cobertura total, asco gilipollas. Se te ve el desastre sin subtítulos, joder. El chat no necesita traducción del desastre, cabrón.',
  'Nadie votó a %N. El ranking a veces sí, patético patético. Se te ve el desastre sin subtítulos, joder.',
  '%N disfruta el papel y no lo esconde, basura asco. Se te ve el desastre sin subtítulos, joder. El chat no necesita traducción del desastre, cabrón.',
  'El puto aura de %N molesta hasta cuando calla, ridículo basura. Se te ve el desastre sin subtítulos, joder Nota 97.',
  '%N es el DLC pago que el grupo no pidió, fracasado ridículo. Se te ve el desastre sin subtítulos, joder Nota 98.',
  'Con %N el rest del chat juega en otra liga de respeto forzado, joder fracasado. Se te ve el desastre sin subtítulos, joder Nota 99.'
];
