...
const COUNTRY_ROAST = {
  AR: {
    ...
    lines: [
      ...
      '%N de %PAIS: te creés el estándar del continente y no llegás al del hilo. PowerPoint sin botones y con soberbia de presentación plena.',
      'Prefijo %PAIS, %N. Exportás cuento de superioridad a un grupo que ya te auditó. El ego sigue en gira; el público pidió la cuenta hace rato.',
      '%N, en %PAIS habrá cracks; vos saliste en el lote del que explica todo y no mueve nada. El archivo no aplaude monólogos.',
      ...
      '%N, soberbia de building y cimientos de cartón. %PAIS te dio el prefijo; el ridículo lo laburaste vos entre verso y verso.',
      '%N, de %PAIS: el falso cumplido se escribe solo —qué país— y se cae solo. Sos imperio de sobremesa. El grupo firmó la independencia de tu monólogo.',
      ...
      'De %PAIS, %N. Te creés el faro del idioma y aportás niebla. El faro está apagado; el barco del grupo ya dobló la costa.',
      ...
      '%N hace de %PAIS el chiste del continente sin querer. El punchline sos vos, sin necesidad de narrador.',
      '%N, de %PAIS: qué seguridad… para terminar midiendo al resto en provincias. Sos mapa mal dibujado. El ranking no usa tu brújula.',
      ...
      'De %PAIS, %N. Te vendés como nivel Europa del Sur y entregás drama de grupo. Soft power del cringe rioplatense.',
      ...
      '%N, en %PAIS habrá gente brillante; vos estás en el feed del que corrige y no construye. Se lee.',
  ...
  CO: {
    name: 'Colombia',
    lines: [
      '%N, de %PAIS: qué labia tan fina… para terminar vendiendo humo al por menor. Sos la viveza con WiFi: todo se “acomoda” menos tu historial. El grupo ya no compra; archiva.',
      ...
      'De %PAIS, %N. Te creés táctico y salís predecible. El “ya veo” eterno como estrategia de no hacer. El ranking vio de sobra.',
      ...
      '%N de %PAIS: confundes ser pillo con ser útil. Acá no sos ninguna de las dos. El chat lo huele sin detector.',
      ...
      '%N, de %PAIS: el falso cumplido —qué paisa mental— se derrite solo. Sos deal de ego. Checkout obligado.',
      ...
      'De %PAIS, %N. Te vendés como vivo y entregás ruido con postureo. Soft power del verso.',
      ...
      '%N, en %PAIS el vivo a veces gana. Acá el contador gana siempre, y no va con vos.',
      'Clásico %PAIS, %N: negociar todo menos tu propia mejora visible en el rastro.',
      '%N hace de %PAIS el chiste del verso. Punchline: vos, sin necesidad de narrador.',
      '%N, de %PAIS: qué confianza… para terminar siendo flyer con piernas. Sos anuncio sin producto. El grupo ya scrolleó de largo.',
      ...
      'De %PAIS, %N. Te creés el hub del arreglo y aportás demora. El chat abrió ruta alterna.',
      ...
      '%N, en %PAIS habrá cracks; vos estás en el feed del almost. El almost no paga.',
  ...
  MX: {
    name: 'México',
    lines: [
      '%N, de %PAIS: qué intensidad… para terminar siendo volumen sin argumento. Sos el drama con teclado: todo escena, nada guion. El grupo te baja el gain.',
      ...
      'De %PAIS, %N. Te creés el centro y aportás el caos. Piñata del hilo: todos saben dónde pegar y el dulce es poco.',
      '%N, prefijo %PAIS y ego de plaza. El volumen no te da la razón; te da audiencia cansada y ranking frío.',
      '%N de %PAIS: mucho “no manches” mental y cero ejecución. Sos alarma, no líder. El chat ya silenció la sirena.',
      'Drama fácil, criterio difícil, %N. %PAIS en el número y el vacío en el párrafo que debería importar.',
      '%N de %PAIS convierte todo en escena. El chat no es tu set ni tu foro. Apagá reflectores y aportá.',
      ...
      '%N, de %PAIS: el falso cumplido —qué país— se satura solo. Sos farándula de ego. Checkout del público.',
      ...
      'De %PAIS, %N. Te vendés como presencia y entregás saturación. Soft power del ruido.',
      ...
      '%N hace de %PAIS el chiste del volumen. Punchline: vos, sin necesidad de pista.',
      '%N, de %PAIS: qué carisma anunciado… para terminar siendo saturación con wifi. Sos playlist a máximo sin canciones buenas.',
      ...
      'De %PAIS, %N. Te creés el centro del mapa y aportás tráfico. El chat pidió desvío.',
      ...
      '%N, en %PAIS habrá cracks; vos estás en el feed del grito. El grito no suma.',
  ...
  VE: {
    name: 'Venezuela',
    lines: [
      '%N, de %PAIS: qué narrativa tan urgente… para terminar siendo noticiero sin cierre. Sos el agravio con teclado. El grupo no es tu gobierno ni tu canal.',
      ...
      '%N de %PAIS: convertís todo en agravio. El archivo pide hechos y sigue esperando el primer recibo útil.',
      ...
      '%N, de %PAIS: el falso cumplido —qué lucha— se agota solo. Sos noticiero de ego. El grupo cambió de canal.',
      ...
      'De %PAIS, %N. Te vendés como resistencia y entregás saturación. Soft power del reclamo eterno.',
      ...
      '%N hace de %PAIS el chiste del reclamo. Punchline: vos, sin locutor.',
      '%N, de %PAIS: qué urgencia moral… para terminar siendo saturación con bandera. Sos asamblea de uno. El ranking no vota esa lista.',
      ...
      'De %PAIS, %N. Te creés faro moral y aportás niebla. El faro pide mantenimiento de hechos.',
      ...
      '%N, en %PAIS habrá gente clara; vos preferís el micrófono. Se nota la falta de párrafo útil.',
  ...
  PE: {
    name: 'Perú',
    lines: [
      '%N, de %PAIS: qué compostura… para terminar siendo tribunal sin toga. Sos el mohín profesional: juzgás en silencio y aportás en cuotas. El grupo no te pidió sentencia ni expediente.',
      ...
      'De %PAIS, %N. Te hacés el humilde y medís a todos con regla ajena. Juez del hilo sin expediente ni carga útil detrás.',
      ...
      '%N, de %PAIS: el falso cumplido —qué seriedad— se agrieta solo. Sos compostura de ego. El grupo pidió sustancia, no pose.',
      ...
      'De %PAIS, %N. Te vendés como sobrio y entregás vacío con buena letra. Soft power del cringe silencioso.',
      ...
      '%N hace de %PAIS el chiste del mohín. Punchline: vos, sin necesidad de narrador externo.',
      '%N, de %PAIS: qué calma judicial… para terminar sin fallo útil. Sos tribunal de bolsillo. El chat apeló y ganó el contador.',
      ...
      'De %PAIS, %N. Te creés el adulto de la sala y no sostenés el hilo cuando pesa. Superioridad sin expediente.',
      ...
      '%N, en %PAIS habrá gente clara; vos preferís la sombra del juicio. Se nota la falta de luz en el aporte.',
  ...
  BR: {
    name: 'Brasil',
    lines: [
      '%N, de %PAIS: qué alegría tan ruidosa… para terminar siendo after sin sustancia. Sos la farra con teclado: ambientás todo y no cargás nada. El grupo no es tu camarote ni tu camarín.',
      ...
      '%N exporta de %PAIS el show tropical. Carnaval de un solo flotante: vos. El chat bajó el volumen y pidió contenido.',
      'De %PAIS, %N. Te creés el desfile y el desfile es malo. Resaca con beat y sin coreografía de utilidad.',
      ...
      '%N, de %PAIS: el falso cumplido —qué país— se derrite con la resaca del roast. Sos after de ego. Checkout.',
      ...
      'De %PAIS, %N. Te vendés como buen vibra y entregás saturación con beat. Soft power del ruido tropical.',
      ...
      '%N hace de %PAIS el chiste del beat. Punchline: vos, sin DJ que te salve el frame.',
      '%N, de %PAIS: qué carisma de escenario… para terminar siendo karaoke de ego. Sos feat que nadie pidió. El ranking no da credits.',
      ...
      'De %PAIS, %N. Te creés selección y aportás amistoso flojo. El chat ya hizo los cambios.',
      ...
      '%N, en %PAIS habrá cracks; vos estás en el feed del ambientador. El ambientador no suma.',
  ...
  CL: {
    name: 'Chile',
    lines: [
      '%N, de %PAIS: qué orden… para terminar mirando al resto por encima del hombro. Sos el frío administrativo: distancia olímpica, aporte tibio. El grupo no es tu sucursal ni tu checklist.',
      ...
      'Prefijo %PAIS, %N. Exportás distancia educada. El archivo no se impresiona con el hielo.',
      '%N, en %PAIS habrá nivel; vos estás de visita en el cringe ordenado. Se nota la falta de calor de aporte.',
      ...
      '%N, de %PAIS: el falso cumplido —qué país serio— se congela solo. Sos compostura de ego. El grupo pidió movimiento.',
      ...
      'De %PAIS, %N. Te vendés como estándar y entregás tibieza con buena ortografía. Soft power del cringe frío.',
      '%N, pack %PAIS: ofensa en voz baja, aporte en suspensión indefinida. El contador no hiberna con vos.',
      ...
      '%N hace de %PAIS el chiste del frío. Punchline: vos, sin bufanda que tape el hueco.'
    ],
  },
  EC: {
    name: 'Ecuador',
    lines: [
      '%N, de %PAIS: qué discreción… para terminar invisible de utilidad. Sos la molestia suave: drama de baja intensidad y alta constancia. El grupo no te debe el clima emocional del día.',
      ...
      'De %PAIS, %N. Te hacés la víctima con el teclado y el verdugo con el silencio. Sos el clima del hilo. La dignidad no es meteorología.',
      ...
      'Prefijo %PAIS, %N. Exportás molestia suave. El archivo no hace de paño de lágrimas ni de altavoz.',
      '%N, en %PAIS habrá gente clara; vos enturbiás con queja de baja intensidad. Se nota el barro fino.',
      ...
      '%N, de %PAIS: el falso cumplido —qué país— se diluye solo. Sos llovizna de ego. El grupo sacó el paraguas.',
      ...
      'De %PAIS, %N. Te vendés como sensible y entregás saturación suave. Soft power del cringe templado.',
      ...
      '%N hace de %PAIS el chiste del clima. Punchline: vos, sin pronóstico que te salve.'
    ],
  },
  GT: {
    name: 'Guatemala',
